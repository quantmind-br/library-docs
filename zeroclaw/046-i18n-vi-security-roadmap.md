...
url: https://github.com/openagen/zeroclaw/blob/master/docs/i18n/vi/security-roadmap.md
source: git
fetched_at: 2026-05-02T14:51:35.634104119-03:00
rendered_js: false
word_count: 932
summary: This document outlines a phased roadmap for enhancing ZeroClaw's security architecture through operating system-level sandboxing, resource isolation, and improved audit logging.
tags:
    - security-roadmap
    - sandboxing
    - resource-isolation
...
>
> Tài liệu này mô tả các hướng tiếp cận đề xuất và có thể bao gồm các lệnh hoặc cấu hình giả định. Để biết hành vi runtime hiện tại, xem [[049-vi-adding-boards-and-tools|Thêm Board và Tool]] và [[054-vi-operations-runbook|Sổ tay Vận hành]]
...
#security-roadmap #sandboxing #resource-isolation #audit-logging
