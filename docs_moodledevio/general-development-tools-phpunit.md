---
title: PHPUnit | Moodle Developer Resources
url: https://moodledev.io/general/development/tools/phpunit
source: sitemap
fetched_at: 2026-02-17T16:01:41.945067-03:00
rendered_js: false
word_count: 1050
summary: This document provides comprehensive instructions for installing, configuring, and executing PHPUnit tests within a Moodle development environment.
tags:
    - phpunit
    - moodle-development
    - unit-testing
...
## Installation of PHPUnit via Composer[​](#installation-of-phpunit-via-composer "Direct link to Installation of PHPUnit via Composer")

- Install Composer Instructions for installing composer on all platforms are here: [https://getcomposer.org/download/](https://getcomposer.org/download/)
...
- You may be prompted for github credentials when installing composer dependencies.
  ...
  - If you have Two Factor Authentication enabled on your github account, or do not wish to supply your own credentials you will need to generate a token manually:
    ...
    - Visit [https://github.com/settings/applications](https://github.com/settings/applications) and request personal access token
...
- [Composer documentation](http://getcomposer.org/doc/00-intro.md) Detailed instructions:
...
## PHPUnit versions[​](#phpunit-versions "Direct link to PHPUnit versions")
...
Moodle versionPHPUnit versionLinksMoodle 5.0PHPUnit 11.4[Documentation](https://docs.phpunit.de/en/11.4/)Moodle 4.4 - 4.5PHPUnit 9.6[Documentation](https://docs.phpunit.de/en/9.6/)Moodle 3.11 - 4.3PHPUnit 9.5[Documentation](https://docs.phpunit.de/en/9.6/)Moodle 3.10PHPUnit 8.5[Documentation](https://docs.phpunit.de/en/8.5/)Moodle 3.7 - 3.9PHPUnit 7.5[Documentation](https://docs.phpunit.de/en/7.5/)Moodle 3.4 - 3.6PHPUnit 6.5[Documentation](https://phpunit.de/manual/6.5/en/)Moodle 3.2 - 3.3PHPUnit 5.5[Documentation](https://phpunit.de/manual/5.5/en/)Moodle 3.1PHPUnit 4.8.27[Documentation 4.8](https://phpunit.de/manual/4.8/en/)

## Initialisation of test environment[​](#initialisation-of-test-environment "Direct link to Initialisation of test environment")
...
**NOTE:** make sure that your php cli executable (or the one you want to use) is correctly on your path as the individual init scripts will call it repeatedly. Also, ensure en\_AU locale is installed on your server.
...
## Test execution[​](#test-execution "Direct link to Test execution")
...
### How to run only some tests[​](#how-to-run-only-some-tests "Direct link to How to run only some tests")

#### Running a single test quickly (PHPUnit 9)[​](#running-a-single-test-quickly-phpunit-9 "Direct link to Running a single test quickly (PHPUnit 9)")
...
Run all tests from the workshop accumulative grading plugin
...
#### Using the @group annotation[​](#using-the-group-annotation "Direct link to Using the @group annotation")

If you add annotations like

```
namespaceqtype_stack;
/**
 * Unit tests for {@link stack_cas_keyval} @ qtype/stack/tests/cas_keyval_test.php.
 * @group qtype_stack
 */
classcas_keyval_testextends\basic_testcase{
```
...
#### Using multiple phpunit.xml files[​](#using-multiple-phpunitxml-files "Direct link to Using multiple phpunit.xml files")
...
## External test resources[​](#external-test-resources "Direct link to External test resources")

By default Moodle phpunit tests contact [http://download.moodle.org](http://download.moodle.org) server when testing curl related functionality. Optionally you may checkout a local copy of the test scripts and access it instead:

1. clone [https://github.com/moodlehq/moodle-exttests](https://github.com/moodlehq/moodle-exttests) to web directory
...
## Writing new tests[​](#writing-new-tests "Direct link to Writing new tests")

- read [official PHPUnit online documentation](https://docs.phpunit.de/en/9.6/)
- see [Writing PHPUnit tests](https://moodledev.io/docs/5.2/guides/testing)

## PHPUnit support in IDEs[​](#phpunit-support-in-ides "Direct link to PHPUnit support in IDEs")

- [Setting up PhpStorm](https://docs.moodle.org/dev/Setting_up_PhpStorm)

## Common Unit Test Problems[​](#common-unit-test-problems "Direct link to Common Unit Test Problems")

[Common unit test problems](https://docs.moodle.org/dev/Common_unit_test_problems)

## Command line tips[​](#command-line-tips "Direct link to Command line tips")
