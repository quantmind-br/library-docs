---
title: manager - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/simple_kv_offload/manager/
source: sitemap
fetched_at: 2026-05-07T21:41:41.176764122-03:00
rendered_js: false
word_count: 122
summary: This class manages CPU-side KV cache offloading for a vLLM scheduler, handling the allocation of CPU blocks, coordinating cache hits, and managing data transfers between GPU and CPU memory.
tags:
    - cpu-offloading
    - kv-cache
    - memory-management
...
```
classSimpleCPUOffloadScheduler:
...
"""Derive a CPU KVCacheConfig from the GPU config.
        ...
        fromvllm.v1.kv_cache_interfaceimport KVCacheConfig as KVCacheConfigCls
        fromvllm.v1.kv_cache_interfaceimport KVCacheTensor
    ...
    @staticmethod
    def_estimate_lazy_target_blocks(
...
"""Identify newly computed blocks to offload from scheduler requests.
    ...
    defupdate_connector_output(self, connector_output: KVConnectorOutput) -> None:
"""Handle async transfer completions from worker.
    ...
    def_process_store_event(self, event_idx: int) -> None:
...
"""Cache CPU blocks per-group and release GPU refs.
    ...
    defhas_pending_stores(self) -> bool:
...
"""Always returns (False, None). GPU blocks are protected by ref_cnt,
    ...
    def_cleanup_load_request(self, req_id: str) -> None:
"""Release all load resources for a request.
    ...
    def_cleanup_store_request(self, req_id: str) -> None:
