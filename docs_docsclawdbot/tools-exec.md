...
source: llms
fetched_at: 2026-01-26T09:54:14.432507458-03:00
rendered_js: false
word_count: 639
summary: This document provides a technical specification and configuration guide for the Exec tool, which facilitates shell command execution across sandboxed and host environments.
tags:
    - shell-execution
    - process-management
    - security-policy
