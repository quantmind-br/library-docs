...
source: llms
fetched_at: 2026-04-16T22:35:36.578751044-03:00
rendered_js: false
word_count: 898
summary: This document explains how to use Ultraplan, a feature that allows users to hand off planning tasks from a local CLI to a cloud-based web session for collaborative drafting and flexible execution.
tags:
    - ultraplan
    - claude-code
    - workflow-automation
