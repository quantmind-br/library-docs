...
url: https://moodledev.io/docs/5.0/tags/advanced
source: sitemap
fetched_at: 2026-02-17T15:16:14.945707-03:00
rendered_js: false
word_count: 191
summary: This document outlines advanced features of the Moodle Form API, including methods for hiding elements, grouping checkboxes, handling non-submitting button actions, and implementing repeatable form components.
tags:
    - moodle-api
    - form-elements
    - user-interface
