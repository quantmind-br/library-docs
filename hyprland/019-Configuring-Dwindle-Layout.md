...
source: sitemap
fetched_at: 2026-01-22T22:15:55.817519164-03:00
rendered_js: false
word_count: 511
summary: This document provides a detailed reference for the Dwindle window layout, explaining its binary tree structure and configuration options. It covers settings for split behavior, tiling logic, and layout-specific dispatchers for window management.
tags:
    - window-management
    - dwindle-layout
