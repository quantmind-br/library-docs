...
source: llms
fetched_at: 2026-01-24T14:11:07.341530359-03:00
rendered_js: false
word_count: 372
summary: This document provides step-by-step instructions for deploying a containerized PHP application to a local Kubernetes cluster using Docker Desktop.
tags:
    - kubernetes
    - docker-desktop
    - php
...
```
apiVersion:apps/v1kind:Deploymentmetadata:name:docker-php-demonamespace:defaultspec:replicas:1selector:matchLabels:hello-php:webtemplate:metadata:labels:hello-php:webspec:containers:- name:hello-siteimage:DOCKER_USERNAME/REPO_NAMEimagePullPolicy:Always---apiVersion:v1kind:Servicemetadata:name:php-entrypointnamespace:defaultspec:type:NodePortselector:hello-php:webports:- port:80targetPort:80nodePort:30001
```
...
3. Open a browser and visit your app at [http://localhost:30001/hello.php](http://localhost:30001/hello.php). You should see your application.
