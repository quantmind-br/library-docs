...
url: https://moodledev.io/docs/5.1/apis/core/user
source: sitemap
fetched_at: 2026-02-17T15:34:36.18223-03:00
rendered_js: false
word_count: 1070
summary: This document outlines Moodle's core APIs for managing user data, including methods for displaying user profile information, validating user fields, and implementing user selector widgets.
tags:
    - moodle-development
    - user-api
    - data-validation
...
- [Access API](https://moodledev.io/docs/5.1/apis/subsystems/access)
