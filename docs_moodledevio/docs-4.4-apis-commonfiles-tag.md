...
url: https://moodledev.io/docs/4.4/apis/commonfiles/tag.php
source: sitemap
fetched_at: 2026-02-17T15:01:56.687606-03:00
rendered_js: false
word_count: 0
summary: This document defines the structure and attributes for declaring tag areas in Moodle, explaining how to register database tables as taggable entities via the db/tag.php configuration file.
tags:
    - moodle
    - tag-areas
    - php-configuration
