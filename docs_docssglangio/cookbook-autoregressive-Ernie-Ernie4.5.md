---
title: Ernie4.5 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Ernie/Ernie4.5
source: sitemap
fetched_at: 2026-05-11T05:50:47.430696485-03:00
rendered_js: false
word_count: 453
summary: This document provides an overview of the ERNIE-4.5 large language model series, including its technical architecture, deployment instructions using the SGLang framework, and benchmarking procedures for AMD hardware.
tags:
    - ernie-4.5
    - sglang
    - model-deployment
