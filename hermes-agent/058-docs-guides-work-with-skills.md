...
source: crawler
fetched_at: 2026-04-24T17:00:24.0214815-03:00
rendered_js: false
word_count: 885
summary: This document serves as a comprehensive guide detailing Hermes' 'Skills,' explaining how these on-demand knowledge documents function for task execution. It covers finding, searching, using, installing, configuring, and creating custom skills for various use cases.
tags:
    - hermes-skills
    - knowledge-documents
    - slash-commands
...
SkillsMemory**What**Procedural knowledge — how to do thingsFactual knowledge — what things are**When**Loaded on demand, only when relevantInjected into every session automatically**Size**Can be large (hundreds of lines)Should be compact (key facts only)**Cost**Zero tokens until loadedSmall but constant token cost**Examples**"How to deploy to Kubernetes""User prefers dark mode, lives in PST"**Who creates**You, the agent, or installed from HubThe agent, based on conversations
