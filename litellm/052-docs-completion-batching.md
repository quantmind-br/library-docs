...
## Send multiple completion calls to 1 model[​](#send-multiple-completion-calls-to-1-model "Direct link to Send multiple completion calls to 1 model")
...
## Send 1 completion call to many models: Return Fastest Response[​](#send-1-completion-call-to-many-models-return-fastest-response "Direct link to Send 1 completion call to many models: Return Fastest Response")
...
## Send 1 completion call to many models: Return All Responses[​](#send-1-completion-call-to-many-models-return-all-responses "Direct link to Send 1 completion call to many models: Return All Responses")
