...
url: https://moodledev.io/docs/4.1/apis/subsystems/form/advanced/repeat-elements
source: sitemap
fetched_at: 2026-02-17T14:56:38.393514-03:00
rendered_js: false
word_count: 256
summary: This document explains how to use the repeat_elements method in the Form API to create repeating groups of form elements for handling dynamic quantities of input data.
tags:
    - form-api
    - repeat-elements
    - dynamic-forms
