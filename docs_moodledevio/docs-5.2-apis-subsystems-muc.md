...
url: https://moodledev.io/docs/5.2/apis/subsystems/muc
source: sitemap
fetched_at: 2026-02-17T15:46:04.309097-03:00
rendered_js: false
word_count: 4016
summary: This document provides an overview of the Moodle Universal Cache (MUC) API, explaining how to create cache definitions, manage data with cache objects, and configure cache settings for plugins.
tags:
    - moodle
    - cache-api
    - muc
