...
url: https://moodledev.io/docs/4.4/tags/forms-api
source: sitemap
fetched_at: 2026-02-17T14:59:30.260907-03:00
rendered_js: false
word_count: 191
summary: This document explains advanced features of the Moodle Form API, including techniques for managing element visibility, grouping checkboxes, handling non-processing buttons, and repeating element sets.
tags:
    - moodle-development
    - form-api
    - advanced-elements
