...
url: https://moodledev.io/docs/5.1/apis/subsystems/communication
source: sitemap
fetched_at: 2026-02-17T15:36:10.53519-03:00
rendered_js: false
word_count: 1473
summary: This document explains the Communication API's architecture, including its use of asynchronous ad-hoc tasks and the Hooks API to manage rooms and memberships across communication providers.
tags:
    - communication-api
    - moodle-development
    - ad-hoc-tasks
...
The Communication API takes advantage of the [Hooks API](https://moodledev.io/docs/5.1/apis/plugintypes/communication) with actions performed in the following way:
