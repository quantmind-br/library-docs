...
url: https://moodledev.io/docs/4.5/apis/plugintypes/format
source: sitemap
fetched_at: 2026-02-17T15:12:08.748095-03:00
rendered_js: false
word_count: 4768
summary: This document explains the structure and implementation of Moodle course format plugins, detailing how they control course layouts, section organization, and navigation through specific PHP files and classes.
tags:
    - moodle-development
    - course-formats
    - plugin-architecture
...
In case your plugin is a Moodle 3.11 compatible plugin, see the [migration guide](https://moodledev.io/docs/4.5/apis/plugintypes/format/migration) for more information.
