...
source: sitemap
fetched_at: 2026-01-30T20:33:55.153015516-03:00
rendered_js: false
word_count: 801
summary: This document explains the concept and usage of the workspace in the OpenClaw system, detailing its location, structure, management, and best practices for backing up and securing workspace contents.
tags:
    - workspace
    - file-tools
    - configuration
...
`openclaw onboard`, `openclaw configure`, or `openclaw setup` will create the workspace and seed the bootstrap files if they are missing. If you already manage the workspace files yourself, you can disable bootstrap file creation:
