...
source: sitemap
fetched_at: 2026-05-07T21:14:20.769090662-03:00
rendered_js: false
word_count: 156
summary: This document explains the process of using AWQ quantization to reduce model memory usage and latency in vLLM, while noting the deprecation of the AutoAWQ library in favor of llm-compressor.
tags:
    - awq
    - quantization
    - model-optimization
...
[](https://github.com/vllm-project/vllm/edit/main/docs/features/quantization/auto_awq.md "Edit this page")
...
```
fromawqimport AutoAWQForCausalLM
...
```
pythonexamples/offline_inference/llm_engine_example.py\
--modelTheBloke/Llama-2-7b-Chat-AWQ\
--quantizationawq
```
