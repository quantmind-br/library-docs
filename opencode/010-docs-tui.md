...
source: sitemap
fetched_at: 2026-04-17T06:44:18.964640226-03:00
rendered_js: false
word_count: 713
summary: This document provides a comprehensive guide to using the OpenCode terminal user interface, including command syntax, keyboard shortcuts, and configuration options.
tags:
    - terminal-ui
    - cli-guide
    - user-interface
