---
title: Penetration testing | Moodle Developer Resources
url: https://moodledev.io/general/development/process/security/penetration-testing
source: sitemap
fetched_at: 2026-02-17T16:00:29.065828-03:00
rendered_js: false
word_count: 356
summary: This document provides guidance for preparing a Moodle instance for penetration testing and explains common false positives related to XSS risks and CSRF tokens.
tags:
    - moodle
    - penetration-testing
    - security-audit
...
## Preparing for a penetration test[​](#preparing-for-a-penetration-test "Direct link to Preparing for a penetration test")

### Set debugging to normal[​](#set-debugging-to-normal "Direct link to Set debugging to normal")

Either turn off all debugging which can disclose stacktraces etc, or show the pen testers how this can be toggled.

### Setup the environment like production[​](#setup-the-environment-like-production "Direct link to Setup the environment like production")
...
## Common non-issues[​](#common-non-issues "Direct link to Common non-issues")
...
### XSS risks and capabilities[​](#xss-risks-and-capabilities "Direct link to XSS risks and capabilities")
...
The most trivial example would be the ability to [edit `site:config`](https://github.com/moodle/moodle/blob/main/lib/db/access.php#L58-L60) which has the RISK\_XSS:
...
### The sesskey param is a CSRF token[​](#the-sesskey-param-is-a-csrf-token "Direct link to The sesskey param is a CSRF token")
