...
#### Step 1: Select Tool Permission Guardrail[​](#step-1-select-tool-permission-guardrail "Direct link to Step 1: Select Tool Permission Guardrail")
...
#### Step 2: Define Regex Rules[​](#step-2-define-regex-rules "Direct link to Step 2: Define Regex Rules")
...
#### Step 3: Restrict Tool Arguments (Optional)[​](#step-3-restrict-tool-arguments-optional "Direct link to Step 3: Restrict Tool Arguments (Optional)")
...
#### Step 4: Choose Defaults & Actions[​](#step-4-choose-defaults--actions "Direct link to Step 4: Choose Defaults & Actions")
...
#### Rule Structure[​](#rule-structure "Direct link to Rule Structure")
...
### `on_disallowed_action` behavior[​](#on_disallowed_action-behavior "Direct link to on_disallowed_action-behavior")
...
### Custom denial message[​](#custom-denial-message "Direct link to Custom denial message")
...
### Constrain Tool Arguments[​](#constrain-tool-arguments "Direct link to Constrain Tool Arguments")
...
Only allow mail\_mcp to mail @berri.ai addresses
