...
url: https://moodledev.io/docs/5.1/apis/subsystems/routing/parameters
source: sitemap
fetched_at: 2026-02-17T15:37:12.157309-03:00
rendered_js: false
word_count: 1347
summary: This document explains how to define and handle path, query, and header parameters within the routing subsystem, covering validation, optional settings, and retrieval methods.
tags:
    - routing
    - path-parameters
    - query-parameters
