...
url: https://moodledev.io/docs/5.1/guides/javascript/comboboxsearch
source: sitemap
fetched_at: 2026-02-17T15:37:45.055807-03:00
rendered_js: false
word_count: 1026
summary: This document explains how to implement and extend the core Moodle combobox search component to provide consistent search and filtering functionality across the platform. It details the technical structure, implementation steps, and available JavaScript helper methods for plugin developers.
tags:
    - moodle-development
    - search-combobox
    - ui-component
...
For example usages view the [examples](https://moodledev.io/docs/5.1/guides/javascript/comboboxsearch/examples) page.