...
url: https://moodledev.io/docs/5.1/apis/subsystems/availability
source: sitemap
fetched_at: 2026-02-17T15:36:04.98928-03:00
rendered_js: false
word_count: 869
summary: This document explains how to use the Moodle Availability API to manage and restrict access to course activities and sections based on specific criteria. It provides guidance on checking user visibility, filtering user lists, and programmatically configuring access restrictions.
tags:
    - moodle-development
    - availability-api
    - access-control
...
- Writing [Availability condition](https://moodledev.io/docs/5.1/apis/plugintypes/availability) plugins