---
title: Moodle App Development Guide | Moodle Developer Resources
url: https://moodledev.io/general/app/development/development-guide
source: sitemap
fetched_at: 2026-02-17T15:54:28.090676-03:00
rendered_js: false
word_count: 5948
summary: This document provides an introductory guide for developers on setting up the development environment, debugging, and understanding the codebase structure for the Moodle mobile application.
tags:
    - moodle-app
    - mobile-development
    - environment-setup
...
This document contains information that developers should know before starting to code on the Mobile App. If you are only interested in developing a site plugin, you should read [the Moodle App Plugins development guide](https://moodledev.io/general/app/development/plugins-development-guide) instead.
...
This will launch the application in a browser, but keep in mind that it only works with chromium-based browsers. You can read more about that in the [Using the Moodle App in a browser](https://moodledev.io/general/app/development/setup/app-in-browser) page.

Other than this, there are different things you'll need to do depending on what you are trying to achieve. We'll go over some of them briefly, but if you want to learn more about this or something isn't working as you expect, make sure to check out the full guide on [Setting up your development environment for the Moodle App](https://moodledev.io/general/app/development/setup).

### Editing code[​](#editing-code "Direct link to Editing code")
...
If you need to debug how the application is interacting with a Moodle site, you'll need to take a look at the network requests. Most of the time [using the Network Panel](https://developer.chrome.com/docs/devtools/network/) should suffice, but if that isn't working take a look at the [Debugging network requests in the Moodle App](https://moodledev.io/general/app/development/network-debug) page.

### Working with a Moodle site[​](#working-with-a-moodle-site "Direct link to Working with a Moodle site")
...
### Working on native functionality[​](#working-on-native-functionality "Direct link to Working on native functionality")
...
## Folders structure[​](#folders-structure "Direct link to Folders structure")
...
### main.ts[​](#maints "Direct link to main.ts")
...
### polyfills.ts[​](#polyfillsts "Direct link to polyfills.ts")

This file adds [polyfills](https://en.wikipedia.org/wiki/Polyfill_%28programming%29) for missing functionality in the platform.
...
#### core/initializers/[​](#coreinitializers "Direct link to core/initializers/")
...
#### core/services/[​](#coreservices "Direct link to core/services/")
...
#### core/components/[​](#corecomponents "Direct link to core/components/")
...
#### core/directives/ and core/pipes/[​](#coredirectives-and-corepipes "Direct link to core/directives/ and core/pipes/")
...
#### core/guards/[​](#coreguards "Direct link to core/guards/")
...
#### core/classes/[​](#coreclasses "Direct link to core/classes/")
...
#### core/utils/[​](#coreutils "Direct link to core/utils/")

Same as [core/classes/](#coreclasses), but containing functional utilities instead of classes.

#### core/singletons/[​](#coresingletons "Direct link to core/singletons/")
...
#### core/features/[​](#corefeatures "Direct link to core/features/")
...
### Constants files[​](#constants-files "Direct link to Constants files")
...
### Dynamic Routes[​](#dynamic-routes "Direct link to Dynamic Routes")
...
### Split View Routes[​](#split-view-routes "Direct link to Split View Routes")
...
### Navigating between routes[​](#navigating-between-routes "Direct link to Navigating between routes")
...
### Navigating using swipe gestures[​](#navigating-using-swipe-gestures "Direct link to Navigating using swipe gestures")
...
## Singletons[​](#singletons "Direct link to Singletons")
...
### Pure Singletons[​](#pure-singletons "Direct link to Pure Singletons")
...
```
exportclassCoreArray{

staticcontains<T>(items:T[], item:T):boolean{
...
### Service Singletons[​](#service-singletons "Direct link to Service Singletons")
...
exportclassCoreUserService{

// ...

}

exportconst CoreUser =makeSingleton(CoreUserService);
```
...
```
exportclassMyHttpClientextendsHttpClient{}

exportconst Http =makeSingleton(HttpClient);
...
## Application Lifecycle[​](#application-lifecycle "Direct link to Application Lifecycle")
...
![A summary of the Application Lifecycle](https://moodledev.io/assets/images/application_lifecycle-8d4b8ea7c6b9bd777d26aa93d74c3598.jpg)

## Testing[​](#testing-1 "Direct link to Testing")

There are two types of tests in the mobile app.

### Unit[​](#unit "Direct link to Unit")
...
You can learn more about this in the [Unit testing for the Moodle App](https://moodledev.io/general/app/development/testing/unit-testing) page.

### Acceptance[​](#acceptance "Direct link to Acceptance")

Acceptance tests are written in [Gherkin](https://en.wikipedia.org/wiki/Cucumber_%28software%29#Gherkin_language) using [Behat](https://moodledev.io/general/app/development/testing/acceptance-testing). These are run against the full application with a real Moodle site, so they are more heavy-handed and will take longer to run. But they are also much more realistic than unit tests.
...
You can learn more about this in the [Acceptance testing for the Moodle App](https://moodledev.io/general/app/development/testing/acceptance-testing) page.

## See also[​](#see-also "Direct link to See also")

- [Moodle App Accessibility](https://moodledev.io/general/app/development/accessibility)
- [Moodle App Link Handling](https://moodledev.io/general/app/development/link-handling/app-links)
