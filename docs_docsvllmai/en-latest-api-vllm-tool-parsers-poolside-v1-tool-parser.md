---
title: poolside_v1_tool_parser - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/tool_parsers/poolside_v1_tool_parser/
source: sitemap
fetched_at: 2026-05-07T21:36:20.970660989-03:00
rendered_js: false
word_count: 55
summary: This document defines the PoolsideV1ToolParser class, which manages the parsing and incremental streaming of tool-call outputs for GLM-4 language models.
tags:
    - python
    - tool-calling
    - streaming
...
```
classPoolsideV1ToolParser(ToolParser):
"""Tool parser for GLM-4 models with incremental string streaming.
    ...
    @staticmethod
    def_json_escape_string_content(s: str) -> str:
"""JSON-escape string content for incremental streaming.
    ...
    @staticmethod
    def_tools_enabled(request: ChatCompletionRequest) -> bool:
...
"""Adjust request parameters for tool call token handling."""
    ...
    def_ensure_tool_state(self) -> None:
    ...
    def_finish_tool_call(self) -> None:
        self._in_tool_call = False
        self._current_tool_name = None
        self._pending_key = None
        self._streaming_string_value = False

    def_revert_last_tool_call_state(self) -> None:
"""Revert the state allocation for the last tool call."""
    ...
    def_get_or_create_delta(self, pending: dict[int, DeltaToolCall]) -> DeltaToolCall:
...
"""Complete a partial JSON prefix into a valid JSON object.
    ...
    def_close_args_if_needed(self) -> str | None:
