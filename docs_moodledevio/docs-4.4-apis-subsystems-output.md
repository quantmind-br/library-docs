...
url: https://moodledev.io/docs/4.4/apis/subsystems/output
source: sitemap
fetched_at: 2026-02-17T15:04:41.514152-03:00
rendered_js: false
word_count: 2502
summary: This document explains the Moodle Output API and how renderers, renderables, and templates interact to generate visual content. It describes the lifecycle of page rendering, including the role of the global $PAGE variable and the implementation of renderable interfaces.
tags:
    - moodle-development
    - output-api
    - php-renderers
...
While to render complex elements, you should use [templates](https://moodledev.io/docs/4.4/guides/templates), some simple elements can be rendered using the following functions:
...
- [Templates](https://moodledev.io/docs/4.4/guides/templates)