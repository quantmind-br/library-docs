...
source: llms
fetched_at: 2026-01-26T09:52:55.98120411-03:00
rendered_js: false
word_count: 316
summary: This document explains how the macOS application manages the Gateway service using launchd, covering process lifecycle, manual controls, and various configuration modes.
tags:
    - macos
    - launchd
    - process-management
