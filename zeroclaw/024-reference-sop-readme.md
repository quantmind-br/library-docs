...
- [[connectivity|Connect Events]] — trigger SOPs via MQTT, webhooks, cron, or peripherals
- [[syntax|Write SOPs]] — required file layout and trigger/step syntax
- [[observability|Monitor]] — where run state and audit entries are stored
- [[cookbook|Examples]] — reusable SOP patterns
