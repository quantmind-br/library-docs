...
url: https://docs.factory.ai/pricing.md
source: llms
fetched_at: 2026-02-05T21:44:56.859925907-03:00
rendered_js: false
word_count: 323
summary: This document outlines the pricing structure and subscription plans for Factory's services, detailing how standard tokens and model-specific multipliers are used to calculate usage costs.
tags:
    - pricing-tiers
    - token-multipliers
    - billing-reference
