...
source: sitemap
fetched_at: 2026-04-15T09:00:55.265902453-03:00
rendered_js: false
word_count: 576
summary: This document explains how to configure and manage mixed models in Droid, allowing users to designate specific AI models for Specification Mode versus standard coding tasks.
tags:
    - mixed-models
    - model-configuration
    - spec-mode
