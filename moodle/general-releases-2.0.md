---
title: Moodle 2.0 | Moodle Developer Resources
url: https://moodledev.io/general/releases/2.0
source: sitemap
fetched_at: 2026-02-17T16:04:09.62647-03:00
rendered_js: false
word_count: 2373
summary: This document outlines the major features, core improvements, and architectural changes introduced in the Moodle 2.0 release.
tags:
...
## Moodle 2.0[​](#moodle-20 "Direct link to Moodle 2.0")
...
#### [Repository support](https://docs.moodle.org/en/Repositories)[​](#repository-support "Direct link to repository-support")
...
#### [Portfolio support](https://docs.moodle.org/en/Portfolios)[​](#portfolio-support "Direct link to portfolio-support")
...
#### [Course completion](https://docs.moodle.org/dev/Course_completion) and prerequisites[​](#course-completion-and-prerequisites "Direct link to course-completion-and-prerequisites")
...
#### [Conditional activities](https://docs.moodle.org/dev/Conditional_activities)[​](#conditional-activities "Direct link to conditional-activities")
...
#### [Web services support](https://docs.moodle.org/dev/Web_Services)[​](#web-services-support "Direct link to web-services-support")
...
#### New blocks[​](#new-blocks "Direct link to New blocks")
...
#### [Plagiarism prevention](https://docs.moodle.org/en/Plagiarism_Prevention)[​](#plagiarism-prevention "Direct link to plagiarism-prevention")

- Moodle supports integration with plagiarism prevention tools such as Turnitin

### Major improvements to existing core features[​](#major-improvements-to-existing-core-features "Direct link to Major improvements to existing core features")

#### [Backup and restore](https://docs.moodle.org/dev/Backup_2.0)[​](#backup-and-restore "Direct link to backup-and-restore")
...
#### [Blocks](https://docs.moodle.org/en/Blocks_2.0)[​](#blocks "Direct link to blocks")
...
#### [Blogs](https://docs.moodle.org/en/Blogs_2.0)[​](#blogs "Direct link to blogs")
...
#### [Enrolment plugins](https://docs.moodle.org/en/Enrolments_2.0)[​](#enrolment-plugins "Direct link to enrolment-plugins")
...
#### [File handling](https://docs.moodle.org/en/File_handling_2.0)[​](#file-handling "Direct link to file-handling")
...
#### [Filters 2.0](https://docs.moodle.org/dev/Filters_2.0)[​](#filters-20 "Direct link to filters-20")
...
#### [HTML editor](https://docs.moodle.org/dev/HTML_editor_2.0)[​](#html-editor "Direct link to html-editor")
...
#### [Messaging](https://docs.moodle.org/dev/Messaging_2.0)[​](#messaging "Direct link to messaging")
...
#### [My Moodle page](https://docs.moodle.org/dev/My_Moodle_2.0)[​](#my-moodle-page "Direct link to my-moodle-page")
...
#### [Ratings](https://docs.moodle.org/dev/Ratings_2.0)[​](#ratings "Direct link to ratings")
...
#### [Roles and permissions](https://docs.moodle.org/en/Roles_2.0)[​](#roles-and-permissions "Direct link to roles-and-permissions")
...
#### [Themes](https://docs.moodle.org/dev/Themes_2.0)[​](#themes "Direct link to themes")
...
#### [Translation system](https://docs.moodle.org/dev/Translation_2.0)[​](#translation-system "Direct link to translation-system")
...
#### User profile pages[​](#user-profile-pages "Direct link to User profile pages")
...
### Major improvements to activity modules[​](#major-improvements-to-activity-modules "Direct link to Major improvements to activity modules")
...
#### Quiz module and question bank[​](#quiz-module-and-question-bank "Direct link to Quiz module and question bank")
...
#### [Wiki](https://docs.moodle.org/en/Wiki_module_2.0)[​](#wiki "Direct link to wiki")

- Completely re-written from scratch, based on NWIki from UPC
- Support for Mediawiki-style syntax, as well as Creole
- Interface improvements

#### [Workshop](https://docs.moodle.org/en/Workshop_module_2.0)[​](#workshop "Direct link to workshop")
...
- Require capability used to do an automatic require\_login. It no longer does so. All pages must explicitly call require\_login if they need it. [MDL-19882](https://moodle.atlassian.net/browse/MDL-19882)
...
- [Notes de mise à jour de Moodle 2.0](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_2.0)
