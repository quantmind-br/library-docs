...
url: https://moodledev.io/docs/5.2/apis/plugintypes/qbank/filters
source: sitemap
fetched_at: 2026-02-17T15:44:42.399981-03:00
rendered_js: false
word_count: 1169
summary: This document explains how to create custom filter conditions for question bank plugins, involving both backend PHP classes and frontend JavaScript components. It provides step-by-step instructions for implementing basic filters and customizing advanced options like query building and value restrictions.
tags:
    - moodle-development
    - qbank-plugins
    - filter-conditions
