...
url: https://moodledev.io/docs/5.1/apis/subsystems/form/advanced/checkbox-controller
source: sitemap
fetched_at: 2026-02-17T15:36:43.043587-03:00
rendered_js: false
word_count: 75
summary: This document demonstrates how to implement checkbox controllers in Moodle forms to manage multiple checkboxes within specific groups simultaneously.
tags:
    - moodle-development
    - php
    - mform-api
