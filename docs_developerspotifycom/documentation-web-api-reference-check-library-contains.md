...
source: crawler
fetched_at: 2026-02-27T23:38:44.119618-03:00
rendered_js: true
word_count: 75
summary: This document describes a Web API endpoint used to verify whether specific Spotify items, such as tracks, albums, or artists, are saved in the current user's library.
tags:
    - spotify-api
    - user-library
    - saved-items
