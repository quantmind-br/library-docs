...
source: sitemap
fetched_at: 2026-04-15T09:01:13.264221202-03:00
rendered_js: false
word_count: 388
summary: This document explains how to use the /readiness-report slash command to evaluate a repository's maturity level based on the Autonomy Maturity Model and generate actionable improvement recommendations.
tags:
    - readiness-report
    - repository-maturity
    - devops-tooling
