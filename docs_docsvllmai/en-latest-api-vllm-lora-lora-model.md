---
title: lora_model - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/lora/lora_model/
source: sitemap
fetched_at: 2026-05-07T21:22:40.726844135-03:00
rendered_js: false
word_count: 0
summary: This document defines the LoRAModel class, which provides mechanisms for managing, cloning, and loading Low-Rank Adaptation (LoRA) weights from tensors or local checkpoints for machine learning models.
tags:
    - lora
    - fine-tuning
    - machine-learning
...
"""
    ...
    defclone(self, lora_model_id: int) -> "LoRAModel":
"""Return a copy of the object with different ids.
    ...
    defget_lora(self, module_name: str) -> LoRALayerWeights | None:
"""Get LoRA for a given module by name"""
        return self.loras.get(module_name, None)

    defcheck_lora_name(self, lora_name: str) -> bool:
        return lora_name in self.loras

    @staticmethod
    def_should_skip_module(module_name: str, skip_prefixes: list[str]) -> bool:
...
"""Create a LoRAModel from a local checkpoint.
        ...
        defcheck_unexpected_modules(modules: dict):
        ...
        if tensorizer_config_dict:
            fromtensorizerimport TensorDeserializer
