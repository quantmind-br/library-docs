...
url: https://moodledev.io/docs/5.1/apis/plugintypes/theme/fonts
source: sitemap
fetched_at: 2026-02-17T15:35:41.348825-03:00
rendered_js: false
word_count: 247
summary: This document explains how to integrate and reference custom web fonts within Moodle themes and plugins using specific file structures and CSS placeholders.
tags:
    - moodle-development
    - web-fonts
    - css-styling
