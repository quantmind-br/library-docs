---
title: Moodle 5.0 developer update | Moodle Developer Resources
url: https://moodledev.io/docs/5.0/devupdate
source: sitemap
fetched_at: 2026-02-17T15:28:26.887672-03:00
rendered_js: false
word_count: 904
summary: This document outlines the key technical changes, deprecations, and new features introduced in Moodle 5.0 specifically for developers, covering APIs, course formats, and theme updates.
tags:
    - moodle-5-0
    - developer-guide
    - api-changes
...
## Activity overview page integration[​](#activity-overview-page-integration "Direct link to Activity overview page integration")
...
See the [Activity overview page integration](https://moodledev.io/docs/5.0/apis/plugintypes/mod/courseoverview) documentation for more information.

## Calendar: New human date renderers[​](#calendar-new-human-date-renderers "Direct link to Calendar: New human date renderers")
...
See the [Date and Time Output Classes](https://moodledev.io/docs/5.0/apis/subsystems/output/humandate) documentation for more information.
...
To ensure a smooth transition, we have documented the migration process in detail. Please refer to the [migration guide](https://moodledev.io/docs/5.0/apis/plugintypes/format/migration) for comprehensive instructions on updating your course formats to be compatible with the latest Moodle standards.
...
### New `core_courseformat_new_module` webservice[​](#new-core_courseformat_new_module-webservice "Direct link to new-core_courseformat_new_module-webservice")
...
A new process for plugin type and subplugin type deprecation has been introduced. See [the Plugin Type deprecation](https://moodledev.io/docs/5.0/apis/plugintypes#deprecating-a-plugin-type) and [Subplugin deprecation](https://moodledev.io/docs/5.0/apis/plugintypes#deprecating-a-subplugin-type) documentation for further information.
...
Example of the new `subplugintypes` values
...
mod/quiz/db/subplugins.json demonstrating the legacy plugintypes object
...
mod/quiz/db/subplugins.json demonstrating the new subplugintypes object
...
mod/quiz/db/subplugins.json demonstrating both the legacy plugintypes and the new subplugintypes values
...
### Activity icon colors[​](#activity-icon-colors "Direct link to Activity icon colors")
...
Example of customizing activity icon colors
...
### Bootstrap 5[​](#bootstrap-5 "Direct link to Bootstrap 5")

Bootstrap has been upgraded to version 5, bringing new features and improvements. As part of this transition, we have implemented a backwards-compatibility layer to ensure a smooth migration for third-party plugins and custom code.

For more details on the upgrade process and how to utilize the compatibility layer, please visit [Bootstrap 5 migration](https://moodledev.io/docs/5.0/guides/bs5migration). This will help you adapt your projects to the latest Bootstrap version.
...
Please see the [PHPUnit 11 Upgrade Guide](https://moodledev.io/general/development/tools/phpunit/upgrading-11) for assistance in updating any broken tests.
