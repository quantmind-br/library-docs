---
title: "null"
url: https://docs.clawd.bot/token-use.md
source: llms
fetched_at: 2026-01-26T09:54:04.507495169-03:00
rendered_js: false
word_count: 521
summary: This document explains how Clawdbot tracks token usage and calculates costs, detailing what affects the context window and how to monitor consumption via commands. It also provides optimization strategies such as prompt caching and session pruning.
tags:
    - token-usage
    - cost-estimation
    - context-window
