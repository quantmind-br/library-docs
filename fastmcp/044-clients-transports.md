---
title: Client Transports - FastMCP
url: https://gofastmcp.com/clients/transports
source: crawler
fetched_at: 2026-01-22T22:21:48.530417417-03:00
rendered_js: false
word_count: 277
summary: This document explains how to configure and implement various transport layers for MCP clients, covering STDIO, HTTP, and in-memory connections along with advanced multi-server setups.
tags:
    - mcp
    - fastmcp
    - transport-layer
...
New in version `2.0.0` Transports handle the underlying connection between your client and MCP servers. While the client can automatically select a transport based on what you pass to it, instantiating transports explicitly gives you full control over configuration.
...
New in version `2.3.0` HTTP transport connects to MCP servers running as web services. This is the recommended transport for production deployments.
...
New in version `2.4.0` Connect to multiple servers defined in a configuration dictionary:
