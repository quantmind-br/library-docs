---
title: model_inspection - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_inspection/
source: sitemap
fetched_at: 2026-05-07T21:34:00.812219185-03:00
rendered_js: false
word_count: 98
summary: This document provides internal utility functions for vLLM designed to inspect and represent neural network model architectures as hierarchical, summarized strings.
tags:
    - vllm
    - model-inspection
    - pytorch
...
## \_format\_index\_ranges [¶](#vllm.model_inspection._format_index_ranges "Permanent link")

Format indices into range notation (e.g., \[0,1,2,4,5,6] -&gt; '0-2, 4-6').

Source code in `vllm/model_inspection.py`

```
def_format_index_ranges(indices: list[int]) -> str:
"""Format indices into range notation (e.g., [0,1,2,4,5,6] -> '0-2, 4-6')."""
...
## \_format\_module\_tree [¶](#vllm.model_inspection._format_module_tree "Permanent link")

Format a module tree with indentation, grouping identical layers.

Produces output like

(layers): ModuleList( (0-27, 29-47): 47 x LlamaDecoderLayer( ... ) (28, 48): 2 x DifferentDecoderLayer( ... ) )

Source code in `vllm/model_inspection.py`

```
def_format_module_tree(
    module: nn.Module,
    name: str = "",
    indent: int = 0,
) -> list[str]:
...
## \_get\_child\_signature [¶](#vllm.model_inspection._get_child_signature "Permanent link")
...
```
def_get_child_signature(child: nn.Module) -> str:
"""Get a signature for a child module to detect duplicates."""
    lines = []
...
## \_get\_module\_info [¶](#vllm.model_inspection._get_module_info "Permanent link")
...
def_get_module_info(module: nn.Module) -> str:
"""Get info string for a module."""
...
## format\_model\_inspection [¶](#vllm.model_inspection.format_model_inspection "Permanent link")

```
format_model_inspection(model: Module) -> str
```
...
```
defformat_model_inspection(model: nn.Module) -> str:
"""Format a model into a transformers-style hierarchical string."""
