...
url: https://moodledev.io/docs/4.5/apis/core/di
source: sitemap
fetched_at: 2026-02-17T15:11:07.170999-03:00
rendered_js: false
word_count: 486
summary: This document explains the implementation and usage of PSR-11 compatible Dependency Injection in Moodle, covering constructor injection, manual fetching, and mocking dependencies for unit testing.
tags:
    - moodle
