...
url: https://moodledev.io/docs/5.1/apis/subsystems/task/adhoc
source: sitemap
fetched_at: 2026-02-17T15:37:24.393104-03:00
rendered_js: false
word_count: 697
summary: This document explains how to create, queue, and manage adhoc tasks for background processing, covering implementation details such as custom data, scheduling, and error handling.
tags:
    - adhoc-tasks
