...
url: https://moodledev.io/docs/5.0/apis/plugintypes/qtype/newquestiondefaults
source: sitemap
fetched_at: 2026-02-17T15:26:34.436996-03:00
rendered_js: false
word_count: 470
summary: This document explains how to implement persistent user preferences as default settings for new question types in Moodle to improve the user experience during question creation.
tags:
    - moodle-development
    - question-types
    - user-preferences
