...
url: https://moodledev.io/docs/4.1/apis/plugintypes/mod_data/fields
source: sitemap
fetched_at: 2026-02-17T14:55:36.603202-03:00
rendered_js: false
word_count: 390
summary: This document explains how to develop custom field type sub-plugins for the Moodle Database activity module, detailing the required file structure and class methods.
tags:
    - moodle
    - mod-data
    - plugin-development
...
Some of the important files for the database field plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
