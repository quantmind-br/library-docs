---
title: tag.php | Moodle Developer Resources
url: https://moodledev.io/docs/4.5/apis/commonfiles/tag.php
source: sitemap
fetched_at: 2026-02-17T15:10:50.303795-03:00
rendered_js: false
word_count: 0
summary: This document defines the structure and attributes for specifying tag areas in Moodle, allowing components to register taggable entities and their associated behaviors. It provides a reference for the $tagareas array configuration used to link database tables with the tagging system.
tags:
    - moodle
    - tag-areas
    - plugin-development
