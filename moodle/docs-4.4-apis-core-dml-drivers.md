...
url: https://moodledev.io/docs/4.4/apis/core/dml/drivers
source: sitemap
fetched_at: 2026-02-17T15:02:20.43072-03:00
rendered_js: false
word_count: 151
summary: This document describes Moodle's native database drivers and explains how to configure query logging features through the DML driver layer.
tags:
    - moodle
    - database-drivers
    - dml
...
- [DML functions](https://moodledev.io/docs/4.4/apis/core/dml): Where all the functions used to handle DB data ([DML](https://en.wikipedia.org/wiki/Data_Manipulation_Language)) are defined.
