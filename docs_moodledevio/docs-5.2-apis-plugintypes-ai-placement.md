...
url: https://moodledev.io/docs/5.2/apis/plugintypes/ai/placement
source: sitemap
fetched_at: 2026-02-17T15:43:52.136732-03:00
rendered_js: false
word_count: 453
summary: This document explains how to develop and implement AI Placement plugins in Moodle, detailing their role in providing user interfaces for AI actions and their interaction with the AI subsystem's central manager.
tags:
    - moodle-development
    - ai-subsystem
    - placement-plugins
