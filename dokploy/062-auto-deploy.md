...
url: https://docs.dokploy.com/docs/core/auto-deploy#api-method
source: crawler
fetched_at: 2026-02-08T04:02:00.807601006-03:00
rendered_js: false
word_count: 418
summary: This document explains how to automate application deployments in Dokploy through webhooks and the Dokploy API. It provides step-by-step instructions for integrating various Git providers and DockerHub into a CI/CD pipeline.
tags:
    - dokploy
    - auto-deploy
    - webhooks
