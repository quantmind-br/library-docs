...
url: https://doc.rust-lang.org/src/std/ffi/os_str.rs.html#609-617
source: crawler
fetched_at: 2026-05-06T21:23:27.827336879-03:00
rendered_js: false
word_count: 7957
summary: This document explains the OsString and OsStr types, which provide platform-agnostic representations of strings to bridge the gap between Rust's UTF-8 strings and operating system-specific string formats.
tags:
    - rust
    - ffi
    - string-handling
