...
url: https://moodledev.io/docs/5.0/tags/web-services
source: sitemap
fetched_at: 2026-02-17T15:23:17.178271-03:00
rendered_js: false
word_count: 127
summary: This document provides an overview of Moodle's external API subsystem, covering function declarations, security protocols, file handling, and the creation of custom web services.
tags:
    - moodle-development
    - external-api
    - web-services
