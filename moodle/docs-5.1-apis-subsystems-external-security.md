...
url: https://moodledev.io/docs/5.1/apis/subsystems/external/security
source: sitemap
fetched_at: 2026-02-17T15:36:26.607034-03:00
rendered_js: false
word_count: 399
summary: This document outlines the security and validation requirements for Moodle external functions, including parameter cleaning, context verification, and capability checks. It explains the mandatory use of specific API methods to ensure data integrity and proper user access control.
tags:
    - moodle-development
    - external-functions
