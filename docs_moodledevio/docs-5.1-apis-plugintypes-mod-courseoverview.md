...
url: https://moodledev.io/docs/5.1/apis/plugintypes/mod/courseoverview
source: sitemap
fetched_at: 2026-02-17T15:35:23.528877-03:00
rendered_js: false
word_count: 1288
summary: Explains how activity plugins can customize their information in the course overview table by implementing an integration class. It details the class structure, metadata properties for overview items, and methods for overriding fixed items like due dates.
tags:
    - moodle-development
    - activity-plugins
    - course-overview
...
The `overview` class will be loaded using [dependency injection](https://moodledev.io/docs/5.1/apis/core/di). The constructor must accept a `cm_info` object to initialize the parent class, however, the constructor can also accept other dependencies that the plugin needs.
