...
source: llms
fetched_at: 2026-01-24T14:41:44.749067765-03:00
rendered_js: false
word_count: 117
summary: This document explains how to use the docker trust revoke command to remove digital signatures from Docker image tags or entire repositories.
tags:
    - docker
    - docker-trust
    - image-signing
...
DescriptionRemove trust for an imageUsage`docker trust revoke [OPTIONS] IMAGE[:TAG]`
...
OptionDefaultDescription`-y, --yes`Do not prompt for confirmation
