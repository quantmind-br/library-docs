...
source: sitemap
fetched_at: 2026-01-24T15:52:38.102472666-03:00
rendered_js: false
word_count: 865
summary: This document announces the release of Zellij version 0.43.0, highlighting new features such as web client integration, multi-pane selection, and expanded Rust plugin APIs.
tags:
    - zellij
    - release-notes
...
![A screenshot of a Zellij session running inside a browser](https://zellij.dev/img/web-client-preview.png)
...
*Check out the new [web-client screencast](https://zellij.dev/tutorials/web-client) if you’d like to learn more.*
...
![An animated gif demonstrating the multiple select feature - first selecting 3 panes and stacking them, then selecting 3 other panes and making them floating. ](https://zellij.dev/img/multiple-select-demo.gif)
...
![An animated gif demonstrating the multiple select feature - first selecting 3 panes and stacking them, then selecting 3 other panes and making them floating. ](https://zellij.dev/img/compact-bar-tooltip-demo.gif)
...
To help sustain the project, please consider a recurring donation so that the developer can pay their bills: [https://github.com/sponsors/imsnif](https://github.com/sponsors/imsnif)