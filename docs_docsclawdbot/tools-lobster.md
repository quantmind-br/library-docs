---
title: Lobster
url: https://docs.clawd.bot/tools/lobster.md
source: llms
fetched_at: 2026-01-26T09:54:16.492780399-03:00
rendered_js: false
word_count: 1023
summary: Lobster is a typed workflow runtime for Clawdbot that enables the execution of deterministic, multi-step tool pipelines with built-in human-in-the-loop approval gates. It provides a structured DSL and CLI to manage complex AI orchestrations while ensuring safety and efficiency through resumable state tokens.
tags:
    - lobster
    - clawdbot
    - workflow-automation
...
> Typed workflow runtime for Clawdbot — composable pipelines with approval gates.
