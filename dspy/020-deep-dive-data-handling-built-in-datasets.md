---
title: Built in datasets - DSPy
url: https://dspy.ai/deep-dive/data-handling/built-in-datasets/
source: sitemap
fetched_at: 2026-01-23T08:03:08.862441175-03:00
rendered_js: false
word_count: 553
summary: This document explains how to utilize built-in datasets like HotPotQA in DSPy and provides a deep dive into the Dataset class mechanics for sampling and shuffling data. It demonstrates how to load datasets and convert them into standardized Example objects for use in training and evaluation.
tags:
    - dspy
    - data-handling
    - hotpotqa
...
[](https://github.com/stanfordnlp/dspy/blob/main/docs/docs/deep-dive/data-handling/built-in-datasets.md "Edit this page")

This page is outdated and may not be fully accurate in DSPy 2.5

## Utilizing Built-in Datasets[¶](#utilizing-built-in-datasets "Permanent link")
...
## Loading HotPotQA[¶](#loading-hotpotqa "Permanent link")
...
## Advanced: Inside DSPy's `Dataset` class (Optional)[¶](#advanced-inside-dspys-dataset-class-optional "Permanent link")
...
![Dataset Loading Process in HotPotQA Class](https://dspy.ai/deep-dive/data-handling/img/data-loading.png)
...
```
def_shuffle_and_sample(self, split, data, size, seed=0):
    data = list(data)
