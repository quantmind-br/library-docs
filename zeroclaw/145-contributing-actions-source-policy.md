...
url: https://github.com/openagen/zeroclaw/blob/master/docs/contributing/actions-source-policy.md
source: git
fetched_at: 2026-05-02T14:50:31.599357586-03:00
rendered_js: false
word_count: 374
summary: This document outlines the GitHub Actions security and source-control policy, detailing the approved action allowlist, workflow management, and the mandatory change control process for modifications.
tags:
    - github-actions
    - security-policy
    - ci-cd
...
Defines GitHub Actions source-control policy for this repository.
...
Selected allowlist (actions used across workflows):
...
- Any PR adding/changing `uses:` action sources must include allowlist impact note
...
- 2026-03-10: Renamed workflows — CI → Quality Gate, Beta Release → Release Beta, Promote Release → Release Stable. Added `lint` and `security` jobs to Quality Gate. Added Cross-Platform Build.
...
- 2026-03-05: CI build optimization — added mold linker, cargo-nextest, CARGO_INCREMENTAL=0; sccache removed due to fragile GHA cache backend
