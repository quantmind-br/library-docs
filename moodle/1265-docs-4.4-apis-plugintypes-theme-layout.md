...
url: https://moodledev.io/docs/4.4/apis/plugintypes/theme/layout
source: sitemap
fetched_at: 2026-02-17T15:03:41.001122-03:00
rendered_js: false
word_count: 1655
summary: This document explains how to define, configure, and implement theme layouts in Moodle using the config.php file and mustache templates.
tags:
    - moodle-development
    - theme-layout
    - mustache-templates
...
Layouts are defined in [`config.php`](https://moodledev.io/docs/4.4/apis/plugintypes/theme#configphp) within `$THEME->layouts`.
...
In the [`config.php`](https://moodledev.io/docs/4.4/apis/plugintypes/theme#configphp) for a theme there is a list of **layouts** which map a page type to a specific PHP page in the layout folder for the theme.
...
[Read about mustache templates](https://moodledev.io/docs/4.4/guides/templates)
