...
source: llms
fetched_at: 2026-04-16T22:35:28.839790184-03:00
rendered_js: false
word_count: 1542
summary: This document provides a comprehensive reference of the built-in tools available within Claude Code, detailing their functions and specific permission requirements.
tags:
    - claude-code
    - tool-reference
    - automation-tools
