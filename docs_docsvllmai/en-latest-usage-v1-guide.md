...
source: sitemap
fetched_at: 2026-05-07T21:15:34.896945812-03:00
rendered_js: false
word_count: 1050
summary: This document provides an overview of the vLLM V1 architecture upgrade, detailing key structural improvements, behavioral changes from V0, and the current support status for various hardware, models, and features.
tags:
    - vllm
    - v1-migration
    - llm-inference
...
Hardware Status **NVIDIA** 🟢 **AMD** 🟢 **INTEL GPU** 🟢 **TPU** 🟢 **CPU** 🟢

### Models[¶](#models "Permanent link")

Model Type Status **Decoder-only Models** 🟢 **Encoder-Decoder Models** 🟢 (Whisper), 🔴 (Others) **Pooling Models** 🟢 **Mamba Models** 🟢 **Multimodal Models** 🟢
...
For other encoder-decoder models (e.g., `MllamaForConditionalGeneration`), we recommend following a similar pattern by implementing support through the [plugin system](https://docs.vllm.ai/en/latest/design/plugin_system/).

### Features[¶](#features "Permanent link")

Feature Status **Prefix Caching** 🟢 Functional **Chunked Prefill** 🟢 Functional **LoRA** 🟢 Functional **Logprobs Calculation** 🟢 Functional **FP8 KV Cache** 🟢 Functional **Spec Decode** 🟢 Functional **Prompt Logprobs with Prefix Caching** 🟢 Functional **Structured Output Alternative Backends** 🟢 Functional **Concurrent Partial Prefills** 🟡 [In Progress](https://github.com/vllm-project/vllm/issues/14003) **best\_of** 🔴 [Removed](https://github.com/vllm-project/vllm/issues/13361) **Per-Request Logits Processors** 🔴 [Removed](https://github.com/vllm-project/vllm/pull/13360) **GPU &lt;&gt; CPU KV Cache Swapping** 🔴 Removed **Request-level Structured Output Backend** 🔴 Removed
...
- **best\_of**: This feature has been removed due to limited usage. See details at [RFC #13361](https://github.com/vllm-project/vllm/issues/13361).
