...
source: llms
fetched_at: 2026-01-26T09:50:50.801351225-03:00
rendered_js: false
word_count: 237
summary: This document provides a command reference for managing LLM models, discovery, aliases, and authentication profiles using the clawdbot CLI.
tags:
    - cli-commands
    - model-configuration
