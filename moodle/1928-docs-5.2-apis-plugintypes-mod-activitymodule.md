...
url: https://moodledev.io/docs/5.2/apis/plugintypes/mod/activitymodule
source: sitemap
fetched_at: 2026-02-17T15:44:35.402695-03:00
rendered_js: false
word_count: 673
summary: This document outlines planned improvements to the Moodle activity chooser and provides implementation details for developers to support new features like starred and recommended activities.
tags:
    - moodle-development
    - activity-chooser
    - plugin-api
