...
url: https://moodledev.io/docs/5.0/apis/plugintypes/theme/styles
source: sitemap
fetched_at: 2026-02-17T15:26:51.292076-03:00
rendered_js: false
word_count: 1355
summary: This document explains the architecture and best practices for including and organizing CSS within Moodle themes and plugins. It covers file locations, SCSS integration, and the use of page-specific body classes to prevent style collisions.
tags:
    - moodle-css
    - theme-development
    - sass-integration
