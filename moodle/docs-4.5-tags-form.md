---
title: 3 docs tagged with "form" | Moodle Developer Resources
url: https://moodledev.io/docs/4.5/tags/form
source: sitemap
fetched_at: 2026-02-17T15:07:31.077573-03:00
rendered_js: false
word_count: 130
summary: This document provides an overview of the Moodle Forms API and its components, specifically detailing the implementation of the choice dropdown field and the API's technical foundations.
tags:
    - moodle-development
    - forms-api
    - choicedropdown
...
## [Choice Dropdown](https://moodledev.io/docs/4.5/apis/subsystems/form/fields/choicedropdown)
