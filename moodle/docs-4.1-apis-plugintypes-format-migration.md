...
url: https://moodledev.io/docs/4.1/apis/plugintypes/format/migration
source: sitemap
fetched_at: 2026-02-17T14:55:22.84193-03:00
rendered_js: false
word_count: 2886
summary: Explains the architectural changes in the Moodle 4.0 course editor and provides guidance for developers to migrate course format plugins from Moodle 3.11 to the new reactive component system.
tags:
    - moodle
    - course-format
    - plugin-development
...
The first thing your plugin needs is to create that structure and link it to the output components. Follow the guide on the [create format plugin page](https://moodledev.io/docs/4.1/apis/plugintypes/format#creating-the-basic-output-structure) to know how to create the basic structure.
...
Once your plugin has the basic mustache structure, you can provide extra mustache blocks to override parts of the page. Follow the [Override mustache blocks](https://moodledev.io/docs/4.1/apis/plugintypes/format#override-mustache-blocks) on the Creating a course format page to know how to do it.
