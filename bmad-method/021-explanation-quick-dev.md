---
title: Quick Dev
url: https://docs.bmad-method.org/explanation/quick-dev/
source: sitemap
fetched_at: 2026-04-08T11:30:05.443305146-03:00
rendered_js: false
word_count: 876
summary: This document describes 'bmad-quick-dev,' a workflow designed to improve development velocity by minimizing required human intervention in LLM-assisted coding cycles. It achieves this by first clarifying intent, routing changes safely, allowing the model to run autonomously for longer stretches, and intelligently diagnosing failure points.
tags:
    - llm-workflow
    - human-in-the-loop
    - autonomous-coding
...
[Section titled “1. Compress intent first”](#1-compress-intent-first)
...
[Section titled “2. Route to the smallest safe path”](#2-route-to-the-smallest-safe-path)
...
[Section titled “3. Run longer with less supervision”](#3-run-longer-with-less-supervision)
...
[Section titled “4. Diagnose failure at the right layer”](#4-diagnose-failure-at-the-right-layer)
...
[Section titled “5. Bring the human back only when needed”](#5-bring-the-human-back-only-when-needed)
...
[Section titled “Why the Review System Matters”](#why-the-review-system-matters)
