...
url: https://moodledev.io/docs/4.1/apis/subsystems/privacy/faq
source: sitemap
fetched_at: 2026-02-17T14:56:52.415999-03:00
rendered_js: false
word_count: 723
summary: Provides guidance for Moodle developers on handling user data, privacy providers, and metadata declarations across various plugin types and scenarios.
tags:
    - moodle-development
    - privacy-api
    - user-data-handling
