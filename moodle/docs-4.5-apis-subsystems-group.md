...
url: https://moodledev.io/docs/4.5/apis/subsystems/group
source: sitemap
fetched_at: 2026-02-17T15:14:34.650287-03:00
rendered_js: false
word_count: 1041
summary: This document explains the Moodle Groups API and how developers can implement group support and access control within activity modules. It covers group modes, visibility settings, and core functions for managing user collections and groupings.
tags:
    - moodle-development
    - groups-api
    - access-control
