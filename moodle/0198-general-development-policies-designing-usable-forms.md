---
title: Designing usable forms | Moodle Developer Resources
url: https://moodledev.io/general/development/policies/designing-usable-forms
source: sitemap
fetched_at: 2026-02-17T15:59:16.281193-03:00
rendered_js: false
word_count: 1009
summary: This document provides best practices for designing user-friendly forms and configuration pages, focusing on clear labeling, descriptive section naming, and logical organizational structure. It outlines strategies for improving the flow and usability of both simple and complex interfaces.
tags:
    - form-design
    - user-experience
    - ui-guidelines
...
The terms *settings* and *fields* are used interchangeably here because these instructions apply to both the configuration of administration, and forms.

## Labelling settings[​](#labelling-settings "Direct link to Labelling settings")

All fields in a form should have a descriptive label (not too long) that gives a clear idea of what the setting is for.

Do not rely on *Help* popups to compensate for a poor label. If the user has to open and read the *Help* popup to find out what the setting is about, then your label is not clear enough.

## Naming sections[​](#naming-sections "Direct link to Naming sections")
...
### Be accurate, clear, and concise[​](#be-accurate-clear-and-concise "Direct link to Be accurate, clear, and concise")
...
### Avoid ambiguous names[​](#avoid-ambiguous-names "Direct link to Avoid ambiguous names")
...
## Re-use existing names[​](#re-use-existing-names "Direct link to Re-use existing names")
...
### Avoid using 'Options' or 'Settings'[​](#avoid-using-options-or-settings "Direct link to Avoid using 'Options' or 'Settings'")
...
### Merging sections[​](#merging-sections "Direct link to Merging sections")
...
## Use 'Show more/less' advanced settings sparingly[​](#use-show-moreless-advanced-settings-sparingly "Direct link to Use 'Show more/less' advanced settings sparingly")
...
## Adequate number of fields and sections[​](#adequate-number-of-fields-and-sections "Direct link to Adequate number of fields and sections")
...
## Expanding more sections[​](#expanding-more-sections "Direct link to Expanding more sections")
...
## Think about the flow[​](#think-about-the-flow "Direct link to Think about the flow")
