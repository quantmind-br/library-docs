---
title: Links in the Moodle App | Moodle Developer Resources
url: https://moodledev.io/general/app/development/link-handling/app-links
source: sitemap
fetched_at: 2026-02-17T15:54:31.745742-03:00
rendered_js: false
word_count: 639
summary: This document explains how the Moodle app handles internal and external links and provides instructions on customizing link behavior using specific data attributes and link handlers.
tags:
    - moodle-app
    - link-handling
    - mobile-development
...
## Pressing a link inside the app[​](#pressing-a-link-inside-the-app "Direct link to Pressing a link inside the app")
...
## Extending the list of supported URLs[​](#extending-the-list-of-supported-urls "Direct link to Extending the list of supported URLs")

The app has a defined list of supported URLs. If you have a plugin adapted to work in the app and you want to support links to your plugin you will need to create a Link Handler. For more information and examples about this, please see the [CoreContentLinksDelegate](https://moodledev.io/general/app/development/plugins-development-guide/api-reference#corecontentlinksdelegate) documentation.

## Opening links in an embedded browser[​](#opening-links-in-an-embedded-browser "Direct link to Opening links in an embedded browser")

To open a link in an embedded browser instead of an external browser you can use the `data-open-in` attribute:

```
<ahref="https://domain.com"data-open-in="app">
```
...
## Adding links to any HTML element[​](#adding-links-to-any-html-element "Direct link to Adding links to any HTML element")
...
```
<buttondata-app-url="https://domain.com">
```
...
```
<ahref="https://domain.com"data-app-url="https://anotherdomain.com"></a>
```
