...
url: https://moodledev.io/docs/4.4/apis/subsystems/form/fields/choicedropdown
source: sitemap
fetched_at: 2026-02-17T15:04:35.581177-03:00
rendered_js: false
word_count: 121
summary: This document explains how to implement the choicedropdown form field and the choicelist data definition to create rich dropdown menus with icons and descriptions.
tags:
    - choicedropdown
    - choicelist
    - form-api
