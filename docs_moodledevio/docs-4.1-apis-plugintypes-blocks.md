...
url: https://moodledev.io/docs/4.1/apis/plugintypes/blocks
source: sitemap
fetched_at: 2026-02-17T14:55:13.270414-03:00
rendered_js: false
word_count: 2077
summary: This document explains the standard file structure and implementation requirements for creating block plugins in Moodle, including class definitions and mandatory configuration files.
tags:
    - moodle
    - block-plugins
    - plugin-development
