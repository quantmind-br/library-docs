...
url: https://moodledev.io/docs/5.0/apis/core/htmlwriter
source: sitemap
fetched_at: 2026-02-17T15:24:47.44739-03:00
rendered_js: false
word_count: 56
summary: This document explains how to use the Moodle html_writer class to programmatically generate HTML tags within renderer functions.
tags:
    - moodle
    - html-writer
    - php
...
Please consider using [templates](https://moodledev.io/docs/5.0/guides/templates) as an alternative to the *HTML writer*.
