---
title: Git guide
url: https://ratatui.rs/developer-guide/git-guide/
source: crawler
fetched_at: 2026-02-01T21:13:36.772738785-03:00
rendered_js: false
word_count: 1406
summary: This document outlines the Git conventions and practices for project contributors, covering essential workflows such as Git LFS, commit signing, and rebasing. It provides instructional steps for managing large files and maintaining a clean commit history through squashing and amending.
tags:
    - git-workflow
    - git-lfs
    - commit-signing
...
[Section titled “The Basic Workflow”](#the-basic-workflow)
...
[Section titled “Setting up images with Git LFS”](#setting-up-images-with-git-lfs)
...
gitaddsrc/content/docs/developer-guide/picture.png
gitcommit-m“Addedpicture.png”
```
...
[Section titled “How to sign your commits”](#how-to-sign-your-commits)
...
[Section titled “Skipping the pre-commit hooks”](#skipping-the-pre-commit-hooks)
...
![Updating a branch on Github](https://ratatui.rs/_astro/github-update.CdvqM4QF_Z1iTIfQ.webp)

### Squashing commits

[Section titled “Squashing commits”](#squashing-commits)
...
gitcommit--amend-m"updated commit message”
```
...
[Section titled “Solving upstream issues”](#solving-upstream-issues)

When you fork a repository, you can avoid a lot of issues by using the following command:

```

gitremoteaddupstreamhttps://github.com/ratatui/ratatui.git
```
