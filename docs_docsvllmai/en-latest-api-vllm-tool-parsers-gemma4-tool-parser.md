---
title: gemma4_tool_parser - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/tool_parsers/gemma4_tool_parser/
source: sitemap
fetched_at: 2026-05-07T21:35:57.857022937-03:00
rendered_js: false
word_count: 62
summary: This document defines the Gemma4ToolParser class, which manages the parsing and streaming of tool calls from Google Gemma4 models using a custom accumulate-then-parse-then-diff strategy.
tags:
    - gemma4
    - tool-parsing
    - streaming-logic
...
```
classGemma4ToolParser(ToolParser):
"""
...
"""Reset all streaming state for a new request."""
    ...
    def_buffer_delta_text(self, delta_text: str) -> str:
...
"""Tag-counting streaming parser.
    ...
    def_extract_partial_call(self, current_text: str) -> tuple[str | None, str]:
"""Extract function name and raw argument string from partial text.
    ...
    def_handle_tool_call_middle(self, current_text: str) -> DeltaMessage | None:
"""Handle streaming when we're inside an active tool call.
    ...
    def_handle_tool_call_end(self, current_text: str) -> DeltaMessage | None:
"""Handle streaming when a tool call has just completed.
    ...
    def_emit_argument_diff(self, raw_args_str: str) -> DeltaMessage | None:
