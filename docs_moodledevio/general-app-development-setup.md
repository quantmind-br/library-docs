---
title: Setting up your development environment for the Moodle App | Moodle Developer Resources
url: https://moodledev.io/general/app/development/setup
source: sitemap
fetched_at: 2026-02-17T15:54:57.269748-03:00
rendered_js: false
word_count: 1193
summary: This document provides instructions for setting up the development environment for the Moodle App, covering installation requirements and procedures for running the application in a browser or on native mobile devices.
tags:
    - moodle-app
    - environment-setup
    - mobile-development
...
- You can find [troubleshooting advices in a separate page](https://moodledev.io/general/app/development/setup/troubleshooting). If you encounter a problem that is not already listed, please consider adding it.
...
If you are just [adding mobile support to plugins](https://moodledev.io/general/app/development/plugins-development-guide), you probably don't need to build the app yourself and you can skip reading this page.

## Requirements[​](#requirements "Direct link to Requirements")

### Install a browser for development[​](#install-a-browser-for-development "Direct link to Install a browser for development")
...
To learn more about using a browser for development, and why it needs to be Chromium-based, read the [Using the Moodle App in a browser](https://moodledev.io/general/app/development/setup/app-in-browser) page.

### Install git[​](#install-git "Direct link to Install git")
...
### Install native SDKs[​](#install-native-sdks "Direct link to Install native SDKs")
...
### Windows only: Native build dependencies[​](#windows-only-native-build-dependencies "Direct link to Windows only: Native build dependencies")
...
### Mac only: Push notifications[​](#mac-only-push-notifications "Direct link to Mac only: Push notifications")
...
## Running the app in a browser[​](#running-the-app-in-a-browser "Direct link to Running the app in a browser")
...
This will launch the application in a browser and you should be ready to start coding (you may also want to [configure the default browser](https://moodledev.io/general/app/development/setup/app-in-browser#configuring-the-default-browser) for future runs). This compiles the entire application and can take a while, so don't worry if it doesn't open the browser instantly. Keep in mind that this command may open the browser before the dev server is ready, and you could get a network error. If that happens, just wait until the dev server is ready and launch the application again. It should be ready when you see a "Compiled successfully" message in the console.
...
## Running the app in Android and iOS[​](#running-the-app-in-android-and-ios "Direct link to Running the app in Android and iOS")
...
If you get any errors while building, please see the [Troubleshooting](https://moodledev.io/general/app/development/setup/troubleshooting) section.
...
### Developing using Live Reload[​](#developing-using-live-reload "Direct link to Developing using Live Reload")
...
### Compiling using AOT[​](#compiling-using-aot "Direct link to Compiling using AOT")
