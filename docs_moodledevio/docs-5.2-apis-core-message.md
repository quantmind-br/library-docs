...
url: https://moodledev.io/docs/5.2/apis/core/message
source: sitemap
fetched_at: 2026-02-17T15:43:37.472811-03:00
rendered_js: false
word_count: 811
summary: This document provides technical guidance on using the Moodle Messaging API to programmatically send notifications and messages to users. It covers registering message producers, configuring defaults, and implementing message sending logic within Moodle plugins.
tags:
    - moodle-api
    - messaging-system
    - php-development
