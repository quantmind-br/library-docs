...
url: https://moodledev.io/docs/5.2/guides/javascript/yui/namespacing
source: sitemap
fetched_at: 2026-02-17T15:47:08.610142-03:00
rendered_js: false
word_count: 204
summary: This document defines the naming conventions and structure for Moodle-specific YUI modules to ensure consistent sandboxing and namespace isolation.
tags:
    - moodle
    - yui
    - javascript
