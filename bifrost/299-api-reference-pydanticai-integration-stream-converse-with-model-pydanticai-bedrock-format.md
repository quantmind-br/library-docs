...
````yaml openapi/openapi.json post /pydanticai/bedrock/model/{modelId}/converse-stream
openapi: 3.1.0
info:
  title: Bifrost API
  description: >
...
paths:
  /pydanticai/bedrock/model/{modelId}/converse-stream:
    post:
      ...
      description: >
        Streams messages using AWS Bedrock Converse-compatible format via
        PydanticAI.
          ...
          content:
            application/x-amz-eventstream:
              schema:
                type: object
                description: >-
                  Flat structure for streaming events matching actual Bedrock
                  API response
                properties:
                  role:
                    type: string
