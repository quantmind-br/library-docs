...
url: https://epi052.github.io/feroxbuster-docs/examples/detect-directory-listing
source: github_pages
fetched_at: 2026-02-06T10:55:16.618131472-03:00
rendered_js: true
word_count: 289
summary: This document explains how feroxbuster identifies directory listings using standard page title analysis and advanced heuristic signals to automate web reconnaissance.
tags:
    - feroxbuster
    - directory-listing
    - web-security
...
[Section titled “Detect Directory Listing”](#detect-directory-listing)
...
[Section titled “Detection Methods”](#detection-methods)

### Standard Detection (v2.5.0+)

[Section titled “Standard Detection (v2.5.0+)”](#standard-detection-v250)
...
[Section titled “Enhanced Heuristic Detection (v2.13.1+)”](#enhanced-heuristic-detection-v2131)
...
![dir-list-no-tack-e](https://epi052.github.io/feroxbuster-docs/images/examples/dir-list-no-tack-e.png)
...
![dir-list-with-tack-e](https://epi052.github.io/feroxbuster-docs/images/examples/dir-list-with-tack-e.png)