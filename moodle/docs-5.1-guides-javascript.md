...
url: https://moodledev.io/docs/5.1/guides/javascript
source: sitemap
fetched_at: 2026-02-17T15:37:39.881266-03:00
rendered_js: false
word_count: 2046
summary: This guide explains the standards and practices for implementing JavaScript in Moodle, including the ES2015 module format, naming conventions, and basic event handling.
tags:
    - moodle
    - javascript
    - es2015
...
See the [Creating reactive UI](https://moodledev.io/docs/5.1/guides/javascript/reactive) for more information.
