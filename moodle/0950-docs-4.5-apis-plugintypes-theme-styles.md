...
url: https://moodledev.io/docs/4.5/apis/plugintypes/theme/styles
source: sitemap
fetched_at: 2026-02-17T15:12:59.595391-03:00
rendered_js: false
word_count: 1355
summary: This document explains how CSS and SCSS are integrated into Moodle themes, detailing file locations, pre-processor usage, and the system of unique body IDs and classes used for page-specific styling.
tags:
    - moodle
    - css
    - scss
