...
url: https://doc.rust-lang.org/src/alloc/bstr.rs.html#567
source: crawler
fetched_at: 2026-05-06T21:23:56.855498123-03:00
rendered_js: false
word_count: 2582
summary: This document defines the ByteString type, an owned, growable wrapper for Vec<u8> designed to handle string data that may contain non-UTF-8 sequences.
tags:
    - rust
    - bytestring
    - string-processing
