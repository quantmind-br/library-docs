...
source: sitemap
fetched_at: 2026-01-24T13:32:58.462744178-03:00
rendered_js: false
word_count: 415
summary: This document provides step-by-step instructions for contributing plugins and themes to the DankMaterialShell registry, including JSON schema requirements and validation procedures.
tags:
    - dank-material-shell
    - plugin-development
    - theme-creation
