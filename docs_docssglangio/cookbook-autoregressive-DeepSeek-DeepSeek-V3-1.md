---
title: DeepSeek-V3.1 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/DeepSeek/DeepSeek-V3_1
source: sitemap
fetched_at: 2026-05-11T05:50:56.098026015-03:00
rendered_js: false
word_count: 826
summary: This document provides instructions for deploying and invoking DeepSeek V3.1 and V3.1-Terminus models using the SGLang inference server, specifically detailing the configuration for reasoning parsers and tool calling capabilities.
tags:
    - sglang
    - deepseek
    - model-deployment
...
- [Basic API Usage](https://docs.sglang.io/docs/get-started/quickstart)
