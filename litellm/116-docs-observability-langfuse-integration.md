---
title: "\U0001FAA2 Langfuse - Logging LLM Input/Output | liteLLM"
...
For Langfuse v3, we recommend using the [Langfuse OTEL](https://docs.litellm.ai/docs/observability/langfuse_otel_integration) integration.
...
👉 [**Follow this link to start sending logs to langfuse with LiteLLM Proxy server**](https://docs.litellm.ai/docs/proxy/logging)
...
Get your Langfuse API Keys from [https://cloud.langfuse.com/](https://cloud.langfuse.com/)
...
#### Set Custom Generation Names, pass Metadata[​](#set-custom-generation-names-pass-metadata "Direct link to Set Custom Generation Names, pass Metadata")
...
#### Set Custom Trace ID, Trace User ID, Trace Metadata, Trace Version, Trace Release and Tags[​](#set-custom-trace-id-trace-user-id-trace-metadata-trace-version-trace-release-and-tags "Direct link to Set Custom Trace ID, Trace User ID, Trace Metadata, Trace Version, Trace Release and Tags")
...
#### Trace & Generation Parameters[​](#trace--generation-parameters "Direct link to Trace & Generation Parameters")

##### Trace Specific Parameters[​](#trace-specific-parameters "Direct link to Trace Specific Parameters")
...
##### Updatable Parameters on Continuation[​](#updatable-parameters-on-continuation "Direct link to Updatable Parameters on Continuation")
...
#### Generation Specific Parameters[​](#generation-specific-parameters "Direct link to Generation Specific Parameters")
...
#### Disable Logging - Specific Calls[​](#disable-logging---specific-calls "Direct link to Disable Logging - Specific Calls")
...
Pass `trace_user_id`, `session_id` in model\_kwargs
...
### Redacting Messages, Response Content from Langfuse Logging[​](#redacting-messages-response-content-from-langfuse-logging "Direct link to Redacting Messages, Response Content from Langfuse Logging")

#### Redact Messages and Responses from all Langfuse Logging[​](#redact-messages-and-responses-from-all-langfuse-logging "Direct link to Redact Messages and Responses from all Langfuse Logging")

Set `litellm.turn_off_message_logging=True` This will prevent the messages and responses from being logged to langfuse, but request metadata will still be logged.

#### Redact Messages and Responses from specific Langfuse Logging[​](#redact-messages-and-responses-from-specific-langfuse-logging "Direct link to Redact Messages and Responses from specific Langfuse Logging")
...
### Data not getting logged to Langfuse ?[​](#data-not-getting-logged-to-langfuse- "Direct link to Data not getting logged to Langfuse ?")
