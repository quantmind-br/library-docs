...
source: llms
fetched_at: 2026-01-26T09:52:43.391584964-03:00
rendered_js: false
word_count: 548
summary: This document provides step-by-step instructions for connecting the Android companion node app to a central Gateway, including networking configuration, pairing procedures, and feature usage.
tags:
    - android-node
    - gateway-pairing
    - mdns-discovery
