...
source: crawler
fetched_at: 2026-02-27T23:38:17.78427-03:00
rendered_js: true
word_count: 1863
summary: This document explains the core concepts and attributes of Spotify playlists, including visibility statuses, collaborative features, required authorization scopes, and the handling of local files through the Web API.
tags:
    - spotify-api
    - playlists
    - web-api
