---
title: "null"
url: https://docs.clawd.bot/tools/elevated.md
source: llms
fetched_at: 2026-01-26T09:54:13.865126717-03:00
rendered_js: false
word_count: 442
summary: This document explains the functionality and configuration of Elevated Mode directives, which allow users to control tool execution environments and security approvals. It covers command syntax, session-based overrides, and the hierarchy of permission gates for sandboxed agents.
tags:
    - elevated-mode
    - bot-directives
    - security-policy
