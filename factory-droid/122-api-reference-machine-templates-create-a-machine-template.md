...
source: llms
fetched_at: 2026-02-05T21:40:01.805102244-03:00
rendered_js: false
word_count: 64
summary: This document defines the API endpoint and schema for creating machine templates, including repository configuration, environment variables, and setup scripts.
tags:
    - machine-templates
    - factory-api
    - rest-api
