...
By specifying 'allowed\_model\_region' for a customer, LiteLLM will filter-out any models in a model group which is not in the allowed region (i.e. 'eu').

[**See Code**](https://github.com/BerriAI/litellm/blob/5eb12e30cc5faa73799ebc7e48fc86ebf449c879/litellm/router.py#L2938)

### 1. Create customer with region-specification[​](#1-create-customer-with-region-specification "Direct link to 1. Create customer with region-specification")
...
### 2. Add eu models to model-group[​](#2-add-eu-models-to-model-group "Direct link to 2. Add eu models to model-group")

Add eu models to a model group. Use the 'region\_name' param to specify the region for each model.
