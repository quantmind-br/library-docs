...
url: https://danklinux.com/docs/1.2/dankmaterialshell/nixos-flake
source: sitemap
fetched_at: 2026-02-22T18:43:06.040264-03:00
rendered_js: false
word_count: 1052
summary: This document provides instructions for installing and configuring DankMaterialShell on NixOS using flakes, covering both NixOS and Home-Manager modules as well as niri compositor integration.
tags:
    - nixos
    - home-manager
    - flakes
...
DankMaterialShell is now available in nixpkgs unstable! If you're on NixOS unstable (26.05), see [Installation - NixOS](https://danklinux.com/docs/1.2/dankmaterialshell/nixos) for the native nixpkgs installation method which doesn't require flakes.
...
If `niri.enableKeybinds = true` conflicts with your existing niri configuration, you can disable it and manually configure keybindings using the examples in the [Keybinds & IPC](https://danklinux.com/docs/1.2/dankmaterialshell/keybinds-ipc) guide.

## Next Steps[​](#next-steps "Direct link to Next Steps")

- Configure your preferences via [Themes](https://danklinux.com/docs/1.2/dankmaterialshell/application-themes)
- Set up compositor keybindings in [Keybinds & IPC](https://danklinux.com/docs/1.2/dankmaterialshell/keybinds-ipc)
- Extend functionality with [Plugins](https://danklinux.com/docs/1.2/dankmaterialshell/plugins-overview)