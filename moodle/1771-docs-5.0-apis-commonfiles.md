...
url: https://moodledev.io/docs/5.0/apis/commonfiles
source: sitemap
fetched_at: 2026-02-17T15:23:51.128376-03:00
rendered_js: false
word_count: 2704
summary: This document outlines the standard file structure and mandatory components required for developing Moodle plugins and subsystems, detailing the purpose of core files like version.php and database scripts.
tags:
    - moodle-development
    - plugin-structure
    - file-conventions
...
This page describes the common files which may be present in any Moodle subsystem or [plugin type](https://moodledev.io/docs/5.0/apis/plugintypes). Some of these files are mandatory and **must** exist within a component, whilst others are optional.
...
See the [Upgrade API](https://moodledev.io/docs/5.0/guides/upgrade) documentation for further information.
...
The [install.xml](https://moodledev.io/docs/5.0/apis/commonfiles#dbinstallxml) schema must match the schema generated by the upgrade at all times.
...
See the [Upgrade API](https://moodledev.io/docs/5.0/guides/upgrade) documentation for more information on the upgrade process.
...
Access control is handled in Moodle by the use of Roles, and Capabilities. You can read more about these in the [Access API](https://moodledev.io/docs/5.0/apis/subsystems/access) documentation.
...
See the [Message API](https://moodledev.io/docs/5.0/apis/core/message) documentation for further information.
...
See [db/tasks.php](https://moodledev.io/docs/5.0/apis/commonfiles/db-tasks.php) for full details of the file format.
...
Full details on how to create settings are available in the [Admin settings](https://moodledev.io/docs/5.0/apis/subsystems/admin) documentation.
...
The [Moodle JavaScript Guide](https://moodledev.io/docs/5.0/guides/javascript) has detailed information and examples on writing JavaScript in Moodle. Further information is also available in the [JavaScript Modules](https://moodledev.io/docs/5.0/guides/javascript/modules) documentation.
...
In older versions of Moodle, JavaScript was written in the YUI format. This is being phased out in favour of [JavaScript Modules](https://moodledev.io/docs/5.0/guides/javascript/modules), although some older uses still remain in Moodle core.

- [YUI/Modules](https://moodledev.io/docs/5.0/guides/javascript/yui/modules)
- [YUI](https://moodledev.io/docs/5.0/guides/javascript/yui)

caution

New YUI code will not be accepted into Moodle core, except for new plugins for the [Atto editor](https://moodledev.io/docs/5.0/apis/plugintypes/atto).
...
- [Plugin types](https://moodledev.io/docs/5.0/apis/plugintypes) - list of all supported plugin types
