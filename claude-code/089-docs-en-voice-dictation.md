...
source: llms
fetched_at: 2026-04-16T22:35:46.974020805-03:00
rendered_js: false
word_count: 1217
summary: This document provides instructions and requirements for using the voice dictation feature in Claude Code to transcribe spoken prompts into text.
tags:
    - claude-code
    - voice-dictation
    - user-interface
