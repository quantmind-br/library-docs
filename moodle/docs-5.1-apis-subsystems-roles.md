...
url: https://moodledev.io/docs/5.1/apis/subsystems/roles
source: sitemap
fetched_at: 2026-02-17T15:37:10.067449-03:00
rendered_js: false
word_count: 1439
summary: This document explains the Moodle Roles API, detailing how roles, capabilities, permissions, and contexts work together to control user access and manage system security risks.
tags:
    - moodle-api
    - access-control
