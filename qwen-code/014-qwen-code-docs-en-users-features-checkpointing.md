...
source: github_pages
fetched_at: 2026-04-09T09:05:49.675425323-03:00
rendered_js: true
word_count: 460
summary: This document explains Qwen Code's Checkpointing feature, which automatically saves project states before AI file modifications, allowing users to safely revert changes using the /restore command. It also details how to enable this safety feature via command-line flags or settings.
tags:
    - checkpointing
    - version-control
    - state-management
...
### Using the `settings.json` File[](#using-the-settingsjson-file)
...
### List Available Checkpoints[](#list-available-checkpoints)
...
### Restore a Specific Checkpoint[](#restore-a-specific-checkpoint)
...
[Headless Mode](https://qwenlm.github.io/qwen-code-docs/en/users/features/headless/ "Headless Mode")[MCP](https://qwenlm.github.io/qwen-code-docs/en/users/features/mcp/ "MCP")