---
title: Options
url: https://docs.mitmproxy.org/stable/concepts/options/#tcp_hosts
source: crawler
fetched_at: 2026-01-28T16:19:00.217294861-03:00
rendered_js: false
word_count: 3208
summary: This document explains the comprehensive options mechanism used by mitmproxy tools, detailing how options control runtime behavior via a shared YAML configuration file or command-line flags.
tags:
    - mitmproxy
    - configuration
    - options
