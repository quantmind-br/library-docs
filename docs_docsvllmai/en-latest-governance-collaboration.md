---
title: Collaboration Policy - vLLM
url: https://docs.vllm.ai/en/latest/governance/collaboration/
source: sitemap
fetched_at: 2026-05-07T21:14:49.861665067-03:00
rendered_js: false
word_count: 602
summary: This document defines the governance and collaboration processes for contributing major features, integrating new model architectures, and adding hardware support to the vLLM project.
tags:
    - project-governance
...
If you use vLLM, we recommend you making the model work with vLLM by following the [model registration](https://docs.vllm.ai/en/latest/contributing/model/registration/) process before you release it publicly.

The vLLM team helps with new model architectures not supported by vLLM, especially models pushing architectural frontiers. Here's how the vLLM team works with model providers. The vLLM team includes all [committers](https://docs.vllm.ai/en/latest/governance/committers/) of the project. Model providers can exclude certain members but shouldn't, as this may harm release timelines due to missing expertise. Contact [project leads](https://docs.vllm.ai/en/latest/governance/process/) if you want to collaborate.
