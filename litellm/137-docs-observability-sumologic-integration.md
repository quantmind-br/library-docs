...
Sumo Logic is a cloud-native machine data analytics platform that provides real-time insights into your applications and infrastructure. [https://www.sumologic.com/](https://www.sumologic.com/)
...
1. Create a Sumo Logic account at [https://www.sumologic.com/](https://www.sumologic.com/)
...
## What Data is Logged?[​](#what-data-is-logged "Direct link to What Data is Logged?")
...
#### Changing the Log Format (Advanced)[​](#changing-the-log-format-advanced "Direct link to Changing the Log Format (Advanced)")
...
### Batching Settings[​](#batching-settings "Direct link to Batching Settings")
...
### Compressed Data[​](#compressed-data "Direct link to Compressed Data")
...
### Query Logs in Sumo Logic[​](#query-logs-in-sumo-logic "Direct link to Query Logs in Sumo Logic")
...
```
_sourceCategory=litellm
| json "start_time","end_time"asstart,end
...
```
_sourceCategory=litellm
| json "model_parameters.user"asuser
| count byuser
```
...
## Getting Your Sumo Logic URL[​](#getting-your-sumo-logic-url "Direct link to Getting Your Sumo Logic URL")
...
### Logs not appearing in Sumo Logic[​](#logs-not-appearing-in-sumo-logic "Direct link to Logs not appearing in Sumo Logic")
...
### No authentication errors[​](#no-authentication-errors "Direct link to No authentication errors")
