---
title: Quickstart - SGLang Documentation
url: https://docs.sglang.io/docs/get-started/quickstart
source: sitemap
fetched_at: 2026-05-11T05:51:12.564306006-03:00
rendered_js: false
word_count: 251
summary: This guide provides instructions for installing SGLang, launching inference servers, and interacting with models through both OpenAI-compatible APIs and native SGLang methods.
tags:
    - sglang
    - llm-inference
    - model-deployment
...
The Docker images are available on Docker Hub at [lmsysorg/sglang](https://hub.docker.com/r/lmsysorg/sglang/tags).Replace `<secret>` with your [Hugging Face token](https://huggingface.co/docs/hub/en/security-tokens):
