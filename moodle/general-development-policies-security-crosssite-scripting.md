---
title: Cross-site scripting | Moodle Developer Resources
url: https://moodledev.io/general/development/policies/security/crosssite-scripting
source: sitemap
fetched_at: 2026-02-17T15:59:38.62636-03:00
rendered_js: false
word_count: 949
summary: This document explains the risks of Cross-Site Scripting (XSS) in Moodle and provides instructions for developers and administrators on how to prevent these vulnerabilities using specific input cleaning and output escaping functions.
tags:
    - xss-prevention
    - moodle-security
    - input-cleaning
...
### Escaping output[​](#escaping-output "Direct link to Escaping output")
...
### Escaping output 2 - JavaScript[​](#escaping-output-2---javascript "Direct link to Escaping output 2 - JavaScript")
...
The best solution is to not echo JavaScript like this. Instead, follow the [JavaScript guidelines](https://moodledev.io/docs/5.2/guides/javascript), and put your JavaScript in an external file, and communicate with it using `$PAGE->requires->data_for_js` or `$PAGE->requires->js_function_call`. Those two methods properly encode any PHP data to be passed to JavaScript using `json_encode`.

### Cleaning input[​](#cleaning-input "Direct link to Cleaning input")
...
- Alternatively, use a [moodleforms](https://moodledev.io/docs/5.2/apis/subsystems/form), with appropriate `->setType` calls in the form definition.
...
Follow the [Output functions](https://moodledev.io/docs/5.2/apis/subsystems/output#output-functions) link to get a best understanding of how dynamic data should be sent from Moodle to the browser.
