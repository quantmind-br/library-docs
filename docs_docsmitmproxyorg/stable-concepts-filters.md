...
source: crawler
fetched_at: 2026-01-28T15:01:10.193425929-03:00
rendered_js: false
word_count: 259
summary: This document explains how to use filter expressions in mitmproxy for matching and selecting flows based on various criteria.
tags:
    - mitmproxy
    - filter-expressions
    - flow-matching
