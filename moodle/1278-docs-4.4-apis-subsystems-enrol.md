...
url: https://moodledev.io/docs/4.4/apis/subsystems/enrol
source: sitemap
fetched_at: 2026-02-17T15:04:03.14901-03:00
rendered_js: false
word_count: 886
summary: This document explains the Moodle enrolment API, detailing the technical distinction between user enrolments and role assignments while providing functional methods for managing course participation. It describes how to programmatically check enrolment status, retrieve participant lists, and interact with enrolment plugins to modify user records.
tags:
    - enrolment-api
    - moodle-development
    - user-management
...
The enrolment API gives access to the enrolment methods and also to [enrolment plugins](https://moodledev.io/docs/4.4/apis/plugintypes/enrol) instances.
