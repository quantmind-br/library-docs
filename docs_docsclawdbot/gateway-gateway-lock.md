...
source: llms
fetched_at: 2026-01-26T09:51:58.056663439-03:00
rendered_js: false
word_count: 222
summary: This document explains the mechanism and rationale behind gateway locking, which prevents multiple instances from binding to the same port and ensures clean resource release after process exits.
tags:
    - gateway-lock
    - process-concurrency
    - socket-binding
