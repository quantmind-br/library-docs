...
source: llms
fetched_at: 2026-02-05T21:45:05.708544904-03:00
rendered_js: false
word_count: 2191
summary: This reference guide provides technical specifications for implementing Droid hooks, including configuration structures, event triggers, and data input schemas. It explains how to automate shell commands in response to lifecycle events such as tool usage, session changes, and user prompts.
tags:
    - droid-hooks
    - event-handling
    - automation
