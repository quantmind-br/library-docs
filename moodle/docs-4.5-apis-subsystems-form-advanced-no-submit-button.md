...
url: https://moodledev.io/docs/4.5/apis/subsystems/form/advanced/no-submit-button
source: sitemap
fetched_at: 2026-02-17T15:14:22.447228-03:00
rendered_js: false
word_count: 156
summary: This document explains how to implement and handle non-submitting buttons in Moodle forms using the no_submit_button_pressed method to trigger sub-actions without full form processing.
tags:
    - moodle-forms
    - php-development
    - form-handling
