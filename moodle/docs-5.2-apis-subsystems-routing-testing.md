...
url: https://moodledev.io/docs/5.2/apis/subsystems/routing/testing
source: sitemap
fetched_at: 2026-02-17T15:46:28.905862-03:00
rendered_js: false
word_count: 501
summary: "This document explains how to unit test Moodle routes using the \route_testcase class and provides instructions for mocking routes and processing requests."
tags:
    - moodle
    - unit-testing
    - routing
...
One of the benefits of using routes is how easy they are to unit test. It is also possible to test [parameters](https://moodledev.io/docs/5.2/apis/subsystems/routing/parameters) for validation, which is especially useful for [mapped parameters](https://moodledev.io/docs/5.2/apis/subsystems/routing/parameters#mapped-parameters).
