...
url: https://moodledev.io/docs/4.1/apis/subsystems/form/usage
source: sitemap
fetched_at: 2026-02-17T14:56:42.088653-03:00
rendered_js: false
word_count: 488
summary: This document provides an overview of Moodle's Form API, explaining how to create form classes, handle data submission, and integrate forms into activity modules.
tags:
    - moodle
    - form-api
    - php
