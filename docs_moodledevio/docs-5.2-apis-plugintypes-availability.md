...
url: https://moodledev.io/docs/5.2/apis/plugintypes/availability
source: sitemap
fetched_at: 2026-02-17T15:44:03.666317-03:00
rendered_js: false
word_count: 747
summary: This document provides a technical guide for developing Moodle availability condition plugins, detailing the required file structure and PHP class implementations.
tags:
    - moodle-development
    - availability-api
    - plugin-development
...
Availability conditions allow teachers to restrict an activity or section so that only certain users can access it. These are accessed using the [Availability API](https://moodledev.io/docs/5.2/apis/subsystems/availability).
...
Some of the important files for the format plugintype are described below. See the [common plugin files](https://moodledev.io/docs/5.2/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
...
- Using the [Availability API as a consumer](https://moodledev.io/docs/5.2/apis/subsystems/availability)
- [Conditional activities API](https://moodledev.io/docs/5.2/apis/core/conditionalactivities)