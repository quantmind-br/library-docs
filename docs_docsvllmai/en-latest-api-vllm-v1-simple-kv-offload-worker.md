---
title: worker - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/simple_kv_offload/worker/
source: sitemap
fetched_at: 2026-05-07T21:41:43.264522982-03:00
rendered_js: false
word_count: 0
summary: This document defines the SimpleCPUOffloadWorker class, which manages the asynchronous offloading of GPU KV cache blocks to pinned CPU memory to optimize memory usage during model execution.
tags:
    - kv-cache
    - cpu-offloading
    - gpu-memory
...
"""Register GPU KV caches and allocate pinned CPU tensors.
        ...
        def_repr_tensor(v: torch.Tensor | list[torch.Tensor]) -> torch.Tensor:
    ...
    defbind_connector_metadata(self, metadata: SimpleCPUOffloadMetadata) -> None:
...
"""Submit transfers and report completed events to the scheduler.
    ...
    defbuild_connector_worker_meta(self) -> SimpleCPUOffloadWorkerMetadata | None:
...
"""Sync all in-flight transfers before preempted blocks are reused."""
    ...
    def_flush_and_sync_all(self) -> None:
"""Synchronize all in-flight transfer events."""
    ...
    def_poll_stream_events(self, is_store: bool) -> int:
