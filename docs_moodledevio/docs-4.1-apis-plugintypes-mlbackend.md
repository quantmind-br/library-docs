...
url: https://moodledev.io/docs/4.1/apis/plugintypes/mlbackend
source: sitemap
fetched_at: 2026-02-17T14:55:27.835062-03:00
rendered_js: false
word_count: 662
summary: This document explains how machine learning backends process Moodle datasets for training and prediction through the Analytics API. It details the internal architecture, core backend options like PHP and Python, and the PHP interfaces required for implementing custom predictors.
tags:
    - moodle-development
    - machine-learning
    - analytics-api
...
Machine learning backends process the datasets generated from the indicators and targets calculated by the [Analytics API](https://moodledev.io/docs/4.1/apis/subsystems/analytics). They are used for machine learning training, prediction and models evaluation.

tip

We strongly recommend that you read the [Analytics API](https://moodledev.io/docs/4.1/apis/subsystems/analytics) documentation to help understand the core concepts, how they are implemented in Moodle, and how machine learning backend plugins fit into the analytics API.
...
Some of the important files for the mlbackend plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
