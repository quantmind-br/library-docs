...
source: sitemap
fetched_at: 2026-05-07T21:13:28.98329734-03:00
rendered_js: false
word_count: 0
summary: This document provides examples and utility functions for performing offline inference on geospatial imagery using the vLLM library integrated with TerraTorch.
tags:
    - vllm
    - terratorch
    - geospatial
...
importalbumentations
importnumpyasnp
importrasterio
importregexasre
importtorch
fromeinopsimport rearrange
fromterratorch.datamodulesimport Sen1Floods11NonGeoDataModule
...
classPrithviMAE:
    ...
    defrun(self, input_data, location_coords):
...
defprocess_channel_group(orig_img, channels):
"""
    Args:
...
defsave_geotiff(image, output_path: str, meta: dict):
...
def_convert_np_uint8(float_image: torch.Tensor):
