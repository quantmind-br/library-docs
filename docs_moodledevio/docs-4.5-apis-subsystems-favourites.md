...
url: https://moodledev.io/docs/4.5/apis/subsystems/favourites
source: sitemap
fetched_at: 2026-02-17T15:13:43.455278-03:00
rendered_js: false
word_count: 746
summary: This document describes the Favourites API, explaining how to mark, retrieve, and delete user-specific bookmarks for various system items. It details the required identification fields and provides instructions for integrating favourite data into database queries.
tags:
    - moodle-development
    - favourites-api
    - crud-operations
