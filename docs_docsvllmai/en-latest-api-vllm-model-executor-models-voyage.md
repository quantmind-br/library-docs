---
title: voyage - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/models/voyage/
source: sitemap
fetched_at: 2026-05-07T21:33:45.902989626-03:00
rendered_js: false
word_count: 0
summary: This document defines a custom PyTorch model class for integrating Voyage embeddings with Qwen3, implementing specific weight remapping and layer fusion logic for compatibility with vLLM.
tags:
    - model-architecture
    - weight-fusing
    - llm-inference
...
```
classVoyageQwen3BidirectionalEmbedModel(Qwen3Model):
"""
    ...
    def_fuse_qkv_proj(self, weights: Iterable[WeightItem]) -> Iterable[WeightItem]:
"""Fuse q_proj, k_proj, v_proj into qkv_proj."""
    ...
    def_fuse_gate_up_proj(self, weights: Iterable[WeightItem]) -> Iterable[WeightItem]:
"""Fuse gate_proj and up_proj into gate_up_proj."""
    ...
    defload_weights(self, weights: Iterable[WeightItem]) -> set[str]:
