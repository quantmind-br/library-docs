---
title: Agnostic security
url: https://github.com/openagen/zeroclaw/blob/master/docs/i18n/vi/agnostic-security.md
source: git
fetched_at: 2026-05-02T14:51:01.732738731-03:00
rendered_js: false
word_count: 962
summary: This document outlines an architectural approach for implementing platform-independent security in Rust using conditional compilation, feature flags, and modular traits to maintain performance and hardware compatibility.
tags:
    - rust
...
> Để biết hành vi runtime hiện tại, xem [[002-config-reference|config-reference]], [[009-operations-runbook|operations-runbook]], và [[011-troubleshooting|troubleshooting]].
...
#rust #security-architecture #conditional-compilation #sandboxing #cross-platform #performance-optimization #pluggable-design
