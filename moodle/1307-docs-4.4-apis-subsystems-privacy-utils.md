...
url: https://moodledev.io/docs/4.4/apis/subsystems/privacy/utils
source: sitemap
fetched_at: 2026-02-17T15:04:52.806574-03:00
rendered_js: false
word_count: 53
summary: This document provides a set of PHP command-line scripts designed to help developers test and verify the implementation of the Moodle Privacy API within their plugins.
tags:
    - moodle-development
    - privacy-api
    - cli-scripts
...
Put these scripts into the root of your Moodle development installation and run them via command line. See [Privacy API](https://moodledev.io/docs/4.4/apis/subsystems/privacy) for the full guide on implementing the API in your plugin.
