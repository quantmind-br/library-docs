...
url: https://moodledev.io/docs/4.5/apis/subsystems/time
source: sitemap
fetched_at: 2026-02-17T15:15:19.021443-03:00
rendered_js: false
word_count: 829
summary: This document explains how Moodle handles date and time using the Time API, detailing the differentiation between system and user time, the PSR-20 compliant Clock API, and functions for timezone-aware display.
tags:
    - moodle-development
    - time-api
    - clock-interface
...
The `\core\clock` Interface was added in Moodle 4.4 and is available via [Dependency Injection](https://moodledev.io/docs/4.5/apis/core/di). It provides a [clock implementation](https://moodledev.io/docs/4.5/apis/core/clock) which is consistent with the [PSR-20: Clock](https://www.php-fig.org/psr/psr-20/) interfaces.
...
You can read more on [Unit testing](https://moodledev.io/docs/4.5/apis/core/clock#unit-testing) with the Clock API.
