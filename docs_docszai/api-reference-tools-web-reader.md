...
source: llms
fetched_at: 2026-01-24T11:02:28.005132217-03:00
rendered_js: false
word_count: 74
summary: This document provides the OpenAPI specification for the Web Reader API, which enables parsing and extracting content from URLs into formats like markdown or text.
tags:
    - web-reader
    - api-reference
    - openapi
