...
url: https://moodledev.io/docs/4.5/apis/subsystems/roles
source: sitemap
fetched_at: 2026-02-17T15:15:00.864158-03:00
rendered_js: false
word_count: 1439
summary: This document provides a technical overview of the Moodle Roles API, detailing the relationship between roles, capabilities, permissions, and context levels. It explains how to manage user access, handle capability conflicts, and implement security hardening using risk bitmasks.
tags:
    - moodle-development
    - roles-api
    - access-control
