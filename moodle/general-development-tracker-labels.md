---
title: Tracker issue labels | Moodle Developer Resources
url: https://moodledev.io/general/development/tracker/labels
source: sitemap
fetched_at: 2026-02-17T16:01:51.134254-03:00
rendered_js: false
word_count: 1474
summary: This document defines the standard labels used in the Moodle Tracker for categorizing and managing issues, bugs, and feature requests. It explains the purpose of specific tags used during the triaging, documentation, and integration phases of the Moodle development process.
tags:
    - moodle-tracker
    - issue-tracking
    - development-process
...
## Issue reporting and triaging[​](#issue-reporting-and-triaging "Direct link to Issue reporting and triaging")
...
- `triaged`
  ...
  This is set after a bug has been [triaged](https://moodledev.io/general/development/process/triage) by component lead or HQ developer. It indicates that the issue has been confirmed, with basic fields like "Priority" checked, and is now ready for a developer to look at.
- [`triaging_in_progress`](https://moodle.atlassian.net/issues/?jql=labels%20in%20%28triaging_in_progress%29)
...
- `cl_docs_required` ([all](https://moodle.atlassian.net/issues/?jql=labels%20in%20%28cl_docs_required%29) | [yours](https://moodle.atlassian.net/issues/?jql=labels%20in%20%28cl_docs_required%29%20AND%20assignee%20%3D%20currentUser%28%29))
...
- `dev_docs_required` ([all](https://moodle.atlassian.net/issues/?jql=labels%20in%20%28dev_docs_required%29) | [yours](https://moodle.atlassian.net/issues/?jql=labels%20in%20%28dev_docs_required%29%20AND%20assignee%20%3D%20currentUser%28%29))
...
- [`developer_notes`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20developer_notes)
  ...
  Issues that need to be mentioned in the [integration exposed forum](https://moodle.org/mod/forum/view.php?f=1153) and in the [Moodle developer update documentation](https://moodledev.io/docs/5.2/devupdate).
...
## QA and testing[​](#qa-and-testing "Direct link to QA and testing")

- [`acceptance_test_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20acceptance_test_required)
  
  Used to flag issues that should be regularly tested using the behat framework [Acceptance testing](https://moodledev.io/general/development/tools/behat). Before a major release these issues will be reviewed and new feature files will be added.
- `cime`
  
  A developer can add the `cime` label to an issue to request that CiBot perform an [Automated code review](https://moodledev.io/general/development/tools/cibot).
...
## User experience (UX)[​](#user-experience-ux "Direct link to User experience (UX)")
...
- [Tracker](https://moodledev.io/general/development/tracker)
