...
source: crawler
fetched_at: 2026-02-27T23:38:44.372914-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response format representing the playback state and device information for a media application API. It outlines the schema for track details, device status, and available playback actions.
tags:
    - api-response
    - playback-state
    - media-metadata
