...
url: https://moodledev.io/docs/4.4/apis/core/customfields
source: sitemap
fetched_at: 2026-02-17T15:02:08.483644-03:00
rendered_js: false
word_count: 795
summary: This document explains how to implement and interact with the Custom Fields API to add configurable metadata fields to various components and plugins. It covers handler implementation, form integration, data retrieval, and privacy considerations for developers.
tags:
    - custom-fields-api
    - plugin-development
    - handler-classes
...
Except for common [Plugin files](https://moodledev.io/docs/4.4/apis/commonfiles) and tests the following classes must be present in `customfield` plugins (in respective autoloaded locations):
