...
url: https://moodledev.io/docs/5.0/apis/core/grading
source: sitemap
fetched_at: 2026-02-17T15:24:41.721207-03:00
rendered_js: false
word_count: 447
summary: This document explains the architecture and implementation of advanced grading in Moodle, detailing key entities like grading areas and definitions while providing steps for integration into modules.
tags:
    - moodle
    - advanced-grading
    - plugin-development
