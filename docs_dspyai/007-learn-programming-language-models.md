...
source: sitemap
fetched_at: 2026-01-23T08:03:21.017746966-03:00
rendered_js: false
word_count: 854
summary: This document explains how to initialize and configure language models in DSPy, covering various providers, authentication methods, and global or contextual model management.
tags:
    - dspy
    - language-models
    - model-configuration
...
OpenAIGemini (AI Studio)AnthropicDatabricksLocal LMs on a GPU serverLocal LMs on your laptopOther providers
...
You can authenticate by setting the GEMINI\_API\_KEY env variable or passing `api_key` below.
...
>CUDA_VISIBLE_DEVICES=0python-msglang.launch_server--port7501--model-pathmeta-llama/Meta-Llama-3-8B-Instruct
```
...
## Calling the LM directly.[¶](#calling-the-lm-directly "Permanent link")
...
## Using the LM with DSPy modules.[¶](#using-the-lm-with-dspy-modules "Permanent link")
...
## Using multiple LMs.[¶](#using-multiple-lms "Permanent link")
...
## Configuring LM generation.[¶](#configuring-lm-generation "Permanent link")
...
## Using the Responses API[¶](#using-the-responses-api "Permanent link")
...
## Advanced: Building custom LMs and writing your own Adapters.[¶](#advanced-building-custom-lms-and-writing-your-own-adapters "Permanent link")
