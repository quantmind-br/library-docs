...
url: https://gofastmcp.com/v2/servers/server
source: crawler
fetched_at: 2026-01-22T22:22:59.359208545-03:00
rendered_js: false
word_count: 905
summary: This document provides a comprehensive overview of the FastMCP server class, explaining how to instantiate, configure, and manage core components like tools, resources, and prompts. It also covers advanced capabilities including tag-based filtering, server composition, proxying, and deployment options.
tags:
    - fastmcp
    - mcp-server
    - python-sdk
...
New in version `2.2.0` FastMCP supports composing multiple servers together using `import_server` (static copy) and `mount` (live link). This allows you to organize large applications into modular components or reuse existing servers. See the [Server Composition](https://gofastmcp.com/v2/servers/composition) guide for full details, best practices, and examples.
