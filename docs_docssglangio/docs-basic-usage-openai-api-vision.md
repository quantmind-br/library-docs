---
title: OpenAI APIs - Vision - SGLang Documentation
url: https://docs.sglang.io/docs/basic_usage/openai_api_vision
source: sitemap
fetched_at: 2026-05-11T05:48:58.404878656-03:00
rendered_js: false
word_count: 146
summary: This document demonstrates how to utilize SGLang's OpenAI-compatible APIs to interact with vision language models for image analysis tasks. It provides instructions on launching a server and sending multimodal requests via cURL, Python requests, and the official OpenAI client library.
tags:
    - sglang
