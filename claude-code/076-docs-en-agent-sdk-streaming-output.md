...
source: llms
fetched_at: 2026-04-16T22:29:50.800022799-03:00
rendered_js: false
word_count: 788
summary: This document explains how to enable and implement real-time response streaming using the Agent SDK for both Python and TypeScript. It details how to handle StreamEvent objects to extract incremental text deltas and tool call inputs.
tags:
    - agent-sdk
    - streaming-responses
    - real-time-data
