---
title: Governance Process - vLLM
url: https://docs.vllm.ai/en/latest/governance/process/
source: sitemap
fetched_at: 2026-05-07T21:14:51.97212171-03:00
rendered_js: false
word_count: 1437
summary: This document outlines the governance philosophy, design values, and hierarchical maintainer structure of the vLLM project. It details the responsibilities of core and lead maintainers, as well as the merit-based process for becoming a project committer.
tags:
...
For a full list of committers and their respective areas, see the [committers](https://docs.vllm.ai/en/latest/governance/committers/) page.

#### Committer Proposal Process[¶](#committer-proposal-process "Permanent link")
...
These topics are outlined for agents in [AGENTS.md](https://github.com/vllm-project/vllm/blob/main/AGENTS.md) with instructions for how to autonomously implement them.
