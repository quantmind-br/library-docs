...
url: https://moodledev.io/docs/5.0/tags/form
source: sitemap
fetched_at: 2026-02-17T15:19:03.481439-03:00
rendered_js: false
word_count: 130
summary: This document provides an overview of the Moodle Forms API, explaining how to create web forms and detailing specific components like the choice dropdown field.
tags:
    - moodle-forms
    - forms-api
    - choicedropdown
...
## [Choice Dropdown](https://moodledev.io/docs/5.0/apis/subsystems/form/fields/choicedropdown)
