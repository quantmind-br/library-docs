...
url: https://moodledev.io/docs/4.5/guides/javascript/comboboxsearch
source: sitemap
fetched_at: 2026-02-17T15:15:47.281193-03:00
rendered_js: false
word_count: 1026
summary: This document explains how to implement and extend the Moodle core combobox search component to create consistent and maintainable search interfaces across the platform.
tags:
    - moodle
    - combobox-search
    - search-ui
...
For example usages view the [examples](https://moodledev.io/docs/4.5/guides/javascript/comboboxsearch/examples) page.