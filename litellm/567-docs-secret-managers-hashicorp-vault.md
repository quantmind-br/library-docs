...
FeatureSupportDescriptionReading Secrets✅Read secrets e.g `OPENAI_API_KEY`Writing Secrets✅Store secrets e.g `Virtual Keys`Authentication Methods to Hashicorp Vault✅AppRole, TLS Certificate, Token
...
### 1. AppRole Authentication[​](#1-approle-authentication "Direct link to 1. AppRole Authentication")
...
### 2. TLS Certificate Authentication[​](#2-tls-certificate-authentication "Direct link to 2. TLS Certificate Authentication")
...
### 3. Token Authentication[​](#3-token-authentication "Direct link to 3. Token Authentication")
...
### Expected Secret Format[​](#expected-secret-format "Direct link to Expected Secret Format")
...
### Team-specific overrides[​](#team-specific-overrides "Direct link to Team-specific overrides")

When running the LiteLLM proxy you can override the Vault location per team. Use the [Team-Level Secret Manager Settings](https://docs.litellm.ai/docs/secret_managers/overview#team-level-secret-manager-settings) flow in the dashboard and configure the panel shown below:
