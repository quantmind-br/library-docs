...
source: crawler
fetched_at: 2026-01-28T16:18:30.576557062-03:00
rendered_js: false
word_count: 1665
summary: This document defines the `AddonManager` and `Loader` classes, detailing the core mechanisms for managing mitmproxy addons, including their registration, lifecycle events, and how they can add options and commands to the proxy. It also covers error handling for addon execution.
tags:
    - mitmproxy-addons
    - addon-manager
    - python-api
