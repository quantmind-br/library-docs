---
title: YUI | Moodle Developer Resources
url: https://moodledev.io/docs/5.2/guides/javascript/yui
source: sitemap
fetched_at: 2026-02-17T15:47:04.028914-03:00
rendered_js: false
word_count: 888
summary: This document provides an overview of the YUI framework's implementation in Moodle, covering modularity, development tools, and configuration settings for debugging. It also outlines the transition from YUI toward native ES2015 module styles in newer versions of the platform.
tags:
    - moodle
    - yui-framework
...
YUI is an extremely extensible, fast, modular, and powerful JavaScript framework with a very capable loading system. A number of modules are available for YUI providing a wide range of functionality to suit most situations. All of the core YUI modules are documented on their [API](http://yuilibrary.com/yui/docs/api/). We are working to put together documentation for moodle's YUI modules too.
...
## Documentation and further information[​](#documentation-and-further-information "Direct link to Documentation and further information")
...
Moodle uses [Grunt](https://moodledev.io/docs/5.2/guides/javascript#grunt) for most JavaScript management. We recommend reading our Grunt documentation for further information on the available commands.

#### Use[​](#use "Direct link to Use")

There are several ways to use `grunt`.

During development, we recommend you run grunt in *watch* mode:

To build all YUI modules across Moodle you can call `grunt` by running the following command from the root directory:

### JSHint[​](#jshint "Direct link to JSHint")
...
## Moodle Settings for JavaScript Development[​](#moodle-settings-for-javascript-development "Direct link to Moodle Settings for JavaScript Development")
...
- [JavaScript Modules](https://moodledev.io/docs/5.2/guides/javascript/modules)
- [jQuery](https://moodledev.io/docs/5.2/guides/javascript/jquery)
