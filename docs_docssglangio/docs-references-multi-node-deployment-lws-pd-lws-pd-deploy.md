---
title: LWS Based PD Deploy - SGLang Documentation
url: https://docs.sglang.io/docs/references/multi_node_deployment/lws_pd/lws_pd_deploy
source: sitemap
fetched_at: 2026-05-11T05:48:21.509143112-03:00
rendered_js: false
word_count: 292
summary: This document provides a configuration template for deploying SGLang on Kubernetes using LeaderWorkerSet for disaggregated prefill tasks.
tags:
    - sglang
    - kubernetes
    - leaderworkerset
...
Prefill manifest file [prefill.yaml](https://github.com/sgl-project/sglang/blob/main/docs/references/multi_node_deployment/lws_pd/lws-examples/p.yaml) *Note: The NodeSelector section, model location section, and taint toleration section can be adjusted according to your actual deployment environment*
...
Decode node deployment manifest file [decode.yaml](https://github.com/sgl-project/sglang/blob/main/docs/references/multi_node_deployment/lws_pd/lws-examples/d.yaml) *Note: The NodeSelector section, model location section, and taint toleration section can be adjusted according to your actual deployment environment*
