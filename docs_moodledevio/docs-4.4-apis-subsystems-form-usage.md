...
url: https://moodledev.io/docs/4.4/apis/subsystems/form/usage
source: sitemap
fetched_at: 2026-02-17T15:04:36.869947-03:00
rendered_js: false
word_count: 488
summary: This document explains the Moodle Form API, detailing how to define form classes, process submitted data, and implement standard forms within activity modules.
tags:
    - moodle-development
    - form-api
    - php
