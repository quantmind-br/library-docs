...
source: github_pages
fetched_at: 2026-04-09T09:04:06.115864562-03:00
rendered_js: true
word_count: 840
summary: This document provides a comprehensive guide on implementing and configuring sandboxing features for Qwen Code, detailing methods like macOS Seatbelt and containerization (Docker/Podman) to enhance security and isolation when executing code.
tags:
    - sandboxing
    - security
    - macos-seatbelt
...
### 2. Container-based (Docker/Podman)[](#2-container-based-dockerpodman)
...
### Enable sandboxing (in order of precedence)[](#enable-sandboxing-in-order-of-precedence)
...
### Configure the sandbox image (Docker/Podman)[](#configure-the-sandbox-image-dockerpodman)
...
### Custom Seatbelt profiles (macOS)[](#custom-seatbelt-profiles-macos)
...
### Custom Sandbox Flags[](#custom-sandbox-flags)
...
### Network proxying (all sandbox methods)[](#network-proxying-all-sandbox-methods)
...
For a working allowlist-style proxy example, see: [Example Proxy Script](https://qwenlm.github.io/qwen-code-docs/en/developers/examples/proxy-script/).
...
For more details on customizing the sandbox, see [Customizing the sandbox environment](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/sandbox/).
...
- [Configuration](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/): Full configuration options.
- [Commands](https://qwenlm.github.io/qwen-code-docs/en/users/features/commands/): Available commands.
- [Troubleshooting](https://qwenlm.github.io/qwen-code-docs/en/users/support/troubleshooting/): General troubleshooting.