...
url: https://moodledev.io/docs/5.0/guides/javascript/modal
source: sitemap
fetched_at: 2026-02-17T15:28:44.319398-03:00
rendered_js: false
word_count: 609
summary: This document explains how to create, configure, and customize modal dialogues in Moodle using the core modal JavaScript modules while ensuring accessibility standards.
tags:
    - moodle
    - javascript-api
    - modal-dialogues
