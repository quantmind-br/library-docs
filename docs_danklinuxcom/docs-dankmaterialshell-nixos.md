...
source: sitemap
fetched_at: 2026-01-24T13:33:50.398698277-03:00
rendered_js: false
word_count: 504
summary: This document explains how to install and configure DankMaterialShell on NixOS using the native nixpkgs module. It provides instructions for enabling features, managing plugins, and using flakes for advanced customization.
tags:
    - nixos
    - nixpkgs
    - dankmaterialshell
