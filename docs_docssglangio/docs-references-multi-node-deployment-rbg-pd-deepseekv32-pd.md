---
title: DeepSeekV32-Exp RBG Based PD Deploy - SGLang Documentation
url: https://docs.sglang.io/docs/references/multi_node_deployment/rbg_pd/deepseekv32_pd
source: sitemap
fetched_at: 2026-05-11T05:48:17.281932804-03:00
rendered_js: false
word_count: 128
summary: This document provides a configuration guide for deploying SGLang on Kubernetes using RoleBasedGroup (RBG) for disaggregated prefill and decode workloads.
tags:
    - kubernetes
    - sglang
    - llm-inference
...
- [2. All In One manifest file](#2-all-in-one-manifest-file)
- [FAQ](#faq)
