---
title: "null"
url: https://docs.clawd.bot/gateway/remote-gateway-readme.md
source: llms
fetched_at: 2026-01-26T09:52:09.531020017-03:00
rendered_js: false
word_count: 260
summary: This guide explains how to connect Clawdbot.app to a remote gateway using SSH tunneling and port forwarding. It includes instructions for manual setup, credential configuration, and creating a persistent background service on macOS.
tags:
    - ssh-tunneling
    - remote-gateway
    - port-forwarding
