...
url: https://moodledev.io/docs/5.0/guides/javascript/ajax
source: sitemap
fetched_at: 2026-02-17T15:28:36.062831-03:00
rendered_js: false
word_count: 592
summary: This document explains how to implement AJAX interactions in Moodle using the core/ajax JavaScript module and the Web Service API, covering configuration, implementation patterns, and best practices.
tags:
    - moodle
    - javascript
    - ajax
