...
url: https://moodledev.io/docs/4.5/tags/plugins
source: sitemap
fetched_at: 2026-02-17T15:09:12.797143-03:00
rendered_js: false
word_count: 719
summary: This document serves as a comprehensive index of Moodle 4.5 APIs and plugin types, outlining the various components and extension points available for developer customization. It provides brief descriptions for core subsystems, common configuration files, and various plugin categories.
tags:
    - moodle-development
    - plugin-types
    - core-apis
...
## [Advanced grading API](https://moodledev.io/docs/4.5/apis/core/grading)
...
## [Antivirus plugins](https://moodledev.io/docs/4.5/apis/plugintypes/antivirus)

Integrate your preferred Antivirus tool to with Moodle to automatically check new file uploads.

## [Block plugins](https://moodledev.io/docs/4.5/apis/plugintypes/blocks)
...
## [db/tasks.php](https://moodledev.io/docs/4.5/apis/commonfiles/db-tasks.php)

A description of the plugin scheduled task configuration file

## [Defaults for new questions](https://moodledev.io/docs/4.5/apis/plugintypes/qtype/newquestiondefaults)

A way for question types to remember a user's preferred settings for creating questions of a given type.

## [Enrolment plugins](https://moodledev.io/docs/4.5/apis/plugintypes/enrol)
...
## [Filter plugins](https://moodledev.io/docs/4.5/apis/plugintypes/filter)

Filters are a way to automatically transform content before it is output. Filters may be used to:

## [Fonts](https://moodledev.io/docs/4.5/apis/plugintypes/theme/fonts)

CSS3 standard introduced the possibility to specify custom fonts, see CSS web fonts tutorial.

## [Images and icons in themes](https://moodledev.io/docs/4.5/apis/plugintypes/theme/images)
...
## [Local plugins](https://moodledev.io/docs/4.5/apis/plugintypes/local)
...
## [Theme plugins](https://moodledev.io/docs/4.5/apis/plugintypes/theme)
...
## [version.php](https://moodledev.io/docs/4.5/apis/commonfiles/version.php)
