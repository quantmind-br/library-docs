...
url: https://moodledev.io/docs/5.1/tags/core
source: sitemap
fetched_at: 2026-02-17T15:29:46.414826-03:00
rendered_js: false
word_count: 474
summary: This document provides a directory and overview of Moodle's developer APIs and subsystems, including the Form API, Core APIs, and Data Manipulation Layer (DML).
tags:
    - moodle-development
    - form-api
    - dml-api
