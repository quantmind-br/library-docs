...
url: https://moodledev.io/docs/4.4/apis/plugintypes/format/migration
source: sitemap
fetched_at: 2026-02-17T15:03:07.37777-03:00
rendered_js: false
word_count: 2886
summary: This document outlines the architectural changes and mandatory updates required to adapt Moodle course format plugins for compatibility with the Moodle 4.0 reactive course editor.
tags:
    - moodle-development
    - course-format
    - migration-guide
...
The first thing your plugin needs is to create that structure and link it to the output components. Follow the guide on the [create format plugin page](https://moodledev.io/docs/4.4/apis/plugintypes/format#creating-the-basic-output-structure) to know how to create the basic structure.
...
Once your plugin has the basic mustache structure, you can provide extra mustache blocks to override parts of the page. Follow the [Override mustache blocks](https://moodledev.io/docs/4.4/apis/plugintypes/format#override-mustache-blocks) on the Creating a course format page to know how to do it.
