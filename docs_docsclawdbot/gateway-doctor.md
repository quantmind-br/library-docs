---
title: "null"
url: https://docs.clawd.bot/gateway/doctor.md
source: llms
fetched_at: 2026-01-26T09:51:56.430931586-03:00
rendered_js: false
word_count: 1380
summary: This document describes the clawdbot doctor command-line tool, which is used to diagnose, repair, and migrate configuration and state data for Clawdbot installations. It details various automation flags, system health checks, and the logic behind legacy state and configuration migrations.
tags:
    - clawdbot
    - cli
    - troubleshooting
