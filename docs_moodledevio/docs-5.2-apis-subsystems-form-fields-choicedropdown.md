...
url: https://moodledev.io/docs/5.2/apis/subsystems/form/fields/choicedropdown
source: sitemap
fetched_at: 2026-02-17T15:45:56.65228-03:00
rendered_js: false
word_count: 121
summary: This document explains how to implement the choicedropdown form field using the choicelist data definition to create rich dropdown menus with icons and descriptions.
tags:
    - choicedropdown
    - choicelist
    - form-api
