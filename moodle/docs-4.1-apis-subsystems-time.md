...
url: https://moodledev.io/docs/4.1/apis/subsystems/time
source: sitemap
fetched_at: 2026-02-17T14:57:05.098544-03:00
rendered_js: false
word_count: 637
summary: This document explains how to use the Moodle Time API to manage and display date-time information based on system or user-specific timezones. It outlines the usage of the core_date class and PHP DateTime objects to handle unixtime storage and daylight saving time calculations.
tags:
    - moodle-development
    - time-api
    - timezone-handling
