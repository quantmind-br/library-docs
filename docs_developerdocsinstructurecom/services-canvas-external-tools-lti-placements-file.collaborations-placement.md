...
url: https://developerdocs.instructure.com/services/canvas/external-tools/lti/placements/file.collaborations_placement
source: sitemap
fetched_at: 2026-02-15T09:14:14.818294-03:00
rendered_js: false
word_count: 360
summary: This document explains how to configure external tools for the collaboration placement in Canvas using LTI Deep Linking. It covers supported resource types, user/group extensions, and migration considerations from LTI 1.1 to 1.3.
tags:
    - canvas-lms
    - lti-deep-linking
    - lti-1-3
...
For an overview of Canvas collaborations, refer to the [Canvas Community article.arrow-up-right](https://community.canvaslms.com/t5/Canvas-Basics-Guide/What-are-Collaborations/ta-p/61)
...
For Deep Linking, the collaboration placement supports the [LTI Resource Link typearrow-up-right](https://www.imsglobal.org/spec/lti-dl/v2p0#lti-resource-link).
