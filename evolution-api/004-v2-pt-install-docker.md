---
title: Docker - Evolution API Documentation
url: https://doc.evolution-api.com/v2/pt/install/docker
source: sitemap
fetched_at: 2026-04-12T18:46:02.025600166-03:00
rendered_js: false
word_count: 570
summary: This document provides a comprehensive guide on deploying the Evolution API v2 using containerization technologies, detailing setup instructions for both standalone Docker Compose environments and scalable Docker Swarm clusters.
tags:
    - docker-compose
    - docker-swarm
    - deployment-guide
...
O Docker standalone é adequado quando a Evolution API será executada em apenas uma máquina, sem a necessidade de escalabilidade imediata. Esta é a forma mais conveniente para a maioria dos usuários. Para começar, crie um arquivo `docker-compose.yml` com o seguinte conteúdo:
...
**Etapa 2: Instalação do Docker** Instale o Docker executando:

```
curl -fsSL https://get.docker.com | bash
```

**Etapa 3: Iniciando o Swarm** Inicie o Docker Swarm:

```
docker swarm init --advertise-addr IP_SERVER
```

**Etapa 4: Configuração da Rede do Docker Swarm** Crie a rede overlay para o Docker Swarm:
...
**Etapa 3: Adicionar o Worker ao Cluster** Execute o comando obtido anteriormente para adicionar o Worker ao cluster:
