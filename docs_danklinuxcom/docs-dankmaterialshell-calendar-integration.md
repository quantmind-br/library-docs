...
source: sitemap
fetched_at: 2026-01-24T13:33:20.310557598-03:00
rendered_js: false
word_count: 131
summary: This document provides instructions for synchronizing CalDAV-compatible calendars with a dashboard using vdirsyncer and khal on Linux systems.
tags:
    - caldav
    - calendar-sync
    - vdirsyncer
