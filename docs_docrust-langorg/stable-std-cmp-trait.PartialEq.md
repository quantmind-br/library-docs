...
url: https://doc.rust-lang.org/stable/std/cmp/trait.PartialEq.html#method.ne
source: crawler
fetched_at: 2026-05-06T21:26:10.73355842-03:00
rendered_js: false
word_count: 783
summary: The PartialEq trait in Rust enables equality comparisons using the == and != operators by defining the eq and ne methods for types.
tags:
    - rust
    - traits
    - equality
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#251)
...
If [`PartialOrd`](https://doc.rust-lang.org/stable/std/cmp/trait.PartialOrd.html "trait std::cmp::PartialOrd") or [`Ord`](https://doc.rust-lang.org/stable/std/cmp/trait.Ord.html "trait std::cmp::Ord") are also implemented for `Self` and `Rhs`, their methods must also be consistent with `PartialEq` (see the documentation of those traits for the exact requirements). It’s easy to accidentally make them disagree by deriving some of the traits and manually implementing others.
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#256)

Tests for `self` and `other` values to be equal, and is used by `==`.

1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#264)
