...
source: crawler
fetched_at: 2026-05-06T21:21:45.0072311-03:00
rendered_js: false
word_count: 137
summary: This document serves as the official manual for Cargo, the package manager for the Rust programming language, providing comprehensive documentation on its commands, configuration, and workflows.
tags:
    - rust
    - cargo
    - package-management
...
- [Changelog](https://doc.rust-lang.org/cargo/CHANGELOG.html) — Detailed notes about changes in Cargo in each release.
