---
title: Filesystem Extension | goose
url: https://block.github.io/goose/docs/mcp/filesystem-mcp
source: github_pages
fetched_at: 2026-01-22T22:15:11.6209776-03:00
rendered_js: true
word_count: 210
summary: This document explains how to integrate and configure the Filesystem MCP server as an extension for goose to enable automated file management and code analysis.
tags:
    - goose
...
1. [Launch the installer](goose://extension?cmd=npx&arg=-y&arg=%40modelcontextprotocol%2Fserver-filesystem&arg=%2FUsers%2Fusername%2FDesktop&arg=%2Fpath%2Fto%2Fother%2Fallowed%2Fdir&id=filesystem&name=filesystem&description=Enables%20code%20analysis%20and%20file%20management)
...
3. On the `Filesystem` card, click the button
...
```
// Current (Unsafe):
constSTRIPE_SECRET='sk_live_abcdef123456';
constAWS_KEY='AKIA12345EXAMPLE';

// Recommended Fix:
constSTRIPE_SECRET= process.env.STRIPE_SECRET_KEY;
constAWS_KEY= process.env.AWS_ACCESS_KEY_ID;
