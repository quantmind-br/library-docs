...
url: https://moodledev.io/docs/4.5/guides/templates
source: sitemap
fetched_at: 2026-02-17T15:16:02.750975-03:00
rendered_js: false
word_count: 4325
summary: This document explains how Moodle uses the Mustache template system for HTML rendering, covering basic syntax, sections, partials, and Moodle-specific helpers.
tags:
    - moodle
    - mustache-templates
    - templating-engine
...
Rendering a template from JavaScript is fairly easy. There is a [JavaScript module](https://moodledev.io/docs/4.5/guides/javascript/modules) that can load (and cache) a template and then use it for rendering the given data.
