---
title: bitsandbytes_loader - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/model_loader/bitsandbytes_loader/
source: sitemap
fetched_at: 2026-05-07T21:28:37.164966976-03:00
rendered_js: false
word_count: 50
summary: This class provides the infrastructure for loading model weights using BitsAndBytes quantization, including mechanisms for downloading files, filtering weight tensors, and mapping parameters from standard model formats to the target inference engine.
tags:
    - bitsandbytes
    - quantization
    - model-loading
...
```
classBitsAndBytesModelLoader(BaseModelLoader):
...
"""Prepare weight files for the model."""
    ...
    def_hf_weight_iter(self, hf_weights_files, use_safetensors: bool):
        def_maybe_pool_model(module_name: str):
    ...
    def_get_quantized_weights_iterator(
        self,
        model_name_or_path: str,
        revision: str | None,
...
"""Get an iterator to the model weights with bitsandbytes quantization,
    ...
    def_is_8bit_weight_name(self, weight_name: str):
        quantized_suffix = {".scb", ".weight_format"}
        return any(weight_name.lower().endswith(suffix) for suffix in quantized_suffix)

    def_is_4bit_weight_name(self, weight_name: str):
        quantized_suffix = {
            "absmax",
            "quant_map",
            "nested_absmax",
    ...
    def_quantized_4bit_generator(
        self, hf_weights_files, use_safetensors, quant_state_dict
    ) -> Generator:
        frombitsandbytes.functionalimport QuantState
        ...
        def_parse_quant_state(param_name: str, temp_state_dict: dict) -> QuantState:
            quant_state = {}
    ...
    def_unquantized_generator(
        self, hf_weights_files, use_safetensors, quant_state_dict
    ) -> Generator:
        frombitsandbytes.functionalimport quantize_4bit
    ...
    def_get_bnb_target_modules(self, model: nn.Module) -> None:
"""
    ...
    def_classify_module_sharding(self, model: nn.Module):
"""
    ...
    def_verify_model_compatibility(
...
"""
    ...
    def_dequantize_dq(self, quant_states: Any):
"""
        ...
        """
        frombitsandbytes.functionalimport QuantState, dequantize_blockwise

        def_dequantize_single_state(quant_state):
"""Helper function to dequantize a single QuantState object."""
    ...
    def_fuse_moe_quant_states(self, model: nn.Module, quant_states_dict: dict) -> dict:
"""
    ...
    def_stack_quantization_states(
        self, model: nn.Module, quant_state_dict: dict
    ) -> dict[str, dict[int, Any]]:
        stacked_quant_state_dict: dict[str, dict[int, Any]] = {}
        # TODO: Change this lazy import to normal import
        # after the checks are updated to run on a new version
        fromvllm.model_executor.models.utilsimport is_pp_missing_parameter
    ...
    def_bind_quant_states_to_params(
