...
source: crawler
fetched_at: 2026-01-28T16:18:36.48951006-03:00
rendered_js: false
word_count: 1942
summary: This document defines the `_MultiDict` abstract base class and its concrete implementations, `MultiDict` and `MultiDictView`. It details a dictionary-like data structure designed to store multiple values for a single key.
tags:
    - multidict
    - data-structure
    - python-class
