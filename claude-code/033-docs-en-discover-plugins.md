...
source: llms
fetched_at: 2026-04-16T22:32:07.382921991-03:00
rendered_js: false
word_count: 2000
summary: This document explains how to discover, add, and install plugins from marketplaces to extend Claude Code with new capabilities like code intelligence, external integrations, and development workflows.
tags:
    - claude-code
    - plugin-management
    - marketplace
