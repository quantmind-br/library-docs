...
source: sitemap
fetched_at: 2026-01-24T13:33:26.004620076-03:00
rendered_js: false
word_count: 796
summary: This document explains how to use the dms keybinds command to manage and view keyboard shortcuts across various window managers and applications. It covers auto-discovery features, provider-specific parsing for tools like Hyprland and Sway, and keybind management for Niri.
tags:
    - dms-keybinds
    - window-manager
    - linux-configuration
