---
title: Zero-Cost Deployment (AIStudio Reverse Proxy)
url: https://help.router-for.me/hands-on/tutorial-11
source: crawler
fetched_at: 2026-01-14T22:10:08.177257708-03:00
rendered_js: false
word_count: 502
summary: This document explains how to deploy AIStudioBuild as a WebSocket proxy for CLIProxyAPI, using Docker on HuggingFace or a personal server to overcome memory limitations and browser-based deployment issues.
tags:
    - aistudio
    - cli-proxy-api
    - websocket
...
### Step 1: Configure the AIStudioBuild Application [​](#step-1-configure-the-aistudiobuild-application)
...
### Step 2: Prepare AIStudio Cookie [​](#step-2-prepare-aistudio-cookie)

For this step, it is recommended to use your browser's private mode. Log in to [https://aistudio.google.com/](https://aistudio.google.com/) and copy the Cookie from the browser's developer tools. The specific location is shown in the image below:

![](https://img.072899.xyz/2025/11/51f860bf363cab01aa4c3fd5181b7f72.png)

### Step 3 (1): Deploy HuggingFace Space [​](#step-3-1-deploy-huggingface-space)

Open [https://huggingface.co/spaces/hkfires/AIStudioBuildWS](https://huggingface.co/spaces/hkfires/AIStudioBuildWS) and duplicate the Space. Fill in the `CAMOUFOX_INSTANCE_URL` field with the link to the program you prepared in Step 1, and fill in the `USER_COOKIE_1` field with the Cookie you prepared in Step 2. Then, click "Duplicate Space".
...
### Step 3 (2): Server Docker Deployment [​](#step-3-2-server-docker-deployment)
