...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/createAsset
source: crawler
fetched_at: 2026-02-27T23:40:05.12551-03:00
rendered_js: true
word_count: 348
summary: This document details the API endpoint for creating image, audio, and video assets within an ad account, including technical specifications for request parameters and metadata responses.
tags:
    - ads-api
    - asset-management
    - image-upload
...
- Asset subtype only required for asset type AUDIO.
  
  Allowed values: `"BACKGROUND_MUSIC"`, `"USER_UPLOADED_AUDIO"`Example: `"USER_UPLOADED_AUDIO"`
