...
source: sitemap
fetched_at: 2026-01-24T13:33:22.353535337-03:00
rendered_js: false
word_count: 213
summary: This document explains how to use the dms color pick command-line utility to capture colors from any pixel on a Wayland-based screen. It covers various output formats, custom formatting templates, and integration options such as clipboard copying.
tags:
    - wayland
    - color-picker
    - cli-tool
