...
url: https://zellij.dev/news/floating-panes-tmux-mode/
source: sitemap
fetched_at: 2026-01-24T15:52:49.606335382-03:00
rendered_js: false
word_count: 290
summary: This document announces the release of Zellij version 0.25.0, detailing new features such as floating panes, a built-in Tmux compatibility mode, and system clipboard integration.
tags:
    - zellij
...
![](https://zellij.dev/img/floating-panes-demo.gif)
...
![](https://zellij.dev/img/tmux-shortcuts.png)
...
For more information: [https://zellij.dev/documentation/compatibility.html#clipboard-not-working](https://zellij.dev/documentation/compatibility.html#clipboard-not-working)
