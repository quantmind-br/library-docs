...
url: https://moodledev.io/docs/4.4/tags/backup
source: sitemap
fetched_at: 2026-02-17T14:57:54.51028-03:00
rendered_js: false
word_count: 83
summary: This document introduces the Moodle Backup and Restore APIs, which allow developers to integrate plugin data into the course backup and restoration processes.
tags:
    - moodle-development
    - backup-api
    - restore-api
