...
url: https://moodledev.io/docs/5.0/tags/core-form
source: sitemap
fetched_at: 2026-02-17T15:17:42.261968-03:00
rendered_js: false
word_count: 321
summary: This document provides an overview of the Moodle Forms API, detailing advanced elements, specific field types like choice dropdowns, and specialized functionality for managing complex form interactions.
tags:
    - moodle
    - forms-api
    - web-development
