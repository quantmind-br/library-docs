...
url: https://moodledev.io/docs/5.0/guides/javascript/yui
source: sitemap
fetched_at: 2026-02-17T15:28:48.344793-03:00
rendered_js: false
word_count: 888
summary: This document provides an overview of how Moodle integrates the YUI framework for JavaScript development, covering modular architecture, registration patterns, and required development tools.
tags:
    - moodle-development
    - yui-framework
    - javascript-modules
...
Moodle uses [Grunt](https://moodledev.io/docs/5.0/guides/javascript#grunt) for most JavaScript management. We recommend reading our Grunt documentation for further information on the available commands.
...
- [JavaScript Modules](https://moodledev.io/docs/5.0/guides/javascript/modules)
- [jQuery](https://moodledev.io/docs/5.0/guides/javascript/jquery)
