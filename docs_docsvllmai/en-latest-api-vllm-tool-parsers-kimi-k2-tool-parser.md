---
title: kimi_k2_tool_parser - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/tool_parsers/kimi_k2_tool_parser/
source: sitemap
fetched_at: 2026-05-07T21:36:10.768429151-03:00
rendered_js: false
word_count: 47
summary: This class implements a parser for the Kimi K2 model to extract tool calls and function arguments from streaming model outputs using custom marker tokens and regular expressions.
tags:
    - python
    - tool-calling
    - llm-parsing
...
```
classKimiK2ToolParser(ToolParser):
...
"""Return unsent content before the tool-calls section, or None.
    ...
    def_extract_tool_calls(self, current_text: str) -> list[str]:
...
"""Parse ``(tool_id, tool_name)`` from a header
    ...
    def_split_tool_call(self, tool_call: str) -> tuple[str | None, str | None]:
"""Split a tool-call body into ``(header, arguments)`` at the argument marker.
    ...
    def_compute_args_diff(self, index: int, tool_args: str | None) -> str | None:
