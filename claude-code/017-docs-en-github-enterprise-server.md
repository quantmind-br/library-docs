...
source: llms
fetched_at: 2026-04-16T22:32:34.730221399-03:00
rendered_js: false
word_count: 1183
summary: This document provides instructions for administrators and developers on how to connect Claude Code to a self-hosted GitHub Enterprise Server instance to enable automated code reviews, web sessions, and plugin marketplaces.
tags:
    - github-enterprise
    - claude-code
    - admin-setup
