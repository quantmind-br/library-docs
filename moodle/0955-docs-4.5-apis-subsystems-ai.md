...
url: https://moodledev.io/docs/4.5/apis/subsystems/ai
source: sitemap
fetched_at: 2026-02-17T15:13:07.579573-03:00
rendered_js: false
word_count: 1236
summary: This document outlines the architectural design and core components of the Moodle AI Subsystem, explaining how placements, providers, and actions interact through a central manager.
tags:
    - moodle-lms
    - ai-subsystem
    - plugin-development
...
The AI Subsystem in Moodle LMS provides a consistent and user-friendly way for users to interact with AI in Moodle. It has been designed for easy integration with various AI providers and the development of [AI plugins](https://moodledev.io/docs/4.5/apis/plugintypes/ai).
...
However, in the context of Moodle, we are simplifying the term 'AI' to mean the tools and actions AI technologies provide to the LMS learning experience. These AI tools are supplied in the form of [plugins](https://moodledev.io/docs/4.5/apis/plugintypes/ai) that feature a set of possible actions.

For example, the [Placement plugin](https://moodledev.io/docs/4.5/apis/plugintypes/ai/placement) allows users to gain access to the Course Assistant. This AI tool enables users to have information within their course summarised by the integrated AI.
...
See the [Placements](https://moodledev.io/docs/4.5/apis/plugintypes/ai/placement) documentation for more information on developing Placement plugins.
...
See the [Providers](https://moodledev.io/docs/4.5/apis/plugintypes/ai/provider) documentation for more information on developing Provider plugins.
