...
url: https://github.com/openagen/zeroclaw/blob/master/docs/contributing/reviewer-playbook.md
source: git
fetched_at: 2026-05-02T14:50:45.694389383-03:00
rendered_js: false
word_count: 938
summary: This document defines an operational framework for maintaining high-quality code reviews, providing standardized procedures for PR triage, risk assessment, and decision-making.
tags:
...
This playbook is the operational companion to [[157-contributing-pr-workflow|pr-workflow]].
For broader documentation navigation, use [[001-index|README]].
...
- Naming and architecture boundaries follow project contracts (`[[156-contributing-pr-discipline|AGENTS]]`, `[[155-contributing-langgraph-integration|CONTRIBUTING]]`).
...
- [[001-index|README]] — documentation taxonomy and navigation.
- [[157-contributing-pr-workflow|pr-workflow]] — governance workflow and merge contract.
- [[149-contributing-ci-map|ci-map]] — CI ownership and triage map.
- [[151-contributing-custom-providers|actions-source-policy]] — action source allowlist policy.
...
#reviewer-playbook #code-review #risk-management
