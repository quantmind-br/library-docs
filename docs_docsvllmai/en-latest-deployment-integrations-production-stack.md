...
source: sitemap
fetched_at: 2026-05-07T21:12:08.746394176-03:00
rendered_js: false
word_count: 462
summary: This document provides a guide for deploying the vLLM production stack on Kubernetes using Helm charts to enable scalable and efficient large language model serving.
tags:
    - kubernetes
    - vllm
    - helm-charts
...
[](https://github.com/vllm-project/vllm/edit/main/docs/deployment/integrations/production-stack.md "Edit this page")
...
```
sudohelmrepoaddvllmhttps://vllm-project.github.io/production-stack
sudohelminstallvllmvllm/vllm-stack-ftutorials/assets/values-01-minimal-example.yaml
```
...
```
sudokubectlport-forwardsvc/vllm-router-service30080:80
```
