...
source: sitemap
fetched_at: 2026-04-26T07:46:40.48218481-03:00
rendered_js: false
word_count: 641
summary: This document outlines the v0.7.8 update for Crawl4AI, a stability-focused release that fixes bugs related to Docker deployments, LLM extraction configurations, URL handling, and dependency updates.
tags:
    - release-notes
    - bug-fixes
    - docker
...
```
fromcrawl4aiimport BrowserConfig
...
fromcrawl4ai.modelsimport CrawlResult
...
dockerpullunclecode/crawl4ai:0.7.8

# Run
dockerrun-d-p11235:11235--shm-size=1gunclecode/crawl4ai:0.7.8
```
...
```
pythondocs/releases_review/demo_v0.7.8.py
```
