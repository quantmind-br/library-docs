...
url: https://zellij.dev/news/colliding-keybinds-plugin-manager/
source: sitemap
fetched_at: 2026-01-24T15:52:38.110499028-03:00
rendered_js: false
word_count: 948
summary: This document announces the release of Zellij version 0.41.0, detailing new features such as non-colliding keybinding presets, runtime configuration updates, and expanded plugin APIs. It highlights user interface improvements, the addition of a setup wizard, and support for the Kitty keyboard protocol.
tags:
    - zellij
    - release-notes
...
![A diagram explaining the different keybinding presets](https://zellij.dev/img/presets-diagram.png)
...
![Rebinding keys in the new Zellij Configuration](https://zellij.dev/img/rebind-keys-1.png)
...
![An image of the new Zellij status bar](https://zellij.dev/img/new-status-bar.png)

## Configuration Screen and Setup Wizard

![A image of the Zellij setup wizard](https://zellij.dev/img/setup-wizard.png)
...
6. List-clients (including their focused pane\_id, running command or plugin url)
...
![A image of the Zellij plugin manager](https://zellij.dev/img/plugin-manager-1.png)
...
![A screenshot of Zellij with the new night owl theme](https://zellij.dev/img/new-theme.png)

This release includes many different themes added by the community. You can see the new “night-owl” theme above. For a full list of themes, please see the [theme list](https://zellij.dev/documentation/theme-list.html).
