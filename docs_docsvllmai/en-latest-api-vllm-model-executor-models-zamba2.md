---
title: zamba2 - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/models/zamba2/
source: sitemap
fetched_at: 2026-05-07T21:33:50.215420002-03:00
rendered_js: false
word_count: 1429
summary: This document describes the Zamba2Attention module implementation for vLLM, which integrates a hybrid Mamba-Transformer architecture featuring parallel attention computation, rotary position embeddings, and optional LoRA adapters.
tags:
    - pytorch
    - vllm
    - zamba2
...
## Zamba2Attention [¶](#vllm.model_executor.models.zamba2.Zamba2Attention "Permanent link")
...
```
classZamba2Attention(nn.Module):
"""Multi-head attention mechanism for the Zamba2 model.
...
### \_\_init\__ [¶](#vllm.model_executor.models.zamba2.Zamba2Attention.__init__ "Permanent link")
...
Name Type Description Default `config` `Zamba2Config`

The Zamba2 model configuration

*required* `bare_block_idx` `int`

Index of the bare attention block

*required* `num_hybrid_layers` `int`

Total number of hybrid layers

*required* `cache_config` `CacheConfig | None`

Configuration for key-value caching

`None` `quant_config` `QuantizationConfig | None`
...
### forward [¶](#vllm.model_executor.models.zamba2.Zamba2Attention.forward "Permanent link")
...
Input tensor \[batch\_size, seq\_len, hidden\_size]

*required* `position_ids` `Tensor`

Position IDs for positional embeddings

*required* `block_idx` `int`
...
Output tensor \[batch\_size, seq\_len, hidden\_size]
...
## Zamba2AttentionDecoderLayer [¶](#vllm.model_executor.models.zamba2.Zamba2AttentionDecoderLayer "Permanent link")
...
```
classZamba2AttentionDecoderLayer(nn.Module):
"""Single decoder layer combining attention and feed-forward networks.
...
### \_\_init\__ [¶](#vllm.model_executor.models.zamba2.Zamba2AttentionDecoderLayer.__init__ "Permanent link")
...
### forward [¶](#vllm.model_executor.models.zamba2.Zamba2AttentionDecoderLayer.forward "Permanent link")
...
*required* `original_hidden_states` `Tensor`
...
## Zamba2ForCausalLM [¶](#vllm.model_executor.models.zamba2.Zamba2ForCausalLM "Permanent link")

Bases: `Module`, `HasInnerState`, `IsHybrid`, `SupportsMambaPrefixCaching`
...
```
classZamba2ForCausalLM(nn.Module, HasInnerState, IsHybrid, SupportsMambaPrefixCaching):
"""Zamba2 model with causal language modeling head.
...
### \_\_init\__ [¶](#vllm.model_executor.models.zamba2.Zamba2ForCausalLM.__init__ "Permanent link")
...
### compute\_logits [¶](#vllm.model_executor.models.zamba2.Zamba2ForCausalLM.compute_logits "Permanent link")
...
### embed\_input\_ids [¶](#vllm.model_executor.models.zamba2.Zamba2ForCausalLM.embed_input_ids "Permanent link")

Convert input token IDs to embeddings. Args: input\_ids: Tensor of input token IDs Returns: Embedded representation of the input tokens
...
### forward [¶](#vllm.model_executor.models.zamba2.Zamba2ForCausalLM.forward "Permanent link")
...
*required* `inputs_embeds` `Tensor | None`
...
### get\_mamba\_state\_shape\_from\_config `classmethod` [¶](#vllm.model_executor.models.zamba2.Zamba2ForCausalLM.get_mamba_state_shape_from_config "Permanent link")
...
- conv\_state\_shape: Shape for convolutional state cache

`tuple[tuple[int, int], tuple[int, int, int]]`

- temporal\_state\_shape: Shape for state space model cache
...
## Zamba2HybridLayer [¶](#vllm.model_executor.models.zamba2.Zamba2HybridLayer "Permanent link")
...
```
classZamba2HybridLayer(nn.Module):
"""Hybrid layer combining Transformer and Mamba architectures.
...
### \_\_init\__ [¶](#vllm.model_executor.models.zamba2.Zamba2HybridLayer.__init__ "Permanent link")

Initialize the hybrid layer.

Parameters:

Name Type Description Default `shared_transformer` `Zamba2AttentionDecoderLayer`
...
### forward [¶](#vllm.model_executor.models.zamba2.Zamba2HybridLayer.forward "Permanent link")
...
## Zamba2LoRA [¶](#vllm.model_executor.models.zamba2.Zamba2LoRA "Permanent link")
...
### \_\_init\__ [¶](#vllm.model_executor.models.zamba2.Zamba2LoRA.__init__ "Permanent link")
...
*required* `output_dim` `int | list[int]`

output dimension

*required* `quant_config` `QuantizationConfig | None`
...
## Zamba2MLP [¶](#vllm.model_executor.models.zamba2.Zamba2MLP "Permanent link")
...
"""Initialize the MLP layer.
    ...
    defforward(self, hidden_states: torch.Tensor, block_idx: int) -> torch.Tensor:
...
### \_\_init\__ [¶](#vllm.model_executor.models.zamba2.Zamba2MLP.__init__ "Permanent link")
...
*required* `num_hybrid_layers` `dict[int, int]`
...
### forward [¶](#vllm.model_executor.models.zamba2.Zamba2MLP.forward "Permanent link")
...
Output tensor \[batch\_size, seq\_len, hidden\_size] after applying
...
## Zamba2MambaDecoderLayer [¶](#vllm.model_executor.models.zamba2.Zamba2MambaDecoderLayer "Permanent link")
...
```
classZamba2MambaDecoderLayer(nn.Module):
"""Single Mamba decoder layer with normalization.
...
### \_\_init\__ [¶](#vllm.model_executor.models.zamba2.Zamba2MambaDecoderLayer.__init__ "Permanent link")
...
### forward [¶](#vllm.model_executor.models.zamba2.Zamba2MambaDecoderLayer.forward "Permanent link")

```
forward(
    hidden_states: Tensor,
    transformer_hidden_states: Tensor | None = None,
    positions: Tensor | None = None,
    original_hidden_states: Tensor | None = None,
) -> Tensor
```
...
## Zamba2Model [¶](#vllm.model_executor.models.zamba2.Zamba2Model "Permanent link")
...
### \_\_init\__ [¶](#vllm.model_executor.models.zamba2.Zamba2Model.__init__ "Permanent link")
...
### embed\_input\_ids [¶](#vllm.model_executor.models.zamba2.Zamba2Model.embed_input_ids "Permanent link")

Convert input token IDs to embeddings.

Parameters:

Name Type Description Default `input_ids` `Tensor`
...
### forward [¶](#vllm.model_executor.models.zamba2.Zamba2Model.forward "Permanent link")
...
Type Description `Tensor | IntermediateTensors`
