...
url: https://moodledev.io/docs/4.5/apis/subsystems/routing/parameters
source: sitemap
fetched_at: 2026-02-17T15:15:06.306099-03:00
rendered_js: false
word_count: 1347
summary: This document explains how to define, validate, and retrieve path, query, and header parameters within the routing subsystem.
tags:
    - routing
    - path-parameters
    - query-parameters
