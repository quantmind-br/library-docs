...
source: llms
fetched_at: 2026-04-16T22:31:14.147814431-03:00
rendered_js: false
word_count: 2201
summary: This document provides a detailed reference for the .claude directory and project-level files, explaining how Claude Code utilizes configuration files like CLAUDE.md, MCP settings, and worktree inclusion rules to manage context and environment.
tags:
    - claude-code
    - configuration
    - mcp-servers
