...
url: https://moodledev.io/docs/5.0/apis/subsystems/communication
source: sitemap
fetched_at: 2026-02-17T15:27:10.361454-03:00
rendered_js: false
word_count: 1473
summary: This document explains how to interact with the Moodle Communication API to manage rooms and members asynchronously using ad-hoc tasks and the Hooks API.
tags:
    - communication-api
    - ad-hoc-tasks
    - room-management
...
The Communication API takes advantage of the [Hooks API](https://moodledev.io/docs/5.0/apis/plugintypes/communication) with actions performed in the following way:
