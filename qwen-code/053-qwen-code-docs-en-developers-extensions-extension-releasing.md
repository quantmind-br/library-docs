...
url: https://qwenlm.github.io/qwen-code-docs/en/developers/extensions/extension-releasing
source: github_pages
fetched_at: 2026-04-09T09:05:13.917319471-03:00
rendered_js: true
word_count: 954
summary: 'This document compares and details two methods for distributing software extensions: via a general Git repository or through GitHub Releases, outlining the advantages, technical requirements, and best practices for each approach.'
tags:
    - extension-release
    - git-repository
    - github-releases
...
## Releasing through a git repository[](#releasing-through-a-git-repository)
...
### Managing release channels using a git repository[](#managing-release-channels-using-a-git-repository)
...
### Example releasing flow using a git repo[](#example-releasing-flow-using-a-git-repo)
...
## Releasing through Github releases[](#releasing-through-github-releases)
...
#### Platform specific archives[](#platform-specific-archives)
...
The rest of the layout should look exactly the same as a typical extension, see [extensions.md](https://qwenlm.github.io/qwen-code-docs/en/developers/extensions/extension/).
