...
Runbook định nghĩa quy trình release tiêu chuẩn của maintainer.
...
Từ checkout cục bộ sạch đã sync với `origin/master`:
...
- [[158-contributing-release-process|contributing-release-process]] — Quy trình release chi tiết.
