...
url: https://github.com/openagen/zeroclaw/blob/master/docs/i18n/vi/release-process.md
source: git
fetched_at: 2026-05-02T14:51:30.738497557-03:00
rendered_js: false
word_count: 666
summary: Tài liệu này định nghĩa quy trình chuẩn hóa cho maintainer trong việc quản lý và phát hành các phiên bản phần mềm ZeroClaw thông qua hệ thống tự động hóa GitHub Actions.
tags:
    - release-management
    - github-actions
    - devops
