...
source: llms
fetched_at: 2026-01-26T09:54:10.87446662-03:00
rendered_js: false
word_count: 816
summary: Explains how to install, configure, and use the Clawdbot Chrome extension to enable agent control over active browser tabs via a local or remote relay.
tags:
    - chrome-extension
    - browser-automation
    - relay-server
