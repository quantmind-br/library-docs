...
url: https://hyprland-community.github.io/pyprland/versions/2.6.2/scratchpads
source: github_pages
fetched_at: 2026-01-31T16:03:22.580886605-03:00
rendered_js: false
word_count: 551
summary: This document explains how to configure and use scratchpads in Hyprland using the pyprland plugin, covering setup, animations, sizing, positioning, and advanced customization options.
tags:
    - scratchpad
    - hyprland
    - window-management
...
- If you wish to have a more generic space for any application you may run, check [toggle\_special](https://hyprland-community.github.io/pyprland/versions/2.6.2/toggle_special.html).
...
- `attach`  Toggle attaching/anchoring the currently focused window to the (last used) scratchpad. (see also [multi](#multi))
...
It supports [Variables](https://hyprland-community.github.io/pyprland/versions/2.6.2/Variables.html)
...
- [Advanced](https://hyprland-community.github.io/pyprland/versions/2.6.2/scratchpads_advanced.html) contains options for fine-tuners or specific tastes (eg: i3 compatibility)
- [Non-Standard](https://hyprland-community.github.io/pyprland/versions/2.6.2/scratchpads_nonstandard.html) contains options for "broken" applications like progressive web apps (PWA) or emacsclient, use only if you can't get it to work otherwise
