...
url: https://danklinux.com/docs/1.2/dankmaterialshell/nixos
source: sitemap
fetched_at: 2026-02-22T18:43:04.111558-03:00
rendered_js: false
word_count: 528
summary: This document provides instructions for installing and configuring DankMaterialShell on NixOS using the native module or flakes. It details feature toggles, package management, plugin installation methods, and troubleshooting common setup issues.
tags:
    - nixos
    - dankmaterialshell
    - nixpkgs-unstable
...
DMS version available in `nixos-unstable` currently is DMS 1.0.3. This page will be updated as soon as [1.2](https://danklinux.com/blog/v1-2-release) gets updated in `nixpkgs`.

NixOS Unstable Required

DankMaterialShell is currently only available in the **unstable** branch of nixpkgs. If you're on NixOS stable (currently 25.11), you'll need to use the [Flake Installation](https://danklinux.com/docs/1.2/dankmaterialshell/nixos-flake) method instead.
