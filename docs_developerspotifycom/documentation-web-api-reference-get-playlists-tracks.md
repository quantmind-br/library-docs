...
source: crawler
fetched_at: 2026-02-27T23:38:53.297104-03:00
rendered_js: true
word_count: 2
summary: This document provides an example JSON response from the Spotify API, illustrating the data structure for paginated lists of media items including tracks and albums.
tags:
    - spotify-api
    - json-response
    - api-reference
