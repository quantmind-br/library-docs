...
url: https://moodledev.io/docs/5.1/apis/subsystems/form
source: sitemap
fetched_at: 2026-02-17T15:36:38.292467-03:00
rendered_js: false
word_count: 1054
summary: This document provides an overview of the Moodle Form API, detailing how to define form classes, handle submission data, and implement various UI elements. It covers the core requirements for form validation, processing, and rendering within Moodle plugins.
tags:
    - moodle-form-api
    - moodle-development
    - php-forms
...
- Support for file repository using the [File API](https://moodledev.io/docs/5.1/apis/subsystems/files) .
- Support for many custom Moodle specific and non-specific form elements.
- Facility for [repeated elements](https://moodledev.io/docs/5.1/apis/subsystems/form/advanced/repeat-elements).
...
03. [choicedropdown](https://moodledev.io/docs/5.1/apis/subsystems/form/fields/choicedropdown) - A dropdown menu where custom information is displayed on each option.
...
13. [filepicker](https://moodledev.io/docs/5.1/apis/subsystems/form/usage/files#file-picker) - upload single file
14. [filemanager](https://moodledev.io/docs/5.1/apis/subsystems/form/usage/files#file-manager) - upload multiple files
...
- [lib/formslib.php Usage](https://moodledev.io/docs/5.1/apis/subsystems/form/usage)
