---
title: XMLDB editor | Moodle Developer Resources
url: https://moodledev.io/general/development/tools/xmldb
source: sitemap
fetched_at: 2026-02-17T16:01:46.601733-03:00
rendered_js: false
word_count: 1260
summary: This document explains how to use Moodle's XMLDB editor to create and maintain database-neutral schema files for plugins. It provides instructions for managing tables, fields, and keys while adhering to Moodle's specific database conventions.
tags:
    - moodle-development
    - xmldb-editor
    - database-schema
...
functionxmldb_mymodule_upgrade($oldversion){
global$CFG;
...
![An image showing the XMLDB Editor, highlighting the &#39;View PHP Code&#39; link](https://moodledev.io/assets/images/xmldbeditor-showphpcode-690d3b189241cafa552121c6b83d2e0d.png)
...
1. About names:
   ...
   2. Table names and field names must use only a-z, 0-9 and _ chars. Max 53 characters for tables and 63 characters for fields (28 and 30 before Moodle 4.3).
   ...
   2. Primary key always must be named "primary" (this is one exception to the previous convention).
   3. It's highly recommended to avoid [reserved words](https://docs.moodle.org/dev/XMLDB_reserved_words) completely. We know we have some of them now but they should be completely out for next releases.
2. About NULLS
