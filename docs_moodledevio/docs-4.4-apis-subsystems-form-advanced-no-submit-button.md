...
url: https://moodledev.io/docs/4.4/apis/subsystems/form/advanced/no-submit-button
source: sitemap
fetched_at: 2026-02-17T15:04:31.485106-03:00
rendered_js: false
word_count: 156
summary: This document explains how to use the no_submit_button_pressed() method in Moodle forms to handle sub-actions that redisplay the form instead of completing a final submission.
tags:
    - moodle-development
    - moodleforms
    - form-handling
