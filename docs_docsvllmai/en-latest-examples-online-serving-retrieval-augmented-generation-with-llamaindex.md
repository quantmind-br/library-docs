---
title: Retrieval Augmented Generation With Llamaindex
url: https://docs.vllm.ai/en/latest/examples/online_serving/retrieval_augmented_generation_with_llamaindex/
source: sitemap
fetched_at: 2026-05-07T21:13:19.965365771-03:00
rendered_js: false
word_count: 0
summary: This document provides a implementation guide for building a Retrieval Augmented Generation (RAG) system using LlamaIndex, Milvus vector stores, and vLLM-hosted models.
tags:
    - rag
    - llamaindex
    - vllm
...
fromllama_index.coreimport Settings, StorageContext, VectorStoreIndex
...
fromllama_index.readers.webimport SimpleWebPageReader
fromllama_index.vector_stores.milvusimport MilvusVectorStore


definit_config(args: Namespace):
...
defsetup_vector_store(db_path: str) -> MilvusVectorStore:
...
defcreate_index(documents: list, vector_store: MilvusVectorStore):
...
defquery_document(index: VectorStoreIndex, question: str, top_k: int):
"""Query document with given question"""
    query_engine = index.as_query_engine(similarity_top_k=top_k)
    return query_engine.query(question)


defget_parser() -> argparse.ArgumentParser:
