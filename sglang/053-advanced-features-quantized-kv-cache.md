---
title: Quantized KV Cache — SGLang
url: https://docs.sglang.io/advanced_features/quantized_kv_cache.html
source: crawler
fetched_at: 2026-02-04T08:46:50.347103117-03:00
rendered_js: false
word_count: 765
summary: This document explains how to implement and configure quantized KV cache in SGLang using FP8 and FP4 formats to reduce memory usage and increase inference throughput. It covers supported precision types, server configuration, scaling factor management, and the performance trade-offs regarding accuracy and memory savings.
tags:
    - sglang
    - kv-cache
    - quantization
...
## Quantized KV Cache[#](#quantized-kv-cache "Link to this heading")
...
**Backend Support**: Not all attention backends support quantized KV cache. Refer to [Attention Backend](https://docs.sglang.io/advanced_features/attention_backend.html) for which backends support it.

## Supported Formats[#](#supported-formats "Link to this heading")

SGLang supports the following quantized KV cache formats:

### FP8 Format[#](#fp8-format "Link to this heading")
...
### FP4 Format[#](#fp4-format "Link to this heading")
...
### Enabling Quantized KV Cache[#](#enabling-quantized-kv-cache "Link to this heading")
...
--model-pathdeepseek-ai/DeepSeek-R1-0528\
...
python3-msglang.launch_server\
--model-pathnvidia/DeepSeek-R1-0528-NVFP4\
--kv-cache-dtypefp4_e2m1\
```

### Scaling Factors[#](#scaling-factors "Link to this heading")
...
### Memory Savings[#](#memory-savings "Link to this heading")
...
### Accuracy Impact[#](#accuracy-impact "Link to this heading")

#### FP8 Accuracy[#](#fp8-accuracy "Link to this heading")
...
#### FP4 Accuracy[#](#fp4-accuracy "Link to this heading")
