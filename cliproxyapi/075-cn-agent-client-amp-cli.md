...
url: https://help.router-for.me/cn/agent-client/amp-cli
source: crawler
fetched_at: 2026-01-14T22:10:16.47298767-03:00
rendered_js: false
word_count: 682
summary: This guide explains how to integrate the CLIProxyAPI with the Amp CLI and Amp IDE extensions, allowing you to use existing Google, ChatGPT, or Claude subscriptions via OAuth within the Amp CLI.
tags:
    - amr-cli
    - cli-proxy-api
    - oauth
...
### 你可以做什么 [​](#%E4%BD%A0%E5%8F%AF%E4%BB%A5%E5%81%9A%E4%BB%80%E4%B9%88)
...
### 你应该对哪些提供商进行 OAuth 登录？ [​](#%E4%BD%A0%E5%BA%94%E8%AF%A5%E5%AF%B9%E5%93%AA%E4%BA%9B%E6%8F%90%E4%BE%9B%E5%95%86%E8%BF%9B%E8%A1%8C-oauth-%E7%99%BB%E5%BD%95)
...
#### 回退行为 [​](#%E5%9B%9E%E9%80%80%E8%A1%8C%E4%B8%BA)
...
### 请求流程 [​](#%E8%AF%B7%E6%B1%82%E6%B5%81%E7%A8%8B)
...
#### 管理路由的 API 密钥认证 [​](#%E7%AE%A1%E7%90%86%E8%B7%AF%E7%94%B1%E7%9A%84-api-%E5%AF%86%E9%92%A5%E8%AE%A4%E8%AF%81)
...
#### 反向代理部署 [​](#%E5%8F%8D%E5%90%91%E4%BB%A3%E7%90%86%E9%83%A8%E7%BD%B2)
...
### 1. 配置 CLIProxyAPI [​](#_1-%E9%85%8D%E7%BD%AE-cliproxyapi)
...
### 2. 对提供商进行 OAuth 登录 [​](#_2-%E5%AF%B9%E6%8F%90%E4%BE%9B%E5%95%86%E8%BF%9B%E8%A1%8C-oauth-%E7%99%BB%E5%BD%95)
...
### 3. 启动代理 [​](#_3-%E5%90%AF%E5%8A%A8%E4%BB%A3%E7%90%86)
...
### 4. 配置 Amp CLI [​](#_4-%E9%85%8D%E7%BD%AE-amp-cli)

#### 选项 A：设置文件 [​](#%E9%80%89%E9%A1%B9-a-%E8%AE%BE%E7%BD%AE%E6%96%87%E4%BB%B6)
...
#### 选项 B：环境变量 [​](#%E9%80%89%E9%A1%B9-b-%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F)
...
### 5. 使用 Amp [​](#_5-%E4%BD%BF%E7%94%A8-amp)
...
### 6. (可选) 配置 Amp IDE 扩展 [​](#_6-%E5%8F%AF%E9%80%89-%E9%85%8D%E7%BD%AE-amp-ide-%E6%89%A9%E5%B1%95)
...
### 支持的路由 [​](#%E6%94%AF%E6%8C%81%E7%9A%84%E8%B7%AF%E7%94%B1)

#### 提供商别名（始终可用） [​](#%E6%8F%90%E4%BE%9B%E5%95%86%E5%88%AB%E5%90%8D-%E5%A7%8B%E7%BB%88%E5%8F%AF%E7%94%A8)
...
#### 管理路由（需要 `ampcode.upstream-url`） [​](#%E7%AE%A1%E7%90%86%E8%B7%AF%E7%94%B1-%E9%9C%80%E8%A6%81-ampcode-upstream-url)
...
### 模型回退行为 [​](#%E6%A8%A1%E5%9E%8B%E5%9B%9E%E9%80%80%E8%A1%8C%E4%B8%BA)
...
### API 调用示例 [​](#api-%E8%B0%83%E7%94%A8%E7%A4%BA%E4%BE%8B)
...
症状可能的原因解决方法`/api/provider/...` 404路由路径不正确确保路径完全匹配：`/api/provider/{provider}/v1...``/api/user` 401缺少/无效的 API 密钥配置 `api-keys` 并发送 `Authorization: Bearer <key>` 或 `X-Api-Key: <key>``/api/user` 403启用了 localhost 限制且请求来自远程从同一台机器运行或将 `ampcode.restrict-management-to-localhost` 设置为 `false`提供商返回 401/403缺少/过期的 OAuth重新运行 `--codex-login` 或 `--claude-login`Amp gzip 错误响应解压缩问题更新到最新版本；自动解压应能处理此问题模型请求未走代理Amp URL 配置错误检查 `amp.url` 设置或 `AMP_URL` 环境变量CORS 错误受保护的管理端点使用 CLI/终端，而不是浏览器

### 诊断 [​](#%E8%AF%8A%E6%96%AD)
...
### 安全检查清单 [​](#%E5%AE%89%E5%85%A8%E6%A3%80%E6%9F%A5%E6%B8%85%E5%8D%95)
