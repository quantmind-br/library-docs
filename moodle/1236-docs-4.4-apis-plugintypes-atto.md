...
url: https://moodledev.io/docs/4.4/apis/plugintypes/atto
source: sitemap
fetched_at: 2026-02-17T15:02:50.590169-03:00
rendered_js: false
word_count: 0
summary: This document provides a boilerplate example for creating a custom button plugin within the Moodle Atto text editor using the YUI framework. It illustrates how to initialize the button, handle user interactions through callbacks, and define plugin-specific attributes.
tags:
    - moodle
    - atto-editor
    - javascript
