...
url: https://moodledev.io/docs/5.1/apis/plugintypes/tiny/testing
source: sitemap
fetched_at: 2026-02-17T15:35:52.682711-03:00
rendered_js: false
word_count: 687
summary: This document explains how to write Behat tests for TinyMCE editor plugins in Moodle, detailing required tags and specific step definitions for editor interaction. It provides guidance on using generic and editor-specific steps to ensure reliable automated testing of rich text editor functionality.
tags:
    - moodle
    - behat
    - tinymce
