...
url: https://moodledev.io/docs/4.1/apis/plugintypes/mod/activitymodule
source: sitemap
fetched_at: 2026-02-17T14:55:41.612907-03:00
rendered_js: false
word_count: 673
summary: This document outlines the redesign of the Moodle activity chooser to improve user experience and provides technical instructions for plugin developers to implement new content item callbacks.
tags:
    - moodle
    - activity-chooser
    - plugin-development
