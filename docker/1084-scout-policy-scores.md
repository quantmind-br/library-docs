...
source: llms
fetched_at: 2026-01-24T14:29:24.979101112-03:00
rendered_js: false
word_count: 871
summary: This document explains Docker Scout health scores, which provide a security assessment of images on Docker Hub based on supply chain best practices and policy compliance.
tags:
    - docker-scout
    - health-scores
...
4. The final score is assigned based on the percentage of points achieved, as shown in the following table:
   ...
   Points percentage (awarded out of total)ScoreMore than 90%A71% to 90%B51% to 70%C31% to 50%D11% to 30%ELess than 10%F
