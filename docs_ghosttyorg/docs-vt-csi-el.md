...
url: https://ghostty.org/docs/vt/csi/el
source: crawler
fetched_at: 2026-03-03T08:23:35.728878-03:00
rendered_js: true
word_count: 472
summary: This document explains the behavior of the terminal sequence CSI n K (Erase in Line), detailing how the parameter 'n' (0, 1, or 2) dictates whether to erase right, erase left, or erase the entire line, along with rules for handling multi-cell characters and protected attributes.
tags:
    - erase-in-line
    - csi
    - terminal-sequence
...
If `n` is `1`, perform an **erase line left** operation. This replaces the `n` cells left of and including the cursor with a blank character and colors the background according to the current SGR state. The leftmost column that can be blanked is the first column of the screen. The [left margin](#TODO) has no effect on this operation.
...
- [EL V-1: Simple Erase Right](#el-v-1:-simple-erase-right)
- [EL V-2: Erase Right Resets Pending Wrap](#el-v-2:-erase-right-resets-pending-wrap)
- [EL V-3: Erase Right SGR State](#el-v-3:-erase-right-sgr-state)
- [EL V-4: Erase Right Multi-cell Character](#el-v-4:-erase-right-multi-cell-character)
- [EL V-5: Erase Right Left/Right Scroll Region Ignored](#el-v-5:-erase-right-leftright-scroll-region-ignored)
- [EL V-6: Erase Right Protected Attributes Ignored with DECSCA](#el-v-6:-erase-right-protected-attributes-ignored-with-decsca)
- [EL V-7: Protected Attributes Respected without DECSCA](#el-v-7:-protected-attributes-respected-without-decsca)
- [EL V-8: Simple Erase Left](#el-v-8:-simple-erase-left)
- [EL V-9: Erase Left SGR State](#el-v-9:-erase-left-sgr-state)
- [EL V-10: Erase Left Multi-cell Character](#el-v-10:-erase-left-multi-cell-character)
- [EL V-11: Erase Left Protected Attributes Ignored with DECSCA](#el-v-11:-erase-left-protected-attributes-ignored-with-decsca)
- [EL V-12: Simple Erase Complete](#el-v-12:-simple-erase-complete)
- [EL V-13: Erase Complete SGR State](#el-v-13:-erase-complete-sgr-state)