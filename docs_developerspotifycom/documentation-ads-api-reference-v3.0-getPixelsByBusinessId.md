...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/getPixelsByBusinessId
source: crawler
fetched_at: 2026-02-27T23:39:27.451003-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response structure for an API call retrieving pixel tracking data and event history.
tags:
    - api-response
    - json-sample
    - pixel-tracking
