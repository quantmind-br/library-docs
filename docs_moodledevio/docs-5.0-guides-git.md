...
url: https://moodledev.io/docs/5.0/guides/git
source: sitemap
fetched_at: 2026-02-17T15:28:33.445406-03:00
rendered_js: false
word_count: 2920
summary: This document outlines the standard Git workflow and setup procedures for Moodle developers, covering installation, configuration, and repository management.
tags:
    - moodle-development
    - git-workflow
    - version-control
