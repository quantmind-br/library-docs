---
title: Development Guide Using Docker - SGLang Documentation
url: https://docs.sglang.io/docs/developer_guide/development_guide_using_docker
source: sitemap
fetched_at: 2026-05-11T05:48:54.028640687-03:00
rendered_js: false
word_count: 559
summary: This document provides instructions for setting up a development environment for SGLang, covering remote VSCode tunnels, Docker container configuration, and debugging workflows.
tags:
    - sglang
...
*Figure 1: Diagram from VSCode official documentation [Developing inside a Container](https://code.visualstudio.com/docs/devcontainers/containers).* To enable this, you only need to:
...
The following startup command is an example for internal development by the SGLang team. You can **modify or add directory mappings as needed**, especially for model weight downloads, to prevent repeated downloads by different Docker containers. ❗️ **Note on RDMA**
