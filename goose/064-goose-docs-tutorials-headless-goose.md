---
title: Using goose in Headless Mode for Automation | goose
url: https://block.github.io/goose/docs/tutorials/headless-goose
source: github_pages
fetched_at: 2026-01-22T22:16:16.093572425-03:00
rendered_js: true
word_count: 955
summary: This document explains how to use goose in headless mode to automate engineering workflows in non-interactive environments such as CI/CD pipelines and servers.
tags:
    - headless-mode
    - automation
    - ci-cd
...
## What is Headless Mode?[​](#what-is-headless-mode "Direct link to What is Headless Mode?")
...
## Interactive vs. Headless: Understanding the Differences[​](#interactive-vs-headless-understanding-the-differences "Direct link to Interactive vs. Headless: Understanding the Differences")

FeatureInteractive ModeHeadless Mode**User Input**Prompts for user decisions and clarificationsUses default behaviors and pre-configured settings**Context Management**Prompts user to choose strategy when limits reachedAutomatically summarizes conversations**Session Persistence**Maintains ongoing conversation stateExecutes task and exits cleanly**Error Handling**User can intervene and provide guidanceAutomated error responses based on configuration**Tool Permissions**Can prompt for approval of risky operationsUses configured defaults or fails safely**Execution Flow**Back-and-forth conversation styleSingle execution with comprehensive output

## Real-World Use Cases with Command Examples[​](#real-world-use-cases-with-command-examples "Direct link to Real-World Use Cases with Command Examples")

### 1. Server Environments and Cloud Deployments[​](#1-server-environments-and-cloud-deployments "Direct link to 1. Server Environments and Cloud Deployments")
...
### 2. CI/CD Pipeline Integration[​](#2-cicd-pipeline-integration "Direct link to 2. CI/CD Pipeline Integration")
...
### 3. Batch Processing and Bulk Operations[​](#3-batch-processing-and-bulk-operations "Direct link to 3. Batch Processing and Bulk Operations")
...
### 4. Scheduled Job Execution[​](#4-scheduled-job-execution "Direct link to 4. Scheduled Job Execution")
...
## Best Practices for Headless Success[​](#best-practices-for-headless-success "Direct link to Best Practices for Headless Success")

So how do we set all this up?

Let's talk about the foundations of successful headless automation:

### 1. **Craft Crystal-Clear Instructions**[​](#1-craft-crystal-clear-instructions "Direct link to 1-craft-crystal-clear-instructions")
...
### 2. **Pre-Configure Your Environment**[​](#2-pre-configure-your-environment "Direct link to 2-pre-configure-your-environment")
...
### 3. **Implement Robust Error Handling**[​](#3-implement-robust-error-handling "Direct link to 3-implement-robust-error-handling")
...
### 4. **Choose the Right Session Strategy**[​](#4-choose-the-right-session-strategy "Direct link to 4-choose-the-right-session-strategy")
...
## Recipe Execution in Headless Mode[​](#recipe-execution-in-headless-mode "Direct link to Recipe Execution in Headless Mode")

[Recipes](https://block.github.io/goose/docs/guides/recipes/) are goose's powerful way to define reusable, parameterized workflows. In headless mode, recipes become even more valuable as they enable sophisticated automation scenarios.

### Recipe Requirements for Headless Mode[​](#recipe-requirements-for-headless-mode "Direct link to Recipe Requirements for Headless Mode")
...
### Executing Recipes in Headless Mode[​](#executing-recipes-in-headless-mode "Direct link to Executing Recipes in Headless Mode")
...
## Understanding the Limitations[​](#understanding-the-limitations "Direct link to Understanding the Limitations")
...
### 1. No User Interaction Capability[​](#1-no-user-interaction-capability "Direct link to 1. No User Interaction Capability")
...
### 2. Recipe Prompt Requirements[​](#2-recipe-prompt-requirements "Direct link to 2. Recipe Prompt Requirements")
...
### 3. Tool Permission Dependencies[​](#3-tool-permission-dependencies "Direct link to 3. Tool Permission Dependencies")
...
### 4. Context Decision Automation[​](#4-context-decision-automation "Direct link to 4. Context Decision Automation")
...
### 5. Error Recovery Limitations[​](#5-error-recovery-limitations "Direct link to 5. Error Recovery Limitations")
...
## Configuration and Environment Setup[​](#configuration-and-environment-setup "Direct link to Configuration and Environment Setup")

### Essential Environment Variables[​](#essential-environment-variables "Direct link to Essential Environment Variables")
...
## The Future of Automated Development[​](#the-future-of-automated-development "Direct link to The Future of Automated Development")
