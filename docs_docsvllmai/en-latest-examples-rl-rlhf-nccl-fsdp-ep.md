---
title: RLHF NCCL Fsdp Ep - vLLM
url: https://docs.vllm.ai/en/latest/examples/rl/rlhf_nccl_fsdp_ep/
source: sitemap
fetched_at: 2026-05-07T21:13:49.070165348-03:00
rendered_js: false
word_count: 0
summary: This document demonstrates how to synchronize model weights between a PyTorch FSDP2 training process and a vLLM inference engine using NCCL for real-time weight transfer in a distributed Ray environment.
tags:
    - vllm
    - fsdp2
...
fromtorch.distributed.fsdpimport fully_shard
...
"""
    ...
    defsetup_transfer_endpoint(self):
"""Create the NCCL rendezvous endpoint for weight transfer."""
    ...
    definit_weight_transfer_group(self, transfer_world_size: int):
...
"""Return weight names, dtypes, and shapes captured before FSDP wrapping."""
    ...
    defgather_and_broadcast_weights(self, packed: bool = True):
"""
...
async defgenerate_batch(engine, prompts, sampling_params):
"""Generate completions for a batch of prompts."""

    async defgen_one(prompt):
        output = None
