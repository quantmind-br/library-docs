...
url: https://moodledev.io/docs/4.4/apis/subsystems/editor
source: sitemap
fetched_at: 2026-02-17T15:04:01.63342-03:00
rendered_js: false
word_count: 187
summary: This document explains how to use the Moodle Editor API to programmatically enable and configure text editors on HTML text area elements.
tags:
    - moodle-api
    - text-editor
    - php
