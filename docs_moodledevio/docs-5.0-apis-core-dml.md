...
url: https://moodledev.io/docs/5.0/apis/core/dml
source: sitemap
fetched_at: 2026-02-17T15:24:31.945131-03:00
rendered_js: false
word_count: 2451
summary: This document outlines Moodle's Data Manipulation API, explaining how to use the global $DB object to interact with database records across different RDBMS platforms. It details core concepts such as table prefixing, placeholder usage for security, and specific methods for retrieving single or multiple records.
tags:
    - moodle-development
    - database-api
    - dml-api
...
- [DML exceptions](https://moodledev.io/docs/5.0/apis/core/dml/exceptions): New DML code is throwing exceptions instead of returning false if anything goes wrong
- [DML drivers](https://moodledev.io/docs/5.0/apis/core/dml/drivers): Database drivers for new DML layer
- [DDL functions](https://moodledev.io/docs/5.0/apis/core/dml/ddl): Where all the functions used to handle DB objects ([DDL](https://en.wikipedia.org/wiki/Data_Definition_Language)) are defined.