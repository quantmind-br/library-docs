...
url: https://moodledev.io/docs/4.5/apis/core/calendar
source: sitemap
fetched_at: 2026-02-17T15:10:58.343663-03:00
rendered_js: false
word_count: 1799
summary: This document provides a technical guide for using the Moodle Calendar API to manage user, group, and course events, including the implementation of dashboard action events.
tags:
    - moodle-api
    - calendar-api
    - event-management
