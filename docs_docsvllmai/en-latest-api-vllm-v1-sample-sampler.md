---
title: sampler - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/sample/sampler/
source: sitemap
fetched_at: 2026-05-07T21:41:35.19877575-03:00
rendered_js: false
word_count: 20
summary: This document defines a PyTorch-based sampler module responsible for token generation, including logit processing, penalty application, and probability-based token selection. It describes the pipeline for sampling next tokens and gathering specific log-probabilities using optimized kernels.
tags:
    - llm-inference
    - token-sampling
    - pytorch-module
...
"""
    ...
    def__init__(self, logprobs_mode: LogprobsMode = "raw_logprobs"):
        super().__init__()
    ...
    defgather_specific_token_logprobs(
        self,
        logits: torch.Tensor,
...
"""Compute logprobs for specific token IDs using Triton kernel.
    ...
    @staticmethod
    defgreedy_sample(logits: torch.Tensor) -> torch.Tensor:
...
"""Sample logits based on sampling metadata.
    ...
    @staticmethod
    defcompute_logprobs(logits: torch.Tensor) -> torch.Tensor:
