---
title: Tests - FastMCP
url: https://gofastmcp.com/v2/development/tests
source: crawler
fetched_at: 2026-01-22T22:23:00.906229052-03:00
rendered_js: false
word_count: 733
summary: This document outlines the best practices and technical procedures for testing FastMCP applications, including test organization, execution with pytest, and the use of markers and in-memory transports.
tags:
    - fastmcp
    - testing
    - pytest
...
New in version `2.13.0` For most network transport tests, use `run_server_async` as an async context manager. This runs the server as a task in the same process, providing fast, deterministic tests with full debugger support:
