...
url: https://moodledev.io/docs/5.1/apis/plugintypes/customfield
source: sitemap
fetched_at: 2026-02-17T15:34:57.325639-03:00
rendered_js: false
word_count: 0
summary: This document defines the field controller class for a Moodle custom field plugin, illustrating how to extend the core custom field controller and implement configuration form settings.
tags:
    - moodle-development
    - custom-fields
    - php-class
