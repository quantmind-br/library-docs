---
title: Slack Lead Qualifier with Modal - Pydantic AI
url: https://ai.pydantic.dev/examples/slack-lead-qualifier/
source: sitemap
fetched_at: 2026-01-22T22:25:47.633334356-03:00
rendered_js: false
word_count: 1896
summary: This document provides a step-by-step tutorial on building and deploying an AI-powered Slack lead qualifier agent using Pydantic AI, Modal, and Logfire. It explains how to automate user research, send real-time analysis to Slack channels, and manage infrastructure through serverless Python functions.
tags:
    - pydantic-ai
    - modal-deployment
    - slack-integration
...
3. Run the example as an [ephemeral Modal app](https://modal.com/docs/guide/apps#ephemeral-apps), meaning it will only run until you quit it using Ctrl+C:
   ...
   ```
   python/uv-run-mmodalserve-mpydantic_ai_examples.slack_lead_qualifier.modal
   ```
...
```
python/uv-run-mmodaldeploy-mpydantic_ai_examples.slack_lead_qualifier.modal
```
...
[Learn about Gateway](https://ai.pydantic.dev/gateway) [slack\_lead\_qualifier/agent.py (L7-L40)](https://github.com/pydantic/pydantic-ai/blob/main/examples/pydantic_ai_examples/slack_lead_qualifier/agent.py#L7-L40)
