---
title: 快速修复
url: https://docs.bmad-method.org/zh-cn/how-to/quick-fixes/
source: sitemap
fetched_at: 2026-04-08T11:33:21.053945997-03:00
rendered_js: false
word_count: 69
summary: This document explains the use case and workflow for 'Quick Dev', a streamlined development method intended for small changes like bug fixes, minor refactoring, or configuration tweaks. It details how to invoke Quick Dev in an AI IDE, what it does during execution (including self-checking and proposing commits), and when users should revert to the full BMad Method.
tags:
    - quick-dev
    - bug-fixing
    - refactoring
...
参见 [Quick Dev](https://docs.bmad-method.org/zh-cn/explanation/quick-dev/) 了解 Quick Dev 在 BMad Method 中的位置与边界。