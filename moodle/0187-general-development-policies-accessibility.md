---
title: Accessibility | Moodle Developer Resources
url: https://moodledev.io/general/development/policies/accessibility
source: sitemap
fetched_at: 2026-02-17T15:58:53.540165-03:00
rendered_js: false
word_count: 2352
summary: This document outlines Moodle's commitment to web accessibility, detailing its conformance with WCAG standards, audit procedures, and the specific coding requirements for maintaining inclusive design across its products.
tags:
    - accessibility
    - wcag-conformance
    - moodle-lms
...
## Accessibility conformance[​](#accessibility-conformance "Direct link to Accessibility conformance")
...
### Accessibility accreditations[​](#accessibility-accreditations "Direct link to Accessibility accreditations")

#### Moodle LMS[​](#moodle-lms "Direct link to Moodle LMS")
...
Audit periodTarget conformanceAccreditation dateTracker epicFixed versionsJanuary 2020WCAG 2.1 Level AA10 November 2020[MDL-67688](https://moodle.atlassian.net/browse/MDL-67688)v3.10, v3.9.3September 2021WCAG 2.1 Level AA8 November 2021[MDL-72657](https://moodle.atlassian.net/browse/MDL-72657)v4.0, v3.11.5, v3.10.8May 2022WCAG 2.1 Level AA3 May 2023[MDL-74624](https://moodle.atlassian.net/browse/MDL-74624)v4.2, v4.1.3, v4.0.8August 2023WCAG 2.1 Level AA24 January 2024[MDL-78185](https://moodle.atlassian.net/browse/MDL-78185)v4.4, v4.3.1, v4.2.4, v4.1.7January 2025WCAG 2.2 Level AA3 October 2025[MDL-84362](https://moodle.atlassian.net/browse/MDL-84362)v5.1, v5.0.3, v4.5.7
...
#### Moodle App[​](#moodle-app "Direct link to Moodle App")
...
#### Moodle Workplace[​](#moodle-workplace "Direct link to Moodle Workplace")
...
Audit periodTarget conformanceAccreditation dateFixed versionsAugust 2023WCAG 2.1 Level AA27 June 2024v4.4, v4.3, v4.2, v4.1January 2025WCAG 2.2 Level AA3 October 2025v5.1, v5.0, v4.5
...
### Accessibility accreditation process[​](#accessibility-accreditation-process "Direct link to Accessibility accreditation process")
...
### Voluntary Product Accessibility Template (VPAT)[​](#voluntary-product-accessibility-template-vpat "Direct link to Voluntary Product Accessibility Template (VPAT)")

#### Moodle LMS[​](#moodle-lms-1 "Direct link to Moodle LMS")
...
#### Moodle Workplace[​](#moodle-workplace-1 "Direct link to Moodle Workplace")
...
#### Moodle App[​](#moodle-app-1 "Direct link to Moodle App")
...
## IAAP membership[​](#iaap-membership "Direct link to IAAP membership")
...
### Colours[​](#colours "Direct link to Colours")
...
#### Solitary Icons[​](#solitary-icons "Direct link to Solitary Icons")
...
#### Icons and Text[​](#icons-and-text "Direct link to Icons and Text")
...
#### Multiple icons[​](#multiple-icons "Direct link to Multiple icons")
...
### Presentation Only[​](#presentation-only "Direct link to Presentation Only")
...
### Landmark regions[​](#landmark-regions "Direct link to Landmark regions")
...
### Page Titles[​](#page-titles "Direct link to Page Titles")
...
#### Separating components of a page title[​](#separating-components-of-a-page-title "Direct link to Separating components of a page title")
...
#### Site name on the page title[​](#site-name-on-the-page-title "Direct link to Site name on the page title")
...
### Advanced UX Widgets[​](#advanced-ux-widgets "Direct link to Advanced UX Widgets")
...
## Accessibility Testing[​](#accessibility-testing "Direct link to Accessibility Testing")

### Screen readers[​](#screen-readers "Direct link to Screen readers")
...
Screen readerOperating systemBrowser compatibilityUsed in testing on[NVDA](https://www.nvaccess.org/)WindowsChrome, Edge, FirefoxLMS[JAWS](http://www.freedomscientific.com/)WindowsChrome, Edge, FirefoxLMS[Narrator](https://support.microsoft.com/en-us/windows/complete-guide-to-narrator-e4397a0d-ef4f-b386-d8ae-c172f109bdb1)Windows**Edge**, Chrome, Firefox[VoiceOver](https://support.apple.com/guide/voiceover)macOS, iOS**Safari**, Chrome, Edge, FirefoxLMS, App[Talkback](https://support.google.com/accessibility/android/topic/3529932?hl=en&ref_topic=9078845&sjid=13502500306212449126-AP)Android**Chrome**, FirefoxLMS, App[ChromeVox](https://support.google.com/chromebook/answer/7031755)Chrome OS**Chrome**, Firefox

Notes about screen reader testing
...
### Accessibility testing tools[​](#accessibility-testing-tools "Direct link to Accessibility testing tools")

Aside from screen readers, Moodle LMS is also tested using a variety of accessibility tools:

#### Built-in browser dev tools[​](#built-in-browser-dev-tools "Direct link to Built-in browser dev tools")
...
#### Browser Extensions[​](#browser-extensions "Direct link to Browser Extensions")
...
#### HTML Validator[​](#html-validator "Direct link to HTML Validator")

- [Nu HTML Checker](https://github.com/validator/validator)

#### Behat[​](#behat "Direct link to Behat")
...
## International Legislation[​](#international-legislation "Direct link to International Legislation")

Moodle aims to comply with the following international legislation where possible.

### USA[​](#usa "Direct link to USA")

- [Section 508](http://www.section508.gov/)

### UK[​](#uk "Direct link to UK")
...
- [European Accessibility Act (Detailed proposal)](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=COM%3A2015%3A0615%3AFIN)
