---
title: Bioinformatics — Gateway to 400+ bioinformatics skills from bioSkills and ClawBio | Hermes Agent
url: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-bioinformatics
source: crawler
fetched_at: 2026-04-24T17:01:31.105029135-03:00
rendered_js: false
word_count: 1117
summary: This document serves as a gateway and comprehensive index to over 400 specialized bioinformatics skills provided by two libraries, bioSkills and ClawBio. It allows users to fetch domain-specific reference material or runnable pipelines on demand for various areas of biology.
tags:
...
SourceOptional — install with `hermes skills install official/research/bioinformatics`Path`optional-skills/research/bioinformatics`Version`1.0.0`Platformslinux, macosTags`bioinformatics`, `genomics`, `sequencing`, `biology`, `research`, `science`
...
2. Clone the relevant repo (shallow clone to save time):
   ...
   git clone --depth1 https://github.com/GPTomics/bioSkills.git /tmp/bioSkills
   
   # ClawBio (runnable pipelines)
   git clone --depth1 https://github.com/ClawBio/ClawBio.git /tmp/ClawBio
   ```
...
sudoaptinstall samtools bcftools ncbi-blast+ minimap2 bedtools
