---
title: Wan2.2 - SGLang Documentation
url: https://docs.sglang.io/cookbook/diffusion/Wan/Wan2.2
source: sitemap
fetched_at: 2026-05-11T05:49:52.479370732-03:00
rendered_js: false
word_count: 746
summary: This document provides instructions for deploying and invoking Wan2.2 video generative models using SGLang-diffusion, including configuration, optimization techniques, and API usage.
tags:
    - video-generation
    - diffusion-models
    - sglang
...
[Wan2.2 series](https://github.com/Wan-Video/Wan2.2) are the most popular and open and advanced large-scale video generative models. This generation delivers comprehensive upgrades across the board:
...
arcaneCseti/wan2.2-14B-Arcane\_Jinx-lora-v1
...
For more API usage and request examples, please refer to: [SGLang Diffusion OpenAI API](https://github.com/sgl-project/sglang/blob/main/python/sglang/multimodal_gen/docs/openai_api.md)
...
origin modelsupported LoRA[Wan-AI/Wan2.2-I2V-A14B-Diffusers](https://huggingface.co/Wan-AI/Wan2.2-I2V-A14B-Diffusers)[lightx2v/Wan2.2-Distill-Loras](https://huggingface.co/lightx2v/Wan2.2-Distill-Loras)[Wan-AI/Wan2.2-T2V-A14B-Diffusers](https://huggingface.co/Wan-AI/Wan2.2-T2V-A14B-Diffusers)[Cseti/wan2.2-14B-Arcane\_Jinx-lora-v1](https://huggingface.co/Cseti/wan2.2-14B-Arcane_Jinx-lora-v1)
