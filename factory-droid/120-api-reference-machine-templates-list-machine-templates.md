...
source: llms
fetched_at: 2026-02-05T21:40:12.870070184-03:00
rendered_js: false
word_count: 63
summary: Technical specification for the Factory Public API endpoint that retrieves a paginated list of machine templates for an organization.
tags:
    - factory-api
    - machine-templates
    - rest-api
