...
url: https://moodledev.io/docs/4.4/guides/javascript/reactive
source: sitemap
fetched_at: 2026-02-17T15:05:28.480118-03:00
rendered_js: false
word_count: 5759
summary: This document explains the architecture and implementation of Moodle's custom reactive library for building UI components that synchronize with a central state.
tags:
    - moodle-development
    - reactive-ui
    - state-management
