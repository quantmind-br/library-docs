...
url: https://docs.mitmproxy.org/stable/api/mitmproxy/certs.html#Cert
source: crawler
fetched_at: 2026-01-28T16:19:15.044868622-03:00
rendered_js: false
word_count: 3447
summary: This document defines the `Cert` class, providing a Pythonic interface for managing and inspecting TLS certificates within the mitmproxy project. It encapsulates certificate data and operations using the `cryptography` library.
tags:
    - mitmproxy
    - tls-certificates
    - python-api
