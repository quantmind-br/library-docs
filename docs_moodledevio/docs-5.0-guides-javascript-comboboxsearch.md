...
url: https://moodledev.io/docs/5.0/guides/javascript/comboboxsearch
source: sitemap
fetched_at: 2026-02-17T15:28:38.70578-03:00
rendered_js: false
word_count: 1026
summary: This document explains how to implement and extend the Moodle core combobox search component, detailing its structure and the helper methods available for developers.
tags:
    - moodle-development
    - combobox-search
    - ui-component
...
For example usages view the [examples](https://moodledev.io/docs/5.0/guides/javascript/comboboxsearch/examples) page.