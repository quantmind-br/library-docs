---
title: Guidance | Hermes Agent
url: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-guidance
source: crawler
fetched_at: 2026-04-24T17:01:24.754500688-03:00
rendered_js: false
word_count: 515
summary: This document serves as a reference guide for Guidance, a constrained generation framework from Microsoft Research that allows users to control Large Language Model output using regular expressions and grammars. It details various concepts like context managers, token healing, and grammar-based creation, providing installation instructions and quick start examples for use with models like OpenAI and Anthropic Claude.
tags:
...
SourceOptional — install with `hermes skills install official/mlops/guidance`Path`optional-skills/mlops/guidance`Version`1.0.0`AuthorOrchestra ResearchLicenseMITDependencies`guidance`, `transformers`Tags`Prompt Engineering`, `Guidance`, `Constrained Generation`, `Structured Output`, `JSON Validation`, `Grammar`, `Microsoft Research`, `Format Enforcement`, `Multi-Step Workflows`
...
defreact_agent(lm, question, tools, max_rounds=5):
"""ReAct agent with tool use."""
    lm +=f"Question: {question}\n\n"

for i inrange(max_rounds):
# Thought
...
@guidance
defchain_of_thought(lm, question):
...
FeatureGuidanceInstructorOutlinesLMQLRegex Constraints✅ Yes❌ No✅ Yes✅ YesGrammar Support✅ CFG❌ No✅ CFG✅ CFGPydantic Validation❌ No✅ Yes✅ Yes❌ NoToken Healing✅ Yes❌ No✅ Yes❌ NoLocal Models✅ Yes⚠️ Limited✅ Yes✅ YesAPI Models✅ Yes✅ Yes⚠️ Limited✅ YesPythonic Syntax✅ Yes✅ Yes✅ Yes❌ SQL-likeLearning CurveLowLowMediumHigh
