...
url: https://moodledev.io/docs/4.4/guides/bs5migration
source: sitemap
fetched_at: 2026-02-17T15:05:14.043131-03:00
rendered_js: false
word_count: 497
summary: This document outlines the phased migration process from Bootstrap 4 to Bootstrap 5, detailing specific refactoring steps for deprecated features like badges, media objects, and form layouts.
tags:
    - bootstrap-5
    - migration-guide
    - css-refactoring
