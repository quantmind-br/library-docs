...
url: https://ratatui.rs/recipes/apps/release-your-app/
source: crawler
fetched_at: 2026-02-01T21:13:20.058788886-03:00
rendered_js: false
word_count: 674
summary: This document provides a comprehensive checklist and set of best practices for releasing Ratatui-based applications, covering documentation, visual presentation, and compiler optimizations.
tags:
    - ratatui
    - rust-deployment
    - cargo-configuration
...
Don’t forget to add a screenshot / gif of your app in action. This will help users understand what your app does and how it looks. We recommend using a tool like [VHS](https://github.com/charmbracelet/vhs) to automate the process of creating screenshots and gifs. See the `.tape` files in the \[Ratatui repository] for examples of how we use VHS to create screenshots and gifs for our all the examples and widgets.

Some tips for creating good screenshots:

TL;DR: Use [VHS](https://github.com/charmbracelet/vhs), `Set Width 1200`, `Set Theme "Aardvark Blue"`, `Sleep 2s`, `Hide`/`Show` around CLI command to run the app,
...
- [codegen-units](https://doc.rust-lang.org/cargo/reference/profiles.html#codegen-units): Tweaks a tradeoff between compile times and compile time optimizations.
