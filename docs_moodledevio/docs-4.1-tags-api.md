---
title: 41 docs tagged with "API" | Moodle Developer Resources
url: https://moodledev.io/docs/4.1/tags/api
source: sitemap
fetched_at: 2026-02-17T14:49:48.147081-03:00
rendered_js: false
word_count: 1271
summary: This document provides an index and high-level overview of the various core and subsystem APIs available for Moodle 4.1 development. It serves as a central directory explaining the purpose of different backend services, from database manipulation to plugin extensibility.
tags:
    - moodle-development
    - core-api
    - plugin-development
...
## [Activity completion API](https://moodledev.io/docs/4.1/apis/core/activitycompletion)
...
## [Activity modules](https://moodledev.io/docs/4.1/apis/plugintypes/mod)
...
## [Analytics API](https://moodledev.io/docs/4.1/apis/subsystems/analytics)
...
## [Check API](https://moodledev.io/docs/4.1/apis/subsystems/check)
...
## [Core APIs](https://moodledev.io/docs/4.1/apis/core)
...
## [Favourites API](https://moodledev.io/docs/4.1/apis/subsystems/favourites)

Overview

## [File Converters](https://moodledev.io/docs/4.1/apis/plugintypes/fileconverter)
...
## [File Converters](https://moodledev.io/docs/4.1/apis/subsystems/files/converter)
...
## [HTML Writer API](https://moodledev.io/docs/4.1/apis/core/htmlwriter)
...
## [Machine learning backends](https://moodledev.io/docs/4.1/apis/plugintypes/mlbackend)
...
## [Navigation API](https://moodledev.io/docs/4.1/apis/core/navigation)

The Navigation API allows for the manipulation of the navigation system used in Moodle.

## [Output API](https://moodledev.io/docs/4.1/apis/subsystems/output)
...
## [Plagiarism API](https://moodledev.io/docs/4.1/apis/subsystems/plagiarism)
...
## [Preference API](https://moodledev.io/docs/4.1/apis/core/preference)
...
## [Privacy API](https://moodledev.io/docs/4.1/apis/subsystems/privacy)
...
## [Tag API](https://moodledev.io/docs/4.1/apis/subsystems/tag)
...
## [Time API](https://moodledev.io/docs/4.1/apis/subsystems/time)
