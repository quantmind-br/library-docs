...
source: llms
fetched_at: 2026-04-16T22:30:19.751868166-03:00
rendered_js: false
word_count: 1796
summary: This guide explains how to implement the `canUseTool` callback to handle user-driven permissions and clarifying questions within the Claude Agent SDK. It provides strategies for intercepting tool calls to present decisions to users and returning their approvals or denials.
tags:
    - claude-agent-sdk
    - user-input
    - tool-permissions
