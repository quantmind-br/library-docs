...
url: https://docs.clawd.bot/gateway/sandbox-vs-tool-policy-vs-elevated.md
source: llms
fetched_at: 2026-01-26T09:52:10.192596945-03:00
rendered_js: false
word_count: 506
summary: This document explains the differences and interactions between sandbox modes, tool policies, and elevated execution levels in Clawdbot. It provides guidance on configuring where tools run, which tools are accessible, and how to use host-level escape hatches for specific commands.
tags:
    - clawdbot
    - sandboxing
    - tool-policy
