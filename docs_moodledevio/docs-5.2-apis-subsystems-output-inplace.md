...
url: https://moodledev.io/docs/5.2/apis/subsystems/output/inplace
source: sitemap
fetched_at: 2026-02-17T15:46:09.341293-03:00
rendered_js: false
word_count: 535
summary: This document explains how to implement the inplace_editable mini-API in Moodle plugins to enable inline editing of values, covering callbacks, UI types, and template rendering.
tags:
    - moodle-development
    - php
    - inplace-editable
