---
title: Kimi-K2.5 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Moonshotai/Kimi-K2.5
source: sitemap
fetched_at: 2026-05-11T05:50:16.163768167-03:00
rendered_js: false
word_count: 701
summary: This document provides deployment and configuration guidance for the Kimi-K2.5 multimodal agentic model using the SGLang inference framework, covering hardware requirements, environment setup, and API invocation methods.
tags:
    - sglang
    - kimi-k2-5
    - multimodal
...
H200B300MI300XMI325XMI350XMI355X

Quantization

INT4initial modelNVFP4Blackwell only
