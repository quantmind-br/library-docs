...
source: crawler
fetched_at: 2026-01-28T16:18:16.040078797-03:00
rendered_js: false
word_count: 1716
summary: This document explains in detail how mitmproxy intercepts and processes network traffic, covering explicit HTTP, explicit HTTPS, and the various technical challenges like certificate handling, SNI, and upstream certificate sniffing.
tags:
    - mitmproxy
    - proxying
    - http-proxy
