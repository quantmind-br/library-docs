---
title: pydantic_ai.models.bedrock - Pydantic AI
url: https://ai.pydantic.dev/api/models/bedrock/
source: sitemap
fetched_at: 2026-01-22T22:24:23.383090074-03:00
rendered_js: false
word_count: 84
summary: Implementation of the BedrockConverseModel class which provides a structured interface for interacting with AWS Bedrock models via the Converse API.
tags:
    - aws-bedrock
...
"""Count the number of tokens, works with limited models.
        ...
        try:
            ...
            if isinstance(status_code, int):
                raise ModelHTTPError(status_code=status_code, model_name=self.model_name, body=e.response) frome
...
"""Maps a `pydantic_ai.Message` to the Bedrock `MessageUnionTypeDef`.
    ...
    @staticmethod
    def_get_last_user_message_content(messages: list[MessageUnionTypeDef]) -> list[Any] | None:
"""Get the content list from the last user message that can receive a cache point.
    ...
    @staticmethod
    async def_map_user_prompt(  # noqa: C901
        part: UserPromptPart,
...
"""Limit the number of cache points in the request to Bedrock's maximum.
    ...
    @staticmethod
    def_remove_inference_geo_prefix(model_name: BedrockModelName) -> BedrockModelName:
