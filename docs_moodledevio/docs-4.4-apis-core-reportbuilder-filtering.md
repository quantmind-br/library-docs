...
url: https://moodledev.io/docs/4.4/apis/core/reportbuilder/filtering
source: sitemap
fetched_at: 2026-02-17T15:02:38.511974-03:00
rendered_js: false
word_count: 911
summary: This document explains how to configure default filter values for report builder datasources by implementing the get_default_condition_values method with specific key-naming conventions.
tags:
    - moodle
    - report-builder
    - datasource
...
### Operators with a single value[​](#operators-with-a-single-value-1 "Direct link to Operators with a single value")
