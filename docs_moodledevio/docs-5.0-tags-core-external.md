...
url: https://moodledev.io/docs/5.0/tags/core-external
source: sitemap
fetched_at: 2026-02-17T15:17:31.726067-03:00
rendered_js: false
word_count: 149
summary: This document provides an overview of Moodle's External Services framework, detailing how to declare, define, secure, and test web services for integration with external systems.
tags:
    - moodle-api
    - external-services
    - web-services
...
## [File handling](https://moodledev.io/docs/5.0/apis/subsystems/external/files)
