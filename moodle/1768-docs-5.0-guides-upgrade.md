...
url: https://moodledev.io/docs/5.0/guides/upgrade
source: sitemap
fetched_at: 2026-02-17T15:28:54.85884-03:00
rendered_js: false
word_count: 1453
summary: This document explains how Moodle plugins manage installations and database upgrades using the Upgrade API, detailing the roles of versioning files and database schema definitions.
tags:
    - moodle-development
    - upgrade-api
    - database-migration
...
The Upgrade API is a core API which allows your plugin to manage features of its own installation, and upgrade. Every plugin includes a [version](https://moodledev.io/docs/5.0/apis/commonfiles/version.php) which allows the Upgrade API to apply only the required changes.
...
See the documentation on [version.php](https://moodledev.io/docs/5.0/apis/commonfiles/version.php) for further information on the features of this file.
...
- All upgrade code may use the [basic database API](https://moodledev.io/docs/5.0/apis/core/dml).
...
In this scenario, we call upgrade function in [adhoc task](https://moodledev.io/docs/5.0/apis/subsystems/task/adhoc) and schedule its run as follows:
...
See the documentation on other [common files](https://moodledev.io/docs/5.0/apis/commonfiles) that may be of use to you, in particular the following may be useful:

- [install.php](https://moodledev.io/docs/5.0/apis/commonfiles#dbinstallphp)
- [uninstall.php](https://moodledev.io/docs/5.0/apis/commonfiles#dbuninstallphp)
- [access.php](https://moodledev.io/docs/5.0/apis/commonfiles#dbaccessphp)
- [events.php](https://moodledev.io/docs/5.0/apis/commonfiles#dbeventsphp)
- [messages.php](https://moodledev.io/docs/5.0/apis/commonfiles#dbmessagesphp)
- [services.php](https://moodledev.io/docs/5.0/apis/commonfiles#dbservicesphp)
- [subplugins.json](https://docs.moodle.org/dev/Subplugins#db.2Fsubplugins.json)
- [Language files](https://moodledev.io/docs/5.0/apis/commonfiles#langenplugintype_pluginnamephp)
...
The Upgrade API makes *very intensive use* of other APIs, including [DDL](https://moodledev.io/docs/5.0/apis/core/dml/ddl), [DML](https://moodledev.io/docs/5.0/apis/core/dml), and a range of tools in order to proceed with the required changes for the upgrade.
...
- [DDL functions](https://moodledev.io/docs/5.0/apis/core/dml/ddl)
