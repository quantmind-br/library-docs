...
url: https://moodledev.io/docs/5.0/apis/plugintypes/communication
source: sitemap
fetched_at: 2026-02-17T15:25:25.818704-03:00
rendered_js: false
word_count: 881
summary: This document explains how to develop a communication provider plugin, detailing the required file structure and PHP interfaces used to integrate external communication tools. It covers mandatory implementation steps for room management, user synchronization, and API integration within the communication system.
tags:
    - plugin-development
    - communication-api
    - php-interfaces
...
Some important files are described below. See the [common plugin files](https://moodledev.io/docs/5.0/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
