...
source: llms
fetched_at: 2026-01-26T09:53:12.260461732-03:00
rendered_js: false
word_count: 332
summary: This document outlines the macOS Inter-Process Communication architecture for Clawdbot, explaining how the node service, GUI application, and PeekabooBridge interact to handle system commands and UI automation.
tags:
    - macos
    - ipc
    - architecture
