---
title: MOVA - SGLang Documentation
url: https://docs.sglang.io/cookbook/diffusion/MOVA/MOVA
source: sitemap
fetched_at: 2026-05-11T05:50:01.591333187-03:00
rendered_js: false
word_count: 597
summary: This document provides an overview and deployment guide for MOVA, an open-source foundation model designed for synchronized video and audio generation using SGLang-diffusion.
tags:
    - mova
    - video-generation
    - audio-synthesis
