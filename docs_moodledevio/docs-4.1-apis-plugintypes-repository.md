...
url: https://moodledev.io/docs/4.1/apis/plugintypes/repository
source: sitemap
fetched_at: 2026-02-17T14:55:42.954706-03:00
rendered_js: false
word_count: 4033
summary: This document outlines the architecture and mandatory file structure required to develop repository plugins for Moodle, covering administration and file picker integration.
tags:
    - moodle-development
    - repository-plugin
    - plugin-architecture
...
Some of the important files for the repository plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
