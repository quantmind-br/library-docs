...
source: sitemap
fetched_at: 2026-01-23T08:01:20.233362614-03:00
rendered_js: false
word_count: 2383
summary: This document outlines the technical roadmap and strategic goals for the DSPy framework as it transitions toward versions 2.5 and 3.0. It details plans for enhancing modular LM programming, improving prompt optimizers, and refining the core library's architectural abstractions.
tags:
    - dspy-framework
    - technical-roadmap
    - lm-programming
...
This document is from Aug 2024. Since then, DSPy 2.5 and 2.6 were released, DSPy has grown considerably, and 3.0 is approaching! Content below is highly outdated.

## Roadmap Sketch: DSPy 2.5+[¶](#roadmap-sketch-dspy-25 "Permanent link")
...
## Technical Objectives[¶](#technical-objectives "Permanent link")
...
## Team & Organization[¶](#team-organization "Permanent link")
...
## 1) Polishing the core functionality.[¶](#1-polishing-the-core-functionality "Permanent link")
...
### On Signatures & Modules[¶](#on-signatures-modules "Permanent link")
...
### On Finetuning & Serving[¶](#on-finetuning-serving "Permanent link")
...
### On Optimizers & Assertions[¶](#on-optimizers-assertions "Permanent link")
...
## 2) Developing more accurate, lower-cost optimizers.[¶](#2-developing-more-accurate-lower-cost-optimizers "Permanent link")
...
Over the next six months, our goal is to dramatically improve each angle of these *when the other two are held constant*. Concretely, there are three directions here.
...
## 3) Building end-to-end tutorials from DSPy’s ML workflow to deployment.[¶](#3-building-end-to-end-tutorials-from-dspys-ml-workflow-to-deployment "Permanent link")
