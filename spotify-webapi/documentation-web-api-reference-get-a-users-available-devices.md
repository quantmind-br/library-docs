...
source: crawler
fetched_at: 2026-02-27T23:46:46.017431-03:00
rendered_js: false
word_count: 163
summary: This document provides a technical reference for the Spotify Web API endpoint used to retrieve information about a user's available and active Spotify Connect devices. It outlines the response data structure, including device identifiers, status indicators, and playback capabilities.
tags:
    - spotify-api
    - player-endpoints
    - device-management
