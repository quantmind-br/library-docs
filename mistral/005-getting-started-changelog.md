...
source: crawler
fetched_at: 2026-01-29T07:33:08.111334669-03:00
rendered_js: false
word_count: 1225
summary: This document provides a chronological log of all major updates, model releases, and API modifications for the platform's tools and services.
tags:
    - changelog
    - release-notes
    - model-releases
...
- We released the new [Agents API](https://docs.mistral.ai/agents/agents_introduction). API UPDATED

## May 21

- We released Mistral OCR 2 (`mistral-ocr-2505`) and [annotations](https://docs.mistral.ai/capabilities/OCR/annotations). MODEL RELEASED API UPDATED
...
- We released Mistral OCR (`mistral-ocr-2503`) and [document understanding](https://docs.mistral.ai/capabilities/OCR/basic_ocr). MODEL RELEASED API UPDATED
...
- We released Agents API. See details [here](https://docs.mistral.ai/agents/agents_introduction). API UPDATED
...
- We released fine-tuning API. Check out the [capability docs](https://docs.mistral.ai/capabilities/finetuning) and [guides](https://docs.mistral.ai/guides/finetuning). API UPDATED

## May 28

- New model available: `codestral-latest` (aka `codestral-2405`). Check out the code generation [docs](https://docs.mistral.ai/capabilities/code_generation). MODEL RELEASED API UPDATED
...
- We released three versions of tokenizers for commercial and open-weight models: check the related [guide](https://docs.mistral.ai/guides/tokenization) and [repo](https://github.com/mistralai/mistral-common) for more details. OTHER
...
- New API capabilities: API UPDATED
  ...
  - [Function calling](https://docs.mistral.ai/capabilities/function_calling): available for Mistral Small and Mistral Large.
  - [JSON mode](https://docs.mistral.ai/capabilities/structured-output/json_mode): available for Mistral Small and Mistral Large
...
- A previous version of the [guardrailing documentation](https://docs.mistral.ai/capabilities/guardrailing) incorrectly referred to the API parameter as `safe_mode` instead of `safe_prompt`. We corrected this in the documentation. OTHER