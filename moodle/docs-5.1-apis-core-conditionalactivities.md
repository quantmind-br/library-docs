...
url: https://moodledev.io/docs/5.1/apis/core/conditionalactivities
source: sitemap
fetched_at: 2026-02-17T15:34:03.661905-03:00
rendered_js: false
word_count: 469
summary: This document describes the Moodle Conditional Activities API, which manages activity availability through the condition_info class. It covers methods for fetching, adding, updating, and removing availability restrictions based on completion, grades, and dates.
tags:
    - moodle-development
...
- [How to make a new availability condition plugin](https://moodledev.io/docs/5.1/apis/plugintypes/availability).
