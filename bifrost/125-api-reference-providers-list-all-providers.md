...
````yaml openapi/openapi.json get /api/providers
openapi: 3.1.0
info:
  title: Bifrost API
  description: >
...
paths:
  /api/providers:
    get:
      ...
      description: >-
        Returns a list of all configured providers with their configurations and
        status.
                    ...
                    items:
                      ...
                      properties:
                        ...
                        config_hash:
                          type: string
                          description: >-
                            Hash of config.json version, used for change
                            detection
                  total:
                    type: integer
        '500':
