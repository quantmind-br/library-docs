...
source: llms
fetched_at: 2026-01-26T09:51:32.837695055-03:00
rendered_js: false
word_count: 1036
summary: This document explains session management in Clawdbot, covering how chat states are scoped, stored on the gateway, and reset based on time or activity.
tags:
    - session-management
    - clawdbot
    - chat-lifecycle
