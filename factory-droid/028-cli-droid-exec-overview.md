...
source: sitemap
fetched_at: 2026-04-15T09:00:44.731834607-03:00
rendered_js: false
word_count: 1118
summary: Droid Exec is a headless, non-interactive task runner designed for automation workflows, CI/CD pipelines, and batch processing with tiered autonomy levels for secure command execution.
tags:
    - automation
    - ci-cd
    - cli-tools
...
Choose a model with `-m` and adjust reasoning with `-r`. See the [model table](https://docs.factory.ai/pricing#available-models) for available models.
