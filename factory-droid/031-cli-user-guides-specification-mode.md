...
source: sitemap
fetched_at: 2026-04-15T09:01:05.730996383-03:00
rendered_js: false
word_count: 706
summary: This document explains how to use Specification Mode to create detailed implementation plans and safety-checked technical roadmaps before applying changes to a codebase.
tags:
    - specification-mode
    - cli-workflow
    - code-generation
