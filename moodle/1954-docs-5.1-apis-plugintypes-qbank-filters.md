...
url: https://moodledev.io/docs/5.1/apis/plugintypes/qbank/filters
source: sitemap
fetched_at: 2026-02-17T15:35:27.952925-03:00
rendered_js: false
word_count: 1169
summary: This document explains how to create and implement custom filter conditions for question bank plugins, covering the necessary backend PHP classes and frontend JavaScript components.
tags:
    - moodle-development
    - qbank-plugins
    - filter-conditions
