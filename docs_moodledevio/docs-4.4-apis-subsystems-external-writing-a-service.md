...
url: https://moodledev.io/docs/4.4/apis/subsystems/external/writing-a-service
source: sitemap
fetched_at: 2026-02-17T15:04:15.946662-03:00
rendered_js: false
word_count: 1036
summary: This document explains how to create and implement a new external web service function within a Moodle plugin, covering naming conventions, service declaration, and technical implementation details.
tags:
    - moodle-development
    - web-services
    - external-api
...
- [Web services developer documentation](https://moodledev.io/docs/4.4/apis/subsystems/external)
...
- [External services security](https://moodledev.io/docs/4.4/apis/subsystems/external/security)
- [External services description](https://moodledev.io/docs/4.4/apis/subsystems/external/description)
