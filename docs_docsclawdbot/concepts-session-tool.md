...
source: llms
fetched_at: 2026-01-26T09:51:35.29237406-03:00
rendered_js: false
word_count: 843
summary: This document defines a set of tools for agents to manage and interact with sessions, including listing active sessions, fetching message history, sending messages between sessions, and spawning sub-agent tasks.
tags:
    - session-management
    - agent-communication
    - chat-history
