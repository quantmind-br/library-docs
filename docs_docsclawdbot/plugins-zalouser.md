...
source: llms
fetched_at: 2026-01-26T09:53:17.650814974-03:00
rendered_js: false
word_count: 166
summary: This document provides instructions for installing, configuring, and using the Zalo Personal plugin for Clawdbot to automate a standard user account using zca-cli.
tags:
    - clawdbot
    - zalo-personal
    - plugin-installation
