---
title: Contributing | Moodle Developer Resources
url: https://moodledev.io/general/documentation/contributing
source: sitemap
fetched_at: 2026-02-17T16:02:02.254026-03:00
rendered_js: false
word_count: 1882
summary: This document provides comprehensive guidelines and instructions for contributing to Moodle's developer documentation, covering minor fixes, local development setup, and the migration of legacy content.
tags:
    - moodle
    - documentation
...
Moodle is in the process of updating and modernising its [Code of Conduct](https://moodledev.io/general/documentation/code-of-conduct). If you would like to be a part of this process, please see the [GitHub issue](https://github.com/moodle/devdocs/issues/47) and give us your thoughts.
...
- Raise issues in GitHub for [features which need to be documented](https://github.com/moodle/devdocs/issues/new?assignees=&labels=documentation%2C%20help%20wanted%2C%20enhancement&template=documentation-request.yml&title=%5Bdocs%5D%20Create%20documentation%20for%20%5BFeature%5D)
...
## Making a small change[​](#making-a-small-change "Direct link to Making a small change")
...
## Getting started with a development environment[​](#getting-started-with-a-development-environment "Direct link to Getting started with a development environment")

Our documentation is built using [Docusaurus](https://docusaurus.io), a powerful open source documentation project written in JavaScript. For more detailed information, see our [installation guide](https://moodledev.io/general/documentation/installation) to install your development environment and get started.
...
### Migrating legacy docs[​](#migrating-legacy-docs "Direct link to Migrating legacy docs")
...
#### What we automate[​](#what-we-automate "Direct link to What we automate")
...
#### Using the assistant[​](#using-the-assistant "Direct link to Using the assistant")
...
### Triaging Issues and Pull Requests[​](#triaging-issues-and-pull-requests "Direct link to Triaging Issues and Pull Requests")

One of the many ways that you can contribute is to help triage the [list of pending issues](https://github.com/moodle/devdocs/issues?q=is%3Aissue%20is%3Aopen%20label%3Aneeds-triage).
...
## Adding diagrams[​](#adding-diagrams "Direct link to Adding diagrams")
...
### Documentation requests[​](#documentation-requests "Direct link to Documentation requests")
...
A set of writing and coding style guidelines for this documentation will be documented in more detail in the [style guides](https://moodledev.io/general/documentation/style-guides).

important

See our [linting and spelling](https://moodledev.io/general/documentation/linting) documentation for more information on how to check for common issues.
...
### Versioned Docs[​](#versioned-docs "Direct link to Versioned Docs")
...
### Linking to Moodle Academy[​](#linking-to-moodle-academy "Direct link to Linking to Moodle Academy")
