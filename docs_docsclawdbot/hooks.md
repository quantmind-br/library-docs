...
source: llms
fetched_at: 2026-01-26T09:52:20.980371808-03:00
rendered_js: false
word_count: 1516
summary: This document explains the Clawdbot hooks system, an event-driven framework for automating actions in response to agent commands, lifecycle events, and tool results.
tags:
    - clawdbot
    - hooks
    - event-driven
