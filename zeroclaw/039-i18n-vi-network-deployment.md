...
url: https://github.com/openagen/zeroclaw/blob/master/docs/i18n/vi/network-deployment.md
source: git
fetched_at: 2026-05-02T14:51:20.569976791-03:00
rendered_js: false
word_count: 706
summary: Hướng dẫn triển khai ZeroClaw trên thiết bị Raspberry Pi, bao gồm các cấu hình về cổng mạng, kết nối channel, thiết lập phần cứng và sử dụng dịch vụ tunnel.
tags:
    - zeroclaw
    - raspberry-pi
    - iot
