...
url: https://docs.sglang.io/docs/developer_guide/contribution_guide
source: sitemap
fetched_at: 2026-05-11T05:48:56.763113887-03:00
rendered_js: false
word_count: 1467
summary: This document provides guidelines for contributing to the SGLang repository, covering environment setup, code formatting, testing procedures, documentation, and the pull request workflow.
tags:
    - contribution-guide
    - sglang
    - testing
...
Refer to [Install SGLang from Source](https://docs.sglang.io/docs/get-started/install#method-2-from-source).
...
If you want to contribute but don’t have a specific idea in mind, pick issues labeled [“good first issue” or “help wanted”](https://github.com/sgl-project/sglang/issues?q=is%3Aissue%20label%3A%22good%20first%20issue%22%2C%22help%20wanted%22). These tasks typically have lower complexity and provide an excellent introduction to the codebase. Also check out the following materials as startup guide:
...
If you have any questions or want to start a discussion, please feel free to ask in our [Slack channel](https://slack.sglang.io). Thank you for your interest in SGLang. Happy coding!