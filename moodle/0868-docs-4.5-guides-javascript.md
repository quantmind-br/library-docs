...
url: https://moodledev.io/docs/4.5/guides/javascript
source: sitemap
fetched_at: 2026-02-17T15:15:41.935822-03:00
rendered_js: false
word_count: 2046
summary: This document introduces the core concepts and standards for writing JavaScript in Moodle, focusing on ES2015 modules, naming conventions, and event handling.
tags:
    - moodle
    - javascript
    - es2015
...
See the [Creating reactive UI](https://moodledev.io/docs/4.5/guides/javascript/reactive) for more information.
