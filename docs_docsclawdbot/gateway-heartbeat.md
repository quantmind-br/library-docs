---
title: "null"
url: https://docs.clawd.bot/gateway/heartbeat.md
source: llms
fetched_at: 2026-01-26T09:52:00.182962276-03:00
rendered_js: false
word_count: 1233
summary: This document explains Clawdbot's Heartbeat feature, which enables agents to perform periodic background tasks and check-ins within an active session. It provides detailed configuration options for intervals, prompts, delivery targets, and visibility controls across different messaging channels.
tags:
    - clawdbot
    - heartbeat
    - agent-configuration
