...
url: https://moodledev.io/docs/4.5/apis/subsystems/files/converter
source: sitemap
fetched_at: 2026-02-17T15:14:02.931825-03:00
rendered_js: false
word_count: 392
summary: This document explains how to use the Moodle file converter API to transform documents between formats and manage conversion statuses asynchronously.
tags:
    - moodle-development
    - file-converter-api
    - document-conversion
...
- Creating a new [file converter plugin](https://moodledev.io/docs/4.5/apis/plugintypes/fileconverter)