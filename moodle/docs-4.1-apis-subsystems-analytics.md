...
url: https://moodledev.io/docs/4.1/apis/subsystems/analytics
source: sitemap
fetched_at: 2026-02-17T14:55:53.44237-03:00
rendered_js: false
word_count: 5667
summary: This document provides a technical overview of the Moodle Analytics API, explaining how to define prediction models using indicators and targets to generate actionable insights through machine learning.
tags:
    - moodle-development
    - analytics-api
    - machine-learning
...
Documentation available in [Machine learning backends](https://moodledev.io/docs/4.1/apis/plugintypes/mlbackend).
...
[Machine learning backends](https://moodledev.io/docs/4.1/apis/plugintypes/mlbackend) is a new Moodle plugin type. They are stored in `lib/mlbackend`.
...
This section does not include Machine learning backend interfaces. See [Machine learning backends](https://moodledev.io/docs/4.1/apis/plugintypes/mlbackend#interfaces) for more information on these.
...
As specified in the [Target](https://moodledev.io/docs/4.1/apis/subsystems/analytics#target-core_analyticslocaltargetbase) section.
