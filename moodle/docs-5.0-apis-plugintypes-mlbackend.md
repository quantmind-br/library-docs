...
url: https://moodledev.io/docs/5.0/apis/plugintypes/mlbackend
source: sitemap
fetched_at: 2026-02-17T15:25:48.841064-03:00
rendered_js: false
word_count: 662
summary: This document explains the architecture and implementation of machine learning backends in Moodle, detailing how they interact with the Analytics API to perform training, evaluation, and prediction.
tags:
    - moodle-analytics
    - machine-learning
    - mlbackend
...
Machine learning backends process the datasets generated from the indicators and targets calculated by the [Analytics API](https://moodledev.io/docs/5.0/apis/subsystems/analytics). They are used for machine learning training, prediction and models evaluation.

tip

We strongly recommend that you read the [Analytics API](https://moodledev.io/docs/5.0/apis/subsystems/analytics) documentation to help understand the core concepts, how they are implemented in Moodle, and how machine learning backend plugins fit into the analytics API.
...
Some of the important files for the mlbackend plugintype are described below. See the [common plugin files](https://moodledev.io/docs/5.0/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
