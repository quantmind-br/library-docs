...
### 1. Prompt Injection Detection (`promptinjectiondetection`)[​](#1-prompt-injection-detection-promptinjectiondetection "Direct link to 1-prompt-injection-detection-promptinjectiondetection")
...
### 2. Trust & Safety (`trustsafety`)[​](#2-trust--safety-trustsafety "Direct link to 2-trust--safety-trustsafety")
...
### 3. Language Detection (`lang_detector`)[​](#3-language-detection-lang_detector "Direct link to 3-language-detection-lang_detector")
