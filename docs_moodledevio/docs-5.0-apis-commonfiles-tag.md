...
url: https://moodledev.io/docs/5.0/apis/commonfiles/tag.php
source: sitemap
fetched_at: 2026-02-17T15:23:55.980395-03:00
rendered_js: false
word_count: 0
summary: This document defines the configuration structure and available attributes for tag areas in Moodle, specifying how various item types are tagged and retrieved.
tags:
    - moodle
    - tagging-system
