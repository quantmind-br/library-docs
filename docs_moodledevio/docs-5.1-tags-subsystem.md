...
url: https://moodledev.io/docs/5.1/tags/subsystem
source: sitemap
fetched_at: 2026-02-17T15:33:10.749129-03:00
rendered_js: false
word_count: 328
summary: This document provides a high-level overview of various Moodle core APIs and subsystems, including task management, caching, backup and restore processes, and group handling.
tags:
    - moodle-development
    - core-apis
    - subsystems
