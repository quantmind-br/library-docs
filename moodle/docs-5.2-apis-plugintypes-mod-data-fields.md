...
url: https://moodledev.io/docs/5.2/apis/plugintypes/mod_data/fields
source: sitemap
fetched_at: 2026-02-17T15:44:30.777097-03:00
rendered_js: false
word_count: 391
summary: This document provides a technical overview and instructions for developing custom field type sub-plugins for the Moodle Database activity module.
tags:
    - moodle-development
    - database-module
    - plugin-types
...
The [Database activity](https://docs.moodle.org/en/Database_module) included with Moodle includes support for several predefined [field types](https://moodledev.io/docs/5.2/apis/plugintypes/mod_data/fields), including text, date, and URL. It is also possible to create new field types. For example, you might like to create:
...
Some of the important files for the database field plugintype are described below. See the [common plugin files](https://moodledev.io/docs/5.2/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
