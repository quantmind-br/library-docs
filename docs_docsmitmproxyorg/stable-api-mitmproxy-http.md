...
source: crawler
fetched_at: 2026-01-28T16:18:37.502572282-03:00
rendered_js: false
word_count: 12722
summary: This document defines the `Headers` class for managing HTTP headers with case-insensitive access and handling of multiple header values, and the `MessageData` dataclass for structuring HTTP message components within the mitmproxy library.
tags:
    - http-headers
    - mitmproxy
    - dataclass
