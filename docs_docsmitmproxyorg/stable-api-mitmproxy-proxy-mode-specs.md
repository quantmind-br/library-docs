...
url: https://docs.mitmproxy.org/stable/api/mitmproxy/proxy/mode_specs.html#ProxyMode
source: crawler
fetched_at: 2026-01-28T16:19:13.305010614-03:00
rendered_js: false
word_count: 3163
summary: This document describes the parsing and structure of mitmproxy's proxy mode specifications, outlining the general syntax for defining modes with optional configurations, listen addresses, and ports, and detailing the `ProxyMode` class hierarchy.
tags:
    - mitmproxy
    - proxy-mode
