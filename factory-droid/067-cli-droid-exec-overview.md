...
source: llms
fetched_at: 2026-02-05T21:41:42.063799267-03:00
rendered_js: false
word_count: 1267
summary: This document explains Droid Exec, a non-interactive headless mode for automating tasks within CI/CD pipelines and shell scripts. It covers installation, CLI command options, and the tiered autonomy system for managing security permissions.
tags:
    - droid-exec
    - headless-mode
    - automation
