---
title: Profiling - SGLang Documentation
url: https://docs.sglang.io/docs/sglang-diffusion/profiling
source: sitemap
fetched_at: 2026-05-11T05:51:34.534446663-03:00
rendered_js: false
word_count: 415
summary: This document provides instructions for profiling multimodal generation pipelines in SGLang using PyTorch Profiler and NVIDIA Nsight Systems to analyze performance and latency.
tags:
    - sglang
...
See the [SGLang profiling guide](https://docs.sglang.io/docs/developer_guide/benchmark_and_profiling#profile-with-nsight) for installation instructions.
