...
source: llms
fetched_at: 2026-01-24T14:42:05.963803673-03:00
rendered_js: false
word_count: 2089
summary: This document defines the build subsection of the Docker Compose Specification, detailing the configuration options for building container images from source code.
tags:
    - docker-compose
    - build-specification
    - container-images
...
`sbom` configures the builder to add a [provenance attestation](https://slsa.dev/provenance/v0.2#schema) to the published image. The value can be either a boolean to enable/disable sbom attestation, or a key=value string to set SBOM generator configuration. This let you select an alternative SBOM generator image (see [https://github.com/moby/buildkit/blob/master/docs/attestations/sbom-protocol.md](https://github.com/moby/buildkit/blob/master/docs/attestations/sbom-protocol.md))
