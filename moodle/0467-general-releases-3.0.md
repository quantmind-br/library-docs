---
title: Moodle 3.0 | Moodle Developer Resources
url: https://moodledev.io/general/releases/3.0
source: sitemap
fetched_at: 2026-02-17T16:08:31.060414-03:00
rendered_js: false
word_count: 1421
summary: This document provides the release notes for Moodle 3.0, detailing technical server requirements, browser compatibility, and major feature updates across various activity modules.
tags:
    - moodle-3-0
    - release-notes
    - system-requirements
...
Here is [the full list of fixed issues in 3.0](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%223.0%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
- PHP version: minimum PHP 5.4.4 (always use latest PHP 5.4.x or 5.5.x on Windows - [http://windows.php.net/download/](http://windows.php.net/download/)). For PHP 7.0.x support, upgrade to [Moodle 3.0.1](https://moodledev.io/general/releases/3.0/3.0.1) or later. PHP 7.1.x is not supported by Moodle 3.0.
...
- [MDL-49515](https://moodle.atlassian.net/browse/MDL-49515) - Upgrade FPDI library in assignfeedback\_editpdf to 1.5.4 to fix problems with PDF annotator on some files
...
### User interface and usability improvements[​](#user-interface-and-usability-improvements "Direct link to User interface and usability improvements")
...
### Atto editor[​](#atto-editor "Direct link to Atto editor")
...
### Enrolments[​](#enrolments "Direct link to Enrolments")
...
There are no new security issues since the [Moodle 2.9.3 release](https://moodledev.io/general/releases/2.9/2.9.3#security-issues) on 9 November 2015.
...
- [MDL-50125](https://moodle.atlassian.net/browse/MDL-50125) - Allow all plugins to inject links in the preferences page ([documentation](https://moodledev.io/docs/5.2/apis/core/navigation#course-settings))
...
- [MDL-33564](https://moodle.atlassian.net/browse/MDL-33564) - rss\_error() should return a proper HTTP response code
...
- [MDL-51213](https://moodle.atlassian.net/browse/MDL-51213) - external\_format\_text should be safe to call from web or webservice ([documentation](https://docs.moodle.org/dev/How_to_contribute_a_web_service_function_to_core))
- [MDL-51413](https://moodle.atlassian.net/browse/MDL-51413) - Add an additional return field in get\_forums\_by\_courses in order to specify if the current user can create discussions
- [MDL-51217](https://moodle.atlassian.net/browse/MDL-51217) - Using recaptcha is not possible outside auth\_email plugin.
- [MDL-51107](https://moodle.atlassian.net/browse/MDL-51107) - Add a callback to inject nodes in the category settings navigation ([documentation](https://moodledev.io/docs/5.2/apis/core/navigation#category-settings))
- [MDL-50891](https://moodle.atlassian.net/browse/MDL-50891) - is\_web\_crawler should be moved to useragent class
...
- [MDL-50491](https://moodle.atlassian.net/browse/MDL-50491) - New format\_text option to exclude particular filters
- [MDL-50783](https://moodle.atlassian.net/browse/MDL-50783) - Allow some ajax external functions to be called without a session ([documentation](https://moodledev.io/docs/5.2/guides/javascript/ajax))
- [MDL-50150](https://moodle.atlassian.net/browse/MDL-50150) - Add "Blocks" feature to JS and PHP mustache engines ([documentation](https://moodledev.io/docs/5.2/guides/templates#blocks))

## Translations[​](#translations "Direct link to Translations")

- [Notes de mise à jour de Moodle 3.0](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_3.0)
