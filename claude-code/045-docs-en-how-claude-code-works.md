...
source: llms
fetched_at: 2026-04-16T22:33:00.602082373-03:00
rendered_js: false
word_count: 2461
summary: This guide explains the inner workings of Claude Code, detailing how its agentic loop facilitates task completion through context gathering, action, and verification using models and tools.
tags:
    - agentic-loop
    - claude-code
    - terminal-assistant
