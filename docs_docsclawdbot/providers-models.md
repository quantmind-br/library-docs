...
source: llms
fetched_at: 2026-01-26T09:53:23.261492965-03:00
rendered_js: false
word_count: 143
summary: This document explains how to authenticate and configure LLM providers for Clawdbot, including a quick start guide for setting default models. It provides a comprehensive list of supported AI services like Venice AI, OpenAI, and Anthropic.
tags:
    - llm-providers
    - clawdbot-setup
    - model-configuration
