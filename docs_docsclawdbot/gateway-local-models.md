...
source: llms
fetched_at: 2026-01-26T09:52:01.910381861-03:00
rendered_js: false
word_count: 382
summary: This document explains how to configure local large language models for Clawdbot, including hardware requirements, LM Studio integration, and hybrid local-hosted setup strategies.
tags:
    - local-llm
    - lm-studio
    - model-configuration
