...
source: crawler
fetched_at: 2026-01-28T16:18:38.783545179-03:00
rendered_js: false
word_count: 96
summary: This document defines and explains the structure of server specifications within mitmproxy, detailing how a `ServerSpec` tuple is composed and providing the `parse` function for converting a string representation into this structured format, including validation.
tags:
