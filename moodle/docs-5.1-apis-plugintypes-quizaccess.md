...
url: https://moodledev.io/docs/5.1/apis/plugintypes/quizaccess
source: sitemap
fetched_at: 2026-02-17T15:35:34.425167-03:00
rendered_js: false
word_count: 1
summary: This document defines the class structure and interface implementation for a Moodle quiz access rule plugin that supports user or group overrides. It provides a template for handling form fields, data validation, database persistence, and display logic for custom quiz access settings.
tags:
    - moodle-development
    - quiz-access-rule
    - plugin-development
