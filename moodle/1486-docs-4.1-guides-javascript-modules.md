...
url: https://moodledev.io/docs/4.1/guides/javascript/modules
source: sitemap
fetched_at: 2026-02-17T14:57:19.507731-03:00
rendered_js: false
word_count: 1314
summary: Explains the implementation and management of JavaScript modules in Moodle, covering the transition to ES Modules, the transpilation process, and integration with PHP and templates.
tags:
    - moodle
    - javascript-modules
    - es-modules
...
For information on the development toolchain, see our [documentation on how to install and use NodeJS and Grunt](https://moodledev.io/general/development/tools/nodejs).
...
Since all JavaScript must now be transpiled you must use the [Grunt](https://moodledev.io/general/development/tools/nodejs) in order for you changes to appear in the browser.
...
If both are used, then the *default* export will override tall *named* exports.
