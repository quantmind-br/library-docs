...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/updateMobileAppByBusinessAndId
source: crawler
fetched_at: 2026-02-27T23:39:36.878064-03:00
rendered_js: true
word_count: 448
summary: This document provides technical details for an API endpoint used to update metadata and measurement settings for a mobile application within the Ads API.
tags:
    - ads-api
    - mobile-measurement
    - patch-request
...
Ads API •References / mobile-measurement / Update the specified mobile app.

## Update the specified mobile app.
...
Mobile app response with updated values.
