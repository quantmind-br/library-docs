...
url: https://moodledev.io/docs/5.1/apis/subsystems/files/converter
source: sitemap
fetched_at: 2026-02-17T15:36:37.439893-03:00
rendered_js: false
word_count: 392
summary: This document provides an overview and technical guide for using the Moodle file converter API to perform and manage asynchronous file conversions between different formats.
tags:
    - moodle-api
    - file-conversion
...
- Creating a new [file converter plugin](https://moodledev.io/docs/5.1/apis/plugintypes/fileconverter)