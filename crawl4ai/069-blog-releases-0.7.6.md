---
title: Crawl4AI v0.7.6 Release Notes - Crawl4AI Documentation (v0.8.x)
url: https://docs.crawl4ai.com/blog/releases/0.7.6/
source: sitemap
fetched_at: 2026-04-26T07:46:32.350860302-03:00
rendered_js: false
word_count: 574
summary: This document introduces webhook support in Crawl4AI v0.7.6, enabling event-driven notifications for crawling and LLM extraction jobs to replace traditional polling methods.
tags:
    - webhooks
    - api-integration
...
```
curl-XPOSThttp://localhost:11235/crawl/job\
...
curl-XPOSThttp://localhost:11235/llm/job\
-H"Content-Type: application/json"\
-d'{
...
- [**WEBHOOK\_EXAMPLES.md**](https://docs.crawl4ai.com/blog/releases/deploy/docker/WEBHOOK_EXAMPLES.md) - Comprehensive webhook usage guide
- [**docker\_webhook\_example.py**](https://docs.crawl4ai.com/blog/releases/docs/examples/docker_webhook_example.py) - Working code examples

### Updated Documentation

- [**Docker README**](https://docs.crawl4ai.com/blog/releases/deploy/docker/README.md) - Added webhook sections
...
```
pythondocs/releases_review/demo_v0.7.6.py
```

This comprehensive demo showcases: - Crawl job webhooks (notification-only and with data) - LLM extraction webhooks (with JSON schema support) - Custom headers for authentication - Webhook retry mechanism - Real-time webhook receiver
