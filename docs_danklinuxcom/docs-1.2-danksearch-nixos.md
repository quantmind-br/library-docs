...
source: sitemap
fetched_at: 2026-02-22T18:43:17.659795-03:00
rendered_js: false
word_count: 259
summary: This guide provides instructions for installing and configuring the DankSearch application on NixOS using the native nixpkgs module and flake inputs.
tags:
    - nixos
    - danksearch
    - nixpkgs
...
DankSearch is currently only available in the **unstable** branch of nixpkgs. If you're on NixOS stable, you'll need to use the [Flake Installation](https://danklinux.com/docs/1.2/danksearch/nixos-flake) method instead.
