---
title: Qwen2.5-VL - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Qwen/Qwen2.5-VL
source: sitemap
fetched_at: 2026-05-11T05:50:14.879359972-03:00
rendered_js: false
word_count: 636
summary: This document provides an overview of the Qwen2.5-VL vision-language model, including deployment configurations for AMD GPU hardware, multi-modal invocation patterns, and performance benchmarking guidelines using the SGLang framework.
tags:
    - qwen2.5-vl
...
[**Qwen2.5-VL**](https://huggingface.co/collections/Qwen/qwen25-vl) is a vision-language model series from the Qwen team, offering significant improvements over its predecessor in understanding, reasoning, and multi-modal processing. **Key Features:**
