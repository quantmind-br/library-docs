...
source: sitemap
fetched_at: 2026-01-24T13:33:25.058545678-03:00
rendered_js: false
word_count: 726
summary: This document explains how to use the dms doctor command to diagnose system configurations, verify dependencies, and troubleshoot DankMaterialShell installations.
tags:
    - dms-doctor
    - troubleshooting
    - system-diagnostics
