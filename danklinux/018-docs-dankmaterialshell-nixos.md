...
source: sitemap
fetched_at: 2026-04-07T21:33:07.063485116-03:00
rendered_js: false
word_count: 547
summary: This guide details how to install and configure DankMaterialShell on NixOS, covering requirements for the unstable channel, enabling core features like system monitoring and VPN, managing custom package versions via flakes, installing community plugins using a registry or manually, and deploying compositor-specific settings.
tags:
    - nixos-installation
    - dms-shell
    - configuration-guide
...
The NixOS module installs DMS but doesn't generate compositor-specific config files (keybinds, colors, layout, etc.). Use [`dms setup`](https://danklinux.com/docs/dankmaterialshell/cli-setup) to deploy the defaults for your compositor, or generate individual configs:
...
See the [Setup CLI reference](https://danklinux.com/docs/dankmaterialshell/cli-setup) for the full list of subcommands.
