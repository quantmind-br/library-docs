...
source: llms
fetched_at: 2026-04-16T22:35:15.983045793-03:00
rendered_js: false
word_count: 4796
summary: This document explains how to create, configure, and use specialized AI subagents within Claude Code to manage context and automate task-specific workflows. It details built-in agents as well as the process for defining custom agents with unique prompts, tool access, and models.
tags:
    - claude-code
    - ai-subagents
    - workflow-automation
