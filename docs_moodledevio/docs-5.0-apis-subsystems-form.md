...
url: https://moodledev.io/docs/5.0/apis/subsystems/form
source: sitemap
fetched_at: 2026-02-17T15:27:34.84532-03:00
rendered_js: false
word_count: 1054
summary: This document explains how to use the Moodle Form API to create, display, and process secure web forms by extending the moodleform class. It covers form definition, data validation, and provides a comprehensive list of available basic and advanced form elements.
tags:
    - moodle-development
    - form-api
    - moodleform
...
- Support for file repository using the [File API](https://moodledev.io/docs/5.0/apis/subsystems/files) .
- Support for many custom Moodle specific and non-specific form elements.
- Facility for [repeated elements](https://moodledev.io/docs/5.0/apis/subsystems/form/advanced/repeat-elements).
...
03. [choicedropdown](https://moodledev.io/docs/5.0/apis/subsystems/form/fields/choicedropdown) - A dropdown menu where custom information is displayed on each option.
...
13. [filepicker](https://moodledev.io/docs/5.0/apis/subsystems/form/usage/files#file-picker) - upload single file
14. [filemanager](https://moodledev.io/docs/5.0/apis/subsystems/form/usage/files#file-manager) - upload multiple files
...
- [lib/formslib.php Usage](https://moodledev.io/docs/5.0/apis/subsystems/form/usage)
