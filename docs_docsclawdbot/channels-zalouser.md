...
source: llms
fetched_at: 2026-01-26T09:50:29.40772609-03:00
rendered_js: false
word_count: 406
summary: This guide provides instructions for installing and configuring the experimental Zalo Personal plugin for Clawdbot using zca-cli. It covers authentication via QR code, access control policies for DMs and groups, and multi-account management.
tags:
    - zalo-personal
    - clawdbot-plugin
    - zca-cli
