...
source: llms
fetched_at: 2026-01-26T09:51:20.445403676-03:00
rendered_js: false
word_count: 1541
summary: This document explains Clawdbot's memory system, which uses Markdown files for persistent context and includes features for automated memory flushing and semantic vector search.
tags:
    - clawdbot
    - memory-management
    - vector-search
