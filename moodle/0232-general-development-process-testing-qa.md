---
title: QA testing | Moodle Developer Resources
url: https://moodledev.io/general/development/process/testing/qa
source: sitemap
fetched_at: 2026-02-17T16:00:43.627382-03:00
rendered_js: false
word_count: 1963
summary: This document outlines the procedures and guidelines for participating in Moodle's Quality Assurance (QA) testing cycles, including instructions on running tests, reporting bugs, and using the testing dashboard.
tags:
    - moodle
    - quality-assurance
    - qa-testing
...
## Getting involved[​](#getting-involved "Direct link to Getting involved")

Would you like to help with QA testing? If so, please make sure you have created an account in the [Moodle tracker](https://moodledev.io/general/development/tracker) and you're subscribed to the [Testing and QA forum](https://moodle.org/mod/forum/view.php?id=56) in order to receive QA testing news updates.
...
## Any questions?[​](#any-questions "Direct link to Any questions?")
...
- Moodle QA Matrix chat room - Come and join us as in the [#qa:moodle.com](https://matrix.to/#/%23qa:moodle.com) room on Matrix.
...
## Moodle QA Testing Site[​](#moodle-qa-testing-site "Direct link to Moodle QA Testing Site")
...
If you require admin access to the Moodle QA Testing Site for running certain tests, please ask in the [Moodle QA Matrix chat room](https://matrix.to/#/%23qa:moodle.com) or the [Testing and QA forum](https://moodle.org/mod/forum/view.php?id=56) for someone to send you the account credentials via private message.

## Failed tests[​](#failed-tests "Direct link to Failed tests")
...
4. Try searching for whether the bug has been reported previously, and if not create a new issue for it (as described in [Tracker introduction](https://moodledev.io/general/development/tracker)).
5. In the new Moodle (MDL) issue select 'Link' from the 'More actions' dropdown menu. Linking to the QA issue in the tracker
6. Link to the QA test by selecting 'blocks' as the link type, entering the MDLQA number that you noted earlier, and optionally adding a comment. Adding details for a link to the QA issue
...
## Resetting tests[​](#resetting-tests "Direct link to Resetting tests")
...
## Fixing existing bugs[​](#fixing-existing-bugs "Direct link to Fixing existing bugs")
...
## Testing tips[​](#testing-tips "Direct link to Testing tips")
...
## New QA tests required[​](#new-qa-tests-required "Direct link to New QA tests required")
...
### New features, and improvements[​](#new-features-and-improvements "Direct link to New features, and improvements")
...
## Updating tests[​](#updating-tests "Direct link to Updating tests")
...
5. In the description field add the test steps (usually between 3 and 10), similar to the issue's [testing instructions](https://moodledev.io/general/development/process/testing/guide), starting with 'Log in as a teacher...' or similar. It's a good idea to try doing the steps yourself as you write the test.
...
> This test requires admin access. If you would like to use the \[QA testing site|[https://qa.moodledemo.net/](https://qa.moodledemo.net/)] for running it, please see the \[QA testing guide|[https://docs.moodle.org/dev/QA\_testing](https://docs.moodle.org/dev/QA_testing)] for details of how to request admin access. Begin just after the hourly reset to give yourself plenty of time to complete the test!

## Automating a test[​](#automating-a-test "Direct link to Automating a test")

1. Choose a test from the list [MDLQA tests with label mdlqa\_conversion](https://moodle.atlassian.net/issues/?jql=project%20%3D%20MDLQA%20AND%20labels%20%3D%20mdlqa_conversion%20and%20status%20%3D%20Open).
...
## Previous QA cycles[​](#previous-qa-cycles "Direct link to Previous QA cycles")
