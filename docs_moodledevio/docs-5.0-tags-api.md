...
url: https://moodledev.io/docs/5.0/tags/api
source: sitemap
fetched_at: 2026-02-17T15:16:29.284119-03:00
rendered_js: false
word_count: 1371
summary: This document serves as an index and overview of the core APIs, subsystems, and plugin types available within the Moodle development framework for extending platform functionality.
tags:
    - moodle-development
    - core-apis
    - plugin-architecture
...
## [Activity completion API](https://moodledev.io/docs/5.0/apis/core/activitycompletion)
...
## [Activity modules](https://moodledev.io/docs/5.0/apis/plugintypes/mod)
...
## [Analytics API](https://moodledev.io/docs/5.0/apis/subsystems/analytics)

The Analytics API allows managers to use predictions to detect trends and predict student behaviour

## [Backup API](https://moodledev.io/docs/5.0/apis/subsystems/backup)
...
## [Cache API](https://moodledev.io/docs/5.0/apis/subsystems/muc)
...
## [Check API](https://moodledev.io/docs/5.0/apis/subsystems/check)
...
## [Core APIs](https://moodledev.io/docs/5.0/apis/core)
...
## [Favourites API](https://moodledev.io/docs/5.0/apis/subsystems/favourites)
...
## [Form Usage](https://moodledev.io/docs/5.0/apis/subsystems/form/usage)
...
## [Function Definitions](https://moodledev.io/docs/5.0/apis/subsystems/external/functions)
...
## [Hooks API](https://moodledev.io/docs/5.0/apis/core/hooks)

This page describes the Hooks API which is a replacement for some of the lib.php based one-to-many

## [HTML Writer API](https://moodledev.io/docs/5.0/apis/core/htmlwriter)
...
## [Machine learning backends](https://moodledev.io/docs/5.0/apis/plugintypes/mlbackend)
...
## [Message API](https://moodledev.io/docs/5.0/apis/core/message)

What is this document?

## [Module visibility and display](https://moodledev.io/docs/5.0/apis/plugintypes/mod/visibility)
...
## [Plagiarism API](https://moodledev.io/docs/5.0/apis/subsystems/plagiarism)
...
## [Plugin Upgrades](https://moodledev.io/docs/5.0/guides/upgrade)
...
## [Preference API](https://moodledev.io/docs/5.0/apis/core/preference)
...
## [Questions API](https://moodledev.io/docs/5.0/apis/subsystems/question)
...
## [Restore API](https://moodledev.io/docs/5.0/apis/subsystems/backup/restore)
...
## [Scheduled tasks](https://moodledev.io/docs/5.0/apis/subsystems/task/scheduled)
...
## [Security](https://moodledev.io/docs/5.0/apis/subsystems/external/security)

Before operating on any data in an external function, you must ensure that the user:

## [Service creation](https://moodledev.io/docs/5.0/apis/subsystems/external/advanced/custom-services)
...
## [Task API](https://moodledev.io/docs/5.0/apis/subsystems/task)
...
## [Time API](https://moodledev.io/docs/5.0/apis/subsystems/time)
...
## [Unit Testing](https://moodledev.io/docs/5.0/apis/subsystems/external/testing)

Unit tests are the best way of checking the behaviour of your external services and can help you to:

## [xAPI (Experience API)](https://moodledev.io/docs/5.0/apis/subsystems/xapi)
