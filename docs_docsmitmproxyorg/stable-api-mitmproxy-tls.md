---
title: mitmproxy.tls
url: https://docs.mitmproxy.org/stable/api/mitmproxy/tls.html#TlsData
source: crawler
fetched_at: 2026-01-28T16:19:11.900258338-03:00
rendered_js: false
word_count: 1821
summary: This document defines Python classes for representing, parsing, and interacting with TLS and DTLS ClientHello messages and associated event data within the mitmproxy framework, detailing how to extract protocol information like SNI and ALPN.
tags:
    - tls
    - dtls
    - client-hello
