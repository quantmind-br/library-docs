...
url: https://docs.bmad-method.org/fr/explanation/analysis-phase/
source: sitemap
fetched_at: 2026-04-08T11:30:15.660087544-03:00
rendered_js: false
word_count: 834
summary: This document explains the Analysis phase of product development, detailing three key tools—Research, Product Brief, and PRFAQ—designed to refine a vague concept before formal planning. It guides users on when and why to use each method to strengthen their foundational ideas.
tags:
    - product-development
    - analysis-phase
    - prd-refinement
...
[Section titled “Why Analysis Before Planning?”](#why-analysis-before-planning)
...
[Section titled “Research (Market, Domain, Technical)”](#research-market-domain-technical)
...
[Section titled “PRFAQ (Working Backwards)”](#prfaq-working-backwards)
...
[Section titled “What Happens After Analysis?”](#what-happens-after-analysis)
