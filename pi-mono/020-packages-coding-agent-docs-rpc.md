...
source: git
fetched_at: 2026-03-03T03:40:25.111663-03:00
rendered_js: false
word_count: 3784
summary: Document explains how to enable RPC mode for headless operation of a coding agent via JSON protocol over stdin/stdout for integration into other tools.
tags:
    - rpc-mode
    - headless-ai
    - json-protocol
