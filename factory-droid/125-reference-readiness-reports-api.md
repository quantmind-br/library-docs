...
source: llms
fetched_at: 2026-02-05T21:45:08.526708333-03:00
rendered_js: false
word_count: 582
summary: This document provides a technical reference for the Readiness Reports API, enabling programmatic access to agent readiness evaluation data through REST endpoints. It details authentication requirements, request parameters, response schemas, and common integration patterns for CI/CD and custom dashboards.
tags:
    - rest-api
    - readiness-reports
    - api-reference
