...
url: https://moodledev.io/docs/5.2/apis/subsystems/privacy/faq
source: sitemap
fetched_at: 2026-02-17T15:46:13.881875-03:00
rendered_js: false
word_count: 723
summary: This document provides guidance for Moodle developers on implementing the Privacy API, explaining how to handle user data, metadata declarations, and privacy providers within various plugin types.
tags:
    - moodle-development
    - privacy-api
    - gdpr-compliance
