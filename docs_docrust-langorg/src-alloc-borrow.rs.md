...
url: https://doc.rust-lang.org/src/alloc/borrow.rs.html#494
source: crawler
fetched_at: 2026-05-06T21:27:10.756484829-03:00
rendered_js: false
word_count: 1947
summary: This module provides the ToOwned trait for converting borrowed data into owned data and the Cow enum, which implements clone-on-write smart pointer functionality for efficient memory management.
tags:
    - rust
    - memory-management
    - smart-pointers
