...
[Get started with Zen](https://opencode.ai/auth)
...
- \[2]
  ...
  **Use Zen with transparent pricing** - [pay per request](https://opencode.ai/docs/zen/#pricing) with zero markups
- \[3]
...
All Zen models are hosted in the US. Providers follow a zero-retention policy and do not use your data for model training, with the [following exceptions](https://opencode.ai/docs/zen/#privacy).

[![](https://opencode.ai/_build/assets/avatar-dax-BtGwOij3.png)**Dax Raad**ex-CEO, Terminal Products  
\
@OpenCode Zen has been life changing, it's truly a no-brainer.](https://x.com/thdxr/status/1973531687629017227)

[![](https://opencode.ai/_build/assets/avatar-jay-zVEm53TS.png)**Jay V**ex-Founder, SEED, PM, Melt, Pop, Dapt, Cadmus, and ViewPoint  
\
4 out of 5 people on our team love using @OpenCode Zen.](https://x.com/jayair/status/1973530190870618456)

[![](https://opencode.ai/_build/assets/avatar-adam-qKYQ1KwT.png)**Adam Elmore**ex-Hero, AWS  
\
I can't recommend @OpenCode Zen enough. Seriously, it’s really good.](https://x.com/adamdotdev/status/1973732040718860563)

[![](https://opencode.ai/_build/assets/avatar-david-ncaBf0K4.png)**David Hill**ex-Head of Design, Laravel  
\
With @OpenCode Zen I know all the models are tested and perfect for coding agents.](https://x.com/iamdavidhill/status/1973530568773214622)

[![](https://opencode.ai/_build/assets/avatar-frank-WiTSMakV.png)**Frank Wang**ex-Intern, Nvidia (4 times)  
\
I wish I was still at Nvidia.](https://x.com/fanjiewang/status/1973530092736487756)
