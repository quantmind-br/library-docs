---
title: Setting default conditions | Moodle Developer Resources
url: https://moodledev.io/docs/5.2/apis/core/reportbuilder/filtering
source: sitemap
fetched_at: 2026-02-17T15:43:43.565203-03:00
rendered_js: false
word_count: 924
summary: This document explains how to define default condition values for report builder datasources using the get_default_condition_values method. It provides detailed instructions on array key naming conventions and required data structures for various filter types such as text, date, and numbers.
tags:
    - moodle
    - report-builder
    - datasource
...
## Text filters[​](#text-filters "Direct link to Text filters")

### Operators with no additional data[​](#operators-with-no-additional-data "Direct link to Operators with no additional data")

- `ANY_VALUE`
- `IS_EMPTY`
- `IS_NOT_EMPTY`

## Filtering types with a single value[​](#filtering-types-with-a-single-value "Direct link to Filtering types with a single value")
...
Examples of array key and value pairs for single value text filters
...
## Number filter[​](#number-filter "Direct link to Number filter")

### Operators with no additional data[​](#operators-with-no-additional-data-1 "Direct link to Operators with no additional data")

- `ANY_VALUE`
- `IS_NOT_EMPTY`
- `IS_EMPTY`

### Operators with a single value[​](#operators-with-a-single-value "Direct link to Operators with a single value")
...
Examples of array key and value pairs for single value number filters
...
### Operators with complex data[​](#operators-with-complex-data "Direct link to Operators with complex data")
...
Examples of array key and value pairs for range values text filters
...
## Date filter[​](#date-filter "Direct link to Date filter")
...
### Operators with no additional data[​](#operators-with-no-additional-data-2 "Direct link to Operators with no additional data")
...
### Operators with one value[​](#operators-with-one-value "Direct link to Operators with one value")

The `unit` should be sent defining the amount of time that should be considered.

- `DATE_CURRENT`

Examples of array key and value pairs for single value date filters
...
### Operators with two values[​](#operators-with-two-values "Direct link to Operators with two values")
...
Examples of array key and value pairs for two value date filters
...
### Operators with complex values[​](#operators-with-complex-values "Direct link to Operators with complex values")

#### DATE\_RANGE[​](#date_range "Direct link to DATE_RANGE")
...
Examples of array key and value pairs for the range date filters
...
## Select filter[​](#select-filter "Direct link to Select filter")

### Operators with no additional data[​](#operators-with-no-additional-data-3 "Direct link to Operators with no additional data")

- `ANY_VALUE`

### Operators with one value[​](#operators-with-one-value-1 "Direct link to Operators with one value")
...
Examples of array key and value pairs for single value select filters
...
## Boolean select filter[​](#boolean-select-filter "Direct link to Boolean select filter")

### Operators with no additional data[​](#operators-with-no-additional-data-4 "Direct link to Operators with no additional data")

- `ANY_VALUE`
- `CHECKED`
- `NOT_CHECKED`

## Duration filter[​](#duration-filter "Direct link to Duration filter")
...
### Operators with no additional data[​](#operators-with-no-additional-data-5 "Direct link to Operators with no additional data")

- `DURATION_ANY`

### Operators with two values[​](#operators-with-two-values-1 "Direct link to Operators with two values")
...
Examples of array key and value pairs for two value duration filters
...
## Autocomplete filter[​](#autocomplete-filter "Direct link to Autocomplete filter")
...
Examples of array key and value pairs for autocomplete filters
...
## Category filter[​](#category-filter "Direct link to Category filter")

### Operators with complex values[​](#operators-with-complex-values-1 "Direct link to Operators with complex values")
...
Examples of array key and value pairs for category filters
...
## Course\_select filter[​](#course_select-filter "Direct link to Course_select filter")

This filter type does not use `operator`, it requires that `values` contains an array of database ids for courses.

Examples of array key and value pairs for course filters
...
## Cohort filter[​](#cohort-filter "Direct link to Cohort filter")

This filter type does not use `operator`, it requires that `values` contains an array of database ids for cohorts.

Examples of array key and value pairs for cohort filters
...
## Filesize filter[​](#filesize-filter "Direct link to Filesize filter")
...
### Operators with no additional data[​](#operators-with-no-additional-data-6 "Direct link to Operators with no additional data")

- `ANY_VALUE`

### Operators with two values[​](#operators-with-two-values-2 "Direct link to Operators with two values")
...
Examples of array key and value pairs for two value file size filters
...
### Operators with no additional data[​](#operators-with-no-additional-data-7 "Direct link to Operators with no additional data")

- `ANY_VALUE`
- `NOT_EMPTY`
- `EMPTY`

### Operators with one value[​](#operators-with-one-value-2 "Direct link to Operators with one value")
...
Examples of array key and value pairs for single value tag filters
...
## User filter[​](#user-filter "Direct link to User filter")

### Operators with no additional data[​](#operators-with-no-additional-data-8 "Direct link to Operators with no additional data")

- `USER_ANY`
- `USER_CURRENT`

### Operators with one value[​](#operators-with-one-value-3 "Direct link to Operators with one value")

An array of user database ids should be sent in `value` to:

- `USER_SELECT`

Examples of array key and value pairs for single value user filters
