...
url: https://moodledev.io/docs/4.4/apis/core/clock
source: sitemap
fetched_at: 2026-02-17T15:02:05.382254-03:00
rendered_js: false
word_count: 451
summary: This document explains how to implement and use the PSR-20 compatible Clock interface in Moodle to fetch current time via Dependency Injection, facilitating easier unit testing and time mocking.
tags:
    - moodle-development
    - psr-20
    - clock-interface
