---
title: SCSS deprecation | Moodle Developer Resources
url: https://moodledev.io/general/development/policies/deprecation/scss-deprecation
source: sitemap
fetched_at: 2026-02-17T15:59:15.277891-03:00
rendered_js: false
word_count: 490
summary: This document outlines the process for deprecating SCSS styles and classes in Moodle 4.4+, explaining how to use the deprecated.scss file and verify usage via Behat tests.
tags:
    - moodle-development
    - scss
    - css-deprecation
...
## How to deprecate SCSS code[​](#how-to-deprecate-scss-code "Direct link to How to deprecate SCSS code")
...
## Check deprecated styles in Behat tests[​](#check-deprecated-styles-in-behat-tests "Direct link to Check deprecated styles in Behat tests")
