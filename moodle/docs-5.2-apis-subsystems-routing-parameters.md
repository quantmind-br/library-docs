...
url: https://moodledev.io/docs/5.2/apis/subsystems/routing/parameters
source: sitemap
fetched_at: 2026-02-17T15:46:24.192089-03:00
rendered_js: false
word_count: 1347
summary: This document explains how to define, validate, and retrieve path, query, and header parameters within the routing subsystem using PHP attributes.
tags:
    - routing
    - request-parameters
    - path-parameters
