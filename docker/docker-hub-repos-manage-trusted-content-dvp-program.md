...
source: llms
fetched_at: 2026-01-24T14:22:13.249131375-03:00
rendered_js: false
word_count: 865
summary: This document outlines the features and benefits of the Docker Verified Publisher Program, including security scanning, usage analytics, and branding options for commercial software vendors. It also provides instructions for managing repository logos and explains how the program removes pull rate limits for users.
tags:
    - docker-hub
    - verified-publisher
...
![Docker-Sponsored Open Source badge](https://docs.docker.com/docker-hub/images/verified-publisher-badge.png)
...
There is both a [web interface](https://docs.docker.com/docker-hub/repos/manage/trusted-content/insights-analytics/) and an [API](https://docs.docker.com/reference/api/dvp/latest/) for accessing the analytics data.
...
3. Select the upload logo button, represented by a camera icon ( ![camera icon](https://docs.docker.com/docker-hub/images/upload_logo_sm.png) ) overlaying the current repository logo.
