...
url: https://moodledev.io/docs/5.0/apis/plugintypes/quizaccess
source: sitemap
fetched_at: 2026-02-17T15:26:37.806622-03:00
rendered_js: false
word_count: 1
summary: This document defines the implementation requirements for the rule_overridable interface within a Moodle quiz access rule plugin to support user and group overrides.
tags:
    - moodle
    - quiz-access-rule
    - php-development
