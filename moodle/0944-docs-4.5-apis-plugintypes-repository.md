...
url: https://moodledev.io/docs/4.5/apis/plugintypes/repository
source: sitemap
fetched_at: 2026-02-17T15:12:42.498257-03:00
rendered_js: false
word_count: 4033
summary: This document outlines the requirements and file structure for developing Moodle repository plugins, including mandatory files like version.php and lib.php.
tags:
    - moodle-development
    - repository-plugin
    - plugin-structure
...
Some of the important files for the repository plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.5/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
