...
source: llms
fetched_at: 2026-01-26T09:52:23.16300307-03:00
rendered_js: false
word_count: 191
summary: This document explains how to configure and use the SOUL Evil hook to dynamically swap agent identity content in memory based on random chance or scheduled purge windows.
tags:
    - clawdbot
    - hooks
    - soul-evil
