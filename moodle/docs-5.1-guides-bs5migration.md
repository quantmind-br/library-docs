...
url: https://moodledev.io/docs/5.1/guides/bs5migration
source: sitemap
fetched_at: 2026-02-17T15:37:36.721003-03:00
rendered_js: false
word_count: 1726
summary: This document outlines the phased migration process from Bootstrap 4 to Bootstrap 5, detailing specific code refactors, bridge implementations, and library upgrades required for compatibility.
tags:
    - bootstrap-5
    - bootstrap-migration
