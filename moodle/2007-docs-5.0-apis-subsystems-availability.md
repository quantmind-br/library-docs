...
url: https://moodledev.io/docs/5.0/apis/subsystems/availability
source: sitemap
fetched_at: 2026-02-17T15:27:03.791902-03:00
rendered_js: false
word_count: 869
summary: This document explains how to use the Moodle Availability API to manage and check access restrictions for course activities and sections. It covers checking user visibility, filtering user lists based on availability, and programmatically configuring restriction conditions.
tags:
    - moodle-development
    - availability-api
    - access-control
...
- Writing [Availability condition](https://moodledev.io/docs/5.0/apis/plugintypes/availability) plugins