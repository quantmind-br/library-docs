...
url: https://moodledev.io/docs/4.5/apis/subsystems/output/inplace
source: sitemap
fetched_at: 2026-02-17T15:14:45.091883-03:00
rendered_js: false
word_count: 535
summary: This document explains how to implement the Moodle inplace_editable mini-API to enable inline editing of values within custom plugins.
tags:
    - moodle-development
    - inplace-editable
    - plugin-development
