...
url: https://moodledev.io/docs/5.2/apis/core/user
source: sitemap
fetched_at: 2026-02-17T15:43:47.110602-03:00
rendered_js: false
word_count: 1070
summary: This document provides a technical overview of Moodle APIs for managing user data, including methods for displaying profile fields, validating and sanitizing user properties, and implementing user selection interfaces.
tags:
    - moodle-development
    - user-api
    - data-validation
...
- [Access API](https://moodledev.io/docs/5.2/apis/subsystems/access)
