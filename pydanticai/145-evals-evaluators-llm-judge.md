---
title: LLM Judge - Pydantic AI
url: https://ai.pydantic.dev/evals/evaluators/llm-judge/
source: sitemap
fetched_at: 2026-01-22T22:25:23.231105193-03:00
rendered_js: false
word_count: 492
summary: This document provides a detailed overview of the LLMJudge evaluator in pydantic-evals, explaining how to use LLMs to assess subjective output qualities through rubrics, scoring, and context integration.
tags:
    - pydantic-evals
    - llm-judge
    - ai-evaluation
...
The [`LLMJudge`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge "LLMJudge            dataclass   ") evaluator uses an LLM to assess subjective qualities of outputs based on a rubric.
...
- Format validation (use [`IsInstance`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.IsInstance "IsInstance            dataclass   ") instead)
- Exact matching (use [`EqualsExpected`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EqualsExpected "EqualsExpected            dataclass   "))
- Performance checks (use [`MaxDuration`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.MaxDuration "MaxDuration            dataclass   "))
...
[Learn about Gateway](https://ai.pydantic.dev/gateway) recipe\_evaluation.py
