...
url: https://moodledev.io/docs/5.1/tags/core-external
source: sitemap
fetched_at: 2026-02-17T15:29:53.536213-03:00
rendered_js: false
word_count: 149
summary: This document provides an overview of Moodle's external services framework, detailing how to declare, secure, and test web services for integration with external systems.
tags:
    - moodle
    - external-services
    - web-services
