...
url: https://github.com/openagen/zeroclaw/blob/master/docs/assets/architecture-diagrams.md
source: git
fetched_at: 2026-05-02T14:50:29.673158603-03:00
rendered_js: false
word_count: 179
summary: This document outlines the system architecture, message processing flow, agent orchestration logic, and daemon supervision model for the ZeroClaw platform.
tags:
    - system-architecture
    - zeroclaw
    - agent-orchestration
...
> Visual representations of ZeroClaw's architecture, execution modes, and data flows.
...
flowchart TB
    ...
    SpawnScheduler -->|Yes| SppawnSchedulerWorker[Spawn Cron Scheduler]
    ...
    SppawnSchedulerWorker --> SchedulerLoop{Scheduler Loop}
    ...
    class SpawnGateway,SpawnChannelSup,SpawnHeartbeatWorker,SpSawnSchedulerWorker,SpawnState supervisor
...
flowchart TB
    ...
    Complete --> Providers[default_provider,
    api_key, api_url]
    Complete --> Model[default_model,
    default_temperature]
...
#system-architecture #zeroclaw #agent-orchestration #daemon-supervision
