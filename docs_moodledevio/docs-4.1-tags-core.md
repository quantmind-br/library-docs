...
source: sitemap
fetched_at: 2026-02-17T14:51:38.252303-03:00
rendered_js: false
word_count: 455
summary: This document provides a technical overview of Moodle 4.1 development APIs, focusing on the Form API for UI elements and the Data Manipulation Layer (DML) for database operations.
tags:
    - moodle-development
    - forms-api
    - dml-api
