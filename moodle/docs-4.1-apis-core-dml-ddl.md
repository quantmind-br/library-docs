...
url: https://moodledev.io/docs/4.1/apis/core/dml/ddl
source: sitemap
fetched_at: 2026-02-17T14:54:45.863993-03:00
rendered_js: false
word_count: 453
summary: This document provides a reference for Moodle's DDL API functions, which are used to manage database structures like tables, fields, and indexes specifically during installation and upgrade processes.
tags:
    - moodle-development
    - ddl-api
    - database-schema
...
- [DML functions](https://moodledev.io/docs/4.1/apis/core/dml): Where all the functions used to handle DB data ([DML](https://docs.moodle.org/wikipedia/Data_Manipulation_Language)) are defined.