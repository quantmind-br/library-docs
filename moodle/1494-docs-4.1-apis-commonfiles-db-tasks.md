...
url: https://moodledev.io/docs/4.1/apis/commonfiles/db-tasks.php
source: sitemap
fetched_at: 2026-02-17T14:54:29.11959-03:00
rendered_js: false
word_count: 318
summary: This document explains how to define and configure scheduled tasks for a plugin by implementing a specific PHP class and defining properties in a configuration file. It details the available settings for scheduling, execution blocking, and task status.
tags:
    - scheduled-tasks
    - plugin-development
    - php
