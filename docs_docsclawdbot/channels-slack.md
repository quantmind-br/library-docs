---
title: "null"
url: https://docs.clawd.bot/channels/slack.md
source: llms
fetched_at: 2026-01-26T09:50:24.713173118-03:00
rendered_js: false
word_count: 1680
summary: This document provides instructions for configuring the Slack integration for Clawdbot, covering both Socket Mode and HTTP mode setups. It explains how to obtain necessary tokens, configure OAuth scopes, and define bot behavior via the application manifest.
tags:
    - slack-integration
    - socket-mode
    - http-mode
