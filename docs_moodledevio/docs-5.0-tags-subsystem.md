...
url: https://moodledev.io/docs/5.0/tags/subsystem
source: sitemap
fetched_at: 2026-02-17T15:22:29.729222-03:00
rendered_js: false
word_count: 328
summary: This document provides an overview and directory of various Moodle subsystem APIs, covering core functionalities such as task scheduling, data backup and restore, caching, and group management.
tags:
    - moodle-development
    - api-subsystems
    - task-management
