...
url: https://docs.sglang.io/docs/supported-models/support_new_models
source: sitemap
fetched_at: 2026-05-11T05:51:19.248287891-03:00
rendered_js: false
word_count: 1757
summary: This guide provides instructions for developers to integrate new language models and multimodal large language models into the SGLang framework, including requirements for testing, benchmarking, porting from vLLM, and dynamic registration.
tags:
    - sglang
    - llm-integration
    - multimodal-models
...
Below is an introductory, step-by-step walkthrough on how to implement a new model end-to-end in SGLang and then run it via the [Offline Engine](https://docs.sglang.io/docs/basic_usage/offline_engine_api).
...
Add to table of supported models in [generative\_models.md](https://docs.sglang.io/docs/supported-models/generative_models) or [multimodal\_language\_models.md](https://docs.sglang.io/docs/supported-models/multimodal_language_models)
