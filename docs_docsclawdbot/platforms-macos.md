...
source: llms
fetched_at: 2026-01-26T09:53:12.129172744-03:00
rendered_js: false
word_count: 775
summary: This document provides an overview of the Clawdbot macOS Companion app, detailing its functions in managing the local Gateway, handling system permissions, and exposing macOS-specific tools to agents.
tags:
    - macos-app
    - clawdbot-gateway
    - system-permissions
