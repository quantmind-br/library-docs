...
url: https://moodledev.io/docs/5.1/apis/plugintypes/antivirus
source: sitemap
fetched_at: 2026-02-17T15:34:42.549548-03:00
rendered_js: false
word_count: 670
summary: This document provides a technical guide on developing antivirus plugins for Moodle to enable automatic scanning of uploaded files. It outlines the required directory structure and mandatory files such as versioning, settings, and the core scanner implementation class.
tags:
    - moodle-development
    - antivirus-plugin
    - plugin-architecture
...
Some of the important files for the antivirus plugintype are described below. See the [common plugin files](https://moodledev.io/docs/5.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
