...
url: https://qwenlm.github.io/qwen-code-docs/en/users/ide-integration/ide-integration
source: github_pages
fetched_at: 2026-04-09T09:05:52.010644817-03:00
rendered_js: true
word_count: 1122
summary: This document details how to integrate and use Qwen Code with an Integrated Development Environment (IDE), primarily focusing on Visual Studio Code, to enable context-aware features like viewing changes via native diffing. It provides instructions for setup, usage commands, and troubleshooting common connection errors.
tags:
    - ide-integration
    - vscode-setup
    - code-assistance
...
Currently, the only supported IDE is [Visual Studio Code](https://code.visualstudio.com/)  and other editors that support VS Code extensions. To build support for other editors, see the [IDE Companion Extension Spec](https://qwenlm.github.io/qwen-code-docs/en/users/ide-integration/ide-companion-spec/).
...
### 1. Automatic Nudge (Recommended)[](#1-automatic-nudge-recommended)
...
### 2. Manual Installation from CLI[](#2-manual-installation-from-cli)
...
### 3. Manual Installation from a Marketplace[](#3-manual-installation-from-a-marketplace)
...
> NOTE: The “Qwen Code Companion” extension may appear towards the bottom of search results. If you don’t see it immediately, try scrolling down or sorting by “Newly Published”.
> 
...
### Working with Diffs[](#working-with-diffs)
