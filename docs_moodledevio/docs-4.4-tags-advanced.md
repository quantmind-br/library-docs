...
url: https://moodledev.io/docs/4.4/tags/advanced
source: sitemap
fetched_at: 2026-02-17T14:57:39.611978-03:00
rendered_js: false
word_count: 191
summary: This document outlines advanced features of the Moodle Form API, including techniques for managing element visibility, controlling groups of checkboxes, handling non-submitting form actions, and creating repeatable element groups.
tags:
    - moodle-development
    - form-api
    - ui-elements
