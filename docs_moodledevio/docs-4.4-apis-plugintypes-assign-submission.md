...
url: https://moodledev.io/docs/4.4/apis/plugintypes/assign/submission
source: sitemap
fetched_at: 2026-02-17T15:02:48.596693-03:00
rendered_js: false
word_count: 1625
summary: This document provides a technical guide on developing Moodle assignment submission plugins, detailing file structure requirements, database naming conventions, and core implementation methods.
tags:
    - moodle-development
    - plugin-architecture
    - submission-plugins
