...
source: crawler
fetched_at: 2026-02-27T23:38:40.869647-03:00
rendered_js: true
word_count: 2
summary: Provides a sample JSON response structure for retrieving a user's saved podcast episodes and shows via the Spotify API, including pagination details and nested object schemas.
tags:
    - spotify-api
    - json-response
    - podcast-episodes
