...
url: https://docs.bmad-method.org/fr/reference/modules/
source: sitemap
fetched_at: 2026-04-08T11:30:57.232442927-03:00
rendered_js: false
word_count: 530
summary: This document outlines the various specialized modules available for extending a framework, detailing tools for AI agent creation, structured workflow design, creative ideation, game development, and enterprise testing strategies.
tags:
    - module-extension
    - ai-agent-building
    - workflow-design
...
[Section intitulée « Creative Intelligence Suite »](#creative-intelligence-suite)
...
- Cadres d’idéation incluant SCAMPER[1](#user-content-fn-1), Brainstorming inversé et reformulation de problèmes
...
- Workflow de génération de Document de Design de Jeu (GDD[2](#user-content-fn-3))
...
- Évaluation NFR[3](#user-content-fn-2), configuration CI et scaffolding de framework
- Priorisation P0-P3 avec Playwright Utils et intégrations MCP optionnelles

## Modules Communautaires

[Section intitulée « Modules Communautaires »](#modules-communautaires)
...
1. SCAMPER : acronyme anglais pour une technique de créativité structurée (Substitute, Combine, Adapt, Modify, Put to another use, Eliminate, Reverse) qui permet d’explorer systématiquement les modifications possibles d’un produit ou d’une idée pour générer des innovations. [↩](#user-content-fnref-1)
2. GDD (Game Design Document) : document de conception de jeu qui décrit en détail les mécaniques, l’univers, les personnages, les niveaux et tous les aspects du jeu à développer. [↩](#user-content-fnref-3)
3. NFR (Non-Functional Requirement) : exigence décrivant les contraintes de qualité du système (performance, sécurité, fiabilité, ergonomie) plutôt que ses fonctionnalités. [↩](#user-content-fnref-2)