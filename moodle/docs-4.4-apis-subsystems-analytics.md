...
url: https://moodledev.io/docs/4.4/apis/subsystems/analytics
source: sitemap
fetched_at: 2026-02-17T15:03:50.853186-03:00
rendered_js: false
word_count: 5667
summary: This document explains the Moodle Analytics API, focusing on how prediction models are defined through indicators and targets to generate actionable insights. It outlines the core components, data flow, and machine learning concepts necessary for developing and training predictive systems in Moodle.
tags:
    - moodle-analytics
    - prediction-models
    - machine-learning
...
Documentation available in [Machine learning backends](https://moodledev.io/docs/4.4/apis/plugintypes/mlbackend).
...
[Machine learning backends](https://moodledev.io/docs/4.4/apis/plugintypes/mlbackend) is a new Moodle plugin type. They are stored in `lib/mlbackend`.
...
This section does not include Machine learning backend interfaces. See [Machine learning backends](https://moodledev.io/docs/4.4/apis/plugintypes/mlbackend#interfaces) for more information on these.
...
Analysis intervals are used to define when the analytics API will train the predictions processor and when it will generate predictions. As explained above in the [Analysis intervals](https://moodledev.io/docs/4.4/apis/subsystems/analytics#analysis-intervals) documentation, they define time ranges based on analysable elements start and end timestamps.
...
As specified in the [Target](https://moodledev.io/docs/4.4/apis/subsystems/analytics#target-core_analyticslocaltargetbase) section.
