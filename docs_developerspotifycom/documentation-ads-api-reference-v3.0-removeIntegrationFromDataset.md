...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/removeIntegrationFromDataset
source: crawler
fetched_at: 2026-02-27T23:39:40.246698-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response representing an advertising pixel's configuration, including event tracking data and conversion API integration details.
tags:
    - api-response
    - tracking-pixel
    - conversion-api
