...
source: llms
fetched_at: 2026-04-16T22:29:30.364204197-03:00
rendered_js: false
word_count: 987
summary: This guide provides a quickstart for setting up and running an autonomous AI agent using the Anthropic Agent SDK in Python or TypeScript. It demonstrates how to configure the environment, define tasks through prompts, and manage tool-based file editing workflows.
tags:
    - agent-sdk
    - anthropic-claude
    - python
