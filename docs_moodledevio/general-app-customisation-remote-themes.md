---
title: Moodle App Remote Themes | Moodle Developer Resources
url: https://moodledev.io/general/app/customisation/remote-themes
source: sitemap
fetched_at: 2026-02-17T15:54:21.222158-03:00
rendered_js: false
word_count: 1590
summary: This document explains how to create and implement remote themes for the Moodle App by configuring CSS URLs and utilizing custom CSS variables. It provides guidance on development workflows, targeting specific platforms, and overriding default Ionic framework styles.
tags:
    - moodle-app
    - remote-themes
    - css-customization
...
## How do Remote themes work?[​](#how-do-remote-themes-work "Direct link to How do Remote themes work?")
...
## How can you create your own theme?[​](#how-can-you-create-your-own-theme "Direct link to How can you create your own theme?")
...
In order to create your own theme, we recommend that you use the app from [latest.apps.moodledemo.net](https://latest.apps.moodledemo.net) and check the styles using the browser inspector. You can use any Chromium-based browser, but you should launch it with some special arguments. You can read more about that in the [Using the Moodle App in a browser](https://moodledev.io/general/app/development/setup/app-in-browser) page. If you need to test a different version of the app, you can also use [main.apps.moodledemo.net](https://main.apps.moodledemo.net) for the latest development version or [the Docker images](https://moodledev.io/general/app/development/setup/docker-images) for anything more specific.
...
### Applying theme changes during development[​](#applying-theme-changes-during-development "Direct link to Applying theme changes during development")
...
### Knowing what to style[​](#knowing-what-to-style "Direct link to Knowing what to style")
...
### Working with colors[​](#working-with-colors "Direct link to Working with colors")
...
#### Basic shades[​](#basic-shades "Direct link to Basic shades")
...
#### Specific colors[​](#specific-colors "Direct link to Specific colors")
...
### Targeting different environments[​](#targeting-different-environments "Direct link to Targeting different environments")
...
#### Moodle App and Moodle site versions[​](#moodle-app-and-moodle-site-versions "Direct link to Moodle App and Moodle site versions")
...
#### Moodle site theme[​](#moodle-site-theme "Direct link to Moodle site theme")

Starting on Moodle App 4.4 you can restrict CSS rules to a specific site theme. So, when accessing to your site, the app will retrieve the name of the site theme and will add a class to HTML tag following the next pattern: `theme-site-MYTHEME` and you can use this selector to filter your rules.

#### Application theme[​](#application-theme "Direct link to Application theme")
...
#### Combining classes[​](#combining-classes "Direct link to Combining classes")
...
### Styling the shadow DOM[​](#styling-the-shadow-dom "Direct link to Styling the shadow DOM")
...
### Supporting older versions of the app[​](#supporting-older-versions-of-the-app "Direct link to Supporting older versions of the app")

If you need to support different versions of the app, or you're upgrading your theme from an older version, you should read the [Moodle App Remote themes upgrade guide](https://moodledev.io/general/app/upgrading/remote-themes-upgrade-guide).

## Common customisations[​](#common-customisations "Direct link to Common customisations")
...
### Showing course summary image on course page[​](#showing-course-summary-image-on-course-page "Direct link to Showing course summary image on course page")
...
## Updating your theme after release[​](#updating-your-theme-after-release "Direct link to Updating your theme after release")
...
## Difference between Remote themes and Branded Apps[​](#difference-between-remote-themes-and-branded-apps "Direct link to Difference between Remote themes and Branded Apps")
