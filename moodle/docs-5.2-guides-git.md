...
url: https://moodledev.io/docs/5.2/guides/git
source: sitemap
fetched_at: 2026-02-17T15:46:49.292514-03:00
rendered_js: false
word_count: 2920
summary: This document provides instructions for setting up and using Git within the Moodle development environment, covering installation, configuration, and the standard contribution workflow. It explains how to manage local and public repositories to synchronize with Moodle's weekly integration cycle.
tags:
    - moodle-development
    - git-setup
    - version-control
