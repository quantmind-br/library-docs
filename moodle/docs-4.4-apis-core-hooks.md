...
url: https://moodledev.io/docs/4.4/apis/core/hooks
source: sitemap
fetched_at: 2026-02-17T15:02:25.367001-03:00
rendered_js: false
word_count: 1558
summary: This document explains the Moodle Hooks API, a PSR-14 compliant system that replaces legacy plugin callbacks to allow for easier customization of core and plugin functionality.
tags:
    - moodle-development
    - psr-14
    - hooks-api
...
From Moodle 4.4 you should make use of the [Dependency Injection](https://moodledev.io/docs/4.4/apis/core/di) system, for example:
