...
url: https://moodledev.io/docs/5.1/guides/javascript/reactive
source: sitemap
fetched_at: 2026-02-17T15:37:51.542541-03:00
rendered_js: false
word_count: 5759
summary: This document explains the architecture and implementation of Moodle's internal reactive library for building responsive user interfaces through state management and reusable components. It covers core principles like mutations, watchers, and the BaseComponent class for framework-independent frontend development.
tags:
    - moodle-development
    - reactive-ui
    - state-management
