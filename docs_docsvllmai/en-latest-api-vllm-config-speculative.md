...
source: sitemap
fetched_at: 2026-05-07T21:17:13.989104895-03:00
rendered_js: false
word_count: 376
summary: This document defines the configuration parameters for speculative decoding, covering draft model settings, sampling strategies, and optimization techniques for inference acceleration.
tags:
...
"""Target mean acceptance length for synthetic rejection sampling, in
    ...
    @staticmethod
    def_acceptance_length_to_rates(length: float, n: int) -> list[float]:
"""Mean acceptance length to unconditional per-position rates, using
    ...
    @staticmethod
    def_resolve_synthetic_acceptance_rates(
        n: int,
...
"""
    ...
    @staticmethod
    defhf_config_override(hf_config: PretrainedConfig) -> PretrainedConfig:
        ...
        if (arch := hf_config.architectures[0]) in (
            ...
            fromvllm.model_executor.models.mimo_v2_mtpimport (
    ...
    def__post_init__(self):
        ...
        if self.method in ("ngram", "ngram_gpu"):
            ...
            fromvllm.transformers_utils.configs.extract_hidden_statesimport (
            ...
            if self.model is not None:
                ...
                if self.method in ("eagle", "eagle3", "dflash"):
                    fromvllm.transformers_utils.configs.eagleimport EAGLEConfig
                    fromvllm.transformers_utils.configs.speculatorsimport (
                        SpeculatorsConfig,
                    )
    ...
    def_validate_suffix_decoding(self):
    ...
    @staticmethod
    def_maybe_override_draft_max_model_len(
...
"""
    ...
    @staticmethod
    defcreate_draft_parallel_config(
        target_parallel_config: ParallelConfig,
...
"""Create a parallel config for use by the draft worker.
    ...
    @classmethod
    def_parse_attention_backend(cls, value: Any) -> Any:
    ...
    defverify_equal_vocab_size_if_draft_model(self):
        if (
            self.method == "draft_model"
    ...
    @property
    defmax_num_new_slots_for_drafting(self) -> int:
"""
    ...
    defuse_eagle(self) -> bool:
        return self.method in ("eagle", "eagle3", "mtp", "dflash")

    defuse_dflash(self) -> bool:
        return self.method == "dflash"

    defuses_draft_model(self) -> bool:
        return self.method == "draft_model"

    defuses_extract_hidden_states(self) -> bool:
        return self.method == "extract_hidden_states"

    defuse_ngram_gpu(self) -> bool:
