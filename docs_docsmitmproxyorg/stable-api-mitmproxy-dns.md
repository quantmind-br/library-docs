...
source: crawler
fetched_at: 2026-01-28T16:18:36.553308563-03:00
rendered_js: false
word_count: 46
summary: This document defines Python dataclasses for representing DNS Questions and Resource Records within the mitmproxy project, including methods for their serialization to and deserialization from JSON, and handling of various DNS record types like A, AAAA, CNAME, and HTTPS.
tags:
    - dns
    - resource-record
    - question
