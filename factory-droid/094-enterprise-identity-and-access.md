...
source: llms
fetched_at: 2026-02-05T21:42:35.565188684-03:00
rendered_js: false
word_count: 526
summary: This document explains the identity model and access management framework for Droid agents, detailing how roles, organizational contexts, and runtime environments determine permissions. It outlines the integration of identity providers and hierarchical settings to enforce security and audit compliance.
tags:
    - iam
    - identity-management
    - rbac
