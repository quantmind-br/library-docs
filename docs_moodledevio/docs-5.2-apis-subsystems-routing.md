...
url: https://moodledev.io/docs/5.2/apis/subsystems/routing
source: sitemap
fetched_at: 2026-02-17T15:46:19.838193-03:00
rendered_js: false
word_count: 287
summary: This document explains how to implement and configure the Moodle routing system using the Slim Framework and PHP attributes for creating REST API endpoints.
tags:
    - moodle-development
    - routing
    - slim-framework
...
When invoked, any parameter to the route method will be resolved using a combination of [Dependency Injection](https://moodledev.io/docs/5.2/apis/core/di) and resolution of path, query, and header parameters.
