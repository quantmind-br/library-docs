---
title: 48 docs tagged with "API" | Moodle Developer Resources
url: https://moodledev.io/docs/5.1/tags/api
source: sitemap
fetched_at: 2026-02-17T15:29:14.694548-03:00
rendered_js: false
word_count: 1371
summary: This document serves as a comprehensive index of Moodle's core APIs and subsystems, providing developers with brief descriptions and links to specialized documentation for plugin development and system integration.
tags:
    - moodle-development
    - core-apis
    - plugin-architecture
...
## [Activity completion API](https://moodledev.io/docs/5.1/apis/core/activitycompletion)
...
## [Activity modules](https://moodledev.io/docs/5.1/apis/plugintypes/mod)
...
## [Adhoc tasks](https://moodledev.io/docs/5.1/apis/subsystems/task/adhoc)
...
## [Analytics API](https://moodledev.io/docs/5.1/apis/subsystems/analytics)

The Analytics API allows managers to use predictions to detect trends and predict student behaviour

## [Backup API](https://moodledev.io/docs/5.1/apis/subsystems/backup)
...
## [Cache API](https://moodledev.io/docs/5.1/apis/subsystems/muc)
...
## [Check API](https://moodledev.io/docs/5.1/apis/subsystems/check)
...
## [Common files](https://moodledev.io/docs/5.1/apis/commonfiles)
...
## [Core APIs](https://moodledev.io/docs/5.1/apis/core)
...
## [DML drivers](https://moodledev.io/docs/5.1/apis/core/dml/drivers)

A number of native drivers are included with Moodle, including those with support for:

## [DML exceptions](https://moodledev.io/docs/5.1/apis/core/dml/exceptions)

The DML API uses a selection of exceptions to indicate errors.

## [External Services](https://moodledev.io/docs/5.1/apis/subsystems/external)

Moodle has a full-featured Web Service framework, allowing you to use and create web services for use in external systems.

## [Favourites API](https://moodledev.io/docs/5.1/apis/subsystems/favourites)
...
## [Hooks API](https://moodledev.io/docs/5.1/apis/core/hooks)

This page describes the Hooks API which is a replacement for some of the lib.php based one-to-many

## [HTML Writer API](https://moodledev.io/docs/5.1/apis/core/htmlwriter)
...
## [Machine learning backends](https://moodledev.io/docs/5.1/apis/plugintypes/mlbackend)
...
## [Message API](https://moodledev.io/docs/5.1/apis/core/message)

What is this document?

## [Module visibility and display](https://moodledev.io/docs/5.1/apis/plugintypes/mod/visibility)

Summary

## [Navigation API](https://moodledev.io/docs/5.1/apis/core/navigation)

The Navigation API allows for the manipulation of the navigation system used in Moodle.

## [Output API](https://moodledev.io/docs/5.1/apis/subsystems/output)
...
## [Plagiarism API](https://moodledev.io/docs/5.1/apis/subsystems/plagiarism)
...
## [Preference API](https://moodledev.io/docs/5.1/apis/core/preference)
...
## [Privacy API](https://moodledev.io/docs/5.1/apis/subsystems/privacy)
...
## [Questions API](https://moodledev.io/docs/5.1/apis/subsystems/question)
...
## [Restore API](https://moodledev.io/docs/5.1/apis/subsystems/backup/restore)
...
## [Scheduled tasks](https://moodledev.io/docs/5.1/apis/subsystems/task/scheduled)
...
## [Tag API](https://moodledev.io/docs/5.1/apis/subsystems/tag)
...
## [tag.php](https://moodledev.io/docs/5.1/apis/commonfiles/tag.php)

A description of the library tag.php file, describing what plugins have tags where their callbacks are located.

## [Task API](https://moodledev.io/docs/5.1/apis/subsystems/task)
...
## [Time API](https://moodledev.io/docs/5.1/apis/subsystems/time)

Internally Moodle always stores all times in unixtime format, which is a format independent of timezones.

## [Transactions](https://moodledev.io/docs/5.1/apis/core/dml/delegated-transactions)
...
## [xAPI (Experience API)](https://moodledev.io/docs/5.1/apis/subsystems/xapi)
