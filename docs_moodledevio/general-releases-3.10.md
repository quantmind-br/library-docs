---
title: Moodle 3.10 | Moodle Developer Resources
url: https://moodledev.io/general/releases/3.10
source: sitemap
fetched_at: 2026-02-17T16:09:46.743754-03:00
rendered_js: false
word_count: 1379
summary: This document outlines the release notes for Moodle 3.10, providing technical specifications for server and client requirements, database compatibility, and major feature updates. It serves as a technical reference for system administrators and developers managing Moodle installations and upgrades.
tags:
    - moodle-3-10
    - release-notes
    - system-requirements
...
Here is [the full list of fixed issues in 3.10](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%223.10%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
DatabaseMinimum versionRecommended[PostgreSQL](http://www.postgresql.org/)9.6 (increased since Moodle 3.9)Latest[MySQL](http://www.mysql.com/)5.7 (increased since Moodle 3.9)Latest[MariaDB](https://mariadb.org/)10.2.29 (increased since Moodle 3.8)Latest[Microsoft SQL Server](http://www.microsoft.com/en-us/server-cloud/products/sql-server/)2012Latest[Oracle Database](http://www.oracle.com/us/products/database/overview/index.html)11.2Latest
...
### Download course content[​](#download-course-content "Direct link to Download course content")
...
### Payment subsystem[​](#payment-subsystem "Direct link to Payment subsystem")
...
- [MDL-68562](https://moodle.atlassian.net/browse/MDL-68562) - Qtype\_essay: Adding file-size limit to the attachment files
...
### External tool (IMS-LTI)[​](#external-tool-ims-lti "Direct link to External tool (IMS-LTI)")
...
- [MDL-48391](https://moodle.atlassian.net/browse/MDL-48391) - tool\_uploadcourse should check if enrolment method can be disabled/deleted
- [MDL-69739](https://moodle.atlassian.net/browse/MDL-69739) - User tours: Add tour-level CSS selector
- [MDL-69464](https://moodle.atlassian.net/browse/MDL-69464) - Option to allow HTML in the page headings (skip applying format\_string)
...
- [MDL-69583](https://moodle.atlassian.net/browse/MDL-69583) - Add import to tool\_customlang
- [MDL-69582](https://moodle.atlassian.net/browse/MDL-69582) - Add export to tool\_customlang
...
- [MDL-69718](https://moodle.atlassian.net/browse/MDL-69718) - Add support for terabytes and petabytes in the display\_size function
...
- [MDL-60583](https://moodle.atlassian.net/browse/MDL-60583) - external\_tokens table will benefit from index on token field
- [MDL-68665](https://moodle.atlassian.net/browse/MDL-68665) - Improve cacheability of assignfeedback\_editpdf/stamps
- [MDL-64818](https://moodle.atlassian.net/browse/MDL-64818) - Improve efficiency of blocks\_for\_region()
- [MDL-69746](https://moodle.atlassian.net/browse/MDL-69746) - tool\_replace: additional skip tables
...
- [MDL-68564](https://moodle.atlassian.net/browse/MDL-68564) - Update before\_footer hook to allow for output to be added to the page
...
- [MDL-69486](https://moodle.atlassian.net/browse/MDL-69486) - Add user idnumber and gradeitem idnumber to gradereport\_user\_get\_grade\_items webservice
- [MDL-63805](https://moodle.atlassian.net/browse/MDL-63805) - New Web Service mod\_glossary\_update\_entry
- [MDL-69776](https://moodle.atlassian.net/browse/MDL-69776) - New Web Service core\_files\_delete\_draft\_files
- [MDL-69283](https://moodle.atlassian.net/browse/MDL-69283) - Allow specifying a timezone when calling WebServices
- [MDL-63806](https://moodle.atlassian.net/browse/MDL-63806) - New Web Service mod\_glossary\_delete\_entry
- [MDL-68845](https://moodle.atlassian.net/browse/MDL-68845) - Create new Web Service for retrieving the user calendar via iCal
- [MDL-69577](https://moodle.atlassian.net/browse/MDL-69577) - Add courseId and forumId info to mod\_forum\_get\_discussion\_posts web service

### Deprecations[​](#deprecations "Direct link to Deprecations")

- [MDL-67594](https://moodle.atlassian.net/browse/MDL-67594) - Deprecate supports\_recursion() & extend\_lock() in the Lock API
...
- [MDL-63254](https://moodle.atlassian.net/browse/MDL-63254) - Final deprecation of the events message\_contact\_blocked and message\_contact\_unblocked
...
- [MDL-55192](https://moodle.atlassian.net/browse/MDL-55192) - Final deprecation of add\_to\_log()
- [MDL-63167](https://moodle.atlassian.net/browse/MDL-63167) - Final deprecation of the gradingform\_provider interface
...
- [Notes de mise à jour de Moodle 3.10](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_3.10)
