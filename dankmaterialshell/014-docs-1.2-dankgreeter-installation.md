...
source: sitemap
fetched_at: 2026-02-22T18:42:25.670806-03:00
rendered_js: false
word_count: 418
summary: This document provides detailed installation and configuration instructions for the dms-greeter on various Linux distributions using both automated and manual methods.
tags:
    - linux
    - dms-greeter
    - greetd
...
**NixOS users:** The `dms greeter enable` and `dms greeter sync` commands are not available on NixOS. Please follow the manual steps below or see the [NixOS installation guides](https://danklinux.com/docs/1.2/dankgreeter/nixos).
