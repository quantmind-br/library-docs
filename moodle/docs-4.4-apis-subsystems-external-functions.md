...
url: https://moodledev.io/docs/4.4/apis/subsystems/external/functions
source: sitemap
fetched_at: 2026-02-17T15:04:09.720686-03:00
rendered_js: false
word_count: 0
summary: This document defines a Moodle external API class for programmatically creating groups within courses, specifying the required parameters, security checks, and return structures.
tags:
    - moodle
    - external-api
    - php
