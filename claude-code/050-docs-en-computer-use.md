...
source: llms
fetched_at: 2026-04-16T22:31:37.492804325-03:00
rendered_js: false
word_count: 1573
summary: This document explains how to enable and use the computer-use feature within the Claude Code CLI to automate GUI tasks on macOS. It covers setup procedures, permission management, and how the system handles visual interactions and safety boundaries.
tags:
    - claude-code
    - macos-automation
    - mcp-server
