---
title: "null"
url: https://docs.clawd.bot/channels/imessage.md
source: llms
fetched_at: 2026-01-26T09:50:17.036304683-03:00
rendered_js: false
word_count: 1005
summary: This document provides setup and configuration instructions for integrating iMessage with Clawdbot via the imsg CLI, covering local, remote, and multi-account macOS environments.
tags:
    - imessage
    - imsg
    - macos-integration
