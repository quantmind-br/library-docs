...
url: https://moodledev.io/docs/5.0/apis/core/lock
source: sitemap
fetched_at: 2026-02-17T15:24:51.077485-03:00
rendered_js: false
word_count: 330
summary: This document explains the Moodle Locking API, which prevents concurrent process access to shared resources. It covers usage patterns, performance considerations, and the configuration of lock factories.
tags:
    - moodle-development
    - locking-api
    - concurrency-control
