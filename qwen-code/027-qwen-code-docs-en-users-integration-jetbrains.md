...
source: github_pages
fetched_at: 2026-04-09T09:03:51.51070519-03:00
rendered_js: true
word_count: 285
summary: This document explains how to integrate and set up Qwen Code, an AI coding assistant, into various JetBrains IDEs using the Agent Client Protocol (ACP). It provides detailed steps for both recommended installation via the ACP Registry and a manual configuration method.
tags:
    - jetbrains-ide
    - ai-assistant
    - qwen-code
...
#### Manual Install (for older version of JetBrains IDEs)[](#manual-install-for-older-version-of-jetbrains-ides)
...
[Zed IDE](https://qwenlm.github.io/qwen-code-docs/en/users/integration-zed/ "Zed IDE")[Github Actions](https://qwenlm.github.io/qwen-code-docs/en/users/integration-github-action/ "Github Actions")