...
> For complete code examples of each extension trait, see [[154-contributing-extension-examples|extension-examples]].
...
- See [[../hardware/hardware-peripherals-design|hardware-peripherals-design]] for protocol and firmware notes
...
- For `.github/workflows/**` changes, include Actions allowlist impact in PR notes and update [[156-contributing-actions-source-policy|actions-source-policy]] when sources change
...
- When runtime surfaces change, update related references in [[../reference/|reference]]
...
#developer-guide #zero-claw #architecture-patterns #software-extensibility #system-design #best-practices
