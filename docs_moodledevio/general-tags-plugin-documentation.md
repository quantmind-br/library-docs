---
title: 11 docs tagged with "Plugin documentation" | Moodle Developer Resources
url: https://moodledev.io/general/tags/plugin-documentation
source: sitemap
fetched_at: 2026-02-17T15:50:30.945787-03:00
rendered_js: false
word_count: 418
summary: This document outlines the processes, standards, and resources required for contributing, documenting, and maintaining plugins within the Moodle ecosystem.
tags:
    - moodle
    - plugin-contribution
    - code-standards
...
## [Plugin code prechecks](https://moodledev.io/general/community/plugincontribution/codeprechecks)
...
## [Plugin documentation](https://moodledev.io/general/community/plugincontribution/documentation)
...
## [Plugin QA prechecks](https://moodledev.io/general/community/plugincontribution/guardians/qaprechecks)
...
## [Plugin with third party libraries](https://moodledev.io/general/community/plugincontribution/thirdpartylibraries)

This page describes the correct way to include third party libraries with your plugin.

## [Plugins adoption programme](https://moodledev.io/general/community/plugincontribution/adoption)
...
## [Plugins directory](https://moodledev.io/general/community/plugincontribution/pluginsdirectory)
...
## [Plugins directory updates](https://moodledev.io/general/community/plugincontribution/pluginsdirectory/updates)

13 December 2023

## [Plugins guardians](https://moodledev.io/general/community/plugincontribution/guardians)
