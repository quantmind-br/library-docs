...
source: crawler
fetched_at: 2026-02-27T23:46:20.172786-03:00
rendered_js: true
word_count: 233
summary: This document outlines the deprecated Spotify Web API endpoint for retrieving a list of browse categories, including details on request parameters and the structure of the paged response.
tags:
    - spotify-web-api
    - browse-categories
    - api-reference
