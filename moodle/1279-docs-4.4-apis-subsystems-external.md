...
url: https://moodledev.io/docs/4.4/apis/subsystems/external
source: sitemap
fetched_at: 2026-02-17T15:04:03.498269-03:00
rendered_js: false
word_count: 252
summary: This document introduces the Moodle Web Service framework and External API, providing an overview of its internal uses and a directory of resources for developing, securing, and implementing web services.
tags:
    - moodle
    - web-services
    - external-api
...
In addition to the standard API endpoints, several additional API endpoints are available for the purpose of uploading, and downloading, files. For more information on these endpoints, see the [file handling](https://moodledev.io/docs/4.4/apis/subsystems/external/files) documentation.
...
- [Adding a web service to your plugin](https://moodledev.io/docs/4.4/apis/subsystems/external/writing-a-service)
...
- [Web services files handling](https://moodledev.io/docs/4.4/apis/subsystems/external/files)
