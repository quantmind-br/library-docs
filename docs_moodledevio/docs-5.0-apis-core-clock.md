...
url: https://moodledev.io/docs/5.0/apis/core/clock
source: sitemap
fetched_at: 2026-02-17T15:24:20.052609-03:00
rendered_js: false
word_count: 451
summary: This document explains how to implement and use the PSR-20 compatible Clock interface in Moodle via Dependency Injection to facilitate time-based unit testing.
tags:
    - moodle
    - psr-20
    - clock-interface
