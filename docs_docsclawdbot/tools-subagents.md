---
title: "null"
url: https://docs.clawd.bot/tools/subagents.md
source: llms
fetched_at: 2026-01-26T09:54:23.193261334-03:00
rendered_js: false
word_count: 722
summary: This document explains the functionality and configuration of sub-agents, which are background processes spawned by a main agent to parallelize tasks and handle long-running tools without blocking the primary session.
tags:
    - sub-agents
    - agent-orchestration
    - parallel-processing
