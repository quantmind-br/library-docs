...
source: crawler
fetched_at: 2026-01-28T14:58:26.788458449-03:00
rendered_js: false
word_count: 399
summary: This document introduces the mitmproxy command-line interface, teaching users how to navigate the flow list, inspect request details, and utilize keyboard shortcuts and commands.
tags:
    - mitmproxy
    - cli-navigation
    - keyboard-shortcuts
