---
title: step3p5_tool_parser - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/tool_parsers/step3p5_tool_parser/
source: sitemap
fetched_at: 2026-05-07T21:36:30.265153034-03:00
rendered_js: false
word_count: 112
summary: This document defines a Python class for parsing streaming XML-based tool call definitions by maintaining state across chunks and handling manual closure of unclosed XML tags.
tags:
    - xml-parsing
    - streaming-data
    - tool-calls
...
```
classStreamingXMLToolCallParser:
"""
...
"""Reset streaming parsing state"""
    ...
    defparse_single_streaming_chunks(self, xml_chunk: str) -> DeltaMessage:
"""
    ...
    def_escape_xml_special_chars(self, text: str) -> str:
"""
    ...
    def_process_complete_xml_elements(self) -> bool:
"""
    ...
    def_fix_incomplete_tag_in_chunk(self, chunk: str) -> str:
"""
    ...
    def_fix_missing_equals_in_function_tag(self, chunk: str) -> str:
"""
    ...
    def_validate_function_name(self, func_name: str) -> bool:
"""Check if function name exists in tool definitions"""
    ...
    def_validate_parameter_name(self, param_name: str) -> bool:
"""Check if parameter exists in current function's tool definition"""
    ...
    def_should_skip_element(self, element: str) -> bool:
"""
    ...
    def_find_next_complete_element(self, start_pos: int) -> tuple[str | None, int]:
"""
    ...
    def_merge_new_deltas_to_single_response(self, initial_count: int) -> DeltaMessage:
"""
    ...
    def_preprocess_xml_chunk(self, chunk: str) -> str:
"""
    ...
    def_emit_delta(self, delta: DeltaMessage):
"""Emit Delta response (streaming output)"""
        self.deltas.append(delta)

    def_auto_close_open_parameter_if_needed(self, incoming_tag: str | None = None):
"""Before starting to process new elements,
    ...
    def_start_element(self, name: str, attrs: dict[str, str]):
...
"""Set up XML parser event handlers"""
    ...
    defset_tools(self, tools: list[Tool] | None):
"""Set tool configuration information"""
        self.tools = tools

    def_extract_function_name(self, name: str, attrs: dict[str, str]) -> str | None:
"""Extract function name from various formats"""
    ...
    def_extract_parameter_name(self, name: str, attrs: dict[str, str]) -> str | None:
"""Extract parameter name from various formats"""
    ...
    def_get_param_type(self, param_name: str) -> str:
"""Get parameter type based on tool configuration, defaults to string
    ...
    defrepair_param_type(self, param_type: str) -> str:
"""Repair unknown parameter types by treating them as string
    ...
    def_convert_param_value(self, param_value: str, param_type: str) -> Any:
"""Convert value based on parameter type
    ...
    def_convert_for_json_streaming(self, converted_value: Any, param_type: str) -> str:
"""Convert converted_value based on
    ...
    def_reset_xml_parser_after_tool_call(self):
"""
