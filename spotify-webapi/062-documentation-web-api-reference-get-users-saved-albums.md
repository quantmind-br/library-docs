...
source: crawler
fetched_at: 2026-02-27T23:45:50.117208-03:00
rendered_js: true
word_count: 2
summary: This document provides a representative JSON response sample for a paginated list of items from the Spotify Web API. It illustrates the data structure for saved shows, albums, artists, and tracks, including pagination metadata.
tags:
    - spotify-api
    - json-response
    - pagination
