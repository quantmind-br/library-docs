...
url: https://moodledev.io/docs/5.1/apis/core/calendar
source: sitemap
fetched_at: 2026-02-17T15:33:58.577769-03:00
rendered_js: false
word_count: 1799
summary: This document explains how to use the Moodle Calendar API to programmatically manage calendar events, covering creation, modification, deletion, and the configuration of dashboard action events.
tags:
    - moodle-api
    - calendar-events
    - event-management
