...
url: https://moodledev.io/docs/4.4/apis/plugintypes/mod_data/fields
source: sitemap
fetched_at: 2026-02-17T15:03:18.361008-03:00
rendered_js: false
word_count: 390
summary: This guide explains how to create custom field types for the Moodle Database activity module by implementing specific sub-plugins. It covers mandatory file structures, the field class implementation, and the configuration forms required for new field behaviors.
tags:
    - moodle-development
    - database-activity
    - plugin-development
...
The [Database activity](https://docs.moodle.org/en/Database_module) included with Moodle includes support for several predefined [field types](https://moodledev.io/docs/4.4/apis/plugintypes/mod_data/fields), including text, date, and URL. It is also possible to create new field types. For example, you might like to create:
...
Some of the important files for the database field plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.4/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
