...
url: https://moodledev.io/docs/5.1/apis/plugintypes/fileconverter
source: sitemap
fetched_at: 2026-02-17T15:34:59.982905-03:00
rendered_js: false
word_count: 363
summary: This document provides a technical overview of creating file converter plugins in Moodle, detailing the required file structure and the implementation of the converter interface.
tags:
    - moodle-development
    - file-converter
    - plugin-development
...
File converters are an important tool to support other plugins with file conversion supported between a wide range of file formats. File converters are accessed using the [File conversion API](https://moodledev.io/docs/5.1/apis/subsystems/files/converter) and are typically consumed by other plugins rather than by the user directly.
...
Some of the important files for the fileconverter plugintype are described below. See the [common plugin files](https://moodledev.io/docs/5.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
...
- Using the [File Converter API](https://moodledev.io/docs/5.1/apis/subsystems/files/converter)