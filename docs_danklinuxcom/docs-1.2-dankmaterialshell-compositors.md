...
source: sitemap
fetched_at: 2026-02-22T18:42:53.269748-03:00
rendered_js: false
word_count: 837
summary: This document provides configuration instructions and optimized settings for integrating DankMaterialShell with Wayland compositors like niri and Hyprland. It details setup procedures for keybindings, layer rules, and environment variables to ensure proper desktop shell functionality.
tags:
    - wayland
    - dankmaterialshell
    - niri
...
For more about layer rules see [layer rules](https://danklinux.com/docs/1.2/dankmaterialshell/layers).
...
For the full list of available IPC commands see [IPC](https://danklinux.com/docs/1.2/dankmaterialshell/keybinds-ipc)
...
See the [Installation guide](https://danklinux.com/docs/1.2/dankmaterialshell/installation#hyprland) for creating the session target.
...
See the [Installation guide](https://danklinux.com/docs/1.2/dankmaterialshell/installation#mangowc) for creating the session target.
...
For the full list of available IPC commands see [IPC](https://danklinux.com/docs/1.2/dankmaterialshell/keybinds-ipc). Basic Sway keybinding examples are available in the [Example for Sway](#example-for-sway) section below.
...
For the full list of available IPC commands see [IPC](https://danklinux.com/docs/1.2/dankmaterialshell/keybinds-ipc). labwc keybinding configuration coming soon.
...
1. **Auto-start DMS:**
2. **Configure keybindings** using the IPC commands from the [Keybinds & IPC](https://danklinux.com/docs/1.2/dankmaterialshell/keybinds-ipc) guide
...
- Customize your shell appearance in [Themes](https://danklinux.com/docs/1.2/dankmaterialshell/application-themes)
- Explore all available IPC commands in [Keybinds & IPC](https://danklinux.com/docs/1.2/dankmaterialshell/keybinds-ipc)
- Add functionality with [Plugins](https://danklinux.com/docs/1.2/dankmaterialshell/plugins-overview)