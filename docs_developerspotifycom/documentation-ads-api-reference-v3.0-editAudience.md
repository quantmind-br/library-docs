...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/editAudience
source: crawler
fetched_at: 2026-02-27T23:39:53.385687-03:00
rendered_js: true
word_count: 326
summary: This document provides the technical specification for updating an existing audience's details, including the request parameters, response schema, and a sample PATCH request.
tags:
    - ads-api
    - audience-management
    - patch-request
