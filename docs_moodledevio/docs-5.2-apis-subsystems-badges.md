---
title: Badges API | Moodle Developer Resources
url: https://moodledev.io/docs/5.2/apis/subsystems/badges
source: sitemap
fetched_at: 2026-02-17T15:45:17.223041-03:00
rendered_js: false
word_count: 344
summary: This document explains the technical implementation and evolution of the Moodle Badges API, detailing its support for various Open Badges standards and the structure of badge data exports.
tags:
    - moodle-badges
    - open-badges
    - api-integration
    - json-schema
    - backpack-interoperability
    - badge-export
category: api
---
...
## Evolution of Open Badges[​](#evolution-of-open-badges "Direct link to Evolution of Open Badges")
...
While many providers support Open Badges 2.0, **Badgr offers a unique API implementation, inherited from Mozilla** (detailed at [https://api.badgr.io/swagger-ui/index.html](https://api.badgr.io/swagger-ui/index.html)). Moodle directly supports this specific API. This is important because the Open Badges 2.0 specification defines the badge data itself, but not the protocol for interchanging badges.

## Badges data (JSON)[​](#badges-data-json "Direct link to Badges data (JSON)")
