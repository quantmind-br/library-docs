...
source: crawler
fetched_at: 2026-02-27T23:47:03.497055-03:00
rendered_js: false
word_count: 140
summary: Provides reference documentation for the deprecated Spotify Web API endpoint used to remove the current user as a follower of specific artists or other Spotify users.
tags:
    - spotify-web-api
    - user-management
    - unfollow-artists
