---
title: Activity chooser | Moodle Developer Resources
url: https://moodledev.io/docs/4.4/apis/plugintypes/mod/activitymodule
source: sitemap
fetched_at: 2026-02-17T15:03:24.130767-03:00
rendered_js: false
word_count: 673
summary: This document outlines the design improvements and technical requirements for the Moodle activity chooser update, focusing on enhancing the course creation user experience and providing new API callbacks for plugin developers.
tags:
    - moodle-development
    - activity-chooser
    - course-creation
...
The following are changes that we are planning on making in this project. We have a demo that can be viewed and interacted with. [Invisio mockup of the activity chooser](https://projects.invisionapp.com/share/SVSREPYNBYG#/screens/388682478).
...
### Larger display area[​](#larger-display-area "Direct link to Larger display area")
...
### Activities and resources are now merged[​](#activities-and-resources-are-now-merged "Direct link to Activities and resources are now merged")
...
### Starred / Favourites tab[​](#starred--favourites-tab "Direct link to Starred / Favourites tab")
...
![The starred tab](https://moodledev.io/assets/images/activity-chooser-starred-1d76565fe45f8e91c5d2f6a4e4e79f51.png)

### Recommended tab[​](#recommended-tab "Direct link to Recommended tab")
...
![The recommended tab](https://moodledev.io/assets/images/activity-chooser-recommend-363b72e9870a2b4113dcfb5cfb78e96c.png)

### Smart search bar[​](#smart-search-bar "Direct link to Smart search bar")
...
### Other activity types[​](#other-activity-types "Direct link to Other activity types")

Other activity types such as LTI will be able to be added to the activity chooser for the user to select.

### Activity information hidden[​](#activity-information-hidden "Direct link to Activity information hidden")
...
![Additional information about an activity](https://moodledev.io/assets/images/activity-chooser-info-8922a8ffef98ce24c03c60ed822eb204.png)

## Third party plugin developers[​](#third-party-plugin-developers "Direct link to Third party plugin developers")
...
In order for activity starring and recommendations to work, each content\_item has an ID which is subject to some additional rules. Each ID:
