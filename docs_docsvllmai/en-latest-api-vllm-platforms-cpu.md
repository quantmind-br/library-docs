---
title: cpu - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/platforms/cpu/
source: sitemap
fetched_at: 2026-05-07T21:34:31.004194259-03:00
rendered_js: false
word_count: 0
summary: This document defines the CpuPlatform class, which provides CPU-specific configurations, environment settings, and hardware-specific handling for the vLLM framework.
tags:
    - cpu-platform
    - vllm-configuration
...
"""
    ...
    defcheck_and_update_config(cls, vllm_config: VllmConfig) -> None:
        ...
        fromvllm.configimport CompilationMode
    ...
    @classmethod
    defdiscover_numa_topology(cls) -> list[list[int]]:
"""
...
"""
    ...
    @classmethod
    defsupports_structured_output(cls) -> bool:
        return True
        ...
        if Platform.get_cpu_architecture() in (CpuArchEnum.X86,):
            ...
            if torch.cpu._is_avx512_supported():
                if torch.cpu._is_avx512_bf16_supported():
                    ...
                    try:
                        importvllm._C_AVX512  # noqa: F401
                    except ImportError as e:
...
"""
        ...
        fromvllm._custom_opsimport cpu_attn_reshape_and_cache
        fromvllm.v1.attention.backends.cpu_attnimport _get_attn_isa
