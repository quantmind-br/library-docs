...
url: https://moodledev.io/docs/4.4/apis/core/di
source: sitemap
fetched_at: 2026-02-17T15:02:11.762667-03:00
rendered_js: false
word_count: 486
summary: This document explains how to implement and manage PSR-11 compatible Dependency Injection in Moodle, covering dependency fetching, configuration via hooks, and mocking for unit tests.
tags:
    - moodle
    - php
