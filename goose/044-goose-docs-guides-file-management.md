---
title: File Access and Management | goose
url: https://block.github.io/goose/docs/guides/file-management
source: github_pages
fetched_at: 2026-01-22T22:13:51.21771714-03:00
rendered_js: true
word_count: 468
summary: This guide explains how to efficiently search for and reference files using goose Desktop's fuzzy search feature and outlines best practices for safe file management.
tags:
    - goose-desktop
    - file-management
    - fuzzy-search
...
## File Access[​](#file-access "Direct link to File Access")

### Quick File Search in goose Desktop[​](#quick-file-search-in-goose-desktop "Direct link to Quick File Search in goose Desktop")
...
## File Management Best Practices[​](#file-management-best-practices "Direct link to File Management Best Practices")
