...
source: sitemap
fetched_at: 2026-04-15T09:01:14.088162975-03:00
rendered_js: false
word_count: 694
summary: This document explains the Auto-Run mode feature, which allows users to set autonomy levels for AI-driven tool execution based on command risk classification.
tags:
    - ai-agents
    - cli-tools
    - automation
