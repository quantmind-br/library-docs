...
url: https://docs.fireworks.ai/api-reference/validate-evaluator-upload
source: sitemap
fetched_at: 2026-04-27T20:19:02.371543195-03:00
rendered_js: false
optimized: true
...
Validates that an evaluator upload completed successfully. Returns an empty `{}` on success.
