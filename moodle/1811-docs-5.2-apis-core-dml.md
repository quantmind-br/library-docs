...
url: https://moodledev.io/docs/5.2/apis/core/dml
source: sitemap
fetched_at: 2026-02-17T15:43:20.977857-03:00
rendered_js: false
word_count: 2451
summary: This document explains the Moodle Data Manipulation API for accessing and modifying database content using the global $DB object. It covers core concepts such as table prefixing, SQL placeholders, and specific methods for retrieving single or multiple records from the database.
tags:
    - moodle-development
    - database-api
    - dml
...
- [DML drivers](https://moodledev.io/docs/5.2/apis/core/dml/drivers): Database drivers for new DML layer
- [DDL functions](https://moodledev.io/docs/5.2/apis/core/dml/ddl): Where all the functions used to handle DB objects ([DDL](https://en.wikipedia.org/wiki/Data_Definition_Language)) are defined.