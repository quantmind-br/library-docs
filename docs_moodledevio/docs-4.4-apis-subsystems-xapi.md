...
url: https://moodledev.io/docs/4.4/apis/subsystems/xapi
source: sitemap
fetched_at: 2026-02-17T15:05:04.575713-03:00
rendered_js: false
word_count: 2486
summary: This document explains the technical implementation of the Moodle xAPI integration library, detailing how it processes learning statements and state data through specific web services and PHP handler classes.
tags:
    - moodle-development
    - xapi-integration
