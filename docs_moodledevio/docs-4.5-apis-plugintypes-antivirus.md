...
url: https://moodledev.io/docs/4.5/apis/plugintypes/antivirus
source: sitemap
fetched_at: 2026-02-17T15:11:42.621685-03:00
rendered_js: false
word_count: 670
summary: This document provides a technical guide for developing antivirus plugins in Moodle, detailing the required file structure and mandatory class implementations for file scanning.
tags:
    - moodle-development
    - antivirus-plugin
    - plugin-architecture
...
Some of the important files for the antivirus plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.5/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
