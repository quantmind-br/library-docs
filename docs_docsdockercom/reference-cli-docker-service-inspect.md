...
source: llms
fetched_at: 2026-01-24T14:40:54.785496877-03:00
rendered_js: false
word_count: 253
summary: This document provides a technical reference for the docker service inspect command, used to retrieve detailed configuration and state information for services within a Docker Swarm.
tags:
    - docker-engine
    - swarm-mode
    - cli-reference
...
DescriptionDisplay detailed information on one or more servicesUsage`docker service inspect [OPTIONS] SERVICE [SERVICE...]`
...
Refer to [https://docs.docker.com/go/formatting/](https://docs.docker.com/go/formatting/) for more information about formatting output with templates[`--pretty`](#pretty)Print the information in a human friendly format
