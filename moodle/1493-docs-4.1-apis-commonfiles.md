...
url: https://moodledev.io/docs/4.1/apis/commonfiles
source: sitemap
fetched_at: 2026-02-17T14:54:28.039591-03:00
rendered_js: false
word_count: 2649
summary: This document describes the mandatory and optional files required for Moodle plugins and subsystems, explaining their specific roles in installation, upgrades, and localization.
tags:
    - moodle-development
    - plugin-architecture
    - file-structure
...
This page describes the common files which may be present in any Moodle subsystem or [plugin type](https://moodledev.io/docs/4.1/apis/plugintypes). Some of these files are mandatory and **must** exist within a component, whilst others are optional.
...
See [db/tasks.php](https://moodledev.io/docs/4.1/apis/commonfiles/db-tasks.php) for full details of the file format.
...
Full details on how to create settings are available in the [Admin settings](https://moodledev.io/docs/4.1/apis/subsystems/admin) documentation.
...
The [Moodle JavaScript Guide](https://moodledev.io/docs/4.1/guides/javascript) has detailed information and examples on writing JavaScript in Moodle. Further information is also available in the [JavaScript Modules](https://moodledev.io/docs/4.1/guides/javascript/modules) documentation.
...
In older versions of Moodle, JavaScript was written in the YUI format. This is being phased out in favour of [JavaScript Modules](https://moodledev.io/docs/4.1/guides/javascript/modules), although some older uses still remain in Moodle core.

- [YUI/Modules](https://moodledev.io/docs/4.1/guides/javascript/yui/modules)
- [YUI](https://moodledev.io/docs/4.1/guides/javascript/yui)
...
- [Plugin types](https://moodledev.io/docs/4.1/apis/plugintypes) - list of all supported plugin types
