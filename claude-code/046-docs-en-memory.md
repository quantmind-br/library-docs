...
source: llms
fetched_at: 2026-04-16T22:33:29.390201586-03:00
rendered_js: false
word_count: 3148
summary: This document explains how to use CLAUDE.md files and auto memory to provide persistent context and instructions for the Claude Code environment. It details different file scopes, placement strategies, and best practices for managing project-specific knowledge.
tags:
    - claude-code
