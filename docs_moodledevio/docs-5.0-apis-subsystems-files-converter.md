...
url: https://moodledev.io/docs/5.0/apis/subsystems/files/converter
source: sitemap
fetched_at: 2026-02-17T15:27:33.519706-03:00
rendered_js: false
word_count: 392
summary: This document explains how to use the Moodle file converter API to transform files between different formats asynchronously. It details how to initiate conversions, monitor their status, and retrieve the resulting converted files.
tags:
    - moodle
    - file-conversion
    - api-documentation
...
- Creating a new [file converter plugin](https://moodledev.io/docs/5.0/apis/plugintypes/fileconverter)