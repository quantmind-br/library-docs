...
source: crawler
fetched_at: 2026-01-28T16:18:37.284777975-03:00
rendered_js: false
word_count: 3121
summary: This document defines the `Flow` base class in mitmproxy, outlining its core attributes, error handling mechanisms, and serialization capabilities for representing network interactions.
tags:
    - mitmproxy
    - flow-object
    - network-flow
