...
url: https://moodledev.io/docs/5.1/apis/subsystems/external/functions
source: sitemap
fetched_at: 2026-02-17T15:36:24.066046-03:00
rendered_js: false
word_count: 0
summary: This PHP document defines a Moodle external service API class used to programmatically create groups within specific courses by specifying their ID, name, and description.
tags:
    - moodle-api
    - php-development
    - group-management
