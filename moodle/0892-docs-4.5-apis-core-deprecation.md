...
url: https://moodledev.io/docs/4.5/apis/core/deprecation
source: sitemap
fetched_at: 2026-02-17T15:11:05.823157-03:00
rendered_js: false
word_count: 0
summary: This document demonstrates how to use the Moodle core deprecated attribute to mark functions, classes, and enum cases as obsolete with specific metadata such as replacement, version, and reasoning.
tags:
    - moodle-development
    - php-attributes
    - deprecation
