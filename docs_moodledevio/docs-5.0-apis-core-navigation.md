...
url: https://moodledev.io/docs/5.0/apis/core/navigation
source: sitemap
fetched_at: 2026-02-17T15:24:55.759119-03:00
rendered_js: false
word_count: 1881
summary: This document explains the Moodle Navigation API architecture and provides instructions on how to programmatically manage and extend navigation structures, settings, and breadcrumbs.
tags:
    - moodle-development
    - navigation-api
    - php-api
