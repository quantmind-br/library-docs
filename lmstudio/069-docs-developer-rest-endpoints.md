---
title: REST API v0
url: https://lmstudio.ai/docs/developer/rest/endpoints
source: sitemap
fetched_at: 2026-04-07T21:30:30.697126773-03:00
rendered_js: false
word_count: 259
summary: This document details the structure and usage of LM Studio's v1 REST API, providing endpoints for listing models, getting model information, performing chat completions, text completions, and generating embeddings.
tags:
    - rest-api
    - llm
    - api-endpoints
...
LM Studio now has a [v1 REST API](https://lmstudio.ai/docs/developer/rest)! We recommend using the v1 API for new projects!

##### Requires [LM Studio 0.3.6](https://lmstudio.ai/download) or newer.

LM Studio now has its own REST API, in addition to OpenAI-compatible endpoints ([learn more](https://lmstudio.ai/docs/developer/openai-compat)) and Anthropic-compatible endpoints ([learn more](https://lmstudio.ai/docs/developer/anthropic-compat)).
...
You can run LM Studio as a service and get the server to auto-start on boot without launching the GUI. [Learn about Headless Mode](https://lmstudio.ai/docs/developer/core/headless).

## Endpoints[](#endpoints "Link to 'Endpoints'")
