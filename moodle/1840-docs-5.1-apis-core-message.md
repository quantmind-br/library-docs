...
url: https://moodledev.io/docs/5.1/apis/core/message
source: sitemap
fetched_at: 2026-02-17T15:34:27.177904-03:00
rendered_js: false
word_count: 811
summary: This document provides a technical guide on using the Moodle Messaging API to programmatically send notifications and messages from plugins and components.
tags:
    - moodle-api
    - messaging-system
    - php-development
