...
url: https://moodledev.io/docs/4.5/tags/core-dml
source: sitemap
fetched_at: 2026-02-17T15:06:32.804098-03:00
rendered_js: false
word_count: 136
summary: This document provides an overview of Moodle's core APIs for managing database structures and manipulating data across different RDBMS platforms. It covers data definition, manipulation, drivers, error handling, and transaction management.
tags:
    - moodle-api
    - database-management
    - dml
