...
url: https://moodledev.io/docs/5.1/apis/core/customfields
source: sitemap
fetched_at: 2026-02-17T15:34:06.815268-03:00
rendered_js: false
word_count: 795
summary: This document provides a technical overview of the Custom fields API, explaining how to implement handler classes, manage field configurations, and integrate custom fields into plugin forms and data structures.
tags:
    - custom-fields-api
    - moodle-development
    - handler-classes
...
Except for common [Plugin files](https://moodledev.io/docs/5.1/apis/commonfiles) and tests the following classes must be present in `customfield` plugins (in respective autoloaded locations):
