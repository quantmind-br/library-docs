...
url: https://moodledev.io/docs/5.0/apis/subsystems/routing/responses
source: sitemap
fetched_at: 2026-02-17T15:28:09.690431-03:00
rendered_js: false
word_count: 315
summary: This document explains how to return data from routes in Moodle 5.0, specifically detailing the use of payload_response for JSON serialization and schema validation.
tags:
    - moodle-development
    - routing
    - payload-response
