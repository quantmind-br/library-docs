---
title: Kimi-K2 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Moonshotai/Kimi-K2
source: sitemap
fetched_at: 2026-05-11T05:50:24.948133078-03:00
rendered_js: false
word_count: 451
summary: This document provides instructions for deploying and invoking the Kimi-K2 model variants using SGLang, including configuration for reasoning and tool-calling capabilities.
tags:
    - sglang
    - kimi-k2
    - model-deployment
...
[Kimi-K2](https://moonshotai.github.io/Kimi-K2/) is a state-of-the-art MoE language model by Moonshot AI with 32B activated parameters and 1T total parameters. **Model Variants:**
...
- **Expert Parallelism (EP)**: Use `--ep` for better MoE throughput. See [EP docs](https://docs.sglang.io/docs/advanced_features/expert_parallelism).
...
See [Basic API Usage](https://docs.sglang.io/docs/get-started/quickstart).
