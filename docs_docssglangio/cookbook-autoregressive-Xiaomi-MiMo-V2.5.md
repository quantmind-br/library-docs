---
title: MiMo-V2.5 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Xiaomi/MiMo-V2.5
source: sitemap
fetched_at: 2026-05-11T05:49:58.004051472-03:00
rendered_js: false
word_count: 1141
summary: This document provides comprehensive technical documentation for deploying and configuring XiaomiMiMo V2.5 series models using the SGLang inference framework on GPU and TPU hardware.
tags:
    - mimo-v2.5
    - sglang
    - llm-deployment
...
VariantTotal paramsActive (MoE)Modalities[**MiMo-V2.5-Pro**](https://huggingface.co/XiaomiMiMo/MiMo-V2.5-Pro)**1.02T**42BText (multimodal planned)[**MiMo-V2.5**](https://huggingface.co/XiaomiMiMo/MiMo-V2.5)**310B**15BText, Image, Video, Audio
...
Refer to the [official SGLang installation guide](https://docs.sglang.io/docs/get-started/install). **Docker Images by Variant × Hardware:**

VariantHardwareDocker Image**MiMo-V2.5 (310B)**H100 / H200 (Hopper, CUDA 12.9)`lmsysorg/sglang:dev-mimo-v2.5`**MiMo-V2.5 (310B)**B200 / GB300 (Blackwell, CUDA 13.0)`lmsysorg/sglang:dev-cu13-mimo-v2.5`**MiMo-V2.5-Pro (1.02T)**H100 / H200 (Hopper, CUDA 12.9)`lmsysorg/sglang:dev-mimo-v2.5-pro`**MiMo-V2.5-Pro (1.02T)**B200 / GB300 (Blackwell, CUDA 13.0)`lmsysorg/sglang:dev-cu13-mimo-v2.5-pro`
...
V2.5-Pro1.02T / 42BV2.5310B / 15B

Hardware Platform

H200H100B200GB300TPU v7xsgl-jax, Pro onlyTPU v6esgl-jax, Pro only

EAGLE MTP

EnabledEAGLEDisabled

DP Attention

Enabledauto for V2.5Disabled

Expert Parallelism

EnabledPro HopperDisabled

DeepEP

Enabledneeds deep\_epDisableddefault
...
TPU TypeTopologyChips/NodeNodesTotal ChipsJAX Devices/ChipTotal JAX Devices (= `--tp-size`)**v7x**2×2×44416232**v6e**4×4×441664164
...
All nodes must sit in the same TPU slice and reach each other on the JAX init port (`20000`) and the TPU process port (`8471`). **Step 1 — Launch the JAX TPU container on every node:**
...
See [Basic API Usage](https://docs.sglang.io/docs/basic_usage/send_request).
...
Standard 5-shot, `temperature=0`, `max_tokens=4096`, model defaults to thinking-on (responses contain `<think>...</think>` and the eval extracts the trailing number via regex). Server launch: see [Section 3](#3-model-deployment). **Benchmark Command:**
