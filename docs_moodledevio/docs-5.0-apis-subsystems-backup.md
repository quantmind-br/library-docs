...
url: https://moodledev.io/docs/5.0/apis/subsystems/backup
source: sitemap
fetched_at: 2026-02-17T15:27:06.349818-03:00
rendered_js: false
word_count: 1061
summary: This document provides a technical overview and implementation guide for the Moodle Backup API, explaining how developers can include plugin-specific data in course backups through tasks and steps.
tags:
    - moodle-development
    - backup-api
    - plugin-data
...
The Backup API provides a way to include your plugin's in the course backup. See [Restore API](https://moodledev.io/docs/5.0/apis/subsystems/backup/restore) for the part that takes care of restoring data.
