---
title: Todo Lists
url: https://code.claude.com/docs/en/agent-sdk/todo-tracking.md
source: llms
fetched_at: 2026-04-16T22:30:04.180263477-03:00
rendered_js: false
word_count: 258
summary: This document explains how to manage and monitor task lifecycles using the built-in todo functionality in the Claude Agent SDK. It details when todos are automatically generated and provides implementation patterns for real-time progress tracking.
tags:
    - claude-agent-sdk
    - task-management
    - workflow-automation
