---
title: Navigation Events | Instructure Developer Documentation Portal
url: https://developerdocs.instructure.com/services/canvas/data-services/live-events/event-format/caliper-ims-1.1/file.data_service_caliper_navigation_events
source: sitemap
fetched_at: 2026-02-15T09:13:53.474316-03:00
rendered_js: false
word_count: 303
summary: This document defines the asset_accessed event in Canvas, detailing the specific data fields and triggers generated when users view various objects within the platform. It provides schema specifications and JSON payload examples for tracking navigation events across different asset types like assignments and attachments.
tags:
    - canvas-lms
    - caliper-analytics
    - event-tracking
...
**data\[0].object.extensions\["com.instructure.canvas"].asset\_name**
...
**data\[0].object.extensions\["com.instructure.canvas"].asset\_subtype**

indicates Canvas object sub-type being accessed in the NavigationEvent

**data\[0].object.extensions\["com.instructure.canvas"].asset\_type**

indicates Canvas object type being accessed in the NavigationEvent

**data\[0].object.extensions\["com.instructure.canvas"].context\_account\_id**
...
**data\[0].object.extensions\["com.instructure.canvas"].http\_method**
...
**Description:** type=context\_external\_tool (this type is used to identify all LTI versions but LTI 2.0 launches)
