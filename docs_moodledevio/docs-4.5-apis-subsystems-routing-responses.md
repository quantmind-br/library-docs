...
url: https://moodledev.io/docs/4.5/apis/subsystems/routing/responses
source: sitemap
fetched_at: 2026-02-17T15:15:08.101178-03:00
rendered_js: false
word_count: 315
summary: This document explains the required return types for routes in Moodle 4.5, focusing on the payload_response class for structured data and PSR-7 response interfaces.
tags:
    - moodle
    - routing
    - php
