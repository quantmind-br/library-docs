...
url: https://docs.clawd.bot/multi-agent-sandbox-tools.md
source: llms
fetched_at: 2026-01-26T09:52:38.022620696-03:00
rendered_js: false
word_count: 657
summary: This document explains how to configure sandboxing and tool restrictions for individual agents in a multi-agent environment, including setup for security profiles and configuration precedence.
tags:
    - multi-agent
    - sandboxing
    - tool-configuration
