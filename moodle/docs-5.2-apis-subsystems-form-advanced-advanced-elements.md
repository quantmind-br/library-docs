...
url: https://moodledev.io/docs/5.2/apis/subsystems/form/advanced/advanced-elements
source: sitemap
fetched_at: 2026-02-17T15:45:51.714997-03:00
rendered_js: false
word_count: 298
summary: This document explains how to use the setAdvanced method in MoodleQuickForm to control the initial visibility of form elements and entire sections.
tags:
    - moodle-forms
    - moodlequickform
    - setadvanced
