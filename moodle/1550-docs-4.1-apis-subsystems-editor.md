...
url: https://moodledev.io/docs/4.1/apis/subsystems/editor
source: sitemap
fetched_at: 2026-02-17T14:56:03.556869-03:00
rendered_js: false
word_count: 187
summary: This document explains how to use the Moodle Editor API to programmatically set up and configure text editors for HTML text areas.
tags:
    - moodle-development
    - text-editor
    - api-reference
