...
url: https://moodledev.io/docs/5.0/guides/javascript/jquery
source: sitemap
fetched_at: 2026-02-17T15:28:40.336894-03:00
rendered_js: false
word_count: 371
summary: This document outlines Moodle's policy and technical methods for implementing jQuery and jQuery UI, emphasizing that their use is discouraged in favor of native ES6 modules.
tags:
    - moodle-development
    - jquery
    - javascript-modules
