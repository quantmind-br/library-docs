...
source: git
fetched_at: 2026-05-03T09:31:13.482484237-03:00
rendered_js: false
word_count: 1357
summary: This document explains how to configure custom AI providers and models using the models.json file, including details on provider configuration, compatibility settings, and authentication methods.
tags:
    - configuration
    - custom-models
    - ai-providers
