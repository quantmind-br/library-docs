...
url: https://moodledev.io/docs/5.1/apis/plugintypes/availability
source: sitemap
fetched_at: 2026-02-17T15:34:52.694657-03:00
rendered_js: false
word_count: 747
summary: This document provides a technical overview and implementation guide for creating Moodle availability condition plugins to restrict user access to course activities and sections.
tags:
    - moodle-development
    - availability-api
    - plugin-development
...
Availability conditions allow teachers to restrict an activity or section so that only certain users can access it. These are accessed using the [Availability API](https://moodledev.io/docs/5.1/apis/subsystems/availability).
...
- Using the [Availability API as a consumer](https://moodledev.io/docs/5.1/apis/subsystems/availability)
- [Conditional activities API](https://moodledev.io/docs/5.1/apis/core/conditionalactivities)