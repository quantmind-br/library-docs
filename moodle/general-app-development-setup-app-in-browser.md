---
title: Using the Moodle App in a browser | Moodle Developer Resources
url: https://moodledev.io/general/app/development/setup/app-in-browser
source: sitemap
fetched_at: 2026-02-17T15:55:02.563707-03:00
rendered_js: false
word_count: 1077
summary: This document explains how to set up and use Chromium-based browsers for developing the Moodle App, including configuration flags and environment variables. It details the advantages and limitations of browser-based development compared to testing on native devices.
tags:
    - moodle-app
    - chromium
    - web-development
...
## Differences between Chromium and Google Chrome[​](#differences-between-chromium-and-google-chrome "Direct link to Differences between Chromium and Google Chrome")
...
## Advantages and disadvantages of using a browser instead of a native device[​](#advantages-and-disadvantages-of-using-a-browser-instead-of-a-native-device "Direct link to Advantages and disadvantages of using a browser instead of a native device")
...
If you are using other operative system, check out [how to run chromium with flags](https://www.chromium.org/developers/how-tos/run-chromium-with-flags) in other environments. Depending on the version of your browser, you may get a warning message saying "You are using an unsupported command-line flag". This is expected and can safely be ignored (for development).
...
### Creating a shortcut[​](#creating-a-shortcut "Direct link to Creating a shortcut")
...
### Configuring the default browser[​](#configuring-the-default-browser "Direct link to Configuring the default browser")
...
## Using the hosted versions of the app[​](#using-the-hosted-versions-of-the-app "Direct link to Using the hosted versions of the app")
...
## Tips & tricks[​](#tips--tricks "Direct link to Tips & tricks")
