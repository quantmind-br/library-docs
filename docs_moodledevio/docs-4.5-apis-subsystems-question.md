...
url: https://moodledev.io/docs/4.5/apis/subsystems/question
source: sitemap
fetched_at: 2026-02-17T15:15:00.458227-03:00
rendered_js: false
word_count: 719
summary: This document explains the architecture of the Moodle question subsystem, detailing how the question engine and question bank manage interactive questions through various plugin types and core classes.
tags:
    - moodle-development
    - question-engine
    - question-bank
...
[Question bank plugins (qbank\_)](https://moodledev.io/docs/4.5/apis/plugintypes/qbank) add features to the question bank. The core question bank code mainly just ties all these features together.
...
[Question types](https://moodledev.io/docs/4.5/apis/plugintypes/qtype) were already considered above, when thinking about the the question engine. They also need to work with the question bank, so that teachers can create and edit questions of that type.