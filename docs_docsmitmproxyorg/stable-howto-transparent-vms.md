...
source: crawler
fetched_at: 2026-01-28T16:18:53.439020284-03:00
rendered_js: false
word_count: 329
summary: This guide details how to set up transparent proxying for virtual machines using a Ubuntu proxy VM with VirtualBox, covering network configuration, DHCP/DNS setup with dnsmasq, traffic redirection via iptables, and running mitmproxy.
tags:
