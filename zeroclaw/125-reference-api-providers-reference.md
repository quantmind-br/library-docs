...
url: https://github.com/openagen/zeroclaw/blob/master/docs/reference/api/providers-reference.md
source: git
fetched_at: 2026-05-02T14:51:57.677519643-03:00
rendered_js: false
word_count: 1420
summary: This document provides a comprehensive mapping of ZeroClaw provider IDs, their respective credential environment variables, and specific configuration notes for local and cloud-based AI inference services.
tags:
    - zeroclaw
    - provider-reference
    - api-keys
...
Maps provider IDs, aliases, and credential environment variables.
...
- Usage does not require a project deployment.
...
- CLI OAuth requests use `cloudcode-pa.googleapis.com/v1internal` with Code Assist request envelope semantics
...
Route model calls by hint using `[[model_routes]]`:
...
Route embedding calls with the same hint pattern using `[[embedding_routes]]`.
...
#zeroclaw #provider-reference #api-keys #environment-variables #model-configuration #inference-providers
