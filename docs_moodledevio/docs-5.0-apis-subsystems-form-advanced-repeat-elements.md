...
url: https://moodledev.io/docs/5.0/apis/subsystems/form/advanced/repeat-elements
source: sitemap
fetched_at: 2026-02-17T15:27:43.307813-03:00
rendered_js: false
word_count: 265
summary: This document explains how to use the repeat_elements method within the Form API to create and manage dynamic, repeating groups of form elements.
tags:
    - form-api
    - repeat-elements
    - dynamic-forms
