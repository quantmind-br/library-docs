...
url: https://moodledev.io/docs/5.2/apis
source: sitemap
fetched_at: 2026-02-17T15:42:57.95163-03:00
rendered_js: false
word_count: 1482
summary: This document provides a comprehensive overview of the core and general APIs available in Moodle, describing their specific functions for plugin development and system integration.
tags:
    - moodle-development
    - core-apis
    - plugin-development
