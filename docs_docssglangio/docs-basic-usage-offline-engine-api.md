---
title: Offline Engine API - SGLang Documentation
url: https://docs.sglang.io/docs/basic_usage/offline_engine_api
source: sitemap
fetched_at: 2026-05-11T05:49:07.28600776-03:00
rendered_js: false
word_count: 187
summary: This document explains how to utilize the SGLang offline inference engine for batch generation, covering both synchronous and asynchronous modes with streaming and non-streaming capabilities.
tags:
    - sglang
    - offline-inference
    - batch-processing
