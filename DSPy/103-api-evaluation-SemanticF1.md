---
title: SemanticF1 - DSPy
url: https://dspy.ai/api/evaluation/SemanticF1/
source: sitemap
fetched_at: 2026-01-23T08:01:34.303960871-03:00
rendered_js: false
word_count: 786
summary: This document defines the SemanticF1 class in DSPy, which evaluates predictions by calculating semantic recall and precision using language model modules.
tags:
    - dspy
    - semantic-f1
    - evaluation-metrics
...
```
def__init__(self, threshold=0.66, decompositional=False):
...
### Functions[¶](#dspy.evaluate.SemanticF1-functions "Permanent link")

#### `__call__(*args, **kwargs) -> Prediction` [¶](#dspy.evaluate.SemanticF1.__call__ "Permanent link")
...
#### `acall(*args, **kwargs) -> Prediction` `async` [¶](#dspy.evaluate.SemanticF1.acall "Permanent link")
...
#### `deepcopy()` [¶](#dspy.evaluate.SemanticF1.deepcopy "Permanent link")
...
#### `dump_state(json_mode=True)` [¶](#dspy.evaluate.SemanticF1.dump_state "Permanent link")
...
#### `forward(example, pred, trace=None)` [¶](#dspy.evaluate.SemanticF1.forward "Permanent link")
...
#### `get_lm()` [¶](#dspy.evaluate.SemanticF1.get_lm "Permanent link")
...
#### `inspect_history(n: int = 1)` [¶](#dspy.evaluate.SemanticF1.inspect_history "Permanent link")
...
#### `load(path, allow_pickle=False)` [¶](#dspy.evaluate.SemanticF1.load "Permanent link")
...
#### `load_state(state)` [¶](#dspy.evaluate.SemanticF1.load_state "Permanent link")
...
#### `map_named_predictors(func)` [¶](#dspy.evaluate.SemanticF1.map_named_predictors "Permanent link")
...
#### `named_parameters()` [¶](#dspy.evaluate.SemanticF1.named_parameters "Permanent link")
...
#### `named_predictors()` [¶](#dspy.evaluate.SemanticF1.named_predictors "Permanent link")
...
#### `named_sub_modules(type_=None, skip_compiled=False) -> Generator[tuple[str, BaseModule], None, None]` [¶](#dspy.evaluate.SemanticF1.named_sub_modules "Permanent link")
...
#### `parameters()` [¶](#dspy.evaluate.SemanticF1.parameters "Permanent link")
...
#### `predictors()` [¶](#dspy.evaluate.SemanticF1.predictors "Permanent link")
...
#### `reset_copy()` [¶](#dspy.evaluate.SemanticF1.reset_copy "Permanent link")
...
#### `save(path, save_program=False, modules_to_serialize=None)` [¶](#dspy.evaluate.SemanticF1.save "Permanent link")
...
#### `set_lm(lm)` [¶](#dspy.evaluate.SemanticF1.set_lm "Permanent link")
