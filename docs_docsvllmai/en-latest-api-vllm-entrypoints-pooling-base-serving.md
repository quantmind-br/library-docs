---
title: serving - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/entrypoints/pooling/base/serving/
source: sitemap
fetched_at: 2026-05-07T21:20:50.451687655-03:00
rendered_js: false
word_count: 33
summary: This document defines the base abstract class for handling pooling request serving in vLLM, providing the framework for preprocessing, asynchronous inference execution, and post-processing steps.
tags:
    - vllm
    - pooling
    - async-serving
...
classPoolingServingBase(ABC):
    ...
    @abstractmethod
    defget_io_processor(self, request: AnyPoolingRequest) -> PoolingIOProcessor:
...
"""Pulls the request id to use from a header, if provided"""
    ...
    def_validate_request(self, ctx: PoolingServeContext) -> None:
    ...
    def_get_active_default_mm_loras(
...
"""Determine if there are any active default multimodal loras."""
    ...
    def_get_message_types(self, request: AnyPoolingRequest) -> set[str]:
