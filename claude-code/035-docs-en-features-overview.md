...
source: llms
fetched_at: 2026-04-16T22:32:18.58359926-03:00
rendered_js: false
word_count: 1546
summary: This guide explains how to extend Claude Code functionality through various tools like CLAUDE.md, Skills, MCP, and subagents to customize workflows and automate development tasks.
tags:
    - claude-code
    - workflow-automation
    - extension-layers
