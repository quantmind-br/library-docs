...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/createDataset
source: crawler
fetched_at: 2026-02-27T23:39:39.314139-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response illustrating the data structure for advertising pixels, conversion events, and API integration details.
tags:
    - json-response
    - advertising-api
    - pixel-tracking
