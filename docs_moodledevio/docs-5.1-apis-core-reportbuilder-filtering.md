...
url: https://moodledev.io/docs/5.1/apis/core/reportbuilder/filtering
source: sitemap
fetched_at: 2026-02-17T15:34:32.824754-03:00
rendered_js: false
word_count: 924
summary: This document explains how to set default condition values for report builder datasources by implementing the get_default_condition_values method. It details the required key naming conventions and parameters for various filter types including text, number, and date.
tags:
    - moodle
    - report-builder
    - datasource
