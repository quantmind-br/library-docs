...
url: https://moodledev.io/docs/5.1/apis/core/navigation
source: sitemap
fetched_at: 2026-02-17T15:34:28.348557-03:00
rendered_js: false
word_count: 1881
summary: This document explains the architecture of the Moodle Navigation API and provides instructions on how to access and extend site navigation, settings, and breadcrumbs using the global page object.
tags:
    - moodle-development
    - navigation-api
    - php-api
