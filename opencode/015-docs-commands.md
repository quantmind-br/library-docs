...
source: sitemap
fetched_at: 2026-04-17T06:43:44.776736462-03:00
rendered_js: false
word_count: 544
summary: This document explains how to create and configure custom commands in the OpenCode TUI using JSON configuration or Markdown files to automate repetitive tasks via LLM prompts.
tags:
    - opencode-tui
    - custom-commands
    - prompt-engineering
