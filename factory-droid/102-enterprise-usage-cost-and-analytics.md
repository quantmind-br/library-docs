...
url: https://docs.factory.ai/enterprise/usage-cost-and-analytics.md
source: llms
fetched_at: 2026-02-05T21:42:58.23715697-03:00
rendered_js: false
word_count: 496
summary: This document explains how to monitor Droid adoption and performance using OpenTelemetry-native metrics and traces. It also outlines strategies for managing LLM costs and measuring the productivity impact of AI automation within an organization.
tags:
    - opentelemetry
    - analytics
    - llm-cost-management
