...
url: https://moodledev.io/docs/5.0/apis/subsystems/favourites
source: sitemap
fetched_at: 2026-02-17T15:27:28.89686-03:00
rendered_js: false
word_count: 746
summary: This document outlines the Moodle Favourites API, explaining how to manage user-specific bookmarks for various system items using the service layer.
tags:
    - moodle
    - favourites-api
    - php-api
