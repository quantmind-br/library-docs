...
url: https://docs.yasb.dev/latest/cli
source: crawler
fetched_at: 2026-02-23T05:28:28.327373-03:00
rendered_js: false
word_count: 380
summary: A command-line tool for managing, configuring, and controlling a status bar application (YASB) including start/stop, autostart, updates, and logging functions via terminal commands.
tags:
    - cli-tool
    - status-bar-control
    - command-reference
