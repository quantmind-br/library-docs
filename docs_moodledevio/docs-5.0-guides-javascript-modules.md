...
url: https://moodledev.io/docs/5.0/guides/javascript/modules
source: sitemap
fetched_at: 2026-02-17T15:28:44.442891-03:00
rendered_js: false
word_count: 1314
summary: This document explains how to create, manage, and use JavaScript modules in Moodle, focusing on the mandatory ESM format and the required build toolchain.
tags:
    - moodle-development
    - javascript-modules
    - esm
