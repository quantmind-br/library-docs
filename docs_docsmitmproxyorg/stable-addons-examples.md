...
source: crawler
fetched_at: 2026-01-28T16:18:29.13351887-03:00
rendered_js: false
word_count: 1094
summary: This document provides a comprehensive list of mitmproxy addon examples, detailing various ways to extend mitmproxy's functionality through custom scripts, covering HTTP, WebSocket, TCP, and configuration adjustments.
tags:
    - mitmproxy
    - addons
    - scripting-examples
