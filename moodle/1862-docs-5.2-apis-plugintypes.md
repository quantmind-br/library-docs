...
url: https://moodledev.io/docs/5.2/apis/plugintypes
source: sitemap
fetched_at: 2026-02-17T15:43:48.252813-03:00
rendered_js: false
word_count: 1677
summary: This document outlines the architectural principles of Moodle plugins, detailing internal naming conventions and providing a comprehensive list of available plugin types and their directory paths.
tags:
    - moodle
    - plugin-development
    - naming-conventions
...
Although there are many different types of plugin, there are some things that work the same way in all plugin types. Please see the [Plugin files](https://moodledev.io/docs/5.2/apis/commonfiles) documentation that describes common files which are found in many plugin types.
