...
url: https://moodledev.io/docs/5.2/tags/custom-field
source: sitemap
fetched_at: 2026-02-17T15:39:16.906793-03:00
rendered_js: false
word_count: 93
summary: This document introduces Moodle's Custom fields API and explains how to create and implement custom field types within various core areas and addon plugins.
tags:
    - moodle-development
    - custom-fields
    - plugin-types
...
## [Custom fields API](https://moodledev.io/docs/5.2/apis/core/customfields)
