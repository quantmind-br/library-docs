...
url: https://doc.evolution-api.com/v2/en/integrations/cloudapi
source: sitemap
fetched_at: 2026-04-12T18:46:35.917332982-03:00
rendered_js: false
word_count: 545
summary: This document provides a comprehensive guide on integrating an application with the WhatsApp Cloud API using Evolution API v2. It details necessary prerequisites, such as setting up Facebook Business Manager and creating permanent tokens, followed by specific steps to configure the API instance and set up webhooks.
tags:
    - whatsapp-api
    - cloud-api
    - integration-guide
...
With the instance created and the webhook configured, your Evolution API v2 is ready to operate with the official WhatsApp Cloud API. All messages and events related to the configured number will be automatically managed by Evolution API. This documentation provides a clear and detailed overview of how to integrate the WhatsApp Cloud API with Evolution API v2, from the necessary preparation to the final configuration. By following all the steps, you will be prepared to utilize WhatsApp functionalities in your application through Evolution API v2.