...
source: sitemap
fetched_at: 2026-02-17T15:59:26.173315-03:00
rendered_js: false
word_count: 1504
summary: This document provides a comprehensive overview of Moodle's security design philosophy and guidelines for developers to write code that prevents common web vulnerabilities.
tags:
    - moodle-security
    - secure-coding
...
## Security of web applications[​](#security-of-web-applications "Direct link to Security of web applications")

### Secure web app requirements[​](#secure-web-app-requirements "Direct link to Secure web app requirements")
...
### Balanced security[​](#balanced-security "Direct link to Balanced security")
...
## Moodle security design[​](#moodle-security-design "Direct link to Moodle security design")

The security of web application depends on the intended use and features available for each type of user.

### Types of users[​](#types-of-users "Direct link to Types of users")
...
#### Teachers[​](#teachers "Direct link to Teachers")
...
#### Students[​](#students "Direct link to Students")
...
#### Guests[​](#guests "Direct link to Guests")
...
### Capability risks[​](#capability-risks "Direct link to Capability risks")
...
## Common types of security vulnerability[​](#common-types-of-security-vulnerability "Direct link to Common types of security vulnerability")
...
## Summary of the guidelines[​](#summary-of-the-guidelines "Direct link to Summary of the guidelines")

### Authenticate the user[​](#authenticate-the-user "Direct link to Authenticate the user")

- With very few exceptions, every script should call [`require_login`](https://moodledev.io/docs/5.2/apis/subsystems/access#require_login) or [`require_course_login`](https://moodledev.io/docs/5.2/apis/subsystems/access#require_course_login) as near the start as possible.

### Verify course and module access[​](#verify-course-and-module-access "Direct link to Verify course and module access")
...
### Check permissions[​](#check-permissions "Direct link to Check permissions")

- Before allowing the user to see anything or do anything, call to [`has_capability`](https://moodledev.io/docs/5.2/apis/subsystems/access#has_capability) or [`require_capability`](https://moodledev.io/docs/5.2/apis/subsystems/access#require_capability).
- Capabilities should be annotated with the appropriate [**risks**](https://moodledev.io/docs/5.2/apis/subsystems/roles#risk-bitmask-in-capabilities).
- If appropriate, restrict what people can see according to **groups**.

### Don't trust any input from users[​](#dont-trust-any-input-from-users "Direct link to Don't trust any input from users")

- Use [**moodleforms**](https://moodledev.io/docs/5.2/apis/subsystems/form) whenever possible, with an appropriate `setType` method call for each field.
...
- If not using a moodleform, clean input using `optional_param` or `required_param` with an appropriate `PARAM_...` type. \** Do not access `$_GET`, `$_POST` or `$_REQUEST` directly. \** Group optional\_param and required\_param calls together at the top of the script, to make them easy to find.

Similarly, clean data from other external resources like RSS feeds before use.

### Clean and escape data before output[​](#clean-and-escape-data-before-output "Direct link to Clean and escape data before output")
...
We recommend that you follow the [Output functions](https://moodledev.io/docs/5.2/apis/subsystems/output#output-functions) to get a better understanding of how dynamic data should be sent from Moodle to the browser.

### Escape data before storing it in the database[​](#escape-data-before-storing-it-in-the-database "Direct link to Escape data before storing it in the database")

- Use the [XMLDB](https://moodledev.io/general/development/tools/xmldb) library. This takes care of most escaping issues for you.
...
### Escape data before using it in shell commands[​](#escape-data-before-using-it-in-shell-commands "Direct link to Escape data before using it in shell commands")
...
### Log every request[​](#log-every-request "Direct link to Log every request")

- Every script should log an [event](https://docs.moodle.org/dev/Events_API)

### Other good practice[​](#other-good-practice "Direct link to Other good practice")
...
- [Security issue process](https://moodledev.io/general/development/process#security-issues)
