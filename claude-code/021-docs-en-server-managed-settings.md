...
source: llms
fetched_at: 2026-04-16T22:34:48.304951401-03:00
rendered_js: false
word_count: 1240
summary: This document explains how administrators can centrally manage Claude Code configurations for Teams and Enterprise users via a web-based interface. It compares server-managed settings with endpoint-managed approaches and provides instructions for deploying JSON-based configurations.
tags:
    - claude-code
    - admin-configuration
