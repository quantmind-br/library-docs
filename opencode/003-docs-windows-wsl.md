...
source: sitemap
fetched_at: 2026-04-17T06:49:22.863304136-03:00
rendered_js: false
word_count: 245
summary: This document provides instructions for setting up and running OpenCode on Windows using the Windows Subsystem for Linux (WSL). It covers installation, server-client connectivity, and accessing local file systems.
tags:
    - wsl-setup
