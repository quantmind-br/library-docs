...
url: https://moodledev.io/docs/5.1/apis/plugintypes/format
source: sitemap
fetched_at: 2026-02-17T15:35:02.679293-03:00
rendered_js: false
word_count: 5359
summary: This document explains the structure and implementation of Moodle course format plugins, detailing the essential files and classes required to customize course layouts and navigation.
tags:
    - moodle-development
    - course-formats
    - plugin-architecture
...
In case your plugin is a Moodle 3.11 compatible plugin, see the [migration guide](https://moodledev.io/docs/5.1/apis/plugintypes/format/migration) for more information.
