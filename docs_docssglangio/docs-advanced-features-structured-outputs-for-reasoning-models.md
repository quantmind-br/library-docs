---
title: Structured Outputs For Reasoning Models - SGLang Documentation
url: https://docs.sglang.io/docs/advanced_features/structured_outputs_for_reasoning_models
source: sitemap
fetched_at: 2026-05-11T05:49:16.186631999-03:00
rendered_js: false
word_count: 429
summary: This document explains how to configure SGLang to support reasoning models by utilizing reasoning parsers and how to implement structured output constraints using JSON schemas, EBNF, and regular expressions.
tags:
    - sglang
    - reasoning-models
    - json-schema
