...
url: https://moodledev.io/docs/5.2/tags/sub-system
source: sitemap
fetched_at: 2026-02-17T15:42:15.125963-03:00
rendered_js: false
word_count: 96
summary: This document provides an overview of the Moodle Tag API, explaining how to create, manage, and search for labels to categorize information within the system.
tags:
    - moodle
    - tag-api
    - metadata-management
