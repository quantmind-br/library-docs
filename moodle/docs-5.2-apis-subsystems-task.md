...
url: https://moodledev.io/docs/5.2/apis/subsystems/task
source: sitemap
fetched_at: 2026-02-17T15:46:33.714474-03:00
rendered_js: false
word_count: 1077
summary: This document provides an overview of the Moodle Tasks API, explaining the implementation and benefits of scheduled and adhoc tasks for background processing.
tags:
    - moodle
    - tasks-api
    - scheduled-tasks
...
See the [scheduled tasks](https://moodledev.io/docs/5.2/apis/subsystems/task/scheduled) page for more information on creating scheduled tasks.
...
Historically many Moodle APIs have used static caches. Whilst many of these have been replaced by the [Moodle Universal Cache](https://moodledev.io/docs/5.2/apis/subsystems/muc), which can be cleared between runs, it is not possible to guarantee that this is always the case.
...
In the case of an adhoc task, you can call the [`set_userid`](https://moodledev.io/docs/5.2/apis/subsystems/task/adhoc#running-as-a-specific-user) function when queueing the task.
...
Since Moodle 3.5 it is safe to use the [Output API](https://moodledev.io/docs/5.2/apis/subsystems/output) in cron tasks. Prior to this there may be cases where the Output API has not been initialised.
