---
title: "null"
url: https://docs.clawd.bot/start/onboarding.md
source: llms
fetched_at: 2026-01-26T09:53:56.63014557-03:00
rendered_js: false
word_count: 428
summary: This document outlines the multi-step onboarding process for the Clawdbot macOS application, covering gateway configuration, authentication, and initial agent environment bootstrapping.
tags:
    - macos-app
    - onboarding-flow
    - authentication
