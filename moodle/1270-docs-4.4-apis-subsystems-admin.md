...
url: https://moodledev.io/docs/4.4/apis/subsystems/admin
source: sitemap
fetched_at: 2026-02-17T15:03:49.065393-03:00
rendered_js: false
word_count: 1791
summary: This document explains the technical architecture of Moodle's administration settings tree and provides instructions for developers on how to define and register plugin-specific configuration settings.
tags:
    - moodle-development
    - admin-settings
    - php-api
...
- [configuration for filter](https://moodledev.io/docs/4.4/apis/plugintypes/filter)
