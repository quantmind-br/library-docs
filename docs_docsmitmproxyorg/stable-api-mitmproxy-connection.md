...
source: crawler
fetched_at: 2026-01-28T15:01:13.512457796-03:00
rendered_js: false
word_count: 3983
summary: This document defines the connection classes and related data structures used in mitmproxy to manage client and server connections, including TLS configuration and metadata.
tags:
    - network-connections
    - tls-configuration
    - mitmproxy
