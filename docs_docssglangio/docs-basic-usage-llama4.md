---
title: Llama4 Usage - SGLang Documentation
url: https://docs.sglang.io/docs/basic_usage/llama4
source: sitemap
fetched_at: 2026-05-11T05:49:09.651591912-03:00
rendered_js: false
word_count: 329
summary: This document provides guidelines for deploying Meta's Llama 4 models using the SGLang runtime, including configuration options, hardware-specific optimization tips, and speculative decoding setup.
tags:
    - sglang
    - llama-4
    - llm-inference
...
[Llama 4](https://github.com/meta-llama/llama-models/blob/main/models/llama4/MODEL_CARD) is Meta’s latest generation of open-source LLM model with industry-leading performance. SGLang has supported Llama 4 Scout (109B) and Llama 4 Maverick (400B) since [v0.4.5](https://github.com/sgl-project/sglang/releases/tag/v0.4.5). Ongoing optimizations are tracked in the [Roadmap](https://github.com/sgl-project/sglang/issues/5118).
...
The accuracy on SGLang for both Llama4 Scout and Llama4 Maverick can match the [official benchmark numbers](https://ai.meta.com/blog/llama-4-multimodal-intelligence/). Benchmark results on MMLU Pro dataset with 8\*H100:

Llama-4-Scout-17B-16E-InstructLlama-4-Maverick-17B-128E-InstructOfficial Benchmark74.380.5SGLang75.280.7
