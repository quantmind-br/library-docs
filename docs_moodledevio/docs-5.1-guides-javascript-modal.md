...
url: https://moodledev.io/docs/5.1/guides/javascript/modal
source: sitemap
fetched_at: 2026-02-17T15:37:50.573506-03:00
rendered_js: false
word_count: 609
summary: This document explains how to implement and customize accessible modal dialogues in Moodle using the modal and modal factory modules. It covers standard modal types, event handling, and the creation of custom modal classes and templates.
tags:
    - moodle-development
    - javascript-modals
    - modal-factory
