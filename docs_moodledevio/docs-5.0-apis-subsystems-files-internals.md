...
url: https://moodledev.io/docs/5.0/apis/subsystems/files/internals
source: sitemap
fetched_at: 2026-02-17T15:27:34.256141-03:00
rendered_js: false
word_count: 1495
summary: This document provides a high-level overview of Moodle's File API, explaining its architecture for storing, serving, and managing content files through a centralized system.
tags:
    - moodle-development
    - file-api
    - file-storage
...
See the [File API](https://moodledev.io/docs/5.0/apis/subsystems/files) documentation for information on using the File API.
...
Details of common operations are documented in the [File System API](https://moodledev.io/docs/5.0/apis/subsystems/files) documentation
...
- links to these files are constructed on the fly from the relative links stored in database (see [Generating a URL to your files](https://moodledev.io/docs/5.0/apis/subsystems/files#generating-a-url-to-your-files) for further information).
...
- The **file picker** is an interface, often accessed using the *file manager*, to select files for upload to Moodle. The file picker makes use of [file repositories](https://moodledev.io/docs/5.0/apis/plugintypes/repository).
...
- [Repository API](https://moodledev.io/docs/5.0/apis/plugintypes/repository)
