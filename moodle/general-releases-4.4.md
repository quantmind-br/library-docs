---
title: Moodle 4.4 | Moodle Developer Resources
url: https://moodledev.io/general/releases/4.4
source: sitemap
fetched_at: 2026-02-17T16:16:33.224431-03:00
rendered_js: false
word_count: 2081
summary: This document provides the release notes and technical specifications for Moodle 4.4.0, including server requirements, database compatibility, and major feature updates.
tags:
...
Here is [the full list of fixed issues in 4.4.0](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%224.4%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
- PHP version: minimum PHP 8.1.0 *Note: minimum PHP version has increased in this Moodle version*. PHP 8.3.x is supported too. See [PHP](https://moodledev.io/general/development/policies/php) for details.
...
DatabaseMinimum versionRecommended[PostgreSQL](http://www.postgresql.org/)13 (last increased in Moodle 4.2)Latest[MySQL](http://www.mysql.com/)8.0 (last increased in Moodle 4.2)Latest[MariaDB](https://mariadb.org/)10.6.7 (last increased in Moodle 4.2)Latest[Microsoft SQL Server](http://www.microsoft.com/en-us/server-cloud/products/sql-server/)2017Latest[Oracle Database](http://www.oracle.com/us/products/database/overview/index.html)19c (increased in this Moodle version)Latest
...
- [MDL-80186](https://moodle.atlassian.net/browse/MDL-80186) - Add delegate section fields to the course\_section table
...
### Messaging phase 2 - Expand Matrix integration & Communication API[​](#messaging-phase-2---expand-matrix-integration--communication-api "Direct link to Messaging phase 2 - Expand Matrix integration & Communication API")
...
### Notification improvements phase 1[​](#notification-improvements-phase-1 "Direct link to Notification improvements phase 1")
...
- [MDL-43820](https://moodle.atlassian.net/browse/MDL-43820) - tool\_uploadcourse supports multiple enrolment instances of the same type
...
- [MDL-79959](https://moodle.atlassian.net/browse/MDL-79959) - Add custom field picker for SSO identification in repository\_equella
...
- [MDL-43056](https://moodle.atlassian.net/browse/MDL-43056) - Add the capability tool/uploadcourse:use for tool\_uploadcourse
...
- [MDL-67898](https://moodle.atlassian.net/browse/MDL-67898) - Have an admin\_setting which exposes a check
...
- [MDL-65403](https://moodle.atlassian.net/browse/MDL-65403) - messaging\_cleanup\_task should use an indexed DB field for improved performance
- [MDL-66546](https://moodle.atlassian.net/browse/MDL-66546) - Add support to unix:// connections to redis caching/sessions.
- [MDL-79337](https://moodle.atlassian.net/browse/MDL-79337) - Unnecessary call to set\_user\_preference when loading a page with an already open drawer in Boost theme
...
- [MDL-81011](https://moodle.atlassian.net/browse/MDL-81011) - Allow hooks to use attributes instead of described\_hook interface
...
- [MDL-80566](https://moodle.atlassian.net/browse/MDL-80566) - Convert callback 'bulk\_user\_actions' to hook
...
- [MDL-75794](https://moodle.atlassian.net/browse/MDL-75794) - Deprecate i\_add\_a\_field\_to\_database\_and\_i\_fill\_the\_form\_with() and i\_add\_an\_entry\_to\_database\_with() behat steps
- [MDL-77038](https://moodle.atlassian.net/browse/MDL-77038) - Deprecate stateactions::section\_move method
- [MDL-67667](https://moodle.atlassian.net/browse/MDL-67667) - Deprecate is\_blocking() for adhoc and scheduled tasks in Task API
- [MDL-81326](https://moodle.atlassian.net/browse/MDL-81326) - Deprecate book\_get\_nav\_classes
- [MDL-72656](https://moodle.atlassian.net/browse/MDL-72656) - Deprecate old course renderer methods
- [MDL-74238](https://moodle.atlassian.net/browse/MDL-74238) - Final deprecation of get\_available\_completion\_tabs() and navigation()
- [MDL-73975](https://moodle.atlassian.net/browse/MDL-73975) - Final deprecation management\_heading/course\_search\_form
- [MDL-73545](https://moodle.atlassian.net/browse/MDL-73545) - Final deprecation lesson\_add\_header\_buttons
- [MDL-73426](https://moodle.atlassian.net/browse/MDL-73426) - Final deprecation print\_badge\_tabs
- [MDL-72376](https://moodle.atlassian.net/browse/MDL-72376) - Final deprecation of book\_get\_nav\_types
- [MDL-73117](https://moodle.atlassian.net/browse/MDL-73117) - Final deprecation of three-month calendar pseudo block items
- [MDL-70483](https://moodle.atlassian.net/browse/MDL-70483) - Final deprecation of get\_forum\_discussions\_paginated web service
- [MDL-80703](https://moodle.atlassian.net/browse/MDL-80703) - Final deprecation of block\_calendar\_upcoming::get\_upcoming\_content()
- [MDL-71950](https://moodle.atlassian.net/browse/MDL-71950) - Final deprecation display\_help\_icon() and print\_help\_icon()
- [MDL-80409](https://moodle.atlassian.net/browse/MDL-80409) - Final deprecation of download\_as\_dataformat method
...
- [MDL-72438](https://moodle.atlassian.net/browse/MDL-72438) - Final deprecations in core\_question initially deprecated in 4.0
...
- [admin/tool/mfa/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dadmin%2Ftool%2Fmfa%2Fupgrade.txt)
- [admin/tool/usertours/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dadmin%2Ftool%2Fusertours%2Fupgrade.txt)
- [admin/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dadmin%2Fupgrade.txt)
- [auth/email/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dauth%2Femail%2Fupgrade.txt)
...
- [blocks/calendar\_upcoming/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dblocks%2Fcalendar_upcoming%2Fupgrade.txt)
- [blocks/recentlyaccesseditems/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dblocks%2Frecentlyaccesseditems%2Fupgrade.txt)
- [blog/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dblog%2Fupgrade.txt)
...
- [mod/book/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dmod%2Fbook%2Fupgrade.txt)
...
- [mod/lesson/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dmod%2Flesson%2Fupgrade.txt)
...
- [mod/url/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dmod%2Furl%2Fupgrade.txt)
...
- [question/type/calculatedmulti/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dquestion%2Ftype%2Fcalculatedmulti%2Fupgrade.txt)
...
- [tag/upgrade.txt](https://git.moodle.org/gw?p=moodle.git%3Ba%3Dblob%3Bf%3Dtag%2Fupgrade.txt)
