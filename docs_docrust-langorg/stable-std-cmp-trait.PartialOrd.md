...
source: crawler
fetched_at: 2026-05-06T21:25:32.761725645-03:00
rendered_js: false
word_count: 1056
summary: This document describes the PartialOrd trait in Rust, which is used for types that define a partial ordering and provides methods for comparison operations.
tags:
    - rust
    - traits
    - comparison
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#1366-1367)
...
The methods of this trait must be consistent with each other and with those of [`PartialEq`](https://doc.rust-lang.org/stable/std/cmp/trait.PartialEq.html "trait std::cmp::PartialEq"). The following conditions must hold:
...
Conditions 2–5 above are ensured by the default implementation. Condition 6 is already ensured by [`PartialEq`](https://doc.rust-lang.org/stable/std/cmp/trait.PartialEq.html "trait std::cmp::PartialEq").

If [`Ord`](https://doc.rust-lang.org/stable/std/cmp/trait.Ord.html "trait std::cmp::Ord") is also implemented for `Self` and `Rhs`, it must also be consistent with `partial_cmp` (see the documentation of that trait for the exact requirements). It’s easy to accidentally make them disagree by deriving some of the traits and manually implementing others.
...
`PartialOrd` only requires implementation of the [`partial_cmp`](https://doc.rust-lang.org/stable/std/cmp/trait.PartialOrd.html#tymethod.partial_cmp "method std::cmp::PartialOrd::partial_cmp") method, with the others generated from default implementations.

However it remains possible to implement the others separately for types which do not have a total order. For example, for floating point numbers, `NaN < 0 == false` and `NaN >= 0 == false` (cf. IEEE 754-2008 section 5.11).

`PartialOrd` requires your type to be [`PartialEq`](https://doc.rust-lang.org/stable/std/cmp/trait.PartialEq.html "trait std::cmp::PartialEq").

If your type is [`Ord`](https://doc.rust-lang.org/stable/std/cmp/trait.Ord.html "trait std::cmp::Ord"), you can implement [`partial_cmp`](https://doc.rust-lang.org/stable/std/cmp/trait.PartialOrd.html#tymethod.partial_cmp "method std::cmp::PartialOrd::partial_cmp") by using [`cmp`](https://doc.rust-lang.org/stable/std/cmp/trait.Ord.html#tymethod.cmp "method std::cmp::Ord::cmp"):
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#1395)
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#1410)
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#1428)
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#1446)
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#1464)
