...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/createAudience
source: crawler
fetched_at: 2026-02-27T23:39:49.841614-03:00
rendered_js: true
word_count: 339
summary: This document provides the technical specification for the Create an Audience API endpoint, detailing the required parameters and response structure for establishing custom and lookalike audiences.
tags:
    - ads-api
    - audience-creation
...
```
curl --request POST \
  --url https://api-partner.spotify.com/ads/v3/ad_accounts/ce4ff15e-f04d-48b9-9ddf-fb3c85fbd57a/audiences \
  --header 'Authorization: Bearer 1POdFZRZbvb...qqillRxMr2z' \
  --header 'Content-Type: application/json' \
  --data '{
    "audience_type": "CUSTOM",
    "name": "US - 18-24 - All gender",
    "description": "For spring promotion campaign",
    "audience_id": "ce4ff15e-f04d-48b9-9ddf-fb3c85fbd57a",
    "dataset_ids": [
