...
Looking for Qualifire Guardrails? Check out the [Qualifire Guardrails Integration](https://docs.litellm.ai/docs/proxy/guardrails/qualifire) for real-time content moderation, prompt injection detection, PII checks, and more.
...
VariableDescription`QUALIFIRE_API_KEY`Your Qualifire API key for authentication`QUALIFIRE_WEBHOOK_URL`The Qualifire webhook endpoint URL from your dashboard
