...
url: https://moodledev.io/docs/4.5/tags/core-form
source: sitemap
fetched_at: 2026-02-17T15:06:41.827772-03:00
rendered_js: false
word_count: 321
summary: This document provides a technical overview of the Moodle Form API, detailing its support for standard and advanced elements, dynamic repeating groups, and specialized UI controllers.
tags:
    - moodle-development
    - forms-api
    - form-elements
