...
url: https://moodledev.io/docs/4.1/apis/core/htmlwriter
source: sitemap
fetched_at: 2026-02-17T14:54:55.060279-03:00
rendered_js: false
word_count: 56
summary: This document explains how to use the Moodle HTML writer class to programmatically generate HTML tags within renderer functions.
tags:
    - moodle
    - php
    - html-writer
...
Please consider using [templates](https://moodledev.io/docs/4.1/guides/templates) as an alternative to the *HTML writer*.
