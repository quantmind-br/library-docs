...
## OIDC Identity Provider (IdP)[​](#oidc-identity-provider-idp "Direct link to OIDC Identity Provider (IdP)")

LiteLLM supports the following OIDC identity providers:

ProviderConfig NameCustom AudiencesGoogle Cloud Run`google`YesCircleCI v1`circleci`NoCircleCI v2`circleci_v2`NoGitHub Actions`github`YesAzure Kubernetes Service`azure`NoAzure AD`azure`YesFile`file`NoEnvironment Variable`env`NoEnvironment Path`env_path`No
...
## OIDC Connect Relying Party (RP)[​](#oidc-connect-relying-party-rp "Direct link to OIDC Connect Relying Party (RP)")
...
### Configuring OIDC[​](#configuring-oidc "Direct link to Configuring OIDC")
...
#### Unofficial Providers (not recommended)[​](#unofficial-providers-not-recommended "Direct link to Unofficial Providers (not recommended)")
...
### Google Cloud Run -&gt; Amazon Bedrock[​](#google-cloud-run---amazon-bedrock "Direct link to Google Cloud Run -> Amazon Bedrock")
...
### CircleCI v2 -&gt; Amazon Bedrock[​](#circleci-v2---amazon-bedrock "Direct link to CircleCI v2 -> Amazon Bedrock")
...
#### Amazon IAM Role Configuration for CircleCI v2 -&gt; Bedrock[​](#amazon-iam-role-configuration-for-circleci-v2---bedrock "Direct link to Amazon IAM Role Configuration for CircleCI v2 -> Bedrock")
...
See [https://docs.aws.amazon.com/bedrock/latest/userguide/security\_iam\_id-based-policy-examples.html](https://docs.aws.amazon.com/bedrock/latest/userguide/security_iam_id-based-policy-examples.html) for more examples.
...
### Google Cloud Run -&gt; Azure OpenAI[​](#google-cloud-run---azure-openai "Direct link to Google Cloud Run -> Azure OpenAI")
