---
title: CHANGELOG
url: https://github.com/badlogic/pi-mono/blob/main/packages/mom/CHANGELOG.md
source: git
fetched_at: 2026-03-03T03:44:29.713129-03:00
rendered_js: false
word_count: 2154
summary: A project changelog for `pi-mono`, documenting version updates, bug fixes, API changes, and new features focusing on user interfaces, session management, and integrations like Slack and OAuth authentication.
tags:
    - crash-fixes
    - workspace-backed
    - auth-storage
