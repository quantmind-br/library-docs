...
source: llms
fetched_at: 2026-04-16T22:33:58.595639919-03:00
rendered_js: false
word_count: 1634
summary: This document explains the various permission modes available for Claude, detailing how they control the balance between automation and user oversight during file edits and command execution.
tags:
    - claude-code
    - permission-modes
    - cli-usage
