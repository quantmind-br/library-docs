...
url: https://moodledev.io/docs/5.1/apis/subsystems/routing/responses
source: sitemap
fetched_at: 2026-02-17T15:37:14.893439-03:00
rendered_js: false
word_count: 315
summary: This document explains how to return data from routes in Moodle 5.1, specifically detailing the use of the payload_response class for web service responses and schema validation.
tags:
    - moodle-development
    - routing-api
    - payload-response
