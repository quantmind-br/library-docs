...
url: https://moodledev.io/docs/5.2/apis/core/hooks
source: sitemap
fetched_at: 2026-02-17T15:43:32.23539-03:00
rendered_js: false
word_count: 1697
summary: This document provides a technical overview of the Moodle Hooks API based on PSR-14, explaining how to create, dispatch, and register callbacks for hooks to customize plugin and core functionality.
tags:
    - moodle-dev
    - hooks-api
    - psr-14
...
From Moodle 4.4 you should make use of the [Dependency Injection](https://moodledev.io/docs/5.2/apis/core/di) system, for example:
...
### Hook Callback Execution Order[​](#hook-callback-execution-order "Direct link to Hook Callback Execution Order")
