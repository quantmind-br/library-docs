...
source: git
fetched_at: 2026-03-03T03:40:40.711559-03:00
rendered_js: false
word_count: 1436
summary: Explains the session file format, structure, and management for Pi coding agent, including how sessions are stored as JSONL files with tree-based branching and versioning.
tags:
    - jsonl-format
