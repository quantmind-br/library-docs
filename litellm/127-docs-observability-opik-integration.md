...
## Opik-Specific Parameters[​](#opik-specific-parameters "Direct link to Opik-Specific Parameters")
...
**Step 1: Save Opik Metadata to the corresponding Api Key** Go to 'Virtual Keys', click on your choosen api key and edit 'Settings'. Now save the opik metadata as user api key metdata.
