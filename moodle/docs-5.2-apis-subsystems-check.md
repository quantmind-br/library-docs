...
url: https://moodledev.io/docs/5.2/apis/subsystems/check
source: sitemap
fetched_at: 2026-02-17T15:45:20.260664-03:00
rendered_js: false
word_count: 1833
summary: This document explains the Moodle Check API used for runtime testing of system configuration, security, performance, and health, including how to implement custom checks in plugins.
tags:
    - moodle
    - check-api
    - runtime-testing
