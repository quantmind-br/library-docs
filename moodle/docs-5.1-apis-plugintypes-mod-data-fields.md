...
url: https://moodledev.io/docs/5.1/apis/plugintypes/mod_data/fields
source: sitemap
fetched_at: 2026-02-17T15:35:16.639996-03:00
rendered_js: false
word_count: 390
summary: This document provides technical instructions for developing custom field types for the Moodle Database activity module, detailing file structures and class methods.
tags:
    - moodle-development
    - database-module
    - field-types
...
The [Database activity](https://docs.moodle.org/en/Database_module) included with Moodle includes support for several predefined [field types](https://moodledev.io/docs/5.1/apis/plugintypes/mod_data/fields), including text, date, and URL. It is also possible to create new field types. For example, you might like to create:
...
Some of the important files for the database field plugintype are described below. See the [common plugin files](https://moodledev.io/docs/5.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
