...
url: https://moodledev.io/docs/4.4/apis/plugintypes/communication
source: sitemap
fetched_at: 2026-02-17T15:02:57.132107-03:00
rendered_js: false
word_count: 881
summary: This document explains how to develop communication provider plugins for Moodle, detailing the necessary file structure and the implementation of specific PHP interfaces for room and user management.
tags:
    - moodle-development
    - communication-api
    - plugin-architecture
...
Some important files are described below. See the [common plugin files](https://moodledev.io/docs/4.4/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
