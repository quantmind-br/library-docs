...
url: https://moodledev.io/docs/5.0/guides/profiling
source: sitemap
fetched_at: 2026-02-17T15:28:53.644338-03:00
rendered_js: false
word_count: 1027
summary: This document explains how to configure and use XHProf and XDebug profilers within Moodle to monitor and analyze PHP performance. It covers installation, Moodle-specific settings, and methods for capturing profile traces in both production and development environments.
tags:
    - php-profiling
    - xhprof
    - xdebug
