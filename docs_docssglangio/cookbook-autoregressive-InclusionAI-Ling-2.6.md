---
title: Ling-2.6 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/InclusionAI/Ling-2.6
source: sitemap
fetched_at: 2026-05-11T05:50:42.118000204-03:00
rendered_js: false
word_count: 888
summary: This document provides technical instructions for deploying and running the Ling-2.6 AI model family using the SGLang inference framework, including configuration parameters for multi-node setups and reasoning modes.
tags:
    - sglang
    - ling-2-6
    - model-deployment
...
H20-3e ×4H100 ×4H200 ×4B200 ×4

Context Length

256K (YaRN ×2)128K (default)
...
GB300 ×4 (1 node)GB200 ×4 (1 node)H200 ×8 (2 nodes)B200 ×8 (2 nodes)
...
`enable_thinking` here is consumed by the SGLang reasoning parser, **not** by the chat template — Ling-2.6’s template ignores it. For the simplest configuration, just omit `--reasoning-parser qwen3` and toggle thinking via the system message. For more API examples, see the [SGLang Basic Usage Guide](https://docs.sglang.io/docs/basic_usage/send_request).
