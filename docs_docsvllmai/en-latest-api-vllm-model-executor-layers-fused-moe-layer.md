---
title: layer - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/layers/fused_moe/layer/
source: sitemap
fetched_at: 2026-05-07T21:24:59.581984514-03:00
rendered_js: false
word_count: 31
summary: This document defines the FusedMoE layer, a specialized neural network component designed for Mixture-of-Experts (MoE) models that integrates parallelized weight operations and expert routing configurations.
tags:
    - mixture-of-experts
...
"""FusedMoE layer for MoE models.
    ...
    def__init__(
        ...
        def_get_quant_method() -> FusedMoEMethodBase:
"""
    ...
    def_replace_quant_method(self, mk: FusedMoEMethodBase):
    ...
    defmaybe_init_modular_kernel(self) -> None:
    ...
    def_maybe_init_expert_routing_tables(
        self,
    ...
    @staticmethod
    defensure_round_robin_expert_routing_tables(
    ...
    def_load_per_tensor_weight_scale(
        self,
        shard_id: str,
    ...
    def_load_combined_w13_weight_scale(
        self,
        shard_dim: int,
        loaded_weight: torch.Tensor,
        param: torch.Tensor,
...
"""
    ...
    def_load_model_weight_or_group_weight_scale(
        self,
        shard_dim: int,
...
"""
    ...
    def_load_per_channel_weight_scale(
        self,
        expert_data: torch.Tensor,
        shard_dim: int,
        shard_id: str,
    ...
    @staticmethod
    def_get_hidden_dim(shard_dim: int, ndim: int) -> int:
"""Compute the hidden dimension index from the shard (intermediate)
    ...
    @staticmethod
    def_narrow_expert_data_for_padding(
        expert_data: torch.Tensor,
        loaded_weight: torch.Tensor,
        hidden_dim: int,
...
"""Narrow expert_data to match loaded_weight for padded dimensions.
    ...
    def_map_global_expert_id_to_local_expert_id(self, expert_id: int) -> int:
        if self._expert_map is None:
            return expert_id
        return self._expert_map[expert_id].item()

    def_init_aiter_shared_experts_topK_buffer(
    ...
    defget_expert_weights(self) -> Iterable[torch.Tensor]:
        def_maybe_make_contiguous(
...
"""
    ...
    defensure_moe_quant_config_init(self):
    ...
    @property
    defmoe_quant_config(self) -> FusedMoEQuantConfig | None:
        self.ensure_moe_quant_config_init()
    ...
    @property
    defintermediate_size_per_partition(self) -> int:
