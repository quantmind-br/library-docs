---
title: Plugin with third party libraries | Moodle Developer Resources
url: https://moodledev.io/general/community/plugincontribution/thirdpartylibraries
source: sitemap
fetched_at: 2026-02-17T15:58:05.440666-03:00
rendered_js: false
word_count: 425
summary: This document outlines the standard process and requirements for incorporating third-party libraries into Moodle plugins, including licensing checks and necessary documentation files.
tags:
    - moodle-development
...
6. Create or update the `thirdpartylibs.xml` file for your plugin, according to the format described in the [documentation](https://moodledev.io/docs/5.2/apis/commonfiles#thirdpartylibsxml).
7. Create a [`readme_moodle.txt`](https://moodledev.io/docs/5.2/apis/commonfiles#readme_moodletxt) file in the new third party library folder containing detailed instructions on how to complete steps 3-6 above. This should list download urls, build instructions etc.
8. Note any creation, update or deletion of third party libraries in your plugins `upgrade.txt` or [CHANGES](https://moodledev.io/docs/5.2/apis/commonfiles#changes).
9. Run `grunt ignorefiles` to regenerate ignored files path

## Exceptions:[​](#exceptions "Direct link to Exceptions:")

### JavaScript AMD modules[​](#javascript-amd-modules "Direct link to JavaScript AMD modules")

JavaScript AMD modules cannot exist in a sub-folder - they must exist in a single .js file in the amd/src folder for your plugin. So - the process for AMD files is the same as above, except that the license and readme\_moodle.txt file contents must be added as a JavaScript comment to the top of the libraries .js file.

## See also[​](#see-also "Direct link to See also")

- [Grunt](https://moodledev.io/general/development/tools/nodejs#grunt) - Information for installing and using Grunt
