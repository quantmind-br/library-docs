...
url: https://doc.rust-lang.org/src/std/ascii.rs.html#193
source: crawler
fetched_at: 2026-05-06T21:29:14.632799156-03:00
rendered_js: false
word_count: 1013
summary: This document defines the AsciiExt trait, which provides methods for performing ASCII-specific case transformations and character checks on Rust strings and bytes.
tags:
    - rust
    - ascii
    - string-manipulation
