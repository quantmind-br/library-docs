---
title: Profiling PHP | Moodle Developer Resources
url: https://moodledev.io/docs/4.4/guides/profiling
source: sitemap
fetched_at: 2026-02-17T15:05:38.010851-03:00
rendered_js: false
word_count: 1027
summary: This document explains how to set up and use XHProf and XDebug profilers to analyze PHP performance within a Moodle environment. It provides instructions on extension installation, Moodle-specific configuration, and methods for capturing and interpreting profiling data.
tags:
    - php
    - moodle
    - profiling
...
### XHProf Extension[​](#xhprof-extension "Direct link to XHProf Extension")
...
### Export Xhprof data to plugins[​](#export-xhprof-data-to-plugins "Direct link to Export Xhprof data to plugins")
...
### Configuration within Moodle[​](#configuration-within-moodle "Direct link to Configuration within Moodle")
...
To enable profiling you must ensure that the *Enable profiling* setting is enabled. We recommend specifying one, or more, paths to profile. Paths should be specified relative to your Moodle directory, and not the web root.
...
- [http://tjhunt.blogspot.co.uk/2013/05/performance-testing-moodle.html](http://tjhunt.blogspot.co.uk/2013/05/performance-testing-moodle.html)
- [https://docs.google.com/presentation/d/1MV4R71UBgPgzM6I9h\_yDnYcxIJlgCoLBUDtJJr-TzNI/present#slide=id.i0](https://docs.google.com/presentation/d/1MV4R71UBgPgzM6I9h_yDnYcxIJlgCoLBUDtJJr-TzNI/present#slide=id.i0) presentation about using XHProf

## Xdebug[​](#xdebug "Direct link to Xdebug")
...
### Installing Xdebug extension[​](#installing-xdebug-extension "Direct link to Installing Xdebug extension")
...
### Configuring the Xdebug Profiler[​](#configuring-the-xdebug-profiler "Direct link to Configuring the Xdebug Profiler")
...
It can also be enabled for specific pages by watching for a [*trigger*](https://xdebug.org/docs/all_settings#start_with_request%23trigger)..
...
Profiling POST and AJAX requests
...
### Analyzing Xdebug profiling files[​](#analyzing-xdebug-profiling-files "Direct link to Analyzing Xdebug profiling files")
...
- [Forum thread about profiling Moodle 2.0](http://moodle.org/mod/forum/discuss.php?d=162045) XHProf articles:
...
- [XHProf – Profiling and Reporting](http://www.open.ac.uk/blogs/XHProf/?page_id=46) from Moodle perspective written by [James Brisland](http://moodle.org/user/view.php?id=264538&course=5) Xdebug articles:
