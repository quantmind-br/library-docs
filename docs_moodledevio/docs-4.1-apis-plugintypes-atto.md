...
url: https://moodledev.io/docs/4.1/apis/plugintypes/atto
source: sitemap
fetched_at: 2026-02-17T14:55:11.122236-03:00
rendered_js: false
word_count: 0
summary: This document provides a boilerplate implementation for creating a custom button in the Moodle Atto text editor using the YUI framework. It demonstrates how to initialize the button, define keyboard shortcuts, and manage plugin attributes.
tags:
    - moodle
    - atto-editor
    - javascript-plugin
