...
url: https://hyprland-community.github.io/pyprland/versions/2.4.7/wallpapers
source: github_pages
fetched_at: 2026-01-31T16:00:39.972915487-03:00
rendered_js: false
word_count: 291
summary: Configurable wallpaper manager that randomly cycles through images in specified folders with support for multiple display outputs and custom commands.
tags:
    - wallpaper-manager
    - background-image
    - random-selection
...
[variables](https://hyprland-community.github.io/pyprland/versions/2.4.7/Variables.html) are replaced with the appropriate values, you must use a `"[file]"` placeholder for the image path. eg:
