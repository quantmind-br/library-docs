...
url: https://moodledev.io/docs/5.0/apis/subsystems/external
source: sitemap
fetched_at: 2026-02-17T15:27:15.148756-03:00
rendered_js: false
word_count: 252
summary: This document provides an overview of Moodle's Web Service framework and External API, outlining its internal uses and providing resources for creating and implementing custom web services.
tags:
    - moodle-development
    - web-services
    - external-api
...
In addition to the standard API endpoints, several additional API endpoints are available for the purpose of uploading, and downloading, files. For more information on these endpoints, see the [file handling](https://moodledev.io/docs/5.0/apis/subsystems/external/files) documentation.
...
- [Adding a web service to your plugin](https://moodledev.io/docs/5.0/apis/subsystems/external/writing-a-service)
...
- [Web services files handling](https://moodledev.io/docs/5.0/apis/subsystems/external/files)
