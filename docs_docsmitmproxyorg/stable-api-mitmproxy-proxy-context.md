...
source: crawler
fetched_at: 2026-01-28T16:18:40.267203854-03:00
rendered_js: false
word_count: 412
summary: This document defines the `Context` object used within the mitmproxy core, detailing its attributes like client and server connections, options, and protocol layers, along with its initialization and utility methods.
tags:
    - mitmproxy
    - proxy-core
    - context-object
