...
url: https://moodledev.io/docs/4.5/apis/subsystems/admin
source: sitemap
fetched_at: 2026-02-17T15:13:06.86623-03:00
rendered_js: false
word_count: 1791
summary: This document explains the internal architecture of Moodle's administration settings system, detailing how the object-oriented settings tree is constructed and how plugins register custom configuration options.
tags:
    - moodle-development
    - admin-settings
    - php-programming
...
- [configuration for filter](https://moodledev.io/docs/4.5/apis/plugintypes/filter)
