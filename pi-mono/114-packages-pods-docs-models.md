---
title: Models
url: https://github.com/badlogic/pi-mono/blob/main/packages/pods/docs/models.md
source: git
fetched_at: 2026-03-03T03:46:11.585834-03:00
rendered_js: false
word_count: 622
summary: Provides optimization guidelines for deploying Qwen-Coder, GPT-OSS, GLM-4.5, and Kimi models with vLLM on diverse GPU hardware configurations, including tensor-parallel, data-parallel, and hybrid modes for scalability and performance.
tags:
    - gpu-configurations
    - llm-optimization
    - model-deployment
