...
url: https://moodledev.io/docs/4.4/apis/core/deprecation
source: sitemap
fetched_at: 2026-02-17T15:02:10.112078-03:00
rendered_js: false
word_count: 0
summary: This document demonstrates how to use the core deprecation attribute in PHP to mark functions, classes, methods, and enum cases as deprecated. It highlights how to provide metadata such as replacement suggestions, versioning, and reasoning for the deprecation.
tags:
    - php
    - deprecation
    - attributes
