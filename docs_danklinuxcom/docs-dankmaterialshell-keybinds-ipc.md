...
source: sitemap
fetched_at: 2026-01-24T13:33:45.265052658-03:00
rendered_js: false
word_count: 1490
summary: This document provides a technical reference for the Inter-Process Communication (IPC) interface of DankMaterialShell, detailing command-line instructions for controlling system audio, display settings, UI components, and media playback.
tags:
    - ipc-commands
    - shell-control
