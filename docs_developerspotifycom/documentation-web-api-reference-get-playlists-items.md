...
source: crawler
fetched_at: 2026-02-27T23:38:54.509381-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response for a Spotify API request, demonstrating the structure of paginated results containing track and album metadata.
tags:
    - spotify-api
    - json-response
    - pagination
