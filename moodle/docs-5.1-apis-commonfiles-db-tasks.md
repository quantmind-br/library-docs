...
url: https://moodledev.io/docs/5.1/apis/commonfiles/db-tasks.php
source: sitemap
fetched_at: 2026-02-17T15:33:51.962417-03:00
rendered_js: false
word_count: 318
summary: This document explains how to set up and configure scheduled tasks in a plugin using the db/tasks.php file and specific class inheritance. It details the available configuration properties, including scheduling syntax, blocking behavior, and initial state.
tags:
    - moodle-development
    - scheduled-tasks
    - php
