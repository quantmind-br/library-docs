...
source: llms
fetched_at: 2026-01-24T14:41:20.013462607-03:00
rendered_js: false
word_count: 355
summary: This document explains how to manage and rotate Docker Swarm join tokens to securely add worker and manager nodes to a cluster.
tags:
    - docker-swarm
    - swarm-mode
    - join-token
...
DescriptionManage join tokensUsage`docker swarm join-token [OPTIONS] (worker|manager)`
...
OptionDefaultDescription[`-q, --quiet`](#quiet)Only display token[`--rotate`](#rotate)Rotate join token
