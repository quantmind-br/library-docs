---
title: raw.rs - source
url: https://doc.rust-lang.org/stable/src/std/os/fd/raw.rs.html#197-202
source: crawler
fetched_at: 2026-05-06T21:31:15.859906897-03:00
rendered_js: false
word_count: 1368
summary: This document defines traits and types for interacting with raw Unix-style file descriptors in Rust, enabling borrowing, consuming, and converting file descriptors between platform-specific objects.
tags:
    - rust
    - unix
    - file-descriptor
