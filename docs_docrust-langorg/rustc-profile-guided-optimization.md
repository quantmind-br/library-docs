---
title: guided Optimization - The rustc book
url: https://doc.rust-lang.org/rustc/profile-guided-optimization.html
source: crawler
fetched_at: 2026-05-06T21:24:59.267393827-03:00
rendered_js: false
word_count: 940
summary: This document explains how to perform profile-guided optimization (PGO) in Rust, detailing the multi-step process of instrumenting binaries, collecting execution data, and recompiling with the generated profiles.
tags:
    - rustc
    - pgo
    - optimization
...
## [What Is Profile-Guided Optimization?](#what-is-profile-guided-optimization)
...
As an alternative to directly using the compiler for Profile-Guided Optimization, you may choose to go with `cargo-pgo`, which has an intuitive command-line API and saves you the trouble of doing all the manual work. You can read more about it in [cargo-pgo repository](https://github.com/Kobzol/cargo-pgo).
