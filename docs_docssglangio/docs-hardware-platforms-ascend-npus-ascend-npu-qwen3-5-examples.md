---
title: Qwen3.5 examples - SGLang Documentation
url: https://docs.sglang.io/docs/hardware-platforms/ascend-npus/ascend_npu_qwen3_5_examples
source: sitemap
fetched_at: 2026-05-11T05:48:39.901294254-03:00
rendered_js: false
word_count: 83
summary: This document provides instructions for setting up and deploying the SGLang inference server on Ascend NPU hardware using Docker containers and specific environment configurations.
tags:
    - npu
    - ascend
    - sglang
