...
source: sitemap
fetched_at: 2026-04-17T06:49:56.912043601-03:00
rendered_js: false
word_count: 627
summary: This document explains how to configure permissions within OpenCode to control automatic execution, user prompts, or blocked actions for various tools and agents.
tags:
    - opencode-config
    - permission-rules
    - automation-control
