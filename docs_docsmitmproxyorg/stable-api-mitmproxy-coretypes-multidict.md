...
source: crawler
fetched_at: 2026-01-28T14:58:31.780866431-03:00
rendered_js: false
word_count: 1942
summary: A module within the mitmproxy library that provides a specialized multi-dictionary data structure for handling key-value pairs with multiple values, typically used for HTTP headers and query parameters.
tags:
    - mitmproxy
    - python
    - multidict
