---
title: nvfp4 - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/kernels/linear/nvfp4/
source: sitemap
fetched_at: 2026-05-07T21:23:35.139269301-03:00
rendered_js: false
word_count: 225
summary: This document defines the base class and configuration structure for NVFP4 quantized linear kernels, providing an interface for hardware-specific GEMM backend implementations.
tags:
    - nvfp4
    - quantization
    - linear-kernel
...
Name Description `base` `cutlass` `emulation` `fbgemm` `flashinfer` `marlin`

## NvFp4LinearKernel [¶](#vllm.model_executor.kernels.linear.nvfp4.NvFp4LinearKernel "Permanent link")
...
### apply\_weights `abstractmethod` [¶](#vllm.model_executor.kernels.linear.nvfp4.NvFp4LinearKernel.apply_weights "Permanent link")
...
### can\_implement `abstractmethod` `classmethod` [¶](#vllm.model_executor.kernels.linear.nvfp4.NvFp4LinearKernel.can_implement "Permanent link")
...
### is\_supported `abstractmethod` `classmethod` [¶](#vllm.model_executor.kernels.linear.nvfp4.NvFp4LinearKernel.is_supported "Permanent link")
...
### process\_weights\_after\_loading `abstractmethod` [¶](#vllm.model_executor.kernels.linear.nvfp4.NvFp4LinearKernel.process_weights_after_loading "Permanent link")
...
## NvFp4LinearLayerConfig `dataclass` [¶](#vllm.model_executor.kernels.linear.nvfp4.NvFp4LinearLayerConfig "Permanent link")
