...
url: https://moodledev.io/docs/5.1/apis/subsystems/external/writing-a-service
source: sitemap
fetched_at: 2026-02-17T15:36:28.596486-03:00
rendered_js: false
word_count: 1036
summary: This document explains how to create and define a new web service function for a Moodle plugin, including naming conventions, configuration, and implementation of external functions.
tags:
    - moodle-development
    - web-services
    - external-functions
...
- [External services security](https://moodledev.io/docs/5.1/apis/subsystems/external/security)
- [External services description](https://moodledev.io/docs/5.1/apis/subsystems/external/description)
