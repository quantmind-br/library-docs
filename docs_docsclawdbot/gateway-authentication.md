---
title: "null"
url: https://docs.clawd.bot/gateway/authentication.md
source: llms
fetched_at: 2026-01-26T09:51:46.898566244-03:00
rendered_js: false
word_count: 511
summary: This document provides instructions for setting up and managing authentication credentials for Clawdbot, specifically detailing Anthropic API key configuration and Claude Code CLI integration.
tags:
    - authentication
    - anthropic
    - api-keys
