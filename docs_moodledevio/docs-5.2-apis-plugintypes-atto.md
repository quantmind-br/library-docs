...
url: https://moodledev.io/docs/5.2/apis/plugintypes/atto
source: sitemap
fetched_at: 2026-02-17T15:44:02.070507-03:00
rendered_js: false
word_count: 0
summary: This document provides a JavaScript template and example for creating custom buttons within the Moodle Atto text editor using the YUI framework.
tags:
    - moodle
    - atto-editor
    - javascript
