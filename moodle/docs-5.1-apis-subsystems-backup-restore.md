---
title: Restore API | Moodle Developer Resources
url: https://moodledev.io/docs/5.1/apis/subsystems/backup/restore
source: sitemap
fetched_at: 2026-02-17T15:36:09.392736-03:00
rendered_js: false
word_count: 296
summary: This document explains how to implement the Moodle Restore API to allow plugins to recover data from backup files. It covers the architecture of restore plans, tasks, and steps, along with the required file structure and class definitions for plugin developers.
tags:
    - moodle-api
    - restore-api
    - plugin-development
...
The Restore API provides a way to restore your plugin's data from a backup file created in Moodle 2.0 or later. For the information on how backup files are created, see [Backup API](https://moodledev.io/docs/5.1/apis/subsystems/backup). For the information on how to support restoring data from backup files created in Moodle 1.x, see [Backup conversion API](https://docs.moodle.org/dev/Backup_conversion_API).
...
classrestore_tool_foobar_pluginextendsrestore_tool_plugin{
