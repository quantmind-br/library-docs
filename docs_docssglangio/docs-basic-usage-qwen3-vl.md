---
title: Qwen3-VL Usage - SGLang Documentation
url: https://docs.sglang.io/docs/basic_usage/qwen3_vl
source: sitemap
fetched_at: 2026-05-11T05:48:58.159703612-03:00
rendered_js: false
word_count: 316
summary: This document provides instructions for deploying and configuring the Qwen3-VL multimodal model within the SGLang framework, including server launch commands, hardware-specific optimization tips, and multimodal request handling.
tags:
    - sglang
    - multimodal
    - qwen3-vl
