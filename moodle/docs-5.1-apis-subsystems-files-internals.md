...
url: https://moodledev.io/docs/5.1/apis/subsystems/files/internals
source: sitemap
fetched_at: 2026-02-17T15:36:37.175446-03:00
rendered_js: false
word_count: 1495
summary: This document explains the architecture and core components of Moodle's File API, detailing how files are stored, managed via metadata, and served to users through various interfaces.
tags:
    - moodle-file-api
    - file-storage
    - file-serving
...
See the [File API](https://moodledev.io/docs/5.1/apis/subsystems/files) documentation for information on using the File API.
...
Details of common operations are documented in the [File System API](https://moodledev.io/docs/5.1/apis/subsystems/files) documentation
...
- links to these files are constructed on the fly from the relative links stored in database (see [Generating a URL to your files](https://moodledev.io/docs/5.1/apis/subsystems/files#generating-a-url-to-your-files) for further information).
...
- The **file picker** is an interface, often accessed using the *file manager*, to select files for upload to Moodle. The file picker makes use of [file repositories](https://moodledev.io/docs/5.1/apis/plugintypes/repository).
...
- [Repository API](https://moodledev.io/docs/5.1/apis/plugintypes/repository)
