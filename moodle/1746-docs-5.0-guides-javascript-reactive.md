...
url: https://moodledev.io/docs/5.0/guides/javascript/reactive
source: sitemap
fetched_at: 2026-02-17T15:28:46.018934-03:00
rendered_js: false
word_count: 5759
summary: This document introduces Moodle's internal reactive library for building dynamic user interfaces, explaining the core architecture of components, state management, and mutations. It provides instructions on how to implement reactive patterns in Moodle plugins by extending the BaseComponent class.
tags:
    - moodle-development
    - reactive-ui
