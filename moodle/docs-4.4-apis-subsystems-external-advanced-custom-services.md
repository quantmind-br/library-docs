...
url: https://moodledev.io/docs/4.4/apis/subsystems/external/advanced/custom-services
source: sitemap
fetched_at: 2026-02-17T15:04:05.569888-03:00
rendered_js: false
word_count: 126
summary: This document defines the structure for configuring external services in Moodle, specifying settings for functions, capabilities, and file handling permissions.
tags:
    - moodle
    - external-services
    - php-configuration
