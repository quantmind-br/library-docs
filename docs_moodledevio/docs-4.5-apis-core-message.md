---
title: Message API | Moodle Developer Resources
url: https://moodledev.io/docs/4.5/apis/core/message
source: sitemap
fetched_at: 2026-02-17T15:11:26.481127-03:00
rendered_js: false
word_count: 811
summary: This document provides technical instructions for using the Moodle Messaging API to programmatically send notifications and messages from plugins or blocks. It details how to register message producers, configure notification defaults, and implement the message_send function.
tags:
    - moodle-development
    - messaging-api
    - php-api
...
## What is this document?[​](#what-is-this-document "Direct link to What is this document?")
...
## Message pop-up[​](#message-pop-up "Direct link to Message pop-up")
...
### How to register as a message producer[​](#how-to-register-as-a-message-producer "Direct link to How to register as a message producer")
...
### How to send a message[​](#how-to-send-a-message "Direct link to How to send a message")
...
### How to set-up the message pop-up[​](#how-to-set-up-the-message-pop-up "Direct link to How to set-up the message pop-up")
...
$url=newmoodle_url('message/index.php',['id'=>$userto->id]);
$attributes=message_messenger_sendmessage_link_params($userto);
echohtml_writer::link($url,'Send a message',$attributes);
```

## Changes in Moodle 3.5[​](#changes-in-moodle-35 "Direct link to Changes in Moodle 3.5")
...
LEFTJOIN mdl_message_user_actions act ON act.userid = mem.userid AND act.messageid = m.id
ORDERBY m.timecreated, m.id, mem.userid, act.id
```