...
url: https://moodledev.io/docs/4.5/apis/plugintypes/communication
source: sitemap
fetched_at: 2026-02-17T15:11:57.353281-03:00
rendered_js: false
word_count: 881
summary: Explains how to develop and implement communication provider plugins, detailing the required file structure and the PHP interfaces used to manage communication rooms and user synchronization.
tags:
    - plugin-development
    - communication-api
    - php-interfaces
...
Some important files are described below. See the [common plugin files](https://moodledev.io/docs/4.5/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
