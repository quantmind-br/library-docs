...
source: sitemap
fetched_at: 2026-01-22T22:16:08.144657498-03:00
rendered_js: false
word_count: 671
summary: This document explains how to use the hyprctl utility to control the Hyprland compositor via the command line or scripts, covering command dispatching, configuration reloading, and system information retrieval.
tags:
    - hyprland
    - hyprctl
    - wayland
