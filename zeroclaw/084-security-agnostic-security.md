...
url: https://github.com/openagen/zeroclaw/blob/master/docs/security/agnostic-security.md
source: git
fetched_at: 2026-05-02T14:52:06.647559516-03:00
rendered_js: false
word_count: 636
optimized: true
...
Security features in ZeroClaw are implemented as optional feature flags with platform-specific conditional compilation. This ensures zero overhead when disabled and maintains cross-platform compatibility across ARM, x86, RISC-V, and small hardware (<5MB RAM).
...
| **Audit logging** | None (hmac/sha2 already present) | All platforms |
```
