---
title: GLM-4.7 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/GLM/GLM-4.7
source: sitemap
fetched_at: 2026-05-11T05:50:49.922078572-03:00
rendered_js: false
word_count: 823
summary: This document provides instructions for deploying and utilizing the GLM-4.7 language model within the SGLang framework, covering installation, server configuration, and advanced features like reasoning parsing and tool calling.
tags:
    - sglang
    - glm-4
    - llm-deployment
...
[GLM-4.7](https://huggingface.co/zai-org/GLM-4.7) is the latest and most powerful language model in the GLM series developed by Zhipu AI, featuring state-of-the-art capabilities in reasoning, function calling, and multi-modal understanding. As the newest iteration in the GLM series, GLM-4.7 achieves significant improvements across all domains:
...
For more details, please refer to the [official GLM-4.7 documentation](https://docs.z.ai/guides/llm/glm-4.7). **Key Features:**
...
**License:** Please refer to the [official GLM-4.7 model card](https://huggingface.co/zai-org/GLM-4.7) for license details.
...
For more detailed configuration tips, please refer to [GLM-4.7 Usage](https://docs.sglang.io/docs/basic_usage/glm45).
