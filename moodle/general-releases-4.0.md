---
title: Moodle 4.0 | Moodle Developer Resources
url: https://moodledev.io/general/releases/4.0
source: sitemap
fetched_at: 2026-02-17T16:14:39.127238-03:00
rendered_js: false
word_count: 2788
summary: This document outlines the release notes and technical requirements for Moodle 4.0.0, including server, database, and browser compatibility standards. It also details significant user experience enhancements and navigation improvements introduced in this version.
tags:
    - moodle-release
    - system-requirements
...
Here is [the full list of fixed issues in 4.0.0](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%224.0%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
### Navigation improvements[​](#navigation-improvements "Direct link to Navigation improvements")
...
- [MDL-72005](https://moodle.atlassian.net/browse/MDL-72005) - Update the context\_header in Boost to move the breadcrumb to the top

### Course index[​](#course-index "Direct link to Course index")
...
### Course experience[​](#course-experience "Direct link to Course experience")
...
- [MDL-71863](https://moodle.atlassian.net/browse/MDL-71863) - Created core\_courseformat subsystem
...
### My Courses page and overview block[​](#my-courses-page-and-overview-block "Direct link to My Courses page and overview block")
...
### Timeline block[​](#timeline-block "Direct link to Timeline block")
...
### Calendar usability[​](#calendar-usability "Direct link to Calendar usability")
...
### User tours[​](#user-tours "Direct link to User tours")
...
### Report builder integration (from Moodle Workplace)[​](#report-builder-integration-from-moodle-workplace "Direct link to Report builder integration (from Moodle Workplace)")
...
### BigBlueButton integration[​](#bigbluebutton-integration "Direct link to BigBlueButton integration")
...
- [MDL-71679](https://moodle.atlassian.net/browse/MDL-71679) - Update mod\_quiz for new question bank
...
- [MDL-71984](https://moodle.atlassian.net/browse/MDL-71984) - Add logging to quiz auto-save, process\_attempt and redo\_question
...
- [MDL-72448](https://moodle.atlassian.net/browse/MDL-72448) - Add qbank\_history to core
- [MDL-71614](https://moodle.atlassian.net/browse/MDL-71614) - Add qbank\_previewquestion to core

### Update LTI tool provider feature to support 1.3[​](#update-lti-tool-provider-feature-to-support-13 "Direct link to Update LTI tool provider feature to support 1.3")
...
### Admin configuration presets[​](#admin-configuration-presets "Direct link to Admin configuration presets")

- [MDL-72112](https://moodle.atlassian.net/browse/MDL-72112) - Integrate admin\_presets third-party plugin in Moodle LMS
...
- [MDL-68394](https://moodle.atlassian.net/browse/MDL-68394) - Integrate mod\_h5pactivity with recent activity plugins
- [MDL-72099](https://moodle.atlassian.net/browse/MDL-72099) - Add navigation by contexts in the content bank
- [MDL-71885](https://moodle.atlassian.net/browse/MDL-71885) - Inline editing H5P content for mod\_h5pactivity
...
- [MDL-72896](https://moodle.atlassian.net/browse/MDL-72896) - Make html\_tables responsive by default
...
- [MDL-72031](https://moodle.atlassian.net/browse/MDL-72031) - Separate out max\_time for audio and video files in Atto/RecordRTC
...
- [MDL-67822](https://moodle.atlassian.net/browse/MDL-67822) - New check\_database\_schema performance check
...
- [MDL-68164](https://moodle.atlassian.net/browse/MDL-68164) - Additional caching of pg\_field\_type postgres field metadata
...
- [MDL-67228](https://moodle.atlassian.net/browse/MDL-67228) - Tool\_replace maturity set

### Web service additions and updates[​](#web-service-additions-and-updates "Direct link to Web service additions and updates")

- [MDL-71135](https://moodle.atlassian.net/browse/MDL-71135) - Create core\_course\_get\_state web service
- [MDL-71165](https://moodle.atlassian.net/browse/MDL-71165) - Create core\_course\_update\_course web service
...
- [MDL-72335](https://moodle.atlassian.net/browse/MDL-72335) - Tool\_health removed from core
...
- [MDL-72348](https://moodle.atlassian.net/browse/MDL-72348) - Microsoft OneDrive (legacy) repository (repository\_skydrive) removed from core
- [MDL-72347](https://moodle.atlassian.net/browse/MDL-72347) - Word censorship filter (filter\_censor) removed from core
...
- [MDL-73756](https://moodle.atlassian.net/browse/MDL-73756) - Deprecate $modinfo param to completion\_info::get\_data()
...
- [MDL-72098](https://moodle.atlassian.net/browse/MDL-72098) - deprecate grade\_grade::insert method that just calls its parent
- [MDL-72433](https://moodle.atlassian.net/browse/MDL-72433) - Final deprecation of get\_grades() in lib/classes/grades\_external.php
- [MDL-71476](https://moodle.atlassian.net/browse/MDL-71476) - Remove mysql\_engine.php
- [MDL-65252](https://moodle.atlassian.net/browse/MDL-65252) - Final deprecations of forum\_count\_replies and get\_forum\_discussion\_posts
...
- backup/upgrade.txt
- badges/upgrade.txt
- blocks/section\_links/upgrade.txt
- blocks/tag\_youtube/upgrade.txt
