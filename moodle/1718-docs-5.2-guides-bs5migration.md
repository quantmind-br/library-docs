...
url: https://moodledev.io/docs/5.2/guides/bs5migration
source: sitemap
fetched_at: 2026-02-17T15:46:47.842612-03:00
rendered_js: false
word_count: 1726
summary: This document outlines the phased migration process from Bootstrap 4 to Bootstrap 5, providing instructions for refactoring deprecated features and implementing a compatibility bridge.
tags:
    - bootstrap-migration
    - moodle-development
    - scss-refactoring
