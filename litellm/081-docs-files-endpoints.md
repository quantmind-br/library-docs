...
## Multi-Account Support (Multiple OpenAI Keys)[​](#multi-account-support-multiple-openai-keys "Direct link to Multi-Account Support (Multiple OpenAI Keys)")
...
### Parameter Options[​](#parameter-options "Direct link to Parameter Options")
...
### How Encoded IDs Work[​](#how-encoded-ids-work "Direct link to How Encoded IDs Work")
...
### Migration from files\_settings[​](#migration-from-files_settings "Direct link to Migration from files_settings")
...
### [Bedrock](https://docs.litellm.ai/docs/providers/bedrock_batches#4-retrieve-batch-results)[​](#bedrock "Direct link to bedrock")

## [Swagger API Reference](https://litellm-api.up.railway.app/#/files)[​](#swagger-api-reference "Direct link to swagger-api-reference")