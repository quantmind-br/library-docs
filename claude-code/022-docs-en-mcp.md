...
source: llms
fetched_at: 2026-04-16T22:33:21.515256559-03:00
rendered_js: false
word_count: 4949
summary: This document explains how to connect Claude Code to external tools using the Model Context Protocol (MCP) via an automated registry-fetching mechanism. It provides technical details on fetching server metadata, handling transport types like HTTP, SSE, and stdio, and generating CLI commands for tool integration.
tags:
    - mcp
    - claude-code
    - react
