...
source: crawler
fetched_at: 2026-02-27T23:38:20.253679-03:00
rendered_js: true
word_count: 2
summary: Provides a sample JSON structure representing music album metadata and associated track information for an API response.
tags:
    - api-response
    - json-structure
    - music-metadata
