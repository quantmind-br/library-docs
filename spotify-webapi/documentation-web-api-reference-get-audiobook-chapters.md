...
source: crawler
fetched_at: 2026-02-27T23:46:12.956953-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response structure for the Spotify API endpoint that retrieves a user's saved shows and podcast episodes.
tags:
    - spotify-api
    - json-response
    - web-api
