...
url: https://moodledev.io/docs/5.1/apis/plugintypes/mod/visibility
source: sitemap
fetched_at: 2026-02-17T15:35:25.583689-03:00
rendered_js: false
word_count: 1179
summary: This document explains how to use the Moodle Course Module Display API to customize how activities and resources appear on the main course page, including modifying links, icons, and dynamic content.
tags:
    - moodle-api
    - course-modules
    - plugin-development
