---
title: GPT OSS Usage - SGLang Documentation
url: https://docs.sglang.io/docs/basic_usage/gpt_oss
source: sitemap
fetched_at: 2026-05-11T05:49:06.901828332-03:00
rendered_js: false
word_count: 361
summary: This document provides instructions on deploying and configuring GPT-OSS models using SGLang, covering tool server integration, MCP client setup, and speculative decoding.
tags:
    - sglang
    - gpt-oss
    - mcp
...
- We support OpenAI Reasoning and Tool Call parser, as well as our SGLang native api for tool call and reasoning. Refer to [reasoning parser](https://docs.sglang.io/docs/advanced_features/separate_reasoning) and [tool call parser](https://docs.sglang.io/docs/advanced_features/tool_parser) for more details.
