...
source: llms
fetched_at: 2026-04-16T22:31:28.71936436-03:00
rendered_js: false
word_count: 3869
summary: This guide outlines common workflows for using Claude Code to explore codebases, fix bugs, refactor code, and manage specialized subagents or plan modes.
tags:
    - claude-code
    - developer-workflows
