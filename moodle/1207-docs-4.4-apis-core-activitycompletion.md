...
url: https://moodledev.io/docs/4.4/apis/core/activitycompletion
source: sitemap
fetched_at: 2026-02-17T15:02:02.928695-03:00
rendered_js: false
word_count: 2062
summary: This document provides technical instructions for developers to implement activity completion features in Moodle activities, covering view-based, grade-based, and custom completion criteria.
tags:
    - moodle-development
    - activity-completion
    - php-api
