---
title: SGLang HiCache Best Practices - SGLang Documentation
url: https://docs.sglang.io/docs/advanced_features/hicache_best_practices
source: sitemap
fetched_at: 2026-05-11T05:49:33.94199638-03:00
rendered_js: false
word_count: 486
summary: This document provides configuration guidelines and implementation details for the SGLang HiCache hierarchical KV caching system, covering storage backends, prefetch policies, and heterogeneous deployment setups.
tags:
    - hicache
    - kv-cache
    - sglang
