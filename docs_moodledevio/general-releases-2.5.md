---
title: Moodle 2.5 | Moodle Developer Resources
url: https://moodledev.io/general/releases/2.5
source: sitemap
fetched_at: 2026-02-17T16:06:22.992495-03:00
rendered_js: false
word_count: 1443
summary: This document outlines the release notes for Moodle 2.5, detailing minimum system requirements, major new features like Open Badges and Bootstrap themes, and various activity enhancements.
tags:
    - moodle-2-5
    - release-notes
    - system-requirements
...
Here is [the full list of fixed issues in 2.5](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%222.5%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
- Minimum DB versions: PostgreSQL 8.3, MySQL 5.1.33, MariaDB 5.2, MSSQL 2005 or Oracle 10.2 (oci\_native\_moodle\_package.sql needs to be executed before upgrade on Oracle servers)
...
#### Open Badges integration[​](#open-badges-integration "Direct link to Open Badges integration")
...
#### Add-on installer[​](#add-on-installer "Direct link to Add-on installer")
...
#### Forms improvements[​](#forms-improvements "Direct link to Forms improvements")
...
#### Assignment activity[​](#assignment-activity "Direct link to Assignment activity")
...
#### Glossary activity[​](#glossary-activity "Direct link to Glossary activity")
...
#### Quiz activity[​](#quiz-activity "Direct link to Quiz activity")
...
#### Workshop activity[​](#workshop-activity "Direct link to Workshop activity")
...
#### Course listings[​](#course-listings "Direct link to Course listings")
...
#### Automated functional testing[​](#automated-functional-testing "Direct link to Automated functional testing")

- [MDL-35611](https://moodle.atlassian.net/browse/MDL-35611) - [Behat integration](https://moodledev.io/general/development/tools/behat), the framework for testing of user expectations, has been incorporated into Moodle.

### Other highlights[​](#other-highlights "Direct link to Other highlights")

#### Drag and drop improvements[​](#drag-and-drop-improvements "Direct link to Drag and drop improvements")
...
#### Forum activity[​](#forum-activity "Direct link to Forum activity")
...
#### Upload users[​](#upload-users "Direct link to Upload users")
...
#### Settings block rename[​](#settings-block-rename "Direct link to Settings block rename")
...
Moodle 2.5 also includes fixes to security issues resolved in earlier minor versions released after [Moodle 2.4](https://moodledev.io/general/releases/2.4). See the release notes for [Moodle 2.4.1](https://moodledev.io/general/releases/2.4/2.4.1), [Moodle 2.4.2](https://moodledev.io/general/releases/2.4/2.4.2) and [Moodle 2.4.3](https://moodledev.io/general/releases/2.4/2.4.3) for more details.
...
- [MDL-38391](https://moodle.atlassian.net/browse/MDL-38391) - Convert YUI\_config to class in lib/outputrequirements.php.
- [MDL-35819](https://moodle.atlassian.net/browse/MDL-35819) - JS M.util.help\_icon deprecated in favour of moodle-core-popuphelp
...
- [Notes de mise à jour de Moodle 2.5](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_2.5)