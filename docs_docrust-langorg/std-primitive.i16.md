---
title: i16 - Rust
url: https://doc.rust-lang.org/std/primitive.i16.html
source: crawler
fetched_at: 2026-05-06T21:30:11.442795643-03:00
rendered_js: false
word_count: 12345
summary: This document provides a reference for the 16-bit signed integer (i16) primitive type in Rust, detailing its constants, bitwise operations, and endianness conversion methods.
tags:
    - rust
    - primitive-types
    - i16
...
[Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#369)[§](#impl-i16)

1.43.0 · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.53.0 · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.0.0 (const: 1.32.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
Depending on what you’re doing with the value, you might also be interested in the [`ilog2`](https://doc.rust-lang.org/std/primitive.i16.html#method.ilog2 "method i16::ilog2") function which returns a consistent number, even if the type widens.
...
1.46.0 (const: 1.46.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
[Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.87.0 (const: 1.87.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.37.0 (const: 1.37.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
See also [from\_be\_bytes()](https://doc.rust-lang.org/std/primitive.i16.html#method.from_be_bytes "associated function i16::from_be_bytes").
...
See also [from\_le\_bytes()](https://doc.rust-lang.org/std/primitive.i16.html#method.from_le_bytes "associated function i16::from_le_bytes").
...
See [`to_be_bytes()`](https://doc.rust-lang.org/std/primitive.i16.html#method.to_be_bytes "method i16::to_be_bytes") for a type-safe alternative.
...
See [`to_le_bytes()`](https://doc.rust-lang.org/std/primitive.i16.html#method.to_le_bytes "method i16::to_le_bytes") for a type-safe alternative.
...
1.0.0 (const: 1.47.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.91.0 (const: 1.91.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.79.0 (const: 1.79.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)

Unchecked integer addition. Computes `self + rhs`, assuming overflow cannot occur.

Calling `x.unchecked_add(y)` is semantically equivalent to calling `x.`[`checked_add`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_add "method i16::checked_add")`(y).`[`unwrap_unchecked`](https://doc.rust-lang.org/std/option/enum.Option.html#method.unwrap_unchecked)`()`.

If you’re just trying to avoid the panic in debug mode, then **do not** use this. Instead, you’re looking for [`wrapping_add`](https://doc.rust-lang.org/std/primitive.i16.html#method.wrapping_add "method i16::wrapping_add").

##### [§](#safety)Safety

This results in undefined behavior when `self + rhs > i16::MAX` or `self + rhs < i16::MIN`, i.e. when [`checked_add`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_add "method i16::checked_add") would return `None`.

1.66.0 (const: 1.66.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
Calling `x.unchecked_sub(y)` is semantically equivalent to calling `x.`[`checked_sub`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_sub "method i16::checked_sub")`(y).`[`unwrap_unchecked`](https://doc.rust-lang.org/std/option/enum.Option.html#method.unwrap_unchecked)`()`.

If you’re just trying to avoid the panic in debug mode, then **do not** use this. Instead, you’re looking for [`wrapping_sub`](https://doc.rust-lang.org/std/primitive.i16.html#method.wrapping_sub "method i16::wrapping_sub").

##### [§](#safety-1)Safety

This results in undefined behavior when `self - rhs > i16::MAX` or `self - rhs < i16::MIN`, i.e. when [`checked_sub`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_sub "method i16::checked_sub") would return `None`.
...
Calling `x.unchecked_mul(y)` is semantically equivalent to calling `x.`[`checked_mul`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_mul "method i16::checked_mul")`(y).`[`unwrap_unchecked`](https://doc.rust-lang.org/std/option/enum.Option.html#method.unwrap_unchecked)`()`.

If you’re just trying to avoid the panic in debug mode, then **do not** use this. Instead, you’re looking for [`wrapping_mul`](https://doc.rust-lang.org/std/primitive.i16.html#method.wrapping_mul "method i16::wrapping_mul").

##### [§](#safety-2)Safety

This results in undefined behavior when `self * rhs > i16::MAX` or `self * rhs < i16::MIN`, i.e. when [`checked_mul`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_mul "method i16::checked_mul") would return `None`.

1.0.0 (const: 1.52.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.38.0 (const: 1.52.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
This results in undefined behavior when `rhs == 0`, `self % rhs != 0`, or `self == i16::MIN && rhs == -1`, i.e. when [`checked_div_exact`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_div_exact "method i16::checked_div_exact") would return `None`.

1.7.0 (const: 1.52.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.7.0 (const: 1.47.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.93.0 (const: 1.93.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)

Unchecked negation. Computes `-self`, assuming overflow cannot occur.

##### [§](#safety-4)Safety

This results in undefined behavior when `self == i16::MIN`, i.e. when [`checked_neg`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_neg "method i16::checked_neg") would return `None`.
...
This results in undefined behavior if `rhs` is larger than or equal to the number of bits in `self`, i.e. when [`checked_shl`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_shl "method i16::checked_shl") would return `None`.
...
This results in undefined behavior when `rhs >= self.leading_zeros() && rhs >= self.leading_ones()` i.e. when [`i16::shl_exact`](https://doc.rust-lang.org/std/primitive.i16.html#method.shl_exact "method i16::shl_exact") would return `None`.
...
This results in undefined behavior if `rhs` is larger than or equal to the number of bits in `self`, i.e. when [`checked_shr`](https://doc.rust-lang.org/std/primitive.i16.html#method.checked_shr "method i16::checked_shr") would return `None`.
...
This results in undefined behavior when `rhs > self.trailing_zeros() || rhs >= i16::BITS` i.e. when [`i16::shr_exact`](https://doc.rust-lang.org/std/primitive.i16.html#method.shr_exact "method i16::shr_exact") would return `None`.

1.13.0 (const: 1.47.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.34.0 (const: 1.50.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.84.0 (const: 1.84.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.45.0 (const: 1.47.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.58.0 (const: 1.58.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.2.0 (const: 1.52.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.2.0 (const: 1.32.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
Beware that, unlike most other `wrapping_*` methods on integers, this does *not* give the same result as doing the shift in infinite precision then truncating as needed. The behaviour matches what shift instructions do on many processors, and is what the `>>` operator does when overflow checks are disabled, but numerically it’s weird. Consider, instead, using [`Self::unbounded_shr`](https://doc.rust-lang.org/std/primitive.i16.html#method.unbounded_shr "method i16::unbounded_shr") which has nicer behaviour.

Note that this is *not* the same as a rotate-right; the RHS of a wrapping shift-right is restricted to the range of the type, rather than the bits shifted out of the LHS being returned to the other end. The primitive integer types all implement a [`rotate_right`](https://doc.rust-lang.org/std/primitive.i16.html#method.rotate_right "method i16::rotate_right") function, which may be what you want instead.
...
1.13.0 (const: 1.32.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.51.0 (const: 1.51.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.7.0 (const: 1.32.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)

Calculates `self` + `rhs`.

Returns a tuple of the addition along with a boolean indicating whether an arithmetic overflow would occur. If an overflow would have occurred then the wrapped value is returned (negative if overflowed above [`MAX`](https://doc.rust-lang.org/std/primitive.i16.html#associatedconstant.MAX "associated constant i16::MAX"), non-negative if below [`MIN`](https://doc.rust-lang.org/std/primitive.i16.html#associatedconstant.MIN "associated constant i16::MIN")).
...
This allows chaining together multiple additions to create a wider addition, and can be useful for bignum addition. This method should only be used for the most significant word; for the less significant words the unsigned method [`u16::carrying_add`](https://doc.rust-lang.org/std/primitive.u16.html#method.carrying_add "method u16::carrying_add") should be used.

The output boolean returned by this method is *not* a carry flag, and should *not* be added to a more significant word.

If overflow occurred, the wrapped value is returned (negative if overflowed above [`MAX`](https://doc.rust-lang.org/std/primitive.i16.html#associatedconstant.MAX "associated constant i16::MAX"), non-negative if below [`MIN`](https://doc.rust-lang.org/std/primitive.i16.html#associatedconstant.MIN "associated constant i16::MIN")).

If the input carry is false, this method is equivalent to [`overflowing_add`](https://doc.rust-lang.org/std/primitive.i16.html#method.overflowing_add "method i16::overflowing_add").
...
Returns a tuple of the subtraction along with a boolean indicating whether an arithmetic overflow would occur. If an overflow would have occurred then the wrapped value is returned (negative if overflowed above [`MAX`](https://doc.rust-lang.org/std/primitive.i16.html#associatedconstant.MAX "associated constant i16::MAX"), non-negative if below [`MIN`](https://doc.rust-lang.org/std/primitive.i16.html#associatedconstant.MIN "associated constant i16::MIN")).
...
If the input borrow is false, this method is equivalent to [`overflowing_sub`](https://doc.rust-lang.org/std/primitive.i16.html#method.overflowing_sub "method i16::overflowing_sub").
...
If you also need to add a carry to the wide result, then you want [`Self::carrying_mul`](https://doc.rust-lang.org/std/primitive.i16.html#method.carrying_mul "method i16::carrying_mul") instead.
...
If you don’t need the `carry`, then you can use [`Self::widening_mul`](https://doc.rust-lang.org/std/primitive.i16.html#method.widening_mul "method i16::widening_mul") instead.
...
If you don’t need either `carry`, then you can use [`Self::widening_mul`](https://doc.rust-lang.org/std/primitive.i16.html#method.widening_mul "method i16::widening_mul") instead, and if you only need one `carry`, then you can use [`Self::carrying_mul`](https://doc.rust-lang.org/std/primitive.i16.html#method.carrying_mul "method i16::carrying_mul") instead.
...
1.0.0 (const: 1.50.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.67.0 (const: 1.67.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.60.0 (const: 1.60.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
1.32.0 (const: 1.44.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#370-389)
...
As the target platform’s native endianness is used, portable code should use [`to_be_bytes`](https://doc.rust-lang.org/std/primitive.i16.html#method.to_be_bytes "method i16::to_be_bytes") or [`to_le_bytes`](https://doc.rust-lang.org/std/primitive.i16.html#method.to_le_bytes "method i16::to_le_bytes"), as appropriate, instead.
...
As the target platform’s native endianness is used, portable code likely wants to use [`from_be_bytes`](https://doc.rust-lang.org/std/primitive.i16.html#method.from_be_bytes "associated function i16::from_be_bytes") or [`from_le_bytes`](https://doc.rust-lang.org/std/primitive.i16.html#method.from_le_bytes "associated function i16::from_le_bytes"), as appropriate instead.
...
New code should prefer to use [`i16::MIN`](https://doc.rust-lang.org/std/primitive.i16.html#associatedconstant.MIN "associated constant i16::MIN") instead.
...
New code should prefer to use [`i16::MAX`](https://doc.rust-lang.org/std/primitive.i16.html#associatedconstant.MAX "associated constant i16::MAX") instead.
...
1.87.0 (const: 1.87.0) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#390)
...
[Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#1801)[§](#impl-i16-1)
...
[Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#599)[§](#impl-i16-2)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#114)[§](#impl-Add%3C%26i16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#114)[§](#impl-Add%3C%26i16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#114)[§](#impl-Add%3Ci16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#114)[§](#impl-Add-for-i16)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-AddAssign%3C%26i16%3E-for-Saturating%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-AddAssign%3C%26i16%3E-for-Wrapping%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#800)[§](#impl-AddAssign%3C%26i16%3E-for-i16)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-AddAssign%3Ci16%3E-for-Saturating%3Ci16%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-AddAssign%3Ci16%3E-for-Wrapping%3Ci16%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#800)[§](#impl-AddAssign-for-i16)
...
[Source](https://doc.rust-lang.org/src/core/sync/atomic.rs.html#300)[§](#associatedtype.AtomicInner)

🔬This is a nightly-only experimental API. (`atomic_internals`)

Temporary implementation detail.

1.0.0 · [Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#74)[§](#impl-Binary-for-i16)

[Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#74)[§](#method.fmt-2)

Format signed integers in the two’s-complement form.

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#187)[§](#impl-BitAnd%3C%26i16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#187)[§](#impl-BitAnd%3C%26i16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#187)[§](#impl-BitAnd%3Ci16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#187)[§](#impl-BitAnd-for-i16)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-BitAndAssign%3C%26i16%3E-for-Saturating%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-BitAndAssign%3C%26i16%3E-for-Wrapping%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#755)[§](#impl-BitAndAssign%3C%26i16%3E-for-i16)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-BitAndAssign%3Ci16%3E-for-Saturating%3Ci16%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-BitAndAssign%3Ci16%3E-for-Wrapping%3Ci16%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#755)[§](#impl-BitAndAssign-for-i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#291)[§](#impl-BitOr%3C%26i16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#291)[§](#impl-BitOr%3C%26i16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#291)[§](#impl-BitOr%3Ci16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#291)[§](#impl-BitOr-for-i16)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-BitOrAssign%3C%26i16%3E-for-Saturating%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-BitOrAssign%3C%26i16%3E-for-Wrapping%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#830)[§](#impl-BitOrAssign%3C%26i16%3E-for-i16)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-BitOrAssign%3Ci16%3E-for-Saturating%3Ci16%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-BitOrAssign%3Ci16%3E-for-Wrapping%3Ci16%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#830)[§](#impl-BitOrAssign-for-i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#395)[§](#impl-BitXor%3C%26i16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#395)[§](#impl-BitXor%3C%26i16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#395)[§](#impl-BitXor%3Ci16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#395)[§](#impl-BitXor-for-i16)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-BitXorAssign%3C%26i16%3E-for-Saturating%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-BitXorAssign%3C%26i16%3E-for-Wrapping%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#905)[§](#impl-BitXorAssign%3C%26i16%3E-for-i16)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-BitXorAssign%3Ci16%3E-for-Saturating%3Ci16%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-BitXorAssign%3Ci16%3E-for-Wrapping%3Ci16%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#905)[§](#impl-BitXorAssign-for-i16)

[Source](https://doc.rust-lang.org/src/core/intrinsics/fallback.rs.html#34-45)[§](#impl-CarryingMulAdd-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/142757 "Tracking issue for const_clone")) · [Source](https://doc.rust-lang.org/src/core/clone.rs.html#627-632)[§](#impl-Clone-for-i16)

1.0.0 · [Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#589-592)[§](#impl-Debug-for-i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143894 "Tracking issue for const_default")) · [Source](https://doc.rust-lang.org/src/core/default.rs.html#178)[§](#impl-Default-for-i16)

[Source](https://doc.rust-lang.org/src/core/default.rs.html#178)[§](#method.default)

Returns the default value of `0`

[Source](https://doc.rust-lang.org/src/core/intrinsics/fallback.rs.html#144-148)[§](#impl-DisjointBitOr-for-i16)
...
1.0.0 · [Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#599)[§](#impl-Display-for-i16)

[Source](https://doc.rust-lang.org/src/core/random.rs.html#52)[§](#impl-Distribution%3Ci16%3E-for-RangeFull)

[Source](https://doc.rust-lang.org/src/core/random.rs.html#52)[§](#method.sample)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-DivAssign%3C%26i16%3E-for-Saturating%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-DivAssign%3C%26i16%3E-for-Wrapping%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#994)[§](#impl-DivAssign%3C%26i16%3E-for-i16)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-DivAssign%3Ci16%3E-for-Saturating%3Ci16%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-DivAssign%3Ci16%3E-for-Wrapping%3Ci16%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#994)[§](#impl-DivAssign-for-i16)
...
Converts from [`bool`](https://doc.rust-lang.org/std/primitive.bool.html "primitive bool") to [`i16`](https://doc.rust-lang.org/std/primitive.i16.html "primitive i16") , by turning `false` into `0` and `true` into `1`.
...
[Source](https://doc.rust-lang.org/src/core/sync/atomic.rs.html#3634-3651)[§](#method.from-10)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/src/core/num/mod.rs.html#1801)[§](#impl-FromStr-for-i16)
...
For parsing numbers in other bases, such as binary or hexadecimal, see [`from_str_radix`](https://doc.rust-lang.org/std/primitive.i16.html#method.from_str_radix "associated function i16::from_str_radix").
...
1.42.0 · [Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#600)[§](#impl-LowerExp-for-i16)

1.0.0 · [Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#74)[§](#impl-LowerHex-for-i16)

[Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#74)[§](#method.fmt-4)

Format signed integers in the two’s-complement form.

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#361)[§](#impl-Mul%3C%26i16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#361)[§](#impl-Mul%3C%26i16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#361)[§](#impl-Mul%3Ci16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#361)[§](#impl-Mul-for-i16)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-MulAssign%3C%26i16%3E-for-Saturating%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-MulAssign%3C%26i16%3E-for-Wrapping%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#933)[§](#impl-MulAssign%3C%26i16%3E-for-i16)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-MulAssign%3Ci16%3E-for-Saturating%3Ci16%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-MulAssign%3Ci16%3E-for-Wrapping%3Ci16%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#933)[§](#impl-MulAssign-for-i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#729)[§](#impl-Neg-for-%26i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#729)[§](#impl-Neg-for-i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#72)[§](#impl-Not-for-%26i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#72)[§](#impl-Not-for-i16)

[Source](https://doc.rust-lang.org/src/core/fmt/num_buffer.rs.html#26-33)[§](#impl-NumBufferTrait-for-i16)
...
1.0.0 · [Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#74)[§](#impl-Octal-for-i16)

[Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#74)[§](#method.fmt-3)

Format signed integers in the two’s-complement form.

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/src/core/cmp.rs.html#2080)[§](#impl-Ord-for-i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/src/core/cmp.rs.html#1898-1900)[§](#impl-PartialEq-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/src/core/cmp.rs.html#2080)[§](#impl-PartialOrd-for-i16)
...
1.12.0 · [Source](https://doc.rust-lang.org/src/core/iter/traits/accum.rs.html#204)[§](#impl-Product%3C%26i16%3E-for-i16)

[Source](https://doc.rust-lang.org/src/core/iter/traits/accum.rs.html#204)[§](#method.product-1)

Takes an iterator and generates `Self` from the elements by multiplying the items.

1.12.0 · [Source](https://doc.rust-lang.org/src/core/iter/traits/accum.rs.html#204)[§](#impl-Product-for-i16)

[Source](https://doc.rust-lang.org/src/core/iter/traits/accum.rs.html#204)[§](#method.product)

Takes an iterator and generates `Self` from the elements by multiplying the items.

[Source](https://doc.rust-lang.org/src/core/pat.rs.html#61-64)[§](#impl-RangePattern-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#613-616)[§](#impl-Rem%3C%26i16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#613-616)[§](#impl-Rem%3C%26i16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#613-616)[§](#impl-Rem%3Ci16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#613-616)[§](#impl-Rem-for-i16)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-RemAssign%3C%26i16%3E-for-Saturating%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-RemAssign%3C%26i16%3E-for-Wrapping%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#1059)[§](#impl-RemAssign%3C%26i16%3E-for-i16)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-RemAssign%3Ci16%3E-for-Saturating%3Ci16%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-RemAssign%3Ci16%3E-for-Wrapping%3Ci16%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#1059)[§](#impl-RemAssign-for-i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i128%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i128%3E-for-i16)
...
[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shl%3C%26i16%3E-for-%26Simd%3Ci16,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-%26i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-%26i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-%26i8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-%26isize)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-%26u16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-%26u32)
...
[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shl%3C%26i16%3E-for-Simd%3Ci16,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-i8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-isize)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-u16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i16%3E-for-u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i32%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i32%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i8%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i8%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26isize%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26isize%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u32%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u32%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci128%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci128%3E-for-i16)
...
[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shl%3Ci16%3E-for-%26Simd%3Ci16,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-%26i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-%26i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-%26i8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-%26isize)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-%26u16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-%26u32)
...
[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shl%3Ci16%3E-for-Simd%3Ci16,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-i8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-isize)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-u16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci16%3E-for-u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci32%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci32%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci8%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci8%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cisize%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cisize%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu32%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu32%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#517)[§](#impl-Shl-for-i16)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i128%3E-for-i16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i16%3E-for-i128)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i16%3E-for-i16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i16%3E-for-i32)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i16%3E-for-i8)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i16%3E-for-isize)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i16%3E-for-u16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i16%3E-for-u32)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i32%3E-for-i16)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i8%3E-for-i16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26isize%3E-for-i16)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u16%3E-for-i16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u32%3E-for-i16)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci128%3E-for-i16)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci16%3E-for-i128)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci16%3E-for-i32)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci16%3E-for-i8)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci16%3E-for-isize)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci16%3E-for-u16)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci16%3E-for-u32)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci32%3E-for-i16)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci8%3E-for-i16)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cisize%3E-for-i16)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu16%3E-for-i16)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu32%3E-for-i16)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign-for-i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i128%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i128%3E-for-i16)
...
[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shr%3C%26i16%3E-for-%26Simd%3Ci16,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-%26i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-%26i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-%26i8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-%26isize)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-%26u16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-%26u32)
...
[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shr%3C%26i16%3E-for-Simd%3Ci16,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-i8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-isize)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-u16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i16%3E-for-u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i32%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i32%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i8%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i8%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26isize%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26isize%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u32%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u32%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci128%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci128%3E-for-i16)
...
[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shr%3Ci16%3E-for-%26Simd%3Ci16,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-%26i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-%26i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-%26i8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-%26isize)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-%26u16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-%26u32)
...
[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shr%3Ci16%3E-for-Simd%3Ci16,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-i8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-isize)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-u16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci16%3E-for-u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci32%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci32%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci8%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci8%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cisize%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cisize%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu32%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu32%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#639)[§](#impl-Shr-for-i16)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i128%3E-for-i16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i16%3E-for-i128)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i16%3E-for-i16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i16%3E-for-i32)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i16%3E-for-i8)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i16%3E-for-isize)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i16%3E-for-u16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i16%3E-for-u32)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i32%3E-for-i16)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i8%3E-for-i16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26isize%3E-for-i16)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u16%3E-for-i16)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u32%3E-for-i16)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci128%3E-for-i16)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci16%3E-for-i128)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci16%3E-for-i32)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci16%3E-for-i8)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci16%3E-for-isize)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci16%3E-for-u16)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci16%3E-for-u32)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci32%3E-for-i16)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci8%3E-for-i16)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cisize%3E-for-i16)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu16%3E-for-i16)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu32%3E-for-i16)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign-for-i16)

[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/vector.rs.html#1125)[§](#impl-SimdElement-for-i16)

[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/vector.rs.html#1126)[§](#associatedtype.Mask)

🔬This is a nightly-only experimental API. (`portable_simd` [#86656](https://github.com/rust-lang/rust/issues/86656))

The mask element type corresponding to this element type.

[Source](https://doc.rust-lang.org/src/core/iter/range.rs.html#434-437)[§](#impl-Step-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#227)[§](#impl-Sub%3C%26i16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#227)[§](#impl-Sub%3C%26i16%3E-for-i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#227)[§](#impl-Sub%3Ci16%3E-for-%26i16)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#227)[§](#impl-Sub-for-i16)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-SubAssign%3C%26i16%3E-for-Saturating%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-SubAssign%3C%26i16%3E-for-Wrapping%3Ci16%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#871)[§](#impl-SubAssign%3C%26i16%3E-for-i16)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/saturating.rs.html#551)[§](#impl-SubAssign%3Ci16%3E-for-Saturating%3Ci16%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/num/wrapping.rs.html#566)[§](#impl-SubAssign%3Ci16%3E-for-Wrapping%3Ci16%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/src/core/ops/arith.rs.html#871)[§](#impl-SubAssign-for-i16)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#569)[§](#method.try_from-17)

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#569)[§](#associatedtype.Error-17)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#381)[§](#method.try_from-1)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#381)[§](#associatedtype.Error-1)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#396)[§](#method.try_from-13)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#396)[§](#associatedtype.Error-13)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#396)[§](#method.try_from-12)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#396)[§](#associatedtype.Error-12)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#395)[§](#method.try_from-9)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#395)[§](#associatedtype.Error-9)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#382)[§](#method.try_from-2)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#382)[§](#associatedtype.Error-2)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#466)[§](#method.try_from-15)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#466)[§](#associatedtype.Error-15)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#388)[§](#method.try_from-5)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#388)[§](#associatedtype.Error-5)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#389)[§](#method.try_from-6)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#389)[§](#associatedtype.Error-6)
...
[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#461)[§](#method.try_from-14)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#461)[§](#associatedtype.Error-14)

The type returned in the event of a conversion error.

1.42.0 · [Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#600)[§](#impl-UpperExp-for-i16)

1.0.0 · [Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#74)[§](#impl-UpperHex-for-i16)

[Source](https://doc.rust-lang.org/src/core/fmt/num.rs.html#74)[§](#method.fmt-5)

Format signed integers in the two’s-complement form.

[Source](https://doc.rust-lang.org/src/core/num/nonzero.rs.html#69-83)[§](#impl-ZeroablePrimitive-for-i16)
...
[Source](https://doc.rust-lang.org/src/core/marker.rs.html#1100-1109)[§](#impl-ConstParamTy_-for-i16)

1.0.0 · [Source](https://doc.rust-lang.org/src/core/marker.rs.html#474-484)[§](#impl-Copy-for-i16)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/src/core/cmp.rs.html#1910)[§](#impl-Eq-for-i16)

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#40)[§](#impl-FloatToInt%3Ci16%3E-for-f128)

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#37)[§](#impl-FloatToInt%3Ci16%3E-for-f16)

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#38)[§](#impl-FloatToInt%3Ci16%3E-for-f32)

[Source](https://doc.rust-lang.org/src/core/convert/num.rs.html#39)[§](#impl-FloatToInt%3Ci16%3E-for-f64)

[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/masks.rs.html#109)[§](#impl-MaskElement-for-i16)

[Source](https://doc.rust-lang.org/src/core/portable-simd/crates/core_simd/src/cast.rs.html#21)[§](#impl-SimdCast-for-i16)

[Source](https://doc.rust-lang.org/src/core/marker.rs.html#264-276)[§](#impl-StructuralPartialEq-for-i16)

[Source](https://doc.rust-lang.org/src/core/iter/range.rs.html#17)[§](#impl-TrustedStep-for-i16)

[Source](https://doc.rust-lang.org/src/core/clone.rs.html#339-344)[§](#impl-UseCloned-for-i16)
