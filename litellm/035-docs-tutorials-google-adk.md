...
## 1. Setting Up Environment[​](#1-setting-up-environment "Direct link to 1. Setting Up Environment")
...
## 3. Helper Function for Agent Interaction[​](#3-helper-function-for-agent-interaction "Direct link to 3. Helper Function for Agent Interaction")
...
```
asyncdefcall_agent_async(query:str, runner, user_id, session_id):
...
## 4. Using Different Model Providers with ADK[​](#4-using-different-model-providers-with-adk "Direct link to 4. Using Different Model Providers with ADK")

### 4.1 Using OpenAI Models[​](#41-using-openai-models "Direct link to 4.1 Using OpenAI Models")
...
### 4.2 Using Anthropic Models[​](#42-using-anthropic-models "Direct link to 4.2 Using Anthropic Models")
...
### 4.3 Using Google's Gemini Models[​](#43-using-googles-gemini-models "Direct link to 4.3 Using Google's Gemini Models")
...
## 5. Using LiteLLM Proxy with ADK[​](#5-using-litellm-proxy-with-adk "Direct link to 5. Using LiteLLM Proxy with ADK")
...
VariableDescription`LITELLM_PROXY_API_KEY`The API key for the LiteLLM proxy`LITELLM_PROXY_API_BASE`The base URL for the LiteLLM proxy`USE_LITELLM_PROXY` or `litellm.use_litellm_proxy`When set to True, your request will be sent to litellm proxy.
