---
title: "null"
url: https://docs.clawd.bot/gateway/tailscale.md
source: llms
fetched_at: 2026-01-26T09:52:15.547780553-03:00
rendered_js: false
word_count: 483
summary: This document explains how to configure Clawdbot's Gateway and browser control server to use Tailscale Serve or Funnel for secure network access and authentication. It details the setup for tailnet-only and public internet exposure, including identity header verification and configuration parameters.
tags:
    - tailscale
