...
url: https://moodledev.io/docs/4.5/tags/xmldb
source: sitemap
fetched_at: 2026-02-17T15:10:40.842193-03:00
rendered_js: false
word_count: 131
summary: This document provides an overview and links to Moodle's core APIs for defining database structures, manipulating data, and managing plugin installations and upgrades.
tags:
    - moodle-development
    - database-api
    - dml
...
## [Database schema](https://moodledev.io/docs/4.5/apis/core/dml/database-schema)
