...
source: sitemap
fetched_at: 2026-04-07T21:33:09.959766117-03:00
rendered_js: false
word_count: 1096
summary: This guide details multiple methods for installing DankMaterialShell on NixOS, covering system-wide via the NixOS module and per-user via home-manager. It also includes specific instructions for integrating with other tools like dgop and niri.
tags:
    - nixos
    - home-manager
    - installation-guide
...
DankMaterialShell is now available in nixpkgs unstable! If you're on NixOS unstable (26.05), see [Installation - NixOS](https://danklinux.com/docs/dankmaterialshell/nixos) for the native nixpkgs installation method which doesn't require flakes.
...
The files referenced by `filesToInclude` must exist or niri will error on startup. If you're not generating them through home-manager, use [`dms setup`](https://danklinux.com/docs/dankmaterialshell/cli-setup) to deploy the defaults — or generate individual files like `dms setup binds`, `dms setup colors`, etc.
