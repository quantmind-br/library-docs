...
source: sitemap
fetched_at: 2026-01-24T13:33:11.569637309-03:00
rendered_js: false
word_count: 246
summary: This document provides instructions for installing and configuring the DankGreeter login manager on NixOS using Nix Flakes, including module setup and configuration options.
tags:
    - nixos
    - nix-flakes
    - dankgreeter
