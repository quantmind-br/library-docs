...
source: crawler
fetched_at: 2026-01-28T15:01:14.905703603-03:00
rendered_js: false
word_count: 46
summary: This document provides the implementation details of DNS-related data structures and methods in mitmproxy, including classes for DNS questions and resource records along with their serialization/deserialization to/from JSON.
tags:
    - dns-implementation
    - data-structures
    - serialization
