...
url: https://moodledev.io/docs/5.2/apis/commonfiles/tag.php
source: sitemap
fetched_at: 2026-02-17T15:43:02.499203-03:00
rendered_js: false
word_count: 0
summary: This document defines the structure and attributes used to register tag areas in Moodle, enabling different components to support tagging functionality.
tags:
    - moodle-development
    - tag-areas
