...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/getMobileAppsByBusinessIdAndAdAccountId
source: crawler
fetched_at: 2026-02-27T23:39:33.411567-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response format for an API endpoint that retrieves metadata and integration details for registered mobile applications.
tags:
    - api-response
    - mobile-apps
    - app-integration
