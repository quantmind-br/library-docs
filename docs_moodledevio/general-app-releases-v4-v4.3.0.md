---
title: Moodle App 4.3.0 release notes | Moodle Developer Resources
url: https://moodledev.io/general/app_releases/v4/v4.3.0
source: sitemap
fetched_at: 2026-02-17T15:54:07.222564-03:00
rendered_js: false
word_count: 816
summary: This document provides the release notes for the Moodle app update from November 2023, detailing new features, bug fixes, and improvements such as global search support and redesigned activity cards. it also highlights compatibility requirements for Moodle LMS 4.3 and lists known accessibility issues on iOS devices.
tags:
    - moodle-app
    - release-notes
    - mobile-learning
...
### Experimental features support[​](#experimental-features-support "Direct link to Experimental features support")
...
- [MOBILE-4191](https://moodle.atlassian.net/browse/MOBILE-4191) - Increase limit of 4096 for cmi.suspend\_data in SCORM
