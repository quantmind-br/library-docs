---
title: Query VLM with Offline Engine - SGLang Documentation
url: https://docs.sglang.io/docs/advanced_features/vlm_query
source: sitemap
fetched_at: 2026-05-11T05:49:21.360247977-03:00
rendered_js: false
word_count: 311
summary: 'This tutorial explains how to interface with vision-language models using SGLang''s offline Engine API, covering three distinct input methods: raw images, processor output, and precomputed embeddings.'
tags:
    - sglang
    - vlm
    - offline-engine
