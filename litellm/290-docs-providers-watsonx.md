...
## Usage - Models in deployment spaces[​](#usage---models-in-deployment-spaces "Direct link to Usage - Models in deployment spaces")
...
## Usage - Embeddings[​](#usage---embeddings "Direct link to Usage - Embeddings")
...
### 1. Save keys in your environment[​](#1-save-keys-in-your-environment "Direct link to 1. Save keys in your environment")
...
Model NameFunction CallSlate 30m`embedding(model="watsonx/ibm/slate-30m-english-rtrvr", input=input)`Slate 125m`embedding(model="watsonx/ibm/slate-125m-english-rtrvr", input=input)`
...
### Using Zen API Key[​](#using-zen-api-key "Direct link to Using Zen API Key")
