---
title: Frontend Language - SGLang Documentation
url: https://docs.sglang.io/docs/references/frontend/frontend_index
source: sitemap
fetched_at: 2026-05-11T05:48:19.002471271-03:00
rendered_js: false
word_count: 95
summary: This document provides an overview of advanced configuration options, performance optimization techniques, and architectural features for the SGLang inference engine.
tags:
    - sglang
    - model-optimization
    - inference-engine
