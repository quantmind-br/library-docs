...
url: https://moodledev.io/docs/5.0/apis/core/reportbuilder/filtering
source: sitemap
fetched_at: 2026-02-17T15:25:00.23322-03:00
rendered_js: false
word_count: 924
summary: Explains how to define default condition values for report builder datasources by implementing the get_default_condition_values method and utilizing specific naming conventions for various filter types.
tags:
    - moodle
    - report-builder
    - datasource-filters
