...
url: https://moodledev.io/docs/4.5/apis/subsystems/availability
source: sitemap
fetched_at: 2026-02-17T15:13:12.315922-03:00
rendered_js: false
word_count: 869
summary: This document explains how to use the Moodle Availability API to manage and restrict access to course activities and sections based on specific criteria. It covers checking visibility permissions for users, filtering user lists, and programmatically configuring access conditions.
tags:
    - moodle-development
    - availability-api
    - access-control
...
- Writing [Availability condition](https://moodledev.io/docs/4.5/apis/plugintypes/availability) plugins