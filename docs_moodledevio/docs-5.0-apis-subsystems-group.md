...
url: https://moodledev.io/docs/5.0/apis/subsystems/group
source: sitemap
fetched_at: 2026-02-17T15:27:50.055322-03:00
rendered_js: false
word_count: 1041
summary: This document explains the Moodle Groups API, detailing how to manage user collections, configure group modes, and implement group support within activity modules.
tags:
    - moodle
    - groups-api
    - php
