...
url: https://moodledev.io/docs/5.1/guides/git
source: sitemap
fetched_at: 2026-02-17T15:37:39.648748-03:00
rendered_js: false
word_count: 2920
summary: This document outlines the standard Git workflow for Moodle development, providing instructions for installation, configuration, and repository management.
tags:
    - git-basics
    - moodle-development
    - version-control
