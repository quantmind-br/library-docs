...
source: llms
fetched_at: 2026-01-26T09:52:06.169882896-03:00
rendered_js: false
word_count: 425
summary: This document explains the Gateway-owned pairing process for nodes, detailing the lifecycle of pending requests, authentication token management, and administrative control via CLI and API.
tags:
    - gateway-pairing
    - node-authentication
    - clawdbot-protocol
