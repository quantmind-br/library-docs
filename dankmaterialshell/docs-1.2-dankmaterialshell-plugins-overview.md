...
url: https://danklinux.com/docs/1.2/dankmaterialshell/plugins-overview
source: sitemap
fetched_at: 2026-02-22T18:43:11.020259-03:00
rendered_js: false
word_count: 572
summary: This document outlines the architecture and management of the DankMaterialShell plugin system, detailing how to install, use, and develop various plugin types such as widgets and daemons.
tags:
    - dankmaterialshell
    - plugin-system
    - qml-components
...
See [Plugin Development](https://danklinux.com/docs/1.2/dankmaterialshell/plugin-development) for the complete development guide including:
...
- Learn plugin development in [Plugin Development](https://danklinux.com/docs/1.2/dankmaterialshell/plugin-development)
