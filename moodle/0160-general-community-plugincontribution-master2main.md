---
title: Master to main | Moodle Developer Resources
url: https://moodledev.io/general/community/plugincontribution/master2main
source: sitemap
fetched_at: 2026-02-17T15:57:56.802524-03:00
rendered_js: false
word_count: 481
summary: This document provides instructions for renaming a default Git branch from master to main across various platforms and local environments. It details steps for GitHub, GitLab, and other providers, as well as necessary updates for CI/CD integrations and local repository tracking.
tags:
    - git
    - branch-management
...
### Moving from `master` to `main` for canonical/origin github based repositories[​](#moving-from-master-to-main-for-canonicalorigin-github-based-repositories "Direct link to moving-from-master-to-main-for-canonicalorigin-github-based-repositories")
...
3. Rename `master` to `main` (all associated pull requests will be migrated, also any protection rules and other bits. See [https://github.com/github/renaming](https://github.com/github/renaming) for more information.
4. Time to hack (see the section)

### Moving from `master` to `main` for other canonical/origin (gitlab, bitbucket, sourceforge, ...) repositories[​](#moving-from-master-to-main-for-other-canonicalorigin-gitlab-bitbucket-sourceforge--repositories "Direct link to moving-from-master-to-main-for-other-canonicalorigin-gitlab-bitbucket-sourceforge--repositories")
...
### Time to hack[​](#time-to-hack "Direct link to Time to hack")
...
### Moving from `master` to `main` in your local clones[​](#moving-from-master-to-main-in-your-local-clones "Direct link to moving-from-master-to-main-in-your-local-clones")
