...
source: llms
fetched_at: 2026-02-05T21:40:26.85284571-03:00
rendered_js: false
word_count: 296
summary: This document outlines the features introduced in Factory Release 1.9, including mixed model support for different workflow phases, customizable subagents, and automated GitHub pull request reviews.
tags:
    - release-notes
    - mixed-models
    - custom-droids
