...
url: https://moodledev.io/docs/5.2/tags/xmldb
source: sitemap
fetched_at: 2026-02-17T15:42:51.992621-03:00
rendered_js: false
word_count: 131
summary: This document provides an overview of Moodle's core database APIs and tools, covering data definition, manipulation, schema design, and plugin upgrade mechanisms.
tags:
    - moodle-development
    - database-api
    - dml
