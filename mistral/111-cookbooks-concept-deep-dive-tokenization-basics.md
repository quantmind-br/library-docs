...
url: https://docs.mistral.ai/cookbooks/concept-deep-dive-tokenization-basics
source: crawler
fetched_at: 2026-01-29T07:34:51.646237752-03:00
rendered_js: false
word_count: 874
summary: This document explains the fundamental principles of Large Language Models, focusing on the mechanics of tokenization, encoding, and the use of chat templates for dialogue.
tags:
...
You can learn more on how to make your own tokenizer [here](https://docs.mistral.ai/cookbooks/concept-deep-dive-tokenization-tokenizer)!
...
While this is still not close to what we implement with [mistral-common](https://docs.mistral.ai/cookbooks/concept-deep-dive-tokenization-basics), many could stop here, as these are the bare minimum understanding requirements. However, there are a few hidden issues within tokenizers and LLMs that are crucial to understand, specifically [**boundary problems**](https://docs.mistral.ai/cookbooks/concept-deep-dive-tokenization-boundaries).