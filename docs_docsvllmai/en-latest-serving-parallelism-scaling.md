...
source: sitemap
fetched_at: 2026-05-07T21:15:14.910509371-03:00
rendered_js: false
word_count: 1369
summary: This document provides guidelines for scaling vLLM inference across single and multiple GPU nodes using tensor parallelism, pipeline parallelism, and distributed runtimes like Ray.
tags:
    - vllm
...
```
vllmserve/path/to/the/model/in/the/container\
--tensor-parallel-size8\
--pipeline-parallel-size2\
--distributed-executor-backendray
```
...
```
vllmserve/path/to/the/model/in/the/container\
--tensor-parallel-size8--pipeline-parallel-size2\
--nnodes2--node-rank0\
...
For information about distributed debugging, see [Troubleshooting distributed deployments](https://docs.vllm.ai/en/latest/serving/distributed_troubleshooting/).