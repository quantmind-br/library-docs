...
url: https://moodledev.io/docs/5.1/tags/format
source: sitemap
fetched_at: 2026-02-17T15:30:57.977405-03:00
rendered_js: false
word_count: 76
summary: This document defines Moodle course format plugins and provides instructions for migrating legacy 3.11 formats to the modern course editor introduced in Moodle 4.0.
tags:
    - moodle
    - course-format
    - plugin-migration
