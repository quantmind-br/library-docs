...
source: sitemap
fetched_at: 2026-05-07T21:17:18.002170415-03:00
rendered_js: false
word_count: 217
summary: This document defines the VllmConfig dataclass, which serves as a centralized container for all configuration parameters required to initialize and manage vLLM engine operations, including model, cache, scheduler, and hardware settings.
tags:
    - vllm
    - configuration
    - dataclass
...
"""
    ...
    @property
    defnum_speculative_tokens(self) -> int:
        if (
    ...
    @property
    defneeds_dp_coordinator(self) -> bool:
"""
    ...
    defenable_trace_function_call_for_thread(self) -> None:
"""
...
"""Get the quantization config."""
        ...
        if model_config.quantization is not None:
            fromvllm.model_executor.model_loader.weight_utilsimport get_quant_config
    ...
    defwith_hf_config(
        ...
        if architectures is not None:
            ...
            fromtransformers.models.auto.modeling_autoimport (
    ...
    def_set_config_default(self, config_obj: Any, key: str, value: Any) -> None:
"""Set config attribute to default if not already set by user.
    ...
    def_apply_optimization_level_defaults(self, defaults: dict[str, Any]) -> None:
"""Apply optimization level defaults using self as root.
        ...
        defapply_recursive(config_obj: Any, config_defaults: dict[str, Any]) -> None:
"""Recursively apply defaults to config_obj, using self as root."""
    ...
    def_post_init_kv_transfer_config(self) -> None:
...
"""Verify configs are valid & consistent with each other."""
        ...
        if (
            ...
            fromvllm.utils.deep_gemmimport should_auto_disable_deep_gemm
        ...
        fromvllm.v1.executor.abstractimport Executor
        ...
        if pass_config.enable_sp:
            if self.parallel_config.tensor_parallel_size == 1:
                ...
                if pass_config.sp_min_token_num is None:
                    fromvllm.compilation.passes.fusion.sequence_parallelismimport (
        ...
        fromvllm.utils.torch_utilsimport HAS_OPAQUE_TYPE
        ...
        if current_platform.support_static_graph_mode():
            ...
            if (
                ...
                fromvllm.distributed.kv_transfer.kv_connector.factoryimport (
                    KVConnectorFactory,
                )
    ...
    defupdate_sizes_for_sequence_parallelism(self, possible_sizes: list) -> list:
    ...
    def_set_max_num_scheduled_tokens(self):
"""
...
"""
        ...
        if compilation_config.pass_config.fuse_minimax_qk_norm:
            fromvllm.compilation.passes.fusion.minimax_qk_norm_fusionimport (
                MAX_TOKEN_NUM,
            )
    ...
    deftry_verify_and_update_config(self):
        ...
        if self.model_config.convert_type == "classify":
            ...
            fromvllm.model_executor.models.adaptersimport SequenceClassificationConfig
    ...
    defcompile_debug_dump_path(self) -> Path | None:
"""Returns a rank-aware path for dumping
    ...
    def_validate_v2_model_runner(self) -> None:
"""Check for features not yet supported by the V2 model runner."""
    ...
    def_validate_return_routed_experts(self) -> None:
"""Reject parallelism configurations not yet validated with
    ...
    defvalidate_block_size(self) -> None:
"""Validate block_size against DCP and mamba constraints.
    ...
    defvalidate_nvfp4_kv_cache_with_mla(self) -> "VllmConfig":
        if self.model_config is None:
            return self
    ...
    @model_validator(mode="after")
    defvalidate_mamba_block_size(self) -> "VllmConfig":
        if self.model_config is None:
            return self
