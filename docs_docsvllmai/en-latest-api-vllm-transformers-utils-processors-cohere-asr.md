...
url: https://docs.vllm.ai/en/latest/api/vllm/transformers_utils/processors/cohere_asr/
source: sitemap
fetched_at: 2026-05-07T21:37:49.124542911-03:00
rendered_js: false
word_count: 16
summary: This document defines the FilterbankFeatures class, a PyTorch module designed to preprocess audio waveforms into Mel spectrograms for deep learning models.
tags:
    - audio-processing
    - feature-extraction
    - mel-spectrogram
...
```
classFilterbankFeatures(nn.Module):
"""Featurizer that converts wavs to Mel Spectrograms.
    ...
    deflog_zero_guard_value_fn(self, x):
    ...
    @property
    deffilter_banks(self):
        return self.fb

    defsplice_frames(self, x, frame_splicing):
"""Stacks frames together across feature dim
    ...
    defnormalize_batch(self, x, seq_len, normalize_type):
        x_mean = None
        x_std = None
    ...
    @torch.compile
    defforward(self, x, seq_len, linear_spec=False):
