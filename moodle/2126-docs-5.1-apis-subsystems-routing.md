...
url: https://moodledev.io/docs/5.1/apis/subsystems/routing
source: sitemap
fetched_at: 2026-02-17T15:37:11.139553-03:00
rendered_js: false
word_count: 287
summary: This document explains Moodle's routing system, detailing how to define routes using PHP attributes and the Slim Framework within specific component namespaces. It covers route groups, URI prefixes, and the resolution of parameters via dependency injection and middleware.
tags:
    - moodle-development
    - routing-system
    - slim-framework
...
When invoked, any parameter to the route method will be resolved using a combination of [Dependency Injection](https://moodledev.io/docs/5.1/apis/core/di) and resolution of path, query, and header parameters.
