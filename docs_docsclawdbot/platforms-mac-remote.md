...
source: llms
fetched_at: 2026-01-26T09:53:05.728099668-03:00
rendered_js: false
word_count: 634
summary: This document explains how to configure the macOS Clawdbot app to remotely control a gateway running on another host using SSH or direct connections. It covers prerequisites, transport modes, security, and troubleshooting for the Remote over SSH feature.
tags:
    - clawdbot
    - macos
    - ssh-tunnel
