---
title: Questions API | Moodle Developer Resources
url: https://moodledev.io/docs/5.1/apis/subsystems/question
source: sitemap
fetched_at: 2026-02-17T15:37:07.219188-03:00
rendered_js: false
word_count: 719
summary: This document explains the architecture of the Moodle question subsystem, detailing how the question engine and question bank work together with various plugin types to manage and deliver interactive questions.
tags:
    - moodle
    - question-subsystem
    - question-engine
...
## The question engine[​](#the-question-engine "Direct link to The question engine")
...
The main user of this in the standard Moodle package is mod\_quiz, but there is also qbank\_previewquestion, and numerous plugins, including [`filter_embedquestion`](https://moodle.org/plugins/filter_embedquestion).
...
### Question types (qtype\_)[​](#question-types-qtype_ "Direct link to Question types (qtype_)")

[Question types](https://moodledev.io/docs/5.1/apis/plugintypes/qtype) define what the question is. For example a multiple choice or drag-drop question question, or a text input question graded as with a string (e.g. shortanswer or [pattern-match](https://moodle.org/plugins/qtype_pmatch)) or as a number. It might be something much more complex, like a [crossword](https://moodle.org/plugins/qtype_crossword), or a [coding exercise](https://moodle.org/plugins/qtype_coderunner).

### Question behaviours (qbehaviour\_)[​](#question-behaviours-qbehaviour_ "Direct link to Question behaviours (qbehaviour_)")
...
### Core question engine[​](#core-question-engine "Direct link to Core question engine")
...
### Question bank plugins (qbank\_)[​](#question-bank-plugins-qbank_ "Direct link to Question bank plugins (qbank_)")

[Question bank plugins (qbank\_)](https://moodledev.io/docs/5.1/apis/plugintypes/qbank) add features to the question bank. The core question bank code mainly just ties all these features together.

### Question import/export plugins (qformat\_)[​](#question-importexport-plugins-qformat_ "Direct link to Question import/export plugins (qformat_)")
...
### Question types (qtype\_)[​](#question-types-qtype_-1 "Direct link to Question types (qtype_)")

[Question types](https://moodledev.io/docs/5.1/apis/plugintypes/qtype) were already considered above, when thinking about the the question engine. They also need to work with the question bank, so that teachers can create and edit questions of that type.