---
title: Post-Training Integration - SGLang Documentation
url: https://docs.sglang.io/docs/references/post_training_integration
source: sitemap
fetched_at: 2026-05-11T05:48:13.749514857-03:00
rendered_js: false
word_count: 368
summary: This document outlines the role of SGLang as a high-performance inference backend for LLM post-training and reinforcement learning, detailing its core technical capabilities and industry adoption across various frameworks.
tags:
    - llm-inference
