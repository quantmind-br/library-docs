...
url: https://moodledev.io/docs/4.5/apis/subsystems/enrol
source: sitemap
fetched_at: 2026-02-17T15:13:23.357862-03:00
rendered_js: false
word_count: 886
summary: This document explains the Moodle Enrolment API, detailing the core functions and plugin methods used to manage user participation, course access, and the distinction between enrolments and role assignments.
tags:
    - moodle-api
...
The enrolment API gives access to the enrolment methods and also to [enrolment plugins](https://moodledev.io/docs/4.5/apis/plugintypes/enrol) instances.
