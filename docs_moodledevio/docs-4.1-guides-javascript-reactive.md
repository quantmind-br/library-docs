...
url: https://moodledev.io/docs/4.1/guides/javascript/reactive
source: sitemap
fetched_at: 2026-02-17T14:57:20.768029-03:00
rendered_js: false
word_count: 5727
summary: This document explains Moodle's internal reactive library and the architectural patterns used to build state-driven user interface components in plugins.
tags:
    - moodle
    - reactive-ui
