...
url: https://qwenlm.github.io/qwen-code-docs/en/developers/tools/shell
source: github_pages
fetched_at: 2026-04-09T09:04:45.830365377-03:00
rendered_js: true
word_count: 1310
summary: This document details the `run_shell_command` tool, explaining how to execute shell commands from within Qwen Code by managing critical parameters like foreground/background execution status and configuring interactive session capabilities.
tags:
    - run-shell-command
    - system-interaction
...
## How to use `run_shell_command` with Qwen Code[](#how-to-use-run_shell_command-with-qwen-code)
...
### Required Background Parameter[](#required-background-parameter)
...
### Enabling Interactive Commands[](#enabling-interactive-commands)
...
### Showing Color in Output[](#showing-color-in-output)
...
### Setting the Pager[](#setting-the-pager)
...
### Command Restriction Examples[](#command-restriction-examples)
