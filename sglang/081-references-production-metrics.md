---
title: Production Metrics — SGLang
url: https://docs.sglang.io/references/production_metrics.html
source: crawler
fetched_at: 2026-02-04T08:47:16.761904409-03:00
rendered_js: false
word_count: 605
summary: This document explains how to enable and use Prometheus metrics in SGLang to monitor production performance, including token usage, cache hit rate, and latency.
tags:
    - sglang
    - prometheus
    - metrics
...
- **No Data on Dashboard:**
  ...
  - Generate some traffic to your SGLang server to produce metrics. For example, run a benchmark:
    ...
    ```
    python3-msglang.bench_serving--backendsglang--dataset-namerandom--num-prompts100--random-input128--random-output128
    ```
...
#### Check if the metrics are being collected[#](#check-if-the-metrics-are-being-collected "Link to this heading")
