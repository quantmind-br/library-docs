---
title: MiniMax-M2.5 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/MiniMax/MiniMax-M2.5
source: sitemap
fetched_at: 2026-05-11T05:50:33.939806298-03:00
rendered_js: false
word_count: 709
summary: This document provides technical instructions for deploying and invoking the MiniMax-M2.5 language model using the SGLang framework, including hardware-specific configuration parameters and setup for advanced features like reasoning parsing.
tags:
    - sglang
    - minimax
    - model-deployment
...
[MiniMax-M2.5](https://huggingface.co/MiniMaxAI/MiniMax-M2.5) is a powerful language model developed by MiniMax, built for real-world productivity with state-of-the-art performance across coding, reasoning, agentic tasks, and tool use. As the latest iteration in the MiniMax model series, MiniMax-M2.5 achieves comprehensive enhancements across multiple domains. Details are as follows:
...
H200B200A100H100MI300XMI325XMI355X
