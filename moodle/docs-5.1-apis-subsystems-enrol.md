...
url: https://moodledev.io/docs/5.1/apis/subsystems/enrol
source: sitemap
fetched_at: 2026-02-17T15:36:15.013642-03:00
rendered_js: false
word_count: 886
summary: This document describes the Moodle Enrolment API, explaining the distinction between user enrolments and role assignments while providing technical documentation for managing course access and plugin instances.
tags:
    - moodle-development
    - enrolment-api
    - user-management
...
The enrolment API gives access to the enrolment methods and also to [enrolment plugins](https://moodledev.io/docs/5.1/apis/plugintypes/enrol) instances.
