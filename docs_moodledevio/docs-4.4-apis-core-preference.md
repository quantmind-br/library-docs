...
url: https://moodledev.io/docs/4.4/apis/core/preference
source: sitemap
fetched_at: 2026-02-17T15:02:36.831105-03:00
rendered_js: false
word_count: 306
summary: This document explains the Preference API used for storing and retrieving user-specific settings in the database or session, detailing primary functions for managing these preferences.
tags:
    - moodle-api
    - user-preferences
    - data-storage
