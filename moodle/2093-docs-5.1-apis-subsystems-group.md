...
url: https://moodledev.io/docs/5.1/apis/subsystems/group
source: sitemap
fetched_at: 2026-02-17T15:36:51.548692-03:00
rendered_js: false
word_count: 1041
summary: This document explains the concepts and implementation of groups and groupings in Moodle, providing technical details on group modes, visibility settings, and the Groups API for developers.
tags:
    - moodle
    - groups
    - groupings
