...
url: https://moodledev.io/docs/4.4/apis/plugintypes/format
source: sitemap
fetched_at: 2026-02-17T15:03:05.870309-03:00
rendered_js: false
word_count: 4768
summary: This document explains the purpose, file structure, and implementation of course format plugins in Moodle, which control the layout and navigation of course content.
tags:
    - moodle
    - course-formats
    - plugin-development
...
In case your plugin is a Moodle 3.11 compatible plugin, see the [migration guide](https://moodledev.io/docs/4.4/apis/plugintypes/format/migration) for more information.
