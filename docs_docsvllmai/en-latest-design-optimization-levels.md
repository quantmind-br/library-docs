...
source: sitemap
fetched_at: 2026-05-07T21:12:26.952003423-03:00
rendered_js: false
word_count: 322
summary: This document describes the vLLM optimization levels that allow users to balance startup latency with model inference performance.
tags:
    - vllm
    - model-optimization
    - performance-tuning
...
```
# CLI usage
python-mvllm.entrypoints.api_server--modelRedHatAI/Llama-3.2-1B-FP8-O1
...
### `-O0`: No Optimization[¶](#-o0-no-optimization "Permanent link")
...
### `-O1`: Fast Optimization[¶](#-o1-fast-optimization "Permanent link")
...
### `-O2`: Full Optimization (Default)[¶](#-o2-full-optimization-default "Permanent link")
...
### `-O3`: Aggressive Optimization[¶](#-o3-aggressive-optimization "Permanent link")
