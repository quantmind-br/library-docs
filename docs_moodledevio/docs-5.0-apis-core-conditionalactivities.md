...
url: https://moodledev.io/docs/5.0/apis/core/conditionalactivities
source: sitemap
fetched_at: 2026-02-17T15:24:22.845399-03:00
rendered_js: false
word_count: 469
summary: This document provides a technical overview of the Moodle Conditional Activities API, detailing how to manage activity availability through the condition_info class. It explains how to fetch, add, update, and delete conditions related to activity completion, grades, and dates.
tags:
    - moodle-api
...
- [How to make a new availability condition plugin](https://moodledev.io/docs/5.0/apis/plugintypes/availability).
