---
title: Troubleshooting - Komorebi
url: https://lgug2z.github.io/komorebi/troubleshooting.html
source: github_pages
fetched_at: 2026-02-20T08:45:18.860904-03:00
rendered_js: true
word_count: 595
summary: This document provides solutions and workarounds for common technical issues encountered when using the komorebi tiling window manager, including window visibility, dependency configuration, and hardware-specific display problems.
tags:
    - komorebi
    - troubleshooting
    - windows-os
...
[](https://github.com/LGUG2Z/komorebi/edit/master/docs/troubleshooting.md "Edit this page")[](https://github.com/LGUG2Z/komorebi/raw/master/docs/troubleshooting.md "View source of this page")
...
- Using that information, [create a rule to ignore that window](https://lgug2z.github.io/komorebi/common-workflows/ignore-windows.html)
...
Depending on how AHK is installed the executable on your system may have a different name. In order to account for this, you may set the `KOMOREBI_AHK_EXE` environment variable in your [PowerShell profile](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_profiles?view=powershell-7.4) to match the name of the executable as it is found on your system.
