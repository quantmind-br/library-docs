...
url: https://docs.vllm.ai/en/latest/api/vllm/transformers_utils/processors/moondream3/
source: sitemap
fetched_at: 2026-05-07T21:38:05.31781448-03:00
rendered_js: false
word_count: 0
summary: This document defines the Moondream3Processor class, which handles image preprocessing and chat-template-based tokenization for the Moondream3 multimodal model.
tags:
    - moondream3
    - multimodal
    - processor
...
```
classMoondream3Processor(ProcessorMixin):
"""
...
"""
        ...
        """
        fromtransformersimport AutoTokenizer, PreTrainedTokenizerFast
        fromtransformers.utilsimport cached_file
        ...
        defload_tokenizer(repo_or_path):
            try:
...
"""
    ...
    @staticmethod
    def_image_array_to_uint8(array: np.ndarray) -> np.ndarray:
    ...
    @staticmethod
    def_to_pil_image(image: ImageInput) -> Image.Image:
...
"""
    ...
    defget_num_image_tokens(self) -> int:
