---
title: Document Chunking - Mistral AI Cookbook
url: https://docs.mistral.ai/cookbooks/mistral-ocr-documentchunking-readme
source: crawler
fetched_at: 2026-01-29T07:33:43.906662744-03:00
rendered_js: false
word_count: 250
---
...
**⚠️ Note:** This utility is made to be flexible for many document processing approaches and endpoints. By default it will only output the results of the API calls to the console or logs. You will need to modify the script to save the results, or process as your needs require.