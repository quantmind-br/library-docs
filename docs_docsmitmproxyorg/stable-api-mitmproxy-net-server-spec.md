...
source: crawler
fetched_at: 2026-01-28T14:58:33.709502601-03:00
rendered_js: false
word_count: 96
summary: This document defines the data structures and parsing logic for server specifications used to describe upstream proxies and servers in mitmproxy.
tags:
    - mitmproxy
    - server-spec
    - parsing
