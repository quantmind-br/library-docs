...
url: https://moodledev.io/docs/5.1/apis/core/dml/ddl
source: sitemap
fetched_at: 2026-02-17T15:34:13.514487-03:00
rendered_js: false
word_count: 453
summary: This document outlines the Moodle DDL API functions used to create, modify, and delete database structures such as tables, fields, and indexes during the installation and upgrade process.
tags:
    - moodle-development
    - ddl-functions
    - database-schema
...
- [DML functions](https://moodledev.io/docs/5.1/apis/core/dml): Where all the functions used to handle DB data ([DML](https://docs.moodle.org/wikipedia/Data_Manipulation_Language)) are defined.