---
title: "null"
url: https://docs.clawd.bot/platforms/mac/canvas.md
source: llms
fetched_at: 2026-01-26T09:52:54.419214717-03:00
rendered_js: false
word_count: 330
summary: This document explains the macOS Canvas panel, a web-based visual workspace for rendering HTML content and A2UI surfaces controlled via an agent API. It details the system's storage paths, custom URL schemes, supported agent commands, and security protocols.
tags:
    - macos-app
    - canvas
    - a2ui
