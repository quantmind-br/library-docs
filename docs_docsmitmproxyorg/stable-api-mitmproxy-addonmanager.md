...
source: crawler
fetched_at: 2026-01-28T15:01:12.984474957-03:00
rendered_js: false
word_count: 1665
summary: This document explains the implementation and functionality of the AddonManager class in mitmproxy, which manages the lifecycle of addons, including loading, registering, and removing them.
tags:
    - addon-management
    - mitmproxy
    - python-library
