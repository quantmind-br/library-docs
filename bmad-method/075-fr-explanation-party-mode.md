---
title: Party Mode
url: https://docs.bmad-method.org/fr/explanation/party-mode/
source: sitemap
fetched_at: 2026-04-08T11:30:23.334333041-03:00
rendered_js: false
word_count: 510
summary: This document describes the 'Party Mode' feature, which allows grouping multiple specialized AI agents into a single conversation space. This mode is designed to facilitate complex discussions like brainstorming sessions, major decision-making processes, and post-incident reviews by enabling dynamic interaction between various expert roles.
tags:
    - ai-agents
    - conversation-mode
    - brainstorming
...
[Section intitulée « Qu’est-ce que le Party Mode ? »](#quest-ce-que-le-party-mode)
...
[Section intitulée « Remettre en question une mauvaise architecture »](#remettre-en-question-une-mauvaise-architecture)
...
**Vous :** « Monolithe ou microservices pour le MVP[1](#user-content-fn-1) ? »
...
**PM :** « D’accord. Le time-to-market[2](#user-content-fn-2) compte plus que la scalabilité théorique. »

**Développeur :** « Monolithe avec des frontières de modules claires. On pourra extraire des services plus tard si nécessaire. »

1. MVP (Minimum Viable Product) : version minimale d’un produit contenant juste assez de fonctionnalités pour être utilisée par des utilisateurs précoces et valider les hypothèses de marché avant d’investir dans un développement plus complet. [↩](#user-content-fnref-1)
2. Time-to-market : délai nécessaire pour concevoir, développer et lancer un produit sur le marché. Plus ce délai est court, plus l’entreprise peut prendre de l’avance sur ses concurrents. [↩](#user-content-fnref-2)