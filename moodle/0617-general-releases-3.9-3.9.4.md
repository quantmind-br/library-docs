---
title: Moodle 3.9.4 | Moodle Developer Resources
url: https://moodledev.io/general/releases/3.9/3.9.4
source: sitemap
fetched_at: 2026-02-17T16:14:26.465179-03:00
rendered_js: false
word_count: 713
summary: This document outlines the release notes for Moodle version 3.9.4, detailing general bug fixes, accessibility improvements, and critical security updates.
tags:
    - moodle
    - release-notes
    - security-fixes
...
Here is [the full list of fixed issues in 3.9.4](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%223.9.4%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
- [Notes de mise à jour de Moodle 3.9.4](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_3.9.4)
