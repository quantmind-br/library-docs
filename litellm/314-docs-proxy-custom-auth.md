...
#### 1. Create a custom auth file.[​](#1-create-a-custom-auth-file "Direct link to 1. Create a custom auth file.")
...
asyncdefuser_api_key_auth(request: Request, api_key:str)-> UserAPIKeyAuth:
try:
...
## UserAPIKeyAuth Fields Reference[​](#userapikeyauth-fields-reference "Direct link to UserAPIKeyAuth Fields Reference")

The `UserAPIKeyAuth` object supports the following fields for comprehensive auth configuration:

### Core Authentication Fields[​](#core-authentication-fields "Direct link to Core Authentication Fields")
...
### Budget and Spend Tracking[​](#budget-and-spend-tracking "Direct link to Budget and Spend Tracking")
...
### End User Tracking[​](#end-user-tracking "Direct link to End User Tracking")
...
### Model and Route Access[​](#model-and-route-access "Direct link to Model and Route Access")
...
### Object Permission Example (MCP, agents, etc.)[​](#object-permission-example-mcp-agents-etc "Direct link to Object Permission Example (MCP, agents, etc.)")
...
## ✨ Support LiteLLM Virtual Keys + Custom Auth[​](#-support-litellm-virtual-keys--custom-auth "Direct link to ✨ Support LiteLLM Virtual Keys + Custom Auth")
...
#### Bubble up custom exceptions[​](#bubble-up-custom-exceptions "Direct link to Bubble up custom exceptions")
