...
source: llms
fetched_at: 2026-04-16T22:29:13.79137137-03:00
rendered_js: false
word_count: 997
summary: This document explains how to manage tool access within the Claude Agent SDK using permission modes, allow/deny rules, and hooks.
tags:
    - claude-agent-sdk
    - permission-control
    - tool-use
