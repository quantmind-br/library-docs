...
url: https://github.com/openagen/zeroclaw/blob/master/docs/i18n/vi/config-reference.md
source: git
fetched_at: 2026-05-02T14:51:07.734523678-03:00
rendered_js: false
word_count: 3606
summary: This document provides a comprehensive reference for the ZeroClaw configuration schema, including settings for observability, agent behavior, sub-agent definitions, runtime options, and budget tracking.
tags:
    - zeroclaw
    - configuration
    - toml
...
## 1. Thứ tự tìm config khi khởi động
...
> [!note]
> Cấu hình giám sát, logging và metrics
...
## 4. Ghi đè provider qua biến môi trường
...
> [!note]
> Cấu hình tích hợp Composio (OAuth tools)
...
> [!note]
> Cấu hình hỗ trợ đa phương tiện (ảnh)
...
> [!note]
> Cấu hình mức độ tự chủ (autonomy level)
...
## 18. `[[model_routes]]` và `[[embedding_routes]]`
...
> [!tip]
> Xem [[111-i18n-vi-channels-reference|channels-reference.md]] để biết ma trận kênh và hành vi allowlist chi tiết.

### 20.1 `[channels_config.whatsapp]`
...
- Xem [[076-hardware-hardware-peripherals-design|hardware-peripherals-design.md]] để biết chi tiết giao thức.
...
- Xem [[076-hardware-hardware-peripherals-design|hardware-peripherals-design.md]] để biết giao thức bo mạch và ghi chú firmware.

---

## 23. Giá trị mặc định liên quan bảo mật
...
- [[111-i18n-vi-channels-reference|channels-reference.md]]
- [[118-i18n-vi-providers-reference|providers-reference.md]]
- [[041-i18n-vi-operations-runbook|operations-runbook.md]]
- [[140-i18n-vi-troubleshooting|troubleshooting.md]]

#zeroclaw #configuration #toml #ai-agent #schema #runtime-settings #vietnamese-docs