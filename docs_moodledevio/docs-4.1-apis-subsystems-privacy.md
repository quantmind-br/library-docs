...
url: https://moodledev.io/docs/4.1/apis/subsystems/privacy
source: sitemap
fetched_at: 2026-02-17T14:56:50.522156-03:00
rendered_js: false
word_count: 4733
summary: This document outlines the API changes and implementation requirements for Moodle plugin developers to ensure GDPR compliance through the core_privacy subsystem.
tags:
    - moodle
    - gdpr
    - plugin-development
...
- While implementing the privacy API into your plugin, there are CLI scripts that can help you to test things on the fly. Just don't forget these are not supposed to replace proper unit tests. See [Privacy API/Utilities](https://moodledev.io/docs/4.1/apis/subsystems/privacy/utils) for details.
...
- [Subject Access Request FAQ](https://moodledev.io/docs/4.1/apis/subsystems/privacy/faq)
- [GDPR](https://docs.moodle.org/en/GDPR) in the user documentation
- [Privacy API/Utilities](https://moodledev.io/docs/4.1/apis/subsystems/privacy/utils) provides CLI scripts that are helpful during development