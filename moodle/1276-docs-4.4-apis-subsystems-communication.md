...
url: https://moodledev.io/docs/4.4/apis/subsystems/communication
source: sitemap
fetched_at: 2026-02-17T15:03:58.788719-03:00
rendered_js: false
word_count: 1473
summary: This document explains the Communication API, which enables asynchronous management of rooms and members across different messaging providers through ad-hoc tasks and hooks.
tags:
    - communication-api
    - messaging-system
    - ad-hoc-tasks
...
The Communication API takes advantage of the [Hooks API](https://moodledev.io/docs/4.4/apis/plugintypes/communication) with actions performed in the following way:
