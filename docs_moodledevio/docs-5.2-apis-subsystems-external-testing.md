...
url: https://moodledev.io/docs/5.2/apis/subsystems/external/testing
source: sitemap
fetched_at: 2026-02-17T15:45:37.034065-03:00
rendered_js: false
word_count: 0
summary: This document provides unit tests for a Moodle external function to verify the execution logic and capability checks of a web service method.
tags:
    - moodle
    - unit-testing
    - external-functions
