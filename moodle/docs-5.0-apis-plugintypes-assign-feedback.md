...
url: https://moodledev.io/docs/5.0/apis/plugintypes/assign/feedback
source: sitemap
fetched_at: 2026-02-17T15:25:20.303828-03:00
rendered_js: false
word_count: 1390
summary: This document provides technical specifications and implementation instructions for developing assignment feedback plugins in Moodle, covering file structures, naming conventions, and essential class methods.
tags:
    - moodle-development
    - assignment-feedback
    - plugin-api
...
Some of the important files are described below. See the [common plugin files](https://moodledev.io/docs/5.0/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
