...
url: https://moodledev.io/docs/5.0/apis/subsystems/check
source: sitemap
fetched_at: 2026-02-17T15:27:08.852592-03:00
rendered_js: false
word_count: 1833
summary: This document explains the Moodle Check API, which provides a unified framework for performing runtime system tests, monitoring health, and implementing custom plugin-based checks.
tags:
    - moodle-development
    - check-api
    - runtime-testing
