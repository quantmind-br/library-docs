...
url: https://moodledev.io/docs/5.1/apis/subsystems/files
source: sitemap
fetched_at: 2026-02-17T15:36:32.765014-03:00
rendered_js: false
word_count: 1326
summary: This document explains the Moodle File API, detailing how files are organized into file areas and the process for generating URLs and serving files to users through component-specific callbacks.
tags:
    - moodle-development
    - file-api
    - file-storage
...
- The [Repository API](https://moodledev.io/docs/5.1/apis/plugintypes/repository) is responsible for the code paths associated with uploading files to Moodle. This includes Repository plugins.
- [Using the File API in Moodle forms](https://moodledev.io/docs/5.1/apis/subsystems/form/usage/files)
- Additional detail of how this API works is discussed in the [File API internals](https://moodledev.io/docs/5.1/apis/subsystems/files/internals)
...
You will typically use the [Forms API](https://docs.moodle.org/dev/Forms_API) to accept files from users. This topic is detailed in more detail in the [Using the File API in Moodle forms](https://moodledev.io/docs/5.1/apis/subsystems/form/usage/files) documentation.
...
- [File API internals](https://moodledev.io/docs/5.1/apis/subsystems/files/internals) how the File API works internally.
- [Using the File API in Moodle forms](https://moodledev.io/docs/5.1/apis/subsystems/form/usage/files)
