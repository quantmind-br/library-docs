---
title: Piecewise CUDA Graph - SGLang Documentation
url: https://docs.sglang.io/docs/advanced_features/piecewise_cuda_graph
source: sitemap
fetched_at: 2026-05-11T05:49:30.143597489-03:00
rendered_js: false
word_count: 1175
summary: This document explains the Piecewise CUDA Graph (PCG) feature in SGLang, which optimizes model performance by splitting the computational graph into smaller pieces to handle dynamic token lengths during prefill and extend phases.
tags:
    - sglang
    - cuda-graphs
...
Token rangeStep size4 – 32448 – 25616288 – 51232576 – 1024641280 – 40962564096+512
