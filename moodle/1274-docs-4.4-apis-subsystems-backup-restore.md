...
url: https://moodledev.io/docs/4.4/apis/subsystems/backup/restore
source: sitemap
fetched_at: 2026-02-17T15:03:56.369467-03:00
rendered_js: false
word_count: 296
summary: This document explains how to use the Moodle Restore API to recover plugin data from backup files, detailing the required file structures, restore plans, tasks, and steps.
tags:
    - moodle-development
    - restore-api
    - backup-restoration
