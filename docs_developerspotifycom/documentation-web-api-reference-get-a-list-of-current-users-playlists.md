...
source: crawler
fetched_at: 2026-02-27T23:38:00.605333-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response format for retrieving a user's saved shows via the Spotify API.
tags:
    - spotify-api
    - json-response
    - user-shows
