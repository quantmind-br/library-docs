...
url: https://moodledev.io/docs/4.5/apis/core/conditionalactivities
source: sitemap
fetched_at: 2026-02-17T15:11:01.875853-03:00
rendered_js: false
word_count: 469
summary: This document explains the Moodle Conditional Activities API, which manages the availability and visibility of course activities based on specific criteria like grades, dates, or completion status.
tags:
    - moodle-development
...
- [How to make a new availability condition plugin](https://moodledev.io/docs/4.5/apis/plugintypes/availability).
