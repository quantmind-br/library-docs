...
source: llms
fetched_at: 2026-02-05T21:41:35.86553416-03:00
rendered_js: false
word_count: 1145
summary: This document provides instructions on how to access and modify the configuration settings for droid, detailing the file locations across operating systems and the various available parameters.
tags:
    - configuration
    - droid-ai
    - cli-settings
