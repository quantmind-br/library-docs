...
source: sitemap
fetched_at: 2026-05-07T21:12:31.036227045-03:00
rendered_js: false
word_count: 1798
summary: This document explains the design and implementation of prefix caching in vLLM, detailing its hash-based block identification, multi-modal support, and cache isolation strategies.
tags:
    - vllm
    - kv-cache
    - prefix-caching
...
[![Component Overview](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/overview.png)](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/overview.png)
...
[![Free queue after a request us freed](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/free.png)](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/free.png)
...
[![Example Time 1](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-1.png)](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-1.png)

**Time 2: Request 0 makes the block 3 full and asks for a new block to keep decoding.** We cache block 3 and allocate block 4.

[![Example Time 2](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-3.png)](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-3.png)
...
[![Example Time 3](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-4.png)](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-4.png)
...
[![Example Time 4](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-5.png)](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-5.png)

**Time 5: Request 1 is finished and free.**

[![Example Time 5](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-6.png)](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-6.png)
...
[![Example Time 6](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-7.png)](https://docs.vllm.ai/en/latest/assets/design/prefix_caching/example-time-7.png)