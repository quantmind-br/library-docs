...
source: llms
fetched_at: 2026-04-16T22:33:49.895348217-03:00
rendered_js: false
word_count: 692
summary: This document explains how to use and create different output styles in Claude Code to modify the AI's persona, tone, and response format.
tags:
    - claude-code
    - output-styles
    - system-prompt
