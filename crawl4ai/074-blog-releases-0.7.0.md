---
title: "\U0001F680 Crawl4AI v0.7.0: The Adaptive Intelligence Update"
url: https://docs.crawl4ai.com/blog/releases/0.7.0/
source: sitemap
fetched_at: 2026-04-26T07:46:24.563597197-03:00
rendered_js: false
word_count: 985
summary: This document outlines the v0.7.0 update for Crawl4AI, introducing adaptive learning, virtual scrolling capabilities, and intelligent link scoring to improve data extraction robustness and automation.
tags:
    - web-scraping
    - adaptive-crawling
    - automation
...
```
fromcrawl4aiimport AsyncWebCrawler, AdaptiveCrawler, AdaptiveConfig
importasyncio
...
```
importasyncio
fromcrawl4aiimport CrawlerRunConfig, CacheMode, AsyncWebCrawler
fromcrawl4ai.adaptive_crawlerimport LinkPreviewConfig
...
01. **Intrinsic Score**: Based on link quality indicators
02. Position on page (navigation, content, footer)
03. Link attributes (rel, title, class names)
04. Anchor text quality and length
05. URL structure and depth
06. **Contextual Score**: Relevance to your query using BM25 algorithm
07. Keyword matching in link text and title
08. Meta description analysis
09. Content preview scoring
...
```
# Old (v0.6.x)
fromcrawl4aiimport CrawlerConfig
config = CrawlerConfig(timeout=30000)

# New (v0.7.0)
fromcrawl4aiimport CrawlerRunConfig, BrowserConfig
