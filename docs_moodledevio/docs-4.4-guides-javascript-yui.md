...
url: https://moodledev.io/docs/4.4/guides/javascript/yui
source: sitemap
fetched_at: 2026-02-17T15:05:32.179448-03:00
rendered_js: false
word_count: 888
summary: This document outlines the integration of the Yahoo! User Interface (YUI) framework within Moodle, explaining its modular architecture, development tools like Grunt and JSHint, and specific configuration settings for JavaScript development.
tags:
    - moodle
    - yui
...
Moodle uses [Grunt](https://moodledev.io/docs/4.4/guides/javascript#grunt) for most JavaScript management. We recommend reading our Grunt documentation for further information on the available commands.
