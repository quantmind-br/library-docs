---
title: GLM-5.1 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/GLM/GLM-5.1
source: sitemap
fetched_at: 2026-05-11T05:50:49.866726612-03:00
rendered_js: false
word_count: 648
summary: This document provides configuration and deployment instructions for serving the GLM-5.1 large language model using SGLang on various NVIDIA and AMD hardware platforms. It includes details on quantization, speculative decoding, hardware-specific optimizations, and reasoning mode usage.
tags:
    - sglang
    - glm-5-1
    - model-deployment
...
H200B200GB300H100MI300XMI325XMI355X
...
HardwareFP8BF16H100tp=16tp=32H200tp=8tp=16B200tp=8tp=16GB300tp=4—MI300X/MI325Xtp=8tp=8MI355Xtp=8tp=8
...
- For other configuration tips, please refer to [DeepSeek V3.2 documentation](https://docs.sglang.io/docs/basic_usage/deepseek_v32). GLM-5.1 and DeepSeek V3.2 share the same model structure, so the optimization techniques between these two models are also common (MTP, DSA kernel, Context Parallel…).
