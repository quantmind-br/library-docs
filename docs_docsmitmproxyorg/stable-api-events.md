...
source: crawler
fetched_at: 2026-01-28T16:18:24.393086495-03:00
rendered_js: false
word_count: 1152
summary: This document provides a comprehensive reference of all available event hooks that mitmproxy addons can implement, detailing their purpose and when they are triggered.
tags:
    - mitmproxy
    - addons
    - event-hooks
