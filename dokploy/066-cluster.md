...
source: crawler
fetched_at: 2026-02-08T04:01:36.586890387-03:00
rendered_js: false
word_count: 540
summary: This document explains how to scale applications in Dokploy through vertical and horizontal methods, specifically detailing the setup of server clusters using Docker Swarm. It covers the configuration of external registries and the addition of manager and worker nodes to distribute application traffic.
tags:
    - dokploy
    - docker-swarm
    - cluster-management
