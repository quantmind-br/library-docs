...
url: https://moodledev.io/docs/4.5/tags/theme
source: sitemap
fetched_at: 2026-02-17T15:10:15.276776-03:00
rendered_js: false
word_count: 208
summary: This document provides an overview of the core components and architecture for Moodle theme development, covering fonts, images, layout definitions, and CSS styling.
tags:
    - moodle-development
    - theme-plugins
    - css-styling
