---
title: MiniCPM-V 4.6 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/OpenBMB/MiniCPM-V-4_6
source: sitemap
fetched_at: 2026-05-11T05:50:20.595525584-03:00
rendered_js: false
word_count: 1026
summary: This document provides a technical guide for deploying and utilizing the MiniCPM-V 4.6 multimodal model within the SGLang inference framework, covering installation, configuration, and API usage.
tags:
    - sglang
    - minicpm-v
    - multimodal-model
...
For the general SGLang installation guide (PyPI, source, Docker) see the [official SGLang installation guide](https://docs.sglang.io/docs/get-started/install).
