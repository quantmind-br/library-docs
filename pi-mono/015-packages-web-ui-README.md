...
source: git
fetched_at: 2026-03-03T03:47:26.717048-03:00
rendered_js: false
word_count: 1539
summary: Provides a reusable web UI library for building AI chat interfaces, integrating components like chat panels, artifact panels, and tools for handling documents, code, and API interactions.
tags:
    - ai-chat-ui
    - web-components
    - react-like-syntax
