...
source: crawler
fetched_at: 2026-01-28T16:18:45.748060526-03:00
rendered_js: false
word_count: 393
summary: This document defines the `UDPMessage` and `UDPFlow` classes, which are core components for representing and managing UDP datagrams and sessions within the mitmproxy framework.
tags:
    - mitmproxy
    - udp-flow
    - udp-message
