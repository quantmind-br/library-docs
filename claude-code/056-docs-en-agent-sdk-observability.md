...
source: llms
fetched_at: 2026-04-16T22:29:10.003965838-03:00
rendered_js: false
word_count: 1203
summary: This guide explains how to configure and export telemetry data, including traces, metrics, and logs, from the Agent SDK using OpenTelemetry protocols.
tags:
    - opentelemetry
    - agent-sdk
    - observability
