...
url: https://docs.bmad-method.org/fr/explanation/established-projects-faq/
source: sitemap
fetched_at: 2026-04-08T11:30:21.223072301-03:00
rendered_js: false
word_count: 361
summary: This document addresses frequently asked questions regarding the use of the BMad method (BMM) when working with pre-existing software projects. It advises on running initial project documentation, handling omissions, and confirms compatibility with Quick Dev for maintaining code consistency.
tags:
    - bmad
    - bmm
    - project-setup
...
- [Dois-je d’abord exécuter document-project ?](#dois-je-dabord-ex%C3%A9cuter-document-project)
- [Que faire si j’oublie d’exécuter document-project ?](#que-faire-si-joublie-dex%C3%A9cuter-document-project)
...
[Section intitulée « Dois-je d’abord exécuter document-project ? »](#dois-je-dabord-ex%C3%A9cuter-document-project)
...
[Section intitulée « Que faire si j’oublie d’exécuter document-project ? »](#que-faire-si-joublie-dex%C3%A9cuter-document-project)
...
[Section intitulée « Puis-je utiliser Quick Dev pour les projets existants ? »](#puis-je-utiliser-quick-dev-pour-les-projets-existants)
...
[Section intitulée « Que faire si mon code existant ne suit pas les bonnes pratiques ? »](#que-faire-si-mon-code-existant-ne-suit-pas-les-bonnes-pratiques)
