...
url: https://moodledev.io/docs/5.0/tags/file-converter
source: sitemap
fetched_at: 2026-02-17T15:18:52.670427-03:00
rendered_js: false
word_count: 69
summary: This document explains the purpose and implementation of file converters in Moodle, detailing how they allow plugins to transform files between different formats via a dedicated API.
tags:
    - moodle
    - file-conversion
    - api-reference
