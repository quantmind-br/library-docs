---
title: Quick Dev
url: https://docs.bmad-method.org/fr/explanation/quick-dev/
source: sitemap
fetched_at: 2026-04-08T11:30:30.002351603-03:00
rendered_js: false
word_count: 1153
summary: This document details the concept of 'Quick Dev,' a workflow designed to optimize development cycles by allowing large periods of autonomous LLM execution while minimizing human intervention. It emphasizes structuring human input into clear intentions, routing changes efficiently, and diagnosing failures at the correct conceptual level rather than merely correcting code.
tags:
    - llm-workflow
...
![Diagramme du workflow Quick Dev](https://docs.bmad-method.org/diagrams/quick-dev-diagram-fr.webp)

## Pourquoi cette fonctionnalité existe

[Section intitulée « Pourquoi cette fonctionnalité existe »](#pourquoi-cette-fonctionnalit%C3%A9-existe)
...
[Section intitulée « La conception fondamentale »](#la-conception-fondamentale)

### 1. Compresser l’intention d’abord

[Section intitulée « 1. Compresser l’intention d’abord »](#1-compresser-lintention-dabord)
...
[Section intitulée « 2. Router vers le chemin le plus court et sûr »](#2-router-vers-le-chemin-le-plus-court-et-s%C3%BBr)
...
[Section intitulée « 3. S’exécuter plus longtemps avec moins de supervision »](#3-sex%C3%A9cuter-plus-longtemps-avec-moins-de-supervision)
...
[Section intitulée « 4. Diagnostiquer les échecs au bon niveau »](#4-diagnostiquer-les-%C3%A9checs-au-bon-niveau)
...
[Section intitulée « 5. Ne faire intervenir l’humain que si nécessaire »](#5-ne-faire-intervenir-lhumain-que-si-n%C3%A9cessaire)
...
[Section intitulée « Pourquoi le système de revue est important »](#pourquoi-le-syst%C3%A8me-de-revue-est-important)
...
Ce workflow fonctionne mieux sur une plateforme capable de générer des sous-agents[1](#user-content-fn-1), ou au moins d’invoquer un autre LLM via la ligne de commande et d’attendre un résultat. Si votre plateforme ne supporte pas cela nativement, vous pouvez ajouter un skill pour le faire. Les sous-agents sans contexte sont une pierre angulaire de la conception de la revue.

Les revues agentiques[2](#user-content-fn-2) échouent souvent de deux manières :
...
Quick Dev aborde ces deux problèmes en traitant la revue comme un triage[3](#user-content-fn-3).
...
1. Sous-agent : agent IA secondaire créé temporairement pour effectuer une tâche spécifique (comme une revue de code) de manière isolée, sans hériter du contexte complet de l’agent principal, ce qui permet une analyse plus objective et impartiale. [↩](#user-content-fnref-1)
2. Revues agentiques (agentic review) : revue de code effectuée par un agent IA de manière autonome, capable d’analyser, d’identifier des problèmes et de formuler des recommandations sans intervention humaine directe. [↩](#user-content-fnref-2)
3. Triage : processus de filtrage et de priorisation des observations issues d’une revue, afin de distinguer les problèmes pertinents à traiter immédiatement de ceux qui peuvent être mis de côté pour plus tard. [↩](#user-content-fnref-3)