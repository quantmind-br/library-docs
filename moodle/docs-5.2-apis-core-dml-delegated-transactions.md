...
url: https://moodledev.io/docs/5.2/apis/core/dml/delegated-transactions
source: sitemap
fetched_at: 2026-02-17T15:43:26.129556-03:00
rendered_js: false
word_count: 438
summary: This document explains the implementation and usage of delegated database transactions in Moodle, including principles for nested transactions, error handling requirements, and the associated PHP API methods.
tags:
    - moodle-development
