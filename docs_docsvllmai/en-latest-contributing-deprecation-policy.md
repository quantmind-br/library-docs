...
source: sitemap
fetched_at: 2026-05-07T21:11:17.637697756-03:00
rendered_js: false
word_count: 442
summary: This document defines the formal lifecycle and staged process for deprecating features within the vLLM project, ensuring users receive adequate notice and predictable transitions.
tags:
    - deprecation-policy
    - software-lifecycle
    - versioning
...
### 2. Deprecated (Off By Default)[¶](#2-deprecated-off-by-default "Permanent link")
...
Release Status `v0.9.0` Feature is deprecated with clear removal version listed. `v0.10.0` Feature is now off by default, throws an error when used, and can be re-enabled for legacy use. `v0.11.0` Feature is removed.
