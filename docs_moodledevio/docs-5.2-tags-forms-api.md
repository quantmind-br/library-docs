...
url: https://moodledev.io/docs/5.2/tags/forms-api
source: sitemap
fetched_at: 2026-02-17T15:40:08.441899-03:00
rendered_js: false
word_count: 191
summary: This document describes advanced features of the Moodle Form API, including techniques for managing element visibility, grouping checkboxes, and handling dynamic form sections.
tags:
    - moodle-forms
    - form-api
    - ui-components
