...
source: llms
fetched_at: 2026-04-16T22:28:41.228021327-03:00
rendered_js: false
word_count: 3660
summary: This document explains the internal mechanics of the Agent SDK's execution loop, covering the lifecycle of agent sessions from prompt initiation to final result delivery. It details how turns function through tool-use cycles and provides a breakdown of different message types used for monitoring and handling agent behavior.
tags:
    - agentic-loop
    - llm-architecture
    - sdk-documentation
