...
url: https://zellij.dev/news/new-ui/
source: sitemap
fetched_at: 2026-01-24T15:52:54.447039056-03:00
rendered_js: false
word_count: 651
summary: This document announces the release of Zellij version 0.16.0, detailing new features such as the pane frame UI, updated keybindings, and improvements to the resizing algorithm and layout templates.
tags:
    - zellij
...
![](https://zellij.dev/img/sixteen-post-frames.png)
...
![](https://zellij.dev/img/sixteen-post-session-name.png)

![](https://zellij.dev/img/sixteen-post-list-sessions.png)
...
![](https://zellij.dev/img/sixteen-post-clipboard.png)

Note that copying to the clipboard doesn’t yet work with Gnome Terminal due to this issue: [https://gitlab.gnome.org/GNOME/vte/-/issues/125](https://gitlab.gnome.org/GNOME/vte/-/issues/125)
...
[https://github.com/zellij-org/zellij/releases/tag/v0.16.0](https://github.com/zellij-org/zellij/releases/tag/v0.16.0)