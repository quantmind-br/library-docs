...
url: https://docs.vllm.ai/en/latest/examples/ray_serving/batch_llm_inference/
source: sitemap
fetched_at: 2026-05-07T21:13:33.744401537-03:00
rendered_js: false
word_count: 6
summary: This document explains how to perform large-scale batch inference with vLLM using Ray Data for distributed data processing and parallel execution.
tags:
    - vllm
    - ray-data
    - batch-inference
...
[](https://github.com/vllm-project/vllm/edit/main/docs/examples/ray_serving/batch_llm_inference.md "Edit this page")

Source [https://github.com/vllm-project/vllm/blob/main/examples/ray\_serving/batch\_llm\_inference.py](https://github.com/vllm-project/vllm/blob/main/examples/ray_serving/batch_llm_inference.py).
...
fromray.data.llmimport build_llm_processor, vLLMEngineProcessorConfig
