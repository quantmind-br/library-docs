...
First, sign up to get an API\_KEY on the [Athina dashboard](https://app.athina.ai).
...
You can send some additional information to Athina by using the `metadata` field in completion. This can be useful for sending metadata about the request, such as the customer\_id, prompt\_slug, or any other information you want to track.
...
- `session_id: Optional[str]` - is the session or conversation ID. This is used for grouping different inferences into a conversation or chain. \[Read more].([https://docs.athina.ai/logging/grouping\_inferences](https://docs.athina.ai/logging/grouping_inferences))
...
## Using a self hosted deployment of Athina[​](#using-a-self-hosted-deployment-of-athina "Direct link to Using a self hosted deployment of Athina")
...
## Support & Talk with Athina Team[​](#support--talk-with-athina-team "Direct link to Support & Talk with Athina Team")
