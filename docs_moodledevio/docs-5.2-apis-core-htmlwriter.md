...
url: https://moodledev.io/docs/5.2/apis/core/htmlwriter
source: sitemap
fetched_at: 2026-02-17T15:43:33.356947-03:00
rendered_js: false
word_count: 57
summary: This document explains how to use the Moodle HTML writer class to programmatically generate HTML elements and attributes within renderer functions.
tags:
    - moodle-development
    - html-writer
    - php
...
Please consider using [templates](https://moodledev.io/docs/5.2/guides/templates) as an alternative to the *HTML writer*.
