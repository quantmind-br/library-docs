---
title: vllm bench mm-processor - vLLM
url: https://docs.vllm.ai/en/latest/cli/bench/mm_processor/
source: sitemap
fetched_at: 2026-05-07T21:10:59.678925629-03:00
rendered_js: false
word_count: 8228
summary: This document describes the vLLM multimodal processor benchmark tool, which allows users to profile and measure the latency of individual preprocessing and encoding stages for vision-language models.
tags:
    - vllm
    - benchmarking
    - multimodal-models
...
[](https://github.com/vllm-project/vllm/edit/main/docs/cli/bench/mm_processor.md "Edit this page")
...
## Measured Stages[¶](#measured-stages "Permanent link")
...
For more examples (HF datasets, warmup, JSON output), see [Benchmarking CLI — Multimodal Processor Benchmark](https://docs.vllm.ai/en/latest/benchmarking/cli/#multimodal-processor-benchmark).
