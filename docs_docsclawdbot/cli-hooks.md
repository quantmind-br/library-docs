---
title: "null"
url: https://docs.clawd.bot/cli/hooks.md
source: llms
fetched_at: 2026-01-26T09:50:46.200690641-03:00
rendered_js: false
word_count: 399
summary: This document provides a comprehensive command reference for managing agent hooks, covering installation, status checking, and the activation of event-driven automations via the CLI.
tags:
    - clawdbot-cli
    - hooks-management
    - automation-events
