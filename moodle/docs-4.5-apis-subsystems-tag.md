...
url: https://moodledev.io/docs/4.5/apis/subsystems/tag
source: sitemap
fetched_at: 2026-02-17T15:15:13.59532-03:00
rendered_js: false
word_count: 1190
summary: This document explains how to implement and use the Moodle Tag API to assign, manage, and display labels for various content types within the system.
tags:
    - moodle
    - tag-api
    - plugin-development
...
There are more options such as specifying the default value for "Standard tags", having a fixed collection or excluding from search. They can be found in comments in [Core library tag.php](https://moodledev.io/docs/4.5/apis/commonfiles/tag.php)
...
- [Core library tag.php](https://moodledev.io/docs/4.5/apis/commonfiles/tag.php)
