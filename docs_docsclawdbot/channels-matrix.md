...
source: llms
fetched_at: 2026-01-26T09:50:19.118194512-03:00
rendered_js: false
word_count: 980
summary: This document provides instructions for installing and configuring the Matrix plugin for Clawdbot, including setup for messaging, rooms, and end-to-end encryption.
tags:
    - matrix-plugin
    - bot-setup
    - e2ee
