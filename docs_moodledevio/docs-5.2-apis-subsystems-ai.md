...
url: https://moodledev.io/docs/5.2/apis/subsystems/ai
source: sitemap
fetched_at: 2026-02-17T15:45:08.705157-03:00
rendered_js: false
word_count: 1298
summary: This document provides an architectural overview of the Moodle AI Subsystem, detailing its core components and the design principles governing how placements, providers, and actions interact.
tags:
    - moodle-lms
    - ai-subsystem
    - plugin-development
...
The AI Subsystem in Moodle LMS provides a consistent and user-friendly way for users to interact with AI in Moodle. It has been designed for easy integration with various AI providers and the development of [AI plugins](https://moodledev.io/docs/5.2/apis/plugintypes/ai).
...
However, in the context of Moodle, we are simplifying the term 'AI' to mean the tools and actions AI technologies provide to the LMS learning experience. These AI tools are supplied in the form of [plugins](https://moodledev.io/docs/5.2/apis/plugintypes/ai) that feature a set of possible actions.

For example, the [Placement plugin](https://moodledev.io/docs/5.2/apis/plugintypes/ai/placement) allows users to gain access to the Course Assistant. This AI tool enables users to have information within their course summarised by the integrated AI.
...
See the [Placements](https://moodledev.io/docs/5.2/apis/plugintypes/ai/placement) documentation for more information on developing Placement plugins.

### Providers[​](#providers "Direct link to Providers")

Providers are the interface between the [AI subsystem](https://moodledev.io/docs/5.2/apis/subsystems/ai) and external AI. Their focus should be on converting the data requested into the format needed by the external AI, and then correctly providing the response back.

See the [Providers](https://moodledev.io/docs/5.2/apis/plugintypes/ai/provider) documentation for more information on developing Provider plugins.
...
We can define a set of models that are available for the Actions of the Providers. See the [Pre-defined Models](https://moodledev.io/docs/5.2/apis/plugintypes/ai/provider#predefined-models) documentation for more information on developing Pre-defined Models for Provider plugins.
