...
url: https://zellij.dev/news/welcome-screen-pipes-filepicker/
source: sitemap
fetched_at: 2026-01-24T15:52:42.457516286-03:00
rendered_js: false
word_count: 933
summary: This document announces the release of Zellij 0.40.0, detailing major new features such as the welcome screen, a redesigned filepicker, inter-plugin communication pipes, and performance optimizations.
tags:
    - zellij-release
...
![An image of the Zellij welcome screen with the Zellij filepicker opened to select the location of the session](https://zellij.dev/img/welcome-screen-preview.png)
...
![A demo of the Zellij welcome screen](https://zellij.dev/img/welcome-screen.gif)
...
Learn more about [session management](https://zellij.dev/tutorials/session-management).

## New Strider / Filepicker

![A demo of the Zellij filepicker fuzzy finding files and opening them in vim, then finding folders and opening a terminal in their location.](https://zellij.dev/img/filepicker-demo.gif)
...
Learn more about [the filepicker](https://zellij.dev/tutorials/filepicker).
...
[Learn more about Pipes](https://zellij.dev/documentation/plugin-pipes.html)
