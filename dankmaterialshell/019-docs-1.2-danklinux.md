...
source: sitemap
fetched_at: 2026-02-22T18:42:31.540195-03:00
rendered_js: false
word_count: 552
summary: This document provides an overview of the DankLinux repository and detailed instructions for installing desktop components like DankMaterialShell and niri across various Linux distributions.
tags:
    - danklinux
    - repository-setup
    - installation-guide
...
For complete DMS installation instructions including repository setup, see the [DankMaterialShell Installation Guide](https://danklinux.com/docs/1.2/dankmaterialshell/installation).

Quick Start

- **Fedora**: See the [Fedora & CentOS](https://danklinux.com/docs/1.2/dankmaterialshell/installation#fedora--centos) section in the installation guide
- **Ubuntu/Debian**: See the [Ubuntu & Debian](https://danklinux.com/docs/1.2/dankmaterialshell/installation#debian--ubuntu) section in the installation guide
- **OpenSUSE**: See the [OpenSUSE](https://danklinux.com/docs/1.2/dankmaterialshell/installation#opensuse--derivatives) section in the installation guide
...
1. Check the [DankMaterialShell Installation Guide](https://danklinux.com/docs/1.2/dankmaterialshell/installation) for common solutions
2. Visit the [Support Page](https://danklinux.com/docs/1.2/support) for community resources
...
Interested in maintaining packages for other distributions? Contributions to the DankLinux repository are welcome! Check out the [Contributing Guide](https://danklinux.com/docs/1.2/contributing) to get started.