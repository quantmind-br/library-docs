...
source: sitemap
fetched_at: 2026-01-24T13:34:09.930559223-03:00
rendered_js: false
word_count: 501
summary: This document provides a comprehensive guide for using the dsearch tool to index and search filesystem content through both its command-line interface and HTTP API.
tags:
    - cli-tool
    - filesystem-search
    - index-management
