...
url: https://doc.rust-lang.org/stable/book/ch15-02-deref.html#implicit-deref-coercions-with-functions-and-methods
source: crawler
fetched_at: 2026-05-06T21:28:09.394667571-03:00
rendered_js: false
word_count: 2171
summary: This document explains how to implement the Deref trait in Rust to allow custom smart pointer types to behave like regular references when using the dereference operator.
tags:
    - rust
    - smart-pointers
    - deref-trait
