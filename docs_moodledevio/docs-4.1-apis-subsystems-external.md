...
url: https://moodledev.io/docs/4.1/apis/subsystems/external
source: sitemap
fetched_at: 2026-02-17T14:56:05.992923-03:00
rendered_js: false
word_count: 252
summary: This document provides an overview of the Moodle Web Service framework and External API, detailing their use for external system integration, mobile apps, and internal AJAX interactions.
tags:
    - moodle
    - web-services
    - external-api
...
In addition to the standard API endpoints, several additional API endpoints are available for the purpose of uploading, and downloading, files. For more information on these endpoints, see the [file handling](https://moodledev.io/docs/4.1/apis/subsystems/external/files) documentation.
...
- [Adding a web service to your plugin](https://moodledev.io/docs/4.1/apis/subsystems/external/writing-a-service)
...
- [Web services files handling](https://moodledev.io/docs/4.1/apis/subsystems/external/files)
