...
url: https://moodledev.io/docs/4.5/apis/plugintypes/theme/images
source: sitemap
fetched_at: 2026-02-17T15:12:54.277938-03:00
rendered_js: false
word_count: 502
summary: This document explains how to manage, use, and override images within Moodle themes, covering directory structures, template integration, and CSS implementation.
tags:
    - moodle-development
    - theme-customization
    - image-handling
