...
## Helper utils[​](#helper-utils "Direct link to Helper utils")
...
## Retry failed requests[​](#retry-failed-requests "Direct link to Retry failed requests")
...
## Fallbacks (SDK)[​](#fallbacks-sdk "Direct link to Fallbacks (SDK)")

### Context Window Fallbacks (SDK)[​](#context-window-fallbacks-sdk "Direct link to Context Window Fallbacks (SDK)")
...
### Fallbacks - Switch Models/API Keys/API Bases (SDK)[​](#fallbacks---switch-modelsapi-keysapi-bases-sdk "Direct link to Fallbacks - Switch Models/API Keys/API Bases (SDK)")
...
#### switch models[​](#switch-models "Direct link to switch models")
...
#### switch api keys/bases (E.g. azure deployment)[​](#switch-api-keysbases-eg-azure-deployment "Direct link to switch api keys/bases (E.g. azure deployment)")
...
## Implementation Details (SDK)[​](#implementation-details-sdk "Direct link to Implementation Details (SDK)")

### Fallbacks[​](#fallbacks "Direct link to Fallbacks")

#### Output from calls[​](#output-from-calls "Direct link to Output from calls")
...
#### How does fallbacks work[​](#how-does-fallbacks-work "Direct link to How does fallbacks work")
...
#### Key components of Model Fallbacks implementation:[​](#key-components-of-model-fallbacks-implementation "Direct link to Key components of Model Fallbacks implementation:")

- Looping through `fallbacks`
- Cool-Downs for rate-limited models

#### Looping through `fallbacks`[​](#looping-through-fallbacks "Direct link to looping-through-fallbacks")
...
```
while response ==Noneand time.time()- start_time <45:
for model in fallbacks:
```

#### Cool-Downs for rate-limited models[​](#cool-downs-for-rate-limited-models "Direct link to Cool-Downs for rate-limited models")
...
#### Full code of completion with fallbacks()[​](#full-code-of-completion-with-fallbacks "Direct link to Full code of completion with fallbacks()")
