...
source: llms
fetched_at: 2026-04-16T22:31:38.190693887-03:00
rendered_js: false
word_count: 1602
summary: This document provides an interactive simulation of how Claude Code manages its context window during a coding session. It details the different types of data loaded, including system prompts, project files, rules, and tool execution outputs.
tags:
    - claude-code
    - context-window
    - llm-mechanics
