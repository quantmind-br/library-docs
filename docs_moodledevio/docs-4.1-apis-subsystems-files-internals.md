...
url: https://moodledev.io/docs/4.1/apis/subsystems/files/internals
source: sitemap
fetched_at: 2026-02-17T14:56:32.014886-03:00
rendered_js: false
word_count: 1495
summary: This document provides a technical overview of the Moodle File API architecture, explaining how files are stored, managed, and served using a hash-based deduplication system. It describes the core components of the API including the file system, storage metadata, and access control mechanisms for plugin integration.
tags:
    - moodle-development
    - file-api
    - file-storage
...
See the [File API](https://moodledev.io/docs/4.1/apis/subsystems/files) documentation for information on using the File API.
...
Details of common operations are documented in the [File System API](https://moodledev.io/docs/4.1/apis/subsystems/files) documentation
...
- links to these files are constructed on the fly from the relative links stored in database (see [Generating a URL to your files](https://moodledev.io/docs/4.1/apis/subsystems/files#generating-a-url-to-your-files) for further information).
...
- The **file picker** is an interface, often accessed using the *file manager*, to select files for upload to Moodle. The file picker makes use of [file repositories](https://moodledev.io/docs/4.1/apis/plugintypes/repository).
...
- [Repository API](https://moodledev.io/docs/4.1/apis/plugintypes/repository)
