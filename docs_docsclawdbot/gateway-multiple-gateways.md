...
source: llms
fetched_at: 2026-01-26T09:52:03.875689141-03:00
rendered_js: false
word_count: 288
summary: This document explains how to run multiple isolated Gateway instances on a single host using profiles or manual environment configurations to avoid port and data conflicts. It provides specific instructions for setting up rescue bots and ensuring complete instance isolation through proper directory and port management.
tags:
    - multiple-gateways
    - instance-isolation
    - port-mapping
