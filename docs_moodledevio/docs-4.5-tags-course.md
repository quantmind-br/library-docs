...
url: https://moodledev.io/docs/4.5/tags/course
source: sitemap
fetched_at: 2026-02-17T15:06:43.941763-03:00
rendered_js: false
word_count: 127
summary: This document provides an overview of Moodle's Custom fields and Groups APIs, detailing how to implement custom field types and manage user collections within courses.
tags:
    - moodle-api
    - custom-fields
    - groups-api
