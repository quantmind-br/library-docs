...
source: sitemap
fetched_at: 2026-05-07T21:13:17.786522349-03:00
rendered_js: false
word_count: 94
summary: This document provides an example implementation for deploying a Gradio-based web interface to interact with a vLLM serving engine.
tags:
    - vllm
    - gradio
    - web-server
...
[](https://github.com/vllm-project/vllm/edit/main/docs/examples/online_serving/gradio_webserver.md "Edit this page")

Source [https://github.com/vllm-project/vllm/blob/main/examples/online\_serving/gradio\_webserver.py](https://github.com/vllm-project/vllm/blob/main/examples/online_serving/gradio_webserver.py).
