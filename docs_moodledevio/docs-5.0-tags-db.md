---
title: 4 docs tagged with "DB" | Moodle Developer Resources
url: https://moodledev.io/docs/5.0/tags/db
source: sitemap
fetched_at: 2026-02-17T15:18:00.081307-03:00
rendered_js: false
word_count: 106
summary: This document provides an overview and links to the Moodle core APIs for defining database structures and performing data manipulation tasks, including schema management and error handling.
tags:
    - moodle-api
    - dml
    - ddl
...
## [Database schema](https://moodledev.io/docs/5.0/apis/core/dml/database-schema)
