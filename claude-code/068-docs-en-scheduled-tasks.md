...
source: llms
fetched_at: 2026-04-16T22:34:41.581590287-03:00
rendered_js: false
word_count: 1936
summary: This document explains how to use Claude Code's scheduled task features, specifically the /loop command, to automate prompt execution via fixed intervals or dynamic scheduling.
tags:
    - claude-code
    - automation
    - scheduling
