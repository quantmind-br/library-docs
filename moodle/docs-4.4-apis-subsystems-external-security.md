...
url: https://moodledev.io/docs/4.4/apis/subsystems/external/security
source: sitemap
fetched_at: 2026-02-17T15:04:12.813174-03:00
rendered_js: false
word_count: 399
summary: This document outlines the essential security and validation requirements for implementing Moodle external functions, focusing on parameter verification, context validation, and capability checks.
tags:
    - moodle
    - external-functions
    - api-security
