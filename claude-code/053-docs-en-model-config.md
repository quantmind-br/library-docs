...
source: llms
fetched_at: 2026-04-16T22:33:37.866961114-03:00
rendered_js: false
word_count: 3094
summary: This document explains how to configure and manage model selection in Claude Code, covering model aliases, environment variables, and administrative restriction settings.
tags:
    - claude-code
    - model-configuration
    - anthropic-api
