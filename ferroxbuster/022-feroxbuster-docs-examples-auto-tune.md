...
url: https://epi052.github.io/feroxbuster-docs/examples/auto-tune
source: github_pages
fetched_at: 2026-02-06T10:54:53.079500362-03:00
rendered_js: true
word_count: 290
summary: This document explains how to use the --auto-tune and --auto-bail flags to automatically manage or terminate directory scans based on error thresholds and response codes.
tags:
    - feroxbuster
    - scan-optimization
    - rate-limiting
...
[Section titled “Auto-tune or Auto-bail from scans”](#auto-tune-or-auto-bail-from-scans)
...
![auto-tune](https://epi052.github.io/feroxbuster-docs/images/examples/auto-tune-demo.gif)
...
![auto-bail](https://epi052.github.io/feroxbuster-docs/images/examples/auto-bail-demo.gif)