...
url: https://developer.spotify.com/documentation/web-api/reference/get-users-saved-episodes
source: crawler
fetched_at: 2026-02-27T23:46:31.337712-03:00
rendered_js: true
word_count: 2
summary: Provides a sample JSON response representing the data structure for a user's saved shows and episodes retrieved via the Spotify API. It demonstrates pagination fields and nested metadata for podcast episodes and show details.
tags:
    - spotify-api
    - json-response
    - podcast-data
