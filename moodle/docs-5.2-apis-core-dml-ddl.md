...
url: https://moodledev.io/docs/5.2/apis/core/dml/ddl
source: sitemap
fetched_at: 2026-02-17T15:43:23.896187-03:00
rendered_js: false
word_count: 453
summary: This document provides a reference for Moodle's Data Definition Language (DDL) functions used to manage database structures such as tables, fields, and indexes during plugin installation and upgrade processes.
tags:
    - moodle-development
    - ddl-api
    - database-schema
...
- [DML functions](https://moodledev.io/docs/5.2/apis/core/dml): Where all the functions used to handle DB data ([DML](https://docs.moodle.org/wikipedia/Data_Manipulation_Language)) are defined.