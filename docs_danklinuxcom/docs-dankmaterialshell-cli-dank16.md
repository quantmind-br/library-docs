...
source: sitemap
fetched_at: 2026-01-24T13:33:24.890290166-03:00
rendered_js: false
word_count: 849
summary: This document explains how to use the dms dank16 command to generate harmonious Base16 color palettes for terminal and application themes from a single input color.
tags:
    - base16-palette
    - color-generation
    - terminal-theming
