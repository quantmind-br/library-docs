---
title: Flight booking - Pydantic AI
url: https://ai.pydantic.dev/examples/flight-booking/
source: sitemap
fetched_at: 2026-01-22T22:25:38.909160374-03:00
rendered_js: false
word_count: 5
summary: This document demonstrates a multi-agent orchestration flow where specialized agents delegate tasks to each other, perform structured data extraction, and use procedural validation.
tags:
    - pydantic-ai
    - multi-agent
    - agent-delegation
...
[Learn about Gateway](https://ai.pydantic.dev/gateway) [flight\_booking.py](https://github.com/pydantic/pydantic-ai/blob/main/examples/pydantic_ai_examples/flight_booking.py)
...
[flight\_booking.py](https://github.com/pydantic/pydantic-ai/blob/main/examples/pydantic_ai_examples/flight_booking.py)
