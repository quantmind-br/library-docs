...
url: https://moodledev.io/docs/4.4/apis/subsystems/question
source: sitemap
fetched_at: 2026-02-17T15:04:53.03913-03:00
rendered_js: false
word_count: 719
summary: This document provides an overview of the Moodle question subsystem architecture, covering the interaction between the question engine, question bank, and various plugin types.
tags:
    - moodle
    - question-subsystem
    - question-engine
...
[Question bank plugins (qbank\_)](https://moodledev.io/docs/4.4/apis/plugintypes/qbank) add features to the question bank. The core question bank code mainly just ties all these features together.
...
[Question types](https://moodledev.io/docs/4.4/apis/plugintypes/qtype) were already considered above, when thinking about the the question engine. They also need to work with the question bank, so that teachers can create and edit questions of that type.