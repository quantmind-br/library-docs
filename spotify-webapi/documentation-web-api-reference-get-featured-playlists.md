...
url: https://developer.spotify.com/documentation/web-api/reference/get-featured-playlists
source: crawler
fetched_at: 2026-02-27T23:46:52.967667-03:00
rendered_js: false
word_count: 2
summary: This document provides a sample JSON response for a playlist-related API endpoint, illustrating the data structure for playlist metadata and pagination.
tags:
    - spotify-api
    - api-response
    - json-sample
