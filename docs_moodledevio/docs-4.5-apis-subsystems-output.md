...
url: https://moodledev.io/docs/4.5/apis/subsystems/output
source: sitemap
fetched_at: 2026-02-17T15:14:44.733479-03:00
rendered_js: false
word_count: 2683
summary: This document explains the Moodle Output API, detailing how renderers, renderables, and templates work together to generate and manage visual content within the Moodle framework.
tags:
    - moodle-development
    - output-api
    - renderers
...
This is the mustache template for this demo. It uses some bootstrap classes directly to position and style the content on the page. `{{sometext}}` is replaced with the variable from the context when this template is rendered. For more information on templates see [Templates](https://moodledev.io/docs/4.5/guides/templates).
...
While to render complex elements, you should use [templates](https://moodledev.io/docs/4.5/guides/templates), some simple elements can be rendered using the following functions:
...
- [Templates](https://moodledev.io/docs/4.5/guides/templates)