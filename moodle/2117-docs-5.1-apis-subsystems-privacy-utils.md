...
url: https://moodledev.io/docs/5.1/apis/subsystems/privacy/utils
source: sitemap
fetched_at: 2026-02-17T15:37:06.303457-03:00
rendered_js: false
word_count: 53
summary: Provides a collection of command-line scripts for testing Privacy API implementations in Moodle plugins. These tools allow developers to verify compliance, check metadata, and execute test data exports or deletions directly from the CLI.
tags:
    - moodle-development
    - privacy-api
    - cli-testing
...
Put these scripts into the root of your Moodle development installation and run them via command line. See [Privacy API](https://moodledev.io/docs/5.1/apis/subsystems/privacy) for the full guide on implementing the API in your plugin.
