...
url: https://moodledev.io/docs/5.1/apis/plugintypes/assign/feedback
source: sitemap
fetched_at: 2026-02-17T15:34:47.088129-03:00
rendered_js: false
word_count: 1390
summary: This document provides technical instructions for developing assignment feedback plugins in Moodle, covering file structures, naming constraints, and class method implementations. It explains how to utilize grading interface hooks to extend functionality and manage feedback data within the system.
tags:
    - moodle-development
    - assignment-feedback
    - plugin-api
...
Some of the important files are described below. See the [common plugin files](https://moodledev.io/docs/5.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
