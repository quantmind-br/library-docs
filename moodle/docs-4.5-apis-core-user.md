...
url: https://moodledev.io/docs/4.5/apis/core/user
source: sitemap
fetched_at: 2026-02-17T15:11:35.927209-03:00
rendered_js: false
word_count: 1070
summary: This document outlines Moodle APIs for managing user data, including methods for displaying profile information, validating and cleaning user fields, and implementing user selection widgets.
tags:
    - moodle-development
    - user-api
    - user-fields
...
### `core_user::get_profile_picture`[​](#core_userget_profile_picture "Direct link to core_userget_profile_picture")
...
### `core_user::get_profile_url`[​](#core_userget_profile_url "Direct link to core_userget_profile_url")
...
### `core_user::get_fullname`[​](#core_userget_fullname "Direct link to core_userget_fullname")
...
- [Enrolment API](https://moodledev.io/docs/4.5/apis/subsystems/enrol)