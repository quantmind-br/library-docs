...
url: https://docs.z.ai/devpack/credit-campaign-rules.md
source: llms
fetched_at: 2026-01-24T11:02:33.214312369-03:00
rendered_js: false
word_count: 1284
---
...
* **Base Reward**:
  * For each successfully invited valid friend, the Inviter receives a Credits equivalent to **30% of the friend's first order Actual Payment Amount** (defined below).
