...
source: crawler
fetched_at: 2026-01-28T16:18:35.837212766-03:00
rendered_js: false
word_count: 1410
summary: This document defines and explains mitmproxy's content views, which are used to format, decode, highlight, and reencode data, and details the API for creating and registering custom content views within the system.
tags:
    - mitmproxy
    - content-views
    - data-formatting
