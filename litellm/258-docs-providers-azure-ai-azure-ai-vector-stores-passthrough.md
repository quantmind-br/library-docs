...
## Admin Flow[​](#admin-flow "Direct link to Admin Flow")

### 1. Add the vector store to LiteLLM[​](#1-add-the-vector-store-to-litellm "Direct link to 1. Add the vector store to LiteLLM")
...
### 3. Create a virtual index.[​](#3-create-a-virtual-index "Direct link to 3. Create a virtual index.")
...
### 4. Create a key with the vector store permissions.[​](#4-create-a-key-with-the-vector-store-permissions "Direct link to 4. Create a key with the vector store permissions.")
...
## Developer Flow[​](#developer-flow "Direct link to Developer Flow")

### 1. Create a vector store with some documents.[​](#1-create-a-vector-store-with-some-documents "Direct link to 1. Create a vector store with some documents.")

Note: Use the '/azure\_ai' endpoint for the passthrough api that uses the `azure_ai` provider in your `_new_secret_config.yaml` file.
...
### 2. Search the vector store.[​](#2-search-the-vector-store "Direct link to 2. Search the vector store.")
...
# ----------------------------
defsearch_knowledge_base(query:str, top_k:int=3):
"""
