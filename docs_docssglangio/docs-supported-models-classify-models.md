---
title: Classification Models - SGLang Documentation
url: https://docs.sglang.io/docs/supported-models/classify_models
source: sitemap
fetched_at: 2026-05-11T05:48:08.557940703-03:00
rendered_js: false
word_count: 418
summary: This document provides the specification and implementation details for the /v1/classify API endpoint in SGLang, detailing the request/response formats and compatibility with vLLM's classification API.
tags:
    - sglang
    - api-endpoint
    - text-classification
