---
title: "null"
url: https://docs.clawd.bot/providers/synthetic.md
source: llms
fetched_at: 2026-01-26T09:53:29.336555053-03:00
rendered_js: false
word_count: 352
summary: This document provides instructions for configuring the Synthetic model provider within Clawdbot using Anthropic-compatible endpoints. It includes quick setup steps, detailed configuration examples, and a comprehensive model catalog with technical specifications.
tags:
    - synthetic-provider
    - clawdbot-setup
    - anthropic-api
