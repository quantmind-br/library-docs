...
source: sitemap
fetched_at: 2026-05-07T21:17:04.762023543-03:00
rendered_js: false
word_count: 195
summary: This document defines the configuration schema for multimodal model behavior, including parameters for input limits, encoder optimization, caching strategies, and performance tuning.
tags:
    - multimodal
    - vllm
    - configuration
...
"""IPC (inter-process communication) method for multimodal tensors.
    ...
    @classmethod
    def_validate_mm_encoder_attn_backend(
    ...
    def_validate_multimodal_config(self):
...
"""
    ...
    defget_limit_per_prompt(self, modality: str) -> int:
"""
...
"""
    ...
    defis_multimodal_pruning_enabled(self):
