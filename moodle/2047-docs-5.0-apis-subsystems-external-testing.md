...
url: https://moodledev.io/docs/5.0/apis/subsystems/external/testing
source: sitemap
fetched_at: 2026-02-17T15:27:24.235908-03:00
rendered_js: false
word_count: 0
summary: This document provides a reference implementation for unit testing Moodle external service functions, focusing on verifying user capabilities and permission handling.
tags:
    - moodle-development
    - unit-testing
    - external-functions
