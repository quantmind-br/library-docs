...
source: llms
fetched_at: 2026-04-16T22:29:20.326251946-03:00
rendered_js: false
word_count: 7554
summary: This document serves as a technical reference for the Python Agent SDK, detailing how to interact with Claude Code via single-session or continuous conversation modes and providing specifications for defining MCP tools.
tags:
    - python-sdk
    - claude-code
    - mcp-tools
