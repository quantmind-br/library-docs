...
url: https://moodledev.io/docs/5.1/tags/custom-field
source: sitemap
fetched_at: 2026-02-17T15:30:06.475617-03:00
rendered_js: false
word_count: 93
summary: This document provides an overview of the Moodle Custom fields API and plugin types, explaining how to create and implement custom fields within specific application areas like courses.
tags:
    - moodle-development
    - custom-fields
    - api-overview
...
## [Custom fields API](https://moodledev.io/docs/5.1/apis/core/customfields)
