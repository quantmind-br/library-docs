...
url: https://moodledev.io/docs/5.2/apis/core/lock
source: sitemap
fetched_at: 2026-02-17T15:43:36.293308-03:00
rendered_js: false
word_count: 330
summary: This document explains the purpose, performance considerations, and implementation steps for using Moodle's locking API to manage concurrent access to shared resources.
tags:
    - moodle
    - locking-api
    - concurrency-control
