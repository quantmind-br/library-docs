---
title: Qwen3.6 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Qwen/Qwen3.6
source: sitemap
fetched_at: 2026-05-11T05:50:10.84860906-03:00
rendered_js: false
word_count: 780
summary: This document provides technical instructions for installing and deploying the Qwen3.6 large language model series using the SGLang framework, including configuration tips for hardware optimization and multimodal input handling.
tags:
    - qwen3-6
    - sglang
    - model-deployment
...
Both variants share the same hybrid reasoning, tool-calling, and multimodal interface and natively handle context lengths of up to 262,144 tokens, extensible to over 1M tokens. **Key Features:**
...
```
SGLANG_ENABLE_SPEC_V2=1 sglang serve --model-path Qwen/Qwen3.6-35B-A3B-FP8 \
...
HardwareMemoryBF16 TPFP8 TPH10080GB11H200141GB11B200183GB11
