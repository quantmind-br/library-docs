...
source: crawler
fetched_at: 2026-01-28T16:18:55.636958063-03:00
rendered_js: false
word_count: 372
summary: This document explains how to use mitmproxy's client replay feature to automate repetitive web interactions, such as logging into a wireless network, by recording and replaying HTTP conversations.
tags:
    - mitmproxy
    - client-replay
    - http-automation
