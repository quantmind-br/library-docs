...
url: https://github.com/openagen/zeroclaw/blob/master/docs/i18n/vi/hardware-peripherals-design.md
source: git
fetched_at: 2026-05-02T14:51:07.671578181-03:00
rendered_js: false
word_count: 1972
summary: ZeroClaw is an AI-driven framework for hardware control that enables natural language interaction with microcontrollers and embedded devices via real-time code synthesis and hardware-aware RAG pipelines.
tags:
    - ai-agent
    - embedded-systems
    - rust-lang
...
6. Code tối ưu được lưu lại để tái sử dụng cho các yêu cầu tương tự sau này
...
- [x] Host-mediated ESP32 (serial transport) — cùng giao thức JSON như STM32
...
- [[contributing/adding-boards-and-tools|Adding Boards and Tools]] — Cách thêm board và datasheet
- [[ops/network-deployment|Network Deployment]] — Triển khai RPi và mạng
...
#ai-agent #embedded-systems #rust-lang #llm-integration #hardware-automation #rag-pipeline #edge-computing
