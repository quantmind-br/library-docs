...
url: https://moodledev.io/docs/4.4/tags/sub-system
source: sitemap
fetched_at: 2026-02-17T15:01:09.49708-03:00
rendered_js: false
word_count: 96
summary: This document introduces the Moodle Tag API, detailing how to create, modify, and search for tags to organize and group information across the platform.
tags:
    - moodle
    - tag-api
    - metadata-management
