...
source: llms
fetched_at: 2026-01-24T11:02:07.841522785-03:00
rendered_js: false
word_count: 109
summary: This document describes the Z.AI file upload API, which allows users to upload auxiliary reference materials such as glossaries to improve translation accuracy and consistency.
tags:
    - file-upload
    - translation-api
