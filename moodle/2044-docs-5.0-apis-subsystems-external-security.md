...
url: https://moodledev.io/docs/5.0/apis/subsystems/external/security
source: sitemap
fetched_at: 2026-02-17T15:27:23.38424-03:00
rendered_js: false
word_count: 399
summary: This document outlines the mandatory security and validation steps for implementing external functions, including parameter cleaning, context verification, and capability checks. It explains how to use specific API methods to ensure safe data handling and proper user authorization within the system.
tags:
    - moodle-development
    - external-functions
    - security-validation
