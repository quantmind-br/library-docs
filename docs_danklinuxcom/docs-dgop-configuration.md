...
source: sitemap
fetched_at: 2026-01-24T13:34:11.306310529-03:00
rendered_js: false
word_count: 18
summary: This document provides JSON configuration structures and templates for customizing the visual themes and color palettes of a user interface, including charts and status indicators.
tags:
    - ui-theming
    - color-schemes
    - configuration-json
