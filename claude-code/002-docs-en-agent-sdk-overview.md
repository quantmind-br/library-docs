...
source: llms
fetched_at: 2026-04-16T22:29:12.217964987-03:00
rendered_js: false
word_count: 617
summary: An overview of the Claude Agent SDK, detailing its ability to build autonomous AI agents with built-in tools for file manipulation, terminal execution, and web searching across Python and TypeScript.
tags:
    - claude-agent-sdk
    - ai-agents
    - python
