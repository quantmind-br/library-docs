...
url: https://moodledev.io/docs/5.2/apis/core/activitycompletion
source: sitemap
fetched_at: 2026-02-17T15:43:09.199578-03:00
rendered_js: false
word_count: 2062
summary: This document provides instructions for developers to implement activity completion support in Moodle plugins, covering view-based, grade-based, and custom completion rules.
tags:
    - moodle-development
    - activity-completion
    - php
