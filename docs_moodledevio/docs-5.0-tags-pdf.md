...
url: https://moodledev.io/docs/5.0/tags/pdf
source: sitemap
fetched_at: 2026-02-17T15:20:56.253896-03:00
rendered_js: false
word_count: 69
summary: This document explains the purpose and implementation of file converters in Moodle, which enable plugins to transform files between different formats via a dedicated API.
tags:
    - moodle
    - file-conversion
    - api
