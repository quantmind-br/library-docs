...
url: https://moodledev.io/docs/4.4/apis/plugintypes/fileconverter
source: sitemap
fetched_at: 2026-02-17T15:03:02.073268-03:00
rendered_js: false
word_count: 363
summary: This document explains how to develop file converter plugins in Moodle, detailing the required file structure and the implementation of the core converter interface.
tags:
    - moodle-development
    - file-converter
    - plugin-development
...
Some of the important files for the fileconverter plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.4/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
...
- Using the [File Converter API](https://moodledev.io/docs/4.4/apis/subsystems/files/converter)