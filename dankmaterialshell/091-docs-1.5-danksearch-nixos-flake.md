...
url: https://danklinux.com/docs/1.5/danksearch/nixos-flake
source: sitemap
fetched_at: 2026-02-22T18:44:37.122906-03:00
rendered_js: false
word_count: 360
summary: This guide provides instructions for installing and configuring DankSearch on NixOS using home-manager and Nix flakes, including systemd service management and custom indexing settings.
tags:
    - nixos
    - home-manager
    - nix-flakes
...
DankSearch is now available in nixpkgs unstable! If you're on NixOS unstable, see [Installation - NixOS](https://danklinux.com/docs/1.5/danksearch/nixos) for the native nixpkgs installation method which doesn't require flakes.
...
The configuration follows the TOML format and will be written to `~/.config/danksearch/config.toml`. The structure directly maps to the TOML configuration - see the [Configuration](https://danklinux.com/docs/1.5/danksearch/configuration) guide for all available options.
