...
source: llms
fetched_at: 2026-04-16T22:29:15.546441256-03:00
rendered_js: false
word_count: 579
summary: Explains how to extend Claude Code using the Agent SDK by loading custom plugins such as skills, agents, hooks, and MCP servers from local file paths.
tags:
    - claude-code
    - agent-sdk
    - plugin-architecture
