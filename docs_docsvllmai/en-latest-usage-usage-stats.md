...
source: sitemap
fetched_at: 2026-05-07T21:15:33.913493483-03:00
rendered_js: false
word_count: 140
summary: This document explains the anonymous usage data collection practices in vLLM and provides instructions on how users can opt out of data tracking.
tags:
    - usage-stats
    - telemetry
    - privacy
...
The list of data collected by the latest version of vLLM can be found here: [vllm/usage/usage\_lib.py](https://github.com/vllm-project/vllm/blob/main/vllm/usage/usage_lib.py)
...
exportVLLM_NO_USAGE_STATS=1
exportDO_NOT_TRACK=1
