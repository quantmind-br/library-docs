---
title: 'Qwen Code Companion Plugin: Interface Specification'
url: https://qwenlm.github.io/qwen-code-docs/en/users/ide-integration/ide-companion-spec
source: github_pages
fetched_at: 2026-04-09T09:05:57.916065411-03:00
rendered_js: true
word_count: 1233
summary: This document serves as a technical specification detailing the required contracts for building companion plugins that integrate Qwen Code's IDE mode functionality into editors beyond VS Code. It specifies protocols for communication, context sharing, and proposing code diffs.
tags:
    - plugin-development
    - ide-integration
    - mcp-protocol
...
### 1. Transport Layer: MCP over HTTP[](#1-transport-layer-mcp-over-http)
...
### 2. Discovery Mechanism: The Lock File[](#2-discovery-mechanism-the-lock-file)
...
- **File Naming Convention:** The filename is critical and **MUST** follow the pattern: `<PORT>.lock`
...
### `ide/contextUpdate` Notification[](#idecontextupdate-notification)
...
### How the CLI Uses This Context[](#how-the-cli-uses-this-context)
...
### `ide/diffAccepted` Notification[](#idediffaccepted-notification)
...
### `ide/diffRejected` Notification[](#idediffrejected-notification)
