...
url: https://danklinux.com/docs/1.5/dankmaterialshell/managing
source: sitemap
fetched_at: 2026-02-22T18:44:20.771154-03:00
rendered_js: false
word_count: 580
summary: This guide provides instructions for managing, updating, and configuring DankMaterialShell, covering service control via systemd, environment variable setup for Wayland compositors, and uninstallation procedures.
tags:
    - dankmaterialshell
    - service-management
    - systemd
...
If you installed via [dankinstall](https://danklinux.com/docs/1.5/dankinstall), DMS is configured as a systemd service by default. The installer runs `systemctl --user enable --now dms` during setup. You don't need to add `dms run` to your compositor config.
...
For source builds or [non-packaged](https://danklinux.com/docs/1.5/dankmaterialshell/installation) distro dankinstall setups:
