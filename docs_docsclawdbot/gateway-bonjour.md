---
title: "null"
url: https://docs.clawd.bot/gateway/bonjour.md
source: llms
fetched_at: 2026-01-26T09:51:50.126027082-03:00
rendered_js: false
word_count: 620
summary: This document explains how to configure and use Bonjour (mDNS) and Wide-Area DNS-SD for automatic discovery of Clawdbot Gateways on local networks and across Tailscale VPNs. It covers configuration steps, service types, and troubleshooting methods for desktop and mobile nodes.
tags:
    - bonjour
    - mdns
    - dns-sd
