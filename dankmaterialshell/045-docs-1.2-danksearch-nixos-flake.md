...
url: https://danklinux.com/docs/1.2/danksearch/nixos-flake
source: sitemap
fetched_at: 2026-02-22T18:43:18.681164-03:00
rendered_js: false
word_count: 360
summary: This document provides instructions for installing and configuring DankSearch on NixOS using home-manager and flakes, covering systemd service management and custom indexing options.
tags:
    - nixos
    - home-manager
    - nix-flakes
...
DankSearch is now available in nixpkgs unstable! If you're on NixOS unstable, see [Installation - NixOS](https://danklinux.com/docs/1.2/danksearch/nixos) for the native nixpkgs installation method which doesn't require flakes.
...
The configuration follows the TOML format and will be written to `~/.config/danksearch/config.toml`. The structure directly maps to the TOML configuration - see the [Configuration](https://danklinux.com/docs/1.2/danksearch/configuration) guide for all available options.
...
- Learn more about [Configuration](https://danklinux.com/docs/1.2/danksearch/configuration) options
- Explore [Usage](https://danklinux.com/docs/1.2/danksearch/usage) guide for CLI and API usage
- Check out [DankMaterialShell integration](https://danklinux.com/docs/1.2/dankmaterialshell/overview)