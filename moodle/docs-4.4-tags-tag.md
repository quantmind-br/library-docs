...
url: https://moodledev.io/docs/4.4/tags/tag
source: sitemap
fetched_at: 2026-02-17T15:01:15.086424-03:00
rendered_js: false
word_count: 96
summary: This document introduces the Moodle Tag API, which enables the creation, management, and searching of labels to organize and group information across the system. It highlights the core classes and files used for tag integration in Moodle development.
tags:
    - moodle
    - tag-api
    - content-labeling
