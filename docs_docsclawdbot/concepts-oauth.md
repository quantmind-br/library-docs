---
title: "null"
url: https://docs.clawd.bot/concepts/oauth.md
source: llms
fetched_at: 2026-01-26T09:51:28.196399312-03:00
rendered_js: false
word_count: 731
summary: This document explains Clawdbot's OAuth implementation for Anthropic and OpenAI, covering token exchange via PKCE, storage mechanisms, CLI token reuse, and multi-account profile management.
tags:
    - oauth
    - authentication
    - anthropic
