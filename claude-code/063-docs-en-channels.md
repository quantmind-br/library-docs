...
source: llms
fetched_at: 2026-04-16T22:30:55.671008387-03:00
rendered_js: false
word_count: 1495
summary: This document provides instructions for setting up and configuring channels to push messages from external platforms like Telegram, Discord, and iMessage into a Claude Code session.
tags:
    - claude-code
    - mcp-server
