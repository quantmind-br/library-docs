...
source: llms
fetched_at: 2026-04-16T22:35:13.399106922-03:00
rendered_js: false
word_count: 3342
summary: This guide explains how to configure and build custom status lines in Claude Code to monitor session metrics like context usage, costs, and git status.
tags:
    - claude-code
    - terminal-ui
    - shell-scripting
