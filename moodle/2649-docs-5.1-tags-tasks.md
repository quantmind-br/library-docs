...
url: https://moodledev.io/docs/5.1/tags/tasks
source: sitemap
fetched_at: 2026-02-17T15:33:15.307863-03:00
rendered_js: false
word_count: 104
summary: This document introduces the Moodle Task API and explains the distinctions between adhoc tasks for one-off background execution and scheduled tasks for recurring activities.
tags:
    - moodle
    - task-api
    - adhoc-tasks
