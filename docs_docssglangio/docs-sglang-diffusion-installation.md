---
title: Install SGLang Diffusion - SGLang Documentation
url: https://docs.sglang.io/docs/sglang-diffusion/installation
source: sitemap
fetched_at: 2026-05-11T05:51:23.523132113-03:00
rendered_js: false
word_count: 209
summary: This document provides comprehensive installation instructions for SGLang-Diffusion across various hardware platforms including NVIDIA, AMD, Moore Threads, Intel, Ascend, and Apple devices.
tags:
    - sglang
    - diffusion
    - installation-guide
...
For detailed ROCm system configuration and installation from source, see [AMD GPUs](https://docs.sglang.io/docs/hardware-platforms/amd_gpu).
...
For Intel Data Center GPU Max or Arc GPUs, follow the [XPU installation guide](https://docs.sglang.io/docs/hardware-platforms/xpu) to set up the base environment, then install diffusion dependencies:
...
For Ascend NPU, please follow the [NPU installation guide](https://docs.sglang.io/docs/hardware-platforms/ascend-npus/ascend_npu). Quick test:
