---
title: serving - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/entrypoints/openai/responses/serving/
source: sitemap
fetched_at: 2026-05-07T21:20:32.01359992-03:00
rendered_js: false
word_count: 20
summary: This document defines the OpenAIServingResponses class, which manages OpenAI-compatible response generation, including tool parsing, chat template handling, input validation, and optional response storage within the vLLM framework.
tags:
    - vllm
    - openai-api
    - inference-engine
...
```
classOpenAIServingResponses(OpenAIServing):
    def__init__(
        self,
    ...
    def_effective_chat_template_kwargs(
...
"""Add validations to the input to the generator here."""
    ...
    def_validate_create_responses_input(
        self, request: ResponsesRequest
    ) -> ErrorResponse | None:
    ...
    async def_generate_with_builtin_tools(
        self,
        request_id: str,
        engine_input: EngineInput,
    ...
    async def_initialize_tool_sessions(
        self,
        request: ResponsesRequest,
        context: ConversationContext,
    ...
    async defresponses_full_generator(
        self,
        request: ResponsesRequest,
        sampling_params: SamplingParams,
...
"""Returns the top-k logprobs from the logprobs dictionary."""
    ...
    def_create_stream_response_logprobs(
        self,
        token_ids: Sequence[int],
        logprobs: SampleLogprobs | None,
        tokenizer: TokenizerLike,
    ...
    def_make_response_output_items(
        self,
        request: ResponsesRequest,
    ...
    def_make_response_output_items_with_harmony(
        self,
    ...
    def_extract_system_message_from_request(
        self, request: ResponsesRequest
    ) -> str | None:
        system_msg = None
    ...
    def_construct_harmony_system_input_message(
    ...
    def_construct_input_messages_with_harmony(
        self,
        request: ResponsesRequest,
        prev_response: ResponsesResponse | None,
    ...
    async def_run_background_request_stream(
        self,
        request: ResponsesRequest,
        *args,
        **kwargs,
    ...
    async def_run_background_request(
        self,
        request: ResponsesRequest,
        *args,
        **kwargs,
    ...
    async defresponses_background_stream_generator(
        self,
        response_id: str,
    ...
    def_make_not_found_error(self, response_id: str) -> ErrorResponse:
        return self.create_error_response(
            err_type="invalid_request_error",
    ...
    async def_process_simple_streaming_events(
        self,
        request: ResponsesRequest,
        sampling_params: SamplingParams,
    ...
    async def_process_harmony_streaming_events(
        self,
        request: ResponsesRequest,
        sampling_params: SamplingParams,
        result_generator: AsyncIterator[ConversationContext | None],
    ...
    async defresponses_stream_generator(
        self,
        request: ResponsesRequest,
        sampling_params: SamplingParams,
        result_generator: AsyncIterator[ConversationContext | None],
        ...
        def_increment_sequence_number_and_return(
        ...
        async with AsyncExitStack() as exit_stack:
            ...
            async defempty_async_generator():
