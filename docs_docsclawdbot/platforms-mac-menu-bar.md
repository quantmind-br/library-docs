...
source: llms
fetched_at: 2026-01-26T09:53:01.07756166-03:00
rendered_js: false
word_count: 406
summary: This document explains the logic and implementation details for displaying agent activity and health status in the macOS menu bar, covering session prioritization, visual states, and event ingestion.
tags:
    - macos-development
    - swift
    - ui-logic
