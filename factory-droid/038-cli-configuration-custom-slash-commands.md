...
source: llms
fetched_at: 2026-02-05T21:41:22.710710799-03:00
rendered_js: false
word_count: 743
summary: This document explains how to extend the CLI using custom slash commands created via Markdown prompts or executable scripts for automated workflows.
tags:
    - custom-commands
    - slash-commands
    - cli-extensions
