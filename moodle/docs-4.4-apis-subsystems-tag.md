...
url: https://moodledev.io/docs/4.4/apis/subsystems/tag
source: sitemap
fetched_at: 2026-02-17T15:04:58.121438-03:00
rendered_js: false
word_count: 1190
summary: This document provides a technical overview of the Moodle Tag API, explaining how to define tag areas, integrate tagging functionality into forms, and manage tag instances within custom plugins.
tags:
    - moodle
    - tag-api
    - plugin-development
...
There are more options such as specifying the default value for "Standard tags", having a fixed collection or excluding from search. They can be found in comments in [Core library tag.php](https://moodledev.io/docs/4.4/apis/commonfiles/tag.php)
...
- [Core library tag.php](https://moodledev.io/docs/4.4/apis/commonfiles/tag.php)
