...
url: https://moodledev.io/docs/5.2/tags/tags
source: sitemap
fetched_at: 2026-02-17T15:42:24.165651-03:00
rendered_js: false
word_count: 114
summary: This document provides an overview of the Moodle Tag API, explaining how to manage, group, and search for labels using specific PHP classes and functions.
tags:
    - moodle
    - tag-api
    - metadata
