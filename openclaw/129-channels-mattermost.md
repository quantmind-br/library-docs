...
source: sitemap
fetched_at: 2026-01-30T20:37:33.424372715-03:00
rendered_js: false
word_count: 345
summary: This document provides instructions for configuring and using the Mattermost plugin with OpenClaw, covering installation, setup, chat modes, access control, and troubleshooting.
tags:
    - mattermost
    - plugin
    - messaging
...
If you choose Mattermost during configure/onboarding and a git checkout is detected, OpenClaw will offer the local install path automatically. Details: [Plugins](https://docs.openclaw.ai/plugin)
