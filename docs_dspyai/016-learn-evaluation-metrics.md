...
source: sitemap
fetched_at: 2026-01-23T08:03:14.963100578-03:00
rendered_js: false
word_count: 604
summary: This document explains how to define and implement automatic metrics in DSPy for evaluating and optimizing machine learning programs, covering both simple functions and complex AI-feedback metrics.
tags:
    - dspy
    - machine-learning
    - evaluation-metrics
...
## What is a metric and how do I define a metric for my task?[¶](#what-is-a-metric-and-how-do-i-define-a-metric-for-my-task "Permanent link")
...
## Simple metrics[¶](#simple-metrics "Permanent link")
...
```
defvalidate_context_and_answer(example, pred, trace=None):
...
```
defmetric(gold, pred, trace=None):
...
## Advanced: Using a DSPy program as your metric[¶](#advanced-using-a-dspy-program-as-your-metric "Permanent link")
...
### Advanced: Accessing the `trace`[¶](#advanced-accessing-the-trace "Permanent link")
...
```
defvalidate_hops(example, pred, trace=None):
