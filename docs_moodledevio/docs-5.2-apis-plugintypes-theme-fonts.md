...
url: https://moodledev.io/docs/5.2/apis/plugintypes/theme/fonts
source: sitemap
fetched_at: 2026-02-17T15:44:56.12697-03:00
rendered_js: false
word_count: 248
summary: This document explains how to integrate and use custom fonts within Moodle plugins and themes, covering directory structures and CSS placeholder syntax.
tags:
    - moodle-development
    - web-fonts
    - css-styling
