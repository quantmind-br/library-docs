...
url: https://moodledev.io/docs/5.1/apis/core/htmlwriter
source: sitemap
fetched_at: 2026-02-17T15:34:24.657789-03:00
rendered_js: false
word_count: 56
summary: This document explains how to use Moodle's HTML writer class to programmatically generate HTML tags and attributes within PHP renderer functions.
tags:
    - moodle-development
    - php
    - html-writer
...
Please consider using [templates](https://moodledev.io/docs/5.1/guides/templates) as an alternative to the *HTML writer*.
