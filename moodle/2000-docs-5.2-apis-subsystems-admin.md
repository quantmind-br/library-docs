...
url: https://moodledev.io/docs/5.2/apis/subsystems/admin
source: sitemap
fetched_at: 2026-02-17T15:45:06.91094-03:00
rendered_js: false
word_count: 1791
summary: This document explains the architecture of Moodle's administration settings system, covering how the settings tree is constructed, managed via PHP classes, and implemented within plugins.
tags:
    - moodle
    - admin-settings
    - plugin-development
...
- [configuration for filter](https://moodledev.io/docs/5.2/apis/plugintypes/filter)
