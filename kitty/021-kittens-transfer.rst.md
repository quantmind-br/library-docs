...
title: Transfer
word_count: 429
summary: This document explains how to use the kitty transfer kitten to move files and directory trees between local and remote machines over terminal sessions.
category: guide
word_count: 429
optimized: true
...
![The transfer kitten at work](../screenshots/transfer.png)
...
> [!NOTE]
> See the remote_file kitten
>
>

## Basic usage

Simply ssh into a remote computer using the ssh kitten </kittens/ssh> and run the this kitten
...
1. Setting the file_transfer_confirmation_bypass option to some password.

1. When invoking the kitten use the :option:`--permissions-bypass
