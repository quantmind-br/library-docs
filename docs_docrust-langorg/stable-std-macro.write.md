...
source: crawler
fetched_at: 2026-05-06T21:28:44.875565412-03:00
rendered_js: false
word_count: 191
summary: This document describes the write! macro in Rust, which is used to format and write data into buffers implementing the fmt::Write or io::Write traits.
tags:
    - rust-macros
    - formatted-output
    - io-traits
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/macros/mod.rs.html#606)
...
This macro accepts a ‘writer’, a format string, and a list of arguments. Arguments will be formatted according to the specified format string and the result will be passed to the writer. The writer may be any value with a `write_fmt` method; generally this comes from an implementation of either the [`fmt::Write`](https://doc.rust-lang.org/stable/std/fmt/trait.Write.html "trait std::fmt::Write") or the [`io::Write`](https://doc.rust-lang.org/stable/std/io/trait.Write.html) trait. The macro returns whatever the `write_fmt` method returns; commonly a [`fmt::Result`](https://doc.rust-lang.org/stable/std/fmt/type.Result.html "type std::fmt::Result"), or an [`io::Result`](https://doc.rust-lang.org/stable/std/io/type.Result.html).

See [`std::fmt`](https://doc.rust-lang.org/stable/std/fmt/index.html) for more information on the format string syntax.
