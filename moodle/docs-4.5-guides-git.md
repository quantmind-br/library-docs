...
url: https://moodledev.io/docs/4.5/guides/git
source: sitemap
fetched_at: 2026-02-17T15:15:41.542736-03:00
rendered_js: false
word_count: 2920
summary: This guide outlines the standard Git workflow and setup procedures for Moodle developers, including installation, configuration, and repository management. It describes the lifecycle of a code contribution from local development to integration into the Moodle production repository.
tags:
    - moodle-development
    - git-workflow
    - github
