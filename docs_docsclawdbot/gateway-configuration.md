...
source: llms
fetched_at: 2026-01-26T09:51:53.491797472-03:00
rendered_js: false
word_count: 9043
summary: This document explains how to configure Clawdbot using JSON5, detailing validation rules, RPC update methods, and techniques for organizing settings with the include directive.
tags:
    - clawdbot-config
    - json5-schema
    - config-validation
