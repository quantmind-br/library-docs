...
url: https://moodledev.io/docs/4.4/tags/external
source: sitemap
fetched_at: 2026-02-17T14:59:12.065894-03:00
rendered_js: false
word_count: 149
summary: This document provides an overview of Moodle's External Services subsystem, explaining how to create, define, and secure web services for integration with external systems.
tags:
    - moodle-api
    - web-services
    - external-services
