...
url: https://github.com/openagen/zeroclaw/blob/master/docs/vi/langgraph-integration.md
source: git
fetched_at: 2026-05-02T14:52:39.724559646-03:00
rendered_js: false
word_count: 500
summary: Hướng dẫn sử dụng gói zeroclaw-tools để tích hợp các LLM tương thích với OpenAI thông qua LangGraph, giúp đảm bảo việc gọi tool nhất quán và hiệu quả.
tags:
    - langgraph
    - llm
    - tool-calling
