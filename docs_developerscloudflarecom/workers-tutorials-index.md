...
url: https://developers.cloudflare.com/workers/tutorials/index.md
source: llms
fetched_at: 2026-01-24T15:27:37.058906381-03:00
rendered_js: false
word_count: 1228
summary: This document provides a comprehensive list of tutorials and video guides for building, deploying, and migrating applications on the Cloudflare Workers platform.
tags:
    - cloudflare-workers
...
| [Migrate from Netlify to Workers](https://developers.cloudflare.com/workers/static-assets/migration-guides/netlify-to-workers/) | 8 months ago | Beginner |
| [Migrate from Vercel to Workers](https://developers.cloudflare.com/workers/static-assets/migration-guides/vercel-to-workers/) | 9 months ago | Beginner |
...
| [Set up and use a Prisma Postgres database](https://developers.cloudflare.com/workers/tutorials/using-prisma-postgres-with-workers/) | 12 months ago | Beginner |
| [Store and Catalog AI Generated Images with R2 (Part 3)](https://developers.cloudflare.com/workers-ai/guides/tutorials/image-generation-playground/image-generator-store-and-catalog/) | 12 months ago | Beginner |
