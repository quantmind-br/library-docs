...
source: git
fetched_at: 2026-03-03T03:40:03.602242-03:00
rendered_js: false
word_count: 960
summary: Document outlines configuring custom models and providers for an AI agent, detailing JSON structure and supported configurations for local/remote APIs like Ollama, vLLM, or proxies.
tags:
    - custom-models
