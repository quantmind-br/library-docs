...
url: https://moodledev.io/docs/5.2/tags/file-converter
source: sitemap
fetched_at: 2026-02-17T15:39:59.282403-03:00
rendered_js: false
word_count: 69
summary: This document introduces file converters as tools within the Moodle framework that enable automated file format conversion for use by other plugins via a dedicated API.
tags:
    - moodle-development
    - file-conversion
    - api-reference
