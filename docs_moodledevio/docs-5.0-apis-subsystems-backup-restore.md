...
url: https://moodledev.io/docs/5.0/apis/subsystems/backup/restore
source: sitemap
fetched_at: 2026-02-17T15:27:07.093912-03:00
rendered_js: false
word_count: 296
summary: This document explains how to implement the Restore API in Moodle plugins to restore data from backup files using restore plans, tasks, and steps.
tags:
    - moodle
    - restore-api
    - backup-restoration
