---
title: Troubleshooting when setting up your development environment for the Moodle App | Moodle Developer Resources
url: https://moodledev.io/general/app/development/setup/troubleshooting
source: sitemap
fetched_at: 2026-02-17T15:55:07.524235-03:00
rendered_js: false
word_count: 1322
summary: This document provides troubleshooting advice and solutions for common errors encountered during the development and build process of the Moodle App.
tags:
    - moodle-app
    - troubleshooting
    - error-handling
...
## I get a blank page when launching the app[​](#i-get-a-blank-page-when-launching-the-app "Direct link to I get a blank page when launching the app")
...
## Strange NPM errors[​](#strange-npm-errors "Direct link to Strange NPM errors")
...
## I can't change the language[​](#i-cant-change-the-language "Direct link to I can't change the language")
...
## Error: `libsass` bindings not found. Try reinstalling node-sass?[​](#error-libsass-bindings-not-found-try-reinstalling-node-sass "Direct link to error-libsass-bindings-not-found-try-reinstalling-node-sass")

Most of the time, running the following command will fix the problem:

## com.android.dex.DexException: Multiple dex files define XXX[​](#comandroiddexdexexception-multiple-dex-files-define-xxx "Direct link to com.android.dex.DexException: Multiple dex files define XXX")
...
## Could not resolve all dependencies for configuration ':\_debugCompile'.[​](#could-not-resolve-all-dependencies-for-configuration-_debugcompile "Direct link to Could not resolve all dependencies for configuration ':_debugCompile'.")
...
## Could not find com.android.support:support-v4:XXX[​](#could-not-find-comandroidsupportsupport-v4 "Direct link to could-not-find-comandroidsupportsupport-v4")
...
## ERROR: In `<declare-styleable>` FontFamilyFont, unable to find attribute android:font[​](#error-in-declare-styleable-fontfamilyfont-unable-to-find-attribute-android "Direct link to error-in-declare-styleable-fontfamilyfont-unable-to-find-attribute-android")
...
## Error: Could not find gradle wrapper within Android SDK. Might need to update your Android SDK.[​](#error-could-not-find-gradle-wrapper-within-android-sdk-might-need-to-update-your-android-sdk "Direct link to Error: Could not find gradle wrapper within Android SDK. Might need to update your Android SDK.")
...
## Could not find com.android.support:support-v4:27.1.0[​](#could-not-find-comandroidsupportsupport-v42710 "Direct link to Could not find com.android.support:support-v4:27.1.0")
...
## Error: not found: make[​](#error-not-found-make "Direct link to Error: not found: make")

If you see this error in Ubuntu, run `sudo apt-get install build-essential` and retry.

## Current working directory is not a Cordova-based project.[​](#current-working-directory-is-not-a-cordova-based-project "Direct link to Current working directory is not a Cordova-based project.")

If you see this error during `npm start`, run `mkdir www` and retry.

## ReferenceError: internalBinding is not defined[​](#referenceerror-internalbinding-is-not-defined "Direct link to ReferenceError: internalBinding is not defined")
...
## npm update check failed[​](#npm-update-check-failed "Direct link to npm update check failed")
...
## Unhandled rejection Error: Command failed: C:\\cygwin64\\bin\\git.EXE ...[​](#unhandled-rejection-error-command-failed-ccygwin64bingitexe- "Direct link to Unhandled rejection Error: Command failed: C:\cygwin64\bin\git.EXE ...")
...
## The product name change (`<name>` tag) in config.xml is not supported dynamically[​](#the-product-name-change-name-tag-in-configxml-is-not-supported-dynamically "Direct link to the-product-name-change-name-tag-in-configxml-is-not-supported-dynamically")
...
## Failed to install 'cordova-plugin-x'[​](#failed-to-install-cordova-plugin-x "Direct link to Failed to install 'cordova-plugin-x'")
...
## doc.find is not a function[​](#docfind-is-not-a-function "Direct link to doc.find is not a function")
...
## Mac: linker code failed with exit code 1[​](#mac-linker-code-failed-with-exit-code-1 "Direct link to Mac: linker code failed with exit code 1")
...
Ensure you have followed the [Mac only: Push notifications](https://moodledev.io/general/app/development/setup#mac-only-push-notifications) steps above (particularly opening the .xcworkspace file rather than the .xcodeproj file). Then run the following:
...
## Windows: `npm start` hangs after "Starting 'watch'"[​](#windows-npm-start-hangs-after-starting-watch "Direct link to windows-npm-start-hangs-after-starting-watch")
