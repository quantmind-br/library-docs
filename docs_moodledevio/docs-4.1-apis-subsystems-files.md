...
url: https://moodledev.io/docs/4.1/apis/subsystems/files
source: sitemap
fetched_at: 2026-02-17T14:56:26.876765-03:00
rendered_js: false
word_count: 1326
summary: This document explains the core Moodle File API, detailing how files are organized into file areas and providing instructions on generating secure URLs and implementing callbacks to serve files.
tags:
    - moodle
    - file-api
    - php
...
- The [Repository API](https://moodledev.io/docs/4.1/apis/plugintypes/repository) is responsible for the code paths associated with uploading files to Moodle. This includes Repository plugins.
- [Using the File API in Moodle forms](https://docs.moodle.org/dev/Using_the_File_API_in_Moodle_forms)
- Additional detail of how this API works is discussed in the [File API internals](https://moodledev.io/docs/4.1/apis/subsystems/files/internals)
...
- [File API internals](https://moodledev.io/docs/4.1/apis/subsystems/files/internals) how the File API works internally.
- [Using the File API in Moodle forms](https://docs.moodle.org/dev/Using_the_File_API_in_Moodle_forms)
