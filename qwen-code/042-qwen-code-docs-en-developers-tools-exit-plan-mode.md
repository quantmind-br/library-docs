---
title: Exit Plan Mode Tool (exit_plan_mode)
url: https://qwenlm.github.io/qwen-code-docs/en/developers/tools/exit-plan-mode
source: github_pages
fetched_at: 2026-04-09T09:04:51.771269466-03:00
rendered_js: true
word_count: 835
summary: This document serves as a developer guide explaining the `exit_plan_mode` tool for Qwen Code, which must be used when an implementation plan is finalized to request user approval before transitioning from planning mode to active code implementation.
tags:
    - developer-guide
...
## How to use `exit_plan_mode` with Qwen Code[](#how-to-use-exit_plan_mode-with-qwen-code)
...
### Examples of appropriate usage:[](#examples-of-appropriate-usage)
...
### Examples of inappropriate usage:[](#examples-of-inappropriate-usage)
...
## `exit_plan_mode` examples[](#exit_plan_mode-examples)

### Implementation planning example[](#implementation-planning-example)
...
### Refactoring plan example[](#refactoring-plan-example)
...
## Integration with Planning Workflow[](#integration-with-planning-workflow)
...
[Task](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/task/ "Task")[Web Fetch](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/web-fetch/ "Web Fetch")