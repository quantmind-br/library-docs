...
url: https://moodledev.io/docs/4.4/guides/javascript/ajax
source: sitemap
fetched_at: 2026-02-17T15:05:18.432951-03:00
rendered_js: false
word_count: 592
summary: This document explains how to implement AJAX interactions in Moodle using the core/ajax JavaScript module to communicate with the Web Service API.
tags:
    - moodle
    - ajax
    - javascript
