...
url: https://moodledev.io/docs/4.1/tags/xmldb
source: sitemap
fetched_at: 2026-02-17T14:54:21.270153-03:00
rendered_js: false
word_count: 131
summary: This document provides an overview of Moodle's core database APIs, covering data definition, manipulation, schema design, and plugin upgrade mechanisms. It serves as a directory for developers to manage database structures and ensure cross-RDBMS compatibility.
tags:
    - moodle-development
    - database-api
    - dml
...
## [Database schema](https://moodledev.io/docs/4.1/apis/core/dml/database-schema)
