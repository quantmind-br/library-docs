...
url: https://moodledev.io/docs/5.0/apis/plugintypes/mod/courseoverview
source: sitemap
fetched_at: 2026-02-17T15:26:23.671654-03:00
rendered_js: false
word_count: 978
summary: This document provides technical instructions for developers on how to integrate Moodle activity plugins with the course overview table by extending the activityoverviewbase class.
tags:
    - moodle-development
    - plugin-integration
    - course-format
...
The `overview` class will be loaded using [dependency injection](https://moodledev.io/docs/5.0/apis/core/di). The constructor must accept a `cm_info` object to initialize the parent class, however, the constructor can also accept other dependencies that the plugin needs.
