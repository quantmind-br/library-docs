...
source: sitemap
fetched_at: 2026-01-22T22:15:07.791599058-03:00
rendered_js: false
word_count: 579
summary: This document explains how to use advanced configuration keywords in Hyprland to manage command execution, multi-file sourcing, per-device input settings, and environment variables.
tags:
    - hyprland
