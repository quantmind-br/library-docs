...
source: sitemap
fetched_at: 2026-04-26T08:38:59.739880445-03:00
rendered_js: false
word_count: 471
summary: This document explains how to create and apply custom JSON-based color themes for DankMaterialShell, detailing the required color properties and theme configuration options.
tags:
    - dankmaterialshell
    - theming
    - json-configuration
...
DankMaterialShell supports custom color themes using arbitrary color schemes defined in JSON files that map to [matugen color keywords](https://github.com/InioX/matugen/wiki/Configuration#colors). Themes can have separate `dark` and `light` variants, or use a single color scheme for both modes.
