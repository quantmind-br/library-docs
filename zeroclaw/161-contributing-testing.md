---
title: Testing
url: https://github.com/openagen/zeroclaw/blob/master/docs/contributing/testing.md
source: git
fetched_at: 2026-05-02T14:50:47.842220543-03:00
rendered_js: false
word_count: 588
summary: This document outlines the testing architecture, directory organization, and execution procedures for the ZeroClaw project, including its five-level testing taxonomy and shared mock infrastructure.
tags:
    - rust-testing
    - software-testing
    - test-automation
...
For Telegram-specific testing details, see [[160-contributing-testing-telegram|testing-telegram]].
#rust-testing #software-testing #test-automation
