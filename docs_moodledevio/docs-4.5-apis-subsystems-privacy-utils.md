...
url: https://moodledev.io/docs/4.5/apis/subsystems/privacy/utils
source: sitemap
fetched_at: 2026-02-17T15:14:56.504601-03:00
rendered_js: false
word_count: 53
summary: This document provides CLI scripts designed to help developers test and verify Privacy API implementations in Moodle plugins, including compliance checking and user data export.
tags:
    - moodle-development
    - privacy-api
    - cli-scripts
...
Put these scripts into the root of your Moodle development installation and run them via command line. See [Privacy API](https://moodledev.io/docs/4.5/apis/subsystems/privacy) for the full guide on implementing the API in your plugin.
