...
source: llms
fetched_at: 2026-02-05T21:41:01.818616461-03:00
rendered_js: false
word_count: 378
summary: This document provides instructions for configuring and running Ollama models locally or via the cloud, including hardware requirements, setup steps, and integration settings for the Factory platform.
tags:
    - ollama
    - local-llm
    - factory-ai
