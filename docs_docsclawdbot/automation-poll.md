...
source: llms
fetched_at: 2026-01-26T09:50:04.057197757-03:00
rendered_js: false
word_count: 178
summary: This document provides technical specifications and usage instructions for creating polls on WhatsApp, Discord, and MS Teams using the Clawdbot CLI, Gateway RPC, and agent tools.
tags:
    - clawdbot
    - polls
    - cli-commands
