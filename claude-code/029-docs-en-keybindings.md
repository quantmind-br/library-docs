...
source: llms
fetched_at: 2026-04-16T22:33:09.453768178-03:00
rendered_js: false
word_count: 2280
summary: This document provides instructions and reference information for customizing keyboard shortcuts within the Claude Code environment using a JSON configuration file.
tags:
    - claude-code
    - keyboard-shortcuts
    - configuration
