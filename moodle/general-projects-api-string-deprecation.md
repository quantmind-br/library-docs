---
title: String deprecation | Moodle Developer Resources
url: https://moodledev.io/general/projects/api/string-deprecation
source: sitemap
fetched_at: 2026-02-17T16:02:18.756619-03:00
rendered_js: false
word_count: 931
summary: This document outlines the process and rationale for deprecating and eventually removing unused language strings in Moodle to maintain clean language packs. It provides step-by-step instructions for developers on how to safely transition strings and handle deprecation warnings.
tags:
    - moodle-development
    - string-deprecation
    - language-packs
...
## Removing strings which are no longer used[​](#removing-strings-which-are-no-longer-used "Direct link to Removing strings which are no longer used")
...
### Why and when should a string be deprecated?[​](#why-and-when-should-a-string-be-deprecated "Direct link to Why and when should a string be deprecated?")
...
The same logic applies to cases when a very specific string is to be moved or renamed. In this situation, it is valid to just move it (together with the matching [MOV instruction in the AMOScript](https://moodledev.io/general/projects/api/amos)).

## How to deprecate a string[​](#how-to-deprecate-a-string "Direct link to How to deprecate a string")
...
## What to do if you get a debugging message[​](#what-to-do-if-you-get-a-debugging-message "Direct link to What to do if you get a debugging message")
