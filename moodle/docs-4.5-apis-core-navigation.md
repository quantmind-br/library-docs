...
url: https://moodledev.io/docs/4.5/apis/core/navigation
source: sitemap
fetched_at: 2026-02-17T15:11:26.700737-03:00
rendered_js: false
word_count: 1881
summary: This document explains the architecture and implementation of the Moodle Navigation API, detailing how to manage navigation, settings, and breadcrumbs through the global page object.
tags:
    - moodle-development
    - navigation-api
    - php-api
...
- [Core APIs](https://moodledev.io/docs/4.5/apis)
