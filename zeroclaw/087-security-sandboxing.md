---
title: Sandboxing
url: https://github.com/openagen/zeroclaw/blob/master/docs/security/sandboxing.md
source: git
fetched_at: 2026-05-02T14:52:10.559315836-03:00
rendered_js: false
word_count: 253
optimized: true
...
ZeroClaw currently has application-layer security but lacks OS-level containment. If an attacker bypasses application controls, they could run any allowed command with zeroclaw's user permissions. Proposed solutions: Firejail, Bubblewrap, Docker, and Landlock for OS-level isolation.
