...
url: https://github.com/openagen/zeroclaw/blob/master/docs/i18n/vi/channels-reference.md
source: git
fetched_at: 2026-05-02T14:51:04.739728727-03:00
rendered_js: false
word_count: 2534
summary: Tài liệu này cung cấp hướng dẫn chi tiết về cấu hình, thiết lập channel và quản lý runtime cho các nền tảng tin nhắn tích hợp trong ZeroClaw.
tags:
    - zeroclaw
    - configuration
    - channel-setup
...
> [!tip]
> Với các phòng Matrix được mã hóa, xem hướng dẫn chuyên biệt: [[133-vi-channels-reference#matrix|Hướng dẫn Matrix E2EE]]
...
- Cần hỗ trợ phòng Matrix được mã hóa: dùng [[133-vi-channels-reference#matrix|Hướng dẫn Matrix E2EE]].
- Cần thông tin triển khai/mạng (polling vs webhook): dùng [[039-i18n-vi-network-deployment|Network Deployment]].

> [!warning]
> **FAQ: Cấu hình Matrix thành công nhưng không có phản hồi**
>
> Đây là triệu chứng phổ biến nhất (cùng loại với issue #499). Kiểm tra theo thứ tự:
>
...
| Channel | Trường allowlist |
|---|---|
| Telegram/Discord/Slack/Mattermost/Matrix/IRC/Lark/DingTalk/QQ | `allowed_users` |
| Signal | `allowed_from` |
...
## 7. Ví dụ cấu hình theo từng channel
...
> [!tip]
> Xem [[133-vi-channels-reference#matrix|Hướng dẫn Matrix E2EE]] để xử lý sự cố phòng mã hóa.
...
### 7.8 Cấu hình Webhook Channel (Gateway)
...
## 9. Danh sách kiểm tra xử lý sự cố
...
> [!tip]
> Đặc biệt với các phòng Matrix mã hóa, dùng: [[133-vi-channels-reference#matrix|Hướng dẫn Matrix E2EE]]

---

## 10. Phụ lục vận hành: bảng từ khóa log

Dùng phụ lục này để phân loại sự cố nhanh. Khớp từ khóa log trước, sau đó thực hiện các bước xử lý sự cố ở trên.

### 10.1 Lệnh capture được khuyến nghị
...
### 10.3 Từ khóa của runtime supervisor
...
#zeroclaw #configuration #channel-setup #multimodal #api-integration #messaging-bots #vietnamese-docs