...
url: https://docs.vllm.ai/en/latest/api/vllm/entrypoints/openai/speech_to_text/speech_to_text/
source: sitemap
fetched_at: 2026-05-07T21:20:41.013648786-03:00
rendered_js: false
word_count: 40
summary: This document defines a base class for speech-to-text operations, managing audio preprocessing, language detection, and prompt generation for transcription and translation tasks.
tags:
    - speech-to-text
    - audio-processing
    - transcription
...
```
classOpenAISpeechToText(OpenAIServing):
...
"""Auto-detect the spoken language from an audio chunk.
    ...
    async def_preprocess_speech_to_text(
        ...
        try:
            ...
            raise ValueError("Invalid or unsupported audio file.") fromexc
    ...
    def_preprocess_verbose_prompt(self, prompt: EncoderDecoderDictPrompt):
    ...
    @staticmethod
    def_get_decoder_prompt_len(engine_inputs: list[EngineInput]) -> int:
...
"""
    ...
    async def_create_speech_to_text(
        self,
        audio_data: bytes,
        request: SpeechToTextRequest,
        raw_request: Request,
...
"""Base method for speech-to-text operations like transcription and
    ...
    async def_speech_to_text_stream_generator(
        self,
        request: SpeechToTextRequest,
