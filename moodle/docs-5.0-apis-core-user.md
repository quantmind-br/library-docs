...
url: https://moodledev.io/docs/5.0/apis/core/user
source: sitemap
fetched_at: 2026-02-17T15:25:06.210495-03:00
rendered_js: false
word_count: 1070
summary: This document outlines various Moodle APIs used to manage, display, and validate user data, including tools for generating profile information and implementing user selection widgets.
tags:
    - moodle-development
    - user-api
    - user-fields
...
- [Access API](https://moodledev.io/docs/5.0/apis/subsystems/access)
