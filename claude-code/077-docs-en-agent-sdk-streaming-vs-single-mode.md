...
source: llms
fetched_at: 2026-04-16T22:29:50.799063873-03:00
rendered_js: false
word_count: 269
summary: This guide explains the differences between streaming input mode and single message input within the Claude Agent SDK, helping developers decide which mode to use based on their application's needs.
tags:
    - claude-agent-sdk
    - streaming-input
    - ai-agents
