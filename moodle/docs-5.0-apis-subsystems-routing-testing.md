...
url: https://moodledev.io/docs/5.0/apis/subsystems/routing/testing
source: sitemap
fetched_at: 2026-02-17T15:28:13.464265-03:00
rendered_js: false
word_count: 501
summary: This document explains how to perform unit testing for Moodle routes using the route_testcase class and its helper methods. It details how to create a simplified router, mock specific routes, and simulate requests to validate route behavior and parameters.
tags:
    - moodle-development
    - unit-testing
    - phpunit
    - routing-api
    - mocking-route-loader
    - request-handling
    - server-request
category: guide
---

One of the benefits of using routes is how easy they are to unit test. It is also possible to test [parameters](https://moodledev.io/docs/5.0/apis/subsystems/routing/parameters) for validation, which is especially useful for [mapped parameters](https://moodledev.io/docs/5.0/apis/subsystems/routing/parameters#mapped-parameters).
