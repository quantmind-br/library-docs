---
title: Qwen 3.5 Usage - SGLang Documentation
url: https://docs.sglang.io/docs/basic_usage/qwen3_5
source: sitemap
fetched_at: 2026-05-11T05:49:00.805588876-03:00
rendered_js: false
word_count: 251
summary: This document provides technical instructions for deploying, configuring, and evaluating the Qwen 3.5 language model using the SGLang inference framework, with specific guidance for AMD hardware environments.
tags:
    - sglang
    - qwen-3.5
    - llm-serving
...
Qwen 3.5 is Alibaba’s latest generation LLM featuring a hybrid attention architecture, advanced MoE with shared experts, and native multimodal capabilities. Key architecture features:
