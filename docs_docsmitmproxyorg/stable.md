...
source: crawler
fetched_at: 2026-01-28T16:17:55.40416174-03:00
rendered_js: false
word_count: 480
summary: This document introduces mitmproxy, a suite of tools for intercepting and manipulating HTTP/1, HTTP/2, and WebSockets traffic. It describes the core functionality and differentiates between mitmproxy (console), mitmweb (web UI), and mitmdump (command-line) tools.
tags:
    - mitmproxy
    - http-proxy
