---
title: gdn_linear_attn - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/layers/mamba/gdn_linear_attn/
source: sitemap
fetched_at: 2026-05-07T21:25:53.072230723-03:00
rendered_js: false
word_count: 17
summary: This document defines the GatedDeltaNetAttention layer implementation for the vLLM framework, managing model configurations, projection layers, and cross-platform compute execution.
tags:
    - vllm
    - attention-mechanism
    - gated-delta-net
...
classGatedDeltaNetAttention(PluggableLayer, MambaBase):
    @property
    ...
    def__init__(
        ...
        if current_platform.is_xpu():
            ...
            fromvllm.model_executor.layers.mamba.ops.cpu.gdn_attentionimport (
    ...
    deffix_query_key_value_ordering(
        self,
...
"""
    ...
    def_warmup_prefill_kernels(self, mixed_qkv: torch.Tensor) -> None:
"""Warm up GDN prefill kernels during V1 profiling.
    ...
    def_forward_core_decode_non_spec(
        self,
        mixed_qkv: torch.Tensor,
        b: torch.Tensor,
        a: torch.Tensor,
