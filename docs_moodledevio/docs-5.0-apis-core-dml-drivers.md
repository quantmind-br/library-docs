...
url: https://moodledev.io/docs/5.0/apis/core/dml/drivers
source: sitemap
fetched_at: 2026-02-17T15:24:37.381362-03:00
rendered_js: false
word_count: 151
summary: This document outlines the native database drivers supported by Moodle's DML layer and explains how to configure query logging features for performance and debugging.
tags:
    - moodle
    - database-drivers
    - dml
...
- [DML functions](https://moodledev.io/docs/5.0/apis/core/dml): Where all the functions used to handle DB data ([DML](https://en.wikipedia.org/wiki/Data_Manipulation_Language)) are defined.
