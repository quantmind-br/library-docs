...
url: https://moodledev.io/docs/4.5/apis/plugintypes/mod/visibility
source: sitemap
fetched_at: 2026-02-17T15:12:31.235947-03:00
rendered_js: false
word_count: 1179
summary: This document explains the Moodle API for customizing how course modules are displayed and accessed on course pages, including methods for caching metadata and rendering dynamic user-specific content.
tags:
    - moodle-development
    - course-module-api
