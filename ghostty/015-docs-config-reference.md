...
source: crawler
fetched_at: 2026-02-11T01:43:12.86362-03:00
rendered_js: true
word_count: 19049
summary: This document provides a comprehensive reference for Ghostty terminal emulator configuration options, focusing primarily on font selection, styling, and advanced typographic settings.
tags:
    - ghostty
    - terminal-emulator
    - font-configuration
...
When this is true, the default configuration file paths will be loaded. The default configuration file paths are currently only the XDG config path ($XDG\_CONFIG\_HOME/ghostty/config).
