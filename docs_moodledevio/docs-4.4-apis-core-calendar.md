...
url: https://moodledev.io/docs/4.4/apis/core/calendar
source: sitemap
fetched_at: 2026-02-17T15:02:04.097315-03:00
rendered_js: false
word_count: 1799
summary: This document explains how to programmatically manage calendar events in Moodle using the Calendar API, covering creation, modification, deletion, and dashboard integration.
tags:
    - moodle-development
    - calendar-api
    - event-management
