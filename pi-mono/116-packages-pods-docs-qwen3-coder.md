---
title: Qwen3 coder
url: https://github.com/badlogic/pi-mono/blob/main/packages/pods/docs/qwen3-coder.md
source: git
fetched_at: 2026-03-03T03:46:27.522137-03:00
rendered_js: false
word_count: 561
summary: A guide for installing, configuring, and deploying the Qwen3-Coder large language model using vLLM with optimizations like BF16, FP8, and tool-call support for high-performance serving.
tags:
    - qwen3-coder
    - vllm
    - llm-deployment
