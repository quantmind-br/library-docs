...
url: https://moodledev.io/docs/4.5/apis/core/customfields
source: sitemap
fetched_at: 2026-02-17T15:11:01.78446-03:00
rendered_js: false
word_count: 795
summary: This document provides a technical overview of the Custom Fields API, detailing how to define custom field areas, implement handler classes, and integrate custom fields into plugin forms. It also covers data retrieval methods and compliance requirements for the Privacy API.
tags:
    - custom-fields-api
    - plugin-development
    - moodle-api
...
Except for common [Plugin files](https://moodledev.io/docs/4.5/apis/commonfiles) and tests the following classes must be present in `customfield` plugins (in respective autoloaded locations):
