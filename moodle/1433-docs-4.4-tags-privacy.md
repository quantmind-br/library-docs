...
url: https://moodledev.io/docs/4.4/tags/privacy
source: sitemap
fetched_at: 2026-02-17T15:00:36.628101-03:00
rendered_js: false
word_count: 85
summary: This document introduces the Moodle Privacy API and its role in ensuring GDPR compliance, while also mentioning CLI utilities for testing privacy implementations in plugins.
tags:
    - moodle-development
    - privacy-api
    - gdpr-compliance
...
## [Utilities](https://moodledev.io/docs/4.4/apis/subsystems/privacy/utils)
