...
source: crawler
fetched_at: 2026-01-13T19:15:15.030087105-03:00
rendered_js: false
word_count: 2548
summary: This document outlines the process for contributing to the Gemini CLI project, covering prerequisites, code and documentation contribution guidelines, and development setup.
tags:
    - contributing
    - code-contribution
    - pull-requests
...
- **[Before you begin](#before-you-begin):** Essential steps to take before becoming a Gemini CLI contributor.
- **[Code contribution process](#code-contribution-process):** How to contribute code to Gemini CLI.
- **[Development setup and workflow](#development-setup-and-workflow):** How to set up your development environment and workflow.
- **[Documentation contribution process](#documentation-contribution-process):** How to contribute documentation to Gemini CLI.
...
gitclonehttps://github.com/google-gemini/gemini-cli.git# Or your fork's URL
cdgemini-cli
```
...
echo "npmbuildfailed.Commitaborted."
exit 1
fi
...
1. Start the CLI in debug mode from the root directory: This command runs `node --inspect-brk dist/gemini.js` within the `packages/cli` directory, pausing execution until a debugger attaches. You can then open `chrome://inspect` in your Chrome browser to connect to the debugger.
...
2. **Install and run React DevTools version 4.28.5 (or the latest compatible 4.x version):**
   ...
   npminstall-greact-devtools@4.28.5
   react-devtools
   ```
...
Our documentation is organized using [sidebar.json](https://geminicli.com/docs/sidebar.json) as the table of contents. When adding new documentation:
...
- Open [an issue](https://github.com/google-gemini/gemini-cli/issues) to discuss your proposed changes.
