...
url: https://moodledev.io/docs/5.2/apis/subsystems/task/adhoc
source: sitemap
fetched_at: 2026-02-17T15:46:34.219063-03:00
rendered_js: false
word_count: 697
summary: This document explains how to implement and manage adhoc background tasks, covering task class creation, data handling, scheduling, and retry logic.
tags:
    - adhoc-tasks
