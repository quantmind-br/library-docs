...
url: https://moodledev.io/docs/5.0/tags/conversion
source: sitemap
fetched_at: 2026-02-17T15:17:18.541255-03:00
rendered_js: false
word_count: 69
summary: This document explains the role and functionality of file converters in Moodle, detailing how they allow plugins to transform files between different formats using the File conversion API.
tags:
    - moodle-development
    - file-conversion
    - api-integration
