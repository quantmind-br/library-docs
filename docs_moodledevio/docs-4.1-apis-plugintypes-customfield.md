---
title: Course Custom fields | Moodle Developer Resources
url: https://moodledev.io/docs/4.1/apis/plugintypes/customfield
source: sitemap
fetched_at: 2026-02-17T14:55:15.93596-03:00
rendered_js: false
word_count: 0
summary: This document defines a Moodle field controller class used to create and configure custom field settings using the MoodleQuickForm API.
tags:
    - moodle
    - custom-fields
    - php-development
