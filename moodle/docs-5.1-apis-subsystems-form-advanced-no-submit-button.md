...
url: https://moodledev.io/docs/5.1/apis/subsystems/form/advanced/no-submit-button
source: sitemap
fetched_at: 2026-02-17T15:36:44.022754-03:00
rendered_js: false
word_count: 156
summary: This document explains how to use the no_submit_button_pressed() method in Moodle forms to handle auxiliary button actions that trigger sub-actions without completing a full form submission.
tags:
    - moodle-forms
    - moodle-api
    - form-handling
