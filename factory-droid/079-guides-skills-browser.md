...
source: llms
fetched_at: 2026-02-05T21:44:15.037052919-03:00
rendered_js: false
word_count: 722
summary: This document provides a guide for setting up and using a browser automation skill for Factory Droids to perform tasks like navigation, JavaScript evaluation, and DOM extraction. It outlines the installation and implementation of lightweight Chrome DevTools Protocol helpers for local development environments.
tags:
    - browser-automation
