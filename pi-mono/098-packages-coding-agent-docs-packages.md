...
source: git
fetched_at: 2026-03-03T03:40:09.536717-03:00
rendered_js: false
word_count: 944
summary: Guide explaining how to create, structure, and distribute Pi packages for bundling extensions, skills, prompt templates, and themes for sharing via npm or Git.
tags:
    - pi-packages
    - npm-packages
    - git-packages
