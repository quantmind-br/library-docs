---
title: OpenAI-Compatible APIs - SGLang Documentation
url: https://docs.sglang.io/docs/basic_usage/openai_api
source: sitemap
fetched_at: 2026-05-11T05:51:34.283150467-03:00
rendered_js: false
word_count: 95
summary: This document provides a comprehensive overview of advanced configuration options, optimization techniques, and architectural features for the SGLang framework. It covers topics such as speculative decoding, parallelism strategies, quantization, and specialized model serving capabilities.
tags:
    - sglang
    - llm-inference
    - model-optimization
