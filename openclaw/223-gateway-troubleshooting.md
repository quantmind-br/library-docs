...
source: sitemap
fetched_at: 2026-01-30T20:28:54.366373781-03:00
rendered_js: false
word_count: 2667
summary: Provides troubleshooting guidance for OpenClaw runtime failures and diagnostics, covering common issues like authentication problems, service startup errors, and environment configuration.
tags:
    - troubleshooting
    - runtime-failure
    - diagnostics
...
- If you must stay on HTTP, enable `gateway.controlUi.allowInsecureAuth: true` and use a gateway token (token-only; no device identity/pairing). See [Control UI](https://docs.openclaw.ai/web/control-ui#insecure-http).

### CI Secrets Scan Failed

This means `detect-secrets` found new candidates not yet in the baseline. Follow [Secret scanning](https://docs.openclaw.ai/gateway/security#secret-scanning-detect-secrets).
