---
title: argparse_utils - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/utils/argparse_utils/
source: sitemap
fetched_at: 2026-05-07T21:38:29.254746482-03:00
rendered_js: false
word_count: 60
summary: This class extends the standard Python ArgumentParser to support flexible argument naming with both underscores and dashes, while adding JSON-based configuration parsing and custom help formatting functionality.
tags:
    - python
    - argparse
...
````
classFlexibleArgumentParser(ArgumentParser):
"""ArgumentParser that allows both underscore and dash in names."""
    ...
    if sys.version_info < (3, 13):
        ...
        defparse_known_args(self, args=None, namespace=None):
        ...
        class_FlexibleArgumentGroup(_ArgumentGroup):
            defadd_argument(self, *args, **kwargs):
                deprecated = kwargs.pop("deprecated", False)
                action = super().add_argument(*args, **kwargs)
                if deprecated:
        ...
        defadd_argument_group(self, *args, **kwargs):
    ...
    defparse_args(  # type: ignore[override]
        self,
...
"""Replaces underscores with dashes in the matched string."""
        ...
        defcreate_nested_dict(keys: list[str], value: str) -> dict[str, Any]:
...
"""Recursively updates a dictionary with another dictionary.
    ...
    defcheck_port(self, value):
        try:
            value = int(value)
        except ValueError:
            msg = "Port must be an integer"
            raise ArgumentTypeError(msg) fromNone
    ...
    def_pull_args_from_config(self, args: list[str]) -> list[str]:
"""Method to pull arguments specified in the config file
    ...
    defload_config_file(self, file_path: str) -> list[str]:
