---
title: Contributing to SGLang Diffusion - SGLang Documentation
url: https://docs.sglang.io/docs/sglang-diffusion/contributing
source: sitemap
fetched_at: 2026-05-11T05:48:12.608393885-03:00
rendered_js: false
word_count: 306
summary: This document provides guidelines for contributing to the SGLang Diffusion module, covering coding standards for AI-assisted development, commit message conventions, and mandatory performance reporting procedures.
tags:
    - contribution-guide
    - sglang
    - diffusion-models
...
- [Support New Models](https://docs.sglang.io/docs/sglang-diffusion/support_new_models): implementation guide for adding new diffusion pipelines
- [CI Performance](https://docs.sglang.io/docs/sglang-diffusion/ci_perf): update and regenerate perf baselines
...
Please run the according testcase, then update/add the baseline to `perf_baselines.json` by following the instruction in console if applicable. See [test](https://github.com/sgl-project/sglang/tree/main/python/sglang/multimodal_gen/test) for examples