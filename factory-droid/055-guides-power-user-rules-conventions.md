...
source: llms
fetched_at: 2026-02-05T21:44:04.874999599-03:00
rendered_js: false
word_count: 1124
summary: This document explains how to establish and organize prescriptive coding standards and conventions for Droid using rule files in the .factory/rules/ directory. It provides templates and examples for writing actionable rules for TypeScript, React, and testing environments.
tags:
    - factory-ai
    - coding-standards
    - droid-configuration
