...
source: crawler
fetched_at: 2026-05-06T21:32:13.483612769-03:00
rendered_js: false
word_count: 2576
summary: This document explains the use of if, else if, and else expressions in Rust for control flow, including how to use if as an expression for variable assignment.
tags:
    - rust
    - control-flow
    - if-expressions
