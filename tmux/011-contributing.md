---
title: Contributing
url: https://github.com/tmux/tmux/wiki/Contributing
source: wiki
fetched_at: 2026-02-04T15:44:41.465941091-03:00
rendered_js: false
word_count: 2094
summary: This document outlines the tmux development process, including source code management, release cycles, and a roadmap of planned features and documentation improvements.
tags:
    - tmux
...
- ([#4811](https://github.com/orgs/tmux/discussions/4811)) Add a `-O` flag to
  `switch-client`, `list-window`, `list-sessions`, `list-panes` to sort, like
  `choose-session -O`.
...
- ([#4705](https://github.com/tmux/tmux/issues/4705)) Apply changes to
  `history-limit` to existing panes (unsure whether this should just increase
  or also trim).
