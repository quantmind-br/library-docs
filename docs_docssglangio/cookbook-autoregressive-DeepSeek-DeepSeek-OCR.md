---
title: DeepSeek-OCR - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/DeepSeek/DeepSeek-OCR
source: sitemap
fetched_at: 2026-05-11T05:51:03.474937531-03:00
rendered_js: false
word_count: 297
summary: This document provides an overview, deployment instructions, and performance benchmarking for the DeepSeek-OCR model within the SGLang serving framework.
tags:
    - sglang
    - deepseek-ocr
    - model-deployment
...
[DeepSeek-OCR](https://github.com/deepseek-ai/DeepSeek-OCR) is DeepSeek’s advanced OCR (Optical Character Recognition) model designed for high-accuracy text extraction from images. The model is optimized for various document processing and image-to-text conversion tasks. **Key Features:**
...
**License:** To use DeepSeek-OCR, you must agree to DeepSeek’s Community License. See [LICENSE](https://huggingface.co/deepseek-ai/DeepSeek-OCR/blob/main/LICENSE) for details. For more details, please refer to the [official DeepSeek-OCR repository](https://github.com/deepseek-ai/DeepSeek-OCR).
