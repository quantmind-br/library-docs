---
title: EscapeDebug in std::str - Rust
url: https://doc.rust-lang.org/std/str/struct.EscapeDebug.html
source: crawler
fetched_at: 2026-05-06T21:22:56.766440203-03:00
rendered_js: false
word_count: 1413
summary: This document provides a reference list of methods available in the Rust Iterator trait for processing and transforming data sequences.
tags:
    - rust
    - iterator
    - api-reference
