---
title: DeepSeek-V3 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/DeepSeek/DeepSeek-V3
source: sitemap
fetched_at: 2026-05-11T05:51:04.008644098-03:00
rendered_js: false
word_count: 569
summary: This document provides a guide for deploying and utilizing the DeepSeek V3 model within the SGLang framework, covering server configuration, reasoning parser integration, and tool calling capabilities.
tags:
    - deepseek-v3
    - sglang
    - llm-deployment
...
For more detailed configuration tips, please refer to [DeepSeek-V3 Usage](https://docs.sglang.io/docs/basic_usage/deepseek_v3).
