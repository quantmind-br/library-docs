...
source: git
fetched_at: 2026-03-03T03:39:26.740906-03:00
rendered_js: false
word_count: 1950
summary: Document teaches how to extend the system with custom model providers, detailing proxy configuration, authentication, OAuth/SSO support, and provider management via `pi.registerProvider` or `pi.unregisterProvider`.
tags:
    - provider-extensions
    - custom-provider
    - api-authentication
