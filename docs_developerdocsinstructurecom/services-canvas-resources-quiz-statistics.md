---
title: Quiz Statistics | Instructure Developer Documentation Portal
url: https://developerdocs.instructure.com/services/canvas/resources/quiz_statistics
source: sitemap
fetched_at: 2026-02-15T09:08:50.944083-03:00
rendered_js: false
word_count: 556
summary: This document details the API for retrieving aggregate quiz submission statistics, including student performance metrics and question-level item analysis. It defines various data objects and endpoints used to access graded submission insights and specific question-type statistics.
tags:
    - quiz-statistics
    - api-documentation
    - student-analysis
...
[Quizzes::QuizStatisticsController#indexarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/quizzes/quiz_statistics_controller.rb)
...
Multiple Dropdown question statistics look just like the statistics for [Fill In Multiple Blanks](https://developerdocs.instructure.com/services/canvas/resources/quiz_statistics#fimb-question-stats).
...
File Upload question statistics look just like the statistics for [Essays](https://developerdocs.instructure.com/services/canvas/resources/quiz_statistics#essay-question-stats).

**Formula**

Formula question statistics look just like the statistics for [Essays](https://developerdocs.instructure.com/services/canvas/resources/quiz_statistics#essay-question-stats).
...
True/False question statistics look just like the statistics for [Multiple-Choice](https://developerdocs.instructure.com/services/canvas/resources/quiz_statistics#multiple-choice-question-stats).
