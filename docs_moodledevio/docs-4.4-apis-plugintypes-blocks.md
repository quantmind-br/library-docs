...
url: https://moodledev.io/docs/4.4/apis/plugintypes/blocks
source: sitemap
fetched_at: 2026-02-17T15:02:55.097478-03:00
rendered_js: false
word_count: 2077
summary: This guide outlines the mandatory file structure and essential class definitions required to develop block plugins in Moodle, covering components like access control, language strings, and version metadata.
tags:
    - moodle-development
    - block-plugins
    - plugin-structure
