...
url: https://moodledev.io/docs/4.5/apis/core/preference
source: sitemap
fetched_at: 2026-02-17T15:11:27.264766-03:00
rendered_js: false
word_count: 306
summary: This document explains the Preference API used for storing and retrieving user-specific data in either the database or session. It details the primary PHP functions for managing user preferences and provides best practices for their implementation.
tags:
    - preference-api
    - user-preferences
    - session-storage
