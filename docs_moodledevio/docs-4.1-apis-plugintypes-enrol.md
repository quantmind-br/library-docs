...
url: https://moodledev.io/docs/4.1/apis/plugintypes/enrol
source: sitemap
fetched_at: 2026-02-17T14:55:17.357362-03:00
rendered_js: false
word_count: 1536
summary: This document explains the architecture and development requirements for Moodle enrolment plugins, detailing their file structure, base classes, and core functionalities.
tags:
    - moodle-development
    - enrolment-plugins
    - php
