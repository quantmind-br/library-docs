---
title: Moodle 2.9 | Moodle Developer Resources
url: https://moodledev.io/general/releases/2.9
source: sitemap
fetched_at: 2026-02-17T16:08:07.290808-03:00
rendered_js: false
word_count: 1960
summary: This document provides the release notes for Moodle 2.9, detailing the minimum server and client requirements, database support, and major feature enhancements.
tags:
    - moodle-release
    - server-requirements
...
Here is [the full list of fixed issues in 2.9](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%222.9%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
### User interface improvements[​](#user-interface-improvements "Direct link to User interface improvements")
...
### Course creation improvements[​](#course-creation-improvements "Direct link to Course creation improvements")
...
### Administrator features[​](#administrator-features "Direct link to Administrator features")
...
### Files and repositories[​](#files-and-repositories "Direct link to Files and repositories")
...
### Authentication, enrolments and access[​](#authentication-enrolments-and-access "Direct link to Authentication, enrolments and access")
...
- [MDL-35280](https://moodle.atlassian.net/browse/MDL-35280) - quiz\_reset\_userdata does not have an option to remove user/group overrides
- [MDL-48898](https://moodle.atlassian.net/browse/MDL-48898) - Quiz time period setting should use admin\_setting\_configduration
...
### Various[​](#various "Direct link to Various")
...
- [MDL-49333](https://moodle.atlassian.net/browse/MDL-49333) - Return additional information in WebService core\_get\_site\_info
...
- [MDL-49163](https://moodle.atlassian.net/browse/MDL-49163) - Support for calling webservice functions directly from JavaScript. Developer docs: [AJAX](https://moodledev.io/docs/5.2/guides/javascript/ajax)
- [MDL-49152](https://moodle.atlassian.net/browse/MDL-49152) - Support for implementing renderers as mustache templates (php and JavaScript). Developer docs: [Templates](https://moodledev.io/docs/5.2/guides/templates)
- [MDL-44874](https://moodle.atlassian.net/browse/MDL-44874) - A new per-request directory API has been added, and should be used instead of make\_temp\_directory wherever possible.
...
- [MDL-49163](https://moodle.atlassian.net/browse/MDL-49163) - Unified Ajax script handler. Developer docs: [AJAX](https://moodledev.io/docs/5.2/guides/javascript/ajax)
...
- [MDL-37477](https://moodle.atlassian.net/browse/MDL-37477) - html\_table API supports caption tag
...
- [Notes de mise à jour de Moodle 2.9](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_2.9)
