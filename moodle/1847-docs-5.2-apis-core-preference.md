...
url: https://moodledev.io/docs/5.2/apis/core/preference
source: sitemap
fetched_at: 2026-02-17T15:43:42.410068-03:00
rendered_js: false
word_count: 306
summary: This document explains the Preference API for managing user-specific settings, including storage in the database for registered users and sessions for guests. It details the core functions for retrieving, setting, and deleting user preferences while providing best practices for data redundancy.
tags:
    - preference-api
    - user-settings
    - data-persistence
