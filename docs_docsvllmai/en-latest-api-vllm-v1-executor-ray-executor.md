---
title: ray_executor - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/executor/ray_executor/
source: sitemap
fetched_at: 2026-05-07T21:40:48.144779301-03:00
rendered_js: false
word_count: 27
summary: This code implements a distributed executor for vLLM using Ray to manage and orchestrate GPU workers across a cluster, handling resource allocation, worker initialization, and process management.
tags:
...
```
classRayDistributedExecutor(Executor):
...
"""Ray distributed executor supports pipeline parallelism,
    ...
    def_configure_ray_workers_use_nsight(self, ray_remote_kwargs) -> dict[str, Any]:
    ...
    def_update_noset_device_env_vars(self, ray_remote_kwargs):
        runtime_env = ray_remote_kwargs.setdefault("runtime_env", {})
    ...
    def_get_env_vars_to_be_updated(self):
        return self._env_vars_for_all_workers

    def_init_workers_ray(self, placement_group: "PlacementGroup", **ray_remote_kwargs):
        ...
        defsort_by_driver_then_worker_ip(item: RayWorkerMetaData):
"""
...
"""Runs the given method on all workers."""
    ...
    def_check_ray_cgraph_installation(self):
    ...
    def_compiled_ray_dag(self, enable_asyncio: bool):
        ...
        fromray.dagimport InputNode, MultiOutputNode
        ...
        if envs.VLLM_USE_RAY_WRAPPED_PP_COMM:
            fromray.experimental.channel.accelerator_contextimport (
                register_accelerator_context,
            )

            fromvllm.distributed.device_communicators.ray_communicatorimport (
                RayPPCommunicator,
            )
