---
title: batch_serving - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/entrypoints/openai/chat_completion/batch_serving/
source: sitemap
fetched_at: 2026-05-07T21:19:51.809735573-03:00
rendered_js: false
word_count: 29
summary: This class extends OpenAI-compatible chat serving to provide a batch endpoint that processes multiple conversations concurrently within a single request.
tags:
    - batch-processing
    - chat-completion
    - api-endpoint
...
```
classOpenAIServingChatBatch(OpenAIServingChat):
"""Extends OpenAIServingChat with the /v1/chat/completions/batch endpoint.
    ...
    async defrender_batch_chat_request(
        self,
...
"""Validate the model and preprocess a batched chat completion request.
    ...
    async defcreate_batch_chat_completion(
        self,
        request: BatchChatCompletionRequest,
...
"""Batch Chat Completion endpoint (/v1/chat/completions/batch).
    ...
    async defchat_completion_full_generator_batch(
        self,
