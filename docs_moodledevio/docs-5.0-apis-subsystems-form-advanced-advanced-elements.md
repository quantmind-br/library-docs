...
url: https://moodledev.io/docs/5.0/apis/subsystems/form/advanced/advanced-elements
source: sitemap
fetched_at: 2026-02-17T15:27:37.707503-03:00
rendered_js: false
word_count: 298
summary: This document explains how to hide form elements or entire sections in Moodle forms using the setAdvanced method. It covers implementation details, unsetting the advanced status, and the importance of unique header naming for correct UI behavior.
tags:
    - moodle-forms
    - moodlequickform
    - setadvanced
