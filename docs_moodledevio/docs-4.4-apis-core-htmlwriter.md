...
url: https://moodledev.io/docs/4.4/apis/core/htmlwriter
source: sitemap
fetched_at: 2026-02-17T15:02:27.969436-03:00
rendered_js: false
word_count: 56
summary: This document explains how to use the Moodle html_writer class to programmatically generate HTML tags and attributes within PHP renderer functions.
tags:
    - moodle-development
    - html-writer
    - php-rendering
...
Please consider using [templates](https://moodledev.io/docs/4.4/guides/templates) as an alternative to the *HTML writer*.
