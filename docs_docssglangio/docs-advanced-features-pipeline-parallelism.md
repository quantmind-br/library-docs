---
title: Pipeline Parallelism for Long Context - SGLang Documentation
url: https://docs.sglang.io/docs/advanced_features/pipeline_parallelism
source: sitemap
fetched_at: 2026-05-11T05:49:29.534855983-03:00
rendered_js: false
word_count: 1609
summary: This document explains SGLang's implementation of dynamic chunked prefill and asynchronous pipeline parallelism to reduce Time to First Token (TTFT) in large language model serving. It details the scheduling, memory management, and hyperparameter tuning strategies required to optimize performance in multi-node GPU environments.
tags:
    - sglang
