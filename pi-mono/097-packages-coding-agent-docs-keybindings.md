...
source: git
fetched_at: 2026-03-03T03:39:53.260352-03:00
rendered_js: false
word_count: 862
summary: Explains how to customize keyboard shortcuts for a text editor via JSON configuration in `~/.pi/agent/keybindings.json`
tags:
    - keyboard-shortcuts
