...
url: https://moodledev.io/docs/4.1/apis/subsystems/roles
source: sitemap
fetched_at: 2026-02-17T14:56:54.693733-03:00
rendered_js: false
word_count: 1439
summary: This document explains the architecture of the Moodle Roles API, defining how roles, capabilities, and permissions interact within various contexts to manage user access and system security.
tags:
    - moodle
    - roles-api
    - access-control
