...
source: sitemap
fetched_at: 2026-05-07T21:16:53.958973923-03:00
rendered_js: false
word_count: 310
summary: This document defines the CompilationConfig class, which manages compilation settings for vLLM, including torch.compile modes, backend selection, CUDA graph capture parameters, and Inductor optimization configurations.
tags:
    - vllm
    - compilation
    - torch-compile
...
"""
    ...
    @classmethod
    defvalidate_mode_before(cls, value: Any) -> Any:
"""
    ...
    @classmethod
    defvalidate_cudagraph_mode_before(cls, value: Any) -> Any:
"""Enable parsing of the `cudagraph_mode` enum type from string."""
    ...
    @classmethod
    defvalidate_pass_config_before(cls, value: Any) -> Any:
"""Enable parsing of the `pass_config` field from a dictionary."""
    ...
    @classmethod
    defvalidate_compile_cache_save_format(cls, value: str) -> str:
...
"""
        ...
        fromtorch._dynamo.backends.registryimport list_backends
    ...
    defpost_init_cudagraph_sizes(self) -> None:
"""To complete the initialization after cudagraph related
    ...
    defset_splitting_ops_for_attn_fusion(self):
    ...
    defsplitting_ops_contain_attention(self) -> bool:
        return self.splitting_ops is not None and all(
            op in self.splitting_ops for op in self._attention_ops
        )

    defsplitting_ops_contain_kv_cache_update(self) -> bool:
    ...
    defis_attention_compiled_piecewise(self) -> bool:
...
"""
        ...
        for op in self.custom_ops:
            ...
            if op_name not in all_ops_in_model:
                fromvllm.model_executor.custom_opimport op_registry
    ...
    defis_custom_op_enabled(self, op: str) -> bool:
    ...
    defresolve_cudagraph_mode_and_sizes(
        self,
        ...
        fromvllm.v1.attention.backendimport AttentionCGSupport
    ...
    defadjust_cudagraph_sizes_for_spec_decode(
    ...
    defget_compile_ranges(self) -> list[Range]:
