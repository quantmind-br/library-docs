...
source: llms
fetched_at: 2026-01-26T09:52:04.549351984-03:00
rendered_js: false
word_count: 234
summary: This document explains how to enable and use the OpenAI-compatible Chat Completions endpoint within Clawdbot's Gateway to interact with agents via HTTP.
tags:
