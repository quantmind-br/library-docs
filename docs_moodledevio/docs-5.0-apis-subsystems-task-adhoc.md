...
url: https://moodledev.io/docs/5.0/apis/subsystems/task/adhoc
source: sitemap
fetched_at: 2026-02-17T15:28:18.565584-03:00
rendered_js: false
word_count: 697
summary: This document explains how to create and manage adhoc tasks for background processing, covering implementation details such as custom data, scheduling, user permissions, and retry logic.
tags:
    - adhoc-tasks
