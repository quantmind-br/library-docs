---
title: GLM-5 examples - SGLang Documentation
url: https://docs.sglang.io/docs/hardware-platforms/ascend-npus/ascend_npu_glm5_examples
source: sitemap
fetched_at: 2026-05-11T05:48:34.176884851-03:00
rendered_js: false
word_count: 371
summary: This document provides instructions for deploying the GLM-5 large language model on Ascend NPU hardware using the SGLang inference framework, covering environment setup, containerization, and single- or multi-node deployment configurations.
tags:
    - sglang
    - glm-5
    - ascend-npu
...
**A3 series** Modify the IP of 2 nodes, then run the same scripts on two nodes. **node 0/1**
...
Refer to [Benchmark and Profiling](https://docs.sglang.io/docs/developer_guide/benchmark_and_profiling) for details.