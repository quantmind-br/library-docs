...
source: crawler
fetched_at: 2026-02-23T05:28:26.762548-03:00
rendered_js: false
word_count: 223
summary: Instructions for installing and using YASB (Yet Another Shell Browser) on Windows via manual methods, package managers (winget, scoop, chocolatey), Python, or building from source, including configuration details and requirements like Nerd Fonts.
tags:
