---
title: Accessibility checklist | Moodle Developer Resources
url: https://moodledev.io/general/development/process/peer-review/accessibility-checklist
source: sitemap
fetched_at: 2026-02-17T16:00:14.367665-03:00
rendered_js: false
word_count: 1653
summary: This document provides a comprehensive checklist and set of guidelines for conducting accessibility reviews on code changes, covering automated testing, HTML/CSS standards, and usability requirements for assistive technologies.
tags:
    - accessibility
    - web-accessibility
    - code-review
...
## Do an automated check[​](#do-an-automated-check "Direct link to Do an automated check")
...
## General Checks[​](#general-checks "Direct link to General Checks")

Those are some quick checks you can do to ensure that the changes are accessible.

### Use of tabindex[​](#use-of-tabindex "Direct link to Use of tabindex")
...
### Zoom test[​](#zoom-test "Direct link to Zoom test")
...
### Icons and images[​](#icons-and-images "Direct link to Icons and images")
...
An example of a button with a descriptive sr-only text

```
<buttontype="button"class="btn btn-primary">
<imgsrc="./pix/add_user.png"alt="">
<spanclass="sr-only">Add a new user</span>
</button>
```

Another example using fontawesome icons

```
<buttontype="button"class="btn btn-primary">
<iclass="icon fa-user-plus fa-fw "aria-hidden="true"></i>
<spanclass="sr-only">Add a new user</span>
</button>
```

### Visible focus[​](#visible-focus "Direct link to Visible focus")
...
### Page headers and title[​](#page-headers-and-title "Direct link to Page headers and title")
...
You can read more information about page titles in this [Accessibility policies page section](https://moodledev.io/general/development/policies/accessibility#page-titles).

## Usability accessibility Checks[​](#usability-accessibility-checks "Direct link to Usability accessibility Checks")

Some more checks related to the changes:

### Do the UI uses colors or icons to indicate states or relevant information?[​](#do-the-ui-uses-colors-or-icons-to-indicate-states-or-relevant-information "Direct link to Do the UI uses colors or icons to indicate states or relevant information?")
...
### Do all links in the page have a correct descriptive text?[​](#do-all-links-in-the-page-have-a-correct-descriptive-text "Direct link to Do all links in the page have a correct descriptive text?")
...
### Is CSS ordering elements different than DOM?[​](#is-css-ordering-elements-different-than-dom "Direct link to Is CSS ordering elements different than DOM?")
...
### When the new elements are focused, do the down and tab keys still work in the default way?[​](#when-the-new-elements-are-focused-do-the-down-and-tab-keys-still-work-in-the-default-way "Direct link to When the new elements are focused, do the down and tab keys still work in the default way?")
...
### Does Any of the elements have a CSS animation?[​](#does-any-of-the-elements-have-a-css-animation "Direct link to Does Any of the elements have a CSS animation?")
...
### Does the patch adds tabindex="0" to any element?[​](#does-the-patch-adds-tabindex0-to-any-element 'Direct link to Does the patch adds tabindex="0" to any element?')
...
### Does the page use visuals like empty space, indentations or colors to represent structure or precedence?[​](#does-the-page-use-visuals-like-empty-space-indentations-or-colors-to-represent-structure-or-precedence "Direct link to Does the page use visuals like empty space, indentations or colors to represent structure or precedence?")

If yes, then this structure should also be represented in the HTML (nested lists, or by adding [`role="list"`](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/List_role)) or using explanatory textual elements.

### Does the page have elements that only appear on hover or focus?[​](#does-the-page-have-elements-that-only-appear-on-hover-or-focus "Direct link to Does the page have elements that only appear on hover or focus?")
...
## Review Custom Components[​](#review-custom-components "Direct link to Review Custom Components")
...
### Review Dynamic Content[​](#review-dynamic-content "Direct link to Review Dynamic Content")
...
## Forms checks[​](#forms-checks "Direct link to Forms checks")

Unless custom forms fields are used, all moodleforms are considered accessible.

When a patch introduce adhoc forms, it is important they follow the [forms guidelines](https://moodledev.io/general/development/policies/designing-usable-forms).

### Checks for custom forms (not using moodleforms)[​](#checks-for-custom-forms-not-using-moodleforms "Direct link to Checks for custom forms (not using moodleforms)")
...
## More advanced checks[​](#more-advanced-checks "Direct link to More advanced checks")
