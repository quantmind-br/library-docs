...
source: llms
fetched_at: 2026-01-24T14:41:46.188995904-03:00
rendered_js: false
word_count: 144
summary: This document provides a reference for the docker trust signer remove command, which allows users to remove authorized signers from one or more Docker image repositories.
tags:
    - docker-cli
    - docker-trust
    - content-trust
...
DescriptionRemove a signerUsage`docker trust signer remove [OPTIONS] NAME REPOSITORY [REPOSITORY...]`
...
OptionDefaultDescription`-f, --force`Do not prompt for confirmation before removing the most recent signer
