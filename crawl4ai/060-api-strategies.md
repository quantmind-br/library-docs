---
title: Strategies - Crawl4AI Documentation (v0.8.x)
url: https://docs.crawl4ai.com/api/strategies/
source: sitemap
fetched_at: 2026-04-26T07:45:54.587558978-03:00
rendered_js: false
word_count: 176
summary: This document serves as an API reference for Crawl4AI, detailing the configuration and implementation of various data extraction and text chunking strategies.
tags:
    - crawl4ai
    - data-extraction
    - web-scraping
...
importjson
fromcrawl4aiimport AsyncWebCrawler, CrawlerRunConfig, RegexExtractionStrategy
...
```
fromcrawl4ai.chunking_strategyimport OverlappingWindowChunking
fromcrawl4aiimport LLMConfig
...
01. **Choose the Right Strategy**
02. Use `RegexExtractionStrategy` for common data types like emails, phones, URLs, dates
03. Use `JsonCssExtractionStrategy` for well-structured HTML with consistent patterns
04. Use `LLMExtractionStrategy` for complex, unstructured content requiring reasoning
05. Use `CosineStrategy` for content similarity and clustering
06. **Strategy Selection Guide**
...
07. **Optimize Chunking**
    ...
    ```
08. **Combine Strategies for Best Performance**
