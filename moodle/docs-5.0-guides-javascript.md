---
title: JavaScript | Moodle Developer Resources
url: https://moodledev.io/docs/5.0/guides/javascript
source: sitemap
fetched_at: 2026-02-17T15:28:34.192871-03:00
rendered_js: false
word_count: 2046
summary: This document introduces the fundamentals of JavaScript development in Moodle, covering ES2015 module structure, naming conventions, and event handling practices. It explains how to organize code within Moodle's architecture to ensure compatibility and maintainability across the platform.
tags:
    - moodle-development
    - javascript-modules
    - es2015
...
You may see the terms `ES6` and `ES2015` used interchangeably. ES2015 is the 6th generation of the Ecma Script specification. ES2015 represents a big change from previous versions of the Ecma Script specification.

## Useful References[​](#useful-references "Direct link to Useful References")
...
Like our PHP classes and Mustache templates, our JavaScript modules each belong to a particular component and must be named according to our standard [name and namespace conventions](https://moodledev.io/general/development/policies/naming#javascript).
...
When structuring a new module you may find it clearer to create a main entry-point module with related modules stored in a subdirectory.
...
Since `participants` isn't a formal API in Moodle you must create your submodules in the `local/participants` directory.
...
## Writing your first module[​](#writing-your-first-module "Direct link to Writing your first module")

The convention in Moodle is to have one JavaScript Module which is your initial entrypoint. This usually provides a function called `init` which you then [export](https://developer.mozilla.org/en-US/docs/web/javascript/reference/statements/export) from the module. This `init` function will be called by Moodle.
...
This guide isn't intended to teach you how to write JavaScript. If you are new to JavaScript, you may want to start with the [MDN JavaScript basics guide](https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web).
...
In this example a new variable called `init` is created and exported using the ES2015 [export](https://developer.mozilla.org/en-US/docs/web/javascript/reference/statements/export) keyword. The variable is assigned an arrow function expression which takes no arguments, and when executed will call the browser `console.log` function with the text `"Hello, world!"`.

### Listen to a DOM Event[​](#listen-to-a-dom-event "Direct link to Listen to a DOM Event")

Usually you will want to perform an action in response to a user interacting with the page.

You can use the [document.addEventListener()](https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener) method to do this.
...
```
importSelectorsfrom'./local/helloworld/selectors';

constregisterEventListeners=()=>{
document.addEventListener('click',e=>{
if(e.target.closest(Selectors.actions.showAlertButton)){
window.alert("Thank you for clicking on the button");
}
...
- The list of Selectors has been moved to a new Module which is included using the [import](https://developer.mozilla.org/en-US/docs/web/javascript/reference/statements/import) keyword. The new `selectors` module is a dependency of the `helloworld` module.
...
## Including JavaScript from your pages[​](#including-javascript-from-your-pages "Direct link to Including JavaScript from your pages")
...
### Including from a template[​](#including-from-a-template "Direct link to Including from a template")
...
### Including from PHP[​](#including-from-php "Direct link to Including from PHP")
...
## Passing data to your Module[​](#passing-data-to-your-module "Direct link to Passing data to your Module")
...
### Using data attributes[​](#using-data-attributes "Direct link to Using data attributes")
...
```
constgetModal=questionBody=>{
returnModalFactory.create({
...
## Working with Strings[​](#working-with-strings "Direct link to Working with Strings")
...
## AJAX Calls[​](#ajax-calls "Direct link to AJAX Calls")
...
```
importDropzonefrom'core/dropzone';
...
## Reactive state[​](#reactive-state "Direct link to Reactive state")
...
See the [Creating reactive UI](https://moodledev.io/docs/5.0/guides/javascript/reactive) for more information.

Moodle uses common and popular tools to ensure code quality, and to improve the end-user experience.

Most of the Moodle JavaScript tooling requires [NodeJS](https://moodledev.io/general/development/tools/nodejs).

### Grunt[​](#grunt "Direct link to Grunt")
...
#### Installing grunt[​](#installing-grunt "Direct link to Installing grunt")

- Global

#### Using grunt[​](#using-grunt "Direct link to Using grunt")
