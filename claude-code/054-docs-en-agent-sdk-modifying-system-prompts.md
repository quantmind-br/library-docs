...
source: llms
fetched_at: 2026-04-16T22:29:00.634025147-03:00
rendered_js: false
word_count: 1681
summary: This document explains different methods for customizing Claude's behavior using the Agent SDK, including project-level files, output styles, and custom system prompt appending.
tags:
    - claude-agent-sdk
    - system-prompts
    - configuration
