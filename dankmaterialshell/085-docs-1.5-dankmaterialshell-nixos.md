...
source: sitemap
fetched_at: 2026-02-22T18:44:21.207799-03:00
rendered_js: false
word_count: 547
summary: This document provides instructions for installing and configuring the DankMaterialShell environment on NixOS using both the native nixpkgs module and Nix flakes.
tags:
    - nixos
    - dankmaterialshell
    - nixpkgs
...
DankMaterialShell is currently only available in the **unstable** branch of nixpkgs. If you're on NixOS stable (currently 25.11), you'll need to use the [Flake Installation](https://danklinux.com/docs/1.5/dankmaterialshell/nixos-flake) method instead.
...
## Compositor Config Files[​](#compositor-config-files "Direct link to Compositor Config Files")

The NixOS module installs DMS but doesn't generate compositor-specific config files (keybinds, colors, layout, etc.). Use [`dms setup`](https://danklinux.com/docs/1.5/dankmaterialshell/cli-setup) to deploy the defaults for your compositor, or generate individual configs:
