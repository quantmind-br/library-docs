---
title: Moodle 3.2 | Moodle Developer Resources
url: https://moodledev.io/general/releases/3.2
source: sitemap
fetched_at: 2026-02-17T16:11:04.628306-03:00
rendered_js: false
word_count: 1495
summary: This document provides the technical release notes for Moodle 3.2, detailing server requirements, browser compatibility, and major feature updates across various activity modules.
tags:
    - moodle-3-2
    - release-notes
    - system-requirements
...
Here is [the full list of fixed issues in 3.2](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%223.2%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
### Mobile app[​](#mobile-app "Direct link to Mobile app")
...
- [MDL-29110](https://moodle.atlassian.net/browse/MDL-29110) - Specify welcome email sender in enrol\_self, or send emails from system noreply address
...
- [MDL-50286](https://moodle.atlassian.net/browse/MDL-50286) - Allow to filter report\_log by origin : Logs clogged up with events listed as origin cli
...
- [MDL-54606](https://moodle.atlassian.net/browse/MDL-54606) - Sessions: Add support for Redis as a session\_class\_handler
...
#### Plugins removal[​](#plugins-removal "Direct link to Plugins removal")
...
- [MDL-55928](https://moodle.atlassian.net/browse/MDL-55928) - New Web Service gradereport\_user\_get\_grade\_items
- [MDL-55100](https://moodle.atlassian.net/browse/MDL-55100) - New Web Service core\_course\_get\_courses\_by\_field
...
- [MDL-50937](https://moodle.atlassian.net/browse/MDL-50937) - JQuery updated to version 3.1 (see [jQuery](https://moodledev.io/docs/5.2/guides/javascript/jquery))
...
- [MDL-55727](https://moodle.atlassian.net/browse/MDL-55727) - AMD modal module introduced (see [AMD Modal documentation](https://moodledev.io/docs/5.2/guides/javascript/modal))
...
- [MDL-48114](https://moodle.atlassian.net/browse/MDL-48114) - Moodle can now be downloaded via composer (see [Composer](https://moodledev.io/general/development/tools/composer#use-composer-to-download-moodle-code))
- [MDL-55091](https://moodle.atlassian.net/browse/MDL-55091) - phpunit has been upgraded to 5.x
- [MDL-55072](https://moodle.atlassian.net/browse/MDL-55072) - Behat now supports different themes. (See [Running acceptance test](https://moodledev.io/general/development/tools/behat/running))
...
- [MDL-31243](https://moodle.atlassian.net/browse/MDL-31243) - New get\_with\_capability\_sql function for retrieving SQL for finding users with capability in the given context
...
- [MDL-56082](https://moodle.atlassian.net/browse/MDL-56082) - Expose external authentication methods (loginpage\_idp\_list) in login block (see [Authentication plugins](https://docs.moodle.org/dev/Authentication_plugins#loginpage_idp_list.28.29))

## Translations[​](#translations "Direct link to Translations")

- [Notes de mise à jour de Moodle 3.2](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_3.2)
