...
source: crawler
fetched_at: 2026-02-27T23:38:58.526346-03:00
rendered_js: true
word_count: 271
summary: This document provides the technical reference for the deprecated Spotify Web API endpoint used to add tracks or episodes to a playlist, including request parameters and response formats.
tags:
    - spotify-api
    - playlists
    - deprecated
