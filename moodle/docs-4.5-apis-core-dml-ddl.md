...
url: https://moodledev.io/docs/4.5/apis/core/dml/ddl
source: sitemap
fetched_at: 2026-02-17T15:11:11.862762-03:00
rendered_js: false
word_count: 453
summary: This document provides an overview of the Data Definition Language (DDL) functions in Moodle used to manage database structures like tables, fields, and indexes during installation and upgrade processes.
tags:
    - moodle
    - ddl-api
    - database-schema
...
- [DML functions](https://moodledev.io/docs/4.5/apis/core/dml): Where all the functions used to handle DB data ([DML](https://docs.moodle.org/wikipedia/Data_Manipulation_Language)) are defined.