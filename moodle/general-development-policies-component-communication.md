---
title: Component Communication | Moodle Developer Resources
url: https://moodledev.io/general/development/policies/component-communication
source: sitemap
fetched_at: 2026-02-17T15:59:07.573484-03:00
rendered_js: false
word_count: 2136
summary: This document explains the structural architecture of Moodle, defining its core libraries, subsystems, and plugin types while establishing the rules for inter-component communication and dependencies.
tags:
    - moodle-architecture
    - plugin-system
...
![Components in Moodle](https://moodledev.io/assets/images/componentsinmoodle-1b1a260c55a95a2636ffa703bfd9f450.png)
...
### Subsystems[​](#subsystems "Direct link to Subsystems")
...
core\_component::get\_core\_subsystems()
...
### Sub-plugins[​](#sub-plugins "Direct link to Sub-plugins")
...
![Component dependencies](https://moodledev.io/assets/images/componentdependencies-07e6506c3efe608b3b05a31467e4ab22.png)
...
## General rules for inter-component communications[​](#general-rules-for-inter-component-communications "Direct link to General rules for inter-component communications")

Because all plugins are optional, we can never rely on a plugin being installed in Moodle, unless there is a dependency relationship between the current component and the plugin. Core components and subsystems are always installed. This means there are some strict rules about which types of communication are allowed in Moodle.
...
![Allowed communication](https://moodledev.io/assets/images/allowedcommunication-a18a08cc8737b318a5f1d88374255639.png)

### Direct php function calls[​](#direct-php-function-calls "Direct link to Direct php function calls")
...
### External functions[​](#external-functions "Direct link to External functions")
...
### JavaScript Modules (AMD)[​](#javascript-modules-amd "Direct link to JavaScript Modules (AMD)")
...
### get\_string[​](#get_string "Direct link to get_string")
...
### Templates (Mustache)[​](#templates-mustache "Direct link to Templates (Mustache)")
...
### Event observers[​](#event-observers "Direct link to Event observers")
...
### Callback methods (component\_callback, get\_plugins\_with\_function…)[​](#callback-methods-component_callback-get_plugins_with_function "Direct link to Callback methods (component_callback, get_plugins_with_function…)")
...
A: Existing callbacks are listed [here](https://docs.moodle.org/dev/Callbacks), major core APIs are listed [here](https://moodledev.io/docs/5.2/apis).

**Q: Can I change the data provided to a component\_callback and maintain backwards compatibility.**
...
## Ideal plugin design[​](#ideal-plugin-design "Direct link to Ideal plugin design")

![Ideal plugin design](https://moodledev.io/assets/images/idealplugindesign-7f188504c3df902b91a2afdb01ae30d4.png)
...
### Low Level API[​](#low-level-api "Direct link to Low Level API")
...
### Component API[​](#component-api "Direct link to Component API")
...
### External API[​](#external-api "Direct link to External API")
...
### Webservice API[​](#webservice-api "Direct link to Webservice API")
...
## Editing images in this doc page[​](#editing-images-in-this-doc-page "Direct link to Editing images in this doc page")

This page was created from a google doc. To edit the images in this page - re-export them from the original document here: [https://docs.google.com/document/d/1Z-vRWztT05bsb9b5KbBpLRP26oa3KTx3thB52\_BW5VY/edit#heading=h.ardt51j6brj1](https://docs.google.com/document/d/1Z-vRWztT05bsb9b5KbBpLRP26oa3KTx3thB52_BW5VY/edit#heading=h.ardt51j6brj1)