...
source: llms
fetched_at: 2026-04-16T22:29:41.589849542-03:00
rendered_js: false
word_count: 646
summary: This document explains how to use and manage slash commands within the Claude Agent SDK, including built-in functionality like context compaction and the creation of custom commands via markdown files.
tags:
    - claude-sdk
    - slash-commands
    - typescript
