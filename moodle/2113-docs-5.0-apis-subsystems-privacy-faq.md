...
url: https://moodledev.io/docs/5.0/apis/subsystems/privacy/faq
source: sitemap
fetched_at: 2026-02-17T15:28:00.474958-03:00
rendered_js: false
word_count: 723
summary: This document provides guidance for Moodle developers on identifying and reporting user data within various types of plugins to ensure privacy compliance. It clarifies when plugins need to implement data providers and when data is considered managed by core subsystems.
tags:
    - moodle-development
    - privacy-api
    - gdpr-compliance
