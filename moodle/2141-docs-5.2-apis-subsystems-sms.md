...
url: https://moodledev.io/docs/5.2/apis/subsystems/sms
source: sitemap
fetched_at: 2026-02-17T15:46:29.889481-03:00
rendered_js: false
word_count: 645
summary: This document explains how to use the SMS API and its manager class to send, fetch, and track messages while managing SMS gateway plugins and sensitive data.
tags:
    - sms-api
    - moodle-development
    - message-handling
...
- [SMS gateway](https://moodledev.io/docs/5.2/apis/plugintypes/sms)
...
[SMS gateways](https://moodledev.io/docs/5.2/apis/plugintypes/sms) are plugins that provide a way to interface with external SMS providers. Once a gateway is configured, any component implementing the SMS API can get a list of gateways.
