...
url: https://moodledev.io/docs/5.2/guides/upgrade
source: sitemap
fetched_at: 2026-02-17T15:47:16.119479-03:00
rendered_js: false
word_count: 1453
summary: This document explains how the Moodle Upgrade API manages plugin installations and database migrations using versioning and specific configuration files.
tags:
    - moodle-development
    - upgrade-api
    - database-migration
...
The Upgrade API is a core API which allows your plugin to manage features of its own installation, and upgrade. Every plugin includes a [version](https://moodledev.io/docs/5.2/apis/commonfiles/version.php) which allows the Upgrade API to apply only the required changes.
...
See the documentation on [version.php](https://moodledev.io/docs/5.2/apis/commonfiles/version.php) for further information on the features of this file.
...
- All upgrade code may use the [basic database API](https://moodledev.io/docs/5.2/apis/core/dml).
...
In this scenario, we call upgrade function in [adhoc task](https://moodledev.io/docs/5.2/apis/subsystems/task/adhoc) and schedule its run as follows:
...
See the documentation on other [common files](https://moodledev.io/docs/5.2/apis/commonfiles) that may be of use to you, in particular the following may be useful:

- [install.php](https://moodledev.io/docs/5.2/apis/commonfiles#dbinstallphp)
- [uninstall.php](https://moodledev.io/docs/5.2/apis/commonfiles#dbuninstallphp)
- [access.php](https://moodledev.io/docs/5.2/apis/commonfiles#dbaccessphp)
- [events.php](https://moodledev.io/docs/5.2/apis/commonfiles#dbeventsphp)
- [messages.php](https://moodledev.io/docs/5.2/apis/commonfiles#dbmessagesphp)
- [services.php](https://moodledev.io/docs/5.2/apis/commonfiles#dbservicesphp)
- [subplugins.json](https://docs.moodle.org/dev/Subplugins#db.2Fsubplugins.json)
- [Language files](https://moodledev.io/docs/5.2/apis/commonfiles#langenplugintype_pluginnamephp)
...
The Upgrade API makes *very intensive use* of other APIs, including [DDL](https://moodledev.io/docs/5.2/apis/core/dml/ddl), [DML](https://moodledev.io/docs/5.2/apis/core/dml), and a range of tools in order to proceed with the required changes for the upgrade.
...
- [DDL functions](https://moodledev.io/docs/5.2/apis/core/dml/ddl)
