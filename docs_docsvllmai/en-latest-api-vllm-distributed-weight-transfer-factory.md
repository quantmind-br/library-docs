---
title: factory - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/distributed/weight_transfer/factory/
source: sitemap
fetched_at: 2026-05-07T21:19:06.081375829-03:00
rendered_js: false
word_count: 212
summary: The WeightTransferEngineFactory provides a registry pattern for managing and instantiating weight transfer engines, featuring support for lazy loading and runtime extensibility.
tags:
    - factory-pattern
    - lazy-loading
    - registry-pattern
...
## WeightTransferEngineFactory [¶](#vllm.distributed.weight_transfer.factory.WeightTransferEngineFactory "Permanent link")
...
### create\_engine `classmethod` [¶](#vllm.distributed.weight_transfer.factory.WeightTransferEngineFactory.create_engine "Permanent link")
...
### register\_engine `classmethod` [¶](#vllm.distributed.weight_transfer.factory.WeightTransferEngineFactory.register_engine "Permanent link")
