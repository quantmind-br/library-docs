...
source: sitemap
fetched_at: 2026-01-22T22:15:58.456667998-03:00
rendered_js: false
word_count: 307
summary: This document explains how to integrate and use the Universal Wayland Session Manager (UWSM) with Hyprland to manage sessions, environments, and application lifecycles via Systemd.
tags:
    - hyprland
    - uwsm
    - session-management
