...
url: https://moodledev.io/docs/5.1/apis/subsystems/form/advanced/repeat-elements
source: sitemap
fetched_at: 2026-02-17T15:36:46.370619-03:00
rendered_js: false
word_count: 265
summary: Explains how to implement and configure repeating groups of form elements using the repeat_elements method within the Form API to handle dynamic data quantities.
tags:
    - form-api
    - repeat-elements
    - mform
