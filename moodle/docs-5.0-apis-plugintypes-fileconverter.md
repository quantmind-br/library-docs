...
url: https://moodledev.io/docs/5.0/apis/plugintypes/fileconverter
source: sitemap
fetched_at: 2026-02-17T15:25:31.023795-03:00
rendered_js: false
word_count: 363
summary: This document provides technical instructions for developing Moodle file converter plugins, covering the required file structure and implementation of the converter interface. It explains how to handle file format conversions and status tracking within the File Conversion subsystem.
tags:
    - moodle-development
    - file-conversion
    - plugin-development
...
File converters are an important tool to support other plugins with file conversion supported between a wide range of file formats. File converters are accessed using the [File conversion API](https://moodledev.io/docs/5.0/apis/subsystems/files/converter) and are typically consumed by other plugins rather than by the user directly.
...
Some of the important files for the fileconverter plugintype are described below. See the [common plugin files](https://moodledev.io/docs/5.0/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
...
- Using the [File Converter API](https://moodledev.io/docs/5.0/apis/subsystems/files/converter)