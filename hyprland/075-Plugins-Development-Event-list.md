...
source: sitemap
fetched_at: 2026-01-22T22:15:04.056553381-03:00
rendered_js: false
word_count: 318
summary: This document provides a comprehensive list of available event hooks for monitoring system, window, and input changes, including their descriptions and argument types.
tags:
    - hyprland
    - event-hooks
    - plugin-development
