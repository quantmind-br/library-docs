---
title: goose Architecture | goose
url: https://block.github.io/goose/docs/goose-architecture
source: github_pages
fetched_at: 2026-01-22T22:13:26.976774255-03:00
rendered_js: true
word_count: 711
summary: This document explains the architectural components, interactive loop, and tool integration framework of the goose AI agent, including its use of the Model Context Protocol.
tags:
    - ai-agent
    - mcp-protocol
    - interactive-loop
...
goose operates using three main components, the **interface**, the **agent**, and the **connected [extensions](https://block.github.io/goose/docs/getting-started/using-extensions)**.
...
goose comes with a set of [built-in extensions](https://block.github.io/goose/docs/getting-started/using-extensions#built-in-extensions), each designed to enhance your interaction. These include tools for development, web scraping, automation, memory, and more. goose also supports [connecting to external extensions](https://block.github.io/goose/docs/getting-started/using-extensions#adding-extensions) or [creating custom extensions](https://block.github.io/goose/docs/tutorials/custom-extensions) as MCP servers.

To learn more about the design and implementation of extensions and tools, refer to the [Extensions Design Guide](https://block.github.io/goose/docs/goose-architecture/extensions-design#tools).

## Interactive Loop[​](#interactive-loop "Direct link to Interactive Loop")

![interactive loop](https://block.github.io/goose/assets/images/interactive-loop-55558c45ba877033b3bd355c500150ef.png)
...
2. **Provider Chat**: goose sends your request along with a list of available tools to the [LLM provider](https://block.github.io/goose/docs/getting-started/providers) you've connected. The provider processes it, and if necessary, creates a tool call as part of its response.
...
For more details on how goose handles errors, refer to the [Error Handling in goose](https://block.github.io/goose/docs/goose-architecture/error-handling) Guide.
