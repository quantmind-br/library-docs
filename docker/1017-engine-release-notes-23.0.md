...
source: llms
fetched_at: 2026-01-24T14:25:05.386376809-03:00
rendered_js: false
word_count: 3774
summary: This document provides the release notes for Docker Engine version 23.0, detailing specific bug fixes, security patches, packaging updates, and the transition from CalVer to SemVer versioning.
tags:
    - docker-engine
    - release-notes
    - semver
...
- [docker/cli, 23.0.6 milestone](https://github.com/docker/cli/issues?q=is%3Aclosed%20milestone%3A23.0.6)
- [moby/moby, 23.0.6 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed%20milestone%3A23.0.6)
