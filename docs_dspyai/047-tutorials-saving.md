...
url: https://dspy.ai/tutorials/saving/
source: sitemap
fetched_at: 2026-01-23T08:04:25.597405455-03:00
rendered_js: false
word_count: 745
summary: This tutorial explains how to save and load DSPy programs by either persisting the state only or the entire program architecture. It provides guidance on using JSON and pickle formats, managing custom module dependencies, and ensuring version compatibility.
tags:
    - dspy-framework
    - serialization
    - model-saving
...
## Tutorial: Saving and Loading your DSPy program[¶](#tutorial-saving-and-loading-your-dspy-program "Permanent link")
...
## State-only Saving[¶](#state-only-saving "Permanent link")
...
## Whole Program Saving[¶](#whole-program-saving "Permanent link")
...
### Serializing Imported Modules[¶](#serializing-imported-modules "Permanent link")
...
## Backward Compatibility[¶](#backward-compatibility "Permanent link")
