...
url: https://moodledev.io/docs/5.0/apis/plugintypes/mod
source: sitemap
fetched_at: 2026-02-17T15:25:51.722158-03:00
rendered_js: false
word_count: 1
summary: This document defines the class structure and logic for creating and editing a Moodle activity module instance using the Moodle Form API.
tags:
    - moodle
    - php
    - form-api
