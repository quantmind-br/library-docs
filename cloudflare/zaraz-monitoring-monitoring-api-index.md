...
url: https://developers.cloudflare.com/zaraz/monitoring/monitoring-api/index.md
source: llms
fetched_at: 2026-01-24T15:34:54.867013456-03:00
rendered_js: false
word_count: 446
summary: This document explains how to use the Zaraz Monitoring API via the GraphQL Analytics API to programmatically retrieve and monitor data for events, triggers, and server-side actions.
tags:
    - zaraz
    - graphql-api
    - analytics
...
* Events
  ...
  [Run in GraphQL API Explorer](https://graphql.cloudflare.com/explorer?query=I4VwpgTgngBAWgQwggXgUQG5gHYBcDOAFAFAwwAkKA9tmACoIDmAXDPrhAJbaOkUA2nALadcrEN1wA2ACwBCPuXZIxMOsLCKcAE1bqhmsuSoRtkAEJRWcGmETIUdZAGMA1gEFtCAA65OWAHEIKhBvfAB5UwsoBQBKGABvPgxOMAB3SES+MmpaIgAzTn5cSFYEmFz6JlZKWwZGGABfeKSyNpgvXARWFCRUJwQ3Tx8-QODQomz2mEERVXJZ0Sn2wuLSxI6EEr8DAAkQiAB9RjBgGuUIXAAaTe2NfZAj-lOanSbltpMzCEtWAG1jFEflAALofFofMjOEJ4SEdDTYfCcGj4LLTaYEVidMA7MAPCBwxofIntEnvRpAA\&variables=N4IgXg9gdgpgKgQwOYgFwgFoHkByBRAfQEkAREAGhABsBLAWxoBc0BGABjcoGdGEAnZugBMbIQDYAtGxYShAFjjTULOajYBmDBRAwoAEzQgR4qTPmKA7MtUatlCHz0w+AIQCehvQkYxG9GAASEACufAQAggDKAMIgAL5AA)
