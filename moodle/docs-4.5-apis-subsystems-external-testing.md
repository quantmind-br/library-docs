...
url: https://moodledev.io/docs/4.5/apis/subsystems/external/testing
source: sitemap
fetched_at: 2026-02-17T15:13:37.615284-03:00
rendered_js: false
word_count: 0
summary: This document provides unit tests for validating the capability checks and execution logic of a Moodle external service function.
tags:
    - moodle
    - unit-testing
    - php-unit
