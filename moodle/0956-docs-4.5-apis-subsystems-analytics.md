...
url: https://moodledev.io/docs/4.5/apis/subsystems/analytics
source: sitemap
fetched_at: 2026-02-17T15:13:09.764361-03:00
rendered_js: false
word_count: 5667
summary: This document explains the architecture and implementation of the Moodle Analytics API, focusing on how to define prediction models, indicators, and targets within the learning management system.
tags:
    - moodle-api
    - analytics-api
    - prediction-models
...
Documentation available in [Machine learning backends](https://moodledev.io/docs/4.5/apis/plugintypes/mlbackend).
...
[Machine learning backends](https://moodledev.io/docs/4.5/apis/plugintypes/mlbackend) is a new Moodle plugin type. They are stored in `lib/mlbackend`.
...
This section does not include Machine learning backend interfaces. See [Machine learning backends](https://moodledev.io/docs/4.5/apis/plugintypes/mlbackend#interfaces) for more information on these.
...
As specified in the [Target](https://moodledev.io/docs/4.5/apis/subsystems/analytics#target-core_analyticslocaltargetbase) section.
