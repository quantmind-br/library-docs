...
url: https://moodledev.io/docs/4.1/apis/plugintypes/antivirus
source: sitemap
fetched_at: 2026-02-17T14:55:03.300408-03:00
rendered_js: false
word_count: 670
summary: This document explains how to develop antivirus plugins for Moodle to enable automatic virus scanning for uploaded files, covering file structure and mandatory implementation files.
tags:
    - moodle-development
    - antivirus-plugin
    - file-scanning
...
Some of the important files for the antivirus plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
