...
source: llms
fetched_at: 2026-01-26T09:50:46.692354408-03:00
rendered_js: false
word_count: 2597
summary: Comprehensive reference for the clawdbot command-line interface, detailing available commands, global flags, output styling, and the command tree structure.
tags:
    - cli-reference
    - clawdbot
    - command-line
