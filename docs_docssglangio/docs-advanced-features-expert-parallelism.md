...
url: https://docs.sglang.io/docs/advanced_features/expert_parallelism
source: sitemap
fetched_at: 2026-05-11T05:49:37.800383945-03:00
rendered_js: false
word_count: 1446
summary: This document explains the Expert Parallelism (EP) framework in SGLang, detailing the available communication and computation backends for Mixture-of-Experts (MoE) models and how to extend the modular architecture.
tags:
    - sglang
    - mixture-of-experts
    - expert-parallelism
