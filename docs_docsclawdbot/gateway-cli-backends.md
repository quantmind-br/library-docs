...
source: llms
fetched_at: 2026-01-26T09:51:50.67683276-03:00
rendered_js: false
word_count: 680
summary: This guide explains how to configure and use local AI command-line interfaces as fallback runtimes in Clawdbot for reliable text-only processing. It details configuration settings for provider integration, session management, and input/output handling.
tags:
    - clawdbot
    - cli-backend
    - fallback-runtime
