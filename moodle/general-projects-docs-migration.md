---
title: DevDocs Migration | Moodle Developer Resources
url: https://moodledev.io/general/projects/docs/migration
source: sitemap
fetched_at: 2026-02-17T16:02:22.888447-03:00
rendered_js: false
word_count: 1161
summary: This document outlines the strategic transition of Moodle's developer documentation from a legacy MediaWiki platform to Docusaurus to improve versioning, searchability, and ease of editing. It details the selection criteria for the new system, planned features like automated checks, and the structured three-phase migration roadmap.
tags:
    - moodle
...
- the ease of editing when most *developers* are used to GitHub Formatted Markdown (GFM)
- slow interface
- lack of offline availability

## Candidate selection[​](#candidate-selection "Direct link to Candidate selection")
...
## Migration plan[​](#migration-plan "Direct link to Migration plan")
...
### Initial data migration[​](#initial-data-migration "Direct link to Initial data migration")

During the initial stage, the legacy wiki will remain open for changes by all contributors.

A number of key documents will be migrated to the new platform, including most documents linked from the front page of the legacy docs, that is *most* of:
...
### Maturity and growth[​](#maturity-and-growth "Direct link to Maturity and growth")
...
### Sunset[​](#sunset "Direct link to Sunset")
...
- all versions of Moodle which were covered by the legacy documentation and which are not covered by the new site have been moved *out* of *security* support
...
See the [contributing](https://moodledev.io/general/documentation/contributing) guide for more information.