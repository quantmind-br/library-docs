...
url: https://moodledev.io/docs/4.1/apis/core/dml/drivers
source: sitemap
fetched_at: 2026-02-17T14:54:48.916915-03:00
rendered_js: false
word_count: 151
summary: This document outlines the native database drivers supported by Moodle and provides instructions for configuring query logging to monitor performance and errors.
tags:
    - moodle
    - database-drivers
    - dml
...
- [DML functions](https://moodledev.io/docs/4.1/apis/core/dml): Where all the functions used to handle DB data ([DML](https://en.wikipedia.org/wiki/Data_Manipulation_Language)) are defined.
