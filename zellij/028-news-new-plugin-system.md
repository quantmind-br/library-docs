...
url: https://zellij.dev/news/new-plugin-system/
source: sitemap
fetched_at: 2026-01-24T15:52:43.300324885-03:00
rendered_js: false
word_count: 502
summary: This document introduces the overhauled Zellij WebAssembly plugin system and the zellij-tile Rust SDK for building terminal applets. It outlines core plugin capabilities like UI rendering and workspace management while providing resources for developers to begin building their own plugins.
tags:
    - zellij
    - webassembly
    - rust-sdk
...
![Zellij plugins diagram](https://zellij.dev/img/zellij-plugins-diagram.png)
...
![zellij-tile diagram](https://zellij.dev/img/zellij-tile-diagram.png)
...
![Monocle preview](https://zellij.dev/video/monocle-preview.gif)
...
![multitask plugin preview](https://zellij.dev/img/multitask-preview.png)
...
![dev.kdl development environment](https://zellij.dev/img/dev-kdl-preview.png)
...
Come show us on [Discord](https://discord.gg/CrUAFH3) or [Matrix](https://matrix.to/#/%23zellij_general:matrix.org).
