...
url: https://moodledev.io/docs/5.2/guides/restructure
source: sitemap
fetched_at: 2026-02-17T15:47:11.031866-03:00
rendered_js: false
word_count: 0
summary: This document provides an Apache configuration template for serving multiple Moodle installations from subdirectories under a single domain. It utilizes mod_rewrite to intelligently route traffic based on the presence of a public folder and a router script.
tags:
