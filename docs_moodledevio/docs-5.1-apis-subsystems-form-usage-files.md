...
url: https://moodledev.io/docs/5.1/apis/subsystems/form/usage/files
source: sitemap
fetched_at: 2026-02-17T15:36:50.908219-03:00
rendered_js: false
word_count: 1528
summary: This document explains how to use Moodle form elements like filepicker, filemanager, and editor to handle user file uploads and integrate them with the Moodle File API. It describes the lifecycle of file handling, including managing draft file areas and moving files to permanent storage.
tags:
    - moodle-development
    - file-api
    - form-elements
...
Files and their metadata are stored within the [File API](https://moodledev.io/docs/5.1/apis/subsystems/files). Each file within the API is associated with:
...
4. User chooses a file, the corresponding [Repository plugin](https://moodledev.io/docs/5.1/apis/plugintypes/repository) takes care of copying the file into a "draft file area" within Moodle
5. File appears in the text or as an attachment in the form.
6. When the user hits save, the [File API](https://moodledev.io/docs/5.1/apis/subsystems/files) is invoked to move the file from the draft file area into a permanent file area associated with that data

This document shows you how to use Moodle forms to interact with users in a standard and secure way.

If you just want to write code to manipulate Moodle files internally (without user input) you can use the [File API](https://moodledev.io/docs/5.1/apis/subsystems/files) without involving form elements.
...
- [Using the file API](https://moodledev.io/docs/5.1/apis/subsystems/files)
