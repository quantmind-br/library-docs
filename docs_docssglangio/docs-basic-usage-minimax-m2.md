---
title: MiniMax M2.5/M2.1/M2 Usage - SGLang Documentation
url: https://docs.sglang.io/docs/basic_usage/minimax_m2
source: sitemap
fetched_at: 2026-05-11T05:49:12.283914248-03:00
rendered_js: false
word_count: 202
summary: This document provides technical instructions for deploying the MiniMax-M2 series of language models using SGLang, including system requirements, server launch commands, and verification steps.
tags:
    - minimax-m2
    - sglang
    - llm-deployment
