---
title: v0.21.0
url: https://ratatui.rs/highlights/v021/
source: crawler
fetched_at: 2026-02-01T21:13:28.430583553-03:00
rendered_js: false
word_count: 684
summary: This document details the new features and breaking changes in Ratatui version 0.21.0, including the termwiz backend, new calendar and circle widgets, and the renaming of Spans to Line.
tags:
    - ratatui
    - rust
    - terminal-ui
...
[https://github.com/ratatui/ratatui/releases/tag/v0.21.0](https://github.com/ratatui/ratatui/releases/tag/v0.21.0)

## New backend: `termwiz`

[Section titled “New backend: termwiz”](#new-backend-termwiz)
...
letnow= Instant::now();
whilenow.elapsed() < Duration::from_secs(5) {
...
In the repository, there is an example that simulates downloading multiple files in parallel: [https://github.com/ratatui/ratatui/blob/main/examples/inline.rs](https://github.com/ratatui/ratatui/blob/main/examples/inline.rs)

* * *

## Block: title on bottom

[Section titled “Block: title on bottom”](#block-title-on-bottom)
...
[Section titled “Block: support adding padding”](#block-support-adding-padding)
...
letparagraph= Paragraph::new("example paragraph").block(block);
...
letblock= Block::default().borders(Borders::ALL).padding(Padding {
left:todo!(),
right:todo!(),
top:todo!(),
bottom:todo!(),
});
letinner_block= Block::default().borders(Borders::ALL);
letinner_area=block.inner(area);
...
[Section titled “Text: display secure data”](#text-display-secure-data)
...
[Section titled “Color: support conversion from String”](#color-support-conversion-from-string)
...
See [https://github.com/ratatui/ratatui/pull/178](https://github.com/ratatui/ratatui/pull/178) for more discussion.
...
Also, we moved `APPS.md` file to the [Wiki](https://github.com/ratatui/ratatui/wiki/Apps-using-Ratatui) so check it out for more applications built with `ratatui`!

* * *

## Migration from `tui-rs`

[Section titled “Migration from tui-rs”](#migration-from-tui-rs)

We put together a migration guide at the Wiki: [Migrating from TUI](https://ratatui.rs/recipes/apps/migrate-from-tui-rs/)

Also, the minimum supported Rust version is `1.65.0`

* * *

Any contribution is highly appreciated! There are [contribution guidelines](https://github.com/ratatui/ratatui/blob/main/CONTRIBUTING.md) for getting started.

Feel free to [submit issues](https://github.com/ratatui/ratatui/issues/new/choose) and throw in ideas!
