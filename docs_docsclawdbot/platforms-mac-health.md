...
source: llms
fetched_at: 2026-01-26T09:52:57.210239692-03:00
rendered_js: false
word_count: 213
summary: This document describes how to monitor channel health status using the Clawdbot macOS menu bar application, including UI indicators, settings configurations, and internal probe mechanisms.
tags:
    - macos-app
    - health-checks
