...
url: https://moodledev.io/docs/5.1/tags/advanced
source: sitemap
fetched_at: 2026-02-17T15:29:03.607108-03:00
rendered_js: false
word_count: 191
summary: This document explains advanced Moodle Form API features including hidden elements, bulk checkbox controls, sub-action buttons, and dynamic element repetition.
tags:
    - moodle-forms
    - form-api
    - ui-elements
