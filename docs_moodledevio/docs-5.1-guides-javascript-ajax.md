...
url: https://moodledev.io/docs/5.1/guides/javascript/ajax
source: sitemap
fetched_at: 2026-02-17T15:37:41.570072-03:00
rendered_js: false
word_count: 592
summary: This document explains how to implement AJAX interactions in Moodle using the core/ajax JavaScript module to call web service functions. It covers setting up web services, organizing code into repository modules, and handling chained requests or session-less calls.
tags:
    - moodle
    - ajax
    - javascript
