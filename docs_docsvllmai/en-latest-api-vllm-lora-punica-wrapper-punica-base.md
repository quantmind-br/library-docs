---
title: punica_base - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/lora/punica_wrapper/punica_base/
source: sitemap
fetched_at: 2026-05-07T21:23:02.832829062-03:00
rendered_js: false
word_count: 0
summary: The PunicaWrapperBase class provides a framework for managing metadata and interfacing with Multi-LoRA kernels, facilitating the coordination of tensor indices and batch computations.
tags:
    - multi-lora
    - pytorch
    - kernel-management
...
```
classPunicaWrapperBase(PunicaWrapperABC):
"""
    ...
    def_update_prefill_metadata(self, token_lora_tensor: torch.Tensor) -> None:
        (
            b_seq_start_tensor,
            seq_length_tensor,
            lora_indices_tensor,
...
"""
    ...
    @property
    deftoken_lora_indices(self) -> torch.Tensor:
"""
    ...
    @property
    defsampler_indices(self) -> torch.Tensor:
"""
...
"""
    ...
    @property
    defembeddings_indices(self) -> torch.Tensor:
"""
