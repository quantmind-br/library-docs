---
title: API Reference eSDK 3.204.112 | Spotify for Developers
url: https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.204
source: crawler
fetched_at: 2026-02-27T23:41:31.219621-03:00
rendered_js: true
word_count: 15717
summary: This document serves as a technical reference for the Spotify Embedded SDK C API, detailing macros, data structures, and functions used for managing audio playback, user authentication, and device connectivity.
tags:
...
- If the device is currently the active device setting can\_play to 0 will cause the notification kSpPlaybackNotifyBecameInactive to be sent. Playback-related APIs (SpPlaybackPlay(), ...) will return an error code. This setting will persist across logout/login.
