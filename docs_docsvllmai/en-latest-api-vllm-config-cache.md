...
source: sitemap
fetched_at: 2026-05-07T21:16:52.940844816-03:00
rendered_js: false
word_count: 273
summary: This document defines the configuration parameters for the vLLM Key-Value (KV) cache, including block sizing, memory utilization, data types, and prefix caching settings.
tags:
    - kv-cache
    - vllm
    - memory-management
...
"""Guard against pydantic re-running _apply_block_size_default."""
    ...
    def_apply_block_size_default(self) -> "CacheConfig":
    ...
    @classmethod
    def_warn_deprecated_calculate_kv_scales(cls, calculate_kv_scales: bool) -> bool:
    ...
    @classmethod
    def_validate_cache_dtype(cls, cache_dtype: CacheDType) -> CacheDType:
