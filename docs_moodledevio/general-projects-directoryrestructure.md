---
title: Directory Restructure | Moodle Developer Resources
url: https://moodledev.io/general/projects/directoryrestructure
source: sitemap
fetched_at: 2026-02-17T16:02:21.674301-03:00
rendered_js: false
word_count: 3214
summary: This document outlines a proposal to restructure the Moodle codebase by moving public files into a dedicated sub-directory to improve security and enable modern development workflows.
tags:
    - moodle-core
    - security-hardening
...
## Project statement[​](#project-statement "Direct link to Project statement")
...
## Target versions[​](#target-versions "Direct link to Target versions")
...
A restructure of the code itself has few *immediate* benefits itself, but it allows for greater change and flexibility in the future as a direct result.

### Immediate benefits[​](#immediate-benefits "Direct link to Immediate benefits")
...
### Future benefits[​](#future-benefits "Direct link to Future benefits")
...
### Initial change[​](#initial-change "Direct link to Initial change")
...
Move all content into the new 'public' directory
...
### Immediate follow-up[​](#immediate-follow-up "Direct link to Immediate follow-up")
...
## Risks and Weaknesses[​](#risks-and-weaknesses "Direct link to Risks and Weaknesses")
...
### The introduction of new bugs[​](#the-introduction-of-new-bugs "Direct link to The introduction of new bugs")
...
### Introducing incompatible plugins[​](#introducing-incompatible-plugins "Direct link to Introducing incompatible plugins")
...
### Reconfiguration of Production Systems[​](#reconfiguration-of-production-systems "Direct link to Reconfiguration of Production Systems")
...
### Increased difficulty during backport[​](#increased-difficulty-during-backport "Direct link to Increased difficulty during backport")
...
The following sections suggest *possible* future benefits. These are not currently part of the roadmap, but are ideas of some of the changes which may be realised by making this change.

### Additional deployment steps[​](#additional-deployment-steps "Direct link to Additional deployment steps")
...
#### Build step: Composer[​](#build-step-composer "Direct link to Build step: Composer")
...
Current approach to PHP dependencies
...
#### Build step: NodeJS[​](#build-step-nodejs "Direct link to Build step: NodeJS")
...
Current approach to building JavaScript in Moodle
...
JavaScript goes through a build process using the *Grunt* tooling. Code is minified and transpiled to add and use appropriate polyfills.
...
### Plugin installation via Composer[​](#plugin-installation-via-composer "Direct link to Plugin installation via Composer")
...
### Tooling systems[​](#tooling-systems "Direct link to Tooling systems")
...
### How does this impact me as a plugin developer?[​](#how-does-this-impact-me-as-a-plugin-developer "Direct link to How does this impact me as a plugin developer?")
...
### What about Backporting changes across the point of change[​](#what-about-backporting-changes-across-the-point-of-change "Direct link to What about Backporting changes across the point of change")
...
### What does this mean for our Moodle Downloads?[​](#what-does-this-mean-for-our-moodle-downloads "Direct link to What does this mean for our Moodle Downloads?")
...
### How does this change impact Git history?[​](#how-does-this-change-impact-git-history "Direct link to How does this change impact Git history?")
...
## Future possibilities[​](#future-possibilities "Direct link to Future possibilities")
...
### Adoption of a Frontend Framework[​](#frontend-framework "Direct link to Adoption of a Frontend Framework")
...
### A simplified plugintype system[​](#a-simplified-plugintype-system "Direct link to A simplified plugintype system")
...
Each of these classes would extend the relevant *feature* class, containing full documentation on how to implement that feature. They would also be able to share common JS and CSS between all features without breaching any part of the [component communication principles](https://moodledev.io/general/development/policies/component-communication).
...
### Moodle Framework[​](#moodle-framework "Direct link to Moodle Framework")
