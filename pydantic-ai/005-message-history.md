...
source: sitemap
fetched_at: 2026-01-22T22:23:34.924488263-03:00
rendered_js: false
word_count: 965
summary: This document explains how to access and retrieve message history from Pydantic AI agent runs using RunResult and StreamedRunResult objects. It describes methods for extracting complete conversation logs or run-specific messages in both object and JSON formats.
tags:
    - pydantic-ai
    - message-history
    - agent-run
...
Both [`RunResult`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult "AgentRunResult            dataclass   ") (returned by [`Agent.run`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run "run            async   "), [`Agent.run_sync`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run_sync "run_sync")) and [`StreamedRunResult`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult "StreamedRunResult            dataclass   ") (returned by [`Agent.run_stream`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run_stream "run_stream            async   ")) have the following methods:
...
Example of accessing methods on a [`RunResult`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult "AgentRunResult            dataclass   ") :

With Pydantic AI GatewayDirectly to Provider API

[Learn about Gateway](https://ai.pydantic.dev/gateway) run\_result\_messages.py
...
Example of accessing methods on a [`StreamedRunResult`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult "StreamedRunResult            dataclass   ") :

With Pydantic AI GatewayDirectly to Provider API

[Learn about Gateway](https://ai.pydantic.dev/gateway) streamed\_run\_result\_messages.py
...
To use existing messages in a run, pass them to the `message_history` parameter of [`Agent.run`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run "run            async   "), [`Agent.run_sync`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run_sync "run_sync") or [`Agent.run_stream`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run_stream "run_stream            async   ").
...
We export [`ModelMessagesTypeAdapter`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ModelMessagesTypeAdapter "ModelMessagesTypeAdapter            module-attribute   ") that can be used for this, or you can create your own.
...
The `history_processors` is a list of callables that take a list of [`ModelMessage`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ModelMessage "ModelMessage            module-attribute   ") and return a modified list of the same type.

Each processor is applied in sequence, and processors can be either synchronous or asynchronous.

With Pydantic AI GatewayDirectly to Provider API

[Learn about Gateway](https://ai.pydantic.dev/gateway) simple\_history\_processor.py
...
[Learn about Gateway](https://ai.pydantic.dev/gateway) keep\_recent\_messages.py
...
History processors can optionally accept a [`RunContext`](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.RunContext "RunContext            dataclass   ") parameter to access additional information about the current run, such as dependencies, model information, and usage statistics:

With Pydantic AI GatewayDirectly to Provider API

[Learn about Gateway](https://ai.pydantic.dev/gateway) context\_aware\_processor.py
...
[Learn about Gateway](https://ai.pydantic.dev/gateway) summarize\_old\_messages.py
...
You can test what messages are actually sent to the model provider using [`FunctionModel`](https://ai.pydantic.dev/api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel            dataclass   "):
...
[Learn about Gateway](https://ai.pydantic.dev/gateway) multiple\_history\_processors.py
