---
title: "null"
url: https://docs.clawd.bot/gateway/health.md
source: llms
fetched_at: 2026-01-26T09:51:58.850936396-03:00
rendered_js: false
word_count: 303
summary: This document provides instructions on using CLI commands to perform health checks, diagnose connectivity issues, and monitor the status of ClawdBot gateway and channels.
tags:
    - clawdbot-cli
    - health-checks
    - troubleshooting
