---
title: dp_utils - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/worker/gpu/dp_utils/
source: sitemap
fetched_at: 2026-05-07T21:42:23.307002068-03:00
rendered_js: false
word_count: 21
summary: This document describes the utility function used to synchronize batch execution descriptors and data parallelism padding across all ranks in a GPU worker environment.
tags:
...
## vllm.v1.worker.gpu.dp\_utils [¶](#vllm.v1.worker.gpu.dp_utils "Permanent link")

## sync\_cudagraph\_and\_dp\_padding [¶](#vllm.v1.worker.gpu.dp_utils.sync_cudagraph_and_dp_padding "Permanent link")

Coordinates the batch descriptor and DP padding across all ranks.

Returns (synced\_batch\_desc, num\_tokens\_across\_dp).

Source code in `vllm/v1/worker/gpu/dp_utils.py`

```
defsync_cudagraph_and_dp_padding(
