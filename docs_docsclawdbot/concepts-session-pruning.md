...
source: llms
fetched_at: 2026-01-26T09:51:33.524615353-03:00
rendered_js: false
word_count: 527
summary: This document explains the session pruning mechanism for trimming old tool results from the LLM context to optimize prompt caching and reduce costs.
tags:
    - anthropic
    - prompt-caching
    - session-management
