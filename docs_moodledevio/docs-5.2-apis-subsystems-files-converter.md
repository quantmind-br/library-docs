...
url: https://moodledev.io/docs/5.2/apis/subsystems/files/converter
source: sitemap
fetched_at: 2026-02-17T15:45:46.039239-03:00
rendered_js: false
word_count: 392
summary: This document explains how to use the Moodle file converter API to transform documents into alternative formats asynchronously. It details the methods for initiating conversions, monitoring their progress through various statuses, and retrieving the resulting files.
tags:
    - moodle-api
    - file-conversion
...
- Creating a new [file converter plugin](https://moodledev.io/docs/5.2/apis/plugintypes/fileconverter)