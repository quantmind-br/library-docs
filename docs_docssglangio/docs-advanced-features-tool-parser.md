---
title: Tool Parser - SGLang Documentation
url: https://docs.sglang.io/docs/advanced_features/tool_parser
source: sitemap
fetched_at: 2026-05-11T05:49:21.236819065-03:00
rendered_js: false
word_count: 706
summary: This guide provides instructions on implementing function calling in SGLang, including supported model parsers, server configuration, and handling streaming or non-streaming tool execution.
tags:
    - sglang
    - function-calling
    - llm
...
For more information, refer to Meta’s documentation on [Zero shot function calling](https://github.com/meta-llama/llama-models/blob/main/models/llama4/prompt_format.md#zero-shot-function-calling---system-message). Note that this feature is still under development on Blackwell.
