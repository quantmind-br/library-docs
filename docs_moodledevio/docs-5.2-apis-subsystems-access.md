...
url: https://moodledev.io/docs/5.2/apis/subsystems/access
source: sitemap
fetched_at: 2026-02-17T15:45:06.131021-03:00
rendered_js: false
word_count: 1125
summary: This document explains the Moodle Access API, covering its role-based access control model, context hierarchy, and the process for defining or checking user capabilities in plugins.
tags:
    - moodle
    - access-api
    - rbac
...
See [Enrolment API](https://moodledev.io/docs/5.2/apis/subsystems/enrol).
...
- if an activity is specified, verify any [availability restrictions](https://moodledev.io/docs/5.2/apis/subsystems/availability) for the activity
...
- [Roles](https://moodledev.io/docs/5.2/apis/subsystems/roles)
- [Role archetypes](https://docs.moodle.org/dev/Role_archetypes)
- [Hardening new Roles system](https://moodledev.io/docs/5.2/apis/subsystems/roles)
