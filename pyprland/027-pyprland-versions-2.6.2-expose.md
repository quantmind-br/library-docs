...
url: https://hyprland-community.github.io/pyprland/versions/2.6.2/expose
source: github_pages
fetched_at: 2026-01-31T15:58:09.812952813-03:00
rendered_js: false
word_count: 104
...
For a similar feature using a menu, try the [fetch\_client\_menu](https://hyprland-community.github.io/pyprland/versions/2.6.2/fetch_client_menu.html) plugin (less intrusive).
...
If you are looking for `toggle_minimized`, check the [toggle\_special](https://hyprland-community.github.io/pyprland/versions/2.6.2/toggle_special.html) plugin
