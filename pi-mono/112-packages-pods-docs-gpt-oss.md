---
title: Gpt oss
url: https://github.com/badlogic/pi-mono/blob/main/packages/pods/docs/gpt-oss.md
source: git
fetched_at: 2026-03-03T03:45:44.166039-03:00
rendered_js: false
word_count: 1412
summary: Guide on using vLLM with `gpt-oss` models (`gpt-oss-20b`, `gpt-oss-120b`) across NVIDIA and AMD GPUs, covering installation, GPU-specific optimizations, and deployment configurations for high-performance serving.
tags:
    - vllm-configuration
    - gpt-oss
    - nvidia-blackwell
