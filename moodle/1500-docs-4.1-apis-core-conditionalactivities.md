...
url: https://moodledev.io/docs/4.1/apis/core/conditionalactivities
source: sitemap
fetched_at: 2026-02-17T14:54:40.842939-03:00
rendered_js: false
word_count: 469
summary: This document provides a technical overview of the Conditional Activities API, detailing how to manage activity availability through the condition_info class and its methods. it explains how to fetch, update, and delete conditions related to course module visibility based on completion, grades, and dates.
tags:
    - moodle-development
...
- [How to make a new availability condition plugin](https://moodledev.io/docs/4.1/apis/plugintypes/availability).
