...
url: https://docs.vllm.ai/en/latest/api/vllm/v1/worker/gpu_worker/
source: sitemap
fetched_at: 2026-05-07T21:43:10.580508691-03:00
rendered_js: false
word_count: 57
summary: This class defines the vLLM worker responsible for device initialization, distributed environment setup, and memory management, including specialized sleep and wake-up cycles for resource optimization.
tags:
    - vllm
    - worker-node
    - memory-management
...
classWorker(WorkerBase):
    def__init__(
        ...
        fromvllm.distributed.elastic_ep.elastic_executeimport ElasticEPScalingExecutor
    ...
    defsleep(self, level: int = 1) -> None:
        fromvllm.device_allocator.cumemimport CuMemAllocator
    ...
    def_maybe_get_memory_pool_context(self, tag: str) -> AbstractContextManager:
    ...
    @contextmanager
    def_scoped_allocator_max_split(self, max_split_size_mb: int):
"""Temporarily set max_split_size_mb to reduce allocator fragmentation at the
    ...
    definit_device(self):
        ...
        if self.use_v2_model_runner:
            fromvllm.v1.worker.gpu.model_runnerimport (
            ...
            fromvllm.v1.worker.gpu_model_runnerimport (
    ...
    defupdate_config(self, overrides: dict[str, Any]) -> None:
        self.model_runner.update_config(overrides)

    defreload_weights(self, *args, **kwargs) -> None:
        self.model_runner.reload_weights(*args, **kwargs)

    @torch.inference_mode()
    defdetermine_available_memory(self) -> int:
"""Profiles the peak memory usage of the model to determine how much
    ...
    defget_kv_connector_handshake_metadata(self) -> dict | None:
"""Get KV connector metadata from this worker if available."""
    ...
    defupdate_max_model_len(self, max_model_len: int) -> None:
"""Update max_model_len after auto-fit to GPU memory.
    ...
    definitialize_from_config(self, kv_cache_config: KVCacheConfig) -> None:
"""Allocate GPU KV cache with the specified kv_cache_config."""
    ...
    defcompile_or_warm_up_model(self) -> CompilationTimes:
        ...
        fromvllm.triton_utils.jit_monitorimport (
    ...
    defget_compilation_match_table(self) -> dict[str, int]:
        fromvllm.compilation.passes.vllm_inductor_passimport get_match_table

        return get_match_table()

    defget_encoder_timing_stats(self) -> dict[str, dict[str, float | int]]:
"""Get encoder timing stats from model runner."""
        return self.model_runner.get_encoder_timing_stats()

    defannotate_profile(self, scheduler_output):
    ...
    defprofile(self, is_start: bool = True, profile_prefix: str | None = None):
        ...
        if is_start:
            ...
            fromvllm.distributed.utilsimport get_worker_rank_suffix
    ...
    defsave_tensorized_model(self, tensorizer_config: "TensorizerConfig") -> None:
    ...
    definit_weight_transfer_engine(self, init_info: dict) -> None:
"""
    ...
    defupdate_weights(self, update_info: dict) -> None:
"""
        ...
        if typed_update_info.is_checkpoint_format:
            fromvllm.model_executor.model_loader.reloadimport (
    ...
    defelastic_ep_execute(self, execute_method: str, *args, **kwargs):
