...
url: https://moodledev.io/docs/4.1/apis/plugintypes/availability
source: sitemap
fetched_at: 2026-02-17T14:55:12.39318-03:00
rendered_js: false
word_count: 747
summary: This document outlines the development process for Moodle availability condition plugins, explaining the directory structure and required PHP classes for implementing custom access restrictions.
tags:
    - moodle-development
    - availability-api
    - plugin-development
...
Availability conditions allow teachers to restrict an activity or section so that only certain users can access it. These are accessed using the [Availability API](https://moodledev.io/docs/4.1/apis/subsystems/availability).
...
- Using the [Availability API as a consumer](https://moodledev.io/docs/4.1/apis/subsystems/availability)
- [Conditional activities API](https://moodledev.io/docs/4.1/apis/core/conditionalactivities)