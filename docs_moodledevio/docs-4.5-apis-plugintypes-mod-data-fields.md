...
url: https://moodledev.io/docs/4.5/apis/plugintypes/mod_data/fields
source: sitemap
fetched_at: 2026-02-17T15:12:23.817203-03:00
rendered_js: false
word_count: 390
summary: Explains how to develop custom field type sub-plugins for the Moodle Database activity, covering directory structure, mandatory files, and class methods for field behavior.
tags:
    - moodle-development
    - database-activity
    - plugin-development
...
Some of the important files for the database field plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.5/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
