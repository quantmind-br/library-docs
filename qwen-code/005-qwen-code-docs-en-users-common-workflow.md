...
url: https://qwenlm.github.io/qwen-code-docs/en/users/common-workflow
source: github_pages
fetched_at: 2026-04-09T09:03:48.475593713-03:00
rendered_js: true
word_count: 1503
summary: This document serves as a comprehensive guide detailing various workflows for using Qwen Code, covering tasks such as understanding new codebases, efficiently fixing bugs, refactoring outdated code, and creating pull requests.
tags:
    - qwen-code
    - workflow-guide
    - code-analysis
...
- Know more about [Sub Agents](https://qwenlm.github.io/qwen-code-docs/en/users/features/sub-agents/)
- Know more about [Approval Mode](https://qwenlm.github.io/qwen-code-docs/en/users/features/approval-mode/)
...
This fetches data from connected MCP servers using the format @server: resource. See [MCP](https://qwenlm.github.io/qwen-code-docs/en/users/features/mcp/) for details.
...
## Run parallel Qwen Code sessions with Git worktrees[](#run-parallel-qwen-code-sessions-with-git-worktrees)
...
## Use Qwen Code as a unix-style utility[](#use-qwen-code-as-a-unix-style-utility)

### Add Qwen Code to your verification process[](#add-qwen-code-to-your-verification-process)
...
## Ask Qwen Code about its capabilities[](#ask-qwen-code-about-its-capabilities)
