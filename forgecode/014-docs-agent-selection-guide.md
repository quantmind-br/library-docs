---
title: ForgeCode
url: https://forgecode.dev/docs/agent-selection-guide/
source: sitemap
fetched_at: 2026-03-29T16:30:32.4504-03:00
rendered_js: false
word_count: 441
summary: This document provides instructions on how to select and utilize specialized AI agents within the ForgeCode environment to optimize development workflows.
tags:
    - forgecode
    - ai-agents
    - developer-tools
...
1. **Open the agent selector** by typing `:agent` in your ForgeCode session
...
The interface displays all configured agents, including both default ForgeCode agents and any custom agents you've added.
...
### Built-in ForgeCode Agents[​](#built-in-forgecode-agents "Direct link to Built-in ForgeCode Agents")

ForgeCode comes with specialized agents designed for different stages of development. Each has distinct capabilities and access levels:
...
- Active by default when you start ForgeCode
...
Learn more: [Operating Agents Guide](https://forgecode.dev/docs/operating-agents/)
...
- **ForgeCode** - For implementing solutions and making code changes
...
- [Operating Agents Guide: Understanding Built-in Agents](https://forgecode.dev/docs/operating-agents/)
