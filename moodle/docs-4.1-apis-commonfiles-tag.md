...
url: https://moodledev.io/docs/4.1/apis/commonfiles/tag.php
source: sitemap
fetched_at: 2026-02-17T14:54:30.356448-03:00
rendered_js: false
word_count: 0
summary: This document defines the configuration schema and attributes for registering tag areas within the Moodle tagging system. It explains how to specify item types, components, and callbacks to integrate tagging functionality into core features or plugins.
tags:
    - moodle-development
    - tag-areas
