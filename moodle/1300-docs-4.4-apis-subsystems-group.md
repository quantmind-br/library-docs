---
title: Groups API | Moodle Developer Resources
url: https://moodledev.io/docs/4.4/apis/subsystems/group
source: sitemap
fetched_at: 2026-02-17T15:04:40.563872-03:00
rendered_js: false
word_count: 1041
summary: This document explains the Moodle Groups system, covering group modes, visibility settings, and the Groups API for developers. It describes how to manage collections of users within courses and activities and implement group support in activity modules.
tags:
    - moodle
    - groups-api
    - access-control
...
## Group modes[​](#group-modes "Direct link to Group modes")
...
## Group visibility[​](#group-visibility "Direct link to Group visibility")
...
### How to find and use the "current" group[​](#how-to-find-and-use-the-current-group 'Direct link to How to find and use the "current" group')
...
### How to make sure that the current user can see a given item in your activity[​](#how-to-make-sure-that-the-current-user-can-see-a-given-item-in-your-activity "Direct link to How to make sure that the current user can see a given item in your activity")
...
$url=newmoodle_url('/mod/forum/view.php',['id'=>$cm->id]);
...
### How to get just the groups that the current user can see[​](#how-to-get-just-the-groups-that-the-current-user-can-see "Direct link to How to get just the groups that the current user can see")
...
### Group GeoPattern images[​](#group-geopattern-images "Direct link to Group GeoPattern images")
