...
source: crawler
fetched_at: 2026-05-06T21:28:07.357328049-03:00
rendered_js: false
word_count: 2440
summary: This document introduces Rust's static typing system, focusing on scalar data types including integers and floating-point numbers, and explains how to handle numeric operations and potential overflows.
tags:
    - rust
    - data-types
    - integer-types
...
LengthSignedUnsigned 8-bit`i8``u8` 16-bit`i16``u16` 32-bit`i32``u32` 64-bit`i64``u64` 128-bit`i128``u128` Architecture-dependent`isize``usize`
...
Number literalsExample Decimal`98_222` Hex`0xff` Octal`0o77` Binary`0b1111_0000` Byte (`u8` only)`b'A'`
