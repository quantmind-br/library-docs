---
title: granite_reasoning_parser - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/reasoning/granite_reasoning_parser/
source: sitemap
fetched_at: 2026-05-07T21:35:02.028464341-03:00
rendered_js: false
word_count: 0
summary: This document defines a Python class for parsing reasoning and response sequences generated by IBM Granite models, handling both full output processing and incremental streaming updates.
tags:
    - ibm-granite
    - parser
    - llm-inference
...
```
classGraniteReasoningParser(ReasoningParser):
"""
...
"""Extract the reasoning content / content emitted by granite models;
    ...
    def_is_reasoning_start_substr(self, text: str) -> bool:
"""Check if a text matches one of the possible start reasoning seqs.
    ...
    def_is_response_start_substr(self, text: str) -> bool:
"""Check if a text matches one of the possible start response seqs.
    ...
    def_get_delta_message_with_no_reasoning_bounds(
        self,
        current_text: str,
        delta_text: str,
    ) -> DeltaMessage:
"""Parse the delta message when the current text has not yet completed
    ...
    def_get_delta_message_with_no_response_bounds(
        self,
        current_text: str,
        reasoning: str,
        delta_text: str,
...
"""Parse the delta message when the current text has both reasoning
    ...
    def_get_delta_message_with_both_bounds(
        self,
        delta_text: str,
        reasoning: str,
