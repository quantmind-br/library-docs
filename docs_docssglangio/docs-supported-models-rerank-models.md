---
title: Rerank models - SGLang Documentation
url: https://docs.sglang.io/docs/supported-models/rerank_models
source: sitemap
fetched_at: 2026-05-11T05:48:02.964971087-03:00
rendered_js: false
word_count: 656
summary: This document provides instructions on how to deploy and use reranking models, including cross-encoder and decoder-only architectures, within the SGLang framework.
tags:
    - sglang
    - reranking
    - cross-encoder
...
### Example Client Request (supports optional instruct, top\_n, and return\_documents)
