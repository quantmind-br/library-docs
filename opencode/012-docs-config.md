...
source: sitemap
fetched_at: 2026-04-17T06:37:03.764663808-03:00
rendered_js: false
word_count: 1851
summary: This document explains how to configure OpenCode using JSON or JSONC files and details the hierarchical precedence of various configuration sources from remote defaults to managed macOS preferences.
tags:
...
PlatformPathmacOS`/Library/Application Support/opencode/`Linux`/etc/opencode/`Windows`%ProgramData%\opencode`
