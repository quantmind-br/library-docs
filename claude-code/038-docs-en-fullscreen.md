...
source: llms
fetched_at: 2026-04-16T22:32:27.024455735-03:00
rendered_js: false
word_count: 1806
summary: This document explains how to enable and use the fullscreen rendering mode in Claude Code to provide a flicker-free, mouse-supported interface within terminal emulators.
tags:
    - claude-code
    - terminal-ui
    - user-interface
