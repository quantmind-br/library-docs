...
source: crawler
fetched_at: 2026-02-08T04:01:32.428697843-03:00
rendered_js: false
word_count: 287
summary: This document explains how to configure and use watch paths to automatically trigger application or Docker Compose deployments when specific files or directories change. It provides details on supported Git providers and the various pattern-matching syntaxes available for defining path rules.
tags:
    - dokploy
