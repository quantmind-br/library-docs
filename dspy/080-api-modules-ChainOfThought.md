---
title: ChainOfThought - DSPy
url: https://dspy.ai/api/modules/ChainOfThought/
source: sitemap
fetched_at: 2026-01-23T08:01:43.90388754-03:00
rendered_js: false
word_count: 834
summary: This document defines the ChainOfThought class, a module designed to perform step-by-step reasoning for task prediction within the DSPy framework. It covers initialization with signatures, asynchronous execution, and parallel batch processing capabilities.
tags:
    - dspy
    - chain-of-thought
    - reasoning
...
"""
    ...
    fromdspy.adapters.types.reasoningimport Reasoning

    extended_signature = signature.prepend(name="reasoning", field=OutputField(), type_=Reasoning)
    self.predict = dspy.Predict(extended_signature, **config)
```

### Functions[¶](#dspy.ChainOfThought-functions "Permanent link")

#### `__call__(*args, **kwargs) -> Prediction` [¶](#dspy.ChainOfThought.__call__ "Permanent link")
...
#### `acall(*args, **kwargs) -> Prediction` `async` [¶](#dspy.ChainOfThought.acall "Permanent link")
...
#### `aforward(**kwargs)` `async` [¶](#dspy.ChainOfThought.aforward "Permanent link")
...
#### `deepcopy()` [¶](#dspy.ChainOfThought.deepcopy "Permanent link")
...
#### `dump_state(json_mode=True)` [¶](#dspy.ChainOfThought.dump_state "Permanent link")
...
#### `forward(**kwargs)` [¶](#dspy.ChainOfThought.forward "Permanent link")
...
#### `get_lm()` [¶](#dspy.ChainOfThought.get_lm "Permanent link")
...
#### `inspect_history(n: int = 1)` [¶](#dspy.ChainOfThought.inspect_history "Permanent link")
...
#### `load(path, allow_pickle=False)` [¶](#dspy.ChainOfThought.load "Permanent link")
...
#### `load_state(state)` [¶](#dspy.ChainOfThought.load_state "Permanent link")
...
#### `map_named_predictors(func)` [¶](#dspy.ChainOfThought.map_named_predictors "Permanent link")
...
#### `named_parameters()` [¶](#dspy.ChainOfThought.named_parameters "Permanent link")
...
#### `named_predictors()` [¶](#dspy.ChainOfThought.named_predictors "Permanent link")
...
#### `named_sub_modules(type_=None, skip_compiled=False) -> Generator[tuple[str, BaseModule], None, None]` [¶](#dspy.ChainOfThought.named_sub_modules "Permanent link")
...
#### `parameters()` [¶](#dspy.ChainOfThought.parameters "Permanent link")
...
#### `predictors()` [¶](#dspy.ChainOfThought.predictors "Permanent link")
...
#### `reset_copy()` [¶](#dspy.ChainOfThought.reset_copy "Permanent link")
...
#### `save(path, save_program=False, modules_to_serialize=None)` [¶](#dspy.ChainOfThought.save "Permanent link")
...
#### `set_lm(lm)` [¶](#dspy.ChainOfThought.set_lm "Permanent link")
