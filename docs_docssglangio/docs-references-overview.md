---
title: References - SGLang Documentation
url: https://docs.sglang.io/docs/references/overview
source: sitemap
fetched_at: 2026-05-11T05:51:32.047084915-03:00
rendered_js: false
word_count: 95
summary: This document provides an overview of advanced configuration and performance optimization features for the SGLang runtime. It covers topics including inference acceleration, distributed serving strategies, model quantization, and specialized hardware-level optimizations.
tags:
    - model-inference
