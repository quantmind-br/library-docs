---
title: Moodle App Development process | Moodle Developer Resources
url: https://moodledev.io/general/development/process-moodleapp
source: sitemap
fetched_at: 2026-02-17T16:00:01.461833-03:00
rendered_js: false
word_count: 967
summary: This document outlines the six-phase development lifecycle of the Moodle App, detailing the processes for feature prioritization, design, implementation, and quality assurance. It explains how Moodle HQ moves from initial discovery and stakeholder feedback through to final release and post-release evaluation.
tags:
    - moodle-app
...
### Prioritisation[​](#prioritisation "Direct link to Prioritisation")
...
## Shaping[​](#shaping "Direct link to Shaping")
