---
title: GPT-OSS - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/OpenAI/GPT-OSS
source: sitemap
fetched_at: 2026-05-11T05:50:20.072713946-03:00
rendered_js: false
word_count: 543
summary: This document provides an overview and deployment guide for the GPT-OSS large language model series within the SGLang framework, covering installation, hardware configuration, and advanced features like reasoning and tool-calling.
tags:
    - gpt-oss
    - sglang
    - llm-deployment
...
For more detailed configuration tips, please refer to [GPS-OSS Usage](https://docs.sglang.io/docs/basic_usage/gpt_oss).
