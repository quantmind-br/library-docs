---
title: Post-Training Integration — SGLang
url: https://docs.sglang.io/references/post_training_integration.html
source: crawler
fetched_at: 2026-02-04T08:47:19.692116015-03:00
rendered_js: false
word_count: 349
summary: This document explains SGLang's role as a high-performance inference backend for LLM post-training and reinforcement learning workflows, detailing its key features and industry adoption.
tags:
    - post-training
...
## Post-Training Integration[#](#post-training-integration "Link to this heading")
...
## Adoption[#](#adoption "Link to this heading")
...
## Collaboration[#](#collaboration "Link to this heading")

Due to the privacy of the design parternes, we cannot list the companies that adopt SGLang for post-training. However, we are happy to share the details with you if you are interested and trust the choice among 10+ top companies and frontier labs across US and China. If you are interested in integrating SGLang with your training framework or need technical support, we’re here to help! Reach out to us at **rl\_team@lmsys.org** for partnerships, integration guidance, and custom feature development.