...
source: crawler
fetched_at: 2026-01-28T15:01:16.18876502-03:00
rendered_js: false
word_count: 412
summary: This document defines the Context class used in mitmproxy, which provides access to client and server connections, proxy options, and protocol layers for proxy operations.
tags:
    - mitmproxy
    - proxy-core
    - context-class
