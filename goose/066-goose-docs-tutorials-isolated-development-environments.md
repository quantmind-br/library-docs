---
title: Isolated Development Environments | goose
url: https://block.github.io/goose/docs/tutorials/isolated-development-environments
source: github_pages
fetched_at: 2026-01-22T22:16:17.726894828-03:00
rendered_js: true
word_count: 613
summary: This guide explains how to configure and use the Container Use Model Context Protocol (MCP) with goose to create isolated, containerized development environments. It covers installation, configuration, and workflows for safely experimenting with code and dependencies.
tags:
    - goose-mcp
    - containerization
    - docker
...
### Install Container Use[​](#install-container-use "Direct link to Install Container Use")
...
## Adding to goose[​](#adding-to-goose "Direct link to Adding to goose")

### Method 1: Quick Setup Link[​](#method-1-quick-setup-link "Direct link to Method 1: Quick Setup Link")
...
### Method 2: Manual Configuration[​](#method-2-manual-configuration "Direct link to Method 2: Manual Configuration")
...
### Starting Isolated Development[​](#starting-isolated-development "Direct link to Starting Isolated Development")
...
### Working with Experiments[​](#working-with-experiments "Direct link to Working with Experiments")
...
### Learning New Technologies[​](#learning-new-technologies "Direct link to Learning New Technologies")
...
### Feature Development[​](#feature-development "Direct link to Feature Development")
...
### Dependency Exploration[​](#dependency-exploration "Direct link to Dependency Exploration")
