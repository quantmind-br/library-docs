...
url: https://moodledev.io/docs/4.5/apis/subsystems/access
source: sitemap
fetched_at: 2026-02-17T15:13:05.231104-03:00
rendered_js: false
word_count: 1125
summary: This document explains Moodle's role-based access control system and how developers can use the Access API to define and check user permissions within various contexts.
tags:
    - moodle-development
    - access-api
...
See [Enrolment API](https://moodledev.io/docs/4.5/apis/subsystems/enrol).
...
- if an activity is specified, verify any [availability restrictions](https://moodledev.io/docs/4.5/apis/subsystems/availability) for the activity
...
- [API guides](https://moodledev.io/docs/4.5/apis)
- [Roles](https://moodledev.io/docs/4.5/apis/subsystems/roles)
- [Role archetypes](https://docs.moodle.org/dev/Role_archetypes)
- [Hardening new Roles system](https://moodledev.io/docs/4.5/apis/subsystems/roles)
