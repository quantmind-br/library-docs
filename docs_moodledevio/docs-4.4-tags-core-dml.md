...
url: https://moodledev.io/docs/4.4/tags/core-dml
source: sitemap
fetched_at: 2026-02-17T14:58:26.385488-03:00
rendered_js: false
word_count: 136
summary: This document provides an overview of Moodle's core database APIs, including data definition (DDL), data manipulation (DML), database drivers, error handling, and transaction management.
tags:
    - moodle
    - dml
    - ddl
