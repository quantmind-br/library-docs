...
url: https://moodledev.io/docs/5.1/apis/subsystems/muc
source: sitemap
fetched_at: 2026-02-17T15:36:56.084924-03:00
rendered_js: false
word_count: 4016
summary: This document explains how to use the Moodle Universal Cache (MUC) API to manage data storage within plugins. It covers creating cache definitions, performing basic CRUD operations, and configuring advanced cache requirements.
tags:
    - moodle
    - cache-api
    - muc
