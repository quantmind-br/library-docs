---
title: Codex - vLLM
url: https://docs.vllm.ai/en/latest/serving/integrations/codex/
source: sitemap
fetched_at: 2026-05-07T21:15:16.233930556-03:00
rendered_js: false
word_count: 518
summary: This document provides instructions on how to configure the OpenAI Codex coding tool to use a local vLLM server as a backend for private, model-agnostic coding assistance.
tags:
    - codex
    - vllm
    - tool-calling
...
[](https://github.com/vllm-project/vllm/edit/main/docs/serving/integrations/codex.md "Edit this page")
...
Codex requires a model with strong tool calling capabilities. The model must support the OpenAI-Responses tool calling API. See [Tool Calling](https://docs.vllm.ai/en/latest/features/tool_calling/) for details on enabling tool calling for your model.
...
```
vllmserveQwen/Qwen3.6-27B--port8000--tensor-parallel-size8--max-model-len262144--reasoning-parserqwen3--enable-auto-tool-choice--tool-call-parserqwen3_coder
```
...
## Configuring Codex[¶](#configuring-codex "Permanent link")
