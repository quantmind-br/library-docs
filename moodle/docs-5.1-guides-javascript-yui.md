...
url: https://moodledev.io/docs/5.1/guides/javascript/yui
source: sitemap
fetched_at: 2026-02-17T15:37:55.74279-03:00
rendered_js: false
word_count: 888
summary: This document provides an overview of Moodle's integration with the YUI framework, covering modular JavaScript development, build tools like Grunt and JSHint, and configuration settings for debugging.
tags:
    - moodle
    - yui
    - javascript
...
Moodle uses [Grunt](https://moodledev.io/docs/5.1/guides/javascript#grunt) for most JavaScript management. We recommend reading our Grunt documentation for further information on the available commands.
...
- [JavaScript Modules](https://moodledev.io/docs/5.1/guides/javascript/modules)
- [jQuery](https://moodledev.io/docs/5.1/guides/javascript/jquery)
