...
url: https://moodledev.io/docs/4.4/tags/pdf
source: sitemap
fetched_at: 2026-02-17T15:00:27.675658-03:00
rendered_js: false
word_count: 69
summary: This document introduces Moodle's file converter plugin type and explains how it facilitates the conversion of files between different formats through a dedicated API.
tags:
    - moodle-development
    - file-converters
    - file-conversion-api
