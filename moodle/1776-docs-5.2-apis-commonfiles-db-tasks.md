...
url: https://moodledev.io/docs/5.2/apis/commonfiles/db-tasks.php
source: sitemap
fetched_at: 2026-02-17T15:43:00.228269-03:00
rendered_js: false
word_count: 318
summary: This document explains how to configure scheduled tasks for a plugin by creating a task class and defining settings in the db/tasks.php file. It details various configuration properties including timing, blocking behavior, and initial status.
tags:
    - scheduled-tasks
    - plugin-development
    - configuration-files
