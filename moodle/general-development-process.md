---
title: Development process | Moodle Developer Resources
url: https://moodledev.io/general/development/process
source: sitemap
fetched_at: 2026-02-17T15:59:57.554381-03:00
rendered_js: false
word_count: 3294
summary: This document outlines the collaborative development and integration workflow used for Moodle, detailing the specific roles, quality assurance processes, and release cycles involved in software maintenance.
tags:
    - moodle-development
...
## Integration workflow in the tracker[​](#integration-workflow-in-the-tracker "Direct link to Integration workflow in the tracker")
...
![A summary of the Moodle Development Process flow](https://moodledev.io/assets/images/simplified_workflow-160aa5f70779322072e357167956c80e.png)

- The [triaging](#issue-triage) is done by the Component leads.
- Anybody can participate in the issue [development](https://moodledev.io/general/development), by creating a patch for [a bug](#fixing-a-bug), [an improvement](#new-feature-development) or [a security issue](#security-issues).
- Anybody can also [peer review](https://moodledev.io/general/development/process/peer-review) code developed by other developers.
- There is a dedicated team in Moodle HQ in charge of the [integration review](https://moodledev.io/general/development/process/integration), to ensure consistent quality across the codebase.
- Every time an issue is integrated, the [testing](https://moodledev.io/general/development/process/testing) instructions are run by a dedicated team of testers.
...
While many of the developers work for Moodle.com, a large number are part of the global development community around Moodle. If you're interested in becoming a recognised developer, see [Tracker groups and permissions](https://moodledev.io/general/development/tracker/guide#tracker-groups-and-permissions).

### CiBoT[​](#cibot "Direct link to CiBoT")

CiBoT is not a person but a bot who monitors the tracker and performs the [Automated code review](https://moodledev.io/general/development/tools/cibot) when issue is submitted for Peer review or when developer added `cime` label.

### Component leads[​](#component-leads "Direct link to Component leads")

[Component leads](https://moodle.atlassian.net/projects/MDL?selectedItem=com.atlassian.jira.jira-projects-plugin%3Acomponents-page) are developers with some responsibility for particular components (plugins or modules) in Moodle. They have authority to decide that a particular fix is suitable and complete enough to be considered for integration in Moodle core and should be called upon to complete peer reviews for code in their components. Note that, apart from that, every component also has some [HQ Component leads](https://docs.moodle.org/dev/Component_Leads) that will specifically work on associated issues, triaging, monitoring, reviewing, fixing them.

### Component leads reviewers[​](#component-leads-reviewers "Direct link to Component leads reviewers")

Component Lead Reviewers are Component Leads who have the added responsibility of performing a second and final review of a selection of issues within their component. After reviewing the code, it is sent to the integration team to be pulled without further review.

### Integrators[​](#integrators "Direct link to Integrators")
...
### Testers[​](#testers "Direct link to Testers")
...
See [Testing of integrated issues](https://moodledev.io/general/development/process/testing/integrated-issues) for more details.

### Production maintainers[​](#production-maintainers "Direct link to Production maintainers")
...
## Stable maintenance cycles[​](#stable-maintenance-cycles "Direct link to Stable maintenance cycles")
...
### Minor release (point release) timing[​](#minor-release-point-release-timing "Direct link to Minor release (point release) timing")
...
- There will then be another point release every two months after that. See the [General release calendar](https://moodledev.io/general/releases#general-release-calendar) for details.

### Issue triage[​](#issue-triage "Direct link to Issue triage")

[Issue triage](https://moodledev.io/general/development/process/triage) involves evaluating new issues, making sure that they are recorded correctly. One of the most important jobs triagers do is to identify issues that should be fixed in the stable branch. These are set with a priority ranging from *Trivial* up to *Blocker* and other features are checked.
...
### Scrum[​](#scrum "Direct link to Scrum")
...
## Major release cycles[​](#major-release-cycles "Direct link to Major release cycles")
...
There will be a point release every two months following a major release. See the [General release calendar](https://moodledev.io/general/releases#general-release-calendar) for more details.

note

Each release can be different, but generally the cycles work as follows.

### Define roadmap[​](#define-roadmap "Direct link to Define roadmap")
...
### Planning and development[​](#planning-and-development "Direct link to Planning and development")
...
During development, as new code is integrated, automated testing conducted at the [code](https://moodledev.io/general/development/tools/phpunit) and [interface](https://moodledev.io/general/development/tools/behat) levels, to make sure there are no regressions caused by new features.

In the last month before the release, a feature freeze is called (no new features can be added) and volunteer testers from the Moodle community perform manual [QA testing](https://moodledev.io/general/development/process/testing/qa) of Moodle features. The current set of functional tests is listed in [MDLQA-1](https://moodle.atlassian.net/browse/MDLQA-1). The list of tests is extended as new features are added, though we're also trying to reduce the number as more automated [acceptance tests](https://moodledev.io/general/development/tools/behat) are developed.
...
For more details, see [Testing](https://moodledev.io/general/development/process/testing).

### Sprints[​](#sprints "Direct link to Sprints")
...
### Events during cycle[​](#events-during-cycle "Direct link to Events during cycle")

During each cycle there are a periods and events that occur between and around sprints.

![The Development sprint calendar](https://moodledev.io/assets/images/sprintcalendar-7d42782e6376ee60a2113271beb3a810.png)
...
**End sync period**  
During the [on-sync period](https://moodledev.io/general/development/process/integration#on-sync-period), the recent release and main versions are kept synchronised. No new code is added during this period, which ensures regressions are fixed rapidly. This also allows for planning and provides relief for developers after a release.
...
### Develop the code using Git[​](#develop-the-code-using-git "Direct link to Develop the code using Git")
...
### Submit your code for peer review[​](#submit-your-code-for-peer-review "Direct link to Submit your code for peer review")
...
This would be a good time to fill in the testing instructions (read the [instructions guide](https://moodledev.io/general/development/process/testing/guide)) for how to verify your fix is correct. You may also wish to add a comment in the bug.
...
### Peer review[​](#peer-review "Direct link to Peer review")
...
Process and the list of things to check are described in [Peer reviewing](https://moodledev.io/general/development/process/peer-review).

### Submit the code for integration[​](#submit-the-code-for-integration "Direct link to Submit the code for integration")
...
### Make sure there is a tracker issue[​](#make-sure-there-is-a-tracker-issue "Direct link to Make sure there is a tracker issue")

Every change must have an issue in the tracker. If you are fixing a bug, there is probably one there already, but if not, create one. [Tips for searching tracker](https://moodledev.io/general/development/tracker/tips).

### Decide which branches the fix is required on[​](#decide-which-branches-the-fix-is-required-on "Direct link to Decide which branches the fix is required on")
...
### Develop your change using git[​](#develop-your-change-using-git "Direct link to Develop your change using git")

Develop your fix and push the change to an open git repository, for example on github.com. See also [Git for developers](https://moodledev.io/docs/5.2/guides/git)
...
### Submit your code for peer review[​](#submit-your-code-for-peer-review-1 "Direct link to Submit your code for peer review")
...
- Information about your public git repository
  ...
  - branch name(s)
  - diff URL
- [Testing instructions](https://moodledev.io/general/development/process/testing/guide) for how to verify your fix is correct. If you have never contributed to Moodle and don't see a button *Request peer review*, just comment on the issue with the above information. The component lead or another user with sufficient privileges will then send the issue up for peer review for you.
...
### Peer review[​](#peer-review-1 "Direct link to Peer review")

The [HQ component leads](https://docs.moodle.org/dev/HQ_component_leads) should peer-review the change. If there is no component lead for an affected component, any other recognised developer may complete the peer review. The peer reviewer will either give you comments on the code and if it needs more work.

Process and the list of things to check are described in [Peer reviewing](https://moodledev.io/general/development/process/peer-review).

### Submit your code for integration[​](#submit-your-code-for-integration "Direct link to Submit your code for integration")

It will then be reviewed the following week by one of the integration team and either integrated or rejected. Once integrated, the fix will be tested, and then included in the next weekly release. For details see [Integration Review](https://moodledev.io/general/development/process/integration).

## Security issues[​](#security-issues "Direct link to Security issues")

Issues identified as [security issues](https://moodledev.io/general/development/policies/security) are resolved in a slightly different way, in order to achieve responsible disclosure as described in [Moodle security procedures](https://moodledev.io/general/development/process/security).
...
## Policy issues[​](#policy-issues "Direct link to Policy issues")
...
- [Detailed workflow](https://moodledev.io/assets/files/workflow-d2aa970195d7c87fd3291004672acdee.jpg)
- [Release process](https://moodledev.io/general/development/process/release)
- [Deprecation](https://moodledev.io/general/development/policies/deprecation)
- [Integration dashboard](http://moodle.atlassian.net/secure/Dashboard.jspa?selectPageId=11350) Walks-though of the process for contributors:
- By Dan Poltawski, Integrator: [http://www.slideshare.net/poltawski/how-to-guarantee-your-change-is-integrated-to-moodle-core](http://www.slideshare.net/poltawski/how-to-guarantee-your-change-is-integrated-to-moodle-core), [https://www.youtube.com/watch?v=836WtnM2YpM](https://www.youtube.com/watch?v=836WtnM2YpM)
- By Tim Hunt, contributor: [http://tjhunt.blogspot.co.uk/2012/03/fixing-bug-in-moodle-core-mechanics.html](http://tjhunt.blogspot.co.uk/2012/03/fixing-bug-in-moodle-core-mechanics.html) and [https://www.youtube.com/watch?v=gPPA3h7OGQU](https://www.youtube.com/watch?v=gPPA3h7OGQU) and [https://youtu.be/Hu8ne0NCRAg?t=11659](https://youtu.be/Hu8ne0NCRAg?t=11659)