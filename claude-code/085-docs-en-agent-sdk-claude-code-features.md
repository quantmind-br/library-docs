...
source: llms
fetched_at: 2026-04-16T22:28:41.235434038-03:00
rendered_js: false
word_count: 1552
summary: This document explains how to use the settingSources option in the Claude Agent SDK to control which filesystem-based settings, such as project rules and user configs, are loaded into an agent's context.
tags:
    - claude-agent-sdk
    - filesystem-settings
