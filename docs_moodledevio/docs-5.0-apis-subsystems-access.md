...
source: sitemap
fetched_at: 2026-02-17T15:26:56.359243-03:00
rendered_js: false
word_count: 1125
summary: This document explains the Moodle Access API, detailing how to manage role-based access control, define plugin capabilities, and verify user permissions within various contexts.
tags:
    - moodle-development
    - access-api
    - permissions
...
See [Enrolment API](https://moodledev.io/docs/5.0/apis/subsystems/enrol).
...
- if an activity is specified, verify any [availability restrictions](https://moodledev.io/docs/5.0/apis/subsystems/availability) for the activity
...
- [API guides](https://moodledev.io/docs/5.0/apis)
- [Roles](https://moodledev.io/docs/5.0/apis/subsystems/roles)
- [Role archetypes](https://docs.moodle.org/dev/Role_archetypes)
- [Hardening new Roles system](https://moodledev.io/docs/5.0/apis/subsystems/roles)
