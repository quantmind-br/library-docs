...
url: https://moodledev.io/docs/5.2/apis/subsystems/output
source: sitemap
fetched_at: 2026-02-17T15:46:04.404755-03:00
rendered_js: false
word_count: 3306
summary: This document explains the Moodle Output API's workflow for displaying content through the coordinated use of renderers, renderables, themes, and templates.
tags:
    - moodle-development
    - output-api
    - rendering
...
This is the mustache template for this demo. It uses some bootstrap classes directly to position and style the content on the page. `{{sometext}}` is replaced with the variable from the context when this template is rendered. For more information on templates see [Templates](https://moodledev.io/docs/5.2/guides/templates).
...
While to render complex elements, you should use [templates](https://moodledev.io/docs/5.2/guides/templates), some simple elements can be rendered using the following functions:
...
- [Templates](https://moodledev.io/docs/5.2/guides/templates)