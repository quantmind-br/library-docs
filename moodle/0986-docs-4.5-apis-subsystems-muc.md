...
url: https://moodledev.io/docs/4.5/apis/subsystems/muc
source: sitemap
fetched_at: 2026-02-17T15:14:40.519955-03:00
rendered_js: false
word_count: 4016
summary: This document provides a comprehensive guide to the Moodle Universal Cache (MUC) API, explaining how to define cache areas, manage storage modes, and perform basic data operations within plugins.
tags:
    - moodle
    - cache-api
    - muc
