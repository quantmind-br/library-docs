...
url: https://moodledev.io/docs/4.4/apis/subsystems/files/converter
source: sitemap
fetched_at: 2026-02-17T15:04:21.449891-03:00
rendered_js: false
word_count: 392
summary: This document explains how to utilize Moodle's File Converter API to transform files between formats, covering conversion initiation, status tracking, and file retrieval.
tags:
    - moodle
    - file-converter
    - api-documentation
...
- Creating a new [file converter plugin](https://moodledev.io/docs/4.4/apis/plugintypes/fileconverter)