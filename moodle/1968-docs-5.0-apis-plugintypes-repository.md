...
url: https://moodledev.io/docs/5.0/apis/plugintypes/repository
source: sitemap
fetched_at: 2026-02-17T15:26:38.506428-03:00
rendered_js: false
word_count: 4033
summary: This document explains how to develop Moodle repository plugins, detailing the necessary file structure, prerequisites, and mandatory files required for integration with the file picker and administration pages.
tags:
    - moodle-development
    - repository-plugin
    - plugin-structure
...
Some of the important files for the repository plugintype are described below. See the [common plugin files](https://moodledev.io/docs/5.0/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
