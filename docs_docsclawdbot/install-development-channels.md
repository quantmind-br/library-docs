...
source: llms
fetched_at: 2026-01-26T09:52:27.017697873-03:00
rendered_js: false
word_count: 296
summary: This document explains the available update channels for Clawdbot and provides instructions on how to switch between stable, beta, and development versions.
tags:
    - update-channels
    - release-management
    - clawdbot-cli
