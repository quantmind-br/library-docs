---
title: Task Tool (task)
url: https://qwenlm.github.io/qwen-code-docs/en/developers/tools/task
source: github_pages
fetched_at: 2026-04-09T09:04:49.476821102-03:00
rendered_js: true
word_count: 597
summary: This document explains the usage of the `task` tool in Qwen Code, which allows users to delegate complex, multi-step tasks autonomously to specialized, independent subagents for parallel execution.
tags:
    - qwen-code
    - task-tool
    - subagent
...
## How to use `task` with Qwen Code[](#how-to-use-task-with-qwen-code)
...
## Task Tool Features[](#task-tool-features)
...
### Delegating to a general-purpose agent[](#delegating-to-a-general-purpose-agent)
...
## When NOT to Use the Task Tool[](#when-not-to-use-the-task-tool)
...
[Todo Write](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/todo-write/ "Todo Write")[Exit Plan Mode](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/exit-plan-mode/ "Exit Plan Mode")