...
source: llms
fetched_at: 2026-01-26T09:53:06.104410981-03:00
rendered_js: false
word_count: 382
summary: This document explains how to package and sign macOS debug builds to ensure stable TCC permissions and include build-time metadata in the application bundle.
tags:
    - macos
    - codesigning
    - build-scripts
