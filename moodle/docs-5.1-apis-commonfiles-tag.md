...
url: https://moodledev.io/docs/5.1/apis/commonfiles/tag.php
source: sitemap
fetched_at: 2026-02-17T15:33:52.589303-03:00
rendered_js: false
word_count: 0
summary: This document defines the structure and attributes for declaring tag areas in Moodle, explaining how components register items to be handled by the tagging system.
tags:
    - moodle
    - tag-api
    - configuration-files
