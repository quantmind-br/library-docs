...
url: https://moodledev.io/docs/5.0/apis/plugintypes/ai
source: sitemap
fetched_at: 2026-02-17T15:25:10.725183-03:00
rendered_js: false
word_count: 228
summary: This document explains the architecture of the Moodle AI subsystem, detailing the roles and interaction between provider and placement plugins for integrating external AI services.
tags:
    - moodle-lms
    - ai-subsystem
    - provider-plugins
...
The [AI subsystem](https://moodledev.io/docs/5.0/apis/subsystems/ai) provides a way for developers to integrate external AI services into Moodle LMS.

The design of the AI subsystem features two distinct plugin types:

- [Provider plugins](https://moodledev.io/docs/5.0/apis/plugintypes/ai/provider)
- [Placement plugins](https://moodledev.io/docs/5.0/apis/plugintypes/ai/placement)
...
Providers are the interface between the [AI subsystem](https://moodledev.io/docs/5.0/apis/subsystems/ai) and external AI. Their focus is on formatting actions, passing them to the external AI system, and providing the response.
