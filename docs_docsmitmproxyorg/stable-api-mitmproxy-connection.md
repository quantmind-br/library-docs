...
source: crawler
fetched_at: 2026-01-28T16:18:33.938219335-03:00
rendered_js: false
word_count: 3983
summary: This document defines the base `Connection` class and its `Client` subclass, detailing the metadata associated with network connections in `mitmproxy`, including connection state, addresses, TLS properties, and timestamps.
tags:
    - connection-metadata
    - network-connections
    - tls-details
