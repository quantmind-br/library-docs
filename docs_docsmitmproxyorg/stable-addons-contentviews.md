...
source: crawler
fetched_at: 2026-01-28T16:18:28.77012588-03:00
rendered_js: false
word_count: 174
summary: This document explains how to create custom contentviews in mitmproxy to pretty-print and interactively edit binary message data, detailing the implementation of both standard and interactive contentview classes.
tags:
    - mitmproxy
    - addons
    - contentviews
