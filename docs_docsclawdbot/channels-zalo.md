---
title: "null"
url: https://docs.clawd.bot/channels/zalo.md
source: llms
fetched_at: 2026-01-26T09:50:28.489590364-03:00
rendered_js: false
word_count: 789
summary: This document provides instructions for installing and configuring the Zalo Bot API plugin for the ClawdBot gateway. It details setup procedures, messaging behavior, webhook integration, and full configuration options for direct messaging.
tags:
    - zalo
    - bot-api
