...
url: https://moodledev.io/docs/5.2/apis/plugintypes/qtype/newquestiondefaults
source: sitemap
fetched_at: 2026-02-17T15:44:45.866729-03:00
rendered_js: false
word_count: 470
summary: Explains how to implement a feature in Moodle question types that saves user settings as defaults for future question creation.
tags:
    - moodle-development
    - question-types
    - user-preferences
