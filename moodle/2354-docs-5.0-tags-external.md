...
url: https://moodledev.io/docs/5.0/tags/external
source: sitemap
fetched_at: 2026-02-17T15:18:43.402464-03:00
rendered_js: false
word_count: 149
summary: This document provides an overview of Moodle's External Services framework, explaining how to declare, define, secure, and test web services for integration with external systems.
tags:
    - moodle
    - web-services
    - external-functions
