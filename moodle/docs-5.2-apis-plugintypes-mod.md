...
url: https://moodledev.io/docs/5.2/apis/plugintypes/mod
source: sitemap
fetched_at: 2026-02-17T15:44:26.547115-03:00
rendered_js: false
word_count: 1
summary: This document defines the structure and logic for a Moodle activity module's configuration form, used for creating and editing instances of the plugin.
tags:
    - moodle
    - php
    - activity-module
