...
source: llms
fetched_at: 2026-04-16T22:33:19.911151003-03:00
rendered_js: false
word_count: 561
summary: This document provides technical guidance on configuring Claude Code to work with LLM gateway solutions, including specific requirements for API formats and authentication methods like LiteLLM.
tags:
    - claude-code
    - llm-gateway
    - litellm
