...
url: https://moodledev.io/docs/5.2/apis/plugintypes/theme/styles
source: sitemap
fetched_at: 2026-02-17T15:45:00.764583-03:00
rendered_js: false
word_count: 1355
summary: This document explains how to include and organize CSS and SCSS within Moodle, detailing file locations, pre-processor integration, and best practices for writing targeted rules using body classes.
tags:
    - moodle-development
    - css-styling
    - theme-design
