...
url: https://moodledev.io/docs/5.0/apis/plugintypes/mod/visibility
source: sitemap
fetched_at: 2026-02-17T15:26:27.927609-03:00
rendered_js: false
word_count: 1179
summary: This document explains the Moodle API for customizing how activity modules are displayed on course pages, covering caching mechanisms, dynamic visibility, and user-specific content updates.
tags:
    - moodle-development
    - php-api
    - course-modules
