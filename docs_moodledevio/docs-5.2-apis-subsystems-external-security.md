...
url: https://moodledev.io/docs/5.2/apis/subsystems/external/security
source: sitemap
fetched_at: 2026-02-17T15:45:36.486393-03:00
rendered_js: false
word_count: 399
summary: This document explains how to validate function parameters, context access, and user permissions when developing external functions in Moodle. It outlines the essential security steps required to ensure data integrity and authorized access before performing operations.
tags:
    - moodle-development
    - external-functions
    - data-validation
