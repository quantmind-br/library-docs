...
source: sitemap
fetched_at: 2026-05-07T21:18:54.042579251-03:00
rendered_js: false
word_count: 51
summary: This document defines the P2pNcclConnector class, which facilitates the transfer of Key-Value (KV) cache data between distributed nodes using NCCL in the vLLM framework.
tags:
    - kv-cache
    - nccl
...
```
classP2pNcclConnector(KVConnectorBase_V1):
    def__init__(
        self,
...
"""
    ...
    @staticmethod
    defparse_request_id(request_id: str, is_prefill=True) -> tuple[str, int]:
    ...
    @staticmethod
    defcheck_tensors_except_dim(tensor1, tensor2, dim):
        shape1 = tensor1.size()
        shape2 = tensor2.size()
