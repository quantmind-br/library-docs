...
url: https://docs.factory.ai/guides/skills/service-integration.md
source: llms
fetched_at: 2026-02-05T21:44:30.53275948-03:00
rendered_js: false
word_count: 660
summary: This document provides a framework and template for the Service integration skill, designed to guide the extension of backend services and multi-team integrations in complex monorepos. It outlines required behaviors, implementation checklists, and observability standards to ensure reliable code changes across domain boundaries.
tags:
    - factory-ai
    - service-integration
    - backend-development
