---
title: GLM Glyph - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/GLM/GLM-Glyph
source: sitemap
fetched_at: 2026-05-11T05:50:45.359976625-03:00
rendered_js: false
word_count: 475
summary: This document provides instructions for deploying and invoking the Glyph language model within the SGLang framework, covering hardware support, server configuration, thinking mode, and tool calling capabilities.
tags:
    - sglang
    - glyph-model
    - model-deployment
...
[Glyph](https://huggingface.co/zai-org/Glyph) is a powerful language model developed by Zhipu AI, featuring advanced capabilities in reasoning, function calling, and multi-modal understanding. **Hardware Support:** NVIDIA B200/H100/H200, AMD MI300X/MI325X/MI355X **Key Features:**
...
**License:** Please refer to the [official Glyph model card](https://huggingface.co/zai-org/Glyph) for license details.
