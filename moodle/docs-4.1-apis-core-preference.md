...
url: https://moodledev.io/docs/4.1/apis/core/preference
source: sitemap
fetched_at: 2026-02-17T14:54:58.886452-03:00
rendered_js: false
word_count: 306
summary: This document describes the Preference API used for storing and retrieving persistent user-specific settings in the database or temporary session data for guests. It provides technical details on core functions for managing preferences and outlines best practices for handling default values.
tags:
    - moodle
    - preference-api
    - user-data
