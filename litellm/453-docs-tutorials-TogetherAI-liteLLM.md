...
## Calling Llama2 on TogetherAI[​](#calling-llama2-on-togetherai "Direct link to Calling Llama2 on TogetherAI")
...
## Use Llama2 variants with Custom Prompt Templates[​](#use-llama2-variants-with-custom-prompt-templates "Direct link to Use Llama2 variants with Custom Prompt Templates")
