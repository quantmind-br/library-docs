---
title: MiniMax-M2 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/MiniMax/MiniMax-M2
source: sitemap
fetched_at: 2026-05-11T05:50:29.074071004-03:00
rendered_js: false
word_count: 445
summary: This document provides an overview and technical guide for deploying and invoking the MiniMax-M2 model using the SGLang framework, including setup requirements and configuration for reasoning and tool-calling capabilities.
tags:
    - minimax-m2
    - sglang
    - model-deployment
...
Comment out the following line: @torch.compile(dynamic=True, backend=get\_compiler\_backend()) in /sgl-workspace/sglang/python/sglang/srt/models/minimax\_m2.py
