...
url: https://moodledev.io/docs/5.2/guides/javascript/jquery
source: sitemap
fetched_at: 2026-02-17T15:46:58.618941-03:00
rendered_js: false
word_count: 371
summary: This document explains the recommended approach for using jQuery within Moodle, emphasizing its discouragement in favor of native ES6 modules while providing instructions for legacy integration.
tags:
    - moodle-development
    - jquery
    - javascript
