...
url: https://moodledev.io/docs/4.4/apis/subsystems/form/usage/files
source: sitemap
fetched_at: 2026-02-17T15:04:37.316433-03:00
rendered_js: false
word_count: 1528
summary: This document explains how to integrate file upload and management capabilities into Moodle forms using the filepicker, filemanager, and editor elements. It provides a workflow for handling draft file areas and moving files to permanent storage within the Moodle File API.
tags:
    - moodle-forms
    - file-api
    - file-management
...
Files and their metadata are stored within the [File API](https://moodledev.io/docs/4.4/apis/subsystems/files). Each file within the API is associated with:
...
4. User chooses a file, the corresponding [Repository plugin](https://moodledev.io/docs/4.4/apis/plugintypes/repository) takes care of copying the file into a "draft file area" within Moodle
5. File appears in the text or as an attachment in the form.
6. When the user hits save, the [File API](https://moodledev.io/docs/4.4/apis/subsystems/files) is invoked to move the file from the draft file area into a permanent file area associated with that data

This document shows you how to use Moodle forms to interact with users in a standard and secure way.

If you just want to write code to manipulate Moodle files internally (without user input) you can use the [File API](https://moodledev.io/docs/4.4/apis/subsystems/files) without involving form elements.
...
- [File API](https://moodledev.io/docs/4.4/apis/subsystems/files)
- [Using the file API](https://moodledev.io/docs/4.4/apis/subsystems/files)
