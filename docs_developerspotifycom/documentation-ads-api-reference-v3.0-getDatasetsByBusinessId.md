...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/getDatasetsByBusinessId
source: crawler
fetched_at: 2026-02-27T23:39:35.755276-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response schema for an API endpoint that returns advertising dataset information, including pixel configurations and conversion events.
tags:
    - api-response
    - dataset-metadata
    - tracking-pixel
