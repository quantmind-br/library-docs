---
title: logprobs - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/engine/logprobs/
source: sitemap
fetched_at: 2026-05-07T21:40:39.182239518-03:00
rendered_js: false
word_count: 0
summary: The LogprobsProcessor class manages the collection, aggregation, and detokenization of token log probabilities for both prompt processing and model sampling phases.
tags:
    - logprobs
    - llm-inference
    - tokenization
...
classLogprobsProcessor:
    ...
    def_update_sample_logprobs(self, logprobs_lists: LogprobsLists) -> None:
...
"""Update with prompt logprobs from EngineCore.
    ...
    defpop_prompt_logprobs(self) -> PromptLogprobs | None:
...
"""Verify and correct decoded tokens with replacement characters.
    ...
    defupdate_from_output(self, output: EngineCoreOutput) -> None:
