...
source: crawler
fetched_at: 2026-02-08T04:01:48.733586924-03:00
rendered_js: false
word_count: 184
summary: This document provides step-by-step instructions for configuring Cloudflare R2 buckets as S3-compatible storage destinations for backups, including API token creation and credential mapping.
tags:
    - cloudflare-r2
    - s3-destinations
    - backup-storage
