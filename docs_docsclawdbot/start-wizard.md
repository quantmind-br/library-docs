...
source: llms
fetched_at: 2026-01-26T09:54:00.80684834-03:00
rendered_js: false
word_count: 1132
summary: This document outlines the Clawdbot onboarding wizard process for setting up local or remote gateways, configuring AI model authentication, and managing workspace environments via the CLI.
tags:
    - clawdbot-onboarding
    - cli-configuration
    - gateway-setup
