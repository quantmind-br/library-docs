...
url: https://doc.rust-lang.org/stable/std/ops/trait.Try.html#associatedtype.Output
source: crawler
fetched_at: 2026-05-06T21:26:18.082795687-03:00
rendered_js: false
word_count: 636
summary: This document explains the Rust `Try` trait, which provides the underlying mechanism for the `?` operator and `try` blocks by allowing types to define short-circuiting behavior.
tags:
    - rust
    - try-trait
    - error-handling
...
This is most often seen for error handling with [`Result`](https://doc.rust-lang.org/stable/std/result/enum.Result.html "enum std::result::Result") and [`Option`](https://doc.rust-lang.org/stable/std/option/enum.Option.html "enum std::option::Option"). The quintessential implementation of this trait is on [`ControlFlow`](https://doc.rust-lang.org/stable/std/ops/enum.ControlFlow.html "enum std::ops::ControlFlow").
...
If we get through the entire iterator, we need to wrap up the accumulator into the return type using [`Try::from_output`](https://doc.rust-lang.org/stable/std/ops/trait.Try.html#tymethod.from_output "associated function std::ops::Try::from_output"):
...
[Source](https://doc.rust-lang.org/stable/src/core/ops/try_trait.rs.html#136)

🔬This is a nightly-only experimental API. (`try_trait_v2` [#84277](https://github.com/rust-lang/rust/issues/84277))

The type of the value produced by `?` when *not* short-circuiting.

[Source](https://doc.rust-lang.org/stable/src/core/ops/try_trait.rs.html#160)

🔬This is a nightly-only experimental API. (`try_trait_v2` [#84277](https://github.com/rust-lang/rust/issues/84277))

The type of the value passed to [`FromResidual::from_residual`](https://doc.rust-lang.org/stable/std/ops/trait.FromResidual.html#tymethod.from_residual "associated function std::ops::FromResidual::from_residual") as part of `?` when short-circuiting.
...
[Source](https://doc.rust-lang.org/stable/src/core/ops/try_trait.rs.html#192)
...
[Source](https://doc.rust-lang.org/stable/src/core/ops/try_trait.rs.html#219)

🔬This is a nightly-only experimental API. (`try_trait_v2` [#84277](https://github.com/rust-lang/rust/issues/84277))

Used in `?` to decide whether the operator should produce a value (because this returned [`ControlFlow::Continue`](https://doc.rust-lang.org/stable/std/ops/enum.ControlFlow.html#variant.Continue "variant std::ops::ControlFlow::Continue")) or propagate a value back to the caller (because this returned [`ControlFlow::Break`](https://doc.rust-lang.org/stable/std/ops/enum.ControlFlow.html#variant.Break "variant std::ops::ControlFlow::Break")).
