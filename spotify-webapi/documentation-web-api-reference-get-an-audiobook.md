...
url: https://developer.spotify.com/documentation/web-api/reference/get-an-audiobook
source: crawler
fetched_at: 2026-02-27T23:46:05.471128-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response structure for an audiobook resource, detailing fields for metadata, narrator information, and nested chapter objects.
tags:
    - api-response
    - audiobook-metadata
    - json-schema
