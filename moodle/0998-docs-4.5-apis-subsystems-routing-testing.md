...
url: https://moodledev.io/docs/4.5/apis/subsystems/routing/testing
source: sitemap
fetched_at: 2026-02-17T15:15:10.61205-03:00
rendered_js: false
word_count: 501
summary: This document explains how to unit test Moodle routes using the route_testcase class and its helper methods. It provides instructions on setting up a simplified router, mocking specific routes, and simulating requests to verify route behavior and parameter validation.
tags:
    - moodle-development
    - unit-testing
    - phpunit
...
One of the benefits of using routes is how easy they are to unit test. It is also possible to test [parameters](https://moodledev.io/docs/4.5/apis/subsystems/routing/parameters) for validation, which is especially useful for [mapped parameters](https://moodledev.io/docs/4.5/apis/subsystems/routing/parameters#mapped-parameters).
