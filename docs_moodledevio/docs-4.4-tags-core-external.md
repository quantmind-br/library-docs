...
url: https://moodledev.io/docs/4.4/tags/core-external
source: sitemap
fetched_at: 2026-02-17T14:58:27.938718-03:00
rendered_js: false
word_count: 149
summary: This document outlines Moodle's Web Service framework, explaining how to create, define, secure, and test external services for system integration.
tags:
    - moodle
    - web-services
    - external-functions
