...
source: sitemap
fetched_at: 2026-01-22T22:16:01.423321446-03:00
rendered_js: false
word_count: 470
summary: This document provides instructions for developers to build Hyprland in debug mode and set up a nested development environment for testing. It also covers tools for debugging crashes, formatting code, and accessing system logs.
tags:
    - building-hyprland
    - debugging
