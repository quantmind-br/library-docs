...
url: https://doc.rust-lang.org/stable/src/core/borrow.rs.html#212
source: crawler
fetched_at: 2026-05-06T21:26:25.277679368-03:00
rendered_js: false
word_count: 1223
summary: This document explains the Borrow and BorrowMut traits in Rust, which allow types to be represented or accessed as different, typically underlying, types while maintaining consistent trait behaviors like hashing and equality.
tags:
    - rust
    - borrowing
    - traits
