...
url: https://moodledev.io/docs/4.4/tags/form
source: sitemap
fetched_at: 2026-02-17T14:59:27.780228-03:00
rendered_js: false
word_count: 130
summary: This document provides an overview of the Moodle Forms API, detailing the choice dropdown field and explaining how the API extends standard HTML elements with security and accessibility features.
tags:
    - moodle-development
    - forms-api
    - choice-dropdown
...
## [Choice Dropdown](https://moodledev.io/docs/4.4/apis/subsystems/form/fields/choicedropdown)
