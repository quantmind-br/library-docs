...
url: https://moodledev.io/docs/5.1/apis/core/dml/delegated-transactions
source: sitemap
fetched_at: 2026-02-17T15:34:17.066045-03:00
rendered_js: false
word_count: 437
summary: This document explains Moodle's delegated database transaction system, detailing the principles and API methods used to manage nested CRUD operations and handle rollbacks.
tags:
    - moodle
