...
url: https://moodledev.io/docs/4.4/apis/core/dml
source: sitemap
fetched_at: 2026-02-17T15:02:13.814208-03:00
rendered_js: false
word_count: 2451
summary: This document explains the Moodle Data Manipulation API, detailing how developers use the global $DB object to perform database operations securely across different RDBMS systems. It covers fundamental concepts such as table prefixes and SQL placeholders while providing a reference for methods used to retrieve records.
tags:
    - moodle-development
    - database-api
    - php-backend
...
- [DML exceptions](https://moodledev.io/docs/4.4/apis/core/dml/exceptions): New DML code is throwing exceptions instead of returning false if anything goes wrong
- [DML drivers](https://moodledev.io/docs/4.4/apis/core/dml/drivers): Database drivers for new DML layer
- [DDL functions](https://moodledev.io/docs/4.4/apis/core/dml/ddl): Where all the functions used to handle DB objects ([DDL](https://en.wikipedia.org/wiki/Data_Definition_Language)) are defined.