...
url: https://doc.rust-lang.org/stable/reference/tokens.html#railroad-Token
source: crawler
fetched_at: 2026-05-06T21:32:01.758367148-03:00
rendered_js: false
word_count: 3274
summary: This document defines the syntax and rules for lexical tokens and various literal types within the Rust programming language, including character, string, byte, and numeric formats.
tags:
    - rust
    - tokens
    - literals
...
- [Keywords](https://doc.rust-lang.org/stable/reference/keywords.html)
- [Identifiers](https://doc.rust-lang.org/stable/reference/identifiers.html)
- [Literals](#literals)
- [Lifetimes](#lifetimes-and-loop-labels)
- [Punctuation](#punctuation)
- [Delimiters](#delimiters)

Within this documentation’s grammar, “simple” tokens are given in [string table production](https://doc.rust-lang.org/stable/reference/notation.html#string-table-productions) form, and appear in `monospace` font.

## [Literals](#literals)

Literals are tokens used in [literal expressions](https://doc.rust-lang.org/stable/reference/expressions/literal-expr.html).
...
Like any literal, an integer literal may be followed (immediately, without any spaces) by a suffix as described above. The suffix may not begin with `e` or `E`, as that would be interpreted as the exponent of a floating-point literal. See [Integer literal expressions](https://doc.rust-lang.org/stable/reference/expressions/literal-expr.html#integer-literal-expressions) for the effect of these suffixes.
...
A tuple index is used to refer to the fields of [tuples](https://doc.rust-lang.org/stable/reference/types/tuple.html), [tuple structs](https://doc.rust-lang.org/stable/reference/items/structs.html), and [tuple enum variants](https://doc.rust-lang.org/stable/reference/items/enumerations.html).
...
Lifetime parameters and [loop labels](https://doc.rust-lang.org/stable/reference/expressions/loop-expr.html#loop-labels) use LIFETIME\_OR\_LABEL tokens. Any LIFETIME\_TOKEN will be accepted by the lexer, and for example, can be used in macros.
...
It is an error to use the [RESERVED\_RAW\_LIFETIME](https://doc.rust-lang.org/stable/reference/tokens.html#grammar-RESERVED_RAW_LIFETIME) token.
...
**Lexer**  
[PUNCTUATION](https://doc.rust-lang.org/stable/reference/tokens.html#railroad-PUNCTUATION) →  
      ...  
    | ..=  
    | &lt;&lt;=  
    | &gt;&gt;=  
...
> Note
> 
> See the [syntax index](https://doc.rust-lang.org/stable/reference/syntax-index.html#operators-and-punctuation) for links to how punctuation characters are used.
...
The *reserved guarded string literal* is a token of one or more `U+0023` (`#`) immediately followed by a [STRING\_LITERAL](https://doc.rust-lang.org/stable/reference/tokens.html#grammar-STRING_LITERAL).
...
3. See [lex.token.literal.char-escape.unicode](https://doc.rust-lang.org/stable/reference/tokens.html#r-lex.token.literal.char-escape.unicode). [↩](#fr-valid-hex-char-1)