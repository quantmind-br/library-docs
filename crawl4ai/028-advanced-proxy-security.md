---
title: Proxy & Security - Crawl4AI Documentation (v0.8.x)
url: https://docs.crawl4ai.com/advanced/proxy-security/
source: sitemap
fetched_at: 2026-04-26T07:45:28.413235684-03:00
rendered_js: false
word_count: 325
summary: This document provides a comprehensive guide on configuring proxies and implementing proxy rotation strategies within Crawl4AI, including instructions for handling authenticated proxies and performing SSL certificate analysis.
tags:
    - proxy-configuration
    - proxy-rotation
    - ssl-verification
...
```
importasyncio
fromcrawl4aiimport AsyncWebCrawler, BrowserConfig, CrawlerRunConfig, ProxyConfig
...
```
importos
fromcrawl4aiimport ProxyConfig, CrawlerRunConfig
...
importasyncio
importre
fromcrawl4aiimport AsyncWebCrawler, BrowserConfig, CrawlerRunConfig, CacheMode, ProxyConfig
fromcrawl4ai.proxy_strategyimport RoundRobinProxyStrategy
...
```
fromcrawl4aiimport CrawlerRunConfig, ProxyConfig
fromcrawl4ai.proxy_strategyimport RoundRobinProxyStrategy
...
exportPROXIES="ip1:port1:user1:pass1,ip2:port2:user2:pass2"
```
...
defsafe_proxy_repr(proxy: ProxyConfig):
