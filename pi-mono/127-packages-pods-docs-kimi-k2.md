---
title: Kimi k2
url: https://github.com/badlogic/pi-mono/blob/main/packages/pods/docs/kimi-k2.md
source: git
fetched_at: 2026-03-03T03:46:10.271333-03:00
rendered_js: false
word_count: 1016
summary: Provides deployment commands and configuration guides for Kimi-K2 models using vLLM, SGLang, KTransformers, and TensorRT-LLM across tensor parallelism, data-parallel + expert parallelism, and multi-node setups.
tags:
    - model-deployment
    - tensor-parallelism
