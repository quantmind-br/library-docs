---
title: "null"
url: https://docs.clawd.bot/concepts/agent.md
source: llms
fetched_at: 2026-01-26T09:51:09.423486473-03:00
rendered_js: false
word_count: 645
summary: This document outlines the operational environment for Clawdbot agents, detailing workspace requirements, bootstrap file injection, and session management. It provides technical specifications for tool integration, skill loading, and model configuration within the agent runtime.
tags:
    - agent-runtime
