---
title: CompleteAndGrounded - DSPy
url: https://dspy.ai/api/evaluation/CompleteAndGrounded/
source: sitemap
fetched_at: 2026-01-23T08:01:29.22430118-03:00
rendered_js: false
word_count: 786
summary: This document provides the API reference for the CompleteAndGrounded class in DSPy, which automates the evaluation of answer completeness and groundedness using chain-of-thought modules.
tags:
    - dspy
    - evaluation
    - api-reference
...
```
def__init__(self, threshold=0.66):
    self.threshold = threshold
    self.completeness_module = ChainOfThought(AnswerCompleteness)
    self.groundedness_module = ChainOfThought(AnswerGroundedness)
```

### Functions[¶](#dspy.evaluate.CompleteAndGrounded-functions "Permanent link")

#### `__call__(*args, **kwargs) -> Prediction` [¶](#dspy.evaluate.CompleteAndGrounded.__call__ "Permanent link")
...
#### `acall(*args, **kwargs) -> Prediction` `async` [¶](#dspy.evaluate.CompleteAndGrounded.acall "Permanent link")
...
#### `deepcopy()` [¶](#dspy.evaluate.CompleteAndGrounded.deepcopy "Permanent link")
...
#### `dump_state(json_mode=True)` [¶](#dspy.evaluate.CompleteAndGrounded.dump_state "Permanent link")
...
#### `forward(example, pred, trace=None)` [¶](#dspy.evaluate.CompleteAndGrounded.forward "Permanent link")

Source code in `dspy/evaluate/auto_evaluation.py`

```
defforward(self, example, pred, trace=None):
...
#### `get_lm()` [¶](#dspy.evaluate.CompleteAndGrounded.get_lm "Permanent link")
...
#### `inspect_history(n: int = 1)` [¶](#dspy.evaluate.CompleteAndGrounded.inspect_history "Permanent link")
...
#### `load(path, allow_pickle=False)` [¶](#dspy.evaluate.CompleteAndGrounded.load "Permanent link")
...
#### `load_state(state)` [¶](#dspy.evaluate.CompleteAndGrounded.load_state "Permanent link")
...
#### `map_named_predictors(func)` [¶](#dspy.evaluate.CompleteAndGrounded.map_named_predictors "Permanent link")
...
#### `named_parameters()` [¶](#dspy.evaluate.CompleteAndGrounded.named_parameters "Permanent link")
...
#### `named_predictors()` [¶](#dspy.evaluate.CompleteAndGrounded.named_predictors "Permanent link")
...
#### `named_sub_modules(type_=None, skip_compiled=False) -> Generator[tuple[str, BaseModule], None, None]` [¶](#dspy.evaluate.CompleteAndGrounded.named_sub_modules "Permanent link")
...
#### `parameters()` [¶](#dspy.evaluate.CompleteAndGrounded.parameters "Permanent link")
...
#### `predictors()` [¶](#dspy.evaluate.CompleteAndGrounded.predictors "Permanent link")
...
#### `reset_copy()` [¶](#dspy.evaluate.CompleteAndGrounded.reset_copy "Permanent link")
...
#### `save(path, save_program=False, modules_to_serialize=None)` [¶](#dspy.evaluate.CompleteAndGrounded.save "Permanent link")
...
#### `set_lm(lm)` [¶](#dspy.evaluate.CompleteAndGrounded.set_lm "Permanent link")
