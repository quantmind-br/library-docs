...
source: llms
fetched_at: 2026-04-16T22:29:33.449532874-03:00
rendered_js: false
word_count: 1505
summary: This guide explains how to manage agent conversation history using the SDK's session persistence features, including continuing, resuming, or forking sessions.
tags:
    - session-management
    - agent-sdk
    - context-persistence
