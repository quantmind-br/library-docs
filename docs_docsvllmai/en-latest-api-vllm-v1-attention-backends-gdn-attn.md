---
title: gdn_attn - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/attention/backends/gdn_attn/
source: sitemap
fetched_at: 2026-05-07T21:39:11.195357317-03:00
rendered_js: false
word_count: 0
summary: This class implements a metadata builder for GDNAttention, managing state indices, query locations, and token masks to support speculative decoding and CUDA graph capture in vLLM.
tags:
    - vllm
    - attention-mechanism
    - cuda-graphs
...
```
classGDNAttentionMetadataBuilder(AttentionMetadataBuilder[GDNAttentionMetadata]):
    ...
    defbuild(  # type: ignore[override]
        ...
        if num_prefills > 0:
            ...
            fromvllm.model_executor.layers.fla.ops.indeximport (
                prepare_chunk_indices,
                prepare_chunk_offsets,
            )
            fromvllm.model_executor.layers.fla.ops.utilsimport FLA_CHUNK_SIZE
