---
title: stats - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/distributed/kv_transfer/kv_connector/v1/mooncake/stats/
source: sitemap
fetched_at: 2026-05-07T21:18:32.780240981-03:00
rendered_js: false
word_count: 11
summary: This document defines a thread-safe dataclass for tracking and aggregating performance metrics related to key-value store data transfers.
tags:
    - python
    - threading
    - performance-metrics
...
```
@dataclass
classMooncakeKVConnectorStats(KVConnectorStats):
"""Container for Mooncake KV transfer performance metrics.
    ...
    defrecord_transfer(self, duration_s: float, total_bytes: int, num_descs: int):
        with self._lock:
    ...
    defclone_and_reset(self) -> "MooncakeKVConnectorStats":
