---
title: UAT Issues Template
url: https://github.com/ChristopherKahler/paul/blob/main/src/templates/UAT-ISSUES.md
source: git
fetched_at: 2026-04-30T00:52:55.922900277-03:00
rendered_js: false
word_count: 288
summary: Standardized template and workflow for documenting bugs discovered during user acceptance testing.
tags:
    - uat
    - bug-tracking
    - software-testing
...
> [!note]
> Template for `.paul/phases/XX-name/{phase}-{plan}-UAT.md` — issues discovered during user acceptance testing. Unlike global ISSUES.md (for deferred enhancements), this file tracks bugs and problems in specific delivered work.
...
#uat #bug-tracking #software-testing #quality-assurance #documentation-template