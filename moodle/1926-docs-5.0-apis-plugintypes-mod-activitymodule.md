...
url: https://moodledev.io/docs/5.0/apis/plugintypes/mod/activitymodule
source: sitemap
fetched_at: 2026-02-17T15:26:18.465357-03:00
rendered_js: false
word_count: 673
summary: This document details the redesign of the Moodle activity chooser to improve course creation and provide technical specifications for plugin developers to implement new content item callbacks.
tags:
    - moodle-development
    - activity-chooser
    - course-creation
