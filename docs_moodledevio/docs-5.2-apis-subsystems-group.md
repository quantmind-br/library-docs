...
url: https://moodledev.io/docs/5.2/apis/subsystems/group
source: sitemap
fetched_at: 2026-02-17T15:46:01.48118-03:00
rendered_js: false
word_count: 1041
summary: This document explains the Moodle groups and groupings system, detailing group modes, visibility settings, and how developers can utilize the Groups API to implement group support in activities.
tags:
    - moodle-development
    - groups-api
    - group-modes
