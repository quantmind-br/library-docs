...
with open('/home/diogo/dev/library-docs/zeroclaw/FINDINGS.txt', 'w') as out:
    out.write("Searching for all .md files...\n")
    found = []
    ...
    for task_file in task_files:
        ...
        out.write(f"{task_file}: {'EXISTS' if exists else 'MISSING'}\n")
