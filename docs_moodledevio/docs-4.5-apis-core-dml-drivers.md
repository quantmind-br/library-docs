...
url: https://moodledev.io/docs/4.5/apis/core/dml/drivers
source: sitemap
fetched_at: 2026-02-17T15:11:16.562891-03:00
rendered_js: false
word_count: 151
summary: This document outlines the native database drivers supported by Moodle and provides instructions for configuring query logging features within the DML driver layer.
tags:
    - moodle
    - database-drivers
    - dml
...
- [DML functions](https://moodledev.io/docs/4.5/apis/core/dml): Where all the functions used to handle DB data ([DML](https://en.wikipedia.org/wiki/Data_Manipulation_Language)) are defined.
