...
url: https://moodledev.io/docs/5.0/apis/subsystems/output/humandate
source: sitemap
fetched_at: 2026-02-17T15:27:54.007329-03:00
rendered_js: false
word_count: 108
summary: This document explains how to use Moodle's humandate and humantimeperiod classes to display timestamps and time ranges in a human-friendly format.
tags:
    - moodle
    - php-development
    - date-formatting
