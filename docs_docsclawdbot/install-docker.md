...
source: llms
fetched_at: 2026-01-26T09:52:29.859752531-03:00
rendered_js: false
word_count: 1222
summary: This document provides instructions for setting up Clawdbot using Docker, covering both full gateway containerization and agent-specific sandboxing for tool isolation.
tags:
    - docker
    - containerization
    - sandboxing
