...
source: sitemap
fetched_at: 2026-05-07T21:16:49.818366902-03:00
rendered_js: false
word_count: 23
summary: This class serves as a wrapper for torch.compile in vLLM, specifically managing custom compilation modes, guard removal, and NVTX tracing to ensure efficient model execution.
tags:
    - torch-compile
    - vllm
    - dynamo
...
```
classTorchCompileWithNoGuardsWrapper:
"""
    ...
    def_call_with_optional_nvtx_range(
    ...
    def__init__(
        ...
        fromvllm.env_overrideimport _apply_constrain_to_fx_strides_patch
    ...
    defaot_compile(self, *args: Any, **kwargs: Any) -> Any:
    ...
    @abstractmethod
    defforward(self, *args: Any, **kwargs: Any) -> Any: ...

    deforiginal_code_object(self) -> CodeType:
"""Return the original code object of the forward method."""
        return self.__class__.forward.__code__

    defbytecode_hook(self, old_code: CodeType, new_code: CodeType) -> None:
"""Hook to save the compiled bytecode for direct execution."""
    ...
    @contextmanager
    def_dispatch_to_compiled_code(self) -> Generator[None, None, None]:
        # noqa: E501
"""
