...
url: https://moodledev.io/docs/4.5/apis/core/reportbuilder/filtering
source: sitemap
fetched_at: 2026-02-17T15:11:32.605171-03:00
rendered_js: false
word_count: 899
summary: Explains how to configure default filter values in a report datasource using the get_default_condition_values method, covering various filter types and their specific operator requirements.
tags:
    - moodle
    - report-builder
    - datasource-filters
