...
url: https://moodledev.io/docs/4.1/apis/subsystems/form/advanced/advanced-elements
source: sitemap
fetched_at: 2026-02-17T14:56:33.388277-03:00
rendered_js: false
word_count: 298
summary: This document explains how to use the setAdvanced method in Moodle's form library to hide specific form elements or entire sections until the user chooses to show them.
tags:
    - moodle-forms
    - moodle-quickform
    - setadvanced
