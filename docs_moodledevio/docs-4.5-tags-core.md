...
url: https://moodledev.io/docs/4.5/tags/core
source: sitemap
fetched_at: 2026-02-17T15:06:28.54734-03:00
rendered_js: false
word_count: 474
summary: This document provides an index and overview of Moodle's core APIs and subsystems, focusing on form creation, database manipulation, and system extensibility.
tags:
    - moodle-development
    - core-apis
    - form-api
