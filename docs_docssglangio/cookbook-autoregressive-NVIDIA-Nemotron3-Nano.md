---
title: Nemotron3-Nano - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/NVIDIA/Nemotron3-Nano
source: sitemap
fetched_at: 2026-05-11T05:50:18.018796373-03:00
rendered_js: false
word_count: 408
summary: This document provides a comprehensive guide to deploying and serving the NVIDIA Nemotron3-Nano model using the SGLang framework, including installation, configuration, API usage, and performance benchmarking.
tags:
    - sglang
    - nvidia-nemotron
    - llm-deployment
...
Refer to the [official SGLang installation guide](https://docs.sglang.io/docs/get-started/install), or install nightly wheel through:
