...
url: https://moodledev.io/docs/5.1/tags/form
source: sitemap
fetched_at: 2026-02-17T15:30:56.691398-03:00
rendered_js: false
word_count: 130
summary: This document provides an overview of the Moodle Forms API, detailing how to create accessible web forms and describing specialized components like the choice dropdown field.
tags:
    - moodle-development
    - forms-api
    - choice-dropdown
