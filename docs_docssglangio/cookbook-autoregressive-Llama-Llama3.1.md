---
title: Llama-3.1 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Llama/Llama3.1
source: sitemap
fetched_at: 2026-05-11T05:50:24.042880468-03:00
rendered_js: false
word_count: 571
summary: This document provides instructions for deploying and interacting with Llama 3.1 models using the SGLang framework, covering hardware-specific configurations, speculative decoding, and API usage.
tags:
    - sglang
    - llama-3-1
    - model-deployment
...
BasicThroughput OptimizedLatency Optimized
...
Reference: [SGLang Tool Parser Documentation](https://docs.sglang.io/docs/advanced_features/tool_parser#OpenAI-Compatible-API) **Output Example**
