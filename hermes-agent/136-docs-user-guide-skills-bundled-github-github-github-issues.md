---
title: Github Issues — Create, manage, triage, and close GitHub issues | Hermes Agent
url: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/github/github-github-issues
source: crawler
fetched_at: 2026-04-24T17:05:32.333893621-03:00
rendered_js: false
word_count: 293
summary: This document provides a comprehensive guide and reference for managing GitHub issues, detailing how to create, view, search, assign labels, comment on, close, reopen, and link issues using both the `gh` CLI and direct API calls via curl.
tags:
    - github-issues
    - api-reference
    - issue-management
...
SourceBundled (installed by default)Path`skills/github/github-issues`Version`1.1.0`AuthorHermes AgentLicenseMITTags`GitHub`, `Issues`, `Project-Management`, `Bug-Tracking`, `Triage`Related skills[`github-auth`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/github/github-github-auth), [`github-pr-workflow`](https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/github/github-github-pr-workflow)
...
```bash
gh issue list
gh issue list --stateopen--label"bug"
...
```bash
# With gh
gh issue list --label"needs-triage"--stateopen
