...
url: https://moodledev.io/docs/5.2/apis/core/comment
source: sitemap
fetched_at: 2026-02-17T15:43:14.060184-03:00
rendered_js: false
word_count: 533
summary: This document explains how to use the Moodle Comment API to manage, render, and control comment areas within various components and activities.
tags:
    - moodle
    - comment-api
    - php
