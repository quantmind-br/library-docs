...
url: https://moodledev.io/docs/5.1/guides/javascript/modules
source: sitemap
fetched_at: 2026-02-17T15:37:51.252298-03:00
rendered_js: false
word_count: 1314
summary: This document explains how to develop and implement JavaScript modules in Moodle, covering the transition from AMD to ESM formats and the associated build toolchain.
tags:
    - javascript-modules
    - moodle-development
    - esm
