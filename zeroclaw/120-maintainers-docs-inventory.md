...
url: https://github.com/openagen/zeroclaw/blob/master/docs/maintainers/docs-inventory.md
source: git
fetched_at: 2026-05-02T14:51:39.640348713-03:00
rendered_js: false
word_count: 617
summary: This document provides a comprehensive inventory and classification framework for organizing project documentation based on intent, audience, and maintenance status.
tags:
...
Classifies docs by intent so readers can quickly distinguish runtime-contract guides from design proposals.

Last reviewed: **February 18, 2026**.

## Classification Legend

- **Current Guide/Reference**: matches current runtime behavior
...
Valuable context, but **not strict runtime contracts**.
...
1. Update `commands-reference` when CLI surface changes.
...
7. Update `docs/SUMMARY.md` and collection indexes when new major docs are added.

#docs #documentation-management #classification-system #project-governance #inventory-control #developer-resources
