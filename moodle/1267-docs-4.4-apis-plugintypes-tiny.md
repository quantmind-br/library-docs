...
url: https://moodledev.io/docs/4.4/apis/plugintypes/tiny
source: sitemap
fetched_at: 2026-02-17T15:03:44.95172-03:00
rendered_js: false
word_count: 1463
summary: This document explains how to develop and structure subplugins for the TinyMCE text editor in Moodle, covering file organization, skeleton generation, and key JavaScript integration files.
tags:
    - moodle
    - tinymce
    - text-editor
