...
source: crawler
fetched_at: 2026-02-27T23:38:29.716646-03:00
rendered_js: true
word_count: 2
summary: This document provides an example of a paginated JSON response from the Spotify API, specifically detailing the structure of a collection of saved audiobooks or shows.
tags:
    - spotify-api
    - json-response
    - audiobooks
