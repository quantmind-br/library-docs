---
title: NodeJS and Grunt | Moodle Developer Resources
url: https://moodledev.io/general/development/tools/nodejs
source: sitemap
fetched_at: 2026-02-17T16:01:36.795879-03:00
rendered_js: false
word_count: 935
summary: This document provides instructions for setting up the NodeJS development environment and Grunt build tool for Moodle. It covers installing NVM, managing dependencies with NPM, and using Grunt tasks for code transpilation, linting, and plugin development.
tags:
    - moodle-development
    - nodejs
    - nvm
...
### Install NVM and Node[​](#install-nvm-and-node "Direct link to Install NVM and Node")
...
### Install local development dependencies[​](#install-local-development-dependencies "Direct link to Install local development dependencies")
...
### Install grunt[​](#install-grunt "Direct link to Install grunt")
...
### Running grunt[​](#running-grunt "Direct link to Running grunt")
...
### Install watchman[​](#install-watchman "Direct link to Install watchman")
...
### Using Grunt in additional plugins[​](#using-grunt-in-additional-plugins "Direct link to Using Grunt in additional plugins")
...
### MacOS issues[​](#macos-issues "Direct link to MacOS issues")
...
#### Issues install node-sass[​](#issues-install-node-sass "Direct link to Issues install node-sass")
