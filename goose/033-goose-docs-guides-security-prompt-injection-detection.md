---
title: Prompt Injection Detection | goose
url: https://block.github.io/goose/docs/guides/security/prompt-injection-detection
source: github_pages
fetched_at: 2026-01-22T22:14:22.661093676-03:00
rendered_js: true
word_count: 459
summary: This document explains how goose detects and prevents prompt injection attacks by scanning tool calls for risky patterns and allowing users to configure security thresholds.
tags:
    - prompt-injection
    - security-features
    - ai-safety
...
5. **You choose** whether to proceed or cancel after reviewing the alert details. Note that:
   ...
   - Each decision is logged with its finding ID in the [goose system logs](https://block.github.io/goose/docs/guides/logs#system-logs)
...
## Enabling Detection[​](#enabling-detection "Direct link to Enabling Detection")
...
- [Checks for known malware](https://block.github.io/goose/docs/troubleshooting/known-issues#malicious-package-detected) when installing extensions for locally-run MCP servers

### Configuring Detection Threshold[​](#configuring-detection-threshold "Direct link to Configuring Detection Threshold")

The threshold (0.01-1.0) controls how strict detection is:

ThresholdSensitivityUse When**0.01-0.50**Very lenientYou're experienced and understand the risks**0.50-0.70**BalancedGeneral development work (good default)**0.70-0.90**StrictWorking with sensitive data or systems**0.90-1.00**MaximumHigh-security environments
...
- [goose Permission Modes](https://block.github.io/goose/docs/guides/goose-permissions) - Control goose's autonomy level
- [Managing Tool Permissions](https://block.github.io/goose/docs/guides/managing-tools/tool-permissions) - Fine-grained tool control