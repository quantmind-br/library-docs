...
source: llms
fetched_at: 2026-01-26T09:51:09.879336534-03:00
rendered_js: false
word_count: 823
summary: This document details the end-to-end execution flow of a Clawdbot agentic loop, including session persistence, tool execution, and lifecycle event streaming. It also outlines the internal and plugin hook systems available for intercepting and extending agent behavior.
tags:
    - clawdbot
    - agent-loop
    - session-management
