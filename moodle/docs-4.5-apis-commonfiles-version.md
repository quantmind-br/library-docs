---
title: version.php | Moodle Developer Resources
url: https://moodledev.io/docs/4.5/apis/commonfiles/version.php
source: sitemap
fetched_at: 2026-02-17T15:10:53.097115-03:00
rendered_js: false
word_count: 569
summary: This document explains the purpose and configuration of the version.php file required for all Moodle plugins, detailing properties used for installation, upgrades, and compatibility checks.
tags:
    - moodle-development
...
## Plugin version properties[​](#plugin-version-properties "Direct link to Plugin version properties")

### Component[​](#component "Direct link to Component")

The component value contains the name of the plugin in its full [frankenstyle](https://moodledev.io/general/development/policies/codingstyle/frankenstyle) format.
...
The requires key specifies the minimum version of Moodle core requires for this plugin to function. It is *not* possible to install the plugin on an earlier version of Moodle.
...
Support all versions of Moodle 3.11, and 4.0
...
### Incompatible versions[​](#incompatible-versions "Direct link to Incompatible versions")
...
Specify that this version of the plugin does not support Moodle 3.11 and subsequent releases

```
$plugin->incompatible=311;
```

### Maturity[​](#maturity "Direct link to Maturity")
...
### Release name[​](#release-name "Direct link to Release name")
...
### Peer dependenices[​](#peer-dependenices "Direct link to Peer dependenices")
...
## File template[​](#file-template "Direct link to File template")
