...
source: sitemap
fetched_at: 2026-05-07T21:13:25.667405938-03:00
rendered_js: false
word_count: 519
summary: This document provides a script and instructions for serializing and deserializing vLLM models using Tensorizer, enabling high-speed model loading from local or cloud storage endpoints.
tags:
    - vllm
    - tensorizer
    - model-serialization
...
fromvllm.model_executor.model_loader.tensorizerimport (
    TensorizerArgs,
    TensorizerConfig,
...
defmerge_extra_config_with_tensorizer_config(extra_cfg: dict, cfg: TensorizerConfig):
...
defdeserialize(args, tensorizer_config):
    if args.lora_path:
