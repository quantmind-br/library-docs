...
url: https://moodledev.io/docs/4.4/apis/plugintypes/antivirus
source: sitemap
fetched_at: 2026-02-17T15:02:43.676946-03:00
rendered_js: false
word_count: 670
summary: This document explains how to develop antivirus plugins for Moodle, detailing the required file structure, mandatory files, and the implementation of the scanner class for file scanning.
tags:
    - moodle-development
    - antivirus-plugin
    - file-security
...
Some of the important files for the antivirus plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.4/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
