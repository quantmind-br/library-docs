---
title: serving - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/entrypoints/anthropic/serving/
source: sitemap
fetched_at: 2026-05-07T21:19:19.137901995-03:00
rendered_js: false
word_count: 0
summary: This document defines a handler class that converts Anthropic Messages API requests into the OpenAI Chat Completion format, enabling interoperability within a model serving framework.
tags:
    - api-integration
...
```
classAnthropicServingMessages(OpenAIServingChat):
"""Handler for Anthropic Messages API requests"""
    ...
    @staticmethod
    def_convert_image_source_to_url(source: dict[str, Any]) -> str:
"""Convert an Anthropic image source to an OpenAI-compatible URL.
    ...
    @classmethod
    def_convert_anthropic_to_openai_request(
...
"""Convert individual content block"""
    ...
    @classmethod
    def_convert_tool_use_block(cls, block, tool_calls: list[dict[str, Any]]) -> None:
...
"""
    ...
    async defmessage_stream_converter(
        self,
        generator: AsyncGenerator[str, None],
    ) -> AsyncGenerator[str, None]:
        try:

            class_ActiveBlockState:
                ...
                defstart(self, block: AnthropicContentBlock) -> None:
            ...
            defstart_block(block: AnthropicContentBlock):
                chunk = AnthropicStreamEvent(
