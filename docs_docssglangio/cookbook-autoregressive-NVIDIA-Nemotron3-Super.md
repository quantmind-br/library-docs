---
title: NVIDIA Nemotron3-Super - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/NVIDIA/Nemotron3-Super
source: sitemap
fetched_at: 2026-05-11T05:50:22.781277256-03:00
rendered_js: false
word_count: 542
summary: This document provides instructions for installing, configuring, and deploying the NVIDIA Nemotron3-Super model using the SGLang framework, including guidance on API usage and reasoning configuration.
tags:
    - sglang
    - llm-deployment
    - nemotron-3
...
- **TP support**: To set tp size, use `--tp <2|4|8>`.
