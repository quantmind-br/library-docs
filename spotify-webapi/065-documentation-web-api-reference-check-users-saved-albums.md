...
source: crawler
fetched_at: 2026-02-27T23:46:01.806364-03:00
rendered_js: true
word_count: 70
summary: This reference document details a deprecated Spotify Web API endpoint used to check if specific albums are saved in a user's library and directs users to a modern replacement.
tags:
    - spotify-api
    - web-api
    - albums
