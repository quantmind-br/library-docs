...
url: https://moodledev.io/docs/5.2/apis/subsystems/question
source: sitemap
fetched_at: 2026-02-17T15:46:18.052495-03:00
rendered_js: false
word_count: 719
summary: This document provides an overview of the Moodle question subsystem architecture, detailing how the question engine and question bank manage interactive learning experiences and question management.
tags:
    - moodle-development
    - question-engine
    - question-bank
...
[Question bank plugins (qbank\_)](https://moodledev.io/docs/5.2/apis/plugintypes/qbank) add features to the question bank. The core question bank code mainly just ties all these features together.
...
[Question types](https://moodledev.io/docs/5.2/apis/plugintypes/qtype) were already considered above, when thinking about the the question engine. They also need to work with the question bank, so that teachers can create and edit questions of that type.