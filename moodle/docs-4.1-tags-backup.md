...
url: https://moodledev.io/docs/4.1/tags/backup
source: sitemap
fetched_at: 2026-02-17T14:51:26.535666-03:00
rendered_js: false
word_count: 83
summary: This document introduces the Moodle Backup and Restore APIs, which allow developers to include and retrieve plugin-specific data during course backup and restoration processes.
tags:
    - moodle-development
    - backup-api
    - restore-api
