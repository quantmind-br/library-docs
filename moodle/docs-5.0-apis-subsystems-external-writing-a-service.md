...
url: https://moodledev.io/docs/5.0/apis/subsystems/external/writing-a-service
source: sitemap
fetched_at: 2026-02-17T15:27:25.142191-03:00
rendered_js: false
word_count: 1036
summary: This document explains how to create and define external web service functions for Moodle plugins, covering naming conventions, service declaration, and the implementation of parameter and return structures.
tags:
    - moodle-development
    - web-services
    - external-api
...
returnnewexternal_function_parameters([
'chocolatechips'=>newexternal_value(
PARAM_BOOL,
'if biscuit contains chocolate chips',
VALUE_REQUIRED
),
'glutenfree'=>newexternal_value(
type:PARAM_BOOL,
...
- [Web services developer documentation](https://moodledev.io/docs/5.0/apis/subsystems/external)
...
- [External services security](https://moodledev.io/docs/5.0/apis/subsystems/external/security)
- [External services description](https://moodledev.io/docs/5.0/apis/subsystems/external/description)
