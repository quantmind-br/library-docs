...
url: https://moodledev.io/docs/5.2/apis/subsystems/backup
source: sitemap
fetched_at: 2026-02-17T15:45:15.204463-03:00
rendered_js: false
word_count: 1061
summary: This document provides a technical overview and reference for implementing the Moodle Backup API in various plugin types, explaining the structure of backup plans, tasks, and steps. It guides developers on how to include plugin-specific data and database tables in the course backup process.
tags:
    - moodle-development
    - backup-api
    - plugin-development
...
The Backup API provides a way to include your plugin's in the course backup. See [Restore API](https://moodledev.io/docs/5.2/apis/subsystems/backup/restore) for the part that takes care of restoring data.
