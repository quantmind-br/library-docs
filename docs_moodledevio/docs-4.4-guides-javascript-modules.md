...
url: https://moodledev.io/docs/4.4/guides/javascript/modules
source: sitemap
fetched_at: 2026-02-17T15:05:27.419138-03:00
rendered_js: false
word_count: 1314
summary: This document explains how to create and use JavaScript modules in Moodle, detailing the transition from AMD to ESM format and the required development toolchain.
tags:
    - moodle-javascript
    - es-modules
    - amd-modules
