...
source: sitemap
fetched_at: 2026-04-15T09:01:17.365322771-03:00
rendered_js: false
word_count: 744
summary: This document provides a comprehensive guide to installing, configuring, and utilizing the Droid CLI, covering authentication, command navigation, autonomy modes, and system integration via custom droids and the Model Context Protocol (MCP).
tags:
    - cli-tools
    - ai-agents
    - mcp-integration
