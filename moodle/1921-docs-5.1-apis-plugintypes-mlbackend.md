...
url: https://moodledev.io/docs/5.1/apis/plugintypes/mlbackend
source: sitemap
fetched_at: 2026-02-17T15:35:09.826859-03:00
rendered_js: false
word_count: 635
summary: This document explains the integration of machine learning backends with the Moodle Analytics API, covering file-based communication, plugin architecture, and implementation of prediction interfaces.
tags:
    - moodle-development
    - machine-learning
    - analytics-api
...
Machine learning backends process the datasets generated from the indicators and targets calculated by the [Analytics API](https://moodledev.io/docs/5.1/apis/subsystems/analytics). They are used for machine learning training, prediction and models evaluation.

tip

We strongly recommend that you read the [Analytics API](https://moodledev.io/docs/5.1/apis/subsystems/analytics) documentation to help understand the core concepts, how they are implemented in Moodle, and how machine learning backend plugins fit into the analytics API.
...
Some of the important files for the mlbackend plugintype are described below. See the [common plugin files](https://moodledev.io/docs/5.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
