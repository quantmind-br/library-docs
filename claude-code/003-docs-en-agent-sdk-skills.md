...
url: https://code.claude.com/docs/en/agent-sdk/skills.md
source: llms
fetched_at: 2026-04-16T22:29:37.91291303-03:00
rendered_js: false
word_count: 769
summary: This document explains how to implement and manage Agent Skills within the Claude Agent SDK by utilizing filesystem-based artifacts for autonomous capability extension.
tags:
    - claude-agent-sdk
    - agent-skills
