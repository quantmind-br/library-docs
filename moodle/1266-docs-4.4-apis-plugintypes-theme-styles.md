---
title: Styles | Moodle Developer Resources
url: https://moodledev.io/docs/4.4/apis/plugintypes/theme/styles
source: sitemap
fetched_at: 2026-02-17T15:03:41.978312-03:00
rendered_js: false
word_count: 1355
summary: This document explains how CSS and SCSS are managed, organized, and included within Moodle themes and plugins. It provides guidance on writing effective CSS rules using Moodle's specific body classes and IDs to ensure style precedence and avoid collisions.
tags:
    - moodle-development
    - css-styles
    - scss-sass
...
## CSS pre-processors[​](#css-pre-processors "Direct link to CSS pre-processors")
...
For more information see: [SASS (wikipedia)](https://en.wikipedia.org/wiki/Sass_%28stylesheet_language%29)

## Core CSS organisation[​](#core-css-organisation "Direct link to Core CSS organisation")
...
## How to write effective CSS rules within Moodle[​](#how-to-write-effective-css-rules-within-moodle "Direct link to How to write effective CSS rules within Moodle")
...
### &lt;body&gt; CSS id and classes[​](#body-css-id-and-classes "Direct link to <body> CSS id and classes")
...
What does all of this look like in practise?
...
### Writing your rules[​](#writing-your-rules "Direct link to Writing your rules")
...
## Compiling SCSS on the fly[​](#compiling-scss-on-the-fly "Direct link to Compiling SCSS on the fly")
