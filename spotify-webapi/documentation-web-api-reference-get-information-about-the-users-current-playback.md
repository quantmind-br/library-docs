...
source: crawler
fetched_at: 2026-02-27T23:46:45.497696-03:00
rendered_js: false
word_count: 2
summary: This document provides a detailed JSON response schema for representing a user's current media playback state, including device info, track details, and playback actions.
tags:
    - api-response
    - playback-state
    - media-streaming
