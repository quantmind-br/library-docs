...
url: https://moodledev.io/docs/5.2/guides/javascript/modal
source: sitemap
fetched_at: 2026-02-17T15:47:00.326826-03:00
rendered_js: false
word_count: 609
summary: This document explains how to implement and customize modal dialogues in Moodle using JavaScript modules, covering standard modal types, accessibility features, and custom modal creation.
tags:
    - moodle
    - modal-dialogue
    - javascript
