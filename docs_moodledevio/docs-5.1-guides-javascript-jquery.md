...
url: https://moodledev.io/docs/5.1/guides/javascript/jquery
source: sitemap
fetched_at: 2026-02-17T15:37:46.796575-03:00
rendered_js: false
word_count: 371
summary: This document outlines Moodle's guidelines on using jQuery and jQuery UI, providing instructions for importing them as dependencies while emphasizing the preference for native ES6 modules.
tags:
    - moodle
    - jquery
    - jquery-ui
