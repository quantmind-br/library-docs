...
url: https://docs.sglang.io/cookbook/autoregressive/Qwen/Qwen3-Next
source: sitemap
fetched_at: 2026-05-11T05:50:06.068928288-03:00
rendered_js: false
word_count: 854
summary: This document provides an overview of the Qwen3-Next model architecture, including its hybrid attention and MoE capabilities, and instructions for deploying and invoking the model using the SGLang framework.
tags:
    - qwen3-next
    - sglang
    - llm-deployment
...
BF16Full WeightsFP8High Throughput

Thinking Capabilities

InstructGeneral PurposeThinkingReasoning / CoT
...
1. **Streaming with Thinking Process:** Qwen3-Next-80B-A3B-Thinking only supports thinking mode. Enable the reasoning parser during deployment to separate the thinking and the content sections.
...
2. **Turn off Thinking:** Qwen3-Next-80B-A3B-Instruct only supports instruct (non-thinking) mode.
...
Qwen/Qwen3-Next-80B-A3B-Instruct | Qwen/Qwen3-Next-80B-A3B-Thinking both support tool calling capabilities. Enable the tool call parser: **Python Example (without Thinking Process):** Start sglang server:
