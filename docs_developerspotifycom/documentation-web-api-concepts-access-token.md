...
source: crawler
fetched_at: 2026-02-27T23:37:58.174421-03:00
rendered_js: true
word_count: 183
summary: This document explains how to use access tokens to authenticate and authorize requests to a web API, covering the required header format and token validity periods.
tags:
    - access-token
    - authentication
    - authorization
