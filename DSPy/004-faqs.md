---
title: FAQ - DSPy
url: https://dspy.ai/faqs/
source: sitemap
fetched_at: 2026-01-23T08:01:20.241807355-03:00
rendered_js: false
word_count: 1733
summary: This document provides answers to frequently asked questions about the DSPy framework, highlighting its differences from other libraries and explaining core concepts like signatures, modules, and optimizers.
tags:
    - dspy
    - faq
...
## Is DSPy right for me? DSPy vs. other frameworks[¶](#is-dspy-right-for-me-dspy-vs-other-frameworks "Permanent link")
...
**How should I use DSPy for my task?** We wrote a [eight-step guide](https://dspy.ai/learn/) on this. In short, using DSPy is an iterative process. You first define your task and the metrics you want to maximize, and prepare a few example inputs — typically without labels (or only with labels for the final outputs, if your metric requires them). Then, you build your pipeline by selecting built-in layers (`modules`) to use, giving each layer a `signature` (input/output spec), and then calling your modules freely in your Python code. Lastly, you use a DSPy `optimizer` to compile your code into high-quality instructions, automatic few-shot examples, or updated LM weights for your LM.
...
## Deployment or Reproducibility Concerns[¶](#deployment-or-reproducibility-concerns "Permanent link")
...
## Set Verbose Level[¶](#set-verbose-level "Permanent link")
