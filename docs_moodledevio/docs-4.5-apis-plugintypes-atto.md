...
url: https://moodledev.io/docs/4.5/apis/plugintypes/atto
source: sitemap
fetched_at: 2026-02-17T15:11:51.562694-03:00
rendered_js: false
word_count: 0
summary: This document provides a boilerplate implementation for creating and configuring custom toolbar buttons within Moodle's Atto text editor using the YUI framework.
tags:
    - moodle
    - atto-editor
    - javascript
