---
title: DeepSeek-Math-V2 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/DeepSeek/DeepSeek-Math-V2
source: sitemap
fetched_at: 2026-05-11T05:50:59.924155109-03:00
rendered_js: false
word_count: 324
summary: This document provides deployment instructions and configuration guidance for running the DeepSeek-Math-V2 model using the SGLang inference framework, including examples for mathematical reasoning tasks.
tags:
    - sglang
    - deepseek-math
    - llm-deployment
...
**License:** To use DeepSeek-Math-V2, you must agree to DeepSeek’s Community License. See [LICENSE](https://huggingface.co/deepseek-ai/DeepSeek-Math-V2/blob/main/LICENSE) for details.
...
DeepSeek-Math-V2 excels at mathematical problem-solving with step-by-step reasoning. **Streaming with Thinking Process:**
