...
url: https://doc.rust-lang.org/stable/reference/const_eval.html
source: crawler
fetched_at: 2026-05-06T21:21:55.8674033-03:00
rendered_js: false
word_count: 1308
summary: This document defines the rules and constraints for constant evaluation in Rust, outlining which expressions are permitted at compile time and the requirements for constant contexts.
tags:
    - rust
    - compile-time
    - const-evaluation
...
Constant evaluation is the process of computing the result of [expressions](https://doc.rust-lang.org/stable/reference/expressions.html) during compilation. Only a subset of all expressions can be evaluated at compile-time.
...
Behaviors such as out of bounds [array indexing](https://doc.rust-lang.org/stable/reference/expressions/array-expr.html#array-and-slice-indexing-expressions) or [overflow](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#overflow) are compiler errors if the value must be evaluated at compile time (i.e. in const contexts). Otherwise, these behaviors are warnings, but will likely panic at run-time.

The following expressions are constant expressions, so long as any operands are also constant expressions and do not cause any [`Drop::drop`](https://doc.rust-lang.org/stable/reference/destructors.html) calls to be run.

- [Literals](https://doc.rust-lang.org/stable/reference/expressions/literal-expr.html).

<!--THE END-->

- [Const parameters](https://doc.rust-lang.org/stable/reference/items/generics.html).

<!--THE END-->

- [Paths](https://doc.rust-lang.org/stable/reference/expressions/path-expr.html) to [functions](https://doc.rust-lang.org/stable/reference/items/functions.html) and [constants](https://doc.rust-lang.org/stable/reference/items/constant-items.html). Recursively defining constants is not allowed.

<!--THE END-->

- Paths to [statics](https://doc.rust-lang.org/stable/reference/items/static-items.html) with these restrictions:
...
- [Tuple expressions](https://doc.rust-lang.org/stable/reference/expressions/tuple-expr.html).

<!--THE END-->

- [Array expressions](https://doc.rust-lang.org/stable/reference/expressions/array-expr.html).

<!--THE END-->

- [Struct expressions](https://doc.rust-lang.org/stable/reference/expressions/struct-expr.html).

<!--THE END-->

- [Block expressions](https://doc.rust-lang.org/stable/reference/expressions/block-expr.html), including `unsafe` and `const` blocks.
  
  - [let statements](https://doc.rust-lang.org/stable/reference/statements.html#let-statements) and thus irrefutable [patterns](https://doc.rust-lang.org/stable/reference/patterns.html), including mutable bindings
  - [assignment expressions](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#assignment-expressions)
  - [compound assignment expressions](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#compound-assignment-expressions)
  - [expression statements](https://doc.rust-lang.org/stable/reference/statements.html#expression-statements)

<!--THE END-->

- [Field expressions](https://doc.rust-lang.org/stable/reference/expressions/field-expr.html).

<!--THE END-->

- [Array and slice indexing expressions](https://doc.rust-lang.org/stable/reference/expressions/array-expr.html#array-and-slice-indexing-expressions), where the index is a `usize`.
...
- [Closure expressions](https://doc.rust-lang.org/stable/reference/expressions/closure-expr.html) which don’t capture variables from the environment.

<!--THE END-->

- Built-in [negation](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#negation-operators), [arithmetic](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#arithmetic-and-logical-binary-operators), [logical](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#arithmetic-and-logical-binary-operators), [comparison](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#comparison-operators) or [lazy boolean](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#lazy-boolean-operators) operators used on integer and floating point types, `bool`, and `char`.

<!--THE END-->

- All forms of [borrow](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#borrow-operators)s, including raw borrows, except borrows of expressions whose temporary scopes would be extended (see [temporary lifetime extension](https://doc.rust-lang.org/stable/reference/destructors.html#r-destructors.scope.lifetime-extension)) to the end of the program and which are either:
  
  - Mutable borrows.
  - Shared borrows of expressions that result in values with [interior mutability](https://doc.rust-lang.org/stable/reference/interior-mutability.html).
  ...
  > ```
  > 
  > A place expression is *indirect* if it is a [dereference expression](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#r-expr.deref).
  > 
  > ```rust
  > #![allow(unused)]
  fn main() {
...
- [Dereference expressions](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#r-expr.deref).
...
- [Grouped](https://doc.rust-lang.org/stable/reference/expressions/grouped-expr.html) expressions.

<!--THE END-->

- [Cast](https://doc.rust-lang.org/stable/reference/expressions/operator-expr.html#type-cast-expressions) expressions, except
...
- Calls of [const functions](https://doc.rust-lang.org/stable/reference/items/functions.html#const-functions) and const methods.

<!--THE END-->

- [loop](https://doc.rust-lang.org/stable/reference/expressions/loop-expr.html#infinite-loops) and [while](https://doc.rust-lang.org/stable/reference/expressions/loop-expr.html#predicate-loops) expressions.

<!--THE END-->

- [if](https://doc.rust-lang.org/stable/reference/expressions/if-expr.html#if-expressions) and [match](https://doc.rust-lang.org/stable/reference/expressions/match-expr.html) expressions.
...
- [Array type length expressions](https://doc.rust-lang.org/stable/reference/types/array.html)

[\[const-eval.const-context.repeat-length\]](#r-const-eval.const-context.repeat-length "const-eval.const-context.repeat-length")

- [Array repeat length expressions](https://doc.rust-lang.org/stable/reference/expressions/array-expr.html)

[\[const-eval.const-context.init\]](#r-const-eval.const-context.init "const-eval.const-context.init")

- The initializer of
  
  - [constants](https://doc.rust-lang.org/stable/reference/items/constant-items.html)
  - [statics](https://doc.rust-lang.org/stable/reference/items/static-items.html)
  - [enum discriminants](https://doc.rust-lang.org/stable/reference/items/enumerations.html#discriminants)

[\[const-eval.const-context.generic\]](#r-const-eval.const-context.generic "const-eval.const-context.generic")

- A [const generic argument](https://doc.rust-lang.org/stable/reference/items/generics.html#const-generics)

[\[const-eval.const-context.block\]](#r-const-eval.const-context.block "const-eval.const-context.block")

- A [const block](https://doc.rust-lang.org/stable/reference/expressions/block-expr.html#const-blocks)
...
A *const function* is a function that can be called from a const context. It is defined with the `const` qualifier, and also includes [tuple struct](https://doc.rust-lang.org/stable/reference/items/structs.html) and [tuple enum variant](https://doc.rust-lang.org/stable/reference/items/enumerations.html) constructors.
...
Const functions are not allowed to be [async](https://doc.rust-lang.org/stable/reference/items/functions.html#async-functions).
