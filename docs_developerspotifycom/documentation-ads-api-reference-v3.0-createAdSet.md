...
url: https://developer.spotify.com/documentation/ads-api/reference/v3.0/createAdSet
source: crawler
fetched_at: 2026-02-27T23:39:28.686436-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response for an advertisement ad set, detailing its configuration, budget, and targeting parameters.
tags:
    - ad-set
    - api-response
