...
source: crawler
fetched_at: 2026-02-27T23:38:01.778384-03:00
rendered_js: true
word_count: 950
summary: This document defines the authorization scopes for the Spotify Web API, detailing the specific permissions required to access different user data and playback features.
tags:
    - spotify-api
