...
source: llms
fetched_at: 2026-04-16T22:31:19.805263421-03:00
rendered_js: false
word_count: 2831
summary: This document explains the functionality, setup, and management of Claude Code Review, an automated multi-agent system for analyzing GitHub pull requests to identify logic errors and security vulnerabilities.
tags:
    - code-review
    - github-integration
    - automated-testing
