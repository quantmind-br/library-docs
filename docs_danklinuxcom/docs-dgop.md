...
source: sitemap
fetched_at: 2026-01-24T13:34:10.663365136-03:00
rendered_js: false
word_count: 155
summary: dgop is a stateless system and process monitoring tool that provides performance metrics through a TUI, CLI, and REST API.
tags:
    - system-monitoring
    - process-status
    - tui
