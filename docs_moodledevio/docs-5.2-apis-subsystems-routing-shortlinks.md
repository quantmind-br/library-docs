...
url: https://moodledev.io/docs/5.2/apis/subsystems/routing/shortlinks
source: sitemap
fetched_at: 2026-02-17T15:46:24.808132-03:00
rendered_js: false
word_count: 273
summary: This document explains the implementation and management of shortlinks in Moodle, covering URL structures, public versus private link generation, and the creation of custom shortlink handlers.
tags:
    - moodle-development
    - shortlinks
    - routing-system
...
- [Routing](https://moodledev.io/docs/5.2/apis/subsystems/routing)