...
url: https://docs.yasb.dev/latest/styling
source: crawler
fetched_at: 2026-02-23T05:17:53.07213-03:00
rendered_js: false
word_count: 540
summary: YASB Reborn is a modern, customizable status bar for the Linux desktop environment that offers advanced features such as battery and network indicators, system monitoring, and user-defined widgets. Designed for KDE Plasma but extensible to other environments via Python bindings.
tags:
    - status bar
    - KDE Plasma
    - Linux desktop
...
```
label:"<spanclass=\"icon-1"\">\uf4bc</span>{virtual_mem_free}"
```
...
> **Note:** Keep in mind that YASB is written in Python and styled with very limited CSS. You can't use CSS3 or any other advanced CSS features.
...
> **Note**: If you want to have different menu styles for each widget please refer to the Widget documentation for more information on how to achieve this.
...
![Character Map UWP](https://docs.yasb.dev/latest/assets/361286571-e6e1654b-34c7-484f-961c-ace25cb50286.png)