...
source: llms
fetched_at: 2026-02-05T21:41:46.522710621-03:00
rendered_js: false
word_count: 681
summary: This document explains how to use the /review command to perform AI-powered code analysis on uncommitted changes, branches, or specific commits. It details the various review modes, severity levels, and the criteria used to generate actionable feedback.
tags:
    - code-review
    - ai-review
    - droid-commands
