...
url: https://moodledev.io/docs/5.2/apis/plugintypes/ai/provider
source: sitemap
fetched_at: 2026-02-17T15:43:52.456225-03:00
rendered_js: false
word_count: 1045
summary: This document explains how to develop and implement Provider plugins for the Moodle AI subsystem, detailing the required class structures, methods, and communication flow through the AI manager.
tags:
    - moodle-development
    - ai-subsystem
    - provider-plugins
