---
title: "null"
url: https://docs.clawd.bot/channels/discord.md
source: llms
fetched_at: 2026-01-26T09:50:12.502109716-03:00
rendered_js: false
word_count: 2218
summary: This document provides a comprehensive guide for integrating Clawdbot with Discord, covering bot creation, token configuration, and channel management policies. It explains how to set up the official Discord gateway, manage user permissions, and configure both direct messages and guild channel interactions.
tags:
    - discord-api
    - bot-integration
    - clawdbot-setup
