...
url: https://moodledev.io/docs/4.5/apis/core/clock
source: sitemap
fetched_at: 2026-02-17T15:11:00.472789-03:00
rendered_js: false
word_count: 451
summary: This document explains how to implement the PSR-20 compatible Clock interface in Moodle using dependency injection to replace the standard time function. It details how this approach improves unit testing by allowing developers to mock frozen or incrementing time states.
tags:
    - psr-20
