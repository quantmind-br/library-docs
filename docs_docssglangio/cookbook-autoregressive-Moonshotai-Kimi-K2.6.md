---
title: Kimi-K2.6 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Moonshotai/Kimi-K2.6
source: sitemap
fetched_at: 2026-05-11T05:50:18.025905759-03:00
rendered_js: false
word_count: 911
summary: This document provides technical instructions for deploying and interacting with the Kimi-K2.6 multimodal AI model using SGLang, including hardware requirements, configuration tips for specific GPU architectures, and API usage patterns.
tags:
    - sglang
    - kimi-k2-6
    - multimodal
...
BenchmarkScoreHLE w/ tools54.0SWE-Bench Pro58.6SWE-bench Multilingual76.7BrowseComp83.2Toolathlon50.0AIME 202696.4GPQA-Diamond90.5LiveCodeBench89.6
...
**License:** Modified MIT For details, see [official documentation](https://huggingface.co/moonshotai/Kimi-K2.6) and [tech blog](https://kimi.com/blog/kimi-k2-6).

## 2. SGLang Installation

Refer to the [official SGLang installation guide](https://docs.sglang.io/docs/get-started/install).
...
H200B200B300GB200GB300MI300XMI325XMI350XMI355X
...
DisabledLow LatencyEnabledHigh Throughput
...
- Settings: temperature=1.0, max\_tokens=64,000, concurrency=256
...
MetricValueSuccess Rate99.95% (1999/2000)Tool Call Triggered970Tool Call Valid89.6% (869/970)Tool Call Invalid (schema error)10.4% (101/970)
...
- Settings: temperature=1.0, top\_p=0.95, max\_tokens=131,072, 32 seeds
...
Evaluation ModeAccuracypass@1 (avg-of-32)98.9% (29.7/30)**majority@32****100.0% (30/30)**pass@32100.0%
...
- Settings: temperature=1.0, top\_p=0.95, max\_tokens=131,072, 4 epochs, cot=True
...
Evaluation ModeAccuracypass@1 (avg across epochs)**96.9%**

EpochAccuracy196.4% (160/166)296.9% (156/161)396.9% (155/160)498.5% (65/66)
...
- Settings: max\_tokens=4,096, thinking mode enabled (opensource)
...
Evaluation ModeAccuracypass@1**90.8%**
...
- Evaluation Tool: [Kimi-Vendor-Verifier](https://github.com/MoonshotAI/Kimi-Vendor-Verifier) (inspect-ai based)
- Settings: max\_tokens=32,768, thinking mode (default), max\_connections=256
...
Evaluation ModeAccuracypass@1**82.2%**
