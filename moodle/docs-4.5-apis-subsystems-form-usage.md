...
url: https://moodledev.io/docs/4.5/apis/subsystems/form/usage
source: sitemap
fetched_at: 2026-02-17T15:14:28.781927-03:00
rendered_js: false
word_count: 488
summary: This document provides an overview of Moodle's Form API, detailing how to create, define, and process web forms within the Moodle framework using the moodleform class.
tags:
    - moodle
    - form-api
    - php
