...
url: https://moodledev.io/docs/4.5/apis/commonfiles
source: sitemap
fetched_at: 2026-02-17T15:10:47.550757-03:00
rendered_js: false
word_count: 2704
summary: This document outlines the mandatory and optional files within Moodle plugins and subsystems, explaining their roles in versioning, localization, global functions, and database schema management.
tags:
    - moodle-development
    - plugin-structure
    - version-control
...
This page describes the common files which may be present in any Moodle subsystem or [plugin type](https://moodledev.io/docs/4.5/apis/plugintypes). Some of these files are mandatory and **must** exist within a component, whilst others are optional.
...
See the [Upgrade API](https://moodledev.io/docs/4.5/guides/upgrade) documentation for further information.
...
The [install.xml](https://moodledev.io/docs/4.5/apis/commonfiles#dbinstallxml) schema must match the schema generated by the upgrade at all times.
...
See the [Upgrade API](https://moodledev.io/docs/4.5/guides/upgrade) documentation for more information on the upgrade process.
...
See the [Message API](https://moodledev.io/docs/4.5/apis/core/message) documentation for further information.
...
See [db/tasks.php](https://moodledev.io/docs/4.5/apis/commonfiles/db-tasks.php) for full details of the file format.
...
Full details on how to create settings are available in the [Admin settings](https://moodledev.io/docs/4.5/apis/subsystems/admin) documentation.
...
The [Moodle JavaScript Guide](https://moodledev.io/docs/4.5/guides/javascript) has detailed information and examples on writing JavaScript in Moodle. Further information is also available in the [JavaScript Modules](https://moodledev.io/docs/4.5/guides/javascript/modules) documentation.
...
In older versions of Moodle, JavaScript was written in the YUI format. This is being phased out in favour of [JavaScript Modules](https://moodledev.io/docs/4.5/guides/javascript/modules), although some older uses still remain in Moodle core.

- [YUI/Modules](https://moodledev.io/docs/4.5/guides/javascript/yui/modules)
- [YUI](https://moodledev.io/docs/4.5/guides/javascript/yui)

caution

New YUI code will not be accepted into Moodle core, except for new plugins for the [Atto editor](https://moodledev.io/docs/4.5/apis/plugintypes/atto).
...
- [Plugin types](https://moodledev.io/docs/4.5/apis/plugintypes) - list of all supported plugin types
