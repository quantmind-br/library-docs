...
url: https://moodledev.io/docs/4.1/apis/core/calendar
source: sitemap
fetched_at: 2026-02-17T14:54:39.942284-03:00
rendered_js: false
word_count: 1799
summary: This document explains how to use the Moodle Calendar API to programmatically create, update, and delete events, as well as how to implement action events for dashboard integration.
tags:
    - moodle-api
    - calendar-events
    - event-management
