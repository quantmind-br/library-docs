---
title: Llama 4 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Llama/Llama4
source: sitemap
fetched_at: 2026-05-11T05:50:26.9993028-03:00
rendered_js: false
word_count: 399
summary: This document provides a guide for deploying and benchmarking Meta's Llama 4 models using the SGLang inference framework, including installation steps, server launch commands, and performance test results.
tags:
    - sglang
    - llama-4
    - llm-deployment
...
Test Environment: Hardware: AMD MI300x GPU Model: Llama-4-Scout Tensor Parallelism: 8 sglang version: 0.5.9
...
Test Environment: Hardware: AMD MI300x GPU Model: Llama-4-Maverick Tensor Parallelism: 8 sglang version: 0.5.9
