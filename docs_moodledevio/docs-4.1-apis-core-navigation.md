...
url: https://moodledev.io/docs/4.1/apis/core/navigation
source: sitemap
fetched_at: 2026-02-17T14:54:57.758692-03:00
rendered_js: false
word_count: 1866
summary: This document explains the architecture and implementation of the Moodle Navigation API, detailing how the system manages site structure, settings, and breadcrumbs through the global page object.
tags:
    - moodle-development
    - navigation-api
    - php
