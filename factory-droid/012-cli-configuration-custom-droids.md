...
source: sitemap
fetched_at: 2026-04-15T09:00:40.290035256-03:00
rendered_js: false
word_count: 1262
summary: This document explains how to create, configure, and manage custom droids, which are reusable subagents defined as Markdown files to perform focused tasks within the development environment.
tags:
    - subagents
    - cli-configuration
    - automation
...
- **Choose models strategically** – use `inherit` to match the parent session, or specify a different model for specialized tasks:
  ...
  - See the [plans page](https://docs.factory.ai/pricing#available-models) for available model IDs.
