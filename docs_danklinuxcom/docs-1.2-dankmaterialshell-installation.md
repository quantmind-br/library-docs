...
url: https://danklinux.com/docs/1.2/dankmaterialshell/installation
source: sitemap
fetched_at: 2026-02-22T18:42:59.104959-03:00
rendered_js: false
word_count: 902
...
For pre-built packages on Fedora, Debian, Ubuntu, and OpenSUSE, see the [DankLinux Repository](https://danklinux.com/docs/1.2/danklinux) page.
...
Visit the [DankLinux Repository](https://danklinux.com/docs/1.2/danklinux) page for OBS and PPA links and more information about available packages.  
...
3. Configure your compositor keybinds - see the [Keybinds & IPC](https://danklinux.com/docs/1.2/dankmaterialshell/keybinds-ipc) guide
4. Customize appearance via [Themes](https://danklinux.com/docs/1.2/dankmaterialshell/application-themes)
5. Extend functionality with [Plugins](https://danklinux.com/docs/1.2/dankmaterialshell/plugins-overview)

See [Managing Your Installation](https://danklinux.com/docs/1.2/dankmaterialshell/managing) for detailed guidance on service management, environment variables, and updates.

### Systemd Integration (Recommended)[​](#systemd-integration-recommended "Direct link to Systemd Integration (Recommended)")

DankInstall Users

If you used [dankinstall](https://danklinux.com/docs/1.2/dankinstall), this is already configured. The installer runs `systemctl --user enable --now dms` during setup.
