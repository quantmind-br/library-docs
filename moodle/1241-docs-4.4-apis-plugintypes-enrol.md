...
url: https://moodledev.io/docs/4.4/apis/plugintypes/enrol
source: sitemap
fetched_at: 2026-02-17T15:03:00.407585-03:00
rendered_js: false
word_count: 1683
summary: This document outlines the architecture and implementation requirements for Moodle enrolment plugins, detailing the necessary file structure, base classes, and database interaction.
tags:
    - moodle-development
    - enrolment-plugins
    - plugin-architecture
...
- [Enrolment API](https://moodledev.io/docs/4.4/apis/subsystems/enrol)