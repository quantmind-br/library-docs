...
source: git
fetched_at: 2026-03-03T03:40:48.102003-03:00
rendered_js: false
word_count: 986
summary: Explains how to configure JSON settings for Pi’s AI agent, detailing global vs. project-level overrides, customizable thinking budgets, retries, message handling, and resource loading paths for themes, skills, and packages.
tags:
    - ai-agent
    - json-settings
    - pi-agent
