---
title: xpu - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/platforms/xpu/
source: sitemap
fetched_at: 2026-05-07T21:34:35.898757766-03:00
rendered_js: false
word_count: 19
summary: This document defines the XPUPlatform class, which manages hardware-specific configuration, device interactions, and attention backend selection for Intel XPU devices within the vLLM framework.
tags:
    - intel-xpu
    - vllm
...
classXPUPlatform(Platform):
    ...
    defget_attn_backend_cls(
        ...
        fromvllm.v1.attention.backends.utilsimport set_kv_cache_layout
...
"""
    ...
    @classmethod
    defis_pin_memory_available(cls):
        return True
    ...
    @classmethod
    defis_data_center_gpu(cls) -> bool:
        device_name = cls.get_device_name().lower()
        return device_name.count("data center gpu") > 0

    @classmethod
    defget_device_communicator_cls(cls) -> str:
        fromvllm.utils.torch_utilsimport supports_xccl
