---
title: Version policy - Pydantic AI
url: https://ai.pydantic.dev/version-policy/
source: sitemap
fetched_at: 2026-01-22T22:23:47.609170091-03:00
rendered_js: false
word_count: 377
summary: This document outlines the versioning policy for Pydantic AI, detailing rules for breaking changes, beta feature stability, and the lifecycle for supporting Python versions.
tags:
    - version-policy
...
- Adding new [message parts](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages), [stream events](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.AgentStreamEvent "AgentStreamEvent            module-attribute   "), or optional fields on existing message (part) and event types. Always code defensively when consuming message parts or event streams, and use the [`ModelMessagesTypeAdapter`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ModelMessagesTypeAdapter "ModelMessagesTypeAdapter            module-attribute   ") to (de)serialize message histories.
