...
url: https://moodledev.io/docs/5.1/tags/external
source: sitemap
fetched_at: 2026-02-17T15:30:41.344084-03:00
rendered_js: false
word_count: 149
summary: This document provides an overview of Moodle's web service framework, detailing how to declare, define, secure, and test external services for integration with external systems.
tags:
    - moodle-development
    - external-services
    - web-api
