...
url: https://moodledev.io/docs/5.1/apis/plugintypes/atto
source: sitemap
fetched_at: 2026-02-17T15:34:50.119174-03:00
rendered_js: false
word_count: 0
summary: This document provides a JavaScript template for creating and registering a custom media button within the Moodle Atto text editor.
tags:
    - moodle
    - atto-editor
    - javascript
