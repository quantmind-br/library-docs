...
source: llms
fetched_at: 2026-04-16T22:35:42.243908201-03:00
rendered_js: false
word_count: 896
summary: This document introduces the /ultrareview command in Claude Code, explaining how it uses a remote multi-agent fleet to perform deep code reviews for bug verification. It covers execution methods, pricing models based on extra usage, and comparison with local review features.
tags:
    - claude-code
    - bug-finding
    - cli-commands
