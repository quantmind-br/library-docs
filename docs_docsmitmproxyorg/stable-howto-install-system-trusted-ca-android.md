...
source: crawler
fetched_at: 2026-01-28T15:01:18.186976986-03:00
rendered_js: false
word_count: 1226
summary: This document provides a step-by-step guide on how to install mitmproxy's CA certificate into the system certificate store on an Android emulator to intercept and monitor app traffic.
tags:
    - android-emulator
    - mitmproxy
    - ca-certificate
