...
source: sitemap
fetched_at: 2026-05-11T05:48:21.862122392-03:00
rendered_js: false
word_count: 110
summary: This document provides instructions and configuration examples for deploying large language models using SGLang in multi-node environments, including setups for manual node distribution and SLURM cluster management.
tags:
...
- [DeepSeek V3/R1](#deepseek-v3%2Fr1)
...
Please refer to [DeepSeek documents for reference](https://docs.sglang.io/docs/basic_usage/deepseek_v3#running-examples-on-multi-node).
...
Then, you can test the server by sending requests following other [documents](https://docs.sglang.io/docs/basic_usage/openai_api_completions). Thanks for [aflah02](https://github.com/aflah02) for providing the example, based on his [blog post](https://aflah02.substack.com/p/multi-node-llm-inference-with-sglang).