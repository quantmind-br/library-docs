---
title: "null"
url: https://docs.clawd.bot/tools/slash-commands.md
source: llms
fetched_at: 2026-01-26T09:54:22.145223443-03:00
rendered_js: false
word_count: 1223
summary: This document outlines the slash command and directive system, detailing how commands are parsed, handled across various platforms, and configured within the system. It provides a comprehensive reference of available text and native commands for managing bot sessions, tools, and configurations.
tags:
    - slash-commands
    - bot-configuration
    - chat-directives
