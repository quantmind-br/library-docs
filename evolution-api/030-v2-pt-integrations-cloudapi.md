---
title: WhatsApp Cloud API - Evolution API Documentation
url: https://doc.evolution-api.com/v2/pt/integrations/cloudapi
source: sitemap
fetched_at: 2026-04-12T18:45:41.077005671-03:00
rendered_js: false
word_count: 575
summary: This document outlines the complete process for integrating an application with the official WhatsApp Cloud API using the Evolution API v2. It details prerequisite steps involving Facebook Business Manager and Developer setup, followed by the specific API calls required to create an instance and configure webhooks.
tags:
    - whatsapp-api
    - cloud-api
    - integration-guide
...
Com a instância criada e o webhook configurado, a sua Evolution API v2 está pronta para operar com a Cloud API oficial do WhatsApp. Todas as mensagens e eventos relacionados ao número configurado serão gerenciados automaticamente pela Evolution API. Esta documentação fornece uma visão clara e detalhada de como integrar a Cloud API do WhatsApp com a Evolution API v2, desde a preparação necessária até a configuração final. Se você seguir todas as etapas, estará preparado para utilizar as funcionalidades do WhatsApp em sua aplicação através da Evolution API v2.