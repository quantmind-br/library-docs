...
source: llms
fetched_at: 2026-04-16T22:28:41.296066549-03:00
rendered_js: false
word_count: 2135
summary: This guide explains how to define, register, and manage custom tools using the Claude Agent SDK's in-process MCP server. It provides technical details on input schemas, handlers, error handling, and returning diverse content types like text or images.
tags:
    - claude-agent-sdk
    - mcp-server
    - custom-tools
