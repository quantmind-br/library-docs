...
url: https://moodledev.io/docs/4.5/apis/commonfiles/db-tasks.php
source: sitemap
fetched_at: 2026-02-17T15:10:49.769823-03:00
rendered_js: false
word_count: 318
summary: This document explains how to define and configure scheduled tasks for Moodle plugins using the tasks.php file and specific scheduling properties.
tags:
    - moodle
    - scheduled-tasks
    - plugin-development
