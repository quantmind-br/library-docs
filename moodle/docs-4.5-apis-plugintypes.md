...
url: https://moodledev.io/docs/4.5/apis/plugintypes
source: sitemap
fetched_at: 2026-02-17T15:11:36.632966-03:00
rendered_js: false
word_count: 883
summary: This document provides an overview of Moodle's plugin system, detailing naming conventions, validation rules, and the various plugin types available for extending the platform.
tags:
    - moodle-development
    - plugin-architecture
    - naming-conventions
...
Although there are many different types of plugin, there are some things that work the same way in all plugin types. Please see the [Plugin files](https://moodledev.io/docs/4.5/apis/commonfiles) documentation that describes common files which are found in many plugin types.
