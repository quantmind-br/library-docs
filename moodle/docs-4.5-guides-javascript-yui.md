...
url: https://moodledev.io/docs/4.5/guides/javascript/yui
source: sitemap
fetched_at: 2026-02-17T15:15:56.724455-03:00
rendered_js: false
word_count: 888
summary: This document explains how Moodle utilizes the YUI framework for JavaScript development, covering modular architecture, development tools like Grunt and JSHint, and specific configuration settings for debugging.
tags:
    - moodle-development
    - yui-framework
    - javascript-modules
...
Moodle uses [Grunt](https://moodledev.io/docs/4.5/guides/javascript#grunt) for most JavaScript management. We recommend reading our Grunt documentation for further information on the available commands.
...
- [JavaScript Modules](https://moodledev.io/docs/4.5/guides/javascript/modules)
- [jQuery](https://moodledev.io/docs/4.5/guides/javascript/jquery)
