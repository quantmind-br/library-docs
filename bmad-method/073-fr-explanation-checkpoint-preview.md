...
url: https://docs.bmad-method.org/fr/explanation/checkpoint-preview/
source: sitemap
fetched_at: 2026-04-08T11:30:19.333122462-03:00
rendered_js: false
word_count: 1187
summary: This document describes 'bmad-checkpoint-preview,' an LLM-assisted workflow designed to improve the human review of complex code changes by structuring the review process for better comprehension than simple diff viewing. It guides reviewers through understanding intent, design choices, and high-risk areas sequentially.
tags:
    - code-review
    - llm-assistance
    - workflow-guide
