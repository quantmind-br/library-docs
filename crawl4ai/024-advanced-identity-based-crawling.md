---
title: Identity Based Crawling - Crawl4AI Documentation (v0.8.x)
url: https://docs.crawl4ai.com/advanced/identity-based-crawling/
source: sitemap
fetched_at: 2026-04-26T07:45:18.672848711-03:00
rendered_js: false
word_count: 1230
summary: This document explains how to use Crawl4AI's managed browsers and Magic Mode to maintain persistent digital identities or simulate human-like browsing for web scraping tasks.
tags:
    - crawl4ai
    - web-scraping
    - browser-automation
...
```
python-mplaywrightinstall--dry-run
```

or

```
playwrightinstall--dry-run
```
...
```
importasyncio
fromcrawl4aiimport BrowserProfiler

async defmanage_profiles():
...
```
importasyncio
fromcrawl4aiimport BrowserProfiler, AsyncWebCrawler, BrowserConfig

# Define a function to use a profile for crawling
async defcrawl_with_profile(profile_path, url):
    browser_config = BrowserConfig(
        headless=True,
        use_managed_browser=True,
        user_data_dir=profile_path
...
```
fromcrawl4ai.browser_managerimport ManagedBrowser
...
```
fromcrawl4aiimport AsyncWebCrawler, CrawlerRunConfig, GeolocationConfig
