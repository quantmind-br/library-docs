...
url: https://moodledev.io/docs/4.1/apis/subsystems/backup/restore
source: sitemap
fetched_at: 2026-02-17T14:55:59.282833-03:00
rendered_js: false
word_count: 296
summary: This document explains how to implement the Restore API in Moodle plugins to recover data from backup files using restore plans, tasks, and steps.
tags:
    - moodle
    - restore-api
    - plugin-development
