---
title: GLM-4.6V - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/GLM/GLM-4.6V
source: sitemap
fetched_at: 2026-05-11T05:50:47.222442185-03:00
rendered_js: false
word_count: 638
summary: This document provides an overview of the GLM-4.6V multimodal model series, including installation procedures for SGLang, deployment configuration tips, and API examples for image and video processing.
tags:
    - multimodal
    - glm-4-6v
    - sglang
...
For general installation instructions, you can also refer to the [official SGLang installation guide](https://docs.sglang.io/docs/get-started/install).
...
- For more detailed configuration tips, please refer to [GLM-4.5V/GLM-4.6V Usage](https://docs.sglang.io/docs/basic_usage/glmv).
