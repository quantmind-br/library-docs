---
title: hyperclovax_vision_v2 - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/models/hyperclovax_vision_v2/
source: sitemap
fetched_at: 2026-05-07T21:30:51.031625124-03:00
rendered_js: false
word_count: 259
summary: This document describes the implementation of the HyperCLOVAX V2 vision-language model within the vLLM framework, including its use of the Qwen2.5 vision encoder and memory profiling utilities.
tags:
    - vllm
    - hyperclovax
...
## HCXVisionV2DummyInputsBuilder [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2DummyInputsBuilder "Permanent link")

Bases: `BaseDummyInputsBuilder[HCXVisionV2ProcessingInfo]`
...
```
classHCXVisionV2DummyInputsBuilder(BaseDummyInputsBuilder[HCXVisionV2ProcessingInfo]):
"""Dummy inputs builder for HyperCLOVAX V2 memory profiling."""
...
### get\_dummy\_processor\_inputs [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2DummyInputsBuilder.get_dummy_processor_inputs "Permanent link")
...
## HCXVisionV2ForCausalLM [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2ForCausalLM "Permanent link")
...
classHCXVisionV2ForCausalLM(nn.Module, SupportsMultiModal, SupportsPP):
"""
    HyperCLOVAX-SEED Vision-Language Model (V2 architecture).
...
### \_process\_image\_input [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2ForCausalLM._process_image_input "Permanent link")
...
### \_process\_video\_input [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2ForCausalLM._process_video_input "Permanent link")
...
## HCXVisionV2ImageEmbeddingInputs [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2ImageEmbeddingInputs "Permanent link")
...
```
classHCXVisionV2ImageEmbeddingInputs(TensorSchema):
"""
    V2 Image embedding inputs.
...
## HCXVisionV2ImagePixelInputs [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2ImagePixelInputs "Permanent link")

Bases: `TensorSchema`

V2 Image inputs using Qwen2.5-VL style grid\_thw format.
...
```
classHCXVisionV2ImagePixelInputs(TensorSchema):
"""
...
## HCXVisionV2MultiModalProcessor [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2MultiModalProcessor "Permanent link")

Bases: `BaseMultiModalProcessor[HCXVisionV2ProcessingInfo]`
...
```
classHCXVisionV2MultiModalProcessor(
...
## HCXVisionV2ProcessingInfo [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2ProcessingInfo "Permanent link")
...
```
classHCXVisionV2ProcessingInfo(BaseProcessingInfo):
"""Processing info for HyperCLOVAX V2 (32B Think model)."""
...
## HCXVisionV2VideoEmbeddingInputs [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2VideoEmbeddingInputs "Permanent link")
...
```
classHCXVisionV2VideoEmbeddingInputs(TensorSchema):
"""
    V2 Video embedding inputs.
...
## HCXVisionV2VideoPixelInputs [¶](#vllm.model_executor.models.hyperclovax_vision_v2.HCXVisionV2VideoPixelInputs "Permanent link")

Bases: `TensorSchema`

V2 Video inputs using Qwen2.5-VL style grid\_thw format.

Dimensions

- np: Number of patches
- nv: Number of videos
- ctps: Number of channels * temporal\_patch\_size * patch\_size * patch\_size

Source code in `vllm/model_executor/models/hyperclovax_vision_v2.py`

```
classHCXVisionV2VideoPixelInputs(TensorSchema):
"""
