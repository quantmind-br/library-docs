...
url: https://moodledev.io/docs/4.5/guides/javascript/ajax
source: sitemap
fetched_at: 2026-02-17T15:15:44.610778-03:00
rendered_js: false
word_count: 592
summary: This guide explains how to implement AJAX interactions in Moodle using the core/ajax JavaScript module to interact with the Web Service API. It covers service definition in PHP, repository patterns for JavaScript, and security considerations such as data filtering and session requirements.
tags:
    - moodle-development
    - ajax
    - web-services
