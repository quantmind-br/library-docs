---
title: New Quiz Items | Instructure Developer Documentation Portal
url: https://developerdocs.instructure.com/services/canvas/resources/new_quiz_items
source: sitemap
fetched_at: 2026-02-15T09:10:02.61581-03:00
rendered_js: false
word_count: 1233
summary: This document provides the API specification for managing and interacting with individual items within Canvas New Quizzes, including questions, stimuli, and question banks. It details the data structures and endpoints required to retrieve and create quiz content.
tags:
    - canvas-lms
    - new-quizzes
    - quiz-items
...
Returns a [QuizItem](https://developerdocs.instructure.com/services/canvas/resources/new_quiz_items#quizitem) object.
...
Returns a list of [QuizItem](https://developerdocs.instructure.com/services/canvas/resources/new_quiz_items#quizitem) objects.
...
The type of question. One of ‘multi-answer’, ‘matching’, ‘categorization’, ‘file-upload’, ‘formula’, ‘ordering’, ‘rich-fill-blank’, ‘hot-spot’, ‘choice’, ‘numeric’, ‘true-false’, or ‘essay’. See [Appendix: Question Types](https://developerdocs.instructure.com/services/canvas/resources/new_quiz_items#Question+Types-appendix) for more info about each type.

`item[entry][interaction_data]`

An object that contains additional properties for some question types. See [Appendix: Question Types](https://developerdocs.instructure.com/services/canvas/resources/new_quiz_items#Question+Types-appendix) for more info about this field.
...
Get a url for uploading media for use in hot-spot question types. See the hot-spot question type in the [Appendix: Question Types](https://developerdocs.instructure.com/services/canvas/resources/new_quiz_items#Question+Types-appendix) for more details about using this endpoint.
