...
source: llms
fetched_at: 2026-01-26T09:52:32.438901651-03:00
rendered_js: false
word_count: 288
summary: This document provides instructions for installing and configuring Clawdbot using Nix and Home Manager, including environment-specific runtime behaviors and macOS setup details.
tags:
    - nix
    - home-manager
    - macos
