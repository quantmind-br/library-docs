...
source: llms
fetched_at: 2026-04-16T22:36:14.153734325-03:00
rendered_js: false
word_count: 697
summary: This document explains the scope, benefits, and limitations of Zero Data Retention (ZDR) for Claude Code when used with Claude for Enterprise.
tags:
    - zero-data-retention
    - claude-code
    - enterprise-security
