...
url: https://moodledev.io/docs/4.1/apis/core/dml/delegated-transactions
source: sitemap
fetched_at: 2026-02-17T14:54:47.205666-03:00
rendered_js: false
word_count: 437
summary: This document explains the principles and implementation of delegated database transactions in Moodle, detailing the API for handling nested CRUD operations and error recovery.
tags:
    - moodle-development
