...
url: https://moodledev.io/docs/5.0/apis/subsystems/external/functions
source: sitemap
fetched_at: 2026-02-17T15:27:20.720361-03:00
rendered_js: false
word_count: 0
summary: This PHP code defines a Moodle external API class for programmatically creating multiple groups within a course, including security validation and parameter mapping.
tags:
    - moodle
    - external-api
    - php
