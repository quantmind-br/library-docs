---
title: 3 docs tagged with "GDPR" | Moodle Developer Resources
url: https://moodledev.io/docs/5.1/tags/gdpr
source: sitemap
fetched_at: 2026-02-17T15:31:05.31775-03:00
rendered_js: false
word_count: 104
summary: This document introduces the Moodle Privacy API and its role in GDPR compliance, providing guidance on handling user data in plugins and using utility scripts for implementation testing.
tags:
    - privacy-api
    - gdpr
    - data-protection
...
## [FAQs](https://moodledev.io/docs/5.1/apis/subsystems/privacy/faq)
...
## [Utilities](https://moodledev.io/docs/5.1/apis/subsystems/privacy/utils)
