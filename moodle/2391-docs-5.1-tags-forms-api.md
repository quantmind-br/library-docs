...
url: https://moodledev.io/docs/5.1/tags/forms-api
source: sitemap
fetched_at: 2026-02-17T15:30:59.802035-03:00
rendered_js: false
word_count: 191
summary: This document details advanced functionalities of the Moodle Form API, including techniques for element visibility, bulk checkbox management, non-processing form buttons, and repeating element groups.
tags:
    - moodle
    - form-api
    - advanced-elements
