---
title: "null"
url: https://docs.clawd.bot/gateway/logging.md
source: llms
fetched_at: 2026-01-26T09:52:03.323266292-03:00
rendered_js: false
word_count: 504
summary: This document explains Clawdbot's dual logging architecture, detailings how to configure and manage both file-based JSON logs and console output. It covers log levels, sensitive data redaction, WebSocket protocol monitoring, and subsystem formatting.
tags:
    - logging
    - clawdbot-config
    - log-levels
