...
url: https://moodledev.io/docs/5.2/apis/subsystems/availability
source: sitemap
fetched_at: 2026-02-17T15:45:12.052824-03:00
rendered_js: false
word_count: 869
summary: This document explains how to use the Moodle Availability API to manage and verify user access to course activities and sections based on conditional restrictions.
tags:
    - moodle-development
    - availability-api
    - access-control
...
- Writing [Availability condition](https://moodledev.io/docs/5.2/apis/plugintypes/availability) plugins