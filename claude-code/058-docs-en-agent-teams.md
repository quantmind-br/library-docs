...
source: llms
fetched_at: 2026-04-16T22:30:25.984975879-03:00
rendered_js: false
word_count: 3430
summary: This document explains the concept of agent teams in Claude Code, detailing how to coordinate multiple independent instances for parallel task execution and comparing this feature to subagents.
tags:
    - claude-code
    - agent-teams
    - multi-agent-systems
