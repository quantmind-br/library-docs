---
title: Chat
url: https://docs.mistral.ai/api/endpoint/chat#operation-chat_completion_v1_chat_completions_post
source: crawler
fetched_at: 2026-01-29T07:33:16.803581612-03:00
rendered_js: false
word_count: 610
summary: This document provides the technical specification for the chat completions API endpoint, detailing available request parameters such as penalties, sampling controls, and tool integration.
tags:
    - api-reference
    - chat-completions
    - request-parameters
