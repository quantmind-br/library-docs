...
url: https://moodledev.io/docs/5.1/apis/subsystems/sms
source: sitemap
fetched_at: 2026-02-17T15:37:19.484535-03:00
rendered_js: false
word_count: 645
summary: This document explains how to use the Moodle SMS API to send, fetch, and monitor messages via the core SMS manager class. It covers configuration for message gateways, handling sensitive content, and implementing hooks for gateway lifecycle management.
tags:
    - sms-api
    - moodle-development
    - message-gateway
...
- [SMS gateway](https://moodledev.io/docs/5.1/apis/plugintypes/sms)
...
### Message Truncation[​](#message-truncation "Direct link to Message Truncation")
...
[SMS gateways](https://moodledev.io/docs/5.1/apis/plugintypes/sms) are plugins that provide a way to interface with external SMS providers. Once a gateway is configured, any component implementing the SMS API can get a list of gateways.
