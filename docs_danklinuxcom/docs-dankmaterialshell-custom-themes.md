...
source: sitemap
fetched_at: 2026-01-24T13:33:39.17638193-03:00
rendered_js: false
word_count: 471
summary: This guide explains how to create and implement custom color themes for DankMaterialShell by defining JSON structures for primary, surface, and background colors.
tags:
    - dankmaterialshell
    - color-themes
    - theming
