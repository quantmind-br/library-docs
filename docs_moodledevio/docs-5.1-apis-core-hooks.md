...
url: https://moodledev.io/docs/5.1/apis/core/hooks
source: sitemap
fetched_at: 2026-02-17T15:34:22.045063-03:00
rendered_js: false
word_count: 1665
summary: This document explains the Moodle Hooks API, a PSR-14 compliant replacement for legacy plugin callbacks used to customize core functionality and facilitate communication between plugins. It details the creation, registration, and dispatching of hooks, including naming policies and the use of the hook manager.
tags:
    - moodle-development
    - hooks-api
    - psr-14
...
From Moodle 4.4 you should make use of the [Dependency Injection](https://moodledev.io/docs/5.1/apis/core/di) system, for example:
