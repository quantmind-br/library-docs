...
source: llms
fetched_at: 2026-01-24T14:42:36.171825139-03:00
rendered_js: false
word_count: 12065
summary: This document serves as a technical reference for Dockerfile syntax, detailing the various instructions, formatting rules, and parser directives required to build container images.
tags:
    - dockerfile
    - docker-build
    - container-images
...
No ENTRYPOINTENTRYPOINT exec\_entry p1\_entryENTRYPOINT \["exec\_entry", "p1\_entry"]**No CMD**error, not allowed/bin/sh -c exec\_entry p1\_entryexec\_entry p1\_entry**CMD \["exec\_cmd", "p1\_cmd"]**exec\_cmd p1\_cmd/bin/sh -c exec\_entry p1\_entryexec\_entry p1\_entry exec\_cmd p1\_cmd**CMD exec\_cmd p1\_cmd**/bin/sh -c exec\_cmd p1\_cmd/bin/sh -c exec\_entry p1\_entryexec\_entry p1\_entry /bin/sh -c exec\_cmd p1\_cmd
