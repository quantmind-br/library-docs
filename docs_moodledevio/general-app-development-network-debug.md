---
title: Debugging network requests in the Moodle App | Moodle Developer Resources
url: https://moodledev.io/general/app/development/network-debug
source: sitemap
fetched_at: 2026-02-17T15:54:35.797721-03:00
rendered_js: false
word_count: 472
summary: This guide provides instructions for identifying and troubleshooting common issues within the Moodle mobile app by enabling developer debugging on both the site and the application. It outlines methods for inspecting web service requests and resolving login or data record errors using browser and mobile diagnostic tools.
tags:
    - moodle-app
    - troubleshooting
    - debugging
...
- When you receive one of the following error messages in the app:
  ...
  - "Can not find data record in database table external\_functions".
  - "Invalid response value detected".
  - "Cannot get course contents".

## Enabling debugging on your Moodle site[​](#enabling-debugging-on-your-moodle-site "Direct link to Enabling debugging on your Moodle site")
...
## Enabling debugging on the Moodle App[​](#enabling-debugging-on-the-moodle-app "Direct link to Enabling debugging on the Moodle App")
...
## First attempts[​](#first-attempts "Direct link to First attempts")
...
### Using a mobile device or emulator[​](#using-a-mobile-device-or-emulator "Direct link to Using a mobile device or emulator")
...
### General strategy[​](#general-strategy "Direct link to General strategy")
...
### How to log into a site configured to use browser or embedded authentication[​](#how-to-log-into-a-site-configured-to-use-browser-or-embedded-authentication "Direct link to How to log into a site configured to use browser or embedded authentication")
