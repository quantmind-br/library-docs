...
url: https://moodledev.io/docs/4.4/apis/subsystems/output/inplace
source: sitemap
fetched_at: 2026-02-17T15:04:44.711781-03:00
rendered_js: false
word_count: 535
summary: This document explains how to implement the inplace_editable mini-API in Moodle plugins to allow users to edit values directly on a page. It covers callback definitions, renderer integration, and configuring different UI types like toggles and dropdowns.
tags:
    - moodle
    - inplace-editable
    - plugin-development
