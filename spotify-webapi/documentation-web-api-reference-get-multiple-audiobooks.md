...
url: https://developer.spotify.com/documentation/web-api/reference/get-multiple-audiobooks
source: crawler
fetched_at: 2026-02-27T23:46:09.626735-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response structure for an audiobook resource, illustrating the metadata fields and nested chapter data returned by the API.
tags:
    - api-response
    - json-schema
    - audiobook-data
