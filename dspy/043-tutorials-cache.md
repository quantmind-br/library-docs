---
title: Cache - DSPy
url: https://dspy.ai/tutorials/cache/
source: sitemap
fetched_at: 2026-01-23T08:03:40.828263363-03:00
rendered_js: false
word_count: 628
summary: This tutorial explains the architecture of DSPy's caching system and demonstrates how to enable, disable, and customize in-memory, on-disk, and provider-side caches.
tags:
    - dspy
    - caching
...
[](https://github.com/stanfordnlp/dspy/blob/main/docs/docs/tutorials/cache/index.md "Edit this page")

## Use and Customize DSPy Cache[¶](#use-and-customize-dspy-cache "Permanent link")
...
## DSPy Cache Structure[¶](#dspy-cache-structure "Permanent link")
...
## Using DSPy Cache[¶](#using-dspy-cache "Permanent link")
...
## Using Provider-Side Prompt Caching[¶](#using-provider-side-prompt-caching "Permanent link")
...
## Disabling/Enabling DSPy Cache[¶](#disablingenabling-dspy-cache "Permanent link")
...
## Understanding and Customizing the Cache[¶](#understanding-and-customizing-the-cache "Permanent link")
...
```
classCustomCache(dspy.clients.Cache):
    def__init__(self, **kwargs):
        {write your own constructor}

    defcache_key(self, request: dict[str, Any], ignored_args_for_cache_key: Optional[list[str]] = None) -> str:
        {write your logic of computing cache key}

    defget(self, request: dict[str, Any], ignored_args_for_cache_key: Optional[list[str]] = None) -> Any:
...
importos
importtime
fromtypingimport Dict, Any, Optional
importorjson
fromhashlibimport sha256
