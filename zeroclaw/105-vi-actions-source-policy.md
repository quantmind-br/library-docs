...
url: https://github.com/openagen/zeroclaw/blob/master/docs/vi/actions-source-policy.md
source: git
fetched_at: 2026-05-02T14:52:21.561979929-03:00
rendered_js: false
word_count: 461
summary: Tài liệu này định nghĩa chính sách kiểm soát nguồn GitHub Actions giai đoạn 1, tập trung vào việc thiết lập danh sách cho phép (allowlist) để quản lý rủi ro chuỗi cung ứng và đảm bảo tính bảo mật cho CI/CD.
optimized: true
