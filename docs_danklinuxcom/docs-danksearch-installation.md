...
source: sitemap
fetched_at: 2026-01-24T13:34:00.057817023-03:00
rendered_js: false
word_count: 196
summary: This document provides step-by-step instructions for installing dsearch using various methods, including package managers for Arch and Fedora, NixOS configurations, and building from source.
tags:
    - dsearch
    - installation
    - nixos
