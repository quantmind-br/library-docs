...
url: https://moodledev.io/docs/4.5/tags/core-external
source: sitemap
fetched_at: 2026-02-17T15:06:34.776012-03:00
rendered_js: false
word_count: 149
summary: This document provides an overview of Moodle's web service framework, detailing how to declare, define, and secure external functions and services for integration with external systems.
tags:
    - moodle-api
    - web-services
    - external-services
