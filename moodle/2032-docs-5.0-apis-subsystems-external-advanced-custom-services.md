...
url: https://moodledev.io/docs/5.0/apis/subsystems/external/advanced/custom-services
source: sitemap
fetched_at: 2026-02-17T15:27:15.591788-03:00
rendered_js: false
word_count: 126
summary: This document defines the configuration structure for a Moodle external service, detailing how to register functions and manage access permissions via a PHP array.
tags:
    - moodle
    - external-services
    - web-services
