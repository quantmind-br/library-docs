---
title: 27 docs tagged with "Plugins" | Moodle Developer Resources
url: https://moodledev.io/docs/5.0/tags/plugins
source: sitemap
fetched_at: 2026-02-17T15:21:07.336489-03:00
rendered_js: false
word_count: 736
summary: This document provides a comprehensive index and brief overview of the various Moodle 5.0 developer APIs, plugin types, and core subsystems available for extending platform functionality. It serves as a directory for developers to understand specific components like grading, themes, question banks, and general plugin architecture.
tags:
    - moodle-api
    - plugin-development
    - moodle-5-0
...
## [Advanced grading API](https://moodledev.io/docs/5.0/apis/core/grading)
...
## [Antivirus plugins](https://moodledev.io/docs/5.0/apis/plugintypes/antivirus)

Integrate your preferred Antivirus tool to with Moodle to automatically check new file uploads.

## [Block plugins](https://moodledev.io/docs/5.0/apis/plugintypes/blocks)
...
## [db/tasks.php](https://moodledev.io/docs/5.0/apis/commonfiles/db-tasks.php)

A description of the plugin scheduled task configuration file

## [Defaults for new questions](https://moodledev.io/docs/5.0/apis/plugintypes/qtype/newquestiondefaults)

A way for question types to remember a user's preferred settings for creating questions of a given type.

## [Enrolment plugins](https://moodledev.io/docs/5.0/apis/plugintypes/enrol)
...
## [Filter plugins](https://moodledev.io/docs/5.0/apis/plugintypes/filter)

Filters are a way to automatically transform content before it is output. Filters may be used to:

## [Fonts](https://moodledev.io/docs/5.0/apis/plugintypes/theme/fonts)

CSS3 standard introduced the possibility to specify custom fonts, see CSS web fonts tutorial.

## [Images and icons in themes](https://moodledev.io/docs/5.0/apis/plugintypes/theme/images)
...
## [Layout](https://moodledev.io/docs/5.0/apis/plugintypes/theme/layout)
...
## [Question bank filters](https://moodledev.io/docs/5.0/apis/plugintypes/qbank/filters)

Question bank plugins allow you to define new filters for the question bank view and random question sets.

## [Question bank plugins](https://moodledev.io/docs/5.0/apis/plugintypes/qbank)

Question bank plugins allow you to extend the functionality of the Moodle Question bank.

## [Question type plugin restore code](https://moodledev.io/docs/5.0/apis/plugintypes/qtype/restore)

Question type plugins must implement special restore code to avoid duplicated questions
...
## [Styles](https://moodledev.io/docs/5.0/apis/plugintypes/theme/styles)
...
## [Theme plugins](https://moodledev.io/docs/5.0/apis/plugintypes/theme)
...
## [Writing a new service](https://moodledev.io/docs/5.0/apis/subsystems/external/writing-a-service)
