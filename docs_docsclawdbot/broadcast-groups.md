...
source: llms
fetched_at: 2026-01-26T09:50:11.930349315-03:00
rendered_js: false
word_count: 767
summary: This document explains how to configure and use Broadcast Groups to enable multiple specialized agents to process and respond to the same message simultaneously on WhatsApp.
tags:
    - clawdbot
    - broadcast-groups
