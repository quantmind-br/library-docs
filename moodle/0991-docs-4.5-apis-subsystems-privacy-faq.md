...
url: https://moodledev.io/docs/4.5/apis/subsystems/privacy/faq
source: sitemap
fetched_at: 2026-02-17T15:14:54.4713-03:00
rendered_js: false
word_count: 723
summary: This document provides guidance for Moodle developers on handling user data and privacy compliance across various plugin types. it clarifies when plugins need to declare data, export user information, or implement specific privacy providers based on their interaction with Moodle subsystems.
tags:
    - moodle-development
    - privacy-api
    - gdpr-compliance
