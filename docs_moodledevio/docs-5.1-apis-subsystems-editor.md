...
url: https://moodledev.io/docs/5.1/apis/subsystems/editor
source: sitemap
fetched_at: 2026-02-17T15:36:14.97338-03:00
rendered_js: false
word_count: 187
summary: This document explains how to use the Moodle Editor API to programmatically initialize and configure text editors on HTML text area fields.
tags:
    - moodle
    - editor-api
    - php
