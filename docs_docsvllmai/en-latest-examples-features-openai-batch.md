---
title: Offline Inference with the OpenAI Batch file format
url: https://docs.vllm.ai/en/latest/examples/features/openai_batch/
source: sitemap
fetched_at: 2026-05-07T21:12:54.824529503-03:00
rendered_js: false
word_count: 651
summary: This document explains how to perform batch inference using the vLLM batch runner tool with the OpenAI JSONL file format.
tags:
    - vllm
    - batch-inference
    - openai-compatible
...
[](https://github.com/vllm-project/vllm/edit/main/docs/examples/features/openai_batch.md "Edit this page")

Source [https://github.com/vllm-project/vllm/tree/main/examples/features/openai\_batch](https://github.com/vllm-project/vllm/tree/main/examples/features/openai_batch).
...
```
wgethttps://raw.githubusercontent.com/vllm-project/vllm/main/examples/features/openai_batch/openai_example_batch.jsonl
```

Once you've created your batch file it should look like this

```
catfeatures/openai_batch/openai_example_batch.jsonl
...
```
python-mvllm.entrypoints.openai.run_batch\
...
```
awss3cpfeatures/openai_batch/openai_example_batch.jsonls3://MY_BUCKET/MY_INPUT_FILE.jsonl
```
...
defgenerate_presigned_url(s3_client, client_method, method_parameters, expires_in):
"""
...
--model--modelmeta-llama/Meta-Llama-3-8B-Instruct
```
...
```
awss3cps3://MY_BUCKET/MY_OUTPUT_FILE.jsonl-
```
