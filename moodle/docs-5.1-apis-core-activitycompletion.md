...
url: https://moodledev.io/docs/5.1/apis/core/activitycompletion
source: sitemap
fetched_at: 2026-02-17T15:33:58.34812-03:00
rendered_js: false
word_count: 2062
summary: This document explains how to implement activity completion support in Moodle activities, covering standard triggers like views and grades as well as custom completion rules. It provides instructions on modifying the activity's library file, database structure, and backup/restore logic to enable these features.
tags:
    - moodle-development
    - activity-completion
    - moodle-api
