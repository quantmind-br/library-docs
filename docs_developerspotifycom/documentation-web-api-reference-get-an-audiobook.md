...
source: crawler
fetched_at: 2026-02-27T23:38:28.512399-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response structure for an audiobook resource, detailing fields for metadata, authors, and nested chapter information.
tags:
    - api-response
    - json-schema
    - audiobook-metadata
