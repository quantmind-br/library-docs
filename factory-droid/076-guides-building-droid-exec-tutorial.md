...
url: https://docs.factory.ai/guides/building/droid-exec-tutorial.md
source: llms
fetched_at: 2026-02-05T21:43:06.585136377-03:00
rendered_js: false
word_count: 943
summary: This document explains how to integrate Factory's Droid Exec headless CLI into applications to build features like chat-based codebase analysis. It details process spawning, configuration flags, and implementing real-time progress feedback via Server-Sent Events.
tags:
    - droid-exec
    - factory-cli
