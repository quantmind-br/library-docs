...
url: https://moodledev.io/docs/4.1/apis/subsystems/favourites
source: sitemap
fetched_at: 2026-02-17T14:56:23.417774-03:00
rendered_js: false
word_count: 746
summary: This document explains how to use the Moodle Favourites API to manage user-specific bookmarks for various system items. It details the identification requirements for items and provides instructions for performing CRUD operations and integrating favourites into SQL queries.
tags:
    - moodle-development
    - favourites-api
    - php-backend
