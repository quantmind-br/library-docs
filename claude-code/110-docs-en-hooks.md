...
source: llms
fetched_at: 2026-04-16T22:32:49.241533341-03:00
rendered_js: false
word_count: 12757
summary: This document provides a technical reference for the Claude Code hooks lifecycle, detailing when specific events fire and how they interact with user-defined commands or endpoints.
tags:
    - claude-code
    - hooks-reference
    - lifecycle-events
