...
source: llms
fetched_at: 2026-01-26T09:54:21.464142431-03:00
rendered_js: false
word_count: 243
summary: This document outlines the configuration settings for skills in clawdbot, detailing how to manage skill loading, installation preferences, and individual skill environment variables within the application's configuration file.
tags:
    - clawdbot-config
    - skills-management
