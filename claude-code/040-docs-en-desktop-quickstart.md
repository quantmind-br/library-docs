...
source: llms
fetched_at: 2026-04-16T22:31:55.289548257-03:00
rendered_js: false
word_count: 974
summary: This guide provides instructions for installing and using the Claude Code desktop application to manage coding sessions across local, remote, and SSH environments.
tags:
    - claude-code
    - desktop-app
    - installation-guide
