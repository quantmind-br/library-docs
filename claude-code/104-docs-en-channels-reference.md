...
source: llms
fetched_at: 2026-04-16T22:30:56.416451347-03:00
rendered_js: false
word_count: 3057
summary: This document explains how to build and configure MCP servers known as channels to push external events, webhooks, or chat messages into a Claude Code session. It provides technical specifications for capabilities, notification formats, and a walkthrough for building a webhook receiver using the Model Context Protocol SDK.
tags:
    - mcp-server
    - claude-code
    - webhooks
