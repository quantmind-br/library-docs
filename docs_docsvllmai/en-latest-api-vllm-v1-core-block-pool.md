---
title: block_pool - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/core/block_pool/
source: sitemap
fetched_at: 2026-05-07T21:40:15.241872086-03:00
rendered_js: false
word_count: 103
summary: The BlockPool class manages the allocation, eviction, and lookup of KV cache blocks to support prefix caching in large language model inference.
tags:
    - kv-cache
    - prefix-caching
    - memory-management
...
"""Cache a list of full blocks for prefix caching.
    ...
    defget_new_blocks(self, num_blocks: int) -> list[KVCacheBlock]:
"""Get new blocks from the free block pool.
    ...
    def_maybe_evict_cached_block(self, block: KVCacheBlock) -> bool:
"""
    ...
    deftouch(self, blocks: Sequence[KVCacheBlock]) -> None:
"""Touch a block increases its reference count by 1, and may remove
    ...
    deffree_blocks(self, ordered_blocks: Iterable[KVCacheBlock]) -> None:
"""Free a list of blocks. The blocks should be ordered by their
    ...
    defevict_blocks(self, block_ids: set[int]) -> None:
"""evict blocks from the prefix cache by their block IDs.
    ...
    defreset_prefix_cache(self) -> bool:
"""Reset prefix cache. This function may be used in RLHF
    ...
    defget_num_free_blocks(self) -> int:
...
"""Get the KV cache usage.
    ...
    deftake_events(self) -> list[KVCacheEvent]:
