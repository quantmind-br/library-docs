...
url: https://moodledev.io/docs/4.1/apis/plugintypes/fileconverter
source: sitemap
fetched_at: 2026-02-17T14:55:17.98294-03:00
rendered_js: false
word_count: 363
summary: This document explains the technical structure and implementation requirements for creating file converter plugins in Moodle, detailing mandatory files and the converter interface.
tags:
    - moodle-development
    - file-converter
    - plugin-development
...
Some of the important files for the fileconverter plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.1/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
...
- Using the [File Converter API](https://moodledev.io/docs/4.1/apis/subsystems/files/converter)