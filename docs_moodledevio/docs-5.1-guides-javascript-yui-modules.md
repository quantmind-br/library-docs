---
title: YUI Modules | Moodle Developer Resources
url: https://moodledev.io/docs/5.1/guides/javascript/yui/modules
source: sitemap
fetched_at: 2026-02-17T15:37:56.296596-03:00
rendered_js: false
word_count: 1288
summary: This document explains the structure, naming conventions, and implementation of YUI modules within the Moodle framework. It details the benefits of module-based JavaScript and provides instructions on how to integrate and initialize these modules using PHP.
tags:
    - moodle-development
    - yui-modules
...
## YUI modules[​](#yui-modules "Direct link to YUI modules")

You may want to [Jump straight to the complete example](#additional-functions-instead-of-anonymous-functions).

### What is a module and why would I want to use one?[​](#what-is-a-module-and-why-would-i-want-to-use-one "Direct link to What is a module and why would I want to use one?")

Many people are used to writing their JavaScript code either inline, or in a separate file included using `<script>` tags in their HTML. Although both of these are supported within Moodle, we highly recommend investing a little time in looking into the [YUI](https://moodledev.io/docs/5.1/guides/javascript/yui) module system as it offers some really great features which will benefit you in the long run.
...
- [YUI](https://moodledev.io/docs/5.1/guides/javascript/yui); and

### Structure and naming[​](#structure-and-naming "Direct link to Structure and naming")
...
- what is the [Frankenstyle](https://moodledev.io/general/development/policies/codingstyle/frankenstyle) name of your Moodle plugin;
- what does your YUI module do in a single word.

You can use these pieces of information to work out the namespace for your plugin. This namespace fits into the template:
...
- The block is fruit, therefore the frankenstyle name is block\_fruit.
...
### Including your module from your PHP code[​](#including-your-module-from-your-php-code "Direct link to Including your module from your PHP code")

Rather than using `<script>` tags to include JavaScript code, Moodle makes use of the YUI loader and a single inline script tag in the page footer.
...
#### Passing arguments from your PHP to your module[​](#passing-arguments-from-your-php-to-your-module "Direct link to Passing arguments from your PHP to your module")

You may want to pass a set of arguments to your JavaScript. You can do so using the optional third argument to yui\_module which accepts an array of arguments.
...
### A basic module[​](#a-basic-module "Direct link to A basic module")
...
#### Namespacing[​](#namespacing "Direct link to Namespacing")
...
varNS=M.block_fruit.fruitbowl;
```

This ensures that any existing code on the M.block\_fruit object is not inadvertently overwritten, but also ensures that the definition for the fruitbowl code is clean.
...
#### Separation of code from configuration and style (loose coupling)[​](#separation-of-code-from-configuration-and-style-loose-coupling "Direct link to Separation of code from configuration and style (loose coupling)")
...
#### Additional functions instead of anonymous functions[​](#additional-functions-instead-of-anonymous-functions "Direct link to Additional functions instead of anonymous functions")
