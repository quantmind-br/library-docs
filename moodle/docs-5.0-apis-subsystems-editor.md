...
url: https://moodledev.io/docs/5.0/apis/subsystems/editor
source: sitemap
fetched_at: 2026-02-17T15:27:10.692706-03:00
rendered_js: false
word_count: 187
summary: This document explains how to use the Moodle editor API to programmatically initialize and configure text editors on HTML text areas.
tags:
    - moodle
    - editor-api
    - php
