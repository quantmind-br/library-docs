...
source: llms
fetched_at: 2026-01-24T11:02:18.735655441-03:00
rendered_js: false
word_count: 67
summary: This document defines the OpenAPI specification for retrieving the results of asynchronous video and image generation tasks using a unique task ID.
tags:
    - z-ai-api
    - async-processing
    - video-generation
