...
source: crawler
fetched_at: 2026-01-28T15:01:14.773905407-03:00
rendered_js: false
word_count: 96
summary: This document explains the ServerSpec structure and parsing function used to validate and process upstream proxy or server specifications.
tags:
    - server-spec
    - proxy-configuration
    - parsing-function
