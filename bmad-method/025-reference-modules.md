...
url: https://docs.bmad-method.org/reference/modules/
source: sitemap
fetched_at: 2026-04-08T11:31:31.825063981-03:00
rendered_js: false
word_count: 334
summary: This document outlines various specialized, extendable modules for the BMad framework, detailing tools for creating custom agents and workflows. It highlights dedicated suites for structured creativity, game development design, and enterprise-grade test architecture.
tags:
    - bmad
    - module-extension
    - agent-builder
