...
url: https://moodledev.io/docs/4.5/apis/core/dml/delegated-transactions
source: sitemap
fetched_at: 2026-02-17T15:11:14.108724-03:00
rendered_js: false
word_count: 437
summary: This document outlines the principles and API usage for delegated database transactions in Moodle, explaining how to manage nested CRUD operations and ensure data integrity through rollbacks.
tags:
    - moodle-development
