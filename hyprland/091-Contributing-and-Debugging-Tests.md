...
source: sitemap
fetched_at: 2026-01-22T22:16:32.364215314-03:00
rendered_js: false
word_count: 284
summary: This document provides instructions on how to run, write, and submit unit and functional tests for the Hyprland ecosystem using GTest and hyprtester. It also covers generating coverage reports to identify untested code paths and ensure software stability.
tags:
    - hyprland
    - testing
    - gtest
