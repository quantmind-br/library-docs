---
title: Authentication Providers | Instructure Developer Documentation Portal
url: https://developerdocs.instructure.com/services/canvas/resources/authentication_providers
source: sitemap
fetched_at: 2026-02-15T09:08:02.09121-03:00
rendered_js: false
word_count: 1412
summary: This document defines the data structures and API endpoints for managing external authentication providers such as SAML, LDAP, and CAS. It provides details on configuring provider-specific attributes, single sign-on settings, and user provisioning.
tags:
...
[AuthenticationProvidersController#indexarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/authentication_providers_controller.rb)
...
Returns a list of [AuthenticationProvider](https://developerdocs.instructure.com/services/canvas/resources/authentication_providers#authenticationprovider) objects.

[AuthenticationProvidersController#showarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/authentication_providers_controller.rb)
...
Returns an [AuthenticationProvider](https://developerdocs.instructure.com/services/canvas/resources/authentication_providers#authenticationprovider) object.

[AuthenticationProvidersController#createarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/authentication_providers_controller.rb)
...
- metadata\_uri \[Optional]
  ...
  A URI to download the SAML metadata from, and automatically populate idp\_entity\_id, log\_in\_url, log\_out\_url, certificate\_fingerprint, and identifier\_format. This URI will also be saved, and the metadata periodically refreshed, automatically. If the metadata contains multiple entities, also supply idp\_entity\_id to distinguish which one you want (otherwise the only entity in the metadata will be inferred). If you provide the URI ‘urn:mace:incommon’ or ‘[ukfederation.org.ukarrow-up-right](http://ukfederation.org.uk)’, the InCommon or UK Access Management Federation metadata aggregate, respectively, will be used instead, and additional validation checks will happen (including validating that the metadata has been properly signed with the appropriate key).
- idp\_entity\_id
...
[AuthenticationProvidersController#updatearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/authentication_providers_controller.rb)
...
Update an authentication provider using the same options as the [Add authentication provider](https://developerdocs.instructure.com/services/canvas/resources/authentication_providers#method.authentication_providers.create) endpoint. You cannot update an existing provider to a new authentication type.
...
[AuthenticationProvidersController#destroyarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/authentication_providers_controller.rb)
...
[AuthenticationProvidersController#restorearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/authentication_providers_controller.rb)
...
[AuthenticationProvidersController#show\_sso\_settingsarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/authentication_providers_controller.rb)
...
Returns a [SSOSettings](https://developerdocs.instructure.com/services/canvas/resources/authentication_providers#ssosettings) object.

[AuthenticationProvidersController#update\_sso\_settingsarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/authentication_providers_controller.rb)
