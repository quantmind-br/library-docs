...
url: https://moodledev.io/docs/5.0/apis/subsystems/muc
source: sitemap
fetched_at: 2026-02-17T15:27:51.731714-03:00
rendered_js: false
word_count: 4016
summary: This document provides a comprehensive guide to the Moodle Universal Cache (MUC) API, explaining how to create cache definitions, manage cache objects, and perform basic operations like get, set, and delete.
tags:
    - moodle-development
    - muc-api
    - cache-management
