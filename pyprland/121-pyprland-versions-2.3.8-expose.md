...
url: https://hyprland-community.github.io/pyprland/versions/2.3.8/expose
source: github_pages
fetched_at: 2026-01-31T15:59:57.918134108-03:00
rendered_js: false
word_count: 105
...
For a similar feature using a menu, try the [fetch\_client\_menu](https://hyprland-community.github.io/pyprland/versions/2.3.8/fetch_client_menu.html) plugin (less intrusive).
...
If you are looking for `toggle_minimized`, check the [toggle\_special](https://hyprland-community.github.io/pyprland/versions/2.3.8/toggle_special.html) plugin
...
### `include_special` (optional) [​](#include-special-optional)
