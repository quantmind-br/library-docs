...
url: https://moodledev.io/docs/5.2/apis/plugintypes/blocks
source: sitemap
fetched_at: 2026-02-17T15:44:06.424673-03:00
rendered_js: false
word_count: 2077
summary: This document explains the required file structure and mandatory configuration files for developing block plugins in Moodle, covering block definitions, access control, and localization.
tags:
    - moodle
    - block-plugins
    - plugin-development
