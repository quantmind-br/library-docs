---
title: moriio_connector - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/distributed/kv_transfer/kv_connector/v1/moriio/moriio_connector/
source: sitemap
fetched_at: 2026-05-07T21:18:36.287083867-03:00
rendered_js: false
word_count: 0
summary: This code implements the MoRIIO connector worker, which manages KV cache transfers between vLLM engine instances using an RDMA-based communication backend.
tags:
    - vllm
    - kv-cache
    - rdma
...
```
classMoRIIOConnectorWorker:
"""Implementation of Worker side methods"""

    def__init__(self, vllm_config: VllmConfig, engine_id: str):
...
"""Schedule a block write operation.
    ...
    def_get_built_session(self, remote_engine_id):
...
"""Do a MoRIIO handshake with a remote instance."""
    ...
    def_background_moriio_handshake(
        ...
        defrequest_ready(_f: Future[Any], entry=(req_id, meta)):
        ...
        for cur_dp_rank in range(remote_dp_size):
            ...
            defdone_callback(f: Future[set[str]], eid=dp_engine_id):
...
"""Register the KV Cache data in moriio."""
        ...
        if self.vllm_config.model_config.hf_config.model_type == "llama4":
            fromtransformersimport Llama4TextConfig
...
"""
    ...
    def_pop_done_transfers(self) -> set[str]:
    ...
    defget_engine_name_with_dp(self, engine_name, dp_rank):
        return f"{engine_name}_dp{dp_rank}"

    defstart_load_kv(self, metadata: MoRIIOConnectorMetadata):
"""
    ...
    def_write_blocks_for_req(self, req_id: ReqId, meta: ReqMeta, layer_name, kv_layer):
    ...
    def_compute_block_transfer_offsets(
        self,
        layer_name: str,
        local_block_ids: list[int],
