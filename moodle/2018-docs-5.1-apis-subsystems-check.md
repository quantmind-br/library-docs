...
url: https://moodledev.io/docs/5.1/apis/subsystems/check
source: sitemap
fetched_at: 2026-02-17T15:36:09.72366-03:00
rendered_js: false
word_count: 1833
summary: This document explains the Moodle Check API, a unified framework for performing runtime tests on system health, security, and performance across core and plugins.
tags:
    - moodle-development
    - check-api
    - runtime-testing
