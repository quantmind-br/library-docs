---
title: Step-3.5 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/StepFun/Step3.5
source: sitemap
fetched_at: 2026-05-11T05:50:08.829627159-03:00
rendered_js: false
word_count: 540
summary: This document provides instructions for deploying and invoking the Step-3.5-Flash model using the SGLang framework, including hardware-specific configuration, installation steps, and usage examples for reasoning and tool calling.
tags:
    - sglang
    - step-3-5-flash
    - llm-deployment
