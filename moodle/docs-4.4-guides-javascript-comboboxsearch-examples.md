...
url: https://moodledev.io/docs/4.4/guides/javascript/comboboxsearch/examples
source: sitemap
fetched_at: 2026-02-17T15:05:22.485327-03:00
rendered_js: false
word_count: 103
summary: This document explains the migration of Moodle grade report modules to a new core search dropdown component and provides implementation steps for developers.
tags:
    - moodle-development
    - search-dropdown
    - core-components
