...
source: crawler
fetched_at: 2026-02-27T23:39:15.854804-03:00
rendered_js: true
word_count: 239
summary: This document describes the Web API endpoint for retrieving the detailed profile information of the currently authenticated user. It outlines the response structure and the specific OAuth scopes required to access private data like email and subscription level.
tags:
    - web-api
    - user-profile
    - authentication
