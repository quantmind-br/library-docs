---
title: Qwen3-Coder-Next - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Qwen/Qwen3-Coder-Next
source: sitemap
fetched_at: 2026-05-11T05:50:06.321659668-03:00
rendered_js: false
word_count: 788
summary: This document provides a comprehensive guide on deploying and using the Qwen3-Coder-Next language model within the SGLang framework, including configuration tips for hybrid architecture and implementation examples for code generation, streaming, and tool calling.
tags:
    - sglang
    - llm-deployment
    - qwen3-coder
...
H200H100B200MI300XMI325XMI355X
