...
url: https://moodledev.io/docs/4.5/tags/external
source: sitemap
fetched_at: 2026-02-17T15:07:17.332766-03:00
rendered_js: false
word_count: 149
summary: This document provides an overview of Moodle's Web Service framework, covering the declaration, definition, security, and testing of external services for system integration.
tags:
    - moodle
    - web-services
    - external-services
