...
url: https://moodledev.io/docs/4.1/apis/subsystems/output
source: sitemap
fetched_at: 2026-02-17T14:56:44.9606-03:00
rendered_js: false
word_count: 2165
summary: Explains the architecture and workflow of the Moodle Output API, detailing how renderers, renderables, and mustache templates interact to generate visual content.
tags:
    - moodle-development
    - output-api
    - renderers
...
```
functionformat_text($text,$format=FORMAT_MOODLE,$options=null,$courseid_do_not_use=null)
```
...
- **courseid\_do\_not\_use**: This parameter was earlier used to help applying filters but now is replaced with more precise `$options->context`, see above

### format\_string()[​](#format_string "Direct link to format_string()")

```
functionformat_string($string,$striplinks=true,$options=null)
```
