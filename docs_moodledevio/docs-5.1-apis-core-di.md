...
url: https://moodledev.io/docs/5.1/apis/core/di
source: sitemap
fetched_at: 2026-02-17T15:34:09.618372-03:00
rendered_js: false
word_count: 486
summary: This document explains how to implement and use PSR-11 compatible Dependency Injection in Moodle, covering techniques for fetching, configuring, and mocking dependencies.
tags:
    - moodle-development
