---
title: Add a block cleanup | Moodle Developer Resources
url: https://moodledev.io/general/projects/code/block-cleanup
source: sitemap
fetched_at: 2026-02-17T16:02:19.903527-03:00
rendered_js: false
word_count: 292
summary: This document describes strategies for streamlining the block selection menu by disabling irrelevant or redundant blocks based on feature settings and theme requirements.
tags:
    - block-management
    - ui-optimization
    - feature-settings
...
## Disabling blocks if the feature is disabled[​](#disabling-blocks-if-the-feature-is-disabled "Direct link to Disabling blocks if the feature is disabled")
...
## Disabling less useful blocks[​](#disabling-less-useful-blocks "Direct link to Disabling less useful blocks")
...
## Letting themes define "unneeded" blocks[​](#letting-themes-define-unneeded-blocks 'Direct link to Letting themes define "unneeded" blocks')
