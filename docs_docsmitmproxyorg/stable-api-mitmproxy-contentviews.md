...
source: crawler
fetched_at: 2026-01-28T15:01:13.173841877-03:00
rendered_js: false
word_count: 1410
summary: This document explains the content views system in mitmproxy, which formats, decodes, highlights, and re-encodes data primarily for HTTP message bodies but also for other contexts like WebSocket messages.
tags:
    - mitmproxy
    - content-views
    - data-formatting
