...
source: llms
fetched_at: 2026-01-26T09:53:22.943460929-03:00
rendered_js: false
word_count: 493
summary: This document provides an overview of the MiniMax M2.1 model family and provides instructions for configuring these models within the clawdbot environment via hosted, fallback, or local setups.
tags:
    - minimax
    - m2-1
    - clawdbot
