---
title: u64 - Rust
url: https://doc.rust-lang.org/stable/std/primitive.u64.html
source: crawler
fetched_at: 2026-05-06T21:28:18.958698963-03:00
rendered_js: false
word_count: 12687
summary: This document provides reference documentation for the Rust u64 primitive type, detailing its bitwise manipulation methods, constants, and properties.
tags:
    - rust
    - primitive-types
    - integer
...
[Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1273)[§](#impl-u64)

1.43.0 · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.53.0 · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.0.0 (const: 1.32.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
You might want to use [`Self::count_ones`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.count_ones "method u64::count_ones") instead, or emphasize the type you’re using in the call rather than method syntax:
...
Depending on what you’re doing with the value, you might also be interested in the [`ilog2`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.ilog2 "method u64::ilog2") function which returns a consistent number, even if the type widens.
...
1.46.0 (const: 1.46.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
[Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.87.0 (const: 1.87.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
Please note this isn’t the same operation as the `<<` shifting operator or [`rotate_left`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.rotate_left "method u64::rotate_left"), although `a.funnel_shl(a, n)` is *equivalent* to `a.rotate_left(n)`.
...
Please note this isn’t the same operation as the `>>` shifting operator or [`rotate_right`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.rotate_right "method u64::rotate_right"), although `a.funnel_shr(a, n)` is *equivalent* to `a.rotate_right(n)`.
...
1.37.0 (const: 1.37.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.0.0 (const: 1.47.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.91.0 (const: 1.91.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.79.0 (const: 1.79.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)

Unchecked integer addition. Computes `self + rhs`, assuming overflow cannot occur.

Calling `x.unchecked_add(y)` is semantically equivalent to calling `x.`[`checked_add`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.checked_add "method u64::checked_add")`(y).`[`unwrap_unchecked`](https://doc.rust-lang.org/stable/std/option/enum.Option.html#method.unwrap_unchecked)`()`.

If you’re just trying to avoid the panic in debug mode, then **do not** use this. Instead, you’re looking for [`wrapping_add`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.wrapping_add "method u64::wrapping_add").

##### [§](#safety)Safety

This results in undefined behavior when `self + rhs > u64::MAX` or `self + rhs < u64::MIN`, i.e. when [`checked_add`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.checked_add "method u64::checked_add") would return `None`.

1.66.0 (const: 1.66.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
Calling `x.unchecked_sub(y)` is semantically equivalent to calling `x.`[`checked_sub`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.checked_sub "method u64::checked_sub")`(y).`[`unwrap_unchecked`](https://doc.rust-lang.org/stable/std/option/enum.Option.html#method.unwrap_unchecked)`()`.

If you’re just trying to avoid the panic in debug mode, then **do not** use this. Instead, you’re looking for [`wrapping_sub`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.wrapping_sub "method u64::wrapping_sub").
...
This results in undefined behavior when `self - rhs > u64::MAX` or `self - rhs < u64::MIN`, i.e. when [`checked_sub`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.checked_sub "method u64::checked_sub") would return `None`.

1.90.0 (const: 1.90.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
Checked integer subtraction. Computes `self - rhs` and checks if the result fits into an [`i64`](https://doc.rust-lang.org/stable/std/primitive.i64.html "primitive i64"), returning `None` if overflow occurred.
...
Calling `x.unchecked_mul(y)` is semantically equivalent to calling `x.`[`checked_mul`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.checked_mul "method u64::checked_mul")`(y).`[`unwrap_unchecked`](https://doc.rust-lang.org/stable/std/option/enum.Option.html#method.unwrap_unchecked)`()`.

If you’re just trying to avoid the panic in debug mode, then **do not** use this. Instead, you’re looking for [`wrapping_mul`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.wrapping_mul "method u64::wrapping_mul").

##### [§](#safety-2)Safety

This results in undefined behavior when `self * rhs > u64::MAX` or `self * rhs < u64::MIN`, i.e. when [`checked_mul`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.checked_mul "method u64::checked_mul") would return `None`.

1.0.0 (const: 1.52.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.38.0 (const: 1.52.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
This results in undefined behavior when `rhs == 0` or `self % rhs != 0`, i.e. when [`checked_div_exact`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.checked_div_exact "method u64::checked_div_exact") would return `None`.

1.7.0 (const: 1.52.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.67.0 (const: 1.67.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.7.0 (const: 1.47.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.93.0 (const: 1.93.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)

Unchecked shift left. Computes `self << rhs`, assuming that `rhs` is less than the number of bits in `self`.

##### [§](#safety-5)Safety

This results in undefined behavior if `rhs` is larger than or equal to the number of bits in `self`, i.e. when [`checked_shl`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.checked_shl "method u64::checked_shl") would return `None`.
...
This results in undefined behavior when `rhs > self.leading_zeros() || rhs >= u64::BITS` i.e. when [`u64::shl_exact`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.shl_exact "method u64::shl_exact") would return `None`.
...
This results in undefined behavior if `rhs` is larger than or equal to the number of bits in `self`, i.e. when [`checked_shr`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.checked_shr "method u64::checked_shr") would return `None`.
...
This results in undefined behavior when `rhs > self.trailing_zeros() || rhs >= u64::BITS` i.e. when [`u64::shr_exact`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.shr_exact "method u64::shr_exact") would return `None`.

1.34.0 (const: 1.50.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.58.0 (const: 1.58.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.2.0 (const: 1.52.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.2.0 (const: 1.32.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
Beware that, unlike most other `wrapping_*` methods on integers, this does *not* give the same result as doing the shift in infinite precision then truncating as needed. The behaviour matches what shift instructions do on many processors, and is what the `>>` operator does when overflow checks are disabled, but numerically it’s weird. Consider, instead, using [`Self::unbounded_shr`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.unbounded_shr "method u64::unbounded_shr") which has nicer behaviour.

Note that this is *not* the same as a rotate-right; the RHS of a wrapping shift-right is restricted to the range of the type, rather than the bits shifted out of the LHS being returned to the other end. The primitive integer types all implement a [`rotate_right`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.rotate_right "method u64::rotate_right") function, which may be what you want instead.
...
1.7.0 (const: 1.32.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.91.0 (const: [unstable](https://github.com/rust-lang/rust/issues/152015 "Tracking issue for const_unsigned_bigint_helpers")) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.60.0 (const: 1.60.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
If you want the *value* of the overflow, rather than just *whether* an overflow occurred, see [`Self::carrying_mul`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.carrying_mul "method u64::carrying_mul").
...
If you also need to add a value and carry to the wide result, then you want [`Self::carrying_mul_add`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.carrying_mul_add "method u64::carrying_mul_add") instead.

If you also need to add a carry to the wide result, then you want [`Self::carrying_mul`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.carrying_mul "method u64::carrying_mul") instead.

If you just want to know *whether* the multiplication overflowed, then you want [`Self::overflowing_mul`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.overflowing_mul "method u64::overflowing_mul") instead.
...
If you also need to add a value, then use [`Self::carrying_mul_add`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.carrying_mul_add "method u64::carrying_mul_add").
...
If `carry` is zero, this is similar to [`overflowing_mul`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.overflowing_mul "method u64::overflowing_mul"), except that it gives the value of the overflow instead of just whether one happened:
...
If you don’t need the `add` part, then you can use [`Self::carrying_mul`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.carrying_mul "method u64::carrying_mul") instead.
...
1.0.0 (const: 1.50.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.84.0 (const: 1.84.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.73.0 (const: 1.73.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
1.32.0 (const: 1.44.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1274-1298)
...
As the target platform’s native endianness is used, portable code should use [`to_be_bytes`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.to_be_bytes "method u64::to_be_bytes") or [`to_le_bytes`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.to_le_bytes "method u64::to_le_bytes"), as appropriate, instead.
...
As the target platform’s native endianness is used, portable code likely wants to use [`from_be_bytes`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.from_be_bytes "associated function u64::from_be_bytes") or [`from_le_bytes`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.from_le_bytes "associated function u64::from_le_bytes"), as appropriate instead.
...
New code should prefer to use [`u64::MIN`](https://doc.rust-lang.org/stable/std/primitive.u64.html#associatedconstant.MIN "associated constant u64::MIN") instead.
...
New code should prefer to use [`u64::MAX`](https://doc.rust-lang.org/stable/std/primitive.u64.html#associatedconstant.MAX "associated constant u64::MAX") instead.

Returns the largest value that can be represented by this integer type.

1.85.0 (const: 1.85.0) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1299)
...
[Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1300)
...
[Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1301)
...
[Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1802)[§](#impl-u64-1)
...
[Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#599)[§](#impl-u64-2)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#114)[§](#impl-Add%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#114)[§](#impl-Add%3C%26u64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#114)[§](#impl-Add%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#114)[§](#impl-Add-for-u64)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-AddAssign%3C%26u64%3E-for-Saturating%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-AddAssign%3C%26u64%3E-for-Wrapping%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#800)[§](#impl-AddAssign%3C%26u64%3E-for-u64)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-AddAssign%3Cu64%3E-for-Saturating%3Cu64%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-AddAssign%3Cu64%3E-for-Wrapping%3Cu64%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#800)[§](#impl-AddAssign-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/sync/atomic.rs.html#305)[§](#impl-AtomicPrimitive-for-u64)

Available on **`target_has_atomic_load_store=64`** only.

[Source](https://doc.rust-lang.org/stable/src/core/sync/atomic.rs.html#305)[§](#associatedtype.AtomicInner)

🔬This is a nightly-only experimental API. (`atomic_internals`)

Temporary implementation detail.

1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#76)[§](#impl-Binary-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#76)[§](#method.fmt-2)

Format unsigned integers in the radix.

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#187)[§](#impl-BitAnd%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#187)[§](#impl-BitAnd%3C%26u64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#187)[§](#impl-BitAnd%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#187)[§](#impl-BitAnd-for-u64)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-BitAndAssign%3C%26u64%3E-for-Saturating%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-BitAndAssign%3C%26u64%3E-for-Wrapping%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#755)[§](#impl-BitAndAssign%3C%26u64%3E-for-u64)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-BitAndAssign%3Cu64%3E-for-Saturating%3Cu64%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-BitAndAssign%3Cu64%3E-for-Wrapping%3Cu64%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#755)[§](#impl-BitAndAssign-for-u64)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#291)[§](#impl-BitOr%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#291)[§](#impl-BitOr%3C%26u64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#291)[§](#impl-BitOr%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#291)[§](#impl-BitOr-for-u64)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-BitOrAssign%3C%26u64%3E-for-Saturating%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-BitOrAssign%3C%26u64%3E-for-Wrapping%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#830)[§](#impl-BitOrAssign%3C%26u64%3E-for-u64)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-BitOrAssign%3Cu64%3E-for-Saturating%3Cu64%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-BitOrAssign%3Cu64%3E-for-Wrapping%3Cu64%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#830)[§](#impl-BitOrAssign-for-u64)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#395)[§](#impl-BitXor%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#395)[§](#impl-BitXor%3C%26u64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#395)[§](#impl-BitXor%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#395)[§](#impl-BitXor-for-u64)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-BitXorAssign%3C%26u64%3E-for-Saturating%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-BitXorAssign%3C%26u64%3E-for-Wrapping%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#905)[§](#impl-BitXorAssign%3C%26u64%3E-for-u64)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-BitXorAssign%3Cu64%3E-for-Saturating%3Cu64%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-BitXorAssign%3Cu64%3E-for-Wrapping%3Cu64%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#905)[§](#impl-BitXorAssign-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/intrinsics/fallback.rs.html#34-45)[§](#impl-CarryingMulAdd-for-u64)
...
[Source](https://doc.rust-lang.org/stable/src/core/intrinsics/fallback.rs.html#253-255)[§](#impl-CarrylessMul-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/142757 "Tracking issue for const_clone")) · [Source](https://doc.rust-lang.org/stable/src/core/clone.rs.html#627-632)[§](#impl-Clone-for-u64)

1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#589-592)[§](#impl-Debug-for-u64)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143894 "Tracking issue for const_default")) · [Source](https://doc.rust-lang.org/stable/src/core/default.rs.html#173)[§](#impl-Default-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/default.rs.html#173)[§](#method.default)

Returns the default value of `0`

[Source](https://doc.rust-lang.org/stable/src/core/intrinsics/fallback.rs.html#144-148)[§](#impl-DisjointBitOr-for-u64)
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#599)[§](#impl-Display-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/random.rs.html#55)[§](#impl-Distribution%3Cu64%3E-for-RangeFull)

[Source](https://doc.rust-lang.org/stable/src/core/random.rs.html#55)[§](#method.sample)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#504-507)[§](#impl-Div%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#504-507)[§](#impl-Div%3C%26u64%3E-for-u64)
...
1.51.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#impl-Div%3CNonZero%3Cu64%3E%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#method.div)
...
[Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#associatedtype.Output-4)

The resulting type after applying the `/` operator.

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#504-507)[§](#impl-Div%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#504-507)[§](#impl-Div-for-u64)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-DivAssign%3C%26u64%3E-for-Saturating%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-DivAssign%3C%26u64%3E-for-Wrapping%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#994)[§](#impl-DivAssign%3C%26u64%3E-for-u64)

1.79.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#impl-DivAssign%3CNonZero%3Cu64%3E%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#method.div_assign)

Same as `self /= other.get()`, but because `other` is a `NonZero<_>`, there’s never a runtime check for division-by-zero.

This operation rounds towards zero, truncating any fractional part of the exact result, and cannot panic.

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-DivAssign%3Cu64%3E-for-Saturating%3Cu64%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-DivAssign%3Cu64%3E-for-Wrapping%3Cu64%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#994)[§](#impl-DivAssign-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/ascii/ascii_char.rs.html#1171)[§](#impl-From%3CChar%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/ascii/ascii_char.rs.html#1171)[§](#method.from-6)
...
1.51.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/char/convert.rs.html#59)[§](#impl-From%3Cchar%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/char/convert.rs.html#71)[§](#method.from-7)

Converts a [`char`](https://doc.rust-lang.org/stable/std/primitive.char.html "primitive char") into a [`u64`](https://doc.rust-lang.org/stable/std/primitive.u64.html "primitive u64").
...
1.5.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#97)[§](#impl-From%3Cu32%3E-for-u64)

1.34.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/sync/atomic.rs.html#3729-3746)[§](#impl-From%3Cu64%3E-for-AtomicU64)

[Source](https://doc.rust-lang.org/stable/src/core/sync/atomic.rs.html#3729-3746)[§](#method.from-8)

Converts an `u64` into an `AtomicU64`.

1.26.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#124)[§](#impl-From%3Cu64%3E-for-i128)

1.26.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#99)[§](#impl-From%3Cu64%3E-for-u128)

1.5.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#91)[§](#impl-From%3Cu8%3E-for-u64)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/num/mod.rs.html#1802)[§](#impl-FromStr-for-u64)
...
For parsing numbers in other bases, such as binary or hexadecimal, see [`from_str_radix`](https://doc.rust-lang.org/stable/std/primitive.u64.html#method.from_str_radix "associated function u64::from_str_radix").
...
[Source](https://doc.rust-lang.org/stable/src/core/intrinsics/fallback.rs.html#218-220)[§](#impl-FunnelShift-for-u64)
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/hash/mod.rs.html#830-843)[§](#impl-Hash-for-u64)

1.42.0 · [Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#600)[§](#impl-LowerExp-for-u64)

1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#76)[§](#impl-LowerHex-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#76)[§](#method.fmt-4)

Format unsigned integers in the radix.

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#361)[§](#impl-Mul%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#361)[§](#impl-Mul%3C%26u64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#361)[§](#impl-Mul%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#361)[§](#impl-Mul-for-u64)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-MulAssign%3C%26u64%3E-for-Saturating%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-MulAssign%3C%26u64%3E-for-Wrapping%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#933)[§](#impl-MulAssign%3C%26u64%3E-for-u64)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-MulAssign%3Cu64%3E-for-Saturating%3Cu64%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-MulAssign%3Cu64%3E-for-Wrapping%3Cu64%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#933)[§](#impl-MulAssign-for-u64)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#72)[§](#impl-Not-for-%26u64)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#72)[§](#impl-Not-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/fmt/num_buffer.rs.html#26-33)[§](#impl-NumBufferTrait-for-u64)
...
1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#76)[§](#impl-Octal-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#76)[§](#method.fmt-3)

Format unsigned integers in the radix.

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#2080)[§](#impl-Ord-for-u64)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#1898-1900)[§](#impl-PartialEq-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#2080)[§](#impl-PartialOrd-for-u64)
...
[Source](https://doc.rust-lang.org/stable/src/core/pat.rs.html#61-64)[§](#impl-RangePattern-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#613-616)[§](#impl-Rem%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#613-616)[§](#impl-Rem%3C%26u64%3E-for-u64)
...
1.51.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#impl-Rem%3CNonZero%3Cu64%3E%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#method.rem)

This operation satisfies `n % d == n - (n / d) * d`, and cannot panic.

[Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#associatedtype.Output-9)

The resulting type after applying the `%` operator.

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#613-616)[§](#impl-Rem%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#613-616)[§](#impl-Rem-for-u64)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-RemAssign%3C%26u64%3E-for-Saturating%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-RemAssign%3C%26u64%3E-for-Wrapping%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#1059)[§](#impl-RemAssign%3C%26u64%3E-for-u64)

1.79.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#impl-RemAssign%3CNonZero%3Cu64%3E%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#2448-2458)[§](#method.rem_assign)

This operation satisfies `n % d == n - (n / d) * d`, and cannot panic.

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-RemAssign%3Cu64%3E-for-Saturating%3Cu64%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-RemAssign%3Cu64%3E-for-Wrapping%3Cu64%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#1059)[§](#impl-RemAssign-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/select.rs.html#143-145)[§](#impl-Select%3CMask%3CT,+N%3E%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/select.rs.html#148)[§](#method.select-1)

🔬This is a nightly-only experimental API. (`portable_simd` [#86656](https://github.com/rust-lang/rust/issues/86656))

Choose elements

[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/select.rs.html#73-75)[§](#impl-Select%3CSimd%3CT,+N%3E%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/select.rs.html#78)[§](#method.select)

🔬This is a nightly-only experimental API. (`portable_simd` [#86656](https://github.com/rust-lang/rust/issues/86656))

Choose elements

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i128%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i128%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i32%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i32%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26i64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u128%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u128%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u32%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u32%3E-for-u64)
...
[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shl%3C%26u64%3E-for-%26Simd%3Cu64,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-%26i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-%26i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-%26i64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-%26u128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-%26u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-%26u8)
...
[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shl%3C%26u64%3E-for-Simd%3Cu64,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-i64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-u128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u64%3E-for-u8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u8%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3C%26u8%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci128%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci128%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci32%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci32%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Ci64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu128%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu128%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu32%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu32%3E-for-u64)
...
[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shl%3Cu64%3E-for-%26Simd%3Cu64,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-%26i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-%26i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-%26i64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-%26u128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-%26u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-%26u8)
...
[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shl%3Cu64%3E-for-Simd%3Cu64,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-i64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-u128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu64%3E-for-u8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu8%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl%3Cu8%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#517)[§](#impl-Shl-for-u64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i128%3E-for-u64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i32%3E-for-u64)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26i64%3E-for-u64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u128%3E-for-u64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u32%3E-for-u64)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u64%3E-for-i128)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u64%3E-for-i32)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u64%3E-for-i64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u64%3E-for-u128)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u64%3E-for-u32)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u64%3E-for-u64)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u64%3E-for-u8)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3C%26u8%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci128%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci32%3E-for-u64)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Ci64%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu128%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu32%3E-for-u64)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu64%3E-for-i128)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu64%3E-for-i32)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu64%3E-for-i64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu64%3E-for-u128)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu64%3E-for-u32)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu64%3E-for-u8)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign%3Cu8%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#991)[§](#impl-ShlAssign-for-u64)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i128%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i128%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i32%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i32%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26i64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u128%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u128%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u32%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u32%3E-for-u64)
...
[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shr%3C%26u64%3E-for-%26Simd%3Cu64,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-%26i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-%26i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-%26i64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-%26u128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-%26u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-%26u8)
...
[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shr%3C%26u64%3E-for-Simd%3Cu64,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-i64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-u128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u64%3E-for-u8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u8%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3C%26u8%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci128%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci128%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci32%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci32%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Ci64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu128%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu128%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu32%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu32%3E-for-u64)
...
[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shr%3Cu64%3E-for-%26Simd%3Cu64,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-%26i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-%26i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-%26i64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-%26u128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-%26u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-%26u8)
...
[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/ops/shift_scalar.rs.html#54)[§](#impl-Shr%3Cu64%3E-for-Simd%3Cu64,+N%3E)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-i128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-i32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-i64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-u128)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-u32)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu64%3E-for-u8)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu8%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr%3Cu8%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#639)[§](#impl-Shr-for-u64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i128%3E-for-u64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i32%3E-for-u64)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26i64%3E-for-u64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u128%3E-for-u64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u32%3E-for-u64)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u64%3E-for-i128)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u64%3E-for-i32)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u64%3E-for-i64)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u64%3E-for-u128)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u64%3E-for-u32)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u64%3E-for-u64)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u64%3E-for-u8)
...
1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3C%26u8%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci128%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci32%3E-for-u64)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Ci64%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu128%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu32%3E-for-u64)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu64%3E-for-i128)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu64%3E-for-i32)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu64%3E-for-i64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu64%3E-for-u128)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu64%3E-for-u32)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu64%3E-for-u8)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign%3Cu8%3E-for-u64)
...
1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/bit.rs.html#1077)[§](#impl-ShrAssign-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/vector.rs.html#1104)[§](#impl-SimdElement-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/vector.rs.html#1105)[§](#associatedtype.Mask)

🔬This is a nightly-only experimental API. (`portable_simd` [#86656](https://github.com/rust-lang/rust/issues/86656))

The mask element type corresponding to this element type.

[Source](https://doc.rust-lang.org/stable/src/core/iter/range.rs.html#434-437)[§](#impl-Step-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#227)[§](#impl-Sub%3C%26u64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#227)[§](#impl-Sub%3C%26u64%3E-for-u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#227)[§](#impl-Sub%3Cu64%3E-for-%26u64)
...
1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#227)[§](#impl-Sub-for-u64)
...
1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-SubAssign%3C%26u64%3E-for-Saturating%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-SubAssign%3C%26u64%3E-for-Wrapping%3Cu64%3E)

1.22.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#871)[§](#impl-SubAssign%3C%26u64%3E-for-u64)

1.74.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/saturating.rs.html#551)[§](#impl-SubAssign%3Cu64%3E-for-Saturating%3Cu64%3E)

1.60.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/num/wrapping.rs.html#566)[§](#impl-SubAssign%3Cu64%3E-for-Wrapping%3Cu64%3E)

1.8.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143802 "Tracking issue for const_ops")) · [Source](https://doc.rust-lang.org/stable/src/core/ops/arith.rs.html#871)[§](#impl-SubAssign-for-u64)

1.12.0 · [Source](https://doc.rust-lang.org/stable/src/core/iter/traits/accum.rs.html#204)[§](#impl-Sum%3C%26u64%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/iter/traits/accum.rs.html#204)[§](#method.sum-1)

Takes an iterator and generates `Self` from the elements by “summing up” the items.

1.12.0 · [Source](https://doc.rust-lang.org/stable/src/core/iter/traits/accum.rs.html#204)[§](#impl-Sum-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/iter/traits/accum.rs.html#204)[§](#method.sum)

Takes an iterator and generates `Self` from the elements by “summing up” the items.

1.34.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#401)[§](#impl-TryFrom%3Ci128%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#401)[§](#method.try_from-13)
...
[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#401)[§](#associatedtype.Error-13)
...
1.34.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#398)[§](#impl-TryFrom%3Ci32%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#398)[§](#method.try_from-11)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#398)[§](#associatedtype.Error-11)

The type returned in the event of a conversion error.

1.34.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#400)[§](#impl-TryFrom%3Ci64%3E-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#400)[§](#method.try_from-12)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#400)[§](#associatedtype.Error-12)
...
[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#394)[§](#method.try_from-9)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#394)[§](#associatedtype.Error-9)
...
[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#465)[§](#method.try_from-15)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#465)[§](#associatedtype.Error-15)

The type returned in the event of a conversion error.

1.34.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#378)[§](#impl-TryFrom%3Cu128%3E-for-u64)
...
1.46.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#565)[§](#impl-TryFrom%3Cu64%3E-for-NonZero%3Cu64%3E)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#565)[§](#method.try_from-18)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#565)[§](#associatedtype.Error-18)
...
[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#390)[§](#method.try_from-6)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#390)[§](#associatedtype.Error-6)

The type returned in the event of a conversion error.

1.34.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#390)[§](#impl-TryFrom%3Cu64%3E-for-i32)
...
1.34.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#390)[§](#impl-TryFrom%3Cu64%3E-for-i64)
...
[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#390)[§](#method.try_from-5)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#390)[§](#associatedtype.Error-5)
...
[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#475)[§](#method.try_from-17)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#475)[§](#associatedtype.Error-17)
...
[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#377)[§](#method.try_from-2)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#377)[§](#associatedtype.Error-2)

The type returned in the event of a conversion error.

1.34.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#377)[§](#impl-TryFrom%3Cu64%3E-for-u32)
...
1.34.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143773 "Tracking issue for const_convert")) · [Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#377)[§](#impl-TryFrom%3Cu64%3E-for-u8)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#377)[§](#method.try_from-1)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#377)[§](#associatedtype.Error-1)
...
[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#469)[§](#method.try_from-16)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#469)[§](#associatedtype.Error-16)
...
[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#460)[§](#method.try_from-14)

Tries to create the target number type from a source number type. This returns an error if the source value is outside of the range of the target type.

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#460)[§](#associatedtype.Error-14)

The type returned in the event of a conversion error.

1.42.0 · [Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#600)[§](#impl-UpperExp-for-u64)

1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#76)[§](#impl-UpperHex-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/fmt/num.rs.html#76)[§](#method.fmt-5)

Format unsigned integers in the radix.

[Source](https://doc.rust-lang.org/stable/src/core/num/nonzero.rs.html#69-83)[§](#impl-ZeroablePrimitive-for-u64)
...
[Source](https://doc.rust-lang.org/stable/src/core/marker.rs.html#1100-1109)[§](#impl-ConstParamTy_-for-u64)

1.0.0 · [Source](https://doc.rust-lang.org/stable/src/core/marker.rs.html#474-484)[§](#impl-Copy-for-u64)

1.0.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143800 "Tracking issue for const_cmp")) · [Source](https://doc.rust-lang.org/stable/src/core/cmp.rs.html#1910)[§](#impl-Eq-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#40)[§](#impl-FloatToInt%3Cu64%3E-for-f128)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#37)[§](#impl-FloatToInt%3Cu64%3E-for-f16)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#38)[§](#impl-FloatToInt%3Cu64%3E-for-f32)

[Source](https://doc.rust-lang.org/stable/src/core/convert/num.rs.html#39)[§](#impl-FloatToInt%3Cu64%3E-for-f64)

[Source](https://doc.rust-lang.org/stable/src/core/portable-simd/crates/core_simd/src/cast.rs.html#42)[§](#impl-SimdCast-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/marker.rs.html#264-276)[§](#impl-StructuralPartialEq-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/iter/range.rs.html#17)[§](#impl-TrustedStep-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/clone.rs.html#339-344)[§](#impl-UseCloned-for-u64)

[Source](https://doc.rust-lang.org/stable/src/core/ffi/va_list.rs.html#308)[§](#impl-VaArgSafe-for-u64)
