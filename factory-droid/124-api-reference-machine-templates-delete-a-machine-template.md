...
source: llms
fetched_at: 2026-02-05T21:40:01.508967226-03:00
rendered_js: false
word_count: 62
summary: This document provides the API specification for permanently deleting a machine template and its associated resources via a DELETE request. It outlines the required template ID parameter, authentication headers, and potential response status codes and schemas.
tags:
    - machine-templates
    - api-endpoint
    - delete-operation
