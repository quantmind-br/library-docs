...
url: https://moodledev.io/docs/4.4/apis/subsystems/external/files
source: sitemap
fetched_at: 2026-02-17T15:04:09.534799-03:00
rendered_js: false
word_count: 549
summary: This document explains the available methods for uploading and fetching files in Moodle using either specific web service functions or dedicated HTTP endpoints.
tags:
    - moodle-api
    - file-upload
    - file-download
