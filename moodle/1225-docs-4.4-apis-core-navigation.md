...
url: https://moodledev.io/docs/4.4/apis/core/navigation
source: sitemap
fetched_at: 2026-02-17T15:02:33.320545-03:00
rendered_js: false
word_count: 1881
summary: Provides a technical overview of the Moodle Navigation API, explaining the underlying data structures, their relationship with the $PAGE object, and methods for programmatically extending navigation and settings menus.
tags:
    - moodle
    - navigation-api
    - php
