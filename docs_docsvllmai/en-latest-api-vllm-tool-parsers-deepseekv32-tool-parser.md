---
title: deepseekv32_tool_parser - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/tool_parsers/deepseekv32_tool_parser/
source: sitemap
fetched_at: 2026-05-07T21:35:52.821391643-03:00
rendered_js: false
word_count: 75
summary: This document defines a tool parser class for the DeepSeek-V3 model, providing logic to extract, parse, and type-convert tool function calls from structured model output tags.
tags:
    - deepseek
    - tool-parsing
    - vllm
...
```
classDeepSeekV32ToolParser(ToolParser):
"""
    ...
    def_generate_tool_call_id(self) -> str:
"""Generate a unique tool call ID."""
        return f"call_{uuid.uuid4().hex[:24]}"

    def_parse_invoke_params(self, invoke_str: str) -> dict[str, tuple[str, str]]:
    ...
    def_convert_param_value_checked(self, value: str, param_type: str) -> Any:
"""Convert parameter value to the correct type."""
    ...
    def_convert_param_value(self, value: str, param_type: str | list[str]) -> Any:
"""Convert parameter value to the correct type."""
...
"""Unwrap single 'arguments' / 'input' wrappers when the wrapper
    ...
    def_convert_params_with_schema(
        self,
        function_name: str,
        param_dict: dict[str, tuple[str, str]],
    ) -> dict[str, Any]:
...
"""Extract tool calls from complete model output (non-streaming)."""
    ...
    def_reset_streaming_state(self):
