...
````yaml openapi/openapi.json get /api/models
openapi: 3.1.0
info:
  title: Bifrost API
  description: >
...
paths:
  /api/models:
    get:
      ...
      summary: List models
      description: >
        Lists available models with optional filtering by query, provider, or
        keys.
      ...
      parameters:
        ...
        - name: keys
          in: query
          description: >-
            Comma-separated list of key IDs to filter models accessible by those
            keys
          schema:
            type: string
        - name: limit
