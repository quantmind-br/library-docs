...
source: sitemap
fetched_at: 2026-02-22T18:43:03.378315-03:00
rendered_js: false
word_count: 508
summary: This document provides instructions for managing, updating, and configuring the DankMaterialShell environment, including service management via systemd and manual methods.
tags:
    - dms
    - systemd
    - linux-desktop
...
If you installed via [dankinstall](https://danklinux.com/docs/1.2/dankinstall), DMS is configured as a systemd service by default. The installer runs `systemctl --user enable --now dms` during setup. You don't need to add `dms run` to your compositor config.
