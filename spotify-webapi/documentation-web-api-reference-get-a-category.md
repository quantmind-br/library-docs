...
source: crawler
fetched_at: 2026-02-27T23:46:23.470205-03:00
rendered_js: true
word_count: 151
summary: This document provides technical documentation for the Spotify Web API endpoint used to retrieve metadata for a single browse category, including localization options and response formats. It outlines the request parameters, such as locale, and details the category object returned by the API.
tags:
    - spotify-api
    - browse-category
    - endpoint-reference
