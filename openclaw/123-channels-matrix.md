...
source: sitemap
fetched_at: 2026-01-30T20:37:19.405439879-03:00
rendered_js: false
word_count: 918
summary: This document provides comprehensive instructions for setting up and configuring the Matrix plugin for OpenClaw, including installation, account setup, encryption configuration, and feature capabilities.
tags:
    - matrix
    - plugin
    - configuration
...
If you choose Matrix during configure/onboarding and a git checkout is detected, OpenClaw will offer the local install path automatically. Details: [Plugins](https://docs.openclaw.ai/plugin)
