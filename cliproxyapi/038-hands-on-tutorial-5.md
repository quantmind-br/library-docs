---
title: 'Five: Docker Server Deployment | CLIProxyAPI'
url: https://help.router-for.me/hands-on/tutorial-5
source: crawler
fetched_at: 2026-01-14T22:10:04.186162578-03:00
rendered_js: false
word_count: 889
summary: This document explains how to deploy the CLIProxyAPI on a server using Docker, covering environment preparation, service deployment, log viewing, OAuth authentication setup, and client usage.
tags:
    - docker
    - deployment
    - server
...
## Five: Docker Server Deployment [​](#five-docker-server-deployment)
...
### **1. Environment Preparation** [​](#_1-environment-preparation)
...
### **2. Deploy CLIProxyAPI** [​](#_2-deploy-cliproxyapi)
...
### **4. Add OAuth Authentication** [​](#_4-add-oauth-authentication)
...
#### **Step 1: Generate an authentication link on the server side** [​](#step-1-generate-an-authentication-link-on-the-server-side)
...
#### **Step 2: Establish an SSH tunnel locally** [​](#step-2-establish-an-ssh-tunnel-locally)
...
### **5. Principle Summary** [​](#_5-principle-summary)
