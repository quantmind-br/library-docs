...
url: https://docs.factory.ai/guides/droid-exec/document-automation.md
source: llms
fetched_at: 2026-02-05T21:43:13.848804977-03:00
rendered_js: false
word_count: 454
summary: This document explains how to implement a CI/CD workflow using Droid Exec and GitHub Actions to automatically update documentation when code changes are merged. It provides a complete workflow configuration and best practices for maintaining up-to-date documentation through autonomous discovery and updates.
tags:
    - droid-exec
    - github-actions
