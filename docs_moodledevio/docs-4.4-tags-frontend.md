---
title: 3 docs tagged with "Frontend" | Moodle Developer Resources
url: https://moodledev.io/docs/4.4/tags/frontend
source: sitemap
fetched_at: 2026-02-17T14:59:33.461493-03:00
rendered_js: false
word_count: 99
summary: This document outlines Moodle's implementation of the combobox search component and its framework-independent approach to creating reactive user interfaces.
tags:
    - moodle-development
    - javascript
    - combobox-search
...
## [Creating a reactive UI](https://moodledev.io/docs/4.4/guides/javascript/reactive)
