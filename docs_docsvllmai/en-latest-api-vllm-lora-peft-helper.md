---
title: peft_helper - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/lora/peft_helper/
source: sitemap
fetched_at: 2026-05-07T21:23:01.417758053-03:00
rendered_js: false
word_count: 58
summary: This document defines the PEFTHelper dataclass, which provides a structured interface for validating and processing LoRA configurations within the vLLM framework.
tags:
    - lora
    - peft
...
## PEFTHelper `dataclass` [¶](#vllm.lora.peft_helper.PEFTHelper "Permanent link")
...
"""
    ...
    def_validate_features(self) -> list[str]:
"""
    ...
    @classmethod
    deffrom_dict(cls, config_dict: dict) -> "PEFTHelper":
    ...
    deffrom_local_dir(
        ...
        if tensorizer_config_dict:
            ...
            fromtensorizer.stream_ioimport open_stream
    ...
    defvalidate_legal(self, lora_config: LoRAConfig) -> None:
"""
...
### \_validate\_features [¶](#vllm.lora.peft_helper.PEFTHelper._validate_features "Permanent link")
...
### validate\_legal [¶](#vllm.lora.peft_helper.PEFTHelper.validate_legal "Permanent link")
