...
url: https://doc.rust-lang.org/reference/visibility-and-privacy.html#grammar-Visibility
source: crawler
fetched_at: 2026-05-06T21:25:09.297755962-03:00
rendered_js: false
word_count: 1088
summary: This document explains the visibility and privacy rules in Rust, describing how access to items is controlled through module hierarchies and various publication modifiers.
tags:
    - rust
    - visibility
    - privacy
...
**Syntax**  
[Visibility](https://doc.rust-lang.org/reference/visibility-and-privacy.html#railroad-Visibility) →  
      pub  
    | pub ( crate )  
    | pub ( self )  
    | pub ( super )  
    | pub ( in [SimplePath](https://doc.rust-lang.org/reference/paths.html#grammar-SimplePath) )
