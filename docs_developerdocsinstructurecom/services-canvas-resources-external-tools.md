---
title: External Tools | Instructure Developer Documentation Portal
url: https://developerdocs.instructure.com/services/canvas/resources/external_tools
source: sitemap
fetched_at: 2026-02-15T08:56:10.471772-03:00
rendered_js: false
word_count: 1169
summary: This document describes the API for accessing and configuring external IMS LTI tools and defines the schema for the ContextExternalTool object and its placement configurations.
tags:
    - lti-integration
    - external-tools
    - canvas-api
...
[ExternalToolsController#indexarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
Return all tools at the current context as well as all tools from the parent, and filter the tools list to only those with a placement of ‘editor\_button’
...
Returns a list of [ContextExternalTool](https://developerdocs.instructure.com/services/canvas/resources/external_tools#contextexternaltool) objects.

[ExternalToolsController#generate\_sessionless\_launcharrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
The assignment id for an assignment launch. Required if launch\_type is set to “assessment”.

The assignment id for a module item launch. Required if launch\_type is set to “module\_item”.

The type of launch to perform on the external tool. Placement names (eg. “course\_navigation”) can also be specified to use the custom launch url for that placement; if done, the tool id must be provided.
...
[ExternalToolsController#showarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
Returns a [ContextExternalTool](https://developerdocs.instructure.com/services/canvas/resources/external_tools#contextexternaltool) object.

[ExternalToolsController#createarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
Set the &lt;placement\_configuration\_key&gt; value for a specific placement.

Configuration can be passed in as Common Cartridge XML instead of using query parameters. If this value is “by\_url” or “by\_xml” then an XML configuration will be expected in either the “config\_xml” or “config\_url” parameter. Note that the name parameter overrides the tool name provided in the XML.

Allowed values: `by_url`, `by_xml`

XML tool configuration, as specified in the Common Cartridge XML specification. This is required if “config\_type” is set to “by\_xml”

URL where the server can retrieve an XML tool configuration, as specified in the Common Cartridge XML specification. This is required if “config\_type” is set to “by\_url”

Default: false. If set to true, and if resource\_selection is set to false, the tool won’t show up in the external tool selection UI in modules and assignments
...
[ExternalToolsController#updatearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
[ExternalToolsController#destroyarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
[ExternalToolsController#mark\_rce\_favoritearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
[ExternalToolsController#unmark\_rce\_favoritearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
[ExternalToolsController#add\_top\_nav\_favoritearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
[ExternalToolsController#remove\_top\_nav\_favoritearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
[ExternalToolsController#all\_visible\_nav\_toolsarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
...
List of context\_codes to retrieve visible course nav tools for (for example, `course_123`). Only courses are presently supported.
...
[ExternalToolsController#visible\_course\_nav\_toolsarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/external_tools_controller.rb)
