...
url: https://moodledev.io/docs/5.1/apis/subsystems/privacy
source: sitemap
fetched_at: 2026-02-17T15:37:01.846584-03:00
rendered_js: false
word_count: 4733
summary: This document provides technical guidance for Moodle plugin developers on implementing the privacy API to comply with GDPR regulations regarding personal data handling.
tags:
    - moodle
    - gdpr-compliance
    - privacy-api
...
- While implementing the privacy API into your plugin, there are CLI scripts that can help you to test things on the fly. Just don't forget these are not supposed to replace proper unit tests. See [Privacy API/Utilities](https://moodledev.io/docs/5.1/apis/subsystems/privacy/utils) for details.
...
- [Subject Access Request FAQ](https://moodledev.io/docs/5.1/apis/subsystems/privacy/faq)
- [GDPR](https://docs.moodle.org/en/GDPR) in the user documentation
- [Privacy API/Utilities](https://moodledev.io/docs/5.1/apis/subsystems/privacy/utils) provides CLI scripts that are helpful during development