...
source: llms
fetched_at: 2026-04-16T22:32:57.985344052-03:00
rendered_js: false
word_count: 4125
summary: This guide explains how to use hooks to automate workflows within Claude Code by executing shell commands at specific lifecycle events. It provides instructions for configuration, verification, and common use cases like notifications and auto-formatting.
tags:
    - claude-code
    - automation
