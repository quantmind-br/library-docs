...
source: crawler
fetched_at: 2026-02-04T08:47:37.583313678-03:00
rendered_js: false
word_count: 1278
summary: This document provides comprehensive instructions and optimization details for running DeepSeek V3, V3.1, and R1 models using the SGLang inference engine. It covers hardware-specific launch commands, deployment strategies for multi-node setups, and architectural enhancements like Multi-head Latent Attention.
tags:
    - deepseek-v3
    - deepseek-r1
    - sglang
...
## DeepSeek V3/V3.1/R1 Usage[#](#deepseek-v3-v3-1-r1-usage "Link to this heading")
...
This document outlines current optimizations for DeepSeek. For an overview of the implemented features see the completed [Roadmap](https://github.com/sgl-project/sglang/issues/2591).

## Launch DeepSeek V3.1/V3/R1 with SGLang[#](#launch-deepseek-v3-1-v3-r1-with-sglang "Link to this heading")
...
### Download Weights[#](#download-weights "Link to this heading")
...
### Launch with one node of 8 x H200[#](#launch-with-one-node-of-8-x-h200 "Link to this heading")

Please refer to [the example](https://github.com/sgl-project/sglang/tree/main/benchmark/deepseek_v3#installation--launch).

### Running examples on Multi-Node[#](#running-examples-on-multi-node "Link to this heading")
...
### Multi-head Latent Attention (MLA) Throughput Optimizations[#](#multi-head-latent-attention-mla-throughput-optimizations "Link to this heading")
...
### Data Parallelism Attention[#](#data-parallelism-attention "Link to this heading")
...
### Multi-Node Tensor Parallelism[#](#multi-node-tensor-parallelism "Link to this heading")
...
### Block-wise FP8[#](#block-wise-fp8 "Link to this heading")
...
```
python3-msglang.compile_deep_gemm--modeldeepseek-ai/DeepSeek-V3--tp8--trust-remote-code
```
...
**Usage**: Add `--speculative-algorithm EAGLE`. Other flags, like `--speculative-num-steps`, `--speculative-eagle-topk` and `--speculative-num-draft-tokens` are optional. For example:
...
### Reasoning Content for DeepSeek R1 & V3.1[#](#reasoning-content-for-deepseek-r1-v3-1 "Link to this heading")
...
### Function calling for DeepSeek Models[#](#function-calling-for-deepseek-models "Link to this heading")
...
### Thinking Budget for DeepSeek R1[#](#thinking-budget-for-deepseek-r1 "Link to this heading")
...
fromsglang.srt.sampling.custom_logit_processorimport DeepSeekR1ThinkingBudgetLogitProcessor
