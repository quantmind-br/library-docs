...
url: https://moodledev.io/docs/5.0/tags/gdpr
source: sitemap
fetched_at: 2026-02-17T15:19:13.451694-03:00
rendered_js: false
word_count: 104
summary: This document introduces the Moodle Privacy API, outlining its role in GDPR compliance and providing resources for developers such as FAQs and CLI testing utilities.
tags:
    - moodle-development
    - privacy-api
    - gdpr-compliance
...
## [FAQs](https://moodledev.io/docs/5.0/apis/subsystems/privacy/faq)
...
## [Utilities](https://moodledev.io/docs/5.0/apis/subsystems/privacy/utils)
