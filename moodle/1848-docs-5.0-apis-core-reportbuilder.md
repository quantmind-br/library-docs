...
url: https://moodledev.io/docs/5.0/apis/core/reportbuilder
source: sitemap
fetched_at: 2026-02-17T15:25:00.242004-03:00
rendered_js: false
word_count: 2129
summary: This document provides a technical overview of the report builder API, explaining how to define and implement reusable report elements such as columns, filters, and entities. It details the process of data retrieval, formatting, and organization required to create standardized system and custom reports.
tags:
    - moodle-api
    - report-builder
    - data-reporting
...
You may also optionally define the [initial values for any of the default conditions](https://moodledev.io/docs/5.0/apis/core/reportbuilder/filtering) by overriding the `get_default_condition_values()` method.
