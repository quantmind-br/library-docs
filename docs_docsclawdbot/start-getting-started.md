...
source: llms
fetched_at: 2026-01-26T09:53:52.816065005-03:00
rendered_js: false
word_count: 666
summary: This document provides a step-by-step guide to installing and configuring clawdbot, from initial CLI setup and onboarding to gateway deployment and chat channel pairing.
tags:
    - clawdbot-setup
    - installation-guide
    - cli-onboarding
