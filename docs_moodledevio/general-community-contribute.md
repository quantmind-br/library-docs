...
url: https://moodledev.io/general/community/contribute
source: sitemap
fetched_at: 2026-02-17T15:55:35.798887-03:00
rendered_js: false
word_count: 477
summary: This document outlines various methods for contributing to the Moodle project, including reporting bugs, developing plugins, and proposing new features through the community tracker. It provides a step-by-step guide on how to navigate the contribution process and increase the likelihood of feature implementation.
tags:
    - moodle-development
...
- **Found a bug?** [Report an issue](https://moodledev.io/general/development/tracker#reporting-an-issue) in our bug tracker.
...
- **Ready to help coding**? Check the [getting started](https://moodledev.io/general/development/gettingstarted) page.
...
- **Get involved in the developer resources**, [contributing](https://moodledev.io/general/documentation/contributing) for fixing typos and errors, migrating pages, expanding the content, etc.
...
## Where to begin[​](#where-to-begin "Direct link to Where to begin")
...
- Promising ideas are added to the [Roadmap](https://moodledev.io/general/community/roadmap) (depending on funding availability).
- Small feature ideas and improvements may be added to core by the component maintainer.

## How to maximise the chance of your idea being implemented[​](#how-to-maximise-the-chance-of-your-idea-being-implemented "Direct link to How to maximise the chance of your idea being implemented")
