---
title: Moodle 3.9.3 | Moodle Developer Resources
url: https://moodledev.io/general/releases/3.9/3.9.3
source: sitemap
fetched_at: 2026-02-17T16:14:25.998526-03:00
rendered_js: false
word_count: 651
summary: This document outlines the release notes for Moodle 3.9.3, detailing general bug fixes, security improvements, accessibility enhancements, and critical upgrade warnings.
tags:
    - moodle
    - release-notes
    - bug-fixes
...
Here is [the full list of fixed issues in 3.9.3](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%223.9.3%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
- [MDL-68167](https://moodle.atlassian.net/browse/MDL-68167) - Fix core/form\_autocomplete accessibility issues
...
- [Notes de mise à jour de Moodle 3.9.3](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_3.9.3)
