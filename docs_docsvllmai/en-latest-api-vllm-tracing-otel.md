---
title: otel - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/tracing/otel/
source: sitemap
fetched_at: 2026-05-07T21:36:36.388145206-03:00
rendered_js: false
word_count: 125
summary: This document provides an API reference for utility functions used to initialize, instrument, and propagate OpenTelemetry traces within the vLLM framework.
tags:
    - opentelemetry
    - tracing
    - distributed-tracing
...
## \_get\_smart\_context [¶](#vllm.tracing.otel._get_smart_context "Permanent link")
...
```
def_get_smart_context() -> Context | None:
"""
...
## init\_otel\_tracer [¶](#vllm.tracing.otel.init_otel_tracer "Permanent link")
...
## init\_otel\_worker\_tracer [¶](#vllm.tracing.otel.init_otel_worker_tracer "Permanent link")
...
## instrument\_otel [¶](#vllm.tracing.otel.instrument_otel "Permanent link")

```
instrument_otel(
    func, span_name, attributes, record_exception
)
```
...
```
definstrument_otel(func, span_name, attributes, record_exception):
"""Internal wrapper logic for sync and async functions."""
    ...
    async defasync_wrapper(*args, **kwargs):
...
## manual\_instrument\_otel [¶](#vllm.tracing.otel.manual_instrument_otel "Permanent link")
...
## propagate\_trace\_to\_env [¶](#vllm.tracing.otel.propagate_trace_to_env "Permanent link")
