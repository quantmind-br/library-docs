...
url: https://moodledev.io/docs/5.2/tags/core-dml
source: sitemap
fetched_at: 2026-02-17T15:39:04.406409-03:00
rendered_js: false
word_count: 136
summary: This document provides an overview of Moodle's database APIs, covering tools for defining database structures, manipulating data, handling drivers, and managing transactions.
tags:
    - moodle-api
    - database-management
    - dml
