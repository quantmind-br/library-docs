...
source: crawler
fetched_at: 2026-03-03T08:23:15.236771-03:00
rendered_js: true
word_count: 976
summary: This document explains how the Ghostty project is supported through donations as a fiscally sponsored non-profit under Hack Club, detailing how funds are used, contributor compensation, and the benefits of its non-profit structure.
tags:
    - non-profit
    - donations
    - fiscal-sponsorship
...
7% of all donations go directly to Hack Club. This covers the administrative costs of fiscal sponsorship, but also supports [Hack Club's broader mission](https://hackclub.com/philosophy/) to empower the next generation of technically-minded individuals around the world.
...
All of Ghostty's finances down to individual transactions are [transparent](https://hcb.hackclub.com/ghostty), so you can see exactly how funds are being used and where donations are coming from.
...
The project continues to follow a [BDFL](https://en.wikipedia.org/wiki/Benevolent_dictator_for_life) model, with Mitchell Hashimoto serving as the project lead and final authority on all decisions, including the direction of funds within the non-profit (in accordance with the mission statement and legal requirements).
...
We're grateful for the companies that support Ghostty's development through infrastructure, services, or financial contributions.
