---
title: CLI Updates
url: https://docs.factory.ai/changelog/cli-updates.md
source: llms
fetched_at: 2026-02-05T21:40:30.634123905-03:00
rendered_js: false
word_count: 6119
summary: This document provides a chronological log of updates, new features, and bug fixes for the Factory CLI, tracking improvements in performance, UI, and platform support.
tags:
    - factory-cli
    - changelog
    - release-notes
...
<Update label="November 1" rss={{ title: "CLI Updates", description: "MCP Registry, tool permissions, session resume, and multiple bug fixes" }}>
  ...
  * **MCP Registry** - Added a curated selection of MCP servers for easy discovery and setup
    ...
    <img src="https://mintcdn.com/factory/g8HOmy6isliNA7ef/images/mcp-registry-2.gif?s=07ba446161ea8455ebc1e74351422266" alt="MCP Registry interface showing curated MCP servers" data-og-width="1280" width="1280" data-og-height="720" height="720" data-path="images/mcp-registry-2.gif" data-optimize="true" data-opv="3" />
