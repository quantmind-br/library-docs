...
url: https://moodledev.io/docs/5.2/apis/subsystems/favourites
source: sitemap
fetched_at: 2026-02-17T15:45:41.280212-03:00
rendered_js: false
word_count: 746
summary: This document explains the Moodle Favourites API, detailing how to uniquely identify, store, retrieve, and delete user-specific bookmarks for various database items.
tags:
    - moodle-development
    - favourites-api
    - php-api
