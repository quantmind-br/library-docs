---
title: Examples - DSPy
url: https://dspy.ai/deep-dive/data-handling/examples/
source: sitemap
fetched_at: 2026-01-23T08:03:10.265470706-03:00
rendered_js: false
word_count: 299
summary: This document explains how to use the Example class in DSPy to manage data for training and evaluation, including methods for defining inputs and labels.
tags:
    - dspy
    - example-class
    - data-handling
...
[](https://github.com/stanfordnlp/dspy/blob/main/docs/docs/deep-dive/data-handling/examples.md "Edit this page")
...
## Creating an `Example`[¶](#creating-an-example "Permanent link")
...
## Element Access and Updation[¶](#element-access-and-updation "Permanent link")
...
## Iterating over Example[¶](#iterating-over-example "Permanent link")
