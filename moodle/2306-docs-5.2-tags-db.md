...
url: https://moodledev.io/docs/5.2/tags/db
source: sitemap
fetched_at: 2026-02-17T15:39:22.309885-03:00
rendered_js: false
word_count: 106
summary: This document provides an overview and access to Moodle's database APIs for defining structures, manipulating data, and handling exceptions to ensure cross-RDBMS compatibility.
tags:
    - moodle
    - database-api
    - dml
...
## [Database schema](https://moodledev.io/docs/5.2/apis/core/dml/database-schema)
