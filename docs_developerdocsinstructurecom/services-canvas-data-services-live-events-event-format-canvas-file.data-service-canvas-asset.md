---
title: Asset | Instructure Developer Documentation Portal
url: https://developerdocs.instructure.com/services/canvas/data-services/live-events/event-format/canvas/file.data_service_canvas_asset
source: sitemap
fetched_at: 2026-02-15T09:05:56.42308-03:00
rendered_js: false
word_count: 439
summary: This document defines the asset_accessed event structure in Canvas LMS, detailing how user interactions with various objects like courses, quizzes, and files are tracked and recorded.
tags:
    - canvas-lms
    - asset-accessed
    - event-telemetry
...
**Description:** type=user, subtype=calendar\_feed
...
**Description:** type=context\_external\_tool (this type is used to identify all LTI versions except LTI 2.0 launches)
...
**Description:** type=lti/tool\_proxy (this type is used to identify LTI 2.0 launches)
...
**Description:** type=course, subtype=calendar\_feed
...
**Description:** type=group, subtype=calendar\_feed
...
**Description:** type=calendar\_event
...
**Description:** type=course, subtype=speed\_grader
...
**Description:** type=web\_conference
...
**Description:** type=learning\_outcome
...
**Description:** type=discussion\_topic
...
A categorized list of values based on the asset or asset subtype accessed. (announcements, assignments, calendar, collaborations, conferences, external\_tools, external\_urls, files, grades, home, modules, outcomes, pages, quizzes, roster, syllabus, topics, wiki)

The display name of the attachment, possibly truncated.

The domain of the LTI tool, when subtype is context\_external\_tool.

The file name of the attachment, possibly truncated.

Usually null, can be used to indicate a deeper level of access. Can be "submit" for assignments. Can be "participate" for collaboration, calendar, discussion\_topic (user posts to topic), quizzes:quiz, web\_conference, or wiki\_page (page created or edited).
...
The URL of the LTI tool, when subtype is context\_external\_tool.
