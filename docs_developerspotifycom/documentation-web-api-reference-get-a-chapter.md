...
source: crawler
fetched_at: 2026-02-27T23:38:34.367972-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response representing the metadata structure for an audiobook chapter or podcast episode within an API.
tags:
    - api-response
    - audiobook-metadata
    - json-schema
