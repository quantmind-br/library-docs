---
title: int8_utils - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/layers/quantization/utils/int8_utils/
source: sitemap
fetched_at: 2026-05-07T21:27:57.338724595-03:00
rendered_js: false
word_count: 437
summary: This document provides Triton-accelerated utility functions for int8 quantization, block-wise matrix multiplication, and dequantization, along with configuration management for optimized kernel execution.
tags:
    - triton
    - quantization
    - int8
...
## \_per\_token\_group\_quant\_int8 [¶](#vllm.model_executor.layers.quantization.utils.int8_utils._per_token_group_quant_int8 "Permanent link")
...
```
@triton.jit
def_per_token_group_quant_int8(
...
## \_w8a8\_block\_int8\_matmul [¶](#vllm.model_executor.layers.quantization.utils.int8_utils._w8a8_block_int8_matmul "Permanent link")
...
## block\_dequant [¶](#vllm.model_executor.layers.quantization.utils.int8_utils.block_dequant "Permanent link")
...
## get\_w8a8\_block\_int8\_configs `cached` [¶](#vllm.model_executor.layers.quantization.utils.int8_utils.get_w8a8_block_int8_configs "Permanent link")
...
```
@functools.lru_cache
defget_w8a8_block_int8_configs(
...
## input\_to\_int8 [¶](#vllm.model_executor.layers.quantization.utils.int8_utils.input_to_int8 "Permanent link")
...
## per\_token\_group\_quant\_int8 [¶](#vllm.model_executor.layers.quantization.utils.int8_utils.per_token_group_quant_int8 "Permanent link")
...
## w8a8\_block\_int8\_matmul [¶](#vllm.model_executor.layers.quantization.utils.int8_utils.w8a8_block_int8_matmul "Permanent link")
