...
source: crawler
fetched_at: 2026-05-06T21:21:48.83833859-03:00
rendered_js: false
word_count: 351
summary: The dbg! macro is a debugging utility in Rust that prints an expression's value, source location, and source code to standard error while returning the expression's result.
tags:
    - rust
    - debugging
    - macros
