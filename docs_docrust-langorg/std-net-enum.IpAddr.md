...
source: crawler
fetched_at: 2026-05-06T21:21:48.915064729-03:00
rendered_js: false
word_count: 1144
summary: This document describes the IpAddr enum in Rust, which provides a unified type for representing both IPv4 and IPv6 network addresses along with various utility methods for address inspection and classification.
tags:
    - rust
    - ip-address
    - networking
...
This enum can contain either an [`Ipv4Addr`](https://doc.rust-lang.org/std/net/struct.Ipv4Addr.html "struct std::net::Ipv4Addr") or an [`Ipv6Addr`](https://doc.rust-lang.org/std/net/struct.Ipv6Addr.html "struct std::net::Ipv6Addr"), see their respective documentation for more details.
...
[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#235)[§](#impl-IpAddr)
...
See the documentation for [`Ipv4Addr::is_unspecified()`](https://doc.rust-lang.org/std/net/struct.Ipv4Addr.html#method.is_unspecified "method std::net::Ipv4Addr::is_unspecified") and [`Ipv6Addr::is_unspecified()`](https://doc.rust-lang.org/std/net/struct.Ipv6Addr.html#method.is_unspecified "method std::net::Ipv6Addr::is_unspecified") for more details.
...
See the documentation for [`Ipv4Addr::is_loopback()`](https://doc.rust-lang.org/std/net/struct.Ipv4Addr.html#method.is_loopback "method std::net::Ipv4Addr::is_loopback") and [`Ipv6Addr::is_loopback()`](https://doc.rust-lang.org/std/net/struct.Ipv6Addr.html#method.is_loopback "method std::net::Ipv6Addr::is_loopback") for more details.
...
See the documentation for [`Ipv4Addr::is_global()`](https://doc.rust-lang.org/std/net/struct.Ipv4Addr.html#method.is_global "method std::net::Ipv4Addr::is_global") and [`Ipv6Addr::is_global()`](https://doc.rust-lang.org/std/net/struct.Ipv6Addr.html#method.is_global "method std::net::Ipv6Addr::is_global") for more details.
...
See the documentation for [`Ipv4Addr::is_multicast()`](https://doc.rust-lang.org/std/net/struct.Ipv4Addr.html#method.is_multicast "method std::net::Ipv4Addr::is_multicast") and [`Ipv6Addr::is_multicast()`](https://doc.rust-lang.org/std/net/struct.Ipv6Addr.html#method.is_multicast "method std::net::Ipv6Addr::is_multicast") for more details.
...
See the documentation for [`Ipv4Addr::is_documentation()`](https://doc.rust-lang.org/std/net/struct.Ipv4Addr.html#method.is_documentation "method std::net::Ipv4Addr::is_documentation") and [`Ipv6Addr::is_documentation()`](https://doc.rust-lang.org/std/net/struct.Ipv6Addr.html#method.is_documentation "method std::net::Ipv6Addr::is_documentation") for more details.
...
See the documentation for [`Ipv4Addr::is_benchmarking()`](https://doc.rust-lang.org/std/net/struct.Ipv4Addr.html#method.is_benchmarking "method std::net::Ipv4Addr::is_benchmarking") and [`Ipv6Addr::is_benchmarking()`](https://doc.rust-lang.org/std/net/struct.Ipv6Addr.html#method.is_benchmarking "method std::net::Ipv6Addr::is_benchmarking") for more details.
...
Returns [`true`](https://doc.rust-lang.org/std/primitive.bool.html "primitive bool") if this address is an [`IPv4` address](https://doc.rust-lang.org/std/net/enum.IpAddr.html#variant.V4 "variant std::net::IpAddr::V4"), and [`false`](https://doc.rust-lang.org/std/primitive.bool.html "primitive bool") otherwise.
...
Returns [`true`](https://doc.rust-lang.org/std/primitive.bool.html "primitive bool") if this address is an [`IPv6` address](https://doc.rust-lang.org/std/net/enum.IpAddr.html#variant.V6 "variant std::net::IpAddr::V6"), and [`false`](https://doc.rust-lang.org/std/primitive.bool.html "primitive bool") otherwise.
...
[Source](https://doc.rust-lang.org/src/core/net/parser.rs.html#295)[§](#impl-IpAddr-1)
...
1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#29)[§](#impl-Clone-for-IpAddr)

1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1083)[§](#impl-Debug-for-IpAddr)

1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1073)[§](#impl-Display-for-IpAddr)
...
[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2344)[§](#method.from-4)
...
[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2316)[§](#method.from-3)
...
[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1276)[§](#method.from-2)
...
[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1107)[§](#method.from)
...
[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1130)[§](#method.from-1)
...
1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/parser.rs.html#316)[§](#impl-FromStr-for-IpAddr)

[Source](https://doc.rust-lang.org/src/core/net/parser.rs.html#317)[§](#associatedtype.Err)

The associated error which can be returned from parsing.

[Source](https://doc.rust-lang.org/src/core/net/parser.rs.html#318)[§](#method.from_str)
...
1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#29)[§](#impl-Ord-for-IpAddr)

1.16.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1175)[§](#impl-PartialEq%3CIpAddr%3E-for-Ipv4Addr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1177)[§](#method.eq-2)
...
1.16.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2158)[§](#impl-PartialEq%3CIpAddr%3E-for-Ipv6Addr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2160)[§](#method.eq-3)
...
1.16.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1164)[§](#impl-PartialEq%3CIpv4Addr%3E-for-IpAddr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1166)[§](#method.eq-1)
...
1.16.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2169)[§](#impl-PartialEq%3CIpv6Addr%3E-for-IpAddr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2171)[§](#method.eq-4)
...
1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#29)[§](#impl-PartialEq-for-IpAddr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#29)[§](#method.eq)
...
1.16.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1205)[§](#impl-PartialOrd%3CIpAddr%3E-for-Ipv4Addr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1207)[§](#method.partial_cmp-2)
...
1.16.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2199)[§](#impl-PartialOrd%3CIpAddr%3E-for-Ipv6Addr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2201)[§](#method.partial_cmp-4)
...
1.16.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1194)[§](#impl-PartialOrd%3CIpv4Addr%3E-for-IpAddr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#1196)[§](#method.partial_cmp-1)
...
1.16.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2188)[§](#impl-PartialOrd%3CIpv6Addr%3E-for-IpAddr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#2190)[§](#method.partial_cmp-3)
...
1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#29)[§](#impl-PartialOrd-for-IpAddr)

[Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#29)[§](#method.partial_cmp)
...
1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#29)[§](#impl-Copy-for-IpAddr)

1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#29)[§](#impl-Eq-for-IpAddr)

1.7.0 · [Source](https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#29)[§](#impl-StructuralPartialEq-for-IpAddr)
