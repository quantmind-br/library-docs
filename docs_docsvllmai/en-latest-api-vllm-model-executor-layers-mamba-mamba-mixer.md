---
title: mamba_mixer - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/layers/mamba/mamba_mixer/
source: sitemap
fetched_at: 2026-05-07T21:25:56.438303205-03:00
rendered_js: false
word_count: 7
summary: This document defines the MambaMixer class, which implements a selective state space model layer for neural networks, handling state space parameter computation and integrated parallel linear operations.
tags:
    - mamba
    - deep-learning
    - state-space-models
...
"""
    ...
    **selective** state spaces)
    ...
    def__init__(
        ...
        defweight_loader(param: Parameter, loaded_weight: torch.Tensor):
        ...
        defA_weight_loader(param: Parameter, loaded_weight: torch.Tensor):
    ...
    defforward(self, hidden_states: torch.Tensor, output: torch.Tensor):
    ...
    defforward_impl(self, hidden_states: torch.Tensor, output: torch.Tensor):
"""
    ...
    def_time_proj_bias(self) -> torch.Tensor | None:
