...
url: https://moodledev.io/docs/4.5/apis/core/hooks
source: sitemap
fetched_at: 2026-02-17T15:11:21.373707-03:00
rendered_js: false
word_count: 1558
summary: This document explains the Moodle Hooks API, a PSR-14 compliant system for inter-plugin communication that replaces legacy lib.php callbacks. It covers the creation, registration, and dispatching of hooks within the Moodle framework.
tags:
    - hooks-api
    - psr-14
    - moodle-development
...
From Moodle 4.4 you should make use of the [Dependency Injection](https://moodledev.io/docs/4.5/apis/core/di) system, for example:
...
Callbacks *are executed during system installation and all upgrades*, the callback methods must verify the plugin is in correct state. Often the easiest way is to use function during\_initial\_install() or version string from the plugin configuration.
