...
url: https://moodledev.io/docs/5.0/apis/plugintypes/tiny
source: sitemap
fetched_at: 2026-02-17T15:26:54.463476-03:00
rendered_js: false
word_count: 1594
summary: This document explains how to develop and structure subplugins for the TinyMCE text editor in Moodle, covering directory layouts, plugin generation, and JavaScript implementation.
tags:
    - moodle
    - tinymce
    - editor-plugins
