...
source: crawler
fetched_at: 2026-02-27T23:46:55.428749-03:00
rendered_js: false
word_count: 2
summary: This document provides a sample JSON response format for the Spotify API endpoint used to retrieve a user's saved shows and podcasts.
tags:
    - spotify-api
    - json-response
    - user-library
