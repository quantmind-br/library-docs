...
url: https://github.com/openagen/zeroclaw/blob/master/docs/security/frictionless-security.md
source: git
fetched_at: 2026-05-02T14:52:08.684302876-03:00
rendered_js: false
word_count: 347
optimized: true
...
category: concept
---
# Frictionless Security: Zero Impact on User Experience
...
Security features automatically detect and configure themselves during first run. No new wizard steps, no additional prompts — just silent protection that adapts to the platform and available tools.
