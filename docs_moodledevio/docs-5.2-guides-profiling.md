...
url: https://moodledev.io/docs/5.2/guides/profiling
source: sitemap
fetched_at: 2026-02-17T15:47:10.123144-03:00
rendered_js: false
word_count: 1027
summary: This document provides instructions for configuring and using XHProf and Xdebug profilers to analyze PHP performance and identify code bottlenecks within a Moodle environment.
tags:
    - php-profiling
    - moodle-development
    - xhprof
