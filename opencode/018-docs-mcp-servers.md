...
source: sitemap
fetched_at: 2026-04-17T06:37:37.763785045-03:00
rendered_js: false
word_count: 1008
summary: This document explains how to configure, enable, and manage Model Context Protocol (MCP) servers within OpenCode for both local and remote environments. It provides technical guidance on setting up authentication via OAuth or API keys and managing server visibility in the user's config.
tags:
    - mcp
    - opencode-config
