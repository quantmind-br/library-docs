...
url: https://moodledev.io/docs/4.4/apis/core/user
source: sitemap
fetched_at: 2026-02-17T15:02:40.812306-03:00
rendered_js: false
word_count: 1070
summary: This document outlines Moodle APIs for managing user data, including methods for displaying profile information, validating and cleaning user fields, and implementing user selection interfaces.
tags:
    - moodle-development
    - user-api
    - user-fields
...
- [Access API](https://moodledev.io/docs/4.4/apis/subsystems/access)
