---
title: GLM-4.5 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/GLM/GLM-4.5
source: sitemap
fetched_at: 2026-05-11T05:50:54.661526375-03:00
rendered_js: false
word_count: 685
summary: This document provides a guide for deploying and utilizing the GLM-4.5 language model within the SGLang framework, including configurations for reasoning, tool calling, and hardware-specific optimizations.
tags:
    - sglang
    - glm-4.5
    - llm-deployment
...
[GLM-4.5](https://huggingface.co/zai-org/GLM-4.5) is a powerful language model developed by Zhipu AI, featuring advanced capabilities in reasoning, function calling, and multi-modal understanding. **Key Features:**
...
**License:** Please refer to the [official GLM-4.5 model card](https://huggingface.co/zai-org/GLM-4.5) for license details.
...
For more detailed configuration tips, please refer to [GLM-4.5/GLM-4.6 Usage](https://docs.sglang.io/docs/basic_usage/glm45).
