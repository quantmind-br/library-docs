...
source: crawler
fetched_at: 2026-02-01T21:12:30.345380532-03:00
rendered_js: false
word_count: 928
summary: This document explains the Ratatui coordinate system and demonstrates how to structure terminal user interfaces using the Layout struct and various sizing constraints.
tags:
    - ratatui
    - rust
    - terminal-ui
...
foriin0..10 {
letarea= Rect::new(0, i, frame.area().width, 1);
...
[Section titled “The Layout struct”](#the-layout-struct)
...
letouter_layout= Layout::default()
.direction(Direction::Vertical)
.constraints(vec![
Constraint::Percentage(50),
Constraint::Percentage(50),
...
.split(f.area());
letinner_layout= Layout::default()
