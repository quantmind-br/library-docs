...
url: https://moodledev.io/docs/4.1/apis/core/dml
source: sitemap
fetched_at: 2026-02-17T14:54:40.771391-03:00
rendered_js: false
word_count: 2451
summary: This document explains the Moodle Data Manipulation API, detailing how to use the $DB global object for secure, cross-database compatible operations. It provides guidance on core concepts like SQL placeholders and table prefixes alongside a reference for various record retrieval functions.
tags:
    - moodle-api
...
- [DML exceptions](https://moodledev.io/docs/4.1/apis/core/dml/exceptions): New DML code is throwing exceptions instead of returning false if anything goes wrong
- [DML drivers](https://moodledev.io/docs/4.1/apis/core/dml/drivers): Database drivers for new DML layer
- [DDL functions](https://moodledev.io/docs/4.1/apis/core/dml/ddl): Where all the functions used to handle DB objects ([DDL](https://en.wikipedia.org/wiki/Data_Definition_Language)) are defined.