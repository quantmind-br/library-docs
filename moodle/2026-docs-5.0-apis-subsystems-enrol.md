...
url: https://moodledev.io/docs/5.0/apis/subsystems/enrol
source: sitemap
fetched_at: 2026-02-17T15:27:13.728845-03:00
rendered_js: false
word_count: 886
summary: This document explains the Moodle enrolment API, detailing how to manage user course participation, distinguish between enrolments and roles, and use specific PHP functions for plugin interaction.
tags:
    - moodle-development
    - enrolment-api
    - user-management
...
The enrolment API gives access to the enrolment methods and also to [enrolment plugins](https://moodledev.io/docs/5.0/apis/plugintypes/enrol) instances.
