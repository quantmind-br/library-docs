...
source: crawler
fetched_at: 2026-01-28T16:18:30.079076261-03:00
rendered_js: false
word_count: 340
summary: This document outlines significant breaking changes and deprecations in the mitmproxy addon API across different versions, providing developers with a guide for migrating their existing addons.
tags:
    - mitmproxy
    - addon-api
    - api-changes
