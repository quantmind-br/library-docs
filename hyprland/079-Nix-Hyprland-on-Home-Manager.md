...
source: sitemap
fetched_at: 2026-01-22T22:14:56.336783026-03:00
rendered_js: false
word_count: 375
summary: This document provides instructions for installing and configuring the Hyprland window manager using NixOS and Home Manager modules. It covers declarative configuration, plugin integration, and troubleshooting common environment and theming issues.
tags:
    - nixos
    - home-manager
    - hyprland
