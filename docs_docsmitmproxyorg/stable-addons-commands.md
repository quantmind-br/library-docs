...
source: crawler
fetched_at: 2026-01-28T16:18:25.608416508-03:00
rendered_js: false
word_count: 592
summary: This document explains how to define and use custom commands within mitmproxy addons. It details the declaration process using decorators, mandatory type annotations for arguments and return values, and how to handle special types like flows and file paths.
tags:
    - mitmproxy
    - addons
    - commands
