...
url: https://docs.mistral.ai/cookbooks/concept-deep-dive-tokenization-control_tokens
source: crawler
fetched_at: 2026-01-29T07:34:52.515141882-03:00
rendered_js: false
word_count: 533
summary: This document explains the concept of control tokens, detailing how they address efficiency, security, and boundary issues in language model tokenization compared to standard string markers.
tags:
    - control-tokens
    - tokenization
    - prompt-injection
...
The only difference between V2 and V3 is regarding the **tool calling**, otherwise everything is identical. You can learn more about tool calling [here](https://docs.mistral.ai/cookbooks/concept-deep-dive-tokenization-tool_calling).
