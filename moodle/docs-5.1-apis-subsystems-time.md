...
url: https://moodledev.io/docs/5.1/apis/subsystems/time
source: sitemap
fetched_at: 2026-02-17T15:37:27.141986-03:00
rendered_js: false
word_count: 829
summary: This document explains Moodle's Time API, detailing how it handles internal Unix timestamps, distinguishes between system and user time, and utilizes PSR-20 compliant clock interfaces.
tags:
    - moodle-development
    - time-api
    - unix-timestamp
...
The `\core\clock` Interface was added in Moodle 4.4 and is available via [Dependency Injection](https://moodledev.io/docs/5.1/apis/core/di). It provides a [clock implementation](https://moodledev.io/docs/5.1/apis/core/clock) which is consistent with the [PSR-20: Clock](https://www.php-fig.org/psr/psr-20/) interfaces.
...
You can read more on [Unit testing](https://moodledev.io/docs/5.1/apis/core/clock#unit-testing) with the Clock API.
