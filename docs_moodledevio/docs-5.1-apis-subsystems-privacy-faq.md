...
url: https://moodledev.io/docs/5.1/apis/subsystems/privacy/faq
source: sitemap
fetched_at: 2026-02-17T15:37:05.47824-03:00
rendered_js: false
word_count: 723
summary: Guidance for Moodle plugin developers on identifying and reporting user data for the Privacy API, covering scenarios like notifications, sessions, and external storage.
tags:
    - moodle-development
    - privacy-api
    - gdpr-compliance
