...
url: https://moodledev.io/docs/4.1/apis/subsystems/enrol
source: sitemap
fetched_at: 2026-02-17T14:56:03.811995-03:00
rendered_js: false
word_count: 808
summary: This document explains the Moodle Enrolment API, detailing how to manage user course participation, distinguish between enrolments and role assignments, and utilize core functions for querying and modifying enrolment states.
tags:
    - moodle-development
    - enrolment-api
    - user-management
...
The enrolment API gives access to the enrolment methods and also to [enrolment plugins](https://moodledev.io/docs/4.1/apis/plugintypes/enrol) instances.
