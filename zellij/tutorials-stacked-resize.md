...
url: https://zellij.dev/tutorials/stacked-resize/
source: sitemap
fetched_at: 2026-01-24T15:53:02.22350648-03:00
rendered_js: false
word_count: 2106
summary: This tutorial explains how to manage complex terminal layouts in Zellij using the stacked resize and pinned floating panes features. It provides a step-by-step workflow for organizing multiple panes and maintaining visibility of background tasks while focusing on specific windows.
tags:
    - zellij
...
![An image of Zellij two editor panes side by side.](https://zellij.dev/img/stacked-resize-tutorial-1.png)
...
![An image of Zellij two editor panes side by side, one of them taking up more space.](https://zellij.dev/img/stacked-resize-tutorial-2.png)
...
![An image of Zellij two editor panes in a stack one on top of the other.](https://zellij.dev/img/stacked-resize-tutorial-3.png)
...
![An image of a stack of panes taking up the full Zellij screen, with two editor panes and some additional panes running other commands.](https://zellij.dev/img/stacked-resize-tutorial-4.png)
...
![An image of a stack of panes taking up the right side of the Zellij screen, with an additional single pane taking up the left side.](https://zellij.dev/img/stacked-resize-tutorial-5.png)
...
![An image of a stack of panes taking up the right side of the Zellij screen, with two additional panes taking up the left side one on top of the other - one running cargo test, the other tailing a log file.](https://zellij.dev/img/stacked-resize-tutorial-6.png)
...
![An image of a stack of panes taking up the right half of the Zellij screen, with an additional stack taking up the left half of the screen.](https://zellij.dev/img/stacked-resize-tutorial-7.png)
...
![An image of a stack of panes taking up the right half of the Zellij screen, with an additional stack taking up the left half of the screen. This time, the bottom of the stack includes the watchexec cargo check command.](https://zellij.dev/img/stacked-resize-tutorial-8.png)
...
![An image of a single editor pane taking up the full screen. This time the tab name has a (FULLSCREEN) suffix to it to indicate this.](https://zellij.dev/img/stacked-resize-tutorial-9.png)
...
![An image of two pane stacks on the left and right halves of the screen, with an additional pane floating above them in the middle running the watchexec cargo check command.](https://zellij.dev/img/stacked-resize-tutorial-10.png)
...
![An image of one editor pane taking up the whole screen with a floating watchexec cargo check pane set as pinned (always-on-top) on the top right of the screen, showing compiler errors relating to the editor pane below it in real time.](https://zellij.dev/img/stacked-resize-tutorial-11.png)
...
![An image of six terminal panes of different sizes arranged in different locations on the same tiled surface on screen.](https://zellij.dev/img/stacked-resize-tutorial-12.png)
...
![An image of three terminal panes of different sizes arranged in different locations on the same tiled surface on screen with an additional pane stack in the middle.](https://zellij.dev/img/stacked-resize-tutorial-13.png)
...
![An image of a single terminal pane taking up the whole screen with the (FULLSCREEN) indication on its tab above.](https://zellij.dev/img/stacked-resize-tutorial-14.png)
...
![An image of a stack of panes taking up the whole screen except an additional smaller pane on their bottom.](https://zellij.dev/img/stacked-resize-tutorial-15.png)
...
![An image of a stack of panes taking up the left half of the screen with a single pane taking up the right half.](https://zellij.dev/img/stacked-resize-tutorial-16.png)
...
![An image of a stack of panes taking up the upper left corner of the screen with a single pane taking up the right half and a single pane taking up the bottom left corner of the screen.](https://zellij.dev/img/stacked-resize-tutorial-17.png)
