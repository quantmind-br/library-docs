---
title: punica_xpu - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/lora/punica_wrapper/punica_xpu/
source: sitemap
fetched_at: 2026-05-07T21:23:07.787443808-03:00
rendered_js: false
word_count: 0
summary: This document defines a Python class that provides an interface for managing Multi-LoRA state and performing kernel-level operations for LoRA integration within XPU/IPEX environments.
tags:
    - lora
    - pytorch
    - ipex
...
```
@final
classPunicaWrapperXPU(PunicaWrapperBase):
"""
    ...
    def_get_token_lora_indices(self, x: torch.Tensor) -> torch.IntTensor:
...
"""
    ...
    @property
    defsampler_indices_padded(self) -> torch.Tensor:
"""
...
"""
    ...
    defadd_lora_w13(
        ...
        fromvllm.lora.layers.utilsimport try_get_optimal_moe_lora_config
        fromvllm.lora.ops.triton_ops.utilsimport (
            _normalize_lora_config_keys,
            get_lora_op_configs,
        )
        fromvllm.model_executor.layers.fused_moe.configimport _get_config_dtype_str
