---
title: GLM-5 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/GLM/GLM-5
source: sitemap
fetched_at: 2026-05-11T05:50:47.529842693-03:00
rendered_js: false
word_count: 784
summary: This document provides technical instructions for deploying and configuring the GLM-5 language model using the SGLang framework across various hardware platforms.
tags:
    - glm-5
    - sglang
    - model-deployment
...
H200B200H100MI300X/MI325XMI355X

Quantization

BF16Full WeightsFP8High ThroughputNVFP4Highest Throughput
...
HardwareFP8BF16H100tp=16tp=32H200tp=8tp=16B200tp=8tp=16MI300X/MI325X—tp=8MI355X—tp=8
...
- For other configuration tips, please refer to [DeepSeek V3.2 documentation](https://docs.sglang.io/docs/basic_usage/deepseek_v32). GLM-5 and DeepSeek V3.2 share the same model structure, so the optimization techniques between these two models are also common (MTP, DSA kernel, Context Parallel…).
