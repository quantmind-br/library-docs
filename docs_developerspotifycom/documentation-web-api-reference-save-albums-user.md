...
source: crawler
fetched_at: 2026-02-27T23:38:22.591731-03:00
rendered_js: true
word_count: 107
summary: This document describes a deprecated Spotify Web API endpoint for saving albums to a user's library and provides instructions for migrating to the new recommended endpoint.
tags:
    - spotify-api
    - web-api
    - albums
