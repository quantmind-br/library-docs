---
title: Generator tool | Moodle Developer Resources
url: https://moodledev.io/general/development/tools/generator
source: sitemap
fetched_at: 2026-02-17T16:01:28.6342-03:00
rendered_js: false
word_count: 511
summary: This document explains how to use the Moodle Generator tool to create test courses, users, and scenarios for development and testing environments. It outlines the necessary developer requirements and provides instructions for execution via both web and command-line interfaces.
tags:
    - moodle
...
2. Create testing scenarios: can execute behat generators on the current instance.
3. Test plan: generates JMeter test plans for the current instance.
4. Make test site: Create a site with a specified number of courses, users, and activities.

## Generator requirements[​](#generator-requirements "Direct link to Generator requirements")
...
## Create a test course[​](#create-a-test-course "Direct link to Create a test course")
...
## Create a testing scenario using behat generators[​](#create-a-testing-scenario-using-behat-generators "Direct link to Create a testing scenario using behat generators")
...
2. The tool can only execute scenarios and outline scenarios. It does not support background.

### Execute a testing scenario behat file[​](#execute-a-testing-scenario-behat-file "Direct link to Execute a testing scenario behat file")
...
2. Upload the `feature` file you want to execute and submit the form.
