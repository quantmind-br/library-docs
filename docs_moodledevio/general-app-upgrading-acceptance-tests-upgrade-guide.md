---
title: Moodle App Acceptance Tests Upgrade Guide | Moodle Developer Resources
url: https://moodledev.io/general/app/upgrading/acceptance-tests-upgrade-guide
source: sitemap
fetched_at: 2026-02-17T15:55:19.474473-03:00
rendered_js: false
word_count: 908
summary: This guide explains how to upgrade plugin acceptance tests to maintain compatibility with newer Moodle App versions, covering infrastructure changes, plugin requirements, and Behat step updates.
tags:
    - moodle-app
    - acceptance-testing
    - behat
...
Additionally, core app tests started using the [local\_behatsnapshots](https://github.com/NoelDeMartin/moodle-local_behatsnapshots/) to test against UI regressions. You can consider adopting it as well.
...
If you wrote tests before the app started using Ionic 5 (in version 3.9.5), it is possible that your tests are not working any longer. The [Acceptance Testing guide](https://moodledev.io/general/app/development/testing/acceptance-testing) has been rewritten with the latest information, so make sure to check it out to learn about the latest state of the art.
...
In order to use these new steps, make sure that you have the [local\_moodlemobileapp](https://github.com/moodlehq/moodle-local_moodlemobileapp/) plugin installed. Historically, Behat functionality for the mobile app was included with the LMS out of the box, but it has since been extracted to its own repository.
