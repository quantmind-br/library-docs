...
url: https://moodledev.io/docs/4.4/apis/plugintypes/theme/fonts
source: sitemap
fetched_at: 2026-02-17T15:03:37.543035-03:00
rendered_js: false
word_count: 247
summary: This document explains how to implement and manage custom web fonts in Moodle, covering file organization, supported formats, and CSS placeholder syntax for plugins and themes.
tags:
    - moodle
    - web-fonts
    - css-placeholders
