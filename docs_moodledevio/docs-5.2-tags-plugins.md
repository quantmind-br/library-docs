...
url: https://moodledev.io/docs/5.2/tags/plugins
source: sitemap
fetched_at: 2026-02-17T15:41:26.507717-03:00
rendered_js: false
word_count: 736
summary: This document provides an overview and index of Moodle developer APIs and plugin types, detailing how to extend the platform's functionality through various core subsystems and components.
tags:
    - moodle-development
    - plugin-architecture
    - moodle-api
...
## [Advanced grading API](https://moodledev.io/docs/5.2/apis/core/grading)
...
## [Antivirus plugins](https://moodledev.io/docs/5.2/apis/plugintypes/antivirus)

Integrate your preferred Antivirus tool to with Moodle to automatically check new file uploads.

## [Block plugins](https://moodledev.io/docs/5.2/apis/plugintypes/blocks)
...
## [db/tasks.php](https://moodledev.io/docs/5.2/apis/commonfiles/db-tasks.php)

A description of the plugin scheduled task configuration file

## [Defaults for new questions](https://moodledev.io/docs/5.2/apis/plugintypes/qtype/newquestiondefaults)
...
## [Filter plugins](https://moodledev.io/docs/5.2/apis/plugintypes/filter)

Filters are a way to automatically transform content before it is output. Filters may be used to:

## [Fonts](https://moodledev.io/docs/5.2/apis/plugintypes/theme/fonts)

CSS3 standard introduced the possibility to specify custom fonts, see CSS web fonts tutorial.

## [Images and icons in themes](https://moodledev.io/docs/5.2/apis/plugintypes/theme/images)
...
## [Theme plugins](https://moodledev.io/docs/5.2/apis/plugintypes/theme)
...
## [version.php](https://moodledev.io/docs/5.2/apis/commonfiles/version.php)
