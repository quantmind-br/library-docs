...
source: crawler
fetched_at: 2026-02-27T23:46:47.140643-03:00
rendered_js: false
word_count: 2
summary: This document provides a detailed JSON response schema for retrieving the current playback state of a media player, including device details and track metadata.
tags:
    - playback-status
    - api-response-schema
    - media-streaming
