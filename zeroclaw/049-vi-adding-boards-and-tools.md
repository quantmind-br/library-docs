...
url: https://github.com/openagen/zeroclaw/blob/master/docs/vi/adding-boards-and-tools.md
source: git
fetched_at: 2026-05-02T14:52:23.354569825-03:00
rendered_js: false
word_count: 393
summary: This document provides instructions for configuring hardware boards and custom tools within the ZeroClaw framework, covering CLI management, RAG-based datasheet setup, and peripheral implementation.
tags:
    - zeroclaw
...
Xem [[049-vi-adding-boards-and-tools|Thêm Board và Tool]] để hiểu toàn bộ thiết kế.
...
#hardware-integration #cli-configuration
