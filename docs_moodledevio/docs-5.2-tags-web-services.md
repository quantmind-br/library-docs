...
url: https://moodledev.io/docs/5.2/tags/web-services
source: sitemap
fetched_at: 2026-02-17T15:42:45.946964-03:00
rendered_js: false
word_count: 127
summary: This document outlines the components and procedures for developing Moodle external services, including function declaration, security requirements, and service creation.
tags:
    - moodle-api
    - external-functions
    - web-services
