---
title: connection - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/entrypoints/openai/realtime/connection/
source: sitemap
fetched_at: 2026-05-07T21:20:21.26253027-03:00
rendered_js: false
word_count: 52
summary: This document defines a WebSocket connection manager class that handles realtime audio transcription tasks, including session event routing, audio stream buffering, and integration with a transcription engine.
tags:
    - websocket
...
"""Manages WebSocket lifecycle and state for realtime transcription.
    ...
    def__init__(self, websocket: WebSocket, serving: OpenAIServingRealtime):
    ...
    async defhandle_connection(self):
"""Main connection loop."""
    ...
    def_check_model(self, model: str | None) -> None | ErrorResponse:
    ...
    async defhandle_event(self, event: dict):
"""Route events to handlers.
    ...
    async defaudio_stream_generator(self) -> AsyncGenerator[np.ndarray, None]:
"""Generator that yields audio chunks from the queue."""
    ...
    async defstart_generation(self):
...
"""Run the generation and stream results back to the client.
        ...
        try:
            ...
            fromvllm.sampling_paramsimport RequestOutputKind, SamplingParams
...
"""Send event to client."""
    ...
    async defsend_error(self, message: str, code: str | None = None):
