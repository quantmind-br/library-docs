...
source: crawler
fetched_at: 2026-01-28T16:18:47.571577938-03:00
rendered_js: false
word_count: 1878
summary: This document defines the `WebSocketMessage` and `WebSocketData` classes within mitmproxy, detailing how individual WebSocket messages and full WebSocket connections are structured, handled, and integrated with HTTP flows.
tags:
    - mitmproxy
    - websocket
    - http-flow
