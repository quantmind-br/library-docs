...
url: https://moodledev.io/docs/4.4/apis/plugintypes/repository
source: sitemap
fetched_at: 2026-02-17T15:03:35.374174-03:00
rendered_js: false
word_count: 4033
summary: This document outlines the development process for Moodle repository plugins, detailng the required file structure, metadata requirements, and core class implementations.
tags:
    - moodle-development
    - repository-plugin
    - plugin-architecture
...
Some of the important files for the repository plugintype are described below. See the [common plugin files](https://moodledev.io/docs/4.4/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
