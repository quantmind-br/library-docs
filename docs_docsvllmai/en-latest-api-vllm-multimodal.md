...
url: https://docs.vllm.ai/en/latest/api/vllm/multimodal/
source: sitemap
fetched_at: 2026-05-07T21:34:02.166644232-03:00
rendered_js: false
word_count: 32
summary: This document defines a MultiModalRegistry class used for managing and dispatching multi-modal data processors, enabling the registration, construction, and caching of model-specific input processing workflows.
tags:
    - multimodal
    - processor-registry
    - data-processing
...
```
classMultiModalRegistry:
"""
    A registry that dispatches data processing according to the model.
    """

    defsupports_multimodal_inputs(self, model_config: "ModelConfig") -> bool:
"""
...
"""
    ...
    def_get_model_cls(self, model_config: "ModelConfig") -> "SupportsMultiModal":
        # Avoid circular import
        fromvllm.model_executor.model_loaderimport get_model_architecture
    ...
    defget_processing_info(self, model_config: "ModelConfig") -> BaseProcessingInfo:
...
"""
    ...
    defprocessor_cache_from_config(
        self,
        vllm_config: "VllmConfig",
...
"""Return a `BaseMultiModalProcessorCache`, if enabled."""
    ...
    defprocessor_only_cache_from_config(
        self,
        vllm_config: "VllmConfig",
...
"""Return a `MultiModalProcessorOnlyCache`, if enabled."""
    ...
    defengine_receiver_cache_from_config(
        self,
        vllm_config: "VllmConfig",
...
"""Return a `BaseMultiModalReceiverCache` for the engine process."""
    ...
    defworker_receiver_cache_from_config(
        self,
        vllm_config: "VllmConfig",
