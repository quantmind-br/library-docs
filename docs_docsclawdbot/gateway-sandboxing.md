---
title: Sandboxing
url: https://docs.clawd.bot/gateway/sandboxing.md
source: llms
fetched_at: 2026-01-26T09:52:11.551861502-03:00
rendered_js: false
word_count: 703
summary: This document explains how to configure and use Docker sandboxing in Clawdbot to isolate tool execution and limit host system access. It details various isolation modes, workspace visibility options, and custom container configurations for enhanced security.
tags:
    - sandboxing
    - docker-containers
    - security-isolation
