...
url: https://docs.bmad-method.org/zh-cn/how-to/get-answers-about-bmad/
source: sitemap
fetched_at: 2026-04-08T11:33:13.315671179-03:00
rendered_js: false
word_count: 107
summary: This document describes the `bmad-help` skill, an intelligent guide designed to quickly answer common questions about BMad by understanding natural language and providing context-aware suggestions. It also directs users on advanced methods for deeper investigation using source code or specific documentation files.
tags:
    - smart-guide
...
来源适合回答的问题示例**`_bmad` 文件夹**智能体、工作流、提示词如何工作“PM 智能体具体做什么？”**完整 GitHub 仓库**版本历史、安装器、整体架构“v6 主要改了什么？”**`llms-full.txt`**文档层面的快速全景理解“解释 BMad 的四个阶段”
...
频道适用场景`#bmad-method-help`快速问题（实时聊天）`help-requests` forum复杂问题（可检索、可沉淀）`#suggestions-feedback`建议与功能诉求`#report-bugs-and-issues`Bug 报告
