...
url: https://moodledev.io/docs/5.0/apis/core/dml/delegated-transactions
source: sitemap
fetched_at: 2026-02-17T15:24:37.028577-03:00
rendered_js: false
word_count: 437
summary: This document explains the principles, API, and workflow for implementing delegated database transactions in Moodle to ensure data integrity during CRUD operations.
tags:
    - moodle-development
