...
url: https://moodledev.io/docs/4.1/apis/subsystems/group
source: sitemap
fetched_at: 2026-02-17T14:56:43.329027-03:00
rendered_js: false
word_count: 595
summary: This document explains the Moodle groups and groupings system and provides guidance on using the Groups API to implement group-aware features in activities.
tags:
    - moodle
    - groups-api
    - access-control
