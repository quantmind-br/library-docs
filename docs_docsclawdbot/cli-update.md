---
title: "null"
url: https://docs.clawd.bot/cli/update.md
source: llms
fetched_at: 2026-01-26T09:51:08.375011288-03:00
rendered_js: false
word_count: 375
summary: This document provides a comprehensive reference for the `clawdbot update` command, covering how to manage software updates, switch between release channels, and use the update wizard.
tags:
    - cli-reference
    - update-process
    - release-channels
