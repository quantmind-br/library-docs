...
url: https://ghostty.org/docs/vt/csi/decslrm
source: crawler
fetched_at: 2026-03-10T06:35:39.432846-03:00
rendered_js: true
word_count: 327
summary: This document explains the control sequence used to set the left and right margins (scroll region) in a terminal environment, detailing required prerequisite modes, parameter behavior, and conflicts.
tags:
    - terminal-control
    - scroll-region
    - decslrm
...
- [DECSLRM V-1: Full Screen](#decslrm-v-1:-full-screen)
- [DECSLRM V-2: Left Only](#decslrm-v-2:-left-only)
- [DECSLRM V-3: Left And Right](#decslrm-v-3:-left-and-right)
- [DECSLRM V-4: Left Equal to Right](#decslrm-v-4:-left-equal-to-right)