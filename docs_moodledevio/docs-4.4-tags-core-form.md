...
url: https://moodledev.io/docs/4.4/tags/core-form
source: sitemap
fetched_at: 2026-02-17T14:58:34.907545-03:00
rendered_js: false
word_count: 321
summary: This document provides an overview of the Moodle Forms API, detailing various form elements, advanced configuration options like hidden fields and repeating elements, and general implementation usage.
tags:
    - moodle-forms
    - forms-api
    - web-development
