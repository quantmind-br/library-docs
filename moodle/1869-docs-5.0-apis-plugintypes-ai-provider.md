...
url: https://moodledev.io/docs/5.0/apis/plugintypes/ai/provider
source: sitemap
fetched_at: 2026-02-17T15:25:15.461848-03:00
rendered_js: false
word_count: 1045
summary: This document explains how to implement and structure AI Provider plugins, which serve as the interface between the core AI subsystem and external AI services.
tags:
    - moodle-development
    - ai-subsystem
    - provider-plugins
