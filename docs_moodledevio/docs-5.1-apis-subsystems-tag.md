...
url: https://moodledev.io/docs/5.1/apis/subsystems/tag
source: sitemap
fetched_at: 2026-02-17T15:37:21.566087-03:00
rendered_js: false
word_count: 1190
summary: This document explains how to integrate the Moodle Tag API into plugins to enable labeling, searching, and grouping of system information. It provides instructions for defining tag areas, adding tag elements to forms, and managing tag instances throughout their lifecycle.
tags:
    - moodle-development
    - tag-api
    - metadata-management
...
There are more options such as specifying the default value for "Standard tags", having a fixed collection or excluding from search. They can be found in comments in [Core library tag.php](https://moodledev.io/docs/5.1/apis/commonfiles/tag.php)
...
Custom plugins may go beyond the standard tags handling and use them without mixing with regular course/user/wiki/blogs tags, hide them from the "Tag search" page and "Tags" block but instead have their own interface to search/categorise using tags. This can be achieved by defining tag collection, make it not searchable and specify a custom URL to link to when the tag is actually displayed. This all can be defined in db/tag.php, see the comments in [Core library tag.php](https://moodledev.io/docs/5.1/apis/commonfiles/tag.php)
...
- [Core library tag.php](https://moodledev.io/docs/5.1/apis/commonfiles/tag.php)
