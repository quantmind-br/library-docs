...
url: https://moodledev.io/docs/4.5/apis/subsystems/form/advanced/repeat-elements
source: sitemap
fetched_at: 2026-02-17T15:14:23.299977-03:00
rendered_js: false
word_count: 265
summary: This document explains how to use the Form API's repeat_elements method to create dynamic, repeating groups of form fields for handling variable quantities of user input.
tags:
    - moodle-form-api
    - repeat-elements
    - dynamic-forms
