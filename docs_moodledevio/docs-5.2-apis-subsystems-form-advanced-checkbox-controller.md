...
url: https://moodledev.io/docs/5.2/apis/subsystems/form/advanced/checkbox-controller
source: sitemap
fetched_at: 2026-02-17T15:45:52.036996-03:00
rendered_js: false
word_count: 75
summary: This document demonstrates how to implement checkbox controllers in forms to manage and toggle groups of advanced checkboxes simultaneously.
tags:
    - moodle-forms
    - php
    - form-elements
