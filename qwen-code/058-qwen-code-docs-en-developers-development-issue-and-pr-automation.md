...
url: https://qwenlm.github.io/qwen-code-docs/en/developers/development/issue-and-pr-automation
source: github_pages
fetched_at: 2026-04-09T09:05:10.101376771-03:00
rendered_js: true
word_count: 933
summary: This document provides a comprehensive guide to the automated workflows used for managing and triaging issues and pull requests within a repository, ensuring contributors know how their contributions will be processed.
tags:
...
### 1. When you open an Issue: `Automated Issue Triage`[](#1-when-you-open-an-issue-automated-issue-triage)
...
### 2. When you open a Pull Request: `Continuous Integration (CI)`[](#2-when-you-open-a-pull-request-continuous-integration-ci)
...
### 3. Ongoing Triage for Pull Requests: `PR Auditing and Label Sync`[](#3-ongoing-triage-for-pull-requests-pr-auditing-and-label-sync)
...
### 4. Ongoing Triage for Issues: `Scheduled Issue Triage`[](#4-ongoing-triage-for-issues-scheduled-issue-triage)
...
[Integration Tests](https://qwenlm.github.io/qwen-code-docs/en/developers/development/integration-tests/ "Integration Tests")[Qwen Code Extensions](https://qwenlm.github.io/qwen-code-docs/en/developers/extensions/extension/ "Qwen Code Extensions")