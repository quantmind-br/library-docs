...
url: https://github.com/openagen/zeroclaw/blob/master/docs/vi/network-deployment.md
source: git
fetched_at: 2026-05-02T14:52:42.636619122-03:00
rendered_js: false
word_count: 706
summary: Hướng dẫn triển khai phần mềm ZeroClaw trên Raspberry Pi và cấu hình các tùy chọn mạng bao gồm Telegram polling, kết nối mạng nội bộ LAN và thiết lập webhook qua tunnel.
tags:
    - zeroclaw
    - raspberry-pi
...
- [[049-vi-adding-boards-and-tools|Thêm Board và Tool]] — Tổng quan cấu hình channel
- [[051-vi-matrix-e2ee-guide|Hướng dẫn Matrix E2EE]] — Thiết lập Matrix và xử lý sự cố phòng mã hóa
- [[048-vi-nucleo-setup|ZeroClaw trên Nucleo-F401RE]] — Thiết lập phần cứng Nucleo
- [[047-vi-arduino-uno-q-setup|ZeroClaw trên Arduino Uno Q]] — Thiết lập phần cứng Uno Q

#raspberry-pi #network-configuration #telegram-bot
