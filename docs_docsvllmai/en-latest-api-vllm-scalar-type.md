...
source: sitemap
fetched_at: 2026-05-07T21:35:30.6801494-03:00
rendered_js: false
word_count: 24
summary: This document defines the ScalarType class, which provides a flexible representation for various floating-point and integer data types, including custom sub-byte types and biased quantized formats used in machine learning.
tags:
    - python
    - dataclass
    - data-types
...
"""
    ...
    def_floating_point_max_int(self) -> int:
    ...
    def_floating_point_max(self) -> float:
        double_raw = self._floating_point_max_int()
        return struct.unpack("!d", struct.pack("!Q", double_raw))[0]

    def_raw_max(self) -> int | float:
...
"""
        ...
        defor_and_advance(member, bit_width):
            nonlocal val
            nonlocal offset
    ...
    @property
    defsize_bits(self) -> int:
        return self.exponent + self.mantissa + int(self.signed)

    defmin(self) -> int | float:
"""
...
"""
    ...
    defis_floating_point(self) -> bool:
        "If the type is a floating point type"
        return self.exponent != 0

    defis_integer(self) -> bool:
        "If the type is an integer type"
        return self.exponent == 0

    defhas_bias(self) -> bool:
        "If the type has a non-zero bias"
        return self.bias != 0

    defhas_infs(self) -> bool:
        "If the type is floating point and supports infinity"
        return not self._finite_values_only

    defhas_nans(self) -> bool:
        return self.nan_repr != NanRepr.NONE.value

    defis_ieee_754(self) -> bool:
"""
...
"""
    ...
    @classmethod
    defint_(cls, size_bits: int, bias: int | None) -> "ScalarType":
    ...
    @classmethod
    defuint(cls, size_bits: int, bias: int | None) -> "ScalarType":
"""Create an unsigned integer scalar type."""
    ...
    @classmethod
    deffloat_IEEE754(cls, exponent: int, mantissa: int) -> "ScalarType":
"""
...
"""
    ...
    @classmethod
    deffrom_id(cls, scalar_type_id: int):
