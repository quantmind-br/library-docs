---
title: Ascend NPU Quickstart - SGLang Documentation
url: https://docs.sglang.io/docs/hardware-platforms/ascend-npus/ascend_npu_quick_start
source: sitemap
fetched_at: 2026-05-11T05:48:39.785980096-03:00
rendered_js: false
word_count: 222
summary: This document provides instructions for setting up and running the SGLang server within a Docker container on Atlas inference hardware, including server management and basic inference testing.
tags:
    - sglang
    - docker
    - atlas-inference
