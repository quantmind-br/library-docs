...
url: https://moodledev.io/docs/4.5/apis/subsystems/backup/restore
source: sitemap
fetched_at: 2026-02-17T15:13:14.611168-03:00
rendered_js: false
word_count: 296
summary: This document explains how to implement the Moodle Restore API to recover plugin data from backup files using restore plans, tasks, and steps.
tags:
    - moodle-development
    - restore-api
    - backup-system
