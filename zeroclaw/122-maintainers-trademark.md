---
title: Trademark
url: https://github.com/openagen/zeroclaw/blob/master/docs/maintainers/trademark.md
source: git
fetched_at: 2026-05-02T14:51:45.686534685-03:00
rendered_js: false
word_count: 578
summary: This document outlines the legal guidelines and restrictions for using the ZeroClaw name, logo, and brand identity to prevent trademark infringement and ensure brand consistency.
tags:
    - trademark-policy
    - legal-guidelines
    - brand-identity
...
**Known unauthorized fork:**
- `openagen/zeroclaw` — not affiliated with ZeroClaw Labs

If you encounter unauthorized use, report it by opening an issue at https://github.com/zeroclaw-labs/zeroclaw/issues.

## Permitted Uses

You **may** use the ZeroClaw name and marks without prior written permission for:

1. **Attribution** — stating your software is based on or derived from ZeroClaw, provided it's clear your project is not the official ZeroClaw.

2. **Descriptive reference** — referring to ZeroClaw in documentation, articles, blog posts, or presentations to accurately describe the software.

3. **Community discussion** — using the name in forums, issues, or social media to discuss the project.

4. **Fork identification** — identifying your fork as "a fork of ZeroClaw" with a clear link to the official repository.

## Prohibited Uses

You **may not** use the ZeroClaw name or marks to:

1. **Imply official endorsement** — suggest your project, product, or organization is officially affiliated with or endorsed by ZeroClaw Labs.

2. **Cause brand confusion** — use "ZeroClaw" as the primary name of a competing or derivative product in a way that could confuse users about the source.

3. **Impersonate the project** — create repositories, domains, packages, or accounts that could be mistaken for the official ZeroClaw project.

4. **Misrepresent origin** — remove or obscure attribution to ZeroClaw Labs while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products, services, or marketing without prior written permission from ZeroClaw Labs.
...
#trademark-policy #legal-guidelines #brand-identity #fork-rules #intellectual-property #compliance
