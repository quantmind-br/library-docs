---
title: Structured Outputs - SGLang Documentation
url: https://docs.sglang.io/docs/advanced_features/structured_outputs
source: sitemap
fetched_at: 2026-05-11T05:49:19.418266044-03:00
rendered_js: false
word_count: 720
summary: This document explains how to constrain model output in SGLang using various grammar formats such as JSON schema, regular expressions, and EBNF. It also demonstrates how to integrate these constraints into an OpenAI-compatible API workflow using different backend engines.
tags:
    - sglang
...
You can specify a JSON schema, [regular expression](https://en.wikipedia.org/wiki/Regular_expression) or [EBNF](https://en.wikipedia.org/wiki/Extended_Backus%E2%80%93Naur_form) to constrain the model output. The model output will be guaranteed to follow the given constraints. Only one constraint parameter (`json_schema`, `regex`, or `ebnf`) can be specified for a request. SGLang supports three grammar backends:
...
you can directly define a JSON schema or use [Pydantic](https://docs.pydantic.dev/latest/) to define and validate the response. **Using Pydantic**
