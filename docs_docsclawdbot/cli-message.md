---
title: "null"
url: https://docs.clawd.bot/cli/message.md
source: llms
fetched_at: 2026-01-26T09:50:50.286129542-03:00
rendered_js: false
word_count: 575
summary: This reference document details the usage and subcommands of the `clawdbot message` CLI tool for interacting with multiple messaging platforms like Discord, Slack, and WhatsApp. It provides comprehensive instructions on sending messages, managing threads, reactions, and performing moderation tasks across different channels.
tags:
    - clawdbot
