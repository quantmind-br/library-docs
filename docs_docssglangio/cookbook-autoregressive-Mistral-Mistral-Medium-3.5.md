---
title: Mistral Medium 3.5 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/Mistral/Mistral-Medium-3.5
source: sitemap
fetched_at: 2026-05-11T05:50:29.815054555-03:00
rendered_js: false
word_count: 1035
summary: This document provides technical specifications, deployment instructions, and usage guidance for running the Mistral Medium 3.5 128B model within the SGLang serving framework.
tags:
    - sglang
    - mistral-medium
    - llm-deployment
...
Refer to the [official SGLang installation guide](https://docs.sglang.io/docs/get-started/install). **Docker Images by Hardware:**

HardwareDocker ImageH100 / H200 (Hopper, CUDA 12.9)`lmsysorg/sglang:dev-mistral-medium-3.5`B200 / B300 (Blackwell, CUDA 13.0)`lmsysorg/sglang:dev-cu13-mistral-medium-3.5`
...
```
sglang serve --model-path mistralai/Mistral-Medium-3.5-128B \
  --tp 4 \
