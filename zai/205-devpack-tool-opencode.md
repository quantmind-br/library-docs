---
title: Open Code
url: https://docs.z.ai/devpack/tool/opencode.md
source: llms
fetched_at: 2026-01-24T11:22:51.503848079-03:00
rendered_js: false
word_count: 672
summary: This guide provides instructions for integrating Z.AI GLM models with the OpenCode CLI, covering installation, authentication, and usage within IDEs and GitHub workflows.
tags:
    - opencode-cli
    - z-ai-glm
    - ai-coding-assistant
...
Refer to the [Vision MCP Server](../mcp/vision-mcp-server) , [Search MCP Server](../mcp/search-mcp-server) and [Web Reader MCP Server](../mcp/reader-mcp-server) documentation; once configured, you can use them in OpenCode.
