...
url: https://moodledev.io/docs/5.2/apis/plugintypes/format
source: sitemap
fetched_at: 2026-02-17T15:44:17.366415-03:00
rendered_js: false
word_count: 5359
summary: This document explains the architecture and implementation of Moodle course format plugins, which control the layout, navigation, and rendering of course main pages.
tags:
    - moodle-development
    - course-formats
    - plugin-architecture
...
In case your plugin is a Moodle 3.11 compatible plugin, see the [migration guide](https://moodledev.io/docs/5.2/apis/plugintypes/format/migration) for more information.
