...
url: https://moodledev.io/docs/5.0/guides/javascript/yui/namespacing
source: sitemap
fetched_at: 2026-02-17T15:28:50.395438-03:00
rendered_js: false
word_count: 203
summary: This document defines the standardized naming convention for Moodle-specific YUI module namespaces to ensure consistency and prevent module conflicts through effective sandboxing.
tags:
    - yui
    - moodle-development
