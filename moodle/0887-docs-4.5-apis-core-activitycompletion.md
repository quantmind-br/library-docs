...
url: https://moodledev.io/docs/4.5/apis/core/activitycompletion
source: sitemap
fetched_at: 2026-02-17T15:10:56.63698-03:00
rendered_js: false
word_count: 2062
summary: This document provides technical instructions for developers to implement the activity completion system in Moodle activity modules, including view-based, grade-based, and custom completion rules. It details the required functions, database updates, and backup procedures needed to integrate a plugin with Moodle's completion tracking API.
tags:
    - moodle-development
    - activity-completion
    - php-api
...
protectedfunctionget_suffixed_name(string$fieldname):string{
