...
url: https://moodledev.io/docs/5.2/apis/subsystems/form/usage
source: sitemap
fetched_at: 2026-02-17T15:45:58.249858-03:00
rendered_js: false
word_count: 488
summary: This document provides an overview of Moodle's Form API, detailing how to define form classes and handle data submission within standard pages and activity modules.
tags:
    - moodle-development
    - form-api
    - moodleform
