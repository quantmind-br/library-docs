...
url: https://code.claude.com/docs/en/agent-sdk/tool-search.md
source: llms
fetched_at: 2026-04-16T22:30:11.637041568-03:00
rendered_js: false
word_count: 735
summary: This document explains how to use tool search to manage large-scale tool libraries by dynamically loading definitions into the context window. It provides configuration options, optimization strategies for discovery, and operational limits for scaling agent capabilities.
tags:
    - agentic-workflows
    - context-management
    - tool-use
