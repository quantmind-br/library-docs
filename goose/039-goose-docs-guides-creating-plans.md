---
title: Creating Plans Before Working | goose
url: https://block.github.io/goose/docs/guides/creating-plans
source: github_pages
fetched_at: 2026-01-22T22:13:44.72280613-03:00
rendered_js: true
word_count: 1155
summary: This document explains how to use the goose planning mode to break down projects into actionable steps and provides instructions for configuring specific LLM models for the planning phase.
tags:
    - goose-cli
    - planning-mode
    - configuration
...
## Set your planner provider and model[​](#set-your-planner-provider-and-model "Direct link to Set your planner provider and model")
...
Multi-Model Alternative to Plan Mode

goose also supports automatic model switching with [Lead/Worker mode](https://block.github.io/goose/docs/guides/environment-variables#leadworker-model-configuration), which provides turn-based switching between two models to help balance model capabilities with cost and speed.

### Set goose planner environment variables[​](#set-goose-planner-environment-variables "Direct link to Set goose planner environment variables")
...
## Describe your project[​](#describe-your-project "Direct link to Describe your project")
...
## A simple construction plan example[​](#a-simple-construction-plan-example "Direct link to A simple construction plan example")
...
### Create a separate plan for plan sub-steps[​](#create-a-separate-plan-for-plan-sub-steps "Direct link to Create a separate plan for plan sub-steps")
...
## A development project example[​](#a-development-project-example "Direct link to A development project example")
...
## Clarifying questions[​](#clarifying-questions "Direct link to Clarifying questions")
...
If you've answered *all* of goose's questions and it has no more questions, goose will generate the plan. Other times, you might think goose will never run out of questions. If you want your plan and don't want to answer more questions, you can simply ask for a "generic" plan:
