...
url: https://developer.spotify.com/documentation/web-api/reference/get-new-releases
source: crawler
fetched_at: 2026-02-27T23:38:24.974903-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response structure for an API request returning a paginated list of albums and their associated metadata.
tags:
    - spotify-api
    - json-response
    - album-metadata
