---
title: loggers - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/metrics/loggers/
source: sitemap
fetched_at: 2026-05-07T21:41:10.392977015-03:00
rendered_js: false
word_count: 0
summary: This document defines the PrometheusStatLogger class, which initializes and manages Prometheus metrics for monitoring the performance and internal state of the vLLM engine.
tags:
    - prometheus
    - metrics
    - observability
...
```
classPrometheusStatLogger(AggregateStatLoggerBase):
    _gauge_cls = Gauge
    ...
    deflog_metrics_info(self, type: str, config_obj: SupportsMetricsInfo):
...
"""Log to prometheus."""
    ...
    defrecord_sleep_state(self, sleep: int = 0, level: int = 0):
        awake = 1
        discard_all = 0
        weights_offloaded = 0
    ...
    deflog_engine_initialized(self):
