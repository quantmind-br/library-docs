...
source: sitemap
fetched_at: 2026-04-26T07:46:06.337560944-03:00
rendered_js: false
word_count: 1126
summary: This document introduces adaptive crawling, a strategic approach to web data collection that uses information theory and scenting algorithms to prioritize relevant content, significantly reducing token consumption and processing time compared to traditional brute-force crawling.
tags:
    - web-crawling
    - data-acquisition
    - information-theory
...
defcalculate_information_gain(new_page, knowledge_base):
...
*Adaptive Crawling is now part of Crawl4AI. [Get started with the documentation](https://docs.crawl4ai.com/core/adaptive-crawling/) or [dive into the mathematical framework](https://github.com/unclecode/crawl4ai/blob/main/PROGRESSIVE_CRAWLING.md). For updates on my work in information theory and efficient AI, follow me on [X/Twitter](https://x.com/unclecode).*