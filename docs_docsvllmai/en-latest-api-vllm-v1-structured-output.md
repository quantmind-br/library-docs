---
title: structured_output - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/structured_output/
source: sitemap
fetched_at: 2026-05-07T21:41:58.206894369-03:00
rendered_js: false
word_count: 9
summary: This document defines the StructuredOutputManager class, which handles the lifecycle, grammar compilation, and bitmask generation for structured output requests within the vLLM engine.
tags:
    - structured-output
    - vllm-engine
    - grammar-compilation
...
"""Engine-level manager for structured output requests."""
    ...
    def_get_reasoner(self, request: "Request") -> "ReasoningParser | None":
    ...
    defgrammar_init(self, request: "Request") -> None:
        ...
        if self.backend is None:
            ...
            if backend == "xgrammar":
                ...
                fromvllm.v1.structured_output.backend_outlinesimport OutlinesBackend
                ...
                fromvllm.v1.structured_output.backend_lm_format_enforcerimport (  # noqa: E501
    ...
    def_create_grammar(self, request: "Request") -> StructuredOutputGrammar:
    ...
    defshould_fill_bitmask(self, request: "Request") -> bool:
    ...
    defshould_advance(self, request: "Request") -> bool:
