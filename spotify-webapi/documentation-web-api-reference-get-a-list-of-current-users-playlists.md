...
source: crawler
fetched_at: 2026-02-27T23:45:25.776439-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response format for a Spotify API request, illustrating the structure of paginated data for user shows or playlists.
tags:
    - spotify-api
    - json-response
    - pagination
