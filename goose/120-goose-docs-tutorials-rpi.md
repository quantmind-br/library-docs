---
title: Research → Plan → Implement Pattern | goose
url: https://block.github.io/goose/docs/tutorials/rpi
source: github_pages
fetched_at: 2026-01-22T22:16:24.891139742-03:00
rendered_js: true
word_count: 1173
summary: This tutorial introduces the RPI (Research, Plan, Implement) workflow for AI coding agents, explaining how to handle complex codebase changes through structured research and planning phases.
tags:
    - ai-agents
    - rpi-workflow
...
## RPI Workflow[​](#rpi-workflow "Direct link to RPI Workflow")
...
## The Task[​](#the-task "Direct link to The Task")
...
## Session 1: Research[​](#session-1-research "Direct link to Session 1: Research")
...
## Session 2: Plan[​](#session-2-plan "Direct link to Session 2: Plan")
...
## Session 3: Implement[​](#session-3-implement "Direct link to Session 3: Implement")
...
## When to Use RPI[​](#when-to-use-rpi "Direct link to When to Use RPI")
