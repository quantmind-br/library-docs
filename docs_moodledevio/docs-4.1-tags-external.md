...
url: https://moodledev.io/docs/4.1/tags/external
source: sitemap
fetched_at: 2026-02-17T14:52:29.560859-03:00
rendered_js: false
word_count: 149
summary: This document provides an overview of Moodle's web service framework, detailing how to declare, define, secure, and test external functions and services.
tags:
    - moodle-development
    - web-services
    - external-api
