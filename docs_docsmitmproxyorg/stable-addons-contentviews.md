...
source: crawler
fetched_at: 2026-01-28T15:01:12.571701113-03:00
rendered_js: false
word_count: 174
summary: This document explains how to create and use contentviews in mitmproxy to pretty-print and interactively edit binary message data.
tags:
    - contentviews
    - mitmproxy
    - binary-data
