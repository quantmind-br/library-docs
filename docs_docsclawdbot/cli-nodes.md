...
source: llms
fetched_at: 2026-01-26T09:50:52.351430878-03:00
rendered_js: false
word_count: 206
summary: This document provides a reference for the clawdbot nodes CLI command, used to manage paired devices and execute remote capabilities or system commands on specific nodes.
tags:
    - cli-reference
    - node-management
    - remote-execution
