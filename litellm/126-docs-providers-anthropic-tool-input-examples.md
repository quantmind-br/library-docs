...
## When to Use Input Examples[​](#when-to-use-input-examples "Direct link to When to Use Input Examples")
...
## Example Formats[​](#example-formats "Direct link to Example Formats")

### Simple Tool with Examples[​](#simple-tool-with-examples "Direct link to Simple Tool with Examples")
...
### Complex Nested Objects[​](#complex-nested-objects "Direct link to Complex Nested Objects")
...
### Format-Sensitive Parameters[​](#format-sensitive-parameters "Direct link to Format-Sensitive Parameters")
...
### Server-Side Tools Not Supported[​](#server-side-tools-not-supported "Direct link to Server-Side Tools Not Supported")
...
### Token Costs[​](#token-costs "Direct link to Token Costs")
...
### 1. Show Diverse Examples[​](#1-show-diverse-examples "Direct link to 1. Show Diverse Examples")
...
### 2. Demonstrate Optional Parameters[​](#2-demonstrate-optional-parameters "Direct link to 2. Demonstrate Optional Parameters")
...
### 3. Illustrate Format Requirements[​](#3-illustrate-format-requirements "Direct link to 3. Illustrate Format Requirements")
...
### 4. Keep Examples Realistic[​](#4-keep-examples-realistic "Direct link to 4. Keep Examples Realistic")
...
### 5. Limit Example Count[​](#5-limit-example-count "Direct link to 5. Limit Example Count")
...
### With Tool Search[​](#with-tool-search "Direct link to With Tool Search")
...
### With Programmatic Tool Calling[​](#with-programmatic-tool-calling "Direct link to With Programmatic Tool Calling")
...
### All Features Combined[​](#all-features-combined "Direct link to All Features Combined")
...
### "Invalid request" error with examples[​](#invalid-request-error-with-examples 'Direct link to "Invalid request" error with examples')
...
### Examples not improving tool calls[​](#examples-not-improving-tool-calls "Direct link to Examples not improving tool calls")
...
### Token usage too high[​](#token-usage-too-high "Direct link to Token usage too high")
...
## When NOT to Use Input Examples[​](#when-not-to-use-input-examples "Direct link to When NOT to Use Input Examples")
...
- **Server-side tools**: web\_search, code\_execution, etc. don't support examples

<!--THE END-->

- [Anthropic Tool Search](https://docs.litellm.ai/docs/providers/anthropic_tool_search) - Dynamically discover and load tools on-demand
- [Anthropic Programmatic Tool Calling](https://docs.litellm.ai/docs/providers/anthropic_programmatic_tool_calling) - Call tools from code execution
- [Anthropic Provider](https://docs.litellm.ai/docs/providers/anthropic) - General Anthropic provider documentation