...
source: github_pages
fetched_at: 2026-02-15T21:17:26.833472-03:00
rendered_js: false
word_count: 616
summary: This document provides guidance on optimizing and troubleshooting SketchyBar configurations, covering command batching, performance tuning, icon integration, and running multiple bar instances.
tags:
    - sketchybar
    - macos-customization
    - shell-scripting
...
## Batching of configuration commands[​](#batching-of-configuration-commands "Direct link to heading")
...
### Using bash arrays for cleaner configuration[​](#using-bash-arrays-for-cleaner-configuration "Direct link to heading")
...
## Debugging Problems[​](#debugging-problems "Direct link to heading")
...
## Color Picker[​](#color-picker "Direct link to heading")

SketchyBar uses the argb hex color format, which means: `0xAARRGGBB` encodes a color.

## Finding Icons[​](#finding-icons "Direct link to heading")

The default font *SketchyBar* uses is the *Hack Nerd Font* which means all *Nerdfont* icons can be used. Refer to the *Nerdfont* [cheat-sheet](https://www.nerdfonts.com/cheat-sheet) to find new icons.

Additionally, it is possible to use other icons and glyphs from different fonts, such as the [sf-symbols](https://developer.apple.com/sf-symbols/) from apple. Those symbols can be installed via brew:
...
If you are looking for stylised app icons you might want to checkout the excellent community maintained [app-icon-font](https://github.com/kvndrsslr/sketchybar-app-font) for SketchyBar.

## Multiple Bars[​](#multiple-bars "Direct link to heading")
...
## Performance optimizations[​](#performance-optimizations "Direct link to heading")
