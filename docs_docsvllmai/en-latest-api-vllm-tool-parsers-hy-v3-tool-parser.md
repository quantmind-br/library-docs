---
title: hy_v3_tool_parser - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/tool_parsers/hy_v3_tool_parser/
source: sitemap
fetched_at: 2026-05-07T21:36:08.074295571-03:00
rendered_js: false
word_count: 125
summary: This document defines the HYV3ToolParser class, which handles type normalization, schema parsing, and value deserialization for tool function arguments.
tags:
    - python
    - json-schema
    - tool-calling
...
```
classHYV3ToolParser(ToolParser):
    ...
    @staticmethod
    def_normalize_type(raw_type: str) -> str:
...
"""Look up a specific argument's property schema from the tools list."""
    ...
    @staticmethod
    def_get_schema_options(arg_schema: dict) -> list[dict]:
"""Normalize any property schema into a list of sub-schemas.
    ...
    @staticmethod
    def_get_types(arg_schema: dict) -> set[str]:
...
"""Return True if the parameter's type set is exactly {"string"}.
    ...
    @staticmethod
    def_try_parse_bool(value: str) -> bool | None:
"""Try to parse a string as bool; return None on failure."""
    ...
    @staticmethod
    def_try_parse_int(value: str) -> int | None:
"""Try to parse a string as int; return None on failure."""
    ...
    @staticmethod
    def_try_parse_wildcard_number(value: str) -> int | float | None:
...
"""Unified argument value parser with anyOf/oneOf support.
    ...
    def_reset_streaming_tool_state(self):
"""Reset the streaming state for a single tool call."""
    ...
    def_make_args_delta(self, argument_diff: str) -> DeltaMessage:
"""Build a DeltaMessage containing only an arguments diff."""
    ...
    def_extract_streaming_incremental(
        self,
