...
url: https://moodledev.io/docs/4.5/tags/advanced
source: sitemap
fetched_at: 2026-02-17T15:05:47.352057-03:00
rendered_js: false
word_count: 191
summary: This document explains advanced functionalities of the Moodle Form API, covering hidden elements, checkbox grouping, sub-action buttons, and repeating form elements.
tags:
    - moodle-development
    - form-api
    - advanced-elements
