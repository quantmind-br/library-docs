...
source: crawler
fetched_at: 2026-02-27T23:38:30.613911-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response schema for audiobook resources, illustrating the data structure for authors, chapters, and narrators.
tags:
    - api-response
    - audiobooks
    - json-schema
