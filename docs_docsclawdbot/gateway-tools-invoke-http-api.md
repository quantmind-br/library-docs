---
title: "null"
url: https://docs.clawd.bot/gateway/tools-invoke-http-api.md
source: llms
fetched_at: 2026-01-26T09:52:16.049836906-03:00
rendered_js: false
word_count: 288
summary: This document explains how to use the POST /tools/invoke HTTP endpoint to directly execute tools through the Clawdbot Gateway, detailing authentication, request parameters, and policy-based routing.
tags:
    - clawdbot
    - http-api
    - tool-invocation
