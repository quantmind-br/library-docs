...
url: https://zellij.dev/tutorials/basic-functionality/
source: sitemap
fetched_at: 2026-01-24T15:52:58.732880257-03:00
rendered_js: false
word_count: 757
summary: This document provides an overview and tutorial for using Zellij, a terminal workspace, focusing on UI navigation, pane management, and editing command scrollback.
tags:
    - zellij
    - terminal-workspace
    - pane-management
...
![An image of the Zellij UI, with labels for the tab bar, the status bar and the session name](https://zellij.dev/img/zellij-ui.png)
...
![An image of Zellij, demonstrating splitting panes to the right and down, as well as stacked panes (several panes on top of each other)](https://zellij.dev/img/zellij-new-panes.png)
...
![An image of Zellij with a floating pane with text labels indicating where to toggle the pane as pinned (always on top), to toggle the floating surface and to open more floating panes.](https://zellij.dev/img/zellij-floating-panes.png)
...
![An image of the multiple-select plugin, showing 2 selected panes and a list of actions that can be performed on them in bulk.](https://zellij.dev/img/zellij-multiple-select.png)
...
![An image of Zellij with a pane open to the vim editor editing its own scrollback](https://zellij.dev/img/tutorial-1-editing-scrollback.png)
