...
source: llms
fetched_at: 2026-01-26T09:51:39.416399826-03:00
rendered_js: false
word_count: 588
summary: This document describes how Clawdbot dynamically constructs system prompts for agents, detailing the structural components, available prompt modes, and context injection methods.
tags:
    - clawdbot
    - system-prompt
    - context-injection
