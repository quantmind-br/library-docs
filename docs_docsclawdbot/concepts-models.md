...
source: llms
fetched_at: 2026-01-26T09:51:25.993077565-03:00
rendered_js: false
word_count: 731
summary: This document explains how to configure and manage LLM models, providers, and fallbacks using the Clawdbot CLI and chat commands. It provides detailed information on selection logic, configuration keys, and model scanning utilities.
tags:
    - model-selection
    - cli-commands
