...
title: Adding boards and tools
url: https://github.com/openagen/zeroclaw/blob/master/docs/contributing/adding-boards-and-tools.md
source: git
fetched_at: 2026-05-02T14:50:32.697591719-03:00
rendered_js: false
word_count: 345
summary: This guide provides instructions for configuring hardware boards, integrating datasheets for RAG-based assistance, and extending the system with custom peripheral tools.
tags:
...
Guide to adding new hardware boards and custom tools to ZeroClaw.
...
See [[hardware-peripherals-design|hardware/hardware-peripherals-design]] for the full design.
