---
title: Moodle 5.1 developer update | Moodle Developer Resources
url: https://moodledev.io/docs/5.1/devupdate
source: sitemap
fetched_at: 2026-02-17T15:37:31.210216-03:00
rendered_js: false
word_count: 674
summary: Outlines key architectural changes, API updates, and deprecations in Moodle 5.1 that impact plugin and theme development.
tags:
    - moodle-5-1
    - plugin-development
    - course-formats
...
## Activity modules: now activities can define a secondary purpose[​](#activity-modules-now-activities-can-define-a-secondary-purpose "Direct link to Activity modules: now activities can define a secondary purpose")
...
See the [Activity module support functions](https://moodledev.io/docs/5.1/apis/plugintypes/mod#activity-module-support-functions) for further information.
...
See the [Restructure documentation](https://moodledev.io/docs/5.1/guides/restructure) for further information on some of the changes required.

## Course format: activity chooser is now in core\_courseformat[​](#course-format-activity-chooser-is-now-in-core_courseformat "Direct link to Course format: activity chooser is now in core_courseformat")
...
## Course format: max sections setting is now deprecated[​](#course-format-max-sections-setting-is-now-deprecated "Direct link to Course format: max sections setting is now deprecated")
...
## Course format: new activity chooser rendering[​](#course-format-new-activity-chooser-rendering "Direct link to Course format: new activity chooser rendering")
