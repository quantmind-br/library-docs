---
title: Pr workflow
url: https://github.com/openagen/zeroclaw/blob/master/docs/contributing/pr-workflow.md
source: git
fetched_at: 2026-05-02T14:50:43.730026884-03:00
rendered_js: false
word_count: 1871
summary: This document defines a deterministic, risk-based operating model and lifecycle management system for handling high-volume pull requests in the ZeroClaw repository.
tags:
...
Related references:
- [[001-index|README]] for documentation taxonomy and navigation.
- [[149-contributing-ci-map|ci-map]] for per-workflow ownership, triggers, and triage flow.
- [[159-contributing-reviewer-playbook|reviewer-playbook]] for day-to-day reviewer execution.
...
Use this section to route quickly before deep review.
...
- [[149-contributing-ci-map|ci-map]] — CI workflow ownership and triage map.
- [[159-contributing-reviewer-playbook|reviewer-playbook]] — reviewer execution model.
...
#pr-workflow #repository-governance #cicd-automation
