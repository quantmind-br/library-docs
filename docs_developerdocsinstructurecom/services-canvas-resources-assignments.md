---
title: Assignments | Instructure Developer Documentation Portal
url: https://developerdocs.instructure.com/services/canvas/resources/assignments
source: sitemap
fetched_at: 2026-02-15T08:57:12.818464-03:00
rendered_js: false
word_count: 3938
summary: This document defines the data structures and schemas for the Assignments API, providing technical specifications for assignment objects, rubric criteria, and submission settings. It details the properties and attributes required for interacting with assignment information via an external interface.
tags:
    - assignments-api
    - data-models
    - api-reference
...
[AssignmentsController#destroyarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignments_controller.rb)
...
Returns an [Assignment](https://developerdocs.instructure.com/services/canvas/resources/assignments#assignment) object.

[AssignmentsApiController#indexarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignments_api_controller.rb)
...
[AssignmentsApiController#user\_indexarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignments_api_controller.rb)

`GET /api/v1/users/:user_id/courses/:course_id/assignments`

**Scope:** `url:GET|/api/v1/users/:user_id/courses/:course_id/assignments`

Returns the paginated list of assignments for the specified user if the current user has rights to view. See [List assignments](https://developerdocs.instructure.com/services/canvas/resources/assignments#method.assignments_api.index) for valid arguments.

[AssignmentsApiController#duplicatearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignments_api_controller.rb)
...
[AssignmentsApiController#student\_group\_membersarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignments_api_controller.rb)
...
Returns a list of [BasicUser](https://developerdocs.instructure.com/services/canvas/resources/assignments#basicuser) objects.

[AssignmentsApiController#showarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignments_api_controller.rb)
...
[AssignmentsApiController#createarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignments_api_controller.rb)
...
[AssignmentsApiController#updatearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignments_api_controller.rb)
...
[AssignmentsApiController#bulk\_updatearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignments_api_controller.rb)
...
Accepts a JSON array of objects containing two keys each: `id`, the assignment id, and `all_dates`, an array of `AssignmentDate` structures containing the base and/or override dates for the assignment, as returned from the [List assignments](https://developerdocs.instructure.com/services/canvas/resources/assignments#method.assignments_api.index) endpoint with include\[]=all\_dates.
...
The bulk update is performed in a background job, use the [Progress API](https://developerdocs.instructure.com/services/canvas/resources/progress#method.progress.show) to check its status.
...
[AssignmentOverridesController#indexarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)
...
Returns a list of [AssignmentOverride](https://developerdocs.instructure.com/services/canvas/resources/assignments#assignmentoverride) objects.

[AssignmentOverridesController#showarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)
...
Returns an [AssignmentOverride](https://developerdocs.instructure.com/services/canvas/resources/assignments#assignmentoverride) object.

[AssignmentOverridesController#group\_aliasarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)
...
[AssignmentOverridesController#section\_aliasarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)
...
[AssignmentOverridesController#createarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)
...
See [Appendix: Group assignments](https://developerdocs.instructure.com/services/canvas/resources/assignments#Group+assignments-appendix) for more info.
...
[AssignmentOverridesController#updatearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)
...
[AssignmentOverridesController#destroyarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)
...
[AssignmentOverridesController#batch\_retrievearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)
...
[AssignmentOverridesController#batch\_createarrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)
...
[AssignmentOverridesController#batch\_updatearrow-up-right](https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb)

`PUT /api/v1/courses/:course_id/assignments/overrides`

**Scope:** `url:PUT|/api/v1/courses/:course_id/assignments/overrides`

Updates a list of specified overrides for each assignment. Handles overrides in a transaction, so either all updates are applied or none. See [Update an assignment override](https://developerdocs.instructure.com/services/canvas/resources/assignments#method.assignment_overrides.update) for available attributes.
