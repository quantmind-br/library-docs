...
url: https://moodledev.io/docs/5.2/tags/core-form
source: sitemap
fetched_at: 2026-02-17T15:39:12.515227-03:00
rendered_js: false
word_count: 321
summary: This document provides an overview of the Moodle Form API, detailing standard and advanced form elements, specialized controls, and usage patterns for developer implementation.
tags:
    - moodle-development
    - form-api
    - web-forms
...
## [Choice Dropdown](https://moodledev.io/docs/5.2/apis/subsystems/form/fields/choicedropdown)
