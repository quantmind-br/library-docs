...
source: sitemap
fetched_at: 2026-04-15T09:01:44.244795986-03:00
rendered_js: false
word_count: 327
summary: This document explains the functionality and configuration of Droid Shield, an integrated security feature designed to prevent the accidental exposure of sensitive credentials by scanning git operations for potential secrets.
tags:
    - security-tool
    - git-security
    - secret-detection
