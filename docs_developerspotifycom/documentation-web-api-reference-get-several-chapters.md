...
url: https://developer.spotify.com/documentation/web-api/reference/get-several-chapters
source: crawler
fetched_at: 2026-02-27T23:38:36.831796-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response structure for retrieving chapter-level metadata for audiobooks or podcasts via the Spotify API.
tags:
    - spotify-api
    - json-response
    - chapter-metadata
