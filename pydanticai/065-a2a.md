---
title: Agent2Agent (A2A) - Pydantic AI
url: https://ai.pydantic.dev/a2a/
source: sitemap
fetched_at: 2026-01-22T22:23:11.683573526-03:00
rendered_js: false
word_count: 649
summary: This document introduces the Agent2Agent (A2A) Protocol and the FastA2A library, explaining how to implement interoperable AI agent communication in Python and expose Pydantic AI agents as A2A-compliant servers.
tags:
    - a2a-protocol
    - fasta2a
    - pydantic-ai
...
[Learn about Gateway](https://ai.pydantic.dev/gateway) agent\_to\_a2a.py
...
- [`Broker`](https://ai.pydantic.dev/api/fasta2a/#fasta2a.Broker "Broker            dataclass   "): to schedule tasks
- [`Worker`](https://ai.pydantic.dev/api/fasta2a/#fasta2a.Worker "Worker            dataclass   "): to execute tasks
...
FastA2A allows you to bring your own [`Storage`](https://ai.pydantic.dev/api/fasta2a/#fasta2a.Storage "Storage"), [`Broker`](https://ai.pydantic.dev/api/fasta2a/#fasta2a.Broker "Broker            dataclass   ") and [`Worker`](https://ai.pydantic.dev/api/fasta2a/#fasta2a.Worker "Worker            dataclass   ").
...
```
pipinstall'pydantic-ai-slim[a2a]'
```

```
uvadd'pydantic-ai-slim[a2a]'
```
...
```
uvicornagent_to_a2a:app--host0.0.0.0--port8000
```
