...
url: https://docs.mistral.ai/developers/quickstarts/first-api-request
source: sitemap
fetched_at: 2026-04-26T04:06:45.396909514-03:00
rendered_js: false
word_count: 169
summary: This document provides a foundational guide for setting up the Mistral AI environment by generating an API key, installing the necessary SDKs, and executing a basic chat completion request.
tags:
    - api-setup
    - mistral-ai
    - sdk-installation
...
#api-setup #sdk-installation #getting-started
