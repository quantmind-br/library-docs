...
source: sitemap
fetched_at: 2026-05-07T21:18:26.798297097-03:00
rendered_js: false
word_count: 72
summary: This document defines the LMCacheConnectorV1Impl class, which manages the initialization and configuration of the LMCache KV connector within the vLLM framework to support KV cache offloading and management.
tags:
    - lmcache
    - vllm
    - kv-cache
...
classLMCacheConnectorV1Impl:
    ...
    defget_inference_info(self) -> dict:
"""Get inference information including vLLM config and related details.
    ...
    defget_inference_version(self) -> str:
"""Get vLLM version information.
    ...
    def_init_kv_caches_from_forward_context(self, forward_context: "ForwardContext"):
...
"""
    ...
    @_lmcache_nvtx_annotate
    defupdate_state_after_alloc(self, request: "Request", num_external_tokens: int):
"""
