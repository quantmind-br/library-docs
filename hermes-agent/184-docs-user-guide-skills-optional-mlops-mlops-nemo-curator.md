---
title: Nemo Curator — GPU-accelerated data curation for LLM training | Hermes Agent
url: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-nemo-curator
source: crawler
fetched_at: 2026-04-24T17:01:25.302191654-03:00
rendered_js: false
word_count: 434
summary: This document serves as a reference and guide for NeMo Curator, NVIDIA's toolkit used to prepare high-quality, diverse training datasets specifically for Large Language Models (LLMs). It details various processing stages including quality filtering, multi-modal deduplication (fuzzy/semantic), PII redaction, and utilizes GPU acceleration for massive data handling.
tags:
    - llm-training-data
    - data-curation
    - gpu-acceleration
...
SourceOptional — install with `hermes skills install official/mlops/nemo-curator`Path`optional-skills/mlops/nemo-curator`Version`1.0.0`AuthorOrchestra ResearchLicenseMITDependencies`nemo-curator`, `cudf`, `dask`, `rapids`Tags`Data Processing`, `NeMo Curator`, `Data Curation`, `GPU Acceleration`, `Deduplication`, `Quality Filtering`, `NVIDIA`, `RAPIDS`, `PII Redaction`, `Multimodal`, `LLM Training Data`
...
# Quality filtering
defquality_score(doc):
returnlen(doc["text"].split())>5# Filter short docs
...
OperationCPU (16 cores)GPU (A100)SpeedupFuzzy dedup (8TB)120 hours7.5 hours16×Exact dedup (1TB)8 hours0.5 hours16×Quality filtering2 hours0.2 hours10×
