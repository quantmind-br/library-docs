...
url: https://moodledev.io/docs/4.1/apis/core/lock
source: sitemap
fetched_at: 2026-02-17T14:54:56.083043-03:00
rendered_js: false
word_count: 330
summary: This document explains the Moodle Locking API, detailing how to prevent concurrent access to shared resources across processes and cluster nodes. It covers performance considerations, implementation patterns using lock factories, and configuration of different lock types.
tags:
    - moodle-api
    - locking-mechanism
    - concurrency-control
