...
url: https://moodledev.io/docs/4.1/apis/plugintypes/assign/submission
source: sitemap
fetched_at: 2026-02-17T14:55:07.852986-03:00
rendered_js: false
word_count: 1579
summary: This document explains the technical requirements and implementation details for creating custom assignment submission plugins, including file structure, naming conventions, and essential class methods.
tags:
    - moodle-development
    - plugin-architecture
    - assignment-module
