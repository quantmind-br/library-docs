...
url: https://moodledev.io/docs/4.5/apis/subsystems/form
source: sitemap
fetched_at: 2026-02-17T15:14:12.766039-03:00
rendered_js: false
word_count: 1054
summary: This document explains how to create, define, and process web forms in Moodle using the Form API, covering both the definition of form classes and the handling of submitted data.
tags:
    - moodle-form-api
    - formslib
    - php
...
- Support for file repository using the [File API](https://moodledev.io/docs/4.5/apis/subsystems/files) .
- Support for many custom Moodle specific and non-specific form elements.
- Facility for [repeated elements](https://moodledev.io/docs/4.5/apis/subsystems/form/advanced/repeat-elements).
...
03. [choicedropdown](https://moodledev.io/docs/4.5/apis/subsystems/form/fields/choicedropdown) - A dropdown menu where custom information is displayed on each option.
...
13. [filepicker](https://moodledev.io/docs/4.5/apis/subsystems/form/usage/files#file-picker) - upload single file
14. [filemanager](https://moodledev.io/docs/4.5/apis/subsystems/form/usage/files#file-manager) - upload multiple files
...
- [lib/formslib.php Usage](https://moodledev.io/docs/4.5/apis/subsystems/form/usage)
