...
url: https://moodledev.io/docs/4.5/apis/subsystems/routing
source: sitemap
fetched_at: 2026-02-17T15:15:05.910504-03:00
rendered_js: false
word_count: 287
summary: This document explains how to implement and configure the Moodle routing system using PHP attributes and the Slim framework for RESTful web services.
tags:
    - moodle-development
    - routing-system
    - rest-api
...
When invoked, any parameter to the route method will be resolved using a combination of [Dependency Injection](https://moodledev.io/docs/4.5/apis/core/di) and resolution of path, query, and header parameters.
