...
url: https://moodledev.io/docs/5.1/apis/core/reportbuilder
source: sitemap
fetched_at: 2026-02-17T15:34:32.189225-03:00
rendered_js: false
word_count: 2129
summary: This document explains the Report Builder API framework for creating standardized reports using columns, filters, and reusable entities.
tags:
    - moodle-api
    - report-builder
    - reporting-framework
...
You may also optionally define the [initial values for any of the default conditions](https://moodledev.io/docs/5.1/apis/core/reportbuilder/filtering) by overriding the `get_default_condition_values()` method.
