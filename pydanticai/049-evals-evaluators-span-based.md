---
title: Span-Based - Pydantic AI
url: https://ai.pydantic.dev/evals/evaluators/span-based/
source: sitemap
fetched_at: 2026-01-22T22:25:25.721965741-03:00
rendered_js: false
word_count: 654
summary: This document explains how to evaluate AI system behavior by analyzing internal execution paths using OpenTelemetry spans captured via Logfire. It provides guidance on using evaluators to verify tool usage, performance metrics, and complex agent logic.
tags:
...
The [`HasMatchingSpan`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.HasMatchingSpan "HasMatchingSpan            dataclass   ") evaluator checks if any span matches a query:
...
The [`SpanTree`](https://ai.pydantic.dev/api/pydantic_evals/otel/#pydantic_evals.otel.SpanTree "SpanTree            dataclass   ") provides methods for span analysis:
...
Each [`SpanNode`](https://ai.pydantic.dev/api/pydantic_evals/otel/#pydantic_evals.otel.SpanNode "SpanNode            dataclass   ") has:
