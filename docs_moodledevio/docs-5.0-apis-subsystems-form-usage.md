...
url: https://moodledev.io/docs/5.0/apis/subsystems/form/usage
source: sitemap
fetched_at: 2026-02-17T15:27:44.411415-03:00
rendered_js: false
word_count: 488
summary: This document explains how to use Moodle's Form API to create, define, and process forms within the Moodle framework, including specific requirements for activity modules.
tags:
    - moodle-development
    - form-api
    - php-forms
