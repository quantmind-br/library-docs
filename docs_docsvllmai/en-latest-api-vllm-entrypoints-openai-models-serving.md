---
title: serving - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/entrypoints/openai/models/serving/
source: sitemap
fetched_at: 2026-05-07T21:20:12.740828082-03:00
rendered_js: false
word_count: 0
summary: This class manages the lifecycle of base LLM models and dynamic LoRA adapter loading, providing an interface to register, list, load, and unload adapters via API endpoints.
tags:
    - lora-adapter
    - model-management
    - llm-serving
...
"""Shared instance to hold data about the loaded base model(s) and adapters.
    ...
    async definit_static_loras(self):
"""Loads all static LoRA modules.
    ...
    defis_base_model(self, model_name: str) -> bool:
        return self.registry.is_base_model(model_name)

    defmodel_name(self, lora_request: LoRARequest | None = None) -> str:
        if lora_request is not None:
            return lora_request.lora_name
        return self.base_model_paths[0].name

    async defshow_available_models(self) -> ModelList:
"""Show available models. This includes the base model and all
    ...
    async def_check_load_lora_adapter_request(
    ...
    async def_check_unload_lora_adapter_request(
        self, request: UnloadLoRAAdapterRequest
    ) -> ErrorResponse | None:
    ...
    async defresolve_lora(self, lora_name: str) -> LoRARequest | ErrorResponse:
