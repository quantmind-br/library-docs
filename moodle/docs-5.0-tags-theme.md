...
url: https://moodledev.io/docs/5.0/tags/theme
source: sitemap
fetched_at: 2026-02-17T15:22:47.112116-03:00
rendered_js: false
word_count: 208
summary: This document provides an overview of Moodle theme development, covering the management of fonts, images, layouts, and CSS styles within the theme plugin architecture. It explains how developers can create custom themes or override existing site elements to modify Moodle's appearance and functionality.
tags:
    - moodle-development
    - theme-plugins
    - css-styling
