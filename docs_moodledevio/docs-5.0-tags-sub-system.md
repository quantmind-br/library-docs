---
title: One doc tagged with "Sub System" | Moodle Developer Resources
url: https://moodledev.io/docs/5.0/tags/sub-system
source: sitemap
fetched_at: 2026-02-17T15:22:24.551189-03:00
rendered_js: false
word_count: 96
summary: This document introduces the Moodle Tag API, which provides a centralized system for creating, managing, and searching labels to group and organize information. It outlines the core PHP classes used to implement tagging functionality and manage tag collections and areas.
tags:
    - moodle
    - tag-api
    - metadata-management
