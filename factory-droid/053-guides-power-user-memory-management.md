...
source: llms
fetched_at: 2026-02-05T21:43:58.877277516-03:00
rendered_js: false
word_count: 1121
summary: This document explains how to implement persistent memory and context management for Droid using markdown files, AGENTS.md references, and automated hooks. It provides a structured approach for maintaining personal preferences and project-specific architectural decisions across different sessions.
tags:
    - memory-management
    - context-persistence
    - factory-ai
