...
url: https://moodledev.io/docs/4.1/apis/subsystems/form
source: sitemap
fetched_at: 2026-02-17T14:56:32.581919-03:00
rendered_js: false
word_count: 986
summary: This document explains how to use the Moodle Form API to create, define, and process accessible and secure forms within the Moodle environment. It covers extending the moodleform class and managing various form elements and data validation.
tags:
    - moodle-form-api
    - php-development
    - web-forms
...
- Support for file repository using the [File API](https://moodledev.io/docs/4.1/apis/subsystems/files) .
- Support for many custom Moodle specific and non-specific form elements.
- Facility for [repeated elements](https://moodledev.io/docs/4.1/apis/subsystems/form/advanced/repeat-elements).
...
03. [float](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#float)
04. [passwordunmask](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#passwordunmask) - A password element with option to show the password in plaintext.
05. [recaptcha](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#recaptcha)
06. [selectyesno](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#selectyesno)
07. [selectwithlink](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#selectwithlink)
08. [date\_selector](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#date_selector)
09. [date\_time\_selector](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#date_time_selector)
10. [duration](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#duration)
11. [editor](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#editor)
12. [filepicker](https://moodledev.io/docs/5.2/apis/subsystems/form/usage/files#file-picker) - upload single file
13. [filemanager](https://moodledev.io/docs/5.2/apis/subsystems/form/usage/files#file-manager) - upload multiple files
14. [tags](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#tags)
15. [addGroup](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#addGroup)
16. [modgrade](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#modgrade)
17. [modvisible](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#modvisible)
18. [choosecoursefile](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#choosecoursefile)
19. [grading](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#grading)
20. [questioncategory](https://docs.moodle.org/dev/lib/formslib.php_Form_Definition#questioncategory)
...
- [lib/formslib.php Usage](https://moodledev.io/docs/4.1/apis/subsystems/form/usage)
