...
url: https://moodledev.io/docs/5.1/apis/subsystems/analytics
source: sitemap
fetched_at: 2026-02-17T15:36:04.019779-03:00
rendered_js: false
word_count: 5667
summary: This document explains the Moodle Analytics API framework, detailing how prediction models are constructed using indicators and targets to generate actionable insights. It outlines the system architecture, data flow, and core machine learning concepts such as training, samples, and static models.
tags:
    - moodle-analytics
    - machine-learning
    - prediction-models
...
Documentation available in [Machine learning backends](https://moodledev.io/docs/5.1/apis/plugintypes/mlbackend).
...
[Machine learning backends](https://moodledev.io/docs/5.1/apis/plugintypes/mlbackend) is a new Moodle plugin type. They are stored in `lib/mlbackend`.
...
This section does not include Machine learning backend interfaces. See [Machine learning backends](https://moodledev.io/docs/5.1/apis/plugintypes/mlbackend#interfaces) for more information on these.
...
Analysis intervals are used to define when the analytics API will train the predictions processor and when it will generate predictions. As explained above in the [Analysis intervals](https://moodledev.io/docs/5.1/apis/subsystems/analytics#analysis-intervals) documentation, they define time ranges based on analysable elements start and end timestamps.
...
As specified in the [Target](https://moodledev.io/docs/5.1/apis/subsystems/analytics#target-core_analyticslocaltargetbase) section.
