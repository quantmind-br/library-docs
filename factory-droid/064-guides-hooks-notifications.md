...
url: https://docs.factory.ai/guides/hooks/notifications.md
source: llms
fetched_at: 2026-02-05T21:43:47.404839317-03:00
rendered_js: false
word_count: 342
summary: This document explains how to configure custom notification hooks for Droid to trigger desktop alerts, sounds, and integrations like Slack or email. It provides cross-platform setup instructions and shell script examples for responding to various session events.
tags:
    - notifications
    - custom-hooks
    - slack-integration
