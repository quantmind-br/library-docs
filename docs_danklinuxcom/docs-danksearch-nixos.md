...
source: sitemap
fetched_at: 2026-01-24T13:34:08.900321678-03:00
rendered_js: false
word_count: 259
summary: This document provides a comprehensive guide for installing and configuring DankSearch on NixOS using the native nixpkgs module or flake integration.
tags:
    - nixos
    - danksearch
    - installation-guide
