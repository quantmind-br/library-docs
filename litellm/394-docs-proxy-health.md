...
For detailed configuration and usage, see [Shared Health Check State](https://docs.litellm.ai/docs/proxy/shared_health_check).
...
To run image generation health checks, specify the mode as "image\_generation" in your config for the relevant model.
...
#### Custom Health Check Prompt[​](#custom-health-check-prompt "Direct link to Custom Health Check Prompt")
...
### Text Completion Models[​](#text-completion-models "Direct link to Text Completion Models")
...
### Speech to Text Models[​](#speech-to-text-models "Direct link to Speech to Text Models")
...
### Text to Speech Models[​](#text-to-speech-models "Direct link to Text to Speech Models")
...
### Rerank Models[​](#rerank-models "Direct link to Rerank Models")
...
### Batch Models (Azure Only)[​](#batch-models-azure-only "Direct link to Batch Models (Azure Only)")
...
### Realtime Models[​](#realtime-models "Direct link to Realtime Models")
...
### Wildcard Routes[​](#wildcard-routes "Direct link to Wildcard Routes")
...
## Background Health Checks[​](#background-health-checks "Direct link to Background Health Checks")
...
### Disable Background Health Checks For Specific Models[​](#disable-background-health-checks-for-specific-models "Direct link to Disable Background Health Checks For Specific Models")
...
### Hide details[​](#hide-details "Direct link to Hide details")
...
## Health Check Timeout[​](#health-check-timeout "Direct link to Health Check Timeout")

The health check timeout is set in `litellm/constants.py` and defaults to 60 seconds.

This can be overridden in the config.yaml by setting `health_check_timeout` in the model\_info section.
...
## `/health/readiness`[​](#healthreadiness "Direct link to healthreadiness")
...
## `/health/liveliness`[​](#healthliveliness "Direct link to healthliveliness")
...
## `/health/services`[​](#healthservices "Direct link to healthservices")
...
## Advanced - Call specific models[​](#advanced---call-specific-models "Direct link to Advanced - Call specific models")

To check health of specific models, here's how to call them:

### 1. Get model id via `/model/info`[​](#1-get-model-id-via-modelinfo "Direct link to 1-get-model-id-via-modelinfo")
...
### 2. Call specific model via `/chat/completions`[​](#2-call-specific-model-via-chatcompletions "Direct link to 2-call-specific-model-via-chatcompletions")
