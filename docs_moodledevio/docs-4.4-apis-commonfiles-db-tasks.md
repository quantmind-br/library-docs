...
url: https://moodledev.io/docs/4.4/apis/commonfiles/db-tasks.php
source: sitemap
fetched_at: 2026-02-17T15:01:55.975729-03:00
rendered_js: false
word_count: 318
summary: This document explains how to define and configure scheduled tasks for plugins, detailing the structure of the tasks.php file and the available properties for controlling timing and execution behavior.
tags:
    - scheduled-tasks
