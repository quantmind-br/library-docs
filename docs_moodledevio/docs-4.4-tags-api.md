...
url: https://moodledev.io/docs/4.4/tags/api
source: sitemap
fetched_at: 2026-02-17T14:57:49.314025-03:00
rendered_js: false
word_count: 1370
summary: This document provides a comprehensive index and high-level overview of the various Core APIs, subsystems, and plugin types available for developers within the Moodle LMS ecosystem.
tags:
    - moodle-development
    - api-reference
    - plugin-architecture
...
## [Activity completion API](https://moodledev.io/docs/4.4/apis/core/activitycompletion)
...
## [Activity modules](https://moodledev.io/docs/4.4/apis/plugintypes/mod)
...
## [Analytics API](https://moodledev.io/docs/4.4/apis/subsystems/analytics)

The Analytics API allows managers to use predictions to detect trends and predict student behaviour

## [Backup API](https://moodledev.io/docs/4.4/apis/subsystems/backup)
...
## [Cache API](https://moodledev.io/docs/4.4/apis/subsystems/muc)
...
## [Check API](https://moodledev.io/docs/4.4/apis/subsystems/check)
...
## [External Services](https://moodledev.io/docs/4.4/apis/subsystems/external)

Moodle has a full-featured Web Service framework, allowing you to use and create web services for use in external systems.

## [Favourites API](https://moodledev.io/docs/4.4/apis/subsystems/favourites)
...
## [HTML Writer API](https://moodledev.io/docs/4.4/apis/core/htmlwriter)
...
## [Machine learning backends](https://moodledev.io/docs/4.4/apis/plugintypes/mlbackend)
...
## [Module visibility and display](https://moodledev.io/docs/4.4/apis/plugintypes/mod/visibility)

Summary

## [Navigation API](https://moodledev.io/docs/4.4/apis/core/navigation)

The Navigation API allows for the manipulation of the navigation system used in Moodle.

## [Output API](https://moodledev.io/docs/4.4/apis/subsystems/output)
...
## [Plagiarism API](https://moodledev.io/docs/4.4/apis/subsystems/plagiarism)
...
## [Preference API](https://moodledev.io/docs/4.4/apis/core/preference)
...
## [Privacy API](https://moodledev.io/docs/4.4/apis/subsystems/privacy)
...
## [Questions API](https://moodledev.io/docs/4.4/apis/subsystems/question)
...
## [Time API](https://moodledev.io/docs/4.4/apis/subsystems/time)
...
## [xAPI (Experience API)](https://moodledev.io/docs/4.4/apis/subsystems/xapi)
