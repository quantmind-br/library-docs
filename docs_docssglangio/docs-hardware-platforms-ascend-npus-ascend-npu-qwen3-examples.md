---
title: Qwen3 Examples - SGLang Documentation
url: https://docs.sglang.io/docs/hardware-platforms/ascend-npus/ascend_npu_qwen3_examples
source: sitemap
fetched_at: 2026-05-11T05:48:37.29514532-03:00
rendered_js: false
word_count: 149
summary: This document provides configuration examples for launching various Qwen3 models on Atlas 800I A3 hardware using the SGLang inference server, including support for speculative decoding and disaggregated prefill/decode setups.
tags:
    - sglang
    - qwen3
    - atlas-800i-a3
...
Model weights could be found [here](https://huggingface.co/Qwen/Qwen3-32B) Speculative model weights could be found [here](https://huggingface.co/Zhihu-ai/Zhi-Create-Qwen3-32B-Eagle3)
