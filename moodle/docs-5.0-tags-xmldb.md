...
url: https://moodledev.io/docs/5.0/tags/xmldb
source: sitemap
fetched_at: 2026-02-17T15:23:30.00224-03:00
rendered_js: false
word_count: 131
summary: This document provides an overview of Moodle's core database APIs and tools for managing data structures, performing CRUD operations, and handling plugin installation upgrades.
tags:
    - moodle-development
    - database-api
    - dml
