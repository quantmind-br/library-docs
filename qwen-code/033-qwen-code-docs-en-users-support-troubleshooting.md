...
source: github_pages
fetched_at: 2026-04-09T09:04:25.549343288-03:00
rendered_js: true
word_count: 1036
summary: This document serves as a comprehensive user guide providing troubleshooting solutions and debugging tips for common issues encountered while using Qwen Code. It covers topics ranging from authentication errors and configuration file management to handling various system error codes.
tags:
    - troubleshooting
    - debugging-tips
    - user-guide
...
- **Q: Where are the Qwen Code configuration or settings files stored?**
  ...
  - A: The Qwen Code configuration is stored in two `settings.json` files:
    ...
    Refer to [Qwen Code Configuration](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/) for more details.
...
- **Error: “Operation not permitted”, “Permission denied”, or similar.**
  ...
  - **Solution:** Refer to the [Configuration: Sandboxing](https://qwenlm.github.io/qwen-code-docs/en/users/features/sandbox/) documentation for more information, including how to customize your sandbox configuration.
...
## IDE Companion not connecting[](#ide-companion-not-connecting)
...
## Existing GitHub Issues similar to yours or creating new Issues[](#existing-github-issues-similar-to-yours-or-creating-new-issues)

If you encounter an issue that was not covered here in this *Troubleshooting guide*, consider searching the Qwen Code [Issue tracker on GitHub](https://github.com/QwenLM/qwen-code/issues) . If you can’t find an issue similar to yours, consider creating a new GitHub Issue with a detailed description. Pull requests are also welcome!

Last updated on March 31, 2026

[Keyboard Shortcuts](https://qwenlm.github.io/qwen-code-docs/en/users/reference/keyboard-shortcuts/ "Keyboard Shortcuts")[Terms of Service](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy/ "Terms of Service")