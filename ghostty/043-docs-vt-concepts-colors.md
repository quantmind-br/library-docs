...
url: https://ghostty.org/docs/vt/concepts/colors
source: crawler
fetched_at: 2026-03-10T06:35:54.049404-03:00
rendered_js: true
word_count: 408
summary: This document explains the color capabilities of Ghostty, detailing its 256-color palette, special colors, dynamic colors, and the various color specification formats it supports for defining colors.
tags:
    - color-specification
    - terminal-emulation
    - ghostty
...
The special colors, when specified, are used to color cells with particular styles — bold, underline, blink, reversed and italic. They can be queried or changed either with [OSC 4](https://ghostty.org/docs/vt/osc/4) using indices from 256 to 260 inclusive, or [OSC 5](https://ghostty.org/docs/vt/osc/5) with indices from 0 to 4 inclusive respectively. The ordinary palette colors are used instead of special colors when not specified.
