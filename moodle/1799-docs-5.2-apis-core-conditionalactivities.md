...
url: https://moodledev.io/docs/5.2/apis/core/conditionalactivities
source: sitemap
fetched_at: 2026-02-17T15:43:14.744161-03:00
rendered_js: false
word_count: 469
summary: This document explains the Moodle Conditional Activities API, which manages activity availability by setting and verifying conditions for user access. It details the condition_info class and its functions for adding, updating, and retrieving conditional clauses.
tags:
    - moodle-api
...
- [How to make a new availability condition plugin](https://moodledev.io/docs/5.2/apis/plugintypes/availability).
