---
title: impl - Rust
url: https://doc.rust-lang.org/stable/std/keyword.impl.html
source: crawler
fetched_at: 2026-05-06T21:28:47.608447276-03:00
rendered_js: false
word_count: 278
summary: This document explains the usage of the impl keyword in Rust, detailing its application for defining inherent and trait implementations, as well as its use in designating types via impl Trait syntax.
tags:
    - rust-programming
    - language-features
...
For more information on implementations, see the [Rust book](https://doc.rust-lang.org/stable/book/ch05-03-method-syntax.html) or the [Reference](https://doc.rust-lang.org/stable/reference/items/implementations.html).
...
For more information on `impl Trait` syntax, see the [Rust book](https://doc.rust-lang.org/stable/book/ch10-02-traits.html#returning-types-that-implement-traits).