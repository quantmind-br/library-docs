---
title: Dataset Management - Pydantic AI
url: https://ai.pydantic.dev/evals/how-to/dataset-management/
source: sitemap
fetched_at: 2026-01-22T22:25:29.359798388-03:00
rendered_js: false
word_count: 464
summary: This document explains how to manage evaluation datasets using pydantic-evals, covering manual creation, serialization to YAML and JSON, loading from various formats, and automated generation via LLMs.
tags:
    - pydantic-evals
    - dataset-management
    - evaluations
...
Pydantic Evals allows you to generate test datasets using LLMs with [`generate_dataset`](https://ai.pydantic.dev/api/pydantic_evals/generation/#pydantic_evals.generation.generate_dataset "generate_dataset            async   ").
...
4. Call [`generate_dataset`](https://ai.pydantic.dev/api/pydantic_evals/generation/#pydantic_evals.generation.generate_dataset "generate_dataset            async   ") to create a [`Dataset`](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset "Dataset") with 2 cases confirming to the schema.
...
1. Generate the [`Dataset`](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset "Dataset") exactly as above.
...
Case-specific evaluators let different cases have different evaluation criteria, which is essential for comprehensive "test coverage". Rather than trying to write one-size-fits-all evaluators, you can specify exactly what "good" looks like for each scenario. This is particularly powerful with [`LLMJudge`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge "LLMJudge            dataclass   ") evaluators where you can describe nuanced requirements per case, making it easy to build and maintain golden datasets. See [Case-specific evaluators](https://ai.pydantic.dev/evals/evaluators/overview/#case-specific-evaluators) for detailed guidance.
