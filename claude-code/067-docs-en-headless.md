...
source: llms
fetched_at: 2026-04-16T22:32:47.61864564-03:00
rendered_js: false
word_count: 1371
summary: This document explains how to run Claude Code programmatically via the Agent SDK using the CLI, including usage of bare mode and structured output formats.
tags:
    - claude-code
    - agent-sdk
    - cli-usage
