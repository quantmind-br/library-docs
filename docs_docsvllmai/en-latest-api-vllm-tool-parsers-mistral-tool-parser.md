---
title: mistral_tool_parser - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/tool_parsers/mistral_tool_parser/
source: sitemap
fetched_at: 2026-05-07T21:36:17.297045647-03:00
rendered_js: false
word_count: 38
summary: This document defines the MistralToolParser class, which handles tool call parsing, request adjustments, and streaming extraction for Mistral models within the vLLM framework.
tags:
    - mistral-models
    - tool-calling
    - vllm-framework
...
```
classMistralToolParser(ToolParser):
r"""Tool call parser for Mistral models, intended for use with either:
    ...
    defextract_maybe_reasoning_and_tool_streaming(
        self,
        *,
...
r"""Streaming extraction with reasoning followed by tool-call parsing.
    ...
    @staticmethod
    defbuild_non_streaming_tool_calls(
...
"""
    ...
    def_generate_delta_tool_call(self, delta_text: str) -> list[DeltaToolCall]:
    ...
    @ijson.coroutine
    defupdate_stream_state_pre_v11_tokenizer(self):
        while True:
    ...
    def_extract_tool_calls_streaming_pre_v11_tokenizer(
        self,
        delta_text: str,
        delta_token_ids: Sequence[int],
    ) -> DeltaMessage | None:
"""
    ...
    def_track_streamed_args_pre_v11(self, tool_call: DeltaToolCall) -> None:
