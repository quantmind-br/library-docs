---
title: Hyperparameter Tuning - SGLang Documentation
url: https://docs.sglang.io/docs/advanced_features/hyperparameter_tuning
source: sitemap
fetched_at: 2026-05-11T05:49:35.375522387-03:00
rendered_js: false
word_count: 759
summary: This document provides performance tuning strategies for SGLang to achieve high throughput during offline batch inference by optimizing scheduling, memory allocation, and parallelism settings.
tags:
    - sglang
    - performance-tuning
    - batch-inference
...
Data parallelism is better for throughput. When there is enough GPU memory, always favor data parallelism for throughput. Refer to [SGLang Model Gateway (former Router)](https://docs.sglang.io/docs/advanced_features/sgl_model_gateway) for a better data parallelism rather than using `dp_size` parameter.
