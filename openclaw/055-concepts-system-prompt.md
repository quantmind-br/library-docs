...
source: sitemap
fetched_at: 2026-01-30T20:32:12.029735827-03:00
rendered_js: false
word_count: 564
summary: This document explains how OpenClaw constructs and manages custom system prompts for agent runs, detailing the structure, modes, and components included in these prompts.
tags:
    - system-prompt
    - agent-run
    - prompt-structure
...
- `minimal`: used for sub-agents; omits **Skills**, **Memory Recall**, **OpenClaw Self-Update**, **Model Aliases**, **User Identity**, **Reply Tags**, **Messaging**, **Silent Replies**, and **Heartbeats**. Tooling, Workspace, Sandbox, Current Date & Time (when known), Runtime, and injected context stay available.
