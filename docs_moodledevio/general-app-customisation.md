---
title: Moodle App Customisation | Moodle Developer Resources
url: https://moodledev.io/general/app/customisation
source: sitemap
fetched_at: 2026-02-17T15:54:18.499253-03:00
rendered_js: false
word_count: 451
summary: This document outlines the various methods for customizing the Moodle App, including modifying its appearance via CSS, extending functionality through plugins, and managing site-wide app settings.
tags:
    - moodle-app
    - customization
...
The fourth option involves building your own application, and it is not covered in this documentation. You can learn more about that in the [Custom Moodle Apps](https://moodledev.io/general/app/customisation/custom-apps) page.

## Changing the app appearance for your site[​](#changing-the-app-appearance-for-your-site "Direct link to Changing the app appearance for your site")
...
You can learn more about this in the [Moodle App Remote themes](https://moodledev.io/general/app/customisation/remote-themes) page.

## Adding support in your plugin for the mobile app[​](#adding-support-in-your-plugin-for-the-mobile-app "Direct link to Adding support in your plugin for the mobile app")

You can create Moodle plugins to change how the app works. You can learn about this in the [Moodle App Plugins development guide](https://moodledev.io/general/app/development/plugins-development-guide) page.

## Configuring how the app should work via Moodle site settings[​](#configuring-how-the-app-should-work-via-moodle-site-settings "Direct link to Configuring how the app should work via Moodle site settings")
...
## Testing and developing[​](#testing-and-developing "Direct link to Testing and developing")

You can test your changes using any Chromium-based browser, but you should launch it with some security features disabled. You can learn more about that in the [Using the Moodle App in a browser](https://moodledev.io/general/app/development/setup/app-in-browser) page.
