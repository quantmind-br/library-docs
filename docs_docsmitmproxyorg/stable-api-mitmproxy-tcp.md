...
source: crawler
fetched_at: 2026-01-28T16:18:43.949683301-03:00
rendered_js: false
word_count: 450
summary: This document defines the `TCPFlow` and `TCPMessage` classes, which are used to represent and manage TCP sessions and their constituent messages within the mitmproxy framework.
tags:
    - tcp-flow
    - tcp-message
    - mitmproxy
