...
url: https://moodledev.io/docs/5.2/guides/javascript/reactive
source: sitemap
fetched_at: 2026-02-17T15:47:03.982858-03:00
rendered_js: false
word_count: 5759
summary: This document explains the principles and implementation of Moodle's adhoc reactive library for building state-driven user interfaces. It details the architecture of components, state management, and mutations to ensure UI consistency and maintainability in plugin development.
tags:
    - moodle-development
    - reactive-ui
    - state-management
