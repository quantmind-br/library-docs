...
If you don't want to provide a fake API key in each request, consider using a provider that directly matches your OpenAI-compatible endpoint, such as [`hosted_vllm`](https://docs.litellm.ai/docs/providers/vllm) or [`llamafile`](https://docs.litellm.ai/docs/providers/llamafile).
