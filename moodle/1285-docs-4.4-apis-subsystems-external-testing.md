...
url: https://moodledev.io/docs/4.4/apis/subsystems/external/testing
source: sitemap
fetched_at: 2026-02-17T15:04:14.114832-03:00
rendered_js: false
word_count: 0
summary: This document provides unit tests for a Moodle external function, demonstrating how to verify capability checks and API execution within a custom module.
tags:
    - moodle
    - phpunit
    - unit-testing
