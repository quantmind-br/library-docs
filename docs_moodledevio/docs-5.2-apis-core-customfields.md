...
url: https://moodledev.io/docs/5.2/apis/core/customfields
source: sitemap
fetched_at: 2026-02-17T15:43:15.566494-03:00
rendered_js: false
word_count: 795
summary: This document provides a technical overview of the Custom Fields API, explaining how to implement handler classes to define custom field areas and integrate them into forms and data retrieval processes.
tags:
    - custom-fields-api
    - moodle-development
    - handler-classes
...
Except for common [Plugin files](https://moodledev.io/docs/5.2/apis/commonfiles) and tests the following classes must be present in `customfield` plugins (in respective autoloaded locations):
