...
url: https://moodledev.io/docs/5.2/apis/subsystems/form
source: sitemap
fetched_at: 2026-02-17T15:45:48.172844-03:00
rendered_js: false
word_count: 1054
summary: The Moodle Form API provides a framework for creating, validating, and processing secure and accessible forms within Moodle using the moodleform class. It outlines the structure of form definitions and describes a wide range of standard and advanced form elements available for developers.
tags:
    - moodle-form-api
    - moodleform
    - php-development
...
- Support for file repository using the [File API](https://moodledev.io/docs/5.2/apis/subsystems/files) .
- Support for many custom Moodle specific and non-specific form elements.
- Facility for [repeated elements](https://moodledev.io/docs/5.2/apis/subsystems/form/advanced/repeat-elements).
...
03. [choicedropdown](https://moodledev.io/docs/5.2/apis/subsystems/form/fields/choicedropdown) - A dropdown menu where custom information is displayed on each option.
...
13. [filepicker](https://moodledev.io/docs/5.2/apis/subsystems/form/usage/files#file-picker) - upload single file
14. [filemanager](https://moodledev.io/docs/5.2/apis/subsystems/form/usage/files#file-manager) - upload multiple files
...
- [lib/formslib.php Usage](https://moodledev.io/docs/5.2/apis/subsystems/form/usage)
