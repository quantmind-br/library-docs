...
source: llms
fetched_at: 2026-04-16T22:35:02.355968172-03:00
rendered_js: false
word_count: 3692
summary: This document explains how to create, manage, and deploy custom skills in Claude Code to extend its capabilities through structured instruction files.
tags:
    - claude-code
    - ai-skills
    - custom-commands
