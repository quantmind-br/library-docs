...
source: crawler
fetched_at: 2026-01-28T16:18:13.105286398-03:00
rendered_js: false
word_count: 288
summary: This document provides a step-by-step tutorial on how to modify intercepted HTTP requests using mitmproxy, focusing on editing specific components of a request's URL path before resuming the flow.
tags:
    - mitmproxy
