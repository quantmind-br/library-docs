---
title: ovis2_5 - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/transformers_utils/processors/ovis2_5/
source: sitemap
fetched_at: 2026-05-07T21:38:10.29675513-03:00
rendered_js: false
word_count: 15
summary: This document defines the Ovis2_5Processor class, which combines a Qwen2 tokenizer and an image processor to handle multimodal input processing for Ovis models.
tags:
...
```
classOvis2_5Processor(ProcessorMixin):
r"""
...
"""
    ...
    def_tokenize_with_visual_symbol(self, text_list: list[str]) -> torch.LongTensor:
        batch_token_ids = []
...
"""Rescales the image so that the following conditions are met:
    ...
    defconstruct_visual_indicators(self, grid, is_video: bool = False):
        if is_video:
    ...
    defconstruct_visual_placeholders(self, grid, is_video: bool = False):
