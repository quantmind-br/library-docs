...
url: https://moodledev.io/docs/4.5/guides/javascript/jquery
source: sitemap
fetched_at: 2026-02-17T15:15:52.006278-03:00
rendered_js: false
word_count: 371
summary: This document outlines Moodle's policies and implementation methods for jQuery and jQuery UI, emphasizing that native ES6 modules are preferred and jQuery use is discouraged for new development.
tags:
    - moodle-development
    - jquery
    - javascript-modules
