---
title: Ling-2.5-1T - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/InclusionAI/Ling-2.5-1T
source: sitemap
fetched_at: 2026-05-11T05:50:40.434384547-03:00
rendered_js: false
word_count: 479
summary: This document provides an overview, installation instructions, and deployment guidelines for the Ling-2.5-1T trillion-parameter language model using the SGLang framework.
tags:
    - ling-2.5-1t
    - sglang
...
For other installation methods, please refer to the [official SGLang installation guide](https://docs.sglang.io/docs/get-started/install). Ling-2.5-1T is also supported via the **nightly PyPI builds**. See the [SGLang Installation (PyPI)](https://docs.sglang.io/docs/get-started/install) guide for setup instructions.
