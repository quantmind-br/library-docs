...
url: https://qwenlm.github.io/qwen-code-docs/en/developers/extensions/extension
source: github_pages
fetched_at: 2026-04-09T09:05:11.786687586-03:00
rendered_js: true
word_count: 958
summary: This document provides a comprehensive guide on managing, creating, and understanding Qwen Code extensions, detailing installation, configuration structures like `qwen-extension.json`, command conflict resolution, and variable usage.
tags:
...
### Create a boilerplate extension[](#create-a-boilerplate-extension)
...
Extensions can provide [custom commands](https://qwenlm.github.io/qwen-code-docs/en/developers/extensions/cli/commands/#custom-commands) by placing TOML files in a `commands/` subdirectory within the extension directory. These commands follow the same format as user and project custom commands and use standard naming conventions.
