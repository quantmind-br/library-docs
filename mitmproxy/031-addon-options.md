...
url: https://docs.mitmproxy.org/stable/addons/options/
source: crawler
fetched_at: 2026-01-28T16:21:12.155644277-03:00
rendered_js: false
word_count: 500
summary: This document serves as a guide for developers on how to define and interact with global options within mitmproxy addons. It explains declaring typed options, handling configuration changes, and validating user input for custom settings.
tags:
    - mitmproxy-addons
    - custom-options
    - addon-configuration
...
[Edit on GitHub](https://github.com/mitmproxy/mitmproxy/blob/main/docs/src/content/addons/options.md)
...
When this addon is loaded, the `addheader` setting is available in the persistent [YAML configuration file](https://docs.mitmproxy.org/stable/concepts/options/). You can also over-ride the value directly from the command-line for any of the tools using the `--set` flag:
