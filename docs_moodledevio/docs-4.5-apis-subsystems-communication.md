...
url: https://moodledev.io/docs/4.5/apis/subsystems/communication
source: sitemap
fetched_at: 2026-02-17T15:13:18.852642-03:00
rendered_js: false
word_count: 1473
summary: This document explains the technical architecture and public methods of the Communication API for managing messaging rooms and memberships through asynchronous tasks and hooks.
tags:
    - communication-api
    - moodle-development
    - room-management
...
The Communication API takes advantage of the [Hooks API](https://moodledev.io/docs/4.5/apis/plugintypes/communication) with actions performed in the following way:
