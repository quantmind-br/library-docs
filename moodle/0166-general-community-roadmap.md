---
title: Roadmap | Moodle Developer Resources
url: https://moodledev.io/general/community/roadmap
source: sitemap
fetched_at: 2026-02-17T15:58:09.41898-03:00
rendered_js: false
word_count: 972
summary: This document explains the purpose, creation process, and strategic priorities of the Moodle Products roadmap, outlining how community feedback and organizational goals drive software development.
tags:
    - moodle-hq
    - product-roadmap
...
## What is a roadmap and why is it important?[​](#what-is-a-roadmap-and-why-is-it-important "Direct link to What is a roadmap and why is it important?")
...
## Who creates the roadmap and how often does it get updated?[​](#who-creates-the-roadmap-and-how-often-does-it-get-updated "Direct link to Who creates the roadmap and how often does it get updated?")
...
## Where do the ideas come from?[​](#where-do-the-ideas-come-from "Direct link to Where do the ideas come from?")
...
2. Our [public forums](https://moodle.org/course/) are available to all community members to obtain support and discuss ideas. They are a rich source of feedback that is used to inform our roadmap.
3. The official voice of our users is the [Moodle Users Association](https://moodleassociation.org/), a group of passionate Moodlers from around the world who suggest and vote for new ideas to be delivered at each new release of the Moodle LMS platform.
4. Many of our Products have Product Advisory Groups (PAGs) which meet on a regular basis to help inform the priorities of our roadmap ideas. These groups are formed by representatives from our user base and our [Moodle Partners](https://moodle.com/solutions/certified-service-providers/) network with whom we work closely to define the needs of our markets in education and workplace learning.
5. Each of our products offers the opportunity to provide feedback via short questionnaires, we review the responses regularly and use the insights to shape our thinking.
6. All members of the Moodle HQ team are encouraged to share their thoughts on the future of our open source platform. From new innovations to maintenance tasks, every idea is welcomed and is considered for prioritisation during our planning process.

## How should the roadmap be interpreted?[​](#how-should-the-roadmap-be-interpreted "Direct link to How should the roadmap be interpreted?")
...
## What are Moodle HQ's current priorities?[​](#what-are-moodle-hqs-current-priorities "Direct link to What are Moodle HQ's current priorities?")
...
### Unlocking Creativity[​](#unlocking-creativity "Direct link to Unlocking Creativity")
...
### Facilitating Collaboration[​](#facilitating-collaboration "Direct link to Facilitating Collaboration")
...
### Optimising outcomes[​](#optimising-outcomes "Direct link to Optimising outcomes")
...
## Where can I find out more?[​](#where-can-i-find-out-more "Direct link to Where can I find out more?")
...
To find out more about Moodle release time-frames, please visit our [Releases](https://moodledev.io/general/releases#general-release-calendar) page.
