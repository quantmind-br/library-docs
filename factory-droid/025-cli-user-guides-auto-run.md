---
title: Auto-Run Mode
url: https://docs.factory.ai/cli/user-guides/auto-run.md
source: llms
fetched_at: 2026-02-05T21:42:08.035872351-03:00
rendered_js: false
word_count: 792
summary: This document explains how to configure and use Auto-Run Mode to control the autonomy levels of an AI agent when executing files and CLI commands based on risk classification.
tags:
    - auto-run-mode
    - autonomy-levels
    - risk-assessment
