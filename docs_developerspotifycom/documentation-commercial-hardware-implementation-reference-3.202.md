---
title: API Reference eSDK 3.202.369 | Spotify for Developers
url: https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202
source: crawler
fetched_at: 2026-02-27T23:41:34.445465-03:00
rendered_js: true
word_count: 20727
summary: This document provides a technical reference for the Spotify Embedded SDK C API, detailing the functions, data structures, and constants required to integrate Spotify playback and connectivity into hardware devices.
tags:
    - spotify-sdk
    - embedded-systems
    - c-api
...
\[in][SpError](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sperror) errorError code\[in]`void` * contextContext pointer that was passed when registering the callback
...
\[in]`enum` [SpPlaybackNotification](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spplaybacknotification) eventType of event\[in]`void` * contextContext pointer that was passed when registering the callback
...
\[in]`enum` [SpConnectionNotification](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spconnectionnotification) eventType of event\[in]`void` * contextContext pointer that was passed when registering the callback
...
\[in]`const` `char` * credentials\_blobCredentials to be passed to [SpConnectionLoginBlob](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spconnectionloginblob)\[in]`const` `char` * usernameuser name to be passed to [SpConnectionLoginBlob](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spconnectionloginblob)\[in]`void` * contextContext pointer that was passed when registering the callback
...
\[in][SpError](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sperror) error\_codeif the update was successful, the value is [kSpErrorOk](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sperror)\[in]`void` * contextContext pointer that was passed when registering the callback
...
\[in]`struct` [SpConfig](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spconfig) * confConfiguration parameters
...
\[in]`const` `char` * usernameSpotify username. UTF-8 encoded. Must not be longer than [SP\_MAX\_USERNAME\_LENGTH](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sp_max_username_length) bytes (not UTF-8-encoded characters), not counting the terminating NULL. (For users that log in via Facebook, this is an email address.)\[in]`const` `char` * credentials\_blobCredentials blob received via ZeroConf or in the callback [SpCallbackConnectionNewCredentials](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spcallbackconnectionnewcredentials) Note: if the credentials\_blob is an empty string, this function should not be called or it will return [kSpErrorFailed](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sperror)
...
\[in]`struct` [SpDebugCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spdebugcallbacks) * cbStructure with pointers to individual callback functions.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callback.
...
\[in]`struct` [SpPlaybackCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spplaybackcallbacks) * cbStructure with pointers to individual callback functions. Any of the pointers in the structure may be NULL.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callbacks.
...
\[out]`struct` [SpMetadata](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spmetadata) * metadataStructure to be filled with the metadata for the track\[in]`int` relative\_indexTrack index relative to the current track. Some relative indices are defined in the `enum` [SpMetadataTrack](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spmetadatatrack)
...
\[in]`const` `char` * image\_uriimage URI returned in [SpMetadata::album\_cover\_uri](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spmetadata)\[out]`char` * image\_urlPointer to a buffer that will be filled with HTTP URL.\[in]size\_t image\_url\_sizesize of the image\_url buffer. [SP\_MAX\_METADATA\_IMAGE\_URL\_LENGTH](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sp_max_metadata_image_url_length) is the max amount of data that can be returned in image\_url.
...
\[out]`char` * player\_cookiePointer to a buffer where the player cookie will be copied. This buffer will be reset even if there is no player cookie available.\[in]size\_t player\_cookie\_sizeSize of the player\_cookie buffer. Player cookie length is defined [SP\_PLAYER\_COOKIE\_LENGTH](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sp_player_cookie_length) and the buffer should be at least SP\_PLAYER\_COOKIE\_LENGTH+1 in size.
...
\[out]`struct` [SpZeroConfVars](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spzeroconfvars) * varsStructure to be filled with the variables
...
\[in]`const` `char` * usernameSpotify username. UTF-8 encoded. Must not be longer than [SP\_MAX\_USERNAME\_LENGTH](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sp_max_username_length) bytes (not UTF-8-encoded characters), not counting the terminating NULL.\[in]`const` `char` * zero\_conf\_blobCredentials blob from the "blob" field of the request. Must not be longer than [SP\_MAX\_ZEROCONF\_BLOB\_LENGTH](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sp_max_zeroconf_blob_length) bytes, not counting the terminating NULL.\[in]`const` `char` * client\_keyClient key from the "clientKey" field of the request. This may be NULL if not supplied in the "addUser" request. Must not be longer than [SP\_MAX\_CLIENT\_KEY\_LENGTH](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sp_max_client_key_length) bytes, not counting the terminating NULL.\[in]`const` `char` * login\_idLogin ID from the "loginId" field of the request. This may be NULL if not supplied in the "addUser" request. Must not be longer than [SP\_MAX\_LOGIN\_ID\_LENGTH](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sp_max_login_id_length) bytes, not counting the terminating NULL.\[in]`const` `char` * token\_typeToken type from the "tokenType" field of the request. This may be NULL if not supplied in the "addUser" request. Must not be longer than [SP\_MAX\_TOKEN\_TYPE\_LENGTH](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sp_max_token_type_length) bytes, not counting the terminating NULL.
...
\[in]`struct` [SpDeviceAliasCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spdevicealiascallbacks) * cbStructure with pointers to individual callback functions. Any of the pointers in the structure may be NULL.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callbacks.
...
\[in]`const` `struct` [SpDeviceAlias](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spdevicealias) * aliasesPointer to an array of [SpDeviceAlias](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spdevicealias) structs filled in with the new alias names and corresponding attributes. The array size must be of size SP\_MAX\_DEVICE\_ALIASES.
...
\[in]`struct` [SpContentCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spcontentcallbacks) * callbacksStructure with pointers to individual callback functions. Any of the pointers in the structure may be NULL.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callbacks.
...
\[in]`const` `char` * hostnameName to be resolved.\[out]`struct` [SpSockaddr](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockaddr) * sockaddrPointer to [SpSockaddr](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockaddr) structure. DNS lookup can result in a single instance of [SpSockaddr](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockaddr) structure only. If the underlying implementation (getaddrinfo(), getaddrinfo\_a() etc) returns multiple addresses (IPv6, IPv4, ...) this callback is responsible for choosing the best suitable one. Port value of [SpSockaddr](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockaddr) is ignored.\[inout]`void` * contextContext provided in callback register procedure.
...
\[in]`struct` [SpSocketHandle](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockethandle) * socketSocket instance to perform action with.\[in]`void` * contextContext provided in callback register procedure.
...
\[in]`struct` [SpSocketHandle](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockethandle) * socketSocket instance to perform action with.\[in]`const` `struct` [SpSockaddr](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockaddr) * addrAddress to connect to.\[in]`void` * contextContext provided in callback register procedure.
...
\[in]`struct` [SpSocketHandle](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockethandle) \*\*out_ socketSocket instance to perform action with.\[in]`enum` [SpSocketPool](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsocketpool) pool\_idSocket pool ID to create the new socket from\[in]`struct` [SpSocketHandle](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockethandle) \** out\_socketSocket created by accepting connection.\[in]`void` * contextContext provided in callback register procedure.
...
\[in]`struct` [SpSocketHandle](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockethandle) * socketSocket instance to perform action with.\[in]`void` * dataBuffer to read data into.\[in]`int` data\_sizeAmount of requested data to read.\[in]`const` `void` \** addrPlatform defined address representation. See [SpCallbackSocketAddress](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spcallbacksocketaddress)\[in]`int` * bytes\_readPointer to store how many bytes were actually read. If NULL, read is still performed. Should stay unchanged if reading has failed.\[in]`void` * contextContext provided in callback register procedure.
...
\[in]`struct` [SpSocketHandle](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockethandle) * socketSocket instance to perform action with.\[in]`const` `void` * dataBuffer with data to be written.\[in]`int` data\_sizeAmount of data to write.\[in]`const` `void` * addrPlatform defined address representation. See [SpCallbackSocketAddress](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spcallbacksocketaddress)\[in]`int` * bytes\_writtenPointer to store how many bytes were actually written. If NULL, write is still performed. Should stay unchanged if writing has failed.\[in]`void` * contextContext provided in callback register procedure.
...
\[in]`struct` [SpSocketHandle](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockethandle) * socketSocket instance for which error code is requested.\[in]`void` * contextContext provided in callback register procedure.
...
\[in]`const` `struct` [SpSockaddr](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockaddr) * addrAddress to convert. Network byte order.\[in]`void` * contextContext provided in callback register procedure.
...
\[in]`struct` [SpDnsHALCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spdnshalcallbacks) * callbacksStructure with pointers to individual callback functions. Any of the pointers in the structure may be NULL.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callbacks.
...
\[in]`struct` [SpSocketHALCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockethalcallbacks) * callbacksStructure with pointers to individual callback functions. Either all pointers are NULL or all are valid.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callbacks.
...
\[in]unsigned `int` stream\_idUnique identifier to identify tracks\[in]`enum` [SpMediaFormat](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spmediaformat) media\_formatInformation about the format of the audio data\[in]`enum` [SpDrmFormat](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spdrmformat) drm\_formatInformation about the used DRM method\[in]`const` `struct` [SpStreamInfo](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spstreaminfo) * stream\_infoAdditional information related to the stream
...
\[in]`struct` [SpStreamCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spstreamcallbacks) * cbStructure with pointers to individual callback functions. Any of the pointers in the structure may be NULL.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callbacks.
...
\[in]`const` `char` * uriThe context URI to play.\[in]`const` `struct` [SpPlayOptions](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spplayoptions) * optsThe options to apply to the play command.\[in]`int` alias\_indexDevice alias index. If aliases aren't used, pass SP\_NO\_ALIAS\_SELECTED.
...
\[in]`struct` [SpDiskStorageCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spdiskstoragecallbacks) * cbStructure with pointers to individual callback functions. Any of the pointers in the structure may be NULL.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callbacks.
...
\[in]`struct` [SpSocketHandle](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#spsockethandle) * socketPointer to eSDK socket already connected to the remote peer.\[in]`void` * contextContext provided in callback register function.
...
\[in]`struct` [SpTLSCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sptlscallbacks) * callbacksStructure with pointers to individual callback functions. All pointers must be valid.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callbacks.
...
\[in]`struct` [SpTokenCallbacks](https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.202#sptokencallbacks) * cbStructure with pointers to individual callback functions. Any of the pointers in the structure may be NULL.\[in]`void` * contextApplication-defined pointer that will be passed unchanged as the context argument to the callbacks.
