---
title: Network & Console Capture - Crawl4AI Documentation (v0.8.x)
url: https://docs.crawl4ai.com/advanced/network-console-capture/
source: sitemap
fetched_at: 2026-04-26T07:45:24.521262826-03:00
rendered_js: false
word_count: 310
summary: This document explains how to configure and use Crawl4AI to capture browser network requests and console messages for the purposes of debugging, security auditing, and performance analysis.
tags:
    - web-scraping
    - network-debugging
    - console-logging
...
Field Description `event_type` Type of event: `"request"`, `"response"`, or `"request_failed"` `url` The URL of the request `timestamp` Unix timestamp when the event was captured
...
Field Description `type` Message type: `"log"`, `"error"`, `"warning"`, `"info"`, etc. `text` The message text `timestamp` Unix timestamp when the message was captured
