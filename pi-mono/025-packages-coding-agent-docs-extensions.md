...
source: git
fetched_at: 2026-05-03T09:31:09.494463426-03:00
rendered_js: false
word_count: 6568
summary: This document provides a technical overview and guide for building TypeScript extensions for the pi coding agent, covering event lifecycle management, custom tool registration, and UI integration.
tags:
    - typescript
    - pi-agent
    - extensions
