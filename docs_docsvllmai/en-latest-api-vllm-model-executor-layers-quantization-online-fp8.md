---
title: fp8 - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/layers/quantization/online/fp8/
source: sitemap
fetched_at: 2026-05-07T21:27:28.234841408-03:00
rendered_js: false
word_count: 140
summary: This document defines the implementation classes for online FP8 quantization methods, specifically covering both per-block and per-tensor strategies for linear and MoE layers.
tags:
    - fp8
    - quantization
    - vllm
...
## Fp8PerBlockOnlineLinearMethod [¶](#vllm.model_executor.layers.quantization.online.fp8.Fp8PerBlockOnlineLinearMethod "Permanent link")
...
```
classFp8PerBlockOnlineLinearMethod(_Fp8OnlineLinearBase):
...
## Fp8PerBlockOnlineMoEMethod [¶](#vllm.model_executor.layers.quantization.online.fp8.Fp8PerBlockOnlineMoEMethod "Permanent link")
...
```
classFp8PerBlockOnlineMoEMethod(_Fp8OnlineMoEBase):
...
## Fp8PerTensorOnlineLinearMethod [¶](#vllm.model_executor.layers.quantization.online.fp8.Fp8PerTensorOnlineLinearMethod "Permanent link")
...
```
classFp8PerTensorOnlineLinearMethod(_Fp8OnlineLinearBase):
...
## Fp8PerTensorOnlineMoEMethod [¶](#vllm.model_executor.layers.quantization.online.fp8.Fp8PerTensorOnlineMoEMethod "Permanent link")
...
```
classFp8PerTensorOnlineMoEMethod(_Fp8OnlineMoEBase):
...
## \_Fp8OnlineLinearBase [¶](#vllm.model_executor.layers.quantization.online.fp8._Fp8OnlineLinearBase "Permanent link")
...
```
class_Fp8OnlineLinearBase(LinearMethodBase):
...
## \_Fp8OnlineMoEBase [¶](#vllm.model_executor.layers.quantization.online.fp8._Fp8OnlineMoEBase "Permanent link")

Bases: `OnlineMoEMethodBase`
...
```
class_Fp8OnlineMoEBase(OnlineMoEMethodBase):
