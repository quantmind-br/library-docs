---
title: FP8 ViT Encoder Attention - vLLM
url: https://docs.vllm.ai/en/latest/features/quantization/fp8_vit_attn/
source: sitemap
fetched_at: 2026-05-07T21:14:24.039487713-03:00
rendered_js: false
word_count: 389
summary: This document explains how to configure FP8 quantization for ViT encoder attention in vLLM to optimize performance for high-resolution vision models. It covers dynamic scaling, static calibration workflows, and performance considerations for specific hardware architectures.
tags:
    - vllm
    - fp8-quantization
    - vision-encoder
...
[](https://github.com/vllm-project/vllm/edit/main/docs/features/quantization/fp8_vit_attn.md "Edit this page")
...
## Calibrate-Once, Reuse Workflow (Recommended)[¶](#calibrate-once-reuse-workflow-recommended "Permanent link")
...
--model$MODEL--mm-encoder-attn-backendFLASHINFER\
--mm-encoder-attn-dtypefp8\
...
## Scale File Format[¶](#scale-file-format "Permanent link")
...
**Core cuDNN attention kernel** (PyTorch profiler, `cudnn_generated_fort_native_sdpa_sm100_flash_fprop`, head\_dim=128, seq\_len=8192):

Hardware BF16 FP8 Speedup GB200 350 us 312 us **1.12x** GB300 300 us 211 us **1.42x**

**End-to-end encoder forward time** (Qwen3-VL-30B-A3B-Instruct on GB200, 3 images/request):

Resolution BF16 median FP8 median Speedup HD (720x1280) 31.77 ms 36.39 ms 0.87x FullHD (1080x1920) 57.99 ms 58.73 ms ~same QHD (1440x2560) 131.83 ms 122.30 ms **1.08x** 4K (2160x3840) 543.44 ms 460.31 ms **1.18x**
...
Metric BF16 FP8 dynamic FP8 static relaxed\_accuracy 0.780 0.776 0.780 anywhere\_accuracy 0.806 0.816 0.814 exact\_match 0.584 0.582 0.578
