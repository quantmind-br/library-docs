---
title: arun_many() - Crawl4AI Documentation (v0.8.x)
url: https://docs.crawl4ai.com/api/arun_many/
source: sitemap
fetched_at: 2026-04-26T07:45:42.490503445-03:00
rendered_js: false
word_count: 507
summary: This document provides a technical reference for the arun_many() function in Crawl4AI, which enables concurrent batch processing of multiple URLs with support for custom dispatchers and streaming.
tags:
    - crawling
    - batch-processing
    - concurrency
...
Returns a **`RunManyReturn`** object which contains either a **list** of [`CrawlResult`](https://docs.crawl4ai.com/api/crawl-result/) objects, or an **async generator** if streaming is enabled. You can iterate to check `result.success` or read each item’s `extracted_content`, `markdown`, or `dispatch_result`.
