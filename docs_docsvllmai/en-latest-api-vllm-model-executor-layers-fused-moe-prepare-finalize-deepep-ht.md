---
title: deepep_ht - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/layers/fused_moe/prepare_finalize/deepep_ht/
source: sitemap
fetched_at: 2026-05-07T21:25:16.248441911-03:00
rendered_js: false
word_count: 0
summary: This document defines a class for preparing and finalizing Mixture-of-Experts (MoE) operations using DeepEP high-throughput kernels, including token dispatching and synchronization handling.
tags:
    - deep-ep
    - moe
    - high-throughput
...
```
classDeepEPHTPrepareAndFinalize(mk.FusedMoEPrepareAndFinalizeModular):
"""
    Prepare/Finalize using DeepEP High-Throughput kernels.
    """

    @staticmethod
    defmaybe_roundup_layer_hidden_size(hidden_size: int, dtype: torch.dtype) -> int:
    ...
    def_get_dispatch_config(self) -> deep_ep.Config | None:
    ...
    def_get_combine_config(self) -> deep_ep.Config | None:
        if self.num_dispatchers_ not in self.available_rank_configs:
            return None
