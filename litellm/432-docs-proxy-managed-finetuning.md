---
title: ✨ [BETA] LiteLLM Managed Files with Finetuning | liteLLM
...
PropertyValueCommentsProxy✅SDK❌Requires postgres DB for storing file ids.Available across all [Batch providers](https://docs.litellm.ai/docs/batches#supported-providers)✅Supported endpoints`/fine_tuning/jobs`
...
### 3. Create the Finetuning Job[​](#3-create-the-finetuning-job "Direct link to 3. Create the Finetuning Job")
...
### 4. Retrieve Finetuning Job[​](#4-retrieve-finetuning-job "Direct link to 4. Retrieve Finetuning Job")
...
### 5. List Finetuning Jobs[​](#5-list-finetuning-jobs "Direct link to 5. List Finetuning Jobs")
...
### 6. Cancel a Finetuning Job[​](#6-cancel-a-finetuning-job "Direct link to 6. Cancel a Finetuning Job")
