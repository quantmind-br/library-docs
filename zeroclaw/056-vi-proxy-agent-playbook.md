...
- **Đối tượng:** operator và maintainer vận hành ZeroClaw trong mạng có proxy.
...
Xem: [[056-vi-proxy-agent-playbook#mode-a-chỉ-proxy-cho-nội-bộ-zeroclaw|Mode A]]
...
Xem: [[056-vi-proxy-agent-playbook#mode-b-chỉ-proxy-cho-các-dịch-vụ-cụ-thể|Mode B]]
...
Xem: [[056-vi-proxy-agent-playbook#mode-c-proxy-cho-toàn-bộ-môi-trường-process|Mode C]]
...
Xem: [[056-vi-proxy-agent-playbook#rollback|Rollback]]
