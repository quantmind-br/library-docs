...
url: https://moodledev.io/docs/5.0/guides/javascript/yui/modules
source: sitemap
fetched_at: 2026-02-17T15:28:49.698324-03:00
rendered_js: false
word_count: 1288
summary: This document explains the purpose, structure, and implementation of YUI modules within the Moodle framework, detailing naming conventions and PHP integration.
tags:
    - moodle-development
    - yui-modules
...
Many people are used to writing their JavaScript code either inline, or in a separate file included using `<script>` tags in their HTML. Although both of these are supported within Moodle, we highly recommend investing a little time in looking into the [YUI](https://moodledev.io/docs/5.0/guides/javascript/yui) module system as it offers some really great features which will benefit you in the long run.
...
- [YUI](https://moodledev.io/docs/5.0/guides/javascript/yui); and
