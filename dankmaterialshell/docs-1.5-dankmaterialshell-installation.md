...
url: https://danklinux.com/docs/1.5/dankmaterialshell/installation
source: sitemap
fetched_at: 2026-02-22T18:44:15.509651-03:00
rendered_js: false
word_count: 1054
summary: This document provides comprehensive installation instructions and dependency requirements for DankMaterialShell across various Linux distributions including Arch, Fedora, Debian, and Ubuntu.
tags:
    - dankmaterialshell
    - linux-installation
    - quickshell
...
For pre-built packages on Fedora, Debian, Ubuntu, and OpenSUSE, see the [DankLinux Repository](https://danklinux.com/docs/1.5/danklinux) page.
...
Visit the [DankLinux Repository](https://danklinux.com/docs/1.5/danklinux) page for OBS and PPA links and more information about available packages.  
...
### quilat-overlay[​](#quilat-overlay "Direct link to quilat-overlay")
...
# With OpenRC (elogind)
sudoUSE="-systemd" emerge --ask gui-shell/dms
```

### tdgentoo[​](#tdgentoo "Direct link to tdgentoo")
...
### dacyberduck overlay[​](#dacyberduck-overlay "Direct link to dacyberduck overlay")
...
3. Configure your compositor keybinds - see the [Keybinds & IPC](https://danklinux.com/docs/1.5/dankmaterialshell/keybinds-ipc) guide
4. Customize appearance via [Themes](https://danklinux.com/docs/1.5/dankmaterialshell/application-themes)
5. Extend functionality with [Plugins](https://danklinux.com/docs/1.5/dankmaterialshell/plugins-overview)

See [Managing Your Installation](https://danklinux.com/docs/1.5/dankmaterialshell/managing) for detailed guidance on service management, environment variables, and updates.

### Systemd Integration (Recommended)[​](#systemd-integration-recommended "Direct link to Systemd Integration (Recommended)")

DankInstall Users

If you used [dankinstall](https://danklinux.com/docs/1.5/dankinstall), this is already configured. The installer runs `systemctl --user enable --now dms` during setup.
...
#### Miracle WM[​](#miracle-wm "Direct link to Miracle WM")
