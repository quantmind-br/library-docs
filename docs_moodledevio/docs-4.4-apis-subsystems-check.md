...
url: https://moodledev.io/docs/4.4/apis/subsystems/check
source: sitemap
fetched_at: 2026-02-17T15:03:57.440744-03:00
rendered_js: false
word_count: 1833
summary: This document explains the Moodle Check API, a framework for performing runtime tests on system configuration, security, and performance, and provides guidance on implementing custom checks.
tags:
    - moodle-development
    - check-api
    - runtime-testing
