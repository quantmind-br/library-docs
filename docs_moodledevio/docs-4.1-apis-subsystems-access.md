...
url: https://moodledev.io/docs/4.1/apis/subsystems/access
source: sitemap
fetched_at: 2026-02-17T14:55:51.023165-03:00
rendered_js: false
word_count: 1125
summary: This document explains the Moodle Access API, detailing how to define capabilities in plugins and programmatically check user permissions within the context-based security model.
tags:
    - moodle-api
    - access-control
    - permissions
...
See [Enrolment API](https://moodledev.io/docs/4.1/apis/subsystems/enrol).
...
- if an activity is specified, verify any [availability restrictions](https://moodledev.io/docs/4.1/apis/subsystems/availability) for the activity
...
- [API guides](https://moodledev.io/docs/4.1/apis)
- [Roles](https://moodledev.io/docs/4.1/apis/subsystems/roles)
- [Role archetypes](https://docs.moodle.org/dev/Role_archetypes)
- [Hardening new Roles system](https://moodledev.io/docs/4.1/apis/subsystems/roles)
