...
url: https://moodledev.io/docs/5.0/apis/core/calendar
source: sitemap
fetched_at: 2026-02-17T15:24:14.679965-03:00
rendered_js: false
word_count: 1799
summary: This document explains the Moodle Calendar API for versions 3.3 and later, detailing how to programmatically create, update, and delete events, manage priorities, and implement action events for dashboards.
tags:
    - moodle
    - calendar-api
    - event-management
