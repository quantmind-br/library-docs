---
title: API Reference eSDK 3.210.385 | Spotify for Developers
url: https://developer.spotify.com/documentation/commercial-hardware/implementation/reference/3.210
source: crawler
fetched_at: 2026-02-27T23:41:29.991072-03:00
rendered_js: true
word_count: 15718
summary: This header file provides the core interface definitions for the Spotify Embedded SDK, including constants, data structures, and callbacks for managing audio playback and connectivity.
tags:
    - spotify-sdk
    - embedded-systems
    - audio-playback
