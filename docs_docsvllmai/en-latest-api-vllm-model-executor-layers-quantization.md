...
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/layers/quantization/
source: sitemap
fetched_at: 2026-05-07T21:26:29.821011235-03:00
rendered_js: false
word_count: 531
summary: This document defines the base class and required interfaces for implementing model quantization configurations within the vLLM framework.
tags:
    - vllm
    - quantization
    - model-config
...
Name Description `awq` `awq_marlin` `base_config` `bitsandbytes` `compressed_tensors` `cpu_wna16` `experts_int8` `fbgemm_fp8` `fp8` `fp_quant` `gguf` `gptq` `gptq_marlin` `inc` `input_quant_fp8` `kv_cache` `modelopt` `moe_wna16` `mxfp4` `online` `quark` `qutlass_utils` `schema`
...
## QuantizationConfig [¶](#vllm.model_executor.layers.quantization.QuantizationConfig "Permanent link")
...
### apply\_vllm\_mapper [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.apply_vllm_mapper "Permanent link")
...
### from\_config `abstractmethod` `classmethod` [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.from_config "Permanent link")
...
### get\_config\_filenames `abstractmethod` `staticmethod` [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.get_config_filenames "Permanent link")
...
### get\_from\_keys `staticmethod` [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.get_from_keys "Permanent link")
...
### get\_from\_keys\_or `staticmethod` [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.get_from_keys_or "Permanent link")
...
### get\_min\_capability `abstractmethod` `classmethod` [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.get_min_capability "Permanent link")
...
### get\_name `abstractmethod` [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.get_name "Permanent link")
...
### get\_quant\_method `abstractmethod` [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.get_quant_method "Permanent link")
...
### get\_supported\_act\_dtypes `abstractmethod` [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.get_supported_act_dtypes "Permanent link")
...
### is\_mxfp4\_quant [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.is_mxfp4_quant "Permanent link")
...
### maybe\_update\_config [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.maybe_update_config "Permanent link")
...
### override\_quantization\_method `classmethod` [¶](#vllm.model_executor.layers.quantization.QuantizationConfig.override_quantization_method "Permanent link")
...
## register\_quantization\_config [¶](#vllm.model_executor.layers.quantization.register_quantization_config "Permanent link")
...
Name Type Description Default `quantization` `str`
...
... )
>>> fromvllm.model_executor.layers.quantizationimport get_quantization_config
...
```
defregister_quantization_config(quantization: str):
"""Register a customized vllm quantization config.
