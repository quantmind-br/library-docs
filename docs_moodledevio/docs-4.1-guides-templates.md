...
url: https://moodledev.io/docs/4.1/guides/templates
source: sitemap
fetched_at: 2026-02-17T14:57:27.929914-03:00
rendered_js: false
word_count: 4325
summary: This document explains the implementation and syntax of the Mustache template system within Moodle for rendering dynamic HTML content across server-side and client-side environments.
tags:
    - mustache
    - templates
    - moodle-development
...
Rendering a template from JavaScript is fairly easy. There is a [JavaScript module](https://moodledev.io/docs/4.1/guides/javascript/modules) that can load (and cache) a template and then use it for rendering the given data.
