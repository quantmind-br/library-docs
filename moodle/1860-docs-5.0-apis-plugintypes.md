...
url: https://moodledev.io/docs/5.0/apis/plugintypes
source: sitemap
fetched_at: 2026-02-17T15:25:06.334641-03:00
rendered_js: false
word_count: 1677
summary: This document outlines the architecture and naming conventions for Moodle plugins, providing a comprehensive reference of available plugin types and their directory structures. It explains the core requirements for internal plugin names and the various functional areas where Moodle can be extended.
tags:
    - moodle-development
    - plugin-architecture
    - naming-conventions
...
Although there are many different types of plugin, there are some things that work the same way in all plugin types. Please see the [Plugin files](https://moodledev.io/docs/5.0/apis/commonfiles) documentation that describes common files which are found in many plugin types.
...
- [Core APIs](https://moodledev.io/docs/5.0/apis)
