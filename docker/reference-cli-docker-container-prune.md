...
source: llms
fetched_at: 2026-01-24T14:35:16.444722711-03:00
rendered_js: false
word_count: 260
summary: This document provides a technical reference for the docker container prune command, which is used to remove all stopped containers and reclaim storage space.
tags:
    - docker
...
DescriptionRemove all stopped containersUsage`docker container prune [OPTIONS]`
...
OptionDefaultDescription[`--filter`](#filter)Provide filter values (e.g. `until=<timestamp>`)`-f, --force`Do not prompt for confirmation
