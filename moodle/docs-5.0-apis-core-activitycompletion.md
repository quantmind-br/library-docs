...
url: https://moodledev.io/docs/5.0/apis/core/activitycompletion
source: sitemap
fetched_at: 2026-02-17T15:24:12.35573-03:00
rendered_js: false
word_count: 2062
summary: This document provides technical instructions for developers on how to implement and support the activity completion system in Moodle plugins, including view-based, grade-based, and custom rules.
tags:
    - moodle-development
    - activity-completion
    - php-api
