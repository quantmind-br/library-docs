...
url: https://moodledev.io/docs/4.1/apis/subsystems/form/advanced/no-submit-button
source: sitemap
fetched_at: 2026-02-17T14:56:38.082778-03:00
rendered_js: false
word_count: 156
summary: This document explains how to use the Moodle moodleform method no_submit_button_pressed() to handle form actions that require redisplaying the form without processing final submission data.
tags:
    - moodle-development
    - form-handling
    - moodleform
