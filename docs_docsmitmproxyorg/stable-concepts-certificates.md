...
source: crawler
fetched_at: 2026-01-28T16:18:18.713592358-03:00
rendered_js: false
word_count: 1422
summary: This document explains how mitmproxy utilizes certificates to decrypt encrypted traffic, covering the installation of its Certificate Authority (CA) on various client devices. It also details concepts like upstream certificate sniffing, handling certificate pinning, and using custom server certificates.
tags:
    - certificates
    - mitmproxy-ca
