---
title: Write a Docker guide
url: https://docs.docker.com/contribute/guides/
source: llms
fetched_at: 2026-01-24T14:02:09.341549485-03:00
rendered_js: false
word_count: 1259
summary: This document outlines the standards and best practices for creating Docker usage guides and tutorials, including structural outlines and formatting rules. It provides instructions on metadata, repository organization, and technical writing style to ensure high-quality documentation.
tags:
    - docker-docs
...
### [Example metadata format](#example-metadata-format)
...
If you're creating a single-page guide, create a single markdown file in the guides directory:
...
Then create the pages for the guide under `content/guides/<dir>/<page>.md` as needed. The [metadata](#metadata-for-guides) lives on the `_index.md` page (you don't need to assign metadata to individual pages).

### [Guides for specific frameworks or languages](#guides-for-specific-frameworks-or-languages)
...
### [Publish a repository under `dockersamples`](#publish-a-repository-under-dockersamples)
...
- **Links**: Use descriptive link text (e.g., [Install Docker](https://docs.docker.com/get-started/get-docker/)).
...
- **Existing guides**
  ...
  - Refer to [Docker Guides](https://docs.docker.com/guides/) for examples and inspiration.
- **Style guides**
...
- **Proposal**
  ...
  - Once the proposal has been accepted, start writing your guide by forking the repository and creating a branch for your work.
    ...
    > Avoid contributing from the `main` branch of your fork, since it makes it more difficult for maintainers to help you fix any issues that may arise.
- **Review**
  
  - Proofread your guide for grammar, clarity, and adherence to the guidelines.
  - Once your draft is ready, raise a pull request, with a reference to the original issue.
  - The Docker documentation team and subject matter experts will review your submission and provide feedback on the pull request directly.
- **Publishing**
