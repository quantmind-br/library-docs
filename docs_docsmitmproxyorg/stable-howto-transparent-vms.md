...
source: crawler
fetched_at: 2026-01-28T15:01:17.505510789-03:00
rendered_js: false
word_count: 329
summary: This guide explains how to set up transparent proxying for virtual machines using mitmproxy, covering VM configuration, DHCP/DNS setup, and traffic redirection.
tags:
    - transparent-proxy
    - virtual-machines
    - mitmproxy
