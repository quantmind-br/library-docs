...
source: sitemap
fetched_at: 2026-01-22T22:14:43.665538476-03:00
rendered_js: false
word_count: 597
summary: This document provides a foundational guide for creating Hyprland plugins using C++, covering prerequisites, project structure, and the plugin lifecycle.
tags:
    - hyprland
    - plugin-development
    - cpp
