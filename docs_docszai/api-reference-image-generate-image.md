...
source: llms
fetched_at: 2026-01-24T11:02:17.338765462-03:00
rendered_js: false
word_count: 82
summary: This document specifies the OpenAPI endpoint for generating high-quality images from text prompts using GLM-Image and CogView models.
tags:
    - image-generation
    - text-to-image
    - api-endpoint
