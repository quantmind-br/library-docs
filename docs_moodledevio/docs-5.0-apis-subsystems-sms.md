...
url: https://moodledev.io/docs/5.0/apis/subsystems/sms
source: sitemap
fetched_at: 2026-02-17T15:28:13.93178-03:00
rendered_js: false
word_count: 645
summary: This document explains how to use the SMS API and Manager class to integrate messaging features into plugins, covering message transmission, retrieval, and status monitoring.
tags:
    - sms-api
    - moodle-development
    - messaging
...
- [SMS gateway](https://moodledev.io/docs/5.0/apis/plugintypes/sms)
...
[SMS gateways](https://moodledev.io/docs/5.0/apis/plugintypes/sms) are plugins that provide a way to interface with external SMS providers. Once a gateway is configured, any component implementing the SMS API can get a list of gateways.
