---
title: gguf_loader - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/model_loader/gguf_loader/
source: sitemap
fetched_at: 2026-05-07T21:28:40.730310202-03:00
rendered_js: false
word_count: 17
summary: This document defines the GGUFModelLoader class, which handles loading and mapping quantized GGUF model files and their corresponding weight tensors to match architecture-specific naming conventions.
tags:
    - gguf
    - model-loading
    - quantization
...
```
classGGUFModelLoader(BaseModelLoader):
"""
    ...
    def_prepare_weights(self, model_config: ModelConfig):
    ...
    @staticmethod
    def_get_all_gguf_files(model_path: str) -> list[str]:
"""Discover all GGUF shard files from a single shard path.
    ...
    def_get_gguf_weights_map(self, model_config: ModelConfig):
"""
        ...
        if hf_checkpoint_map := getattr(
            ...
            defrevert_hf_rename(name: str) -> str:
        ...
        deffind_hf_name_in_tensor_map(hf_name: str) -> str | None:
"""
