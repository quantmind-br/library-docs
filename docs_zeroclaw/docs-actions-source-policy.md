...
url: https://github.com/openagen/zeroclaw/blob/main/docs/actions-source-policy.md
source: git
fetched_at: 2026-02-18T07:12:04.25676-03:00
rendered_js: false
word_count: 399
summary: This document defines the Phase 1 GitHub Actions source policy, establishing an allowlist of trusted action patterns and security guardrails to mitigate supply-chain risks. It provides procedures for auditing policy changes, validating workflow execution, and managing action permissions within the repository.
tags:
    - github-actions
    - ci-cd-security
