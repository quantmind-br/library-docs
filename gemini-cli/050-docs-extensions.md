...
url: https://geminicli.com/docs/extensions#hooks
source: crawler
fetched_at: 2026-01-13T19:15:43.736022049-03:00
rendered_js: false
word_count: 1384
summary: This document explains how to manage Gemini CLI extensions, covering installation, uninstallation, enabling/disabling, updating, creating boilerplate extensions, linking local extensions, and the structure of the `gemini-extension.json` configuration file.
tags:
    - gemini-cli
    - extensions
    - cli-commands
...
[Section titled “hooks/hooks.json format”](#hookshooksjson-format)
...
[Section titled “Supported variables”](#supported-variables)

Just like `gemini-extension.json`, the `hooks/hooks.json` file supports [variable substitution](#variables). This is particularly useful for referencing scripts within the extension directory using `${extensionPath}`.
