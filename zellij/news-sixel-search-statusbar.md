...
url: https://zellij.dev/news/sixel-search-statusbar/
source: sitemap
fetched_at: 2026-01-24T15:52:48.775876614-03:00
rendered_js: false
word_count: 596
summary: This release announcement details the major features introduced in Zellij 0.31.0, including Sixel graphics support, a new search mode for pane scrollback, and dynamic status-bar shortcuts for custom configurations.
tags:
    - zellij
...
![](https://zellij.dev/img/sixel-release-preview.png)

[Sixel graphics](https://en.wikipedia.org/wiki/Sixel) is a DEC protocol that enables displaying images and video in the terminal. With this version, Zellij has become one of its modern implementors. In order to take advantage of this new feature, you’ll need a terminal emulator which itself has Sixel support. Here’s [a nice list](https://www.reddit.com/r/linux/comments/t3m7zm/quick_roundup_of_bitmap_graphics_availability_in/).
...
![](https://zellij.dev/img/custom-keys-status-bar-preview.png)
