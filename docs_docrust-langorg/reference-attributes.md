...
source: crawler
fetched_at: 2026-05-06T21:21:47.321941868-03:00
rendered_js: false
word_count: 1196
summary: This document defines the syntax, categorization, and application of attributes in the Rust programming language, covering both inner and outer attributes, meta items, and active versus inert attribute behaviors.
tags:
    - rust
    - rust-language
    - attributes
...
- [Proc macro attributes](https://doc.rust-lang.org/reference/procedural-macros.html#the-proc_macro_attribute-attribute)
...
- [Inline assembly](https://doc.rust-lang.org/reference/inline-assembly.html) template strings and operands accept outer attributes. Only certain attributes are accepted semantically; for details, see [asm.attributes.supported-attributes](https://doc.rust-lang.org/reference/inline-assembly.html#r-asm.attributes.supported-attributes).

A “meta item” is the syntax used for the [Attr](https://doc.rust-lang.org/reference/attributes.html#grammar-Attr) rule by most [built-in attributes](#built-in-attributes-index). It has the following grammar:
...
The [`cfg`](https://doc.rust-lang.org/reference/conditional-compilation.html#the-cfg-attribute) and [`cfg_attr`](https://doc.rust-lang.org/reference/conditional-compilation.html#the-cfg_attr-attribute) attributes are active. [Attribute macros](https://doc.rust-lang.org/reference/procedural-macros.html#the-proc_macro_attribute-attribute) are active. All other attributes are inert.

The compiler may allow attributes for external tools where each tool resides in its own module in the [tool prelude](https://doc.rust-lang.org/reference/names/preludes.html#tool-prelude). The first segment of the attribute path is the name of the tool, with one or more additional segments whose interpretation is up to the tool.
...
Tool attributes are not available if the [`no_implicit_prelude`](https://doc.rust-lang.org/reference/names/preludes.html#the-no_implicit_prelude-attribute) attribute is used.
...
- Macros
  ...
  - [`macro_export`](https://doc.rust-lang.org/reference/macros-by-example.html#the-macro_export-attribute) — Exports a `macro_rules` macro for cross-crate usage.
  ...
  - [`proc_macro`](https://doc.rust-lang.org/reference/procedural-macros.html#the-proc_macro-attribute) — Defines a function-like macro.
  - [`proc_macro_derive`](https://doc.rust-lang.org/reference/procedural-macros.html#r-macro.proc.derive) — Defines a derive macro.
  - [`proc_macro_attribute`](https://doc.rust-lang.org/reference/procedural-macros.html#the-proc_macro_attribute-attribute) — Defines an attribute macro.
- Diagnostics
...
- Code generation
  ...
  - [`instruction_set`](https://doc.rust-lang.org/reference/attributes/codegen.html#the-instruction_set-attribute) — Specify the instruction set used to generate a function’s code.
- Documentation
