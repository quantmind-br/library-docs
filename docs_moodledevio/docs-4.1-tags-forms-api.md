...
url: https://moodledev.io/docs/4.1/tags/forms-api
source: sitemap
fetched_at: 2026-02-17T14:52:46.704806-03:00
rendered_js: false
word_count: 191
summary: This document describes advanced features of the Moodle Form API, including hidden elements, grouped checkbox controllers, non-submitting buttons for sub-actions, and repeatable element groups.
tags:
    - moodle-forms
    - form-api
    - web-development
