...
url: https://moodledev.io/docs/5.1/apis/subsystems/form/fields/choicedropdown
source: sitemap
fetched_at: 2026-02-17T15:36:46.443017-03:00
rendered_js: false
word_count: 121
summary: This document explains the implementation of the choicedropdown form field and its associated choicelist data definition, which allows for rich dropdown options with icons and descriptions.
tags:
    - form-api
    - choicedropdown
    - choicelist
