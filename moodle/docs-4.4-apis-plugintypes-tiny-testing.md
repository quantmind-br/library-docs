...
url: https://moodledev.io/docs/4.4/apis/plugintypes/tiny/testing
source: sitemap
fetched_at: 2026-02-17T15:03:46.035192-03:00
rendered_js: false
word_count: 687
summary: This document provides instructions for writing Behat tests for Moodle's TinyMCE editor and plugins, including required tags and available step definitions for interacting with the editor interface.
tags:
    - moodle
    - tinymce
    - behat
