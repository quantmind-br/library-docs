...
url: https://moodledev.io/docs/5.1/guides/javascript/comboboxsearch/examples
source: sitemap
fetched_at: 2026-02-17T15:37:45.530863-03:00
rendered_js: false
word_count: 103
summary: This document explains the migration of Moodle grade report modules to a standardized core search dropdown component and provides instructions for implementing it in custom modules.
tags:
    - moodle
    - core-components
    - search-dropdown
