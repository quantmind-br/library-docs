---
title: Moodle App Plugins Upgrade Guide | Moodle Developer Resources
url: https://moodledev.io/general/app/upgrading/plugins-upgrade-guide
source: sitemap
fetched_at: 2026-02-17T15:55:24.841573-03:00
rendered_js: false
word_count: 1906
summary: This document provides comprehensive instructions for upgrading site plugins to maintain compatibility with evolving versions of the Moodle app. It details critical framework changes, including Angular and Ionic migrations, as well as version-specific breaking changes and template syntax updates.
tags:
    - moodle-app
    - plugin-development
    - upgrade-guide
...
## 5.0 to 5.1[​](#50-to-51 "Direct link to 5.0 to 5.1")
...
### Angular 20 Upgrade[​](#angular-20-upgrade "Direct link to Angular 20 Upgrade")
...
Additionally, the `<core-icon>` component has been removed (it was deprecated in 3.9.5). If you were still using it, you should replace it with `<ion-icon>` which now supports [using font icons](https://moodledev.io/general/app/development/plugins-development-guide/api-reference#ion-icon).
...
### Ionic changes[​](#ionic-changes "Direct link to Ionic changes")
...
```
<ion-labelcore-mark-required="true">
    ...
</ion-label>

<ion-avatarcore-user-avatar...>
```
...
### You can now use ES6[​](#you-can-now-use-es6 "Direct link to You can now use ES6")
...
```
functionAddonModCertificateModuleLinkHandler(){
...
```
classAddonModCertificateModuleLinkHandlerextendsthis.CoreContentLinksModuleIndexHandler{
...
### Changes in the app's code[​](#changes-in-the-apps-code "Direct link to Changes in the app's code")
...
- `<core-icon>` has been deprecated, please use `<ion-icon>` which now supports [using font icons](https://moodledev.io/general/app/development/plugins-development-guide/api-reference#ion-icon).
...
### Is there any example I can look at?[​](#is-there-any-example-i-can-look-at "Direct link to Is there any example I can look at?")
...
- [https://github.com/ndunand/moodle-mod\_choicegroup/pull/149](https://github.com/ndunand/moodle-mod_choicegroup/pull/149)
- [https://github.com/ndunand/moodle-mod\_choicegroup/pull/150](https://github.com/ndunand/moodle-mod_choicegroup/pull/150)

You can also look at the [Moodle App Plugins development guide](https://moodledev.io/general/app/development/plugins-development-guide), it has been updated to reflect how to write plugins for the latest version of the app.

## Before 3.5[​](#before-35 "Direct link to Before 3.5")
...
You can read about [Remote add-ons](https://docs.moodle.org/dev/Moodle_Mobile_2_%28Ionic_1%29_Remote_add-ons) for more details.