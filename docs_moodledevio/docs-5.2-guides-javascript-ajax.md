...
url: https://moodledev.io/docs/5.2/guides/javascript/ajax
source: sitemap
fetched_at: 2026-02-17T15:46:53.646925-03:00
rendered_js: false
word_count: 592
summary: This document explains how to implement AJAX interactions in Moodle using the core/ajax JavaScript module and the Web Service API. It covers best practices for structuring code, chaining multiple requests, and security considerations for web service functions.
tags:
    - moodle-development
    - javascript-modules
    - ajax
