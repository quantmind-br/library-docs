---
title: Joins & Reducers - Pydantic AI
url: https://ai.pydantic.dev/graph/beta/joins/
source: sitemap
fetched_at: 2026-01-22T22:25:55.124783796-03:00
rendered_js: false
word_count: 627
summary: This document explains how join nodes in Pydantic Graph synchronize and aggregate results from parallel execution paths using reducer functions. It covers the creation of join nodes and the application of built-in reducers for common data operations.
tags:
    - pydantic-graph
    - parallel-execution
    - join-nodes
...
2. Aggregating their outputs using a [`ReducerFunction`](https://ai.pydantic.dev/api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReducerFunction "ReducerFunction            module-attribute   ")
...
[`ReduceFirstValue`](https://ai.pydantic.dev/api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReduceFirstValue "ReduceFirstValue            dataclass   ") returns the first value it receives and cancels all other parallel tasks. This is useful for "race" scenarios where you want the first successful result:
...
Create custom reducers by defining a [`ReducerFunction`](https://ai.pydantic.dev/api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReducerFunction "ReducerFunction            module-attribute   "):
...
Reducers with access to [`ReducerContext`](https://ai.pydantic.dev/api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReducerContext "ReducerContext            dataclass   ") can call [`ctx.cancel_sibling_tasks()`](https://ai.pydantic.dev/api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReducerContext.cancel_sibling_tasks "cancel_sibling_tasks") to cancel all other parallel tasks in the same fork. This is useful for early termination when you've found what you need:
