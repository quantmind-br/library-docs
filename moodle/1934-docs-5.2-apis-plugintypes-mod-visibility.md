...
url: https://moodledev.io/docs/5.2/apis/plugintypes/mod/visibility
source: sitemap
fetched_at: 2026-02-17T15:44:37.975799-03:00
rendered_js: false
word_count: 1179
summary: This document describes the Moodle API for customizing how activity modules are displayed on course pages, including methods for caching display data and handling dynamic user-specific information.
tags:
    - moodle
    - plugin-development
    - modinfo-api
