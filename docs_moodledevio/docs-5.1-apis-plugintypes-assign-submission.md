...
url: https://moodledev.io/docs/5.1/apis/plugintypes/assign/submission
source: sitemap
fetched_at: 2026-02-17T15:34:48.194808-03:00
rendered_js: false
word_count: 1710
summary: This document outlines the development requirements and structural framework for creating Moodle assignment submission plugins, including naming conventions and core class implementations.
tags:
    - moodle-development
    - assignment-plugin
    - submission-api
