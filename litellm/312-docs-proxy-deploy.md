...
💡 Go here 👉 [to make your first LLM API Request](https://docs.litellm.ai/docs/proxy/user_keys)
...
See [Resolve DB Deadlocks](https://docs.litellm.ai/docs/proxy/db_deadlocks) for details.
...
Refer to [Custom Root Path](https://docs.litellm.ai/docs/proxy/custom_root_ui) for more details.
...
- (Recommended) Use the example file `docker-compose.yml` given in the project root. e.g. [https://github.com/BerriAI/litellm/blob/main/docker-compose.yml](https://github.com/BerriAI/litellm/blob/main/docker-compose.yml)
