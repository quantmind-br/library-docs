...
url: https://moodledev.io/docs/5.1/apis/plugintypes/mod/activitymodule
source: sitemap
fetched_at: 2026-02-17T15:35:21.127852-03:00
rendered_js: false
word_count: 673
summary: This document outlines the redesign and functional enhancements of the Moodle activity chooser, detailing new user features and providing implementation guidance for third-party plugin developers.
tags:
    - moodle-development
    - activity-chooser
    - plugin-api
