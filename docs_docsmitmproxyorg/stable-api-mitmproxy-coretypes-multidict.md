...
source: crawler
fetched_at: 2026-01-28T15:01:14.41544841-03:00
rendered_js: false
word_count: 1942
summary: This document defines the MultiDict and MultiDictView classes, which are dictionary-like data structures that support multiple values per key and provide methods for manipulation.
tags:
    - data-structure
    - dictionary
    - multiple-values
