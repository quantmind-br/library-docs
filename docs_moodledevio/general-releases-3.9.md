---
title: Moodle 3.9 | Moodle Developer Resources
url: https://moodledev.io/general/releases/3.9
source: sitemap
fetched_at: 2026-02-17T16:13:52.483048-03:00
rendered_js: false
word_count: 2455
summary: This document outlines the release notes and system requirements for Moodle 3.9, providing technical specifications for servers, databases, and browsers alongside major feature updates.
tags:
    - moodle
    - release-notes
    - system-requirements
...
Here is [the full list of fixed issues in 3.9.0](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project%20%3D%20mdl%20AND%20resolution%20%3D%20fixed%20AND%20fixVersion%20in%20%28%223.9%22%29%20ORDER%20BY%20priority%20DESC&runQuery=true&clear=true).
...
- PHP version: minimum PHP 7.2.0 *Note: minimum PHP version has increased since Moodle 3.8*. PHP 7.3.x and 7.4.x are supported too. See [Moodle and PHP](https://moodledev.io/general/development/policies/php) for details.
...
DatabaseMinimum versionRecommended[PostgreSQL](http://www.postgresql.org/)9.5 (increased since Moodle 3.8)Latest[MySQL](http://www.mysql.com/)5.6Latest[MariaDB](https://mariadb.org/)10.2.29 (increased since Moodle 3.8)Latest[Microsoft SQL Server](http://www.microsoft.com/en-us/server-cloud/products/sql-server/)2012Latest[Oracle Database](http://www.oracle.com/us/products/database/overview/index.html)11.2Latest
...
For the best experience and optimum security, we recommend that you keep your browser up to date. [https://www.whatsmybrowser.org/](https://www.whatsmybrowser.org/)
...
### Activity chooser overhaul[​](#activity-chooser-overhaul "Direct link to Activity chooser overhaul")
...
### H5P updates and improvements[​](#h5p-updates-and-improvements "Direct link to H5P updates and improvements")
...
- [MDL-67063](https://moodle.atlassian.net/browse/MDL-67063) - Add a mechanism to support multi H5P core\_api versions
...
- [MDL-67788](https://moodle.atlassian.net/browse/MDL-67788) - Add xAPI statement support to mod\_h5p
...
- [MDL-67791](https://moodle.atlassian.net/browse/MDL-67791) - Create xAPI activity report inside mod\_h5p
...
- [MDL-68379](https://moodle.atlassian.net/browse/MDL-68379) - Add support for result, attachments, context to core\_xapi library
- [MDL-68381](https://moodle.atlassian.net/browse/MDL-68381) - Add duration, completion and success to H5P activity attempts
- [MDL-68241](https://moodle.atlassian.net/browse/MDL-68241) - Add xAPI result support on mod\_h5pactivity
- [MDL-68826](https://moodle.atlassian.net/browse/MDL-68826) - Add link to the content bank in the H5P activity

### Content bank[​](#content-bank "Direct link to Content bank")
...
- [MDL-67813](https://moodle.atlassian.net/browse/MDL-67813) - Implement search functionality for the repository\_contentbank
...
### MoodleNet integration[​](#moodlenet-integration "Direct link to MoodleNet integration")

- [MDL-68111](https://moodle.atlassian.net/browse/MDL-68111) - Core setting to toggle MoodleNet features globally (master)
- [MDL-68698](https://moodle.atlassian.net/browse/MDL-68698) - Allow links to be imported by tool\_moodlenet (all versions)
- [MDL-67884](https://moodle.atlassian.net/browse/MDL-67884) - Add links to MoodleNet in Moodle (master)

### Improved participants page filtering[​](#improved-participants-page-filtering "Direct link to Improved participants page filtering")
...
### Course copy[​](#course-copy "Direct link to Course copy")

- [MDL-64843](https://moodle.atlassian.net/browse/MDL-64843) - Course Copy User Interface

### Improved Safe Exam Browser integration[​](#improved-safe-exam-browser-integration "Direct link to Improved Safe Exam Browser integration")

- [MDL-67850](https://moodle.atlassian.net/browse/MDL-67850) - Add Safe Exam Browser integration to the standard Moodle package (moodle-quizaccess\_seb)
...
### Accessibility audit improvements[​](#accessibility-audit-improvements "Direct link to Accessibility audit improvements")
...
- [MDL-67072](https://moodle.atlassian.net/browse/MDL-67072) - Include client\_id and lti\_deployment\_id in OIDC Login Initiation request
...
- [MDL-66332](https://moodle.atlassian.net/browse/MDL-66332) - Add "show differences only" into tool\_capability
...
- [MDL-59594](https://moodle.atlassian.net/browse/MDL-59594) - Allow graceful fast exit of cron.php / adhoc\_task.php via SIGTERM or SIGINT
...
- [MDL-66925](https://moodle.atlassian.net/browse/MDL-66925) - Enable cli/adhoc\_task.php to be run as a pseudo daemon with --keep-alive=60
- [MDL-67433](https://moodle.atlassian.net/browse/MDL-67433) - Update admin/tool/task/cli/adhoc\_task.php to respect task\_adhoc\_concurrency\_limit
...
- [MDL-68537](https://moodle.atlassian.net/browse/MDL-68537) - Update the tool\_mobile\_disabledfeatures setting with H5P and new blocks supported on the app
...
- [MDL-58018](https://moodle.atlassian.net/browse/MDL-58018) - Reduce session lock contention with opt-in READ\_ONLY\_SESSION
...
- [MDL-67635](https://moodle.atlassian.net/browse/MDL-67635) - Speed up file system \\core\\task\\file\_trash\_cleanup\_task
...
### Security improvements and new features[​](#security-improvements-and-new-features "Direct link to Security improvements and new features")

- [MDL-67309](https://moodle.atlassian.net/browse/MDL-67309) - Have options to call check\_password\_policy on every login
...
- [MDL-65835](https://moodle.atlassian.net/browse/MDL-65835) - Deprecate plagiarism\_get\_form\_elements()
- [MDL-63580](https://moodle.atlassian.net/browse/MDL-63580) - Deprecate dupe cron\_run\_single\_task() function
- [MDL-67845](https://moodle.atlassian.net/browse/MDL-67845) - Deprecate 'enrol\_database\_admin\_setting\_category' class
- [MDL-67872](https://moodle.atlassian.net/browse/MDL-67872) - Deprecate and fix plagiarismlib use of config vars
- [MDL-68495](https://moodle.atlassian.net/browse/MDL-68495) - Allow flexible\_table to update dynamically

### Component API upgrades[​](#component-api-upgrades "Direct link to Component API upgrades")
...
- [Notes de mise à jour de Moodle 3.9](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_3.9)
