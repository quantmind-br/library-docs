...
source: sitemap
fetched_at: 2026-05-07T21:18:22.770409601-03:00
rendered_js: false
word_count: 0
summary: This document defines the LMCacheConnectorV1 class, which acts as an interface for integrating LMCache into the vLLM framework for managing and transferring KV cache across workers.
tags:
    - vllm
    - lmcache
    - kv-cache
...
```
classLMCacheConnectorV1(KVConnectorBase_V1):
    @classmethod
...
"""
    ...
    def__init__(
        ...
        if use_native:
            ...
            # lazy import
            fromvllm.distributed.kv_transfer.kv_connector.v1import lmcache_integration
            ...
            # lazy import
            fromlmcache.integration.vllm.vllm_v1_adapterimport (
...
"""
    ...
    defget_kv_connector_kv_cache_events(self) -> LMCacheKVEvents | None:
"""
