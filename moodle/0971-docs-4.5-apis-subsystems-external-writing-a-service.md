...
url: https://moodledev.io/docs/4.5/apis/subsystems/external/writing-a-service
source: sitemap
fetched_at: 2026-02-17T15:13:42.741234-03:00
rendered_js: false
word_count: 1036
summary: This document explains the process of creating and declaring external web service functions for Moodle plugins, covering naming conventions, service definitions, and the implementation of parameter and return value structures.
tags:
    - moodle-development
    - web-services
    - external-api
...
- [Web services developer documentation](https://moodledev.io/docs/4.5/apis/subsystems/external)
