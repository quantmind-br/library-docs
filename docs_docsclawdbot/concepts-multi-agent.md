...
source: llms
fetched_at: 2026-01-26T09:51:26.466045916-03:00
rendered_js: false
word_count: 835
summary: This document explains how to configure and manage multiple isolated AI agents within a single Gateway using routing bindings and workspace isolation. It details the deterministic rules for routing messages from different communication channels and accounts to specific agent personas.
tags:
    - multi-agent
    - routing-rules
    - agent-isolation
