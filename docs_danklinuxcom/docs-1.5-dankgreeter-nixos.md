...
url: https://danklinux.com/docs/1.5/dankgreeter/nixos
source: sitemap
fetched_at: 2026-02-22T18:43:41.820757-03:00
rendered_js: false
word_count: 258
summary: This document provides instructions for installing and configuring the DankGreeter display manager on NixOS using the native nixpkgs module or Flakes.
tags:
    - nixos
    - dankgreeter
    - display-manager
...
DankGreeter is currently only available in the **unstable** branch of nixpkgs. If you're on NixOS stable (currently version 25.11), you'll need to use the [Flake Installation](https://danklinux.com/docs/1.5/dankgreeter/nixos-flake) method instead.
