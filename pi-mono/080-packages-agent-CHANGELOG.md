...
source: git
fetched_at: 2026-03-03T03:38:26.334659-03:00
rendered_js: false
word_count: 845
summary: Tracks release versions, introduces breaking changes and additions to a streaming-based agent framework, focusing on API renames, transport handling, and flow control.
tags:
    - api-changes
    - breaking-changes
    - stream-transport
