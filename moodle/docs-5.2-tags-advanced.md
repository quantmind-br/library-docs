...
url: https://moodledev.io/docs/5.2/tags/advanced
source: sitemap
fetched_at: 2026-02-17T15:38:15.849222-03:00
rendered_js: false
word_count: 191
summary: This document outlines advanced features of the Moodle Form API, including element visibility controls, checkbox grouping, sub-action buttons, and repeating element sets.
tags:
    - moodle-development
    - form-api
    - user-interface
