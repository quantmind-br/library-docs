...
url: https://moodledev.io/docs/5.2/apis/subsystems/tag
source: sitemap
fetched_at: 2026-02-17T15:46:30.914209-03:00
rendered_js: false
word_count: 1190
summary: This document explains the technical implementation of the Moodle Tag API, detailing how developers can define tag areas, integrate tag elements into forms, and programmatically manage tag instances within plugins.
tags:
    - moodle
    - tag-api
    - plugin-development
...
There are more options such as specifying the default value for "Standard tags", having a fixed collection or excluding from search. They can be found in comments in [Core library tag.php](https://moodledev.io/docs/5.2/apis/commonfiles/tag.php)
...
Custom plugins may go beyond the standard tags handling and use them without mixing with regular course/user/wiki/blogs tags, hide them from the "Tag search" page and "Tags" block but instead have their own interface to search/categorise using tags. This can be achieved by defining tag collection, make it not searchable and specify a custom URL to link to when the tag is actually displayed. This all can be defined in db/tag.php, see the comments in [Core library tag.php](https://moodledev.io/docs/5.2/apis/commonfiles/tag.php)
...
- [Core library tag.php](https://moodledev.io/docs/5.2/apis/commonfiles/tag.php)
