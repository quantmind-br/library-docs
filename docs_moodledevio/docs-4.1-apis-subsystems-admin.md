...
url: https://moodledev.io/docs/4.1/apis/subsystems/admin
source: sitemap
fetched_at: 2026-02-17T14:55:51.844814-03:00
rendered_js: false
word_count: 1791
summary: Explains the architecture and implementation of the Moodle administration settings tree, providing details on how to define and register configuration options for plugins.
tags:
    - moodle-development
    - admin-settings
    - php-classes
...
- [configuration for filter](https://moodledev.io/docs/4.1/apis/plugintypes/filter)
