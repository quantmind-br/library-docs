...
url: https://developer.spotify.com/documentation/web-api/reference/get-multiple-episodes
source: crawler
fetched_at: 2026-02-27T23:46:27.451021-03:00
rendered_js: true
word_count: 2
summary: This document provides an example of a JSON response structure for a collection of podcast episode objects, illustrating the metadata fields returned by an API.
tags:
    - spotify-api
    - json-response
    - podcast-episodes
