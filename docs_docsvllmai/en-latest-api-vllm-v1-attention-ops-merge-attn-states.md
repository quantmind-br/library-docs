...
url: https://docs.vllm.ai/en/latest/api/vllm/v1/attention/ops/merge_attn_states/
source: sitemap
fetched_at: 2026-05-07T21:39:59.004872624-03:00
rendered_js: false
word_count: 0
summary: This function performs a weighted merge of partial attention outputs from a KV cache prefix and new suffix tokens using log-sum-exp rescaling, selecting between custom CUDA or Triton kernels based on hardware compatibility.
tags:
    - attention-mechanism
    - kv-cache
    - log-sum-exp
...
"""Merge partial attention outputs from prefix (KV cache) and suffix
    ...
    defsupported_dtypes(prefix: torch.Tensor) -> bool:
    ...
    defsupported_headdim(prefix: torch.Tensor) -> bool:
    ...
    if (
        ...
        fromvllm._custom_opsimport merge_attn_states
        ...
        fromvllm.v1.attention.ops.triton_merge_attn_statesimport (
            merge_attn_states,
        )
