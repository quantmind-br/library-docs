---
title: tp_mapping - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/distributed/kv_transfer/kv_connector/v1/nixl/tp_mapping/
source: sitemap
fetched_at: 2026-05-07T21:18:43.96462731-03:00
rendered_js: false
word_count: 72
summary: This document defines the data structures and logic for calculating tensor parallelism (TP) mappings required for cross-engine KV cache transfers in the NIXL system.
tags:
    - vllm
    - kv-cache
    - tensor-parallelism
...
## ReadSpec `dataclass` [¶](#vllm.distributed.kv_transfer.kv_connector.v1.nixl.tp_mapping.ReadSpec "Permanent link")
...
## TPMapping `dataclass` [¶](#vllm.distributed.kv_transfer.kv_connector.v1.nixl.tp_mapping.TPMapping "Permanent link")
...
## compute\_tp\_mapping [¶](#vllm.distributed.kv_transfer.kv_connector.v1.nixl.tp_mapping.compute_tp_mapping "Permanent link")
