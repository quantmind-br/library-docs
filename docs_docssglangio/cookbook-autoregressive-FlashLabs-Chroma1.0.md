---
title: Chroma-1.0 - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/FlashLabs/Chroma1.0
source: sitemap
fetched_at: 2026-05-11T05:50:53.19002389-03:00
rendered_js: false
word_count: 329
summary: This document provides instructions for installing, configuring, and interacting with the Chroma-1.0 end-to-end speech conversation model.
tags:
    - speech-synthesis
    - voice-cloning
    - docker
...
Download the **Chroma-4B** weights from Hugging Face. You can choose one of the following methods: **Method 1: Using Python (Recommended)**

```
huggingface-cli download FlashLabs/Chroma-4B --local-dir Chroma-4B
```

**Method 2: Using Git Clone** Make sure you have Git LFS installed before cloning.
