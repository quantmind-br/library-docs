...
url: https://moodledev.io/docs/4.4/tags/db
source: sitemap
fetched_at: 2026-02-17T14:58:47.11042-03:00
rendered_js: false
word_count: 106
summary: This document outlines the APIs and resources available for defining database structures and manipulating data within the Moodle platform, including schema documentation and error handling.
tags:
    - moodle-api
    - database-management
    - dml-api
