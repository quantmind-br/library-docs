...
source: git
fetched_at: 2026-05-03T09:31:24.63044021-03:00
rendered_js: false
word_count: 671
summary: Create and manage modular agent skills in Pi — self-contained capability packages loaded on-demand.
tags:
    - agent-skills
    - automation
    - capability-package
...
Add other harness skill directories to settings:
...
3. When a task matches, the agent uses `read` to load the full SKILL.md (use prompting or `/skill:name` to force it)
...
#agent-skills #automation #skill-development
