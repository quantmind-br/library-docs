...
url: https://doc.rust-lang.org/std/io/struct.Chain.html
source: crawler
fetched_at: 2026-05-06T21:24:31.552736453-03:00
rendered_js: false
word_count: 521
summary: The Chain struct in Rust's standard library acts as an adapter that links two readers together, allowing sequential data access across multiple sources.
tags:
    - rust
    - io
    - reader
...
1.0.0 · [Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2718-2722)
...
This struct is generally created by calling [`chain`](https://doc.rust-lang.org/std/io/trait.Read.html#method.chain "method std::io::Read::chain") on a reader. Please see the documentation of [`chain`](https://doc.rust-lang.org/std/io/trait.Read.html#method.chain "method std::io::Read::chain") for more details.

[Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2724-2801)[§](#impl-Chain%3CT,+U%3E)

1.20.0 · [Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2744-2746)
...
1.20.0 · [Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2771-2773)
...
1.20.0 · [Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2798-2800)
...
1.9.0 · [Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2863-2895)[§](#impl-BufRead-for-Chain%3CT,+U%3E)

[Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2864-2872)[§](#method.fill_buf)
...
[Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2874-2876)[§](#method.consume)
...
[Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2878-2891)[§](#method.read_until)
...
1.0.0 · [Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2717)[§](#impl-Debug-for-Chain%3CT,+U%3E)

1.0.0 · [Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2804-2860)[§](#impl-Read-for-Chain%3CT,+U%3E)

[Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2805-2813)[§](#method.read)
...
[Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2815-2823)[§](#method.read_vectored)
...
[Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2826-2828)[§](#method.is_read_vectored)
...
[Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2830-2838)[§](#method.read_to_end)
...
[Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#2843-2859)[§](#method.read_buf)
...
1.0.0 · [Source](https://doc.rust-lang.org/src/std/io/mod.rs.html#991-993)[§](#method.read_to_string)
