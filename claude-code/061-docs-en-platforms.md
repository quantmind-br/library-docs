...
source: llms
fetched_at: 2026-04-16T22:34:06.648451019-03:00
rendered_js: false
word_count: 949
summary: This document provides an overview of the various platforms, integrations, and remote access methods available for running Claude Code. It helps users choose between CLI, Desktop, IDEs, and cloud-based surfaces to best fit their specific development workflows.
tags:
    - claude-code
    - developer-workflow
    - platform-comparison
