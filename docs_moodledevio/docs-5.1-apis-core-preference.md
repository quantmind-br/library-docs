...
url: https://moodledev.io/docs/5.1/apis/core/preference
source: sitemap
fetched_at: 2026-02-17T15:34:31.154485-03:00
rendered_js: false
word_count: 306
summary: This document provides an overview and technical documentation for the Preference API used to store and retrieve user-specific settings in the database or session. It describes primary functions for managing user preferences and provides guidance on best practices for handling default values.
tags:
    - moodle
    - preference-api
    - user-data
