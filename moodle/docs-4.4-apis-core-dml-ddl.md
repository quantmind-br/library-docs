...
url: https://moodledev.io/docs/4.4/apis/core/dml/ddl
source: sitemap
fetched_at: 2026-02-17T15:02:17.397434-03:00
rendered_js: false
word_count: 453
summary: This document outlines the Data Definition Language (DDL) functions in Moodle used to manage database structures such as tables, fields, and indexes during installation and upgrade processes.
tags:
    - moodle-development
    - database-management
    - ddl-api
...
- [DML functions](https://moodledev.io/docs/4.4/apis/core/dml): Where all the functions used to handle DB data ([DML](https://docs.moodle.org/wikipedia/Data_Manipulation_Language)) are defined.