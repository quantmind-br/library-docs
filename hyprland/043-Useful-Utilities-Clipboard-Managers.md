...
source: sitemap
fetched_at: 2026-01-22T22:15:39.533261536-03:00
rendered_js: false
word_count: 594
summary: This document outlines various clipboard managers compatible with Hyprland and provides setup instructions for integrating them into a Wayland-based workflow.
tags:
    - hyprland
    - wayland
    - clipboard-manager
...
- [`clipse`](https://github.com/savedra1/clipse) - Utilizes Wayland with `wl-clipboard` support and runs from a single binary.  
...
The class is optional, but it’s recommended to use a floating window to achieve more GUI-like behavior.
