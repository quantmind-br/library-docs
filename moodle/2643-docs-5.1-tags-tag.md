...
url: https://moodledev.io/docs/5.1/tags/tag
source: sitemap
fetched_at: 2026-02-17T15:33:13.535767-03:00
rendered_js: false
word_count: 96
summary: This document introduces the Moodle Tag API, explaining its role in labeling, organizing, and managing system information through specific PHP classes and methods.
tags:
    - moodle
    - tag-api
    - metadata-management
