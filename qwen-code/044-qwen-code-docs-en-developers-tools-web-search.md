---
title: Web Search Tool (web_search)
url: https://qwenlm.github.io/qwen-code-docs/en/developers/tools/web-search
source: github_pages
fetched_at: 2026-04-09T09:04:55.956924296-03:00
rendered_js: true
word_count: 633
summary: This guide details the `web_search` tool, explaining how to use it to perform internet searches through multiple integrated providers like DashScope, Tavily, and Google. It provides detailed instructions on configuring these services via settings files, environment variables, or command line arguments.
tags:
    - web-search
    - tool-usage
    - api-integration
...
### Method 1: Settings File (Recommended)[](#method-1-settings-file-recommended)
...
### Method 3: Command Line Arguments[](#method-3-command-line-arguments)
...
## Disabling Web Search[](#disabling-web-search)
...
### Basic search (using default provider)[](#basic-search-using-default-provider)

```
web_search(query="latest advancements in AI")
```

### Search with specific provider[](#search-with-specific-provider)
...
- **Setup:**
  ...
  2. Create a Custom Search Engine at [https://programmablesearchengine.google.com](https://programmablesearchengine.google.com)
...
[Web Fetch](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/web-fetch/ "Web Fetch")[Memory](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/memory/ "Memory")