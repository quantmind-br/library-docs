---
title: Availability API | Moodle Developer Resources
url: https://moodledev.io/docs/4.4/apis/subsystems/availability
source: sitemap
fetched_at: 2026-02-17T15:03:51.621312-03:00
rendered_js: false
word_count: 869
summary: This document explains how to use the Moodle Availability API to manage and restrict user access to course activities and sections based on specific criteria. It covers checking visibility permissions for individuals, filtering user lists, and programmatically configuring availability restrictions.
tags:
    - moodle-development
    - availability-api
    - access-control
...
### Check access for a user[​](#check-access-for-a-user "Direct link to Check access for a user")
...
#### Accessing information for a different user[​](#accessing-information-for-a-different-user "Direct link to Accessing information for a different user")
...
### Display a list of users who may be able to access the current activity[​](#display-a-list-of-users-who-may-be-able-to-access-the-current-activity "Direct link to Display a list of users who may be able to access the current activity")
...
## Using availability conditions in other areas[​](#using-availability-conditions-in-other-areas "Direct link to Using availability conditions in other areas")

The availability API is provided for activities (course-modules) and sections. It is also possible to use it in other areas such as *within* a module. See [Availability API for items within a module](https://docs.moodle.org/dev/Availability_API_for_items_within_a_module).

## Programmatically setting availability conditions[​](#programmatically-setting-availability-conditions "Direct link to Programmatically setting availability conditions")
...
- Writing [Availability condition](https://moodledev.io/docs/4.4/apis/plugintypes/availability) plugins