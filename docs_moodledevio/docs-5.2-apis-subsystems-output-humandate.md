...
url: https://moodledev.io/docs/5.2/apis/subsystems/output/humandate
source: sitemap
fetched_at: 2026-02-17T15:46:06.025198-03:00
rendered_js: false
word_count: 108
summary: This document provides instructions on using Moodle's humandate and humantimeperiod classes to render timestamps and time intervals in human-readable formats.
tags:
    - moodle
    - php
    - humandate
