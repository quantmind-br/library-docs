...
source: sitemap
fetched_at: 2026-05-07T21:17:58.788741972-03:00
rendered_js: false
word_count: 8
summary: This document provides a set of load-balancing algorithms for Mixture-of-Experts (MoE) models, including strategies for expert packing, replication, and hierarchical distribution across GPU clusters.
tags:
    - load-balancing
    - mixture-of-experts
    - gpu-optimization
...
```
classDefaultEplbPolicy(AbstractEplbPolicy):
    @classmethod
    defbalanced_packing(
...
"""
    ...
    @classmethod
    defrebalance_experts_hierarchical(
        cls,
        weight: np.ndarray,
...
"""
        ...
        definverse(perm: np.ndarray) -> np.ndarray:
