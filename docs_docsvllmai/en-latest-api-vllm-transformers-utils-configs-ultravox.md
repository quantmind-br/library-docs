---
title: ultravox - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/transformers_utils/configs/ultravox/
source: sitemap
fetched_at: 2026-05-07T21:37:43.863404957-03:00
rendered_js: false
word_count: 4
summary: This document defines the configuration class for the Ultravox multimodal model, detailing the parameters used to initialize its audio and text backbones and architectural components.
tags:
    - ultravox
    - model-config
    - multimodal-learning
...
```
classUltravoxConfig(transformers.PretrainedConfig):
r"""
    ...
    def__setattr__(self, key, value):
        ...
        if key == "text_model_id" and value is not None:
            fromvllm.transformers_utils.configimport get_config
    ...
    @property
    deftext_config(self) -> transformers.PretrainedConfig:
