---
title: Repo map
url: https://github.com/openagen/zeroclaw/blob/master/docs/maintainers/repo-map.md
source: git
fetched_at: 2026-05-02T14:51:43.820866511-03:00
rendered_js: false
word_count: 1319
summary: An architectural overview of the ZeroClaw Rust-based autonomous agent runtime, detailing its module structure, runtime flow, and core system components like providers, messaging channels, and tool integration.
tags:
    - rust
    - autonomous-agents
    - llm-runtime
...
| `lib.rs` | 436 | Module declarations, visibility (`pub` vs `pub(crate)`), CLI command enums shared between lib and binary. |
...
#rust #autonomous-agents #llm-runtime #system-architecture #project-layout #agentic-workflow
