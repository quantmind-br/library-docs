---
title: Peer review | Moodle Developer Resources
url: https://moodledev.io/general/development/process/peer-review
source: sitemap
fetched_at: 2026-02-17T16:00:14.093401-03:00
rendered_js: false
word_count: 3531
summary: This document provides a comprehensive checklist and detailed guidelines for conducting peer reviews on Moodle code contributions to ensure quality, consistency, and compliance with project standards.
tags:
    - moodle
    - peer-review
    - coding-standards
...
## Peer review list[​](#peer-review-list "Direct link to Peer review list")
...
- Feedback any notices (E\_STRICT, etc) seen into the MDL.

### Component library[​](#component-library "Direct link to Component library")

Any improvement or new feature that introduces UI features to Moodle core from Moodle 4.0 onwards must be documented within the [Component library](https://moodledev.io/general/development/tools/component-library).
...
- Is documented in the [Component library](https://moodledev.io/general/development/tools/component-library)
...
- Language strings have not been removed or renamed, had their meaning changed or had their parameters changed in stable branches (permitted only in main following [string deprecation policy](https://moodledev.io/general/projects/api/string-deprecation)); and
...
But, remember that what you are doing here is part of a peer review. If you want to perform a systematic accessibility check, you can follow the [Accessibility checklist](https://moodledev.io/general/development/process/peer-review/accessibility-checklist).
...
### Performance and clustering[​](#performance-and-clustering "Direct link to Performance and clustering")
...
- Any code that runs is not specific to a single node. (eg opcache\_reset()) This ensures clusters will run correctly.
...
- If the issue itself is a [security](https://docs.moodle.org/dev/security) issue, the [security process](https://moodledev.io/general/development/process#security-issues) is being followed.
...
### The Moodle mobile app[​](#the-moodle-mobile-app "Direct link to The Moodle mobile app")
...
- New global settings that affect new features for the app are included in the WebServices returning global settings (tool\_mobile\_get\_config)
- The testing instructions include testing steps for the Moodle App

### Third party code[​](#third-party-code "Direct link to Third party code")

Does the change contain [third party code](https://moodledev.io/general/community/plugincontribution/thirdpartylibraries)? If so, ensure that:

- The code is licensed under a [GPL compatible license](http://www.gnu.org/licenses/license-list.html#GPLCompatibleLicenses%7C).
- The instructions for upgrading/importing the library and contained within a readme\_moodle.txt file.
...
- Any modifications to third party code are recorded in readme\_moodle.txt
...
- Where an API has been changed significantly, ensure that [upgrade notes](https://moodledev.io/general/development/upgradenotes) have been written (or upgrade.txt on older branches).
- Where something has been deprecated, that the comments don't just say "do NOT use this any more!!!" but actually follow the [deprecation policy](https://moodledev.io/general/development/policies/deprecation).
- Appropriate [labels](https://moodledev.io/general/development/tracker/labels) have been added when there has been a function change, particularly
  ...
  - `ui_change` - any functional change, usually paired with docs\_required, except ui\_change remains permanently
  - `api_change`- any change to APIs that devs will need to know about, usually paired with dev\_docs\_required, except api\_change remains permanently,
...
- The commit matches the [Coding style](https://moodledev.io/general/development/policies/codingstyle#git-commits)
...
- Git branches have been provided for all the right Moodle branches. The \[supported branches list|[https://moodledev.io/general/releases#version-support](https://moodledev.io/general/releases#version-support)] will help you decide:
  ...
  - For security bugs, this is `main` and all the 'Current stable' and 'Current security' branches (but note the \[special process for handling security fixes|[https://moodledev.io/general/development/process#security-issues](https://moodledev.io/general/development/process#security-issues)]).
...
### Testing instructions and automated tests[​](#testing-instructions-and-automated-tests "Direct link to Testing instructions and automated tests")
...
- The manual testing instructions:
  ...
  - Are in the [correct format](https://moodledev.io/general/development/process/testing/guide).
  - Are clear.
  - Are concise.
...
- However, running automated tests takes time and energy. Check that the tests are not excessive, and that they follow best practice (e.g. Behat tests using generators, not setting things up through the UI.) Don't make [MDL-15169](https://moodle.atlassian.net/browse/MDL-15169) worse!
...
### Overall completeness and correctness[​](#overall-completeness-and-correctness "Direct link to Overall completeness and correctness")
...
You should now add the '[ready\_for\_integration](https://moodledev.io/general/development/tracker/labels)' tag to the issue to indicate you have passed the peer review and it can move to the next step.
...
### Peer review for development by HQ or a known common contributor[​](#peer-review-for-development-by-hq-or-a-known-common-contributor "Direct link to Peer review for development by HQ or a known common contributor")
...
### Peer review for external developers[​](#peer-review-for-external-developers "Direct link to Peer review for external developers")
