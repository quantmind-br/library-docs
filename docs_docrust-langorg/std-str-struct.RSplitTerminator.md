...
url: https://doc.rust-lang.org/std/str/struct.RSplitTerminator.html
source: crawler
fetched_at: 2026-05-06T21:22:44.714416295-03:00
rendered_js: false
word_count: 1419
summary: This document serves as a comprehensive API reference for the Rust Iterator trait, detailing the methods and associated types used for traversing and manipulating sequences of data.
tags:
    - rust
    - iterator-trait
    - api-reference
