...
url: https://hyprland-community.github.io/pyprland/versions/2.5.x/expose
source: github_pages
fetched_at: 2026-01-31T15:57:44.000340513-03:00
rendered_js: false
word_count: 104
...
For a similar feature using a menu, try the [fetch\_client\_menu](https://hyprland-community.github.io/pyprland/versions/2.5.x/fetch_client_menu.html) plugin (less intrusive).
...
If you are looking for `toggle_minimized`, check the [toggle\_special](https://hyprland-community.github.io/pyprland/versions/2.5.x/toggle_special.html) plugin
