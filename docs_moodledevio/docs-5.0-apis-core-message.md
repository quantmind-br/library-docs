...
url: https://moodledev.io/docs/5.0/apis/core/message
source: sitemap
fetched_at: 2026-02-17T15:24:51.323969-03:00
rendered_js: false
word_count: 811
summary: This document explains how to use the Moodle Messaging API to programmatically send notifications to users and register components as message producers.
tags:
    - moodle
    - messaging-api
    - php
