...
url: https://moodledev.io/docs/5.2/apis/plugintypes/sms
source: sitemap
fetched_at: 2026-02-17T15:44:51.550276-03:00
rendered_js: false
word_count: 0
summary: This document provides a PHP implementation of an SMS gateway gateway class designed to send messages using the AWS SNS service.
tags:
    - php
    - aws-sns
    - sms-gateway
