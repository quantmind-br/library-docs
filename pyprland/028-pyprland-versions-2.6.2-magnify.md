...
url: https://hyprland-community.github.io/pyprland/versions/2.6.2/magnify
source: github_pages
fetched_at: 2026-01-31T16:02:02.640404965-03:00
rendered_js: false
word_count: 255
...
Duration in tenths of a second for the zoom animation to last, set to `15` for the former behavior. It is not needed anymore with recent Hyprland versions, you can even customize the animation in use:
