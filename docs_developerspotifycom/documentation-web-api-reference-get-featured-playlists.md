...
source: crawler
fetched_at: 2026-02-27T23:39:00.922847-03:00
rendered_js: true
word_count: 2
summary: This document provides a sample JSON response for an API endpoint returning a collection of playlists and their associated metadata.
tags:
    - api-response
    - json-format
    - spotify-web-api
