...
source: llms
fetched_at: 2026-04-16T22:34:39.038014736-03:00
rendered_js: false
word_count: 2441
summary: This document explains the sandboxing features of Claude Code, detailing how filesystem and network isolation provide a secure environment for autonomous agent execution through OS-level primitives.
tags:
    - claude-code
    - sandboxing
    - security-isolation
