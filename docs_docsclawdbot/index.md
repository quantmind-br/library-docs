...
source: llms
fetched_at: 2026-01-26T09:52:23.933103444-03:00
rendered_js: false
word_count: 862
summary: Clawdbot is a multi-platform messaging gateway that bridges services like WhatsApp, Telegram, and Discord to AI coding agents. It features a centralized architecture for managing channel connections, agent routing, and remote access via a browser-based dashboard.
tags:
    - clawdbot
    - messaging-gateway
    - ai-agents
