...
url: https://moodledev.io/docs/4.4/guides/javascript/modal
source: sitemap
fetched_at: 2026-02-17T15:05:26.435166-03:00
rendered_js: false
word_count: 609
summary: This document explains how to implement and customize accessible modal dialogues in Moodle using the core modal module, covering basic creation, standard types, and legacy support for older versions.
tags:
    - moodle-development
    - javascript
    - modal-dialogue
