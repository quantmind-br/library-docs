---
title: Pr workflow
url: https://github.com/openagen/zeroclaw/blob/master/docs/vi/pr-workflow.md
source: git
fetched_at: 2026-05-02T14:52:47.675984674-03:00
rendered_js: false
word_count: 2766
summary: This document establishes a structured operational framework for managing high-volume pull requests, focusing on risk-based triage, automated validation, and standardized review processes.
tags:
...
Xem tiếp: [[055-vi-pr-workflow|Quy trình PR]] Mục 5.1
...
Xem tiếp: [[046-i18n-vi-security-roadmap|Lộ trình cải tiến bảo mật]] docs/ci-map.md
...
Xem tiếp: [[055-vi-pr-workflow|Quy trình PR]] Mục 9
...
Xem tiếp: [[055-vi-pr-workflow|Quy trình PR]] Mục 8.2
...
- [[046-i18n-vi-security-roadmap|Lộ trình cải tiến bảo mật]] — phân loại và điều hướng tài liệu.
- [[049-vi-adding-boards-and-tools|Thêm Board và Tool]] — bản đồ quyền sở hữu và triage CI workflow.
- [[055-vi-pr-workflow|Quy trình PR]] — mô hình thực thi của reviewer.
...
#pull-request-management #workflow-automation
