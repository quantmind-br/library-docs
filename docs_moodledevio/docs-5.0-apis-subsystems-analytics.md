...
url: https://moodledev.io/docs/5.0/apis/subsystems/analytics
source: sitemap
fetched_at: 2026-02-17T15:27:01.708551-03:00
rendered_js: false
word_count: 5667
summary: This document introduces the Moodle Analytics API, outlining the architecture and components required to define prediction models using indicators and targets. It explains the system's data flow, class structure, and core machine learning concepts like training and samples for generating actionable insights.
tags:
    - moodle-analytics
    - prediction-models
    - machine-learning
...
Documentation available in [Machine learning backends](https://moodledev.io/docs/5.0/apis/plugintypes/mlbackend).
...
[Machine learning backends](https://moodledev.io/docs/5.0/apis/plugintypes/mlbackend) is a new Moodle plugin type. They are stored in `lib/mlbackend`.
...
This section does not include Machine learning backend interfaces. See [Machine learning backends](https://moodledev.io/docs/5.0/apis/plugintypes/mlbackend#interfaces) for more information on these.
...
Analysis intervals are used to define when the analytics API will train the predictions processor and when it will generate predictions. As explained above in the [Analysis intervals](https://moodledev.io/docs/5.0/apis/subsystems/analytics#analysis-intervals) documentation, they define time ranges based on analysable elements start and end timestamps.
...
As specified in the [Target](https://moodledev.io/docs/5.0/apis/subsystems/analytics#target-core_analyticslocaltargetbase) section.
