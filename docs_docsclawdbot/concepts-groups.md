...
source: llms
fetched_at: 2026-01-26T09:51:19.054484167-03:00
rendered_js: false
word_count: 929
summary: This guide explains how to configure and manage group chat interactions for Clawdbot across multiple messaging platforms. It covers group access control policies, session key structures, and sandboxing strategies to isolate group interactions from personal sessions.
tags:
    - group-management
    - access-control
    - messaging-platforms
