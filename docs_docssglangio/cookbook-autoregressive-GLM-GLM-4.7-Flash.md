---
title: GLM-4.7-Flash - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/GLM/GLM-4.7-Flash
source: sitemap
fetched_at: 2026-05-11T05:50:44.520380833-03:00
rendered_js: false
word_count: 801
summary: This document provides an overview and technical configuration guide for deploying and invoking the GLM-4.7-Flash model using SGLang, including specific settings for reasoning parsers and tool calling.
tags:
    - sglang
    - llm-deployment
    - glm-4
...
[GLM-4.7-Flash](https://huggingface.co/zai-org/GLM-4.7-Flash) is a lightweight and high-speed model in the GLM-4.7 series developed by Zhipu AI, featuring state-of-the-art capabilities in reasoning, function calling, and efficient local deployment. As a compact variant in the GLM-4.7 family, GLM-4.7-Flash is a **30B-A3B MoE** model designed to balance performance and efficiency:
...
**License:** Please refer to the [official GLM-4.7-Flash model card](https://huggingface.co/zai-org/GLM-4.7-Flash) for license details.
...
TPTensor ParallelDPData ParallelMTPMulti-token Prediction
