...
url: https://docs.factory.ai/guides/skills/frontend-ui-integration.md
source: llms
fetched_at: 2026-02-05T21:44:21.015629033-03:00
rendered_js: false
word_count: 597
summary: This document defines a standard workflow and configuration for AI-driven frontend UI integration, focusing on React and TypeScript applications that interface with existing backend APIs.
tags:
    - frontend-ui
    - react
    - typescript
