---
title: Data definition API | Moodle Developer Resources
url: https://moodledev.io/docs/5.0/apis/core/dml/ddl
source: sitemap
fetched_at: 2026-02-17T15:24:37.065876-03:00
rendered_js: false
word_count: 453
summary: This document provides a technical reference for Moodle's DDL functions used to manage database structures like tables, fields, and indexes during the installation and upgrade processes. It explains how to utilize the database manager and XMLDB objects to perform schema modifications in a database-neutral manner.
tags:
    - moodle
    - ddl
    - database-management
...
Always use the [XMLDB Editor](https://moodledev.io/general/development/tools/xmldb) to modify your tables. It is capable of generating the PHP code required to make your definition changes.

danger

The use of these functions is **restricted** to the upgrade processes and it should not be used in any other parts of Moodle.

## The functions[​](#the-functions "Direct link to The functions")

### Handling tables[​](#handling-tables "Direct link to Handling tables")
...
### Handling fields[​](#handling-fields "Direct link to Handling fields")
...
### Handling indexes[​](#handling-indexes "Direct link to Handling indexes")
...
## Some considerations[​](#some-considerations "Direct link to Some considerations")
...
5. Always use the [XMLDB Editor](https://moodledev.io/general/development/tools/xmldb) to generate the PHP code automatically.
...
- [DML functions](https://moodledev.io/docs/5.0/apis/core/dml): Where all the functions used to handle DB data ([DML](https://docs.moodle.org/wikipedia/Data_Manipulation_Language)) are defined.