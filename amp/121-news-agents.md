---
title: ""
url: https://ampcode.com/news/AGENTS.md
source: crawler
fetched_at: 2026-02-06T02:08:33.749256141-03:00
rendered_js: false
word_count: 477
summary: This document announces the transition of the standard agent instruction filename from AGENT.md to AGENTS.md to align with emerging industry standards set by OpenAI.
tags:
    - ai-agents
    - configuration-files
    - naming-conventions
			...
			<script>
				{
					...
					Promise.all([
						...
						kit.start(app, element, {
							node_ids: [0, 34, 161],
							data: [{type:"data",data:{user:void 0,userWorkspace:void 0,timezone:"UTC",mostRecentLeaderboard:null,viewerCanCreateAgentThread:false,posthogUserId:null,isNewUser:void 0,isAdvertiserManager:false,hasTaskListFeature:false,forcedTraceId:void 0,dtwConfig:{baseURL:"https://production.ampworkers.com",ampURL:"https://ampcode.com"}},uses:{}},null,{type:"data",data:{newsItem:{slug:"AGENTS.md",date:"August 20, 2025",file:"20250820_AGENTS.md.md",title:"From AGENT.md to AGENTS.md",content:"In [May we added support for `AGENT.md` files](https://ampcode.com/news/AGENT.md) to Amp. Not long after, [OpenAI picked `AGENTS.md` (plural) for their agent](https://x.com/sqs/status/1923793682966438303) and, instead of insisting on what we came up with, we decided that we'd prefer one standard.\n\nOur condition: if OpenAI can get the [agents.md](https://agents.md) domain, we'll switch. And that condition has now been met.\n\nTrue to our word, and as of today, Amp will look for `AGENTS.md` files (while staying backwards compatible with existing `AGENT.md` files, of course)\n\n\u003Cimg width=\"800\" src=\"/news/agents-md-standard.png\" alt=\"AGENTS.md standard\" />",excerpt:void 0,indexOnlyContent:void 0,url:"/news/AGENTS.md",preview:false,previewFlagName:void 0,ogImage:void 0,tagline:"Amp now uses `AGENTS.md` as the standard filename",showTagline:false,screenshot:void 0,backgroundImage:void 0,footnotes:void 0,recommendedReading:{href:"/news/globs-in-AGENTS.md",title:"Globs in AGENTS.md",subtitle:"Include context files dynamically with glob mentions and filters"}},title:"From AGENT.md to AGENTS.md",openGraphTitle:"From AGENT.md to AGENTS.md",openGraphDescription:"Amp now uses `AGENTS.md` as the standard filename",openGraphImage:"https://ampcode.com/news/AGENTS.md?og-image"},uses:{search_params:["og-image"],params:["slug"],url:1}}],
							form: null,
							error: null
						});
					});
