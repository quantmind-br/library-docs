---
title: model_manager - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/lora/model_manager/
source: sitemap
fetched_at: 2026-05-07T21:22:43.471959677-03:00
rendered_js: false
word_count: 77
summary: The LoRAModelManager class provides a framework for managing multiple LoRA-fine-tuned adapters within a model, including support for specialized punica wrappers for both language and multimodal model architectures.
tags:
    - lora
    - model-management
...
"""Create a LoRAModelManager and adapter for a given model.
    ...
    @property
    defcapacity(self) -> int:
        return self.lora_config.max_cpu_loras

    @property
    deflora_slots(self) -> int:
        return self.lora_config.max_loras

    @property
    defadapter_slots(self) -> int:
...
"""Move LoRA into a GPU buffer to be used in the forward pass."""
    ...
    def_deactivate_adapter(self, lora_id: int):
        try:
    ...
    def_add_adapter(self, lora: LoRAModel):
        self._create_merged_loras_inplace(lora)
        self._registered_adapters[lora.id] = lora

    defpin_adapter(self, lora_id: int) -> bool:
"""Pin a LoRAModel in the manager cache."""
    ...
    def_set_adapter_mapping(self, mapping: LoRAMapping) -> None:
...
"""Remove all LoRAModels from the manager."""
    ...
    def_create_lora_modules(self):
        def_parent_module(module_name: str) -> str:
    ...
    defregister_module(self, module_name: str, module: "BaseLayerWithLoRA"):
    ...
    @staticmethod
    def_pad_lora_pairs_to_triplets(
...
"""Return a dummy LoRA rank compatible with wrapped modules.
    ...
    def_match_target_modules(self, module_name: str) -> bool:
"""Check if a module should have LoRA applied.
    ...
    def_get_punica_wrapper(self, module_name: str) -> PunicaWrapperBase | None:
"""
    ...
    def_register_packed_modules(self, module_full_name: str) -> None:
    ...
    def_create_merged_loras_inplace(self, lora_model: LoRAModel) -> None:
    ...
    defdeactivate_adapter(self, adapter_id: int) -> bool:
    ...
    defadd_adapter(self, adapter: LoRAModel) -> bool:
    ...
    defset_adapter_mapping(self, mapping: LoRAMapping) -> None:
    ...
    deflist_adapters(self) -> dict[int, LoRAModel]:
        return dict(self._registered_adapters)

    defget_adapter(self, adapter_id: int) -> LoRAModel | None:
