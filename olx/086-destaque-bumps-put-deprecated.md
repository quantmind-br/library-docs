---
title: Aplicação de destaque em anúncio (deprecated)
url: https://developers.olx.com.br/destaque/bumps_put_deprecated.html
source: crawler
fetched_at: 2026-02-07T15:17:24.707045386-03:00
rendered_js: false
word_count: 366
summary: This document describes the deprecated API endpoint for applying highlights to advertisements, which moves ads to the top of search listings.
tags:
    - olx-api
    - ad-highlighting
    - bump-feature
...
## Aplicação de destaque em anúncio (deprecated)

A URL usada para fazer a requisição do arquivo JSON é https://apps.olx.com.br/autoupload/bump/ad/{ad\_id}, método `PUT`. Essa requisição deve conter o `token` de cada anunciante no header como: `Authorization: Bearer <token>`.
...
- Request
  ...
  ```
  curl -A Mozilla -H "Authorization: Bearer <token>" "https://apps.olx.com.br/autoupload/balance"
  ```
- Response
