---
title: serving - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/entrypoints/openai/chat_completion/serving/
source: sitemap
fetched_at: 2026-05-07T21:19:53.149824886-03:00
rendered_js: false
word_count: 11
summary: The OpenAIServingChat class implements a vLLM-based handler that manages OpenAI-compatible chat completion requests, including tokenization, chat template rendering, and tool parsing logic.
tags:
    - vllm
    - openai-api
    - chat-completion
...
```
classOpenAIServingChat(OpenAIServing):
    def__init__(
        self,
        ...
        *,
        ...
        if (
            ...
            fromvllm.tool_parsers.mistral_tool_parserimport MistralToolParser
...
"""
    ...
    async defcreate_chat_completion(
        self,
        request: ChatCompletionRequest,
...
"""
    ...
    defget_chat_request_role(self, request: ChatCompletionRequest) -> str:
        if request.add_generation_prompt:
            return self.response_role
        return request.messages[-1]["role"]

    async defchat_completion_stream_generator(
        self,
        request: ChatCompletionRequest,
            ...
            async for res in result_generator:
                ...
                for output in res.outputs:
                    ...
                    # Mistral grammar path: combined reasoning + tool streaming
                        ...
                        fromvllm.tool_parsers.mistral_tool_parserimport (
                            MistralToolParser,
                        )
    ...
    async defchat_completion_full_generator(
        self,
        request: ChatCompletionRequest,
        result_generator: AsyncIterator[RequestOutput],
        request_id: str,
        ...
        for output in final_res.outputs:
            ...
            if is_mistral_tokenizer(tokenizer):
                fromvllm.tool_parsers.mistral_tool_parserimport MistralToolCall
...
"""Create OpenAI-style logprobs."""
    ...
    def_should_stream_with_auto_tool_parsing(self, request: ChatCompletionRequest):
"""
    ...
    def_should_check_for_unstreamed_tool_arg_tokens(
        self,
        delta_message: DeltaMessage | None,
...
"""
    ...
    @staticmethod
    def_create_remaining_args_delta(
        delta_message: DeltaMessage,
        remaining_call: str,
        index: int,
    ) -> DeltaMessage:
