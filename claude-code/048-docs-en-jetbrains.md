...
source: llms
fetched_at: 2026-04-16T22:33:07.776119307-03:00
rendered_js: false
word_count: 795
summary: This document explains how to install, configure, and use the Claude Code plugin within JetBrains IDEs to enable seamless terminal-to-editor integration.
tags:
    - jetbrains
    - claude-code
    - ide-integration
