...
url: https://moodledev.io/docs/5.2/apis/subsystems/form/advanced/no-submit-button
source: sitemap
fetched_at: 2026-02-17T15:45:54.068602-03:00
rendered_js: false
word_count: 156
summary: This document explains how to use the no_submit_button_pressed method in Moodle forms to handle sub-actions that require form redisplay without final data processing.
tags:
    - moodle-forms
    - php-development
    - form-handling
