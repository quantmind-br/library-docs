...
url: https://moodledev.io/docs/4.4/apis/core/message
source: sitemap
fetched_at: 2026-02-17T15:02:31.44085-03:00
rendered_js: false
word_count: 811
summary: This document explains how to use the Moodle Messaging API to programmatically send notifications and messages to users from within Moodle components and plugins.
tags:
    - moodle-api
    - messaging-system
    - php-development
