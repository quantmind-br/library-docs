...
source: sitemap
fetched_at: 2026-04-15T09:01:38.443430197-03:00
rendered_js: false
word_count: 200
summary: This document provides instructions on how to configure and run AI models locally using Ollama or connect to Ollama's cloud-hosted inference services within the Factory application.
tags:
    - ollama
    - local-llm
    - model-configuration
