...
source: crawler
fetched_at: 2026-02-27T23:45:23.207237-03:00
rendered_js: true
word_count: 168
summary: This document describes the Spotify Web API endpoint for starting or resuming playback on a user's active device, including details on request parameters like context URIs and offsets.
tags:
    - spotify-web-api
    - playback-control
    - player-management
