...
source: crawler
fetched_at: 2026-02-08T04:01:40.910727042-03:00
rendered_js: false
word_count: 808
summary: This document explains how to configure and execute application rollbacks in Dokploy using both automatic Docker Swarm health checks and manual registry-based versioning.
tags:
    - dokploy
    - deployment
    - rollback
