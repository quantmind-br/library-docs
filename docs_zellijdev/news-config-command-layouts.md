...
url: https://zellij.dev/news/config-command-layouts/
source: sitemap
fetched_at: 2026-01-24T15:52:48.323843849-03:00
rendered_js: false
word_count: 852
summary: Describes the new features in Zellij 0.32.0, specifically the migration to the KDL configuration language and the introduction of advanced CLI controls and layout capabilities.
tags:
    - zellij-release
...
![kdl file preview](https://zellij.dev/img/kdl-file-preview.png)

This coming version moves all of the Zellij configuration from `YAML` to [`KDL`](https://kdl.dev).

Existing configuration and layout files will be automatically converted, with the originals unmodified. The conversion can [also be done manually](https://zellij.dev/documentation/migrating-yaml-config.html).

Read more about the new configuration [here](https://zellij.dev/documentation/configuration.html).
...
For more information and options see [the Zellij Run documentation](https://zellij.dev/documentation/zellij-run.html).

For the alias, see [Zellij CLI completions](https://zellij.dev/documentation/controlling-zellij-through-cli.html#completions).
...
For more information see [the Zellij Edit documentation](https://zellij.dev/documentation/zellij-edit.html).
...
For more information, see [Controlling Zellij through the CLI](https://zellij.dev/documentation/controlling-zellij-through-cli.html).
...
Opening this layout in a [new-tab](https://zellij.dev/documentation/cli-actions.html#new-tab) in a Rust boilerplate project can look like this:

```
$ zellij action new-tab --layout /path/to/above/layout-file.kdl
```

![basic-rust-project-layout-example](https://zellij.dev/documentation/img/basic-rust-project-layout.png)

See [more examples](https://zellij.dev/documentation/layout-examples.html) or [read more](https://zellij.dev/documentation/layouts.html) about layouts.
...
![kdl error demo](https://zellij.dev/img/kdl-error-demo.png)