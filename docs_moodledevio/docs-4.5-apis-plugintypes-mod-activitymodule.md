...
url: https://moodledev.io/docs/4.5/apis/plugintypes/mod/activitymodule
source: sitemap
fetched_at: 2026-02-17T15:12:30.683495-03:00
rendered_js: false
word_count: 673
summary: This document outlines the redesign of the Moodle activity chooser interface and explains the new callbacks required for third-party plugin developers to support features like starring and recommendations.
tags:
    - moodle
    - activity-chooser
    - plugin-development
