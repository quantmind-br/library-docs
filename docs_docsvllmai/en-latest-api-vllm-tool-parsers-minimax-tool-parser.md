---
title: minimax_tool_parser - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/tool_parsers/minimax_tool_parser/
source: sitemap
fetched_at: 2026-05-07T21:36:16.114808117-03:00
rendered_js: false
word_count: 0
summary: This document defines a Python class for parsing and extracting tool calls from Minimax model outputs, handling both streaming and non-streaming scenarios by managing tool tokens and sanitizing JSON structures.
tags:
    - python-class
    - tool-calling
    - data-parsing
...
```
classMinimaxToolParser(ToolParser):
    def__init__(self, tokenizer: TokenizerLike, tools: list[Tool] | None = None):
    ...
    defpreprocess_model_output(self, model_output: str) -> str:
"""
        ...
        defremove_tool_calls_from_think(match):
    ...
    def_clean_duplicate_braces(self, args_text: str) -> str:
"""
    ...
    def_clean_delta_braces(self, delta_text: str) -> str:
"""
...
"""
    ...
    def_update_thinking_state(self, text: str) -> None:
"""
    ...
    def_is_potential_tag_start(self, text: str) -> bool:
"""
    ...
    def_should_buffer_content(self, delta_text: str) -> bool:
"""
    ...
    def_split_content_for_buffering(self, delta_text: str) -> tuple[str, str]:
"""
    ...
    def_process_buffer(self, new_content: str) -> str:
"""
    ...
    def_reset_streaming_state(self) -> None:
"""Reset the streaming state to initial values."""
    ...
    def_advance_to_next_tool(self) -> None:
"""Advance to the next tool in the streaming sequence."""
    ...
    def_set_current_tool_index(self, index: int) -> None:
"""
    ...
    def_get_current_tool_index(self) -> int:
"""
    ...
    def_get_next_unsent_tool_index(self, tool_count: int) -> int:
"""
    ...
    def_ensure_state_arrays(self, tool_count: int) -> None:
"""
    ...
    def_detect_tools_in_text(self, text: str) -> int:
"""
    ...
    def_find_tool_boundaries(self, text: str) -> list[tuple[int, int]]:
"""
    ...
    def_extract_tool_args(self, tool_content: str, args_match: re.Match[str]) -> str:
"""
...
"""
    ...
    def_handle_tool_name_streaming(
...
"""
    ...
    def_handle_tool_args_streaming(
        self, tool_content: str, tool_count: int
    ) -> DeltaMessage | None:
"""
    ...
    def_is_end_tool_calls(self, current_text: str) -> bool:
    ...
    def_find_tool_start_outside_thinking(self, current_text: str) -> int | None:
"""
    ...
    def_extract_content_before_tools(
...
"""
    ...
    def_extract_tool_content(self, current_text: str, tool_start: int) -> str:
"""
