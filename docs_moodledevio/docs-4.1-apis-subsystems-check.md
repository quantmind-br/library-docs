...
url: https://moodledev.io/docs/4.1/apis/subsystems/check
source: sitemap
fetched_at: 2026-02-17T14:56:00.86671-03:00
rendered_js: false
word_count: 1683
summary: This document explains the Moodle Check API, a framework for performing runtime tests to monitor system configuration, security, and performance within the Moodle environment.
tags:
    - moodle-development
    - check-api
    - runtime-testing
...
Available from */report/security/index.php*, these checks make sure that a Moodle instance is hardened correctly for you needs.
