...
source: sitemap
fetched_at: 2026-04-07T21:32:53.648658293-03:00
rendered_js: false
word_count: 908
summary: This document provides detailed configuration instructions for integrating DankMaterialShell (DMS) into various Wayland compositors, specifically focusing on niri and Hyprland. It shows how to include necessary configuration files, set up keybindings, define window rules, and manage startup parameters for seamless integration.
tags:
    - wayland-compositor
    - niri
    - hyprland
...
For systemd autostart setup, see the [Installation guide](https://danklinux.com/docs/dankmaterialshell/installation#niri). If you prefer not to use systemd, add DMS directly to your niri config:
...
For systemd autostart setup (recommended if you have multiple desktop environments), see the [Installation guide](https://danklinux.com/docs/dankmaterialshell/installation#hyprland). If you prefer not to use systemd, add DMS directly to your Hyprland config:
...
For systemd autostart setup (recommended if you have multiple desktop environments), see the [Installation guide](https://danklinux.com/docs/dankmaterialshell/installation#mangowc). If you prefer not to use systemd, add DMS directly to your MangoWC config:
...
For systemd autostart setup (recommended if you have multiple desktop environments), see the [Installation guide](https://danklinux.com/docs/dankmaterialshell/installation#sway). Otherwise, add DMS directly to your Sway config:
...
For systemd autostart setup (recommended if you have multiple desktop environments), see the [Installation guide](https://danklinux.com/docs/dankmaterialshell/installation#miracle-wm). Otherwise, add DMS directly to your Miracle WM config.

#### DMS Keybindings[​](#dms-keybindings-5 "Direct link to DMS Keybindings")

For the full list of available IPC commands see [IPC](https://danklinux.com/docs/dankmaterialshell/keybinds-ipc). Miracle WM keybinding configuration coming soon.
