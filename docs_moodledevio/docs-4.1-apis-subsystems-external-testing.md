...
url: https://moodledev.io/docs/4.1/apis/subsystems/external/testing
source: sitemap
fetched_at: 2026-02-17T14:56:20.431801-03:00
rendered_js: false
word_count: 0
summary: This document provides automated unit tests for evaluating the capability requirements and execution logic of Moodle external functions.
tags:
    - moodle
    - unit-testing
    - php
