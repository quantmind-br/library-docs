...
source: crawler
fetched_at: 2026-02-27T23:46:52.159186-03:00
rendered_js: false
word_count: 2
summary: This document provides a sample JSON response for a Spotify API endpoint, demonstrating the structure of paginated results for saved shows.
tags:
    - spotify-api
    - json-response
    - pagination-metadata
