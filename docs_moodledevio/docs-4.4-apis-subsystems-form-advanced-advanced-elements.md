---
title: Advanced elements | Moodle Developer Resources
url: https://moodledev.io/docs/4.4/apis/subsystems/form/advanced/advanced-elements
source: sitemap
fetched_at: 2026-02-17T15:04:26.651169-03:00
rendered_js: false
word_count: 298
summary: This document explains how to manage advanced form elements in Moodle using the setAdvanced method to hide specific fields or entire sections initially. It details how to toggle advanced status and the importance of using unique header names to prevent unintended layout behavior.
tags:
    - moodle-forms
    - moodlequickform
    - setadvanced
...
For more information on the risks of this, see the advice in [Designing usable forms](https://moodledev.io/general/development/policies/designing-usable-forms#use-show-moreless-advanced-settings-sparingly).
...
### Setting a name[​](#setting-a-name "Direct link to Setting a name")
...
## Marking an entire section as advanced[​](#marking-an-entire-section-as-advanced "Direct link to Marking an entire section as advanced")
