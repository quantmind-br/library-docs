...
## Enable Globally[​](#enable-globally "Direct link to Enable Globally")
...
## Enable for a Model Group[​](#enable-for-a-model-group "Direct link to Enable for a Model Group")
...
## Supported Model Patterns[​](#supported-model-patterns "Direct link to Supported Model Patterns")

The configuration supports various model matching patterns:

### 1. Exact Model Names[​](#1-exact-model-names "Direct link to 1. Exact Model Names")
...
### 2. Wildcard Patterns[​](#2-wildcard-patterns "Direct link to 2. Wildcard Patterns")
...
### 3. Team Model Aliases[​](#3-team-model-aliases "Direct link to 3. Team Model Aliases")

If your team has model aliases configured, the forwarding will work with both the original model name and the alias.

## Forwarded Headers[​](#forwarded-headers "Direct link to Forwarded Headers")

When enabled for a model group, LiteLLM forwards the following types of headers:

### Custom Headers (x- prefix)[​](#custom-headers-x--prefix "Direct link to Custom Headers (x- prefix)")
...
### Provider-Specific Headers[​](#provider-specific-headers "Direct link to Provider-Specific Headers")

- **Anthropic**: `anthropic-beta` headers
- **OpenAI**: `openai-organization` (when enabled via `forward_openai_org_id: true`)

### User Information Headers (Optional)[​](#user-information-headers-optional "Direct link to User Information Headers (Optional)")
...
### 1. Request Tracing[​](#1-request-tracing "Direct link to 1. Request Tracing")
...
### 2. Custom Metadata[​](#2-custom-metadata "Direct link to 2. Custom Metadata")
...
### 3. Anthropic Beta Features[​](#3-anthropic-beta-features "Direct link to 3. Anthropic Beta Features")
...
## Testing Header Forwarding[​](#testing-header-forwarding "Direct link to Testing Header Forwarding")
...
3. **Use Webhook Sites**: For testing, you can use webhook.site URLs as api\_base to see forwarded headers

## Troubleshooting[​](#troubleshooting "Direct link to Troubleshooting")

### Headers Not Being Forwarded[​](#headers-not-being-forwarded "Direct link to Headers Not Being Forwarded")
...
### Provider Errors[​](#provider-errors "Direct link to Provider Errors")
...
- [Request Headers](https://docs.litellm.ai/docs/proxy/request_headers) - Complete list of supported request headers
- [Response Headers](https://docs.litellm.ai/docs/proxy/response_headers) - Headers returned by LiteLLM
- [Team Model Aliases](https://docs.litellm.ai/docs/proxy/team_model_add) - Configure model aliases for teams
- [Model Access Control](https://docs.litellm.ai/docs/proxy/model_access) - Control which users can access which models
...
```
classModelGroupSettings(BaseModel):
...
- [Enable for a Model Group](#enable-for-a-model-group)
- [Supported Model Patterns](#supported-model-patterns)
  
  - [1. Exact Model Names](#1-exact-model-names)
  - [2. Wildcard Patterns](#2-wildcard-patterns)
  - [3. Team Model Aliases](#3-team-model-aliases)
- [Forwarded Headers](#forwarded-headers)
  
  - [Custom Headers (x- prefix)](#custom-headers-x--prefix)
  - [Provider-Specific Headers](#provider-specific-headers)
  - [User Information Headers (Optional)](#user-information-headers-optional)
- [Security Considerations](#security-considerations)
- [Example Use Cases](#example-use-cases)
  
  - [1. Request Tracing](#1-request-tracing)
  - [2. Custom Metadata](#2-custom-metadata)
  - [3. Anthropic Beta Features](#3-anthropic-beta-features)
- [Complete Configuration Example](#complete-configuration-example)
- [Testing Header Forwarding](#testing-header-forwarding)
- [Troubleshooting](#troubleshooting)
  
  - [Headers Not Being Forwarded](#headers-not-being-forwarded)
