...
ModelTool VersionClaude Opus 4.5 (`claude-opus-4-5-20251101`)`code_execution_20250825`Claude Sonnet 4.5 (`claude-sonnet-4-5-20250929`)`code_execution_20250825`
...
## The `allowed_callers` Field[​](#the-allowed_callers-field "Direct link to the-allowed_callers-field")
...
## The `caller` Field in Responses[​](#the-caller-field-in-responses "Direct link to the-caller-field-in-responses")
...
### Step 1: Initial Request[​](#step-1-initial-request "Direct link to Step 1: Initial Request")
...
### Step 2: API Response with Tool Call[​](#step-2-api-response-with-tool-call "Direct link to Step 2: API Response with Tool Call")
...
### Step 3: Provide Tool Result[​](#step-3-provide-tool-result "Direct link to Step 3: Provide Tool Result")
...
### Step 4: Final Response[​](#step-4-final-response "Direct link to Step 4: Final Response")
...
### Batch Processing with Loops[​](#batch-processing-with-loops "Direct link to Batch Processing with Loops")
...
### Early Termination[​](#early-termination "Direct link to Early Termination")
...
### Data Filtering[​](#data-filtering "Direct link to Data Filtering")
...
### When to Use Programmatic Calling[​](#when-to-use-programmatic-calling "Direct link to When to Use Programmatic Calling")
...
### Feature Incompatibilities[​](#feature-incompatibilities "Direct link to Feature Incompatibilities")
...
### Tool Restrictions[​](#tool-restrictions "Direct link to Tool Restrictions")
