...
url: https://moodledev.io/docs/5.0/apis/plugintypes/blocks
source: sitemap
fetched_at: 2026-02-17T15:25:25.955038-03:00
rendered_js: false
word_count: 2077
summary: This document outlines the mandatory file structure and key components required for developing block plugins in Moodle, including the definition class, access control, and localization.
tags:
    - moodle-development
    - block-plugins
    - plugin-architecture
