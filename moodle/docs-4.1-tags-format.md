...
url: https://moodledev.io/docs/4.1/tags/format
source: sitemap
fetched_at: 2026-02-17T14:52:43.697962-03:00
rendered_js: false
word_count: 76
summary: This document defines Moodle course format plugins and provides instructions for migrating 3.11 formats to remain compatible with the course editor updates introduced in Moodle 4.0.
tags:
    - moodle-development
    - course-format
    - plugin-migration
