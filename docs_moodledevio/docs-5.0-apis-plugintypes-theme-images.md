...
url: https://moodledev.io/docs/5.0/apis/plugintypes/theme/images
source: sitemap
fetched_at: 2026-02-17T15:26:49.377401-03:00
rendered_js: false
word_count: 502
summary: This document explains how to manage images in Moodle themes, including methods for referencing images in templates and CSS and the process for overriding core or plugin images.
tags:
    - moodle-development
    - theme-customization
    - image-handling
