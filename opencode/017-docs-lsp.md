...
source: sitemap
fetched_at: 2026-04-17T06:33:21.649149462-03:00
rendered_js: false
word_count: 424
summary: This document explains how OpenCode manages Language Server Protocol (LSP) integration, including built-in server support and user configuration options.
tags:
    - lsp-integration
    - opencode-config
