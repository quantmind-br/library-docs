...
url: https://moodledev.io/docs/5.1/apis/plugintypes/qtype/newquestiondefaults
source: sitemap
fetched_at: 2026-02-17T15:35:31.930361-03:00
rendered_js: false
word_count: 470
summary: This document explains how to implement persistent user preferences as default settings for new question types in Moodle. It provides instructions on updating form and question-type classes, ensuring privacy compliance, and adding automated tests.
tags:
    - moodle-development
    - question-types
    - user-preferences
