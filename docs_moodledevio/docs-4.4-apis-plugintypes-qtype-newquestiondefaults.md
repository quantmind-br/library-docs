...
url: https://moodledev.io/docs/4.4/apis/plugintypes/qtype/newquestiondefaults
source: sitemap
fetched_at: 2026-02-17T15:03:32.202265-03:00
rendered_js: false
word_count: 470
summary: This document explains how to implement persistent user defaults for question type settings to ensure that a teacher's preferred configurations are automatically applied when creating new questions. It covers modifications to form classes, question-type classes, privacy provider compliance, and testing requirements.
tags:
    - moodle-development
    - question-types
    - user-preferences
