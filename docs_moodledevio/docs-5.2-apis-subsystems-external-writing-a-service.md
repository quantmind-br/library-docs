...
url: https://moodledev.io/docs/5.2/apis/subsystems/external/writing-a-service
source: sitemap
fetched_at: 2026-02-17T15:45:37.860441-03:00
rendered_js: false
word_count: 1036
summary: This document provides a guide on creating and declaring external web services for Moodle plugins, covering naming conventions, functional specifications, and the implementation of external functions.
tags:
    - moodle-development
    - web-services
    - external-functions
...
- [Web services developer documentation](https://moodledev.io/docs/5.2/apis/subsystems/external)
...
- [External services security](https://moodledev.io/docs/5.2/apis/subsystems/external/security)
- [External services description](https://moodledev.io/docs/5.2/apis/subsystems/external/description)
