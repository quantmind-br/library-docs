...
url: https://moodledev.io/docs/4.4/apis/subsystems/form/advanced/repeat-elements
source: sitemap
fetched_at: 2026-02-17T15:04:31.483388-03:00
rendered_js: false
word_count: 265
summary: This document explains how to use the repeat_elements method in the Form API to create dynamic, repeating groups of form fields that allow for an unknown number of user inputs.
tags:
    - form-api
    - repeat-elements
    - moodle-development
