...
url: https://docs.vllm.ai/en/latest/api/vllm/transformers_utils/configs/moondream3/
source: sitemap
fetched_at: 2026-05-07T21:37:16.797096684-03:00
rendered_js: false
word_count: 74
summary: This document defines the configuration classes for the Moondream3 multimodal model, including separate text and vision encoder settings within the vLLM framework.
tags:
    - vllm
    - moondream3
    - multimodal-model
...
## vllm.transformers\_utils.configs.moondream3 [¶](#vllm.transformers_utils.configs.moondream3 "Permanent link")

Configuration for Moondream3 model.

## Moondream3Config [¶](#vllm.transformers_utils.configs.moondream3.Moondream3Config "Permanent link")

Bases: `PretrainedConfig`

Combined configuration for Moondream3 multimodal model.

Source code in `vllm/transformers_utils/configs/moondream3.py`

```
classMoondream3Config(PretrainedConfig):
"""Combined configuration for Moondream3 multimodal model."""
    ...
    defget_text_config(self, decoder: bool = False) -> "Moondream3TextConfig":
...
### get\_text\_config [¶](#vllm.transformers_utils.configs.moondream3.Moondream3Config.get_text_config "Permanent link")
...
Return the text config for vLLM's text\_config detection.

Parameters:

Name Type Description Default `decoder` `bool`

Ignored. Only used for encoder-decoder models.
...
## Moondream3TextConfig [¶](#vllm.transformers_utils.configs.moondream3.Moondream3TextConfig "Permanent link")
...
```
classMoondream3TextConfig(PretrainedConfig):
"""Text decoder configuration for Moondream3."""
...
## Moondream3VisionConfig [¶](#vllm.transformers_utils.configs.moondream3.Moondream3VisionConfig "Permanent link")
...
```
classMoondream3VisionConfig(PretrainedConfig):
"""Vision encoder configuration for Moondream3."""
