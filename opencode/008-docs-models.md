...
source: sitemap
fetched_at: 2026-04-17T06:41:39.78483073-03:00
rendered_js: false
word_count: 479
summary: This document provides instructions on how to set up, select, and customize LLM providers and models within the OpenCode environment.
tags:
    - opencode-config
    - llm-providers
    - model-selection
