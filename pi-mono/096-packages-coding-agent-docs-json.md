...
source: git
fetched_at: 2026-03-03T03:39:49.861141-03:00
rendered_js: false
word_count: 290
summary: describes json event stream mode for pi, detailing event types and output structure for session events in JSON lines format for integration with tools.
tags:
    - api-output
    - json-streaming
    - event-modeling
