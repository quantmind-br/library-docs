---
title: Moodle App Deep Linking | Moodle Developer Resources
url: https://moodledev.io/general/app/development/link-handling/deep-linking
source: sitemap
fetched_at: 2026-02-17T15:54:32.529758-03:00
rendered_js: false
word_count: 575
summary: This document explains how to use custom URL schemes to launch the Moodle App, including parameters for site identification, authentication, and deep linking.
tags:
    - moodle-app
    - custom-url-scheme
    - deep-linking
...
### Token and Private token[​](#token-and-private-token "Direct link to Token and Private token")
