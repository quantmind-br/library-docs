...
url: https://moodledev.io/docs/5.0/apis/subsystems/roles
source: sitemap
fetched_at: 2026-02-17T15:28:05.912788-03:00
rendered_js: false
word_count: 1439
summary: This document defines the architecture of the Moodle Roles API, explaining how roles, capabilities, permissions, and contexts interact to control user access and manage security risks.
tags:
    - moodle-development
    - roles-api
    - access-control
