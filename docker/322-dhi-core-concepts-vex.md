...
source: llms
fetched_at: 2026-01-24T14:20:00.150515636-03:00
rendered_js: false
word_count: 450
summary: This document explains the Vulnerability Exploitability eXchange (VEX) framework and its integration with Docker Hardened Images to help organizations filter non-exploitable vulnerabilities. It provides instructions on using VEX with tools like Docker Scout, Trivy, and Grype to prioritize remediation efforts.
tags:
    - vex
...
## [Why is VEX important?](#why-is-vex-important)
...
## [How Docker Hardened Images integrate VEX](#how-docker-hardened-images-integrate-vex)
...
When using Docker Scout or Trivy, VEX statements are automatically applied as shown in the examples in [Common Vulnerabilities and Exposures (CVEs)](https://docs.docker.com/dhi/core-concepts/cves/).

For Grype, you need to export the VEX attestation to a file first before scanning, as shown in the [Grype scanning example](https://docs.docker.com/dhi/core-concepts/cves/#scan-a-dhi-using-grype).

> Note
> 
> By default, VEX attestations are fetched from `registry.scout.docker.com`. Ensure that you can access this registry if your network has outbound restrictions. You can also mirror the attestations to an alternate registry. For more details, see [Mirror a Docker Hardened Image repository](https://docs.docker.com/dhi/how-to/mirror/#mirror-from-docker-hub-to-another-registry).
