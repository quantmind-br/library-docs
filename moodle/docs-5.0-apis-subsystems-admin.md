...
url: https://moodledev.io/docs/5.0/apis/subsystems/admin
source: sitemap
fetched_at: 2026-02-17T15:26:58.562663-03:00
rendered_js: false
word_count: 1791
summary: This document explains the architecture and implementation of Moodle's administration settings system, detailing how the settings tree is constructed and how developers can add configuration options to plugins.
tags:
    - moodle-development
    - admin-settings
...
- [configuration for filter](https://moodledev.io/docs/5.0/apis/plugintypes/filter)
