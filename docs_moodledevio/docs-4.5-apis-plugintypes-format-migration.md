...
url: https://moodledev.io/docs/4.5/apis/plugintypes/format/migration
source: sitemap
fetched_at: 2026-02-17T15:12:11.072225-03:00
rendered_js: false
word_count: 2886
summary: This document outlines the architectural changes in the Moodle 4.0 course editor and provides technical guidance for adapting legacy course format plugins to the new reactive component system.
tags:
    - moodle-development
    - course-formats
    - plugin-migration
...
The first thing your plugin needs is to create that structure and link it to the output components. Follow the guide on the [create format plugin page](https://moodledev.io/docs/4.5/apis/plugintypes/format#creating-the-basic-output-structure) to know how to create the basic structure.
...
Once your plugin has the basic mustache structure, you can provide extra mustache blocks to override parts of the page. Follow the [Override mustache blocks](https://moodledev.io/docs/4.5/apis/plugintypes/format#override-mustache-blocks) on the Creating a course format page to know how to do it.
