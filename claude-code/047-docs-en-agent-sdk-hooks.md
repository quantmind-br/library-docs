...
source: llms
fetched_at: 2026-04-16T22:28:50.8734995-03:00
rendered_js: false
word_count: 2420
summary: This guide explains how to use hooks to intercept, monitor, and control agent behavior during various execution stages. It provides details on event lifecycles, matching logic, and implementation patterns for both Python and TypeScript SDKs.
tags:
    - agent-behavior
    - callback-functions
    - workflow-automation
