---
title: Moodle 2.2 | Moodle Developer Resources
url: https://moodledev.io/general/releases/2.2
source: sitemap
fetched_at: 2026-02-17T16:04:51.192635-03:00
rendered_js: false
word_count: 1164
summary: This document outlines the major features, security updates, and technical API changes introduced in the Moodle 2.2 release.
tags:
    - moodle-release
    - release-notes
    - lms-update
...
- [https://github.com/moodle/moodle/blob/main/lib/upgrade.txt](https://github.com/moodle/moodle/blob/main/lib/upgrade.txt)
- [MDL-29474](https://moodle.atlassian.net/browse/MDL-29474) - Plugins should declare (in [version.php](https://moodledev.io/docs/5.2/apis/commonfiles/version.php)) if they depend on other plugins
- [MDL-28554](https://moodle.atlassian.net/browse/MDL-28554) - Upgrade to YUI 3.4.0 and 2.9.0
- [MDL-26796](https://moodle.atlassian.net/browse/MDL-26796) - We no longer accept arrays in required\_param() and optional\_param()
...
#### New plugin types[​](#new-plugin-types "Direct link to New plugin types")

- [report - report](https://docs.moodle.org/dev/General_report_plugins)
- [admin/tool - tool](https://moodledev.io/general/projects/api/admin-tools)
...
#### DB changes[​](#db-changes "Direct link to DB changes")
...
#### Libraries deleted from distribution[​](#libraries-deleted-from-distribution "Direct link to Libraries deleted from distribution")
...
- Full web service [user](https://docs.moodle.org/en/Web_services) and [developer](https://moodledev.io/docs/5.2/apis/subsystems/external) documentation update
- New [web service roadmap](https://docs.moodle.org/dev/Web_services_Roadmap_)

#### Other deleted items[​](#other-deleted-items "Direct link to Other deleted items")
...
- [Notes de mise à jour de Moodle 2.2](https://docs.moodle.org/fr/Notes_de_mise_%C3%A0_jour_de_Moodle_2.2)