...
url: https://moodledev.io/docs/4.5/apis/plugintypes/assign/submission
source: sitemap
fetched_at: 2026-02-17T15:11:48.534778-03:00
rendered_js: false
word_count: 1625
summary: This document provides a technical overview and implementation guide for creating Moodle assignment submission plugins, detailing file structure, naming constraints, and core class methods.
tags:
    - moodle-development
    - assignment-plugin
    - submission-plugins
...
Some of the important files are described below. See the [common plugin files](https://moodledev.io/docs/4.5/apis/commonfiles) documentation for details of other files which may be useful in your plugin.
