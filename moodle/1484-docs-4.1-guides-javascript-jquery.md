...
url: https://moodledev.io/docs/4.1/guides/javascript/jquery
source: sitemap
fetched_at: 2026-02-17T14:57:15.09316-03:00
rendered_js: false
word_count: 371
summary: This document provides guidelines on the discouraged use of jQuery in Moodle, explaining how to handle legacy dependencies and import the library via AMD modules when necessary.
tags:
    - moodle-development
    - jquery
    - javascript-modules
