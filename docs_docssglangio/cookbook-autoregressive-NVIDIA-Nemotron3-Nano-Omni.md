---
title: Nemotron 3 Nano Omni - SGLang Documentation
url: https://docs.sglang.io/cookbook/autoregressive/NVIDIA/Nemotron3-Nano-Omni
source: sitemap
fetched_at: 2026-05-11T05:50:20.879593807-03:00
rendered_js: false
word_count: 858
summary: This document provides an overview, installation instructions, and deployment guidelines for the NVIDIA Nemotron 3 Nano Omni multimodal model using the SGLang framework.
tags:
    - nemotron-3
    - sglang
    - multimodal-model
...
For the full Docker setup and other installation methods, refer to the [official SGLang installation guide](https://docs.sglang.io/docs/get-started/installation).
...
ReasoningBF16FP8NVFP4

Hardware Platform

H100H200B200A100L40S
