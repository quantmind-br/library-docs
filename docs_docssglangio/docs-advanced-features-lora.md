---
title: LoRA Serving - SGLang Documentation
url: https://docs.sglang.io/docs/advanced_features/lora
source: sitemap
fetched_at: 2026-05-11T05:49:38.801533395-03:00
rendered_js: false
word_count: 1587
summary: This document describes how to configure and utilize LoRA adapters within the SGLang serving framework, including server startup arguments, client-side requests, and dynamic adapter management.
tags:
    - lora
    - model-serving
    - sglang
...
- `lora_paths`: The list of LoRA adapters to load. Each adapter must be specified in one of the following formats: &lt;PATH&gt; | &lt;NAME&gt;=&lt;PATH&gt; | JSON with schema {“lora\_name”:str,“lora\_path”:str,“pinned”:bool}.
...
1. **OpenAI-Compatible API** (`/v1/chat/completions`, `/v1/completions`): Use the `model:adapter-name` syntax. See [OpenAI API with LoRA](https://docs.sglang.io/docs/basic_usage/openai_api_completions#using-lora-adapters) for examples.
