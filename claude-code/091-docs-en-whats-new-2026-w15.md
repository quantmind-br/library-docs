...
url: https://code.claude.com/docs/en/whats-new/2026-w15.md
source: llms
fetched_at: 2026-04-16T22:36:06.952518337-03:00
rendered_js: false
word_count: 432
summary: This document provides a summary of new feature releases and tool updates for Claude Code between versions 2.1.92 and 2.1.101, including the introduction of Ultraplan and Monitor tools.
tags:
    - claude-code
    - changelog
    - software-release
