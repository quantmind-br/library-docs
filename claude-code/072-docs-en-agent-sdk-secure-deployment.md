...
url: https://code.claude.com/docs/en/agent-sdk/secure-deployment.md
source: llms
fetched_at: 2026-04-16T22:29:31.911888028-03:00
rendered_js: false
word_count: 2829
summary: This guide outlines security best practices and technical strategies for deploying AI agents like Claude Code, focusing on mitigating risks from prompt injection and model-driven actions through isolation, least privilege, and defense in depth.
tags:
    - ai-security
    - claude-code
    - prompt-injection
