...
url: https://github.com/openagen/zeroclaw/blob/master/docs/i18n/vi/adding-boards-and-tools.md
source: git
fetched_at: 2026-05-02T14:51:00.736587115-03:00
rendered_js: false
word_count: 393
summary: This document provides instructions for configuring hardware boards and custom tools within the ZeroClaw framework, including device registration, datasheet indexing for RAG, and implementation of peripheral traits.
tags:
    - zeroclaw
