...
url: https://moodledev.io/docs/5.0/tags/document
source: sitemap
fetched_at: 2026-02-17T15:18:29.143615-03:00
rendered_js: false
word_count: 69
summary: This document explains the role of file converters in Moodle, which allow plugins to transform files between different formats via a dedicated internal API.
tags:
    - moodle-development
    - file-conversion
    - plugin-apis
