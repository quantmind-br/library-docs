...
url: https://moodledev.io/docs/5.0/apis/plugintypes/enrol
source: sitemap
fetched_at: 2026-02-17T15:25:30.806968-03:00
rendered_js: false
word_count: 1683
summary: This document explains the architecture and implementation requirements for Moodle enrolment plugins, including file structure, database tables, and core class extensions.
tags:
    - moodle-development
    - enrolment-plugins
    - plugin-structure
...
- [Enrolment API](https://moodledev.io/docs/5.0/apis/subsystems/enrol)