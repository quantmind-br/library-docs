---
title: base - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/model_executor/models/transformers/base/
source: sitemap
fetched_at: 2026-05-07T21:33:33.994177057-03:00
rendered_js: false
word_count: 94
summary: This document defines the base class for vLLM's Transformers modeling backend, which initializes models from Hugging Face configs while integrating vLLM-specific optimizations like pipeline parallelism, custom attention implementations, and torch compile support.
tags:
    - vllm
    - transformers
...
"""
    ...
    def_get_decoder_cls(self, **kwargs: dict) -> type[PreTrainedModel]:
"""
    ...
    def_decorate_cls_for_torch_compile(
        self,
...
"""
        ...
        classSupportTorchCompileWrapper(cls): ...
...
"""
    ...
    def_create_hf_to_vllm_mapper(self):
"""
        ...
        if Version(transformers.__version__) >= Version("5.0.0"):
            fromtransformers.conversion_mappingimport (
                WeightRenaming,
    ...
    def_get_tie_word_embeddings(self):
"""
...
"""Recursively replace modules in the model as needed.
    ...
    defcreate_attention_instances(self) -> dict[int, Attention]:
"""
    ...
    definit_parameters(self, module: nn.Module, dtype: torch.dtype | None = None):
"""
        ...
        def_init_parameters(module: nn.Module, dtype: torch.dtype | None):
    ...
    @staticmethod
    defcheck_version(min_version: str, feature: str):
    ...
    defset_aux_hidden_state_layers(self, layers: tuple[int, ...]) -> None:
        ...
        fromtransformers.utils.output_capturingimport (
            OutputRecorder,
