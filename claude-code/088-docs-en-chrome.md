...
source: llms
fetched_at: 2026-04-16T22:31:03.765037314-03:00
rendered_js: false
word_count: 1254
summary: This document explains how to integrate Claude Code with the Chrome browser extension to enable automated web tasks such as debugging, testing, and data extraction.
tags:
    - claude-code
    - browser-automation
    - chrome-extension
