...
url: https://moodledev.io/docs/4.5/apis/subsystems/external/advanced/custom-services
source: sitemap
fetched_at: 2026-02-17T15:13:25.302538-03:00
rendered_js: false
word_count: 126
summary: This document outlines the configuration structure for defining external web services, including function registration, capability requirements, and file access permissions.
tags:
    - moodle-development
    - web-services
    - external-functions
