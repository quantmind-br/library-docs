...
url: https://moodledev.io/docs/4.4/guides/javascript
source: sitemap
fetched_at: 2026-02-17T15:05:18.130122-03:00
rendered_js: false
word_count: 2046
summary: This document introduces the standards and best practices for developing JavaScript within Moodle, focusing on ES2015+ module structure, naming conventions, and event handling.
tags:
    - moodle-development
    - javascript-modules
    - es2015
...
See the [Creating reactive UI](https://moodledev.io/docs/4.4/guides/javascript/reactive) for more information.
