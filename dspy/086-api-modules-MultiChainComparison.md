---
title: MultiChainComparison - DSPy
url: https://dspy.ai/api/modules/MultiChainComparison/
source: sitemap
fetched_at: 2026-01-23T08:01:50.054506538-03:00
rendered_js: false
word_count: 785
summary: The MultiChainComparison module in DSPy is designed to holistically compare multiple reasoning attempts and generate a refined, accurate rationale using a specialized signature.
tags:
    - dspy
...
```
def__init__(self, signature, M=3, temperature=0.7, **config):  # noqa: N803
    super().__init__()
...
### Functions[¶](#dspy.MultiChainComparison-functions "Permanent link")

#### `__call__(*args, **kwargs) -> Prediction` [¶](#dspy.MultiChainComparison.__call__ "Permanent link")
...
#### `acall(*args, **kwargs) -> Prediction` `async` [¶](#dspy.MultiChainComparison.acall "Permanent link")
...
#### `deepcopy()` [¶](#dspy.MultiChainComparison.deepcopy "Permanent link")
...
#### `dump_state(json_mode=True)` [¶](#dspy.MultiChainComparison.dump_state "Permanent link")
...
#### `forward(completions, **kwargs)` [¶](#dspy.MultiChainComparison.forward "Permanent link")
...
#### `get_lm()` [¶](#dspy.MultiChainComparison.get_lm "Permanent link")
...
#### `inspect_history(n: int = 1)` [¶](#dspy.MultiChainComparison.inspect_history "Permanent link")
...
#### `load(path, allow_pickle=False)` [¶](#dspy.MultiChainComparison.load "Permanent link")
...
#### `load_state(state)` [¶](#dspy.MultiChainComparison.load_state "Permanent link")
...
#### `map_named_predictors(func)` [¶](#dspy.MultiChainComparison.map_named_predictors "Permanent link")
...
#### `named_parameters()` [¶](#dspy.MultiChainComparison.named_parameters "Permanent link")
...
#### `named_predictors()` [¶](#dspy.MultiChainComparison.named_predictors "Permanent link")
...
#### `named_sub_modules(type_=None, skip_compiled=False) -> Generator[tuple[str, BaseModule], None, None]` [¶](#dspy.MultiChainComparison.named_sub_modules "Permanent link")
...
#### `parameters()` [¶](#dspy.MultiChainComparison.parameters "Permanent link")
...
#### `predictors()` [¶](#dspy.MultiChainComparison.predictors "Permanent link")
...
#### `reset_copy()` [¶](#dspy.MultiChainComparison.reset_copy "Permanent link")
...
#### `save(path, save_program=False, modules_to_serialize=None)` [¶](#dspy.MultiChainComparison.save "Permanent link")
...
#### `set_lm(lm)` [¶](#dspy.MultiChainComparison.set_lm "Permanent link")
