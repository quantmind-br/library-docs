...
source: sitemap
fetched_at: 2026-04-26T08:36:55.504475813-03:00
rendered_js: false
word_count: 552
summary: This document provides an overview and installation instructions for the DankLinux software repository, which offers pre-built packages for the DankMaterialShell, the niri compositor, and associated utility tools across multiple Linux distributions.
tags:
    - linux
    - repository
    - wayland
...
For complete DMS installation instructions including repository setup, see [[005-docs-1.5-dankmaterialshell-nixos|DankMaterialShell Installation Guide]].

> [!tip]
> Quick Start guides for specific distributions:
> - **Fedora**: [[005-docs-1.5-dankmaterialshell-nixos#fedora--centos|Fedora & CentOS]]
> - **Ubuntu/Debian**: [[005-docs-1.5-dankmaterialshell-nixos#debian--ubuntu|Ubuntu & Debian]]
> - **OpenSUSE**: [[005-docs-1.5-dankmaterialshell-nixos#opensuse--derivatives|OpenSUSE]]
...
1. Check the [[005-docs-1.5-dankmaterialshell-nixos|DankMaterialShell Installation Guide]] for common solutions
2. Visit the [[094-docs-1.5-support|Support Page]] for community resources
...
Contributions to the DankLinux repository are welcome. See [[092-docs-1.5-contributing|Contributing Guide]] to get started.
