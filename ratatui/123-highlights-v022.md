---
title: v0.22.0
url: https://ratatui.rs/highlights/v022/
source: crawler
fetched_at: 2026-02-01T21:13:27.824057245-03:00
rendered_js: false
word_count: 502
summary: This document outlines the features and improvements in Ratatui v0.22.0, including a new prelude module, scrollbar widget, and enhanced styling capabilities. It also detail updates to block titles, barchart groups, and expanded color string parsing support.
tags:
    - ratatui
    - rust-tui
    - release-notes
...
[Section titled “Block: support multiple titles”](#block-support-multiple-titles)
...
[Section titled “Barchart: support groups”](#barchart-support-groups)
...
See the [barchart example](https://github.com/ratatui/ratatui/blob/main/examples/barchart.rs) for more information and implementation details.

* * *

## Stylization shorthands

[Section titled “Stylization shorthands”](#stylization-shorthands)
...
[Section titled “Stylize everything”](#stylize-everything)
...
constDEFAULT_MODIFIER: Modifier = Modifier::BOLD.union(Modifier::ITALIC);
constEMPTY: Modifier = Modifier::empty();
constDEFAULT_STYLE: Style = Style::with(DEFAULT_MODIFIER, EMPTY)
.fg(Color::Red)
.bg(Color::Black);
```
