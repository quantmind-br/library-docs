...
url: https://docs.factory.ai/cli/getting-started/how-to-talk-to-a-droid.md
source: llms
fetched_at: 2026-02-05T21:41:53.675936225-03:00
rendered_js: false
word_count: 665
summary: This guide outlines best practices and proven techniques for writing effective prompts to interact with Factory's AI agents. It covers providing context, using specification mode, and managing session flow to achieve high-quality coding results.
tags:
    - prompt-engineering
    - factory-ai
    - ai-agents
