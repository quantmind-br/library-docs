---
title: Moodle App Overview | Moodle Developer Resources
url: https://moodledev.io/general/app/overview
source: sitemap
fetched_at: 2026-02-17T15:55:14.790356-03:00
rendered_js: false
word_count: 1393
summary: This document provides a technical overview of the Moodle App, explaining its architecture, core technologies like Angular and Ionic, and how it interacts with Moodle sites via web services.
tags:
    - moodle-app
    - mobile-development
    - angular
...
On a technical level, it's a completely different codebase from the Moodle LMS, and interacts with a Moodle site using [web services](https://moodledev.io/docs/5.2/apis/subsystems/external). You can find the source code of the application in github: [github.com/moodlehq/moodleapp](https://github.com/moodlehq/moodleapp).
...
### Technologies used[​](#technologies-used "Direct link to Technologies used")
...
The code of the application follows an [hexagonal architecture](https://en.wikipedia.org/wiki/Hexagonal_architecture_%28software%29), with core modules that include the main functionality and addon modules that provide additional features.
...
### Web services and caching[​](#web-services-and-caching "Direct link to Web services and caching")
...
### Delegates and handlers[​](#delegates-and-handlers "Direct link to Delegates and handlers")
...
### Site plugins[​](#site-plugins "Direct link to Site plugins")
...
Browsers are not officially supported, but you can use a Chromium-based browser for development if you don't need any native functionality. However, there are [some caveats](https://moodledev.io/general/app/development/setup/app-in-browser) you should be aware of.
...
- Do you want to contribute to the core? Read the [Moodle App Development guide](https://moodledev.io/general/app/development/development-guide).
- Do you want to adapt a plugin to mobile? Read the [Moodle App Plugins development guide](https://moodledev.io/general/app/development/plugins-development-guide).
- Do you want to customise your site in the app? Read the [Moodle App Customisation](https://moodledev.io/general/app/customisation) page.
- Do you want to make a custom app? Read the [Custom Moodle Apps](https://moodledev.io/general/app/customisation/custom-apps) page.

If you have any further questions, check out the [FAQ](https://moodledev.io/general/app/faq). If there's anything you want to share, you can do it in [the forum](https://moodle.org/mod/forum/view.php?id=7798) or [the Matrix developer room](https://docs.moodle.org/dev/Chat). You can also report any bugs that you find in [the tracker](https://moodle.atlassian.net/browse/MOBILE).