...
url: https://moodledev.io/docs/5.1/tags/plugins
source: sitemap
fetched_at: 2026-02-17T15:32:14.209752-03:00
rendered_js: false
word_count: 736
summary: This document serves as an index and overview of Moodle core APIs, plugin types, and common development files used to extend platform functionality.
tags:
    - moodle-development
    - core-apis
    - plugin-types
...
## [Advanced grading API](https://moodledev.io/docs/5.1/apis/core/grading)
...
## [Antivirus plugins](https://moodledev.io/docs/5.1/apis/plugintypes/antivirus)

Integrate your preferred Antivirus tool to with Moodle to automatically check new file uploads.

## [Block plugins](https://moodledev.io/docs/5.1/apis/plugintypes/blocks)
...
## [Course format](https://moodledev.io/docs/5.1/apis/plugintypes/format)

Course formats are plugins that determine the layout of course resources.

## [db/tasks.php](https://moodledev.io/docs/5.1/apis/commonfiles/db-tasks.php)

A description of the plugin scheduled task configuration file

## [Defaults for new questions](https://moodledev.io/docs/5.1/apis/plugintypes/qtype/newquestiondefaults)

A way for question types to remember a user's preferred settings for creating questions of a given type.

## [Enrolment plugins](https://moodledev.io/docs/5.1/apis/plugintypes/enrol)
...
## [Filter plugins](https://moodledev.io/docs/5.1/apis/plugintypes/filter)
...
## [Local plugins](https://moodledev.io/docs/5.1/apis/plugintypes/local)
...
## [Migrating 3.11 formats](https://moodledev.io/docs/5.1/apis/plugintypes/format/migration)
...
## [Question bank filters](https://moodledev.io/docs/5.1/apis/plugintypes/qbank/filters)

Question bank plugins allow you to define new filters for the question bank view and random question sets.

## [Question bank plugins](https://moodledev.io/docs/5.1/apis/plugintypes/qbank)

Question bank plugins allow you to extend the functionality of the Moodle Question bank.

## [Question type plugin restore code](https://moodledev.io/docs/5.1/apis/plugintypes/qtype/restore)

Question type plugins must implement special restore code to avoid duplicated questions

## [Question type plugins](https://moodledev.io/docs/5.1/apis/plugintypes/qtype)

Question type plugins implement the different types of question that the core Question subsystem can handle.

## [Repository plugins](https://moodledev.io/docs/5.1/apis/plugintypes/repository)
...
## [version.php](https://moodledev.io/docs/5.1/apis/commonfiles/version.php)
