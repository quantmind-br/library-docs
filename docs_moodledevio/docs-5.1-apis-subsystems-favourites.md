...
url: https://moodledev.io/docs/5.1/apis/subsystems/favourites
source: sitemap
fetched_at: 2026-02-17T15:36:32.463294-03:00
rendered_js: false
word_count: 746
summary: This document explains the technical implementation and usage of the Favourites API for marking and managing user-specific bookmarked items. It covers item identification using components and contexts, as well as performing CRUD operations and SQL joins via the service layer.
tags:
    - moodle-development
    - favourites-api
    - php-api
