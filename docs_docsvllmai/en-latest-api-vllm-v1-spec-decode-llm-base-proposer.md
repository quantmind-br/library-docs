---
title: llm_base_proposer - vLLM
url: https://docs.vllm.ai/en/latest/api/vllm/v1/spec_decode/llm_base_proposer/
source: sitemap
fetched_at: 2026-05-07T21:41:50.350384345-03:00
rendered_js: false
word_count: 50
summary: This document defines the initialization logic for the speculative decoding proposer in vLLM, configuring model-specific parameters, buffer allocations, and multi-modal handling.
tags:
    - vllm
...
classSpecDecodeBaseProposer:
    def__init__(
        ...
        if current_platform.is_rocm():
            fromvllm.v1.attention.backends.mla.indexerimport (
                DeepseekV32IndexerMetadata,
            )
            fromvllm.v1.attention.backends.mla.rocm_aiter_mla_sparseimport (
                ROCMAiterMLASparseMetadata,
            )
            fromvllm.v1.attention.backends.rocm_attnimport RocmAttentionMetadata
            ...
            if find_spec(
                ...
                fromvllm.v1.attention.backends.rocm_aiter_faimport (
            ...
            fromvllm.v1.attention.backends.flex_attentionimport FlexAttentionMetadata
    ...
    def_raise_if_padded_drafter_batch_disabled(self):
    ...
    def_init_parallel_drafting_params(self):
    ...
    def_get_positions(self, num_tokens: int):
        if self.uses_mrope:
    ...
    def_set_positions(self, num_tokens: int, positions: torch.Tensor):
        if self.uses_mrope:
...
"""Return slot_mapping dict for EAGLE layers.
    ...
    definitialize_cudagraph_keys(self, cudagraph_mode: CUDAGraphMode) -> None:
"""Initialize cudagraph dispatcher keys for the drafter.
    ...
    def_greedy_sample(self, hidden_states: torch.Tensor) -> torch.Tensor:
"""Greedy-sample draft tokens from hidden states."""
    ...
    def_update_positions_dependent_metadata(
        self,
...
"""Update positions, slot mappings, and sequence metadata for the
    ...
    defbuild_model_inputs_first_pass(
        self,
        num_tokens: int,
    ...
    defbuild_per_group_and_layer_attn_metadata(
    ...
    defmodel_returns_tuple(self) -> bool:
        return self.method not in ("mtp", "draft_model", "dflash")

    defprepare_next_token_ids_cpu(
        self,
...
"""
    ...
    defprepare_next_token_ids_padded(
        self,
...
"""
    ...
    defget_model_name(self, model: nn.Module) -> str:
        if hasattr(model, "module"):  # multi-GPU
            model = model.module
        return model.__class__.__name__

    def_create_draft_vllm_config(self) -> VllmConfig:
...
"""
    ...
    def_maybe_share_embeddings(self, target_language_model: nn.Module) -> None:
"""
    ...
    def_maybe_share_lm_head(self, target_language_model: nn.Module) -> None:
"""
    ...
    def_get_eagle3_use_aux_hidden_state_from_config(self) -> bool:
"""
    ...
    defvalidate_same_kv_cache_group(self, kv_cache_config: KVCacheConfig) -> None:
"""
...
"""
    ...
    def_determine_batch_execution_and_padding(
        self,
        num_tokens: int,
        use_cudagraphs: bool = True,
