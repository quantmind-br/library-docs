...
url: https://github.com/ChristopherKahler/paul/blob/main/src/templates/SUMMARY.md
source: git
fetched_at: 2026-04-30T00:52:55.010382937-03:00
rendered_js: false
word_count: 329
summary: Standardized template for project phase completion summaries. Documents deliverables, decisions, deviations, and next-phase readiness.
tags:
...
> [!note]
> Template for `.paul/phases/{phase-number}-{name}/{phase}-{plan}-SUMMARY.md` — plan completion documentation. Documents what was built, decisions made, deviations from plan, and readiness for next phase.
...
> [!note]
> Separate from "Issues Encountered" which documents problems with planned work.
...
#documentation-template #project-management #software-development #phase-tracking